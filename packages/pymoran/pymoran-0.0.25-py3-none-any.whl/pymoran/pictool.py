...
class Pic_Style:
    ...
    def border_radius(img: Image.Image, radius: int):
        '''
        为图像生成圆角
        :param img 需要处理的图像
        :param radius 圆角半径
        ...
        # 粘贴右上角
        alpha.paste(img_rec.crop((radius, 0, radius * 2, radius)), (w - radius, 0))
        # 粘贴左下角
        alpha.paste(img_rec.crop((0, radius, radius, radius * 2)), (0, h - radius))
        # 粘贴右下角
    ...
    def box_shadow(img: Image.Image,
                bgcolor: str = 'white',
