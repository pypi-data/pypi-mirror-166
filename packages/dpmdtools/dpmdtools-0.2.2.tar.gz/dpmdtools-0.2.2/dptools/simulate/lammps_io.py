...
class LammpsInput:
    ...
    def write_angles(self):
        # TODO: Can probably generalize this method to write 
        #       bonds, angles, dihedrals to reduce repetitive code
