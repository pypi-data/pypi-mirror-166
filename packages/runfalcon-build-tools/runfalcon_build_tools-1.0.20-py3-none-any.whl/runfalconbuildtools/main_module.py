...
class ModuleMain:
    ...
    usage_message:str = \
                    ...
                    '\t\tOperations:\n' + \
                    '\t\t\tget: Download an specific artifact\n.  Arguments:' + \
                    ...
                    '\t\t\t\tExample: python -m runfalconbuildtools artifact get name="my artifact" version="1.0.0" out="./,y_artifact.zip"'
    ...
    def __get_artifact(self, main_command:MainCommand):
        ...
        match main_command.get_argument('name'):
            case 'dummy':
        ...
        output_path = artifacts_manager.get_artifact(artifact, main_command.get_argument('version'))
