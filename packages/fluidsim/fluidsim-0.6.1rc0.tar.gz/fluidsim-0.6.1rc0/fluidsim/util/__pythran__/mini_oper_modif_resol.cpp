...
namespace __pythran_mini_oper_modif_resol
{
  ...
  typename fill_field_fft_3d::type<argument_type0, argument_type1>::result_type fill_field_fft_3d::operator()(argument_type0&& field_fft_in, argument_type1&& field_fft_out) const
  {
    ...
    {
      long  __target139926969359184 = pythonic::operator_::add(pythonic::operator_::functor::floordiv()(nk0_min, 2L), 1L);
      for (long  ik0=0L; ik0 < __target139926969359184; ik0 += 1L)
      {
        {
          long  __target139926969356736 = pythonic::operator_::add(pythonic::operator_::functor::floordiv()(nk1_min, 2L), 1L);
          for (long  ik1=0L; ik1 < __target139926969356736; ik1 += 1L)
          {
            {
              long  __target139926969528224 = nk2_min;
              for (long  ik2=0L; ik2 < __target139926969528224; ik2 += 1L)
              {
