...
namespace __pythran_spatiotemporal_spectra
{
  ...
  struct get_arange_minmax
  {
    ...
    struct type
    {
      ...
      typedef typename std::remove_cv<typename std::remove_reference<decltype(pythonic::builtins::functor::len{})>::type>::type __type7;
      typedef typename pythonic::assignable<decltype(std::declval<__type7>()(std::declval<__type3>()))>::type __type9;
      typedef find_index_first_g __type10;
      typedef typename std::remove_cv<typename std::remove_reference<argument_type2>::type>::type __type12;
      typedef typename pythonic::assignable<decltype(std::declval<__type10>()(std::declval<__type3>(), std::declval<__type12>()))>::type __type13;
      typedef typename __combined<__type9,__type13>::type __type14;
      typedef typename pythonic::returnable<decltype(std::declval<__type0>()(std::declval<__type6>(), std::declval<__type14>()))>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 >
    inline
  ...
  typename get_arange_minmax::type<argument_type0, argument_type1, argument_type2>::result_type get_arange_minmax::operator()(argument_type0&& times, argument_type1&& tmin, argument_type2&& tmax) const
  {
    ...
    typedef find_index_first_g __type3;
    typedef typename std::remove_cv<typename std::remove_reference<argument_type2>::type>::type __type5;
    typedef typename pythonic::assignable<decltype(std::declval<__type3>()(std::declval<__type1>(), std::declval<__type5>()))>::type __type6;
    typedef typename pythonic::assignable<long>::type __type7;
    typedef find_index_first_geq __type8;
    typedef typename std::remove_cv<typename std::remove_reference<argument_type1>::type>::type __type10;
    typedef typename pythonic::assignable<decltype(std::declval<__type8>()(std::declval<__type1>(), std::declval<__type10>()))>::type __type11;
    typename pythonic::assignable<typename __combined<__type2,__type6>::type>::type stop;
    typename pythonic::assignable<typename __combined<__type7,__type11>::type>::type start;
