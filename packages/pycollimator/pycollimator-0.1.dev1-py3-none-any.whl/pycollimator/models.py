...
class Model:
    ...
    def __init__(self, data):
        ...
        self._datasource_data_by_uuid: dict[str, pd.DataFrame] = {}  # block_uuid -> data (pd.DataFrame)
        self._hashed_files: dict[str, SimulationHashedFile] = {}  # block_uuid -> SimulationHashedFile
    ...
    def _get_blocks_with_data(self) -> dict[str, pd.DataFrame]:
        """block_uuid -> data (pd.DataFrame)"""
        return self._datasource_data_by_uuid

    def _prepare_hashed_files(self) -> dict[str, SimulationHashedFile]:
    ...
    def _get_hashed_files(self) -> dict[str, SimulationHashedFile]:
