...
def ExtractionStartShapeVector(builder, numElems): return builder.StartVector(16, numElems, 4)
...
def ExtractionStartGcpsVector(builder, numElems): return builder.StartVector(16, numElems, 4)
