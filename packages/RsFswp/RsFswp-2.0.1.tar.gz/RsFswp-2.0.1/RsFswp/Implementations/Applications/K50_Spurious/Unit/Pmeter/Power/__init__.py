...
class Power:
	...
	def set(self, arg_0: enums.PowerMeterUnit, powerMeter=repcap.PowerMeter.Default) -> None:
		...
		Snippet: driver.applications.k50Spurious.unit.pmeter.power.set(arg_0 = enums.PowerMeterUnit.DBM, powerMeter = repcap.PowerMeter.Default) \n
	...
	def get(self, powerMeter=repcap.PowerMeter.Default) -> enums.PowerMeterUnit:
		"""SCPI: UNIT:PMETer<p>:POWer \n
		Snippet: value: enums.PowerMeterUnit = driver.applications.k50Spurious.unit.pmeter.power.get(powerMeter = repcap.PowerMeter.Default) \n
		This command selects the unit for absolute power sensor measurements. \n
			:param powerMeter: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Pmeter')
