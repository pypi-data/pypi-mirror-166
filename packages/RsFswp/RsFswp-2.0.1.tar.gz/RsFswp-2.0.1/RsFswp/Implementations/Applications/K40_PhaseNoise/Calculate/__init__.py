...
class Calculate:
	"""Calculate commands group definition. 9 total commands, 5 Subgroups, 0 group commands
	...
	@property
	def snoise(self):
		"""snoise commands group. 2 Sub-classes, 0 commands."""
	...
	@property
	def pnLimit(self):
		"""pnLimit commands group. 3 Sub-classes, 0 commands."""
