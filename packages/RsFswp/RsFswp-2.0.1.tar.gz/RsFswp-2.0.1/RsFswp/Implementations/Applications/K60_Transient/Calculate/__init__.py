...
class Calculate:
	"""Calculate commands group definition. 62 total commands, 4 Subgroups, 0 group commands
	...
	def distribution(self):
		"""distribution commands group. 1 Sub-classes, 0 commands."""
	...
	def spectrogram(self):
		"""spectrogram commands group. 3 Sub-classes, 2 commands."""
