...
class Coupling:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k30NoiseFigure.source.generator.channel.coupling.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: SOURce:GENerator:CHANnel:COUPling \n
		Snippet: value: bool = driver.applications.k30NoiseFigure.source.generator.channel.coupling.get() \n
		No command help available \n
