...
class Table:
	...
	def delete(self, table_name: str) -> None:
		...
		Snippet: driver.applications.k30NoiseFigure.sense.correction.loss.inputPy.table.delete(table_name = '1') \n
		...
		self._core.io.write(f'SENSe:CORRection:LOSS:INPut:TABLe:DELete {param}')
