...
class Power:
	...
	@property
	def dcpNoise(self):
		"""dcpNoise commands group. 5 Sub-classes, 0 commands."""
		if not hasattr(self, '_dcpNoise'):
			from .DcpNoise import DcpNoise
			self._dcpNoise = DcpNoise(self._core, self._cmd_group)
		return self._dcpNoise
