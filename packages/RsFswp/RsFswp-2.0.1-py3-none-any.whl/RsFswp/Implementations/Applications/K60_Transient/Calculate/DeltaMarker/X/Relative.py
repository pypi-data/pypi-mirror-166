...
class Relative:
	...
	def get(self, window=repcap.Window.Default, deltaMarker=repcap.DeltaMarker.Default) -> float:
		...
		Snippet: value: float = driver.applications.k60Transient.calculate.deltaMarker.x.relative.get(window = repcap.Window.Default, deltaMarker = repcap.DeltaMarker.Default) \n
