...
class Offset:
	...
	def set(self, frequency: float) -> None:
		...
		Snippet: driver.applications.k50Spurious.sense.frequency.offset.set(frequency = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: [SENSe]:FREQuency:OFFSet \n
		Snippet: value: float = driver.applications.k50Spurious.sense.frequency.offset.get() \n
		No command help available \n
