...
class Frequency:
	...
	def set(self, arg_0: float, powerMeter=repcap.PowerMeter.Default) -> None:
		...
		Snippet: driver.applications.k50Spurious.sense.pmeter.frequency.set(arg_0 = 1.0, powerMeter = repcap.PowerMeter.Default) \n
	...
	def get(self, powerMeter=repcap.PowerMeter.Default) -> float:
		"""SCPI: [SENSe]:PMETer<p>:FREQuency \n
		Snippet: value: float = driver.applications.k50Spurious.sense.pmeter.frequency.get(powerMeter = repcap.PowerMeter.Default) \n
		This command defines the frequency of the power sensor. \n
			:param powerMeter: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Pmeter')
