...
class Calculate:
	"""Calculate commands group definition. 66 total commands, 4 Subgroups, 0 group commands
	...
	@property
	def limit(self):
		"""limit commands group. 12 Sub-classes, 1 commands."""
	...
	def uncertainty(self):
		"""uncertainty commands group. 7 Sub-classes, 0 commands."""
