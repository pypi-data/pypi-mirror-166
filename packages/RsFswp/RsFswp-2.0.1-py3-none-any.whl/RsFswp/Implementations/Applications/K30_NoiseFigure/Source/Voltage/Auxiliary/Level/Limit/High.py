...
class High:
	...
	def set(self, voltage: float) -> None:
		...
		Snippet: driver.applications.k30NoiseFigure.source.voltage.auxiliary.level.limit.high.set(voltage = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: SOURce:VOLTage:AUX:LEVel:LIMit:HIGH \n
		Snippet: value: float = driver.applications.k30NoiseFigure.source.voltage.auxiliary.level.limit.high.get() \n
		No command help available \n
