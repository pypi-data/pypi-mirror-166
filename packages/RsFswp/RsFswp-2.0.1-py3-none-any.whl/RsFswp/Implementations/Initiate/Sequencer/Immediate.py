...
class Immediate:
	...
	def set(self) -> None:
		...
		Its effect is similar to the INITiate<n>[:​IMMediate] command used for a single measurement. Before this command can be
		executed, the Sequencer must be activated (see method RsFswp.System.Sequencer.set) . \n
		"""
