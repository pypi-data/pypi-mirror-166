...
class Sequencer:
	...
	def abort(self) -> None:
		...
		This command stops the currently active sequence of measurements. You can start a new sequence any time using method
		RsFswp.Initiate.Sequencer.Immediate.set. \n
		"""
