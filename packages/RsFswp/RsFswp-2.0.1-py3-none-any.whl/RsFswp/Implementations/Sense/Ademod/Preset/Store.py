...
class Store:
	...
	def set(self, standard: str) -> None:
		...
		This command saves the current Analog Demodulation measurement configuration. Standard definitions are stored in an xml
		file. The default directory for Analog Demodulation standards is C:/R_S/INSTR/USER/predefined/AdemodPredefined. \n
