...
class Demod:
	...
	def set(self, bandwidth: float) -> None:
		...
		This command sets the bandwidth for analog demodulation. Depending on the selected demodulation bandwidth, the instrument
		selects the required sample rate. This command is identical to SENS:ADEM:BAND:DEM. \n
