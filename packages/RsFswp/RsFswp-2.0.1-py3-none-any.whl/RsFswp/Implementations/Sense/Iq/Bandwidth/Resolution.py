...
class Resolution:
	...
	def set(self, bandwidth: float) -> None:
		...
		This command defines the resolution bandwidth manually if BWIDth:MODE is set to MAN. Defines the resolution bandwidth.
		The available RBW values depend on the sample rate and record length. For details see 'Frequency Resolution of FFT
		Results - RBW'. \n
