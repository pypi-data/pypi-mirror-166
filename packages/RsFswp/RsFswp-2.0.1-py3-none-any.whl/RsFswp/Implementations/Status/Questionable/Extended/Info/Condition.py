...
class Condition:
	...
	def get(self) -> str:
		...
		Snippet: value: str = driver.status.questionable.extended.info.condition.get() \n
		...
		response = self._core.io.query_str(f'STATus:QUEStionable:EXTended:INFO:CONDition?')
