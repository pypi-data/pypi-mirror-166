...
class Sinfo:
	...
	def get(self) -> str:
		...
		RsFswp.MassMemory.copy command to store the file on the controller PC. If you contact the Rohde&Schwarz support to get
		help for a certain problem, send this file to the support in order to identify and solve the problem faster. \n
