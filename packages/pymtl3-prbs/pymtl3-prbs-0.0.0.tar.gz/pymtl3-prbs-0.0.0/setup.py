...
def get_version():
  ...
  result = "?"
  with open("pymtl3_prbs/__init__.py") as f:
    for line in f:
...
setup(
  ...
  name             = 'pymtl3-prbs',
  version          = get_version(),
  description      = 'PyMTL3-PRBS: an open-source PyMTL3 IP for pseudorandom binary sequence generator/verifier.',
  long_description = get_long_description(),
  long_description_content_type="text/markdown",
  url              = 'https://github.com/pymtl/pymtl3-prbs',
