...
class TestAnnotations:
    ...
    def test_create_cuboid3d_annotation(self):
        ...
        for i in range(3):
            cuboids.append(
                Cuboid3D(tl1=(100.0 + 10.0 * i, 200.0 - 10.0 * i, i),
                         bl1=(150.0 + 10.0 * i, 150.0 - 10.0 * i, i),
                         tr1=(300.0 + 10.0 * i, 300.0 - 10.0 * i, i),
                         br1=(200.0 + 10.0 * i, 200.0 - 10.0 * i, i),
                         tl2=(250.0 + 10.0 * i, 250.0 - 10.0 * i, i),
                         bl2=(350.0 + 10.0 * i, 350.0 - 10.0 * i, i),
                         tr2=(400.0 + 10.0 * i, 400.0 - 10.0 * i, i),
                         br2=(450.0 + 10.0 * i, 450.0 - 10.0 * i, i),
                         label="test_label_{}".format(i),
                         confidence=0.7 + 0.1 * i,
                         category_id=i,
                         attributes={"track_id": 0}))
