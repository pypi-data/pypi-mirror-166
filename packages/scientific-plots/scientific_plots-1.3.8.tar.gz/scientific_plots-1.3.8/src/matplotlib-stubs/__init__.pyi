...
class CyclicProperties(TypedDict):
    """Dictionary of cyclic properties."""

    color: list[str]


class PropCycle:
    """Properties, which are cyclic."""

    def by_key(self) -> CyclicProperties: ...
...
class RCParams:
    ...
    @overload
    def __getitem__(self, key: Literal["axes.prop_cycle"]) -> PropCycle: ...

    @overload
    def __getitem__(self, key: str) -> Union[list[str], PropCycle]: ...
