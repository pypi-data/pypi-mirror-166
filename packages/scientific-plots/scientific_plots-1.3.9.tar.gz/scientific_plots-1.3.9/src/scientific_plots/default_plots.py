...
def three_axis_plots(x1: In, y1: In, label1: str,
    ...
    ax1.yaxis.label.set_color(lines[0].get_color())
    ax1.tick_params(axis="y", colors=lines[0].get_color())
    ...
    ax2.yaxis.label.set_color(lines[-2].get_color())
    ax2.tick_params(axis="y", colors=lines[-2].get_color())
