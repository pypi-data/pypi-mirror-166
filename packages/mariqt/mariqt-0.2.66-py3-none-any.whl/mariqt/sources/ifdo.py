...
class iFDO:
    ...
    def __init__(self, dir: miqtd.Dir, handle_prefix='20.500.12085/ee277578-a911-484d-a515-9c781d79aa91',provenance = None,verbose=True,startEmpty=False,writeTmpProvFile=True):
        ...
        if len(self._imagesInRaw) == 0 and not startEmpty:
