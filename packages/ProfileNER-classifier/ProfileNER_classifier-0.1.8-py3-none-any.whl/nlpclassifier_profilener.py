...
class NLPClassifier:
    ...
    def __init__(self, use, youtube: bool = False):
        ...
        ner_data = pd.read_csv(resources.open_binary('__package__', 'ner_data.csv'))
        ...
        self.politico = pd.read_csv(resources.open_binary('__package__', 'lista_politico.csv'), encoding='utf8')['politicos'].tolist()
        self.artista = ['singer',r'\bcantor',r'\batriz',r'\bator','comediante','youtuber', r'influenciado.* digital']
        midia_tradicional2 = pd.read_csv(resources.open_binary('__package__', 'lista_midia_trad.csv'), encoding ='utf-8')['midias'].apply(lambda x:str(x).replace( ' ', '')).tolist()
        self.veiculo_info = pd.read_csv(resources.open_binary('__package__', 'lista_midia_trad.csv'), encoding ='utf-8')['midias'].tolist() +midia_tradicional2
        ...
        universidades = pd.read_csv(resources.open_binary('__package__', 'lista_unifederal.csv'), encoding ='utf-8', sep =',')['universidade'].tolist()
        self.org = pd.read_csv('__package__','lista_org.csv', encoding='utf8')['org'].tolist() + ['universidade federal','universidade estadual','universidade de sao paulo']
        ...
        parti = ['brasil247']
        midias_partidarias2 = pd.read_csv(resources.open_binary('__package__', 'lista_midia_partidaria.csv'), encoding= 'utf-8')['midias'].apply(lambda x:str(x).replace( ' ', '')).tolist()
        self.midias_partidarias = pd.read_csv(resources.open_binary('__package__', 'lista_midia_partidaria.csv'), encoding= 'utf-8')['midias'].tolist() + parti +midias_partidarias2
