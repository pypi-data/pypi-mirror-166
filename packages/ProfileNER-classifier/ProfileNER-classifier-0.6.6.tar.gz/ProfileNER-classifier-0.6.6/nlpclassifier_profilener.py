...
class NLPClassifier:
    ...
    def __init__(self, use, youtube: bool = False):
        ...
        self.veiculo_info = pd.read_csv(resources.open_binary('nlpclassifier', 'lista_midia_trad.csv'), encoding ='utf-8')['midias'].tolist() +midia_tradicional2
        ...
        universidades = pd.read_csv(resources.open_binary('nlpclassifier', 'lista_unifederal.csv'), encoding ='utf-8', sep =',')['universidade'].tolist()
        ...
        parti = ['brasil247']
        midias_partidarias2 = pd.read_csv(resources.open_binary('nlpclassifier', 'lista_midia_partidaria.csv'), encoding= 'utf-8')['midias'].apply(lambda x:str(x).replace( ' ', '')).tolist()
        self.midias_partidarias = pd.read_csv(resources.open_binary('nlpclassifier', 'lista_midia_partidaria.csv'), encoding= 'utf-8')['midias'].tolist() + parti +midias_partidarias2
