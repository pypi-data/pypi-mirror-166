...
class DynamoDB:
    ...
    def put_ddb_object(self, table_name, item_dict, debug=True):
        """
    ...
    def put_ddb_df_pyspark(self, table_name, pyspark_df, debug=True):
        """
    ...
    def put_ddb_df_pandas(self, table_name, pd_df, debug=True):
        """
    ...
    def get_ddb_object(self, table_name, key_name, search_key, debug=True):
        """
