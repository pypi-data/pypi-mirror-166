...
class Page:
    ...
    def write_metadata(self, stream_names):
        ...
        # tracker_log(f'Notify Merger Services at {current_ts} with alive ids[{prev_unix_ts} {current_ts}] {ids} ', f'Page - ')
...
def load_page(website, section, page, device, output_stream_names):
    if page.is_exists() != 1:
        ...
        page.expire_metrics()
        page.notification_of_active_websites(stream_names=output_stream_names)
        page.send_to_enrich()
