...
class Website:
    ...
    def write_metadata(self, stream_names):
        ...
        tracker_log(f'XADD {stream_names.get("website_unique_devices")} * dimension {Dimension.WEBSITE.value} id {self.id} ts {parsed_key.get("ts")} merged_key {self.metric_unique_device_key}')
