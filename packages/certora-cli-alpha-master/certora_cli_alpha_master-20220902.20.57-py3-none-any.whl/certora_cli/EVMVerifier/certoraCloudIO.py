...
class CloudVerification(metaclass=Singleton):
    ...
    def __compress_and_upload_zip_files(self) -> bool:
        ...
        if self.args.mode == Mode.TAC:
            ...
            if not result:
                return False
            files_list = [CERTORA_BUILD_FILE, CERTORA_VERIFY_FILE, CERTORA_CONFIG_DIR, CERTORA_METADATA_FILE,
                          Path(self.logZipFileName)]
            if CERTORA_SOURCES_DIR.exists():
                files_list.append(CERTORA_SOURCES_DIR)
