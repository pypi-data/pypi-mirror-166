...
class NERRunnerTests(unittest.TestCase):
    ...
    @patch("azureml.automl.dnn.nlp.ner.runner.ResourcePathResolver.model_path", new_callable=PropertyMock)
    @patch("azureml.automl.dnn.nlp.ner.runner.ResourcePathResolver.tokenizer", new_callable=PropertyMock)
    ...
    def test_runner(
        ...
        model_path_mock.return_value = "some_path"
