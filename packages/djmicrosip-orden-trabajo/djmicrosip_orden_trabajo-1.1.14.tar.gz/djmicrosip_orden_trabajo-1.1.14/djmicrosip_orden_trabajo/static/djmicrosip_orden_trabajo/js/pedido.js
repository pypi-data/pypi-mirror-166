		...
		success: function (data) {
			console.log(id_precio_unitario)
				...
				else
				{
					...
					$("#"+id_precio_unitario).val(parseFloat($("#"+id_precio_unitario).val()).toFixed(2));
					$("#"+id_unidades).val(parseFloat($("#"+id_unidades).val()).toFixed(2));
					$("#"+id_precio_total_neto).val(parseFloat($("#"+id_precio_total_neto).val()).toFixed(2));
				}	
