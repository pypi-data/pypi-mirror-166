...
class VendedorForm(forms.Form):
	vendedor = forms.ModelChoiceField(queryset=Vendedor.objects.filter(oculto='N').order_by('nombre'), widget=forms.Select(attrs={'class': 'form-control'}), required=False)
...
class PreferenciasManageForm(forms.Form):
	...
	doc_registro = forms.ChoiceField(choices=DOC_REGISTRO,widget=forms.Select(attrs={'class': 'form-control'}), required=False)
	...
	def save(self, *args, **kwargs):
		...
		doc_registro = Registry.objects.get( nombre = 'SIC_Pedidos_Doc_Registro')
		doc_registro.valor = self.cleaned_data['doc_registro']
		doc_registro.save()
