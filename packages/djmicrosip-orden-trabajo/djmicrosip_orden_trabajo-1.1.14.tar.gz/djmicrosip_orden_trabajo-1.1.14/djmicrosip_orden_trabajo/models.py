...
from django_microsip_base.libs.models_base.models import VentasDocumento,Vendedor,Cliente,Registry
...
class Pedidos_Crm(models.Model):
    ...
    hardware=MultiSelectField(choices=[],db_column="HARDWARE")
    ...
    persona_solicito = models.CharField(max_length=250,null=True, db_column='PERSONA_SOLICITO')
