...
class File_Services(Consumer):
    ...
    def uploadFile(self, container_name: str, file: Part, directory: Query(type=str), overwrite: Query(type=bool) = False):
