...
if (typeof django_modal == 'undefined') {
    var django_modal = function () {
        ...
        ajax_helpers.command_functions.show_modal_method = function (command) {
            ajax_helpers.post_json({ajax_method:command.method, data: command.data, success: create_modal})
        }
