...
class APINexus:
    ...
    def filter_installation(self, Datefrom, Dateto, columnas, filter_txt=None, resolucion=3, fuente=0):
        """
        ...
        Args:
            ...
            Dateto (datetime)
            columnas (dataframe)
            filter_txt (optonal: list or str)
        ...
        # Check content
        if not {'timeStamp', 'uid', 'value'}.issubset(filtered_hist.columns):
    ...
    def filter_tagview(self, Datefrom, Dateto, columnas, uid_vista, filter_txt=None, resolucion=3, fuente=0):
        """
        La funcion recibe como parametros la fecha ini, fecha fin, un df con los uid y
