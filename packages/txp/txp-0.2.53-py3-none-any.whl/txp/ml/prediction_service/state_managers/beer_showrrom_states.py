...
class BeerShowroomAsset(sm.StateManager):
    ...
    def get_state(self, events):
        ...
        # BottleBeerPresence
        bottle_beer_event = predicted_lbls['BottleBeerPresence']

        # CanBeerPresence
        can_beer_presence = predicted_lbls['CanBeerPresence']
        ...
        if bottle_beer_event == 'PresentBeer' and can_beer_presence == 'Present':
            state_val = AssetStateCondition.OPTIMAL
        elif bottle_beer_event == 'PresentBeer' and can_beer_presence == 'NotPresent':
            state_val = AssetStateCondition.OPERATIONAL
        elif bottle_beer_event == 'NotPresentBeer' and can_beer_presence == 'Present':
            state_val = AssetStateCondition.OPERATIONAL
        else:
