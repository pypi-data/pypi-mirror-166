...
class BasicModelTrainer(ABC):
    ...
    def get_label_value(self, task_definition: AssetTask, json_string):
        ...
        if tuple(label_dict["label_value"]) not in task_definition.label_def.label_to_int:
            raise te.WrongLabelValue(label_dict["label_value"])
        return task_definition.label_def.label_to_int[tuple(label_dict["label_value"])]
