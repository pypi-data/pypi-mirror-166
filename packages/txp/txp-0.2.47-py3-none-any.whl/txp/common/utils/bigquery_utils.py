...
def get_all_records_within_interval(
    ...
    start_partition_timestamp = txp.common.utils.bigquery_utils.get_partition_utc_date(start_time)
    end_partition_timestamp = txp.common.utils.bigquery_utils.get_partition_utc_date(end_time + 3.6e12)
...
def annotate_signal(tenant_id, table_name, edge_logical_id, observation_timestamp, label,
    ...
    partition_timestamp = txp.common.utils.bigquery_utils.get_partition_utc_date(observation_timestamp)
...
def get_sampling_window_from_bigquery(table_id, edge_logical_id, perception_name, observation_timestamp, tenant_id,
                                      client):
    partition_timestamp = str(txp.common.utils.bigquery_utils.get_partition_utc_date(observation_timestamp))
    select_query = f"""
