...
class Hive(dict):
    def __init__(self, rpc):
        ...
        self["variable_settings"] = {
            ...
            "custom_types": {"json_rpc": {"description": "Takes all vars and puts them in a body JSON object"}},
        }
        self["variables"] = {
            "hostname": {"type": "url_replacement"},
            "port": {"type": "url_replacement"},
            "jsonrpc": {"type": "json_rpc", "value": "2.0"},
...
class Method(dict):
    def __init__(self, name, method):
        ...
        self["variables"]["method"] = {"type": "json_rpc", "value": name}
