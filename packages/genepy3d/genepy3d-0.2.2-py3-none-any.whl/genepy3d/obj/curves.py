...
#        idx1 = np.argwhere((np.abs(tor) <= tor_thr)).flatten()
    ...
    def resample(self,npoints=None,unit_length=None,spline_order=1,return_interp_param=False):
    ...
    def main_turns(self,nbscales=None,search_step=5,eps_kappa=None,ridgelength_thr=0.1,angle_thr=20,min_dist=None):
