...
class RobotControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TowardJ = channel.unary_unary(
                '/robotc.RobotController/TowardJ',
...
class RobotControllerServicer(object):
    ...
    def TowardJ(self, request, context):
        """跟随移动
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_RobotControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'TowardJ': grpc.unary_unary_rpc_method_handler(
                    servicer.TowardJ,
...
class RobotController(object):
    ...
    def TowardJ(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/robotc.RobotController/TowardJ',
