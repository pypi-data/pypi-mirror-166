...
from azureml.automl.core.shared.exceptions import (
    DataException, InvalidOperationException, UntrainedModelException, ValidationException)
...
from azureml.automl.runtime.frequency_fixer import fix_df_frequency
...
class ForecastModelWrapperBase(ABC):
    ...
    def short_grain_handling(self) -> bool:
        ...
        return forecasting_utils.get_pipeline_step(
            self._get_not_none_ts_transformer().pipeline,
            constants.TimeSeriesInternal.SHORT_SERIES_DROPPEER) is not None
