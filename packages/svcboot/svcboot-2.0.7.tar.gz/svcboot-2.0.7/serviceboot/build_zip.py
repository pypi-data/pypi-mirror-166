...
def build_zip():
    ...
    if platform.system() == 'Windows':
        ...
        if os.path.exists('venv'):
            os.system('xcopy /y /q /s /e venv\\ out\\venv\\')
        ...
        if os.path.exists('venv'):
            os.system('cp -r ./venv ./out/{}/'.format(name))
            os.system('sed -i "1c #!/serviceboot/venv/bin/python3" ./out/venv/bin/serviceboot')
            os.system('sed -i "40c VIRTUAL_ENV=\"\/serviceboot\/venv\"" ./out/venv/bin/activate')
