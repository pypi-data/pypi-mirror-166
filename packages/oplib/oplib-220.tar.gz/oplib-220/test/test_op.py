...
FN = "store/op.Object/2022-04-11/22:40:31.259218"
VALIDJSON = '{"test": "bla"}'
...
class TestObject(unittest.TestCase):
    ...
    def test_otype(self):
        obj = Object()
        self.assertEqual(otype(obj), "op.Object")
    ...
    def test_stp(self):
        obj = Object()
        self.assertTrue("op.Object" in obj.__stp__)
...
class TestDb(unittest.TestCase):
    ...
    def test_fns(self):
        obj = Object()
        save(obj)
        self.assertTrue("Object" in Db.fns(Wd.getpath("op.Object"))[0])
