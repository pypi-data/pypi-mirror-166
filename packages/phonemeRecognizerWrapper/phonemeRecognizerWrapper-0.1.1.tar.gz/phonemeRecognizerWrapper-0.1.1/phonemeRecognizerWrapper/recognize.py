...
# ----------------------------------------------------------------------------------------------------------------------
# Command structure:
# <py phonemeRecognizerWrapper.recognize LANGUAGE_CODE FILES EMIT_PROB>
# ----------------------------------------------------------------------------------------------------------------------
# Required Arguments:
...
# <py phonemeRecognizerWrapper.recognize eng "C:\sound.wav" 1.0>

# Example usage from MATLAB via the <[status, result] = system(command)> function:
# <command = 'py "C:\...\phonemeRecognizerWrapper.py" eng "C:\sounds\sound.wav;C:\sounds\sound2.wav" 1.0';>
