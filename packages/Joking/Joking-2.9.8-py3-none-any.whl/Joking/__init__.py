...
class HelpNFeedBack:
    def Give_FeedBack(self, name, message):
        self.name = name
        self.message = message
        webbrowser.open(f"mailto:hahacoolguystaco@gmail.com?subject=FEEDBACK&body={self.message}%0D%0A%0D%0AFrom%20{self.name}")
