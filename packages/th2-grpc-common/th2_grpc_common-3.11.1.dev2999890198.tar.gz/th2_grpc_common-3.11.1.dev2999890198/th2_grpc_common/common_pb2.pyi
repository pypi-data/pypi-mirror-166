...
class ByteMessage(google.protobuf.message.Message):
    """The very first implementation of message containing CBOR and JSON body, will be changed in future"""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    PARENT_EVENT_ID_FIELD_NUMBER: builtins.int
    METADATA_FIELD_NUMBER: builtins.int
    BODY_FIELD_NUMBER: builtins.int
    ...
    def HasField(self, field_name: typing_extensions.Literal["metadata",b"metadata","parent_event_id",b"parent_event_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["body",b"body","metadata",b"metadata","parent_event_id",b"parent_event_id"]) -> None: ...
global___ByteMessage = ByteMessage

class AnyMessage(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    MESSAGE_FIELD_NUMBER: builtins.int
    RAW_MESSAGE_FIELD_NUMBER: builtins.int
    BYTE_MESSAGE_FIELD_NUMBER: builtins.int
    @property
    def message(self) -> global___Message: ...
    @property
    def raw_message(self) -> global___RawMessage: ...
    @property
    def byte_message(self) -> global___ByteMessage: ...
    def __init__(self,
        *,
        message: typing.Optional[global___Message] = ...,
        raw_message: typing.Optional[global___RawMessage] = ...,
        byte_message: typing.Optional[global___ByteMessage] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["byte_message",b"byte_message","kind",b"kind","message",b"message","raw_message",b"raw_message"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["byte_message",b"byte_message","kind",b"kind","message",b"message","raw_message",b"raw_message"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["kind",b"kind"]) -> typing.Optional[typing_extensions.Literal["message","raw_message","byte_message"]]: ...
...
class ByteMessageBatch(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    MESSAGES_FIELD_NUMBER: builtins.int
    @property
    def messages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ByteMessage]: ...
    def __init__(self,
        *,
        messages: typing.Optional[typing.Iterable[global___ByteMessage]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["messages",b"messages"]) -> None: ...
global___ByteMessageBatch = ByteMessageBatch
