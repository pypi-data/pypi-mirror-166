...
#Contains the bit to cells mapping and sigmap for each module
class Module():
    ...
    def create_map(self):    #populates the bit_to_cells in the module class        
        ...
        for cell in self.module.selected_cells():          #this means that it does it for one specific module - .selected_cells not working
