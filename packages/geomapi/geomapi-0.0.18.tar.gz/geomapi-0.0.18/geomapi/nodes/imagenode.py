...
#---------------------METHODS----------------------------
    ...
    def get_path(self) -> str:
        """Returns the full path of the resource from various inputs.\n
    ...
    def get_virtual_image(self, geometries: o3d.geometry, downsampling:int=2)-> o3d.cpu.pybind.geometry.Image:
        ...
        Args:
            geometries (o3d.geometry): _description_
            downsampling (int, optional): _description_. Defaults to 2.

        Returns:
            o3d.cpu.pybind.geometry.Image: _description_
        """
