...
enums = {
    "ICAROUS_TRACK_BAND_TYPES": {
        ICAROUS_TRACK_BAND_TYPE_NONE: EnumEntry(
            "ICAROUS_TRACK_BAND_TYPE_NONE",
            """""",
        ),
        ICAROUS_TRACK_BAND_TYPE_NEAR: EnumEntry(
            "ICAROUS_TRACK_BAND_TYPE_NEAR",
            """""",
        ),
        ICAROUS_TRACK_BAND_TYPE_RECOVERY: EnumEntry(
            "ICAROUS_TRACK_BAND_TYPE_RECOVERY",
            """""",
        ),
        ICAROUS_TRACK_BAND_TYPES_ENUM_END: EnumEntry(
            "ICAROUS_TRACK_BAND_TYPES_ENUM_END",
            """""",
        ),
    },
    "ICAROUS_FMS_STATE": {
        ICAROUS_FMS_STATE_IDLE: EnumEntry(
            "ICAROUS_FMS_STATE_IDLE",
            """""",
        ),
        ICAROUS_FMS_STATE_TAKEOFF: EnumEntry(
            "ICAROUS_FMS_STATE_TAKEOFF",
            """""",
        ),
        ICAROUS_FMS_STATE_CLIMB: EnumEntry(
            "ICAROUS_FMS_STATE_CLIMB",
            """""",
        ),
        ICAROUS_FMS_STATE_CRUISE: EnumEntry(
            "ICAROUS_FMS_STATE_CRUISE",
            """""",
        ),
        ICAROUS_FMS_STATE_APPROACH: EnumEntry(
            "ICAROUS_FMS_STATE_APPROACH",
            """""",
        ),
        ICAROUS_FMS_STATE_LAND: EnumEntry(
            "ICAROUS_FMS_STATE_LAND",
            """""",
        ),
        ICAROUS_FMS_STATE_ENUM_END: EnumEntry(
