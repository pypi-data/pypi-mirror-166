...
class Pipeline(Storage):
    ...
    def add(self, list_obj: List[Instrument | Dataset]):
        ...
        assert isinstance(list_obj, list), "the input must be a list containing Instrument or Dataset object(s)"
        ...
        for item in list_obj:
            if isinstance(item, Instrument):
                ...
                raise TypeError('input must be a list of Instrument or Dataset object(s)')