...
def build_multi_parameters(dic:dict) -> list:
    ...
    assert 'list_of_parameters' in dic.keys(), 'the key to contain the list should be list_of_parameters'
    assert isinstance(dic['list_of_parameters'], list), 'the value of list_of_parameters should be a list'
