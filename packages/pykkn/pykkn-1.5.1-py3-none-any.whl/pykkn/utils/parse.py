                    ...
                    for a in list(file[key][subgroup_name].keys()):
                        ...
                        for b in list(aa.keys()):
                            ...
                            for c in list(bb.keys()):
                                pipe_obj = create_instance(file[key][subgroup_name], f'{a}/{b}/{c}')
                                for sub_subgroup_name in list(file[key][subgroup_name][f'{a}/{b}/{c}']):
                                    pipe_obj.add(recursive_create_instance(file[key][subgroup_name][f'{a}/{b}/{c}'][sub_subgroup_name]))
                                obj.add([pipe_obj])
        results.append(obj)
