...
def remove_dist(hub, directory: str):
    ...
    This is in its own function in case one day someone adds the --distpath option to
...
def remove_build(hub, directory: str):
    """
    Clean the build dir
    This is in its own function in case one day someone adds the --workpath option to
    the pyinstaller call
    """
