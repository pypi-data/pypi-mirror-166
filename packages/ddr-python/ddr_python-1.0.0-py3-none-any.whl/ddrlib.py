...
def ddr_ddr_write_to_file(data: str, target_dir: str, filename: str, mode: str = "w"):
    """
...
def ddr_decode_btrace_log(device, access_type, show_template, pcount, par1, par2, par3, match_string, log_path, debug_flag=False):
    ...
    """
        ...
        Usage::
          ...
          ddr_decode_btrace_log(device, "cli", "show logging process {0} start last {1} minutes", 2, "dmiauthd", 20, "none", "%DMI-5-AUTH_PASSED:", "/bootflash/guest-share/Btrace_dmiauthd_log", debug_flag=False)
