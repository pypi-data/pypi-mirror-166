    ...
    for device in devices:
        ...
        if prepared_device["probeType"] == "siren":
            ...
            prepared_device["color"] = {
                "r": round(2.55 * prepared_device["level"]),
                "g": round(2.55 * prepared_device["level"]),
                "b": round(2.55 * prepared_device["level"]),
            }
            prepared_device["level"] = "on" if prepared_device["level"] else "off"
