...
telegram_channel_username = global_common.get_environment_variable("TELEGRAM_BOT_USERNAME")
telegram_channel_development_username = global_common.get_environment_variable("TELEGRAM_BOT_DEV_USERNAME")
