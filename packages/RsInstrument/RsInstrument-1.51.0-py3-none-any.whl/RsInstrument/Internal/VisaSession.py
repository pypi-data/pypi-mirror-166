...
class VisaSession(object):
	...
	def go_to_local(self) -> None:
		...
		if self.vxi_capable:
			self._session.gpib_control_ren(pyvisa.constants.RENLineOperation.deassert_gtl)
		else:
			self.write("&GTL")
	...
	def go_to_remote(self) -> None:
		...
		if self.vxi_capable:
			self._session.gpib_control_ren(pyvisa.constants.RENLineOperation.asrt_address)
		else:
			self.write("&GTR")
