    ...
    def writeFiQuS2yaml(self, output_path: str, append_str_to_magnet_name: str = ''):
        ...
        ** Writes FiQuS input files **
        ...
        for attribute, file_ext in zip(self.attributes, self.file_exts):
            dict_to_yaml(getattr(self.builder_FiQuS, attribute).dict(), os.path.join(output_path, f'{self.builder_FiQuS.data_FiQuS.general.magnet_name}{append_str_to_magnet_name}.{file_ext}'), list_exceptions=[])
