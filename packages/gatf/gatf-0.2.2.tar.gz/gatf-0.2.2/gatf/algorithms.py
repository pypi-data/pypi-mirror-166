...
class NSGA3:
    ...
    def __call__(self):
        ...
        if self.verbose: print('Generation 0 – HV {} – MDR {} – Ref dirs {}%     '.format(np.round(hv.numpy(),2),np.round(mdr.numpy(),2),np.round(100*refs.numpy())), end = '\r')
        ...
        for gen in range(1, self.generations+1):
            ...
            if gen % self.record_gens == 0: 
                ...
                if self.verbose: print('Generation {} – HV {} – MDR {} – Ref dirs {}%     '.format(gen,np.round(hv.numpy(),2),np.round(mdr.numpy(),2),np.round(100*refs.numpy())), end = '\r')
