...
# class DiffBotDrivingEnv(object):
    ...
    def __init__(self):
        ...
        env_plugin = 'my_environment' # default : plugins/my_environment.py
        plugin_import_prefix = 'haibot_rosgymbullet.resources.plugins'
        ...
        # plugins = [ {'module': 'haibot_rosgymbullet.resources.plugins.body_vel_control', 'class': 'cmdVelCtrl'},\
        ...
        plugins = [{'plugins': [{'module': 'haibot_rosgymbullet.resources.plugins.body_vel_control', 'class': 'cmdVelCtrl'},\
                    {'module': 'haibot_rosgymbullet.resources.plugins.odometry', 'class': 'simpleOdometry'},\
                    {'module': 'haibot_rosgymbullet.resources.plugins.control', 'class': 'Control'},\
                    {'module': 'haibot_rosgymbullet.resources.plugins.joint_state_pub', 'class': 'joinStatePub'},\
                    {'module': 'haibot_rosgymbullet.resources.plugins.laser_scanner', 'class': 'laserScanner'},\
...
#---------------------------------------------------------------------------------------
    def init_pybullet_robot(self):
        ...
        urdf_path = "/home/saun/ReinforcementLearning_Robot/src/differential_robot/urdf/diff_robot.urdf"
        if urdf_path == None:
        ...
        if 'xacro' in urdf_path:
            ...
            robot_description = "$(find xacro)/xacro $(arg urdf_path)"
