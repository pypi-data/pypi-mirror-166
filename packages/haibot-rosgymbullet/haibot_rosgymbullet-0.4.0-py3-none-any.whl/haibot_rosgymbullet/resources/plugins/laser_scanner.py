...
class laserScanner:
    def __init__(self, pybullet, robot, **kargs):
        ...
        self.pub_laser_scanner = rospy.Publisher('scan', LaserScan, queue_size=10)
        self.laser_msg.header.frame_id = laser_frame_id
        self.laser_freq = 25
        self.laser_msg.angle_increment = (math.pi / self.numRays)
        self.laser_msg.time_increment = ((1.0 / self.laser_freq) / self.numRays)
        self.laser_msg.scan_time = (1.0 / self.laser_freq) # 25 hz
