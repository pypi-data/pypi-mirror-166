...
class RasterConfigs():
	...
	@property
	def palette_nonlinearity(self) -> float: ...
...
class VectorAttributes():
	...
	def add_field(self, field: AttributeField) -> None: ...

	def contains_field(self, field: AttributeField) -> bool: ...

	def get_attribute_fields(self) -> List[AttributeField]: ...

	def get_attribute_record(self, index: int) -> List[FieldData]: ...

	def get_field_info(self, index: int) -> AttributeField: ...

	def get_field_num(self, name: str) -> int: ...

	def get_num_fields(self) -> int: ...

	def get_value(self, record_index: int, field_name: str) -> FieldData: ...

	def is_field_numeric(self, index: int) -> bool: ...

	def reinitialize(self) -> None: ...

	def set_value(self, record_index: int, field_name: str, field_data: FieldData) -> None: ...
...
class WbEnvironment():
	...
	def create_colour_composite(self, red: Raster, green: Raster, blue: Raster, opacity: Raster, enhance: bool = False, treat_zeros_as_nodata: bool = False) -> Raster: ...
