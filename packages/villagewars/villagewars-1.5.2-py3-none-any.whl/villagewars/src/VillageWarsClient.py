...
try:
    ...
    from villagewars.src.PodSixNet.Connection import ConnectionListener, connection

except:
    from villagewars.src import toolbox
    from villagewars.src import toolbox as t
    from villagewars.src import typer
    from villagewars.src import GameClient
    from villagewars.src import VillageWarsDownload
    from villagewars.src.PodSixNet.Connection import ConnectionListener, connection

path = os.path.abspath('.')
import villagewars
os.chdir(os.path.join(villagewars.__file__[:-11], 'src'))
