...
class Spectrumcomponent(object):
    ...
    def setNumberOfBands(self, numberOfBands: "int") -> "int":
        return _spectrum.Spectrumcomponent_setNumberOfBands(self, numberOfBands)

    def getScaleType(self) -> "OpenCMISS::Zinc::Spectrumcomponent::ScaleType":
        return _spectrum.Spectrumcomponent_getScaleType(self)

    def setScaleType(self, scaleType: "OpenCMISS::Zinc::Spectrumcomponent::ScaleType") -> "int":
        return _spectrum.Spectrumcomponent_setScaleType(self, scaleType)

    def getColourMappingType(self) -> "OpenCMISS::Zinc::Spectrumcomponent::ColourMappingType":
        return _spectrum.Spectrumcomponent_getColourMappingType(self)

    def setColourMappingType(self, colourMapping: "OpenCMISS::Zinc::Spectrumcomponent::ColourMappingType") -> "int":
...
class Spectrum(object):
    ...
    def getId(self) -> "cmzn_spectrum_id":
    ...
    def getNumberOfSpectrumcomponents(self) -> "int":
        return _spectrum.Spectrum_getNumberOfSpectrumcomponents(self)

    def createSpectrumcomponent(self) -> "OpenCMISS::Zinc::Spectrumcomponent":
        return _spectrum.Spectrum_createSpectrumcomponent(self)

    def getFirstSpectrumcomponent(self) -> "OpenCMISS::Zinc::Spectrumcomponent":
        return _spectrum.Spectrum_getFirstSpectrumcomponent(self)

    def getNextSpectrumcomponent(self, refComponent: "Spectrumcomponent") -> "OpenCMISS::Zinc::Spectrumcomponent":
        return _spectrum.Spectrum_getNextSpectrumcomponent(self, refComponent)

    def getPreviousSpectrumcomponent(self, refComponent: "Spectrumcomponent") -> "OpenCMISS::Zinc::Spectrumcomponent":
        return _spectrum.Spectrum_getPreviousSpectrumcomponent(self, refComponent)

    def moveSpectrumcomponentBefore(self, component: "Spectrumcomponent", refComponent: "Spectrumcomponent") -> "int":
        return _spectrum.Spectrum_moveSpectrumcomponentBefore(self, component, refComponent)

    def removeSpectrumcomponent(self, component: "Spectrumcomponent") -> "int":
        return _spectrum.Spectrum_removeSpectrumcomponent(self, component)

    def removeAllSpectrumcomponents(self) -> "int":
        return _spectrum.Spectrum_removeAllSpectrumcomponents(self)

    def isMaterialOverwrite(self) -> "bool":
        return _spectrum.Spectrum_isMaterialOverwrite(self)

    def setMaterialOverwrite(self, overwrite: "bool") -> "int":
        return _spectrum.Spectrum_setMaterialOverwrite(self, overwrite)

    def autorange(self, scene: "OpenCMISS::Zinc::Scene const &", scenefilter: "OpenCMISS::Zinc::Scenefilter const &") -> "int":
...
def __eq__(a: "Spectrum", b: "Spectrum") -> "bool":
...
class Spectrumiterator(object):
    ...
    def next(self) -> "OpenCMISS::Zinc::Spectrum":
...
class Spectrummodule(object):
    ...
    def getId(self) -> "cmzn_spectrummodule_id":
        return _spectrum.Spectrummodule_getId(self)

    def createSpectrum(self) -> "OpenCMISS::Zinc::Spectrum":
        return _spectrum.Spectrummodule_createSpectrum(self)

    def createSpectrumiterator(self) -> "OpenCMISS::Zinc::Spectrumiterator":
        return _spectrum.Spectrummodule_createSpectrumiterator(self)

    def findSpectrumByName(self, name: "char const *") -> "OpenCMISS::Zinc::Spectrum":
    ...
    def getDefaultSpectrum(self) -> "OpenCMISS::Zinc::Spectrum":
        return _spectrum.Spectrummodule_getDefaultSpectrum(self)

    def setDefaultSpectrum(self, spectrum: "Spectrum") -> "int":
    ...
    def createSpectrummodulenotifier(self) -> "OpenCMISS::Zinc::Spectrummodulenotifier":
...
class Spectrummoduleevent(object):
    ...
    def getId(self) -> "cmzn_spectrummoduleevent_id":
        return _spectrum.Spectrummoduleevent_getId(self)

    def getSpectrumChangeFlags(self, spectrum: "Spectrum") -> "OpenCMISS::Zinc::Spectrum::ChangeFlags":
        return _spectrum.Spectrummoduleevent_getSpectrumChangeFlags(self, spectrum)

    def getSummarySpectrumChangeFlags(self) -> "OpenCMISS::Zinc::Spectrum::ChangeFlags":
...
class Spectrummodulenotifier(object):
    ...
    def getId(self) -> "cmzn_spectrummodulenotifier_id":
