...
class Tessellation(object):
    ...
    def getId(self) -> "cmzn_tessellation_id":
    ...
    def getCircleDivisions(self) -> "int":
        return _tessellation.Tessellation_getCircleDivisions(self)

    def setCircleDivisions(self, circleDivisions: "int") -> "int":
...
def __eq__(a: "Tessellation", b: "Tessellation") -> "bool":
...
class Tessellationiterator(object):
    ...
    def next(self) -> "OpenCMISS::Zinc::Tessellation":
...
class Tessellationmodule(object):
    ...
    def getId(self) -> "cmzn_tessellationmodule_id":
        return _tessellation.Tessellationmodule_getId(self)

    def createTessellation(self) -> "OpenCMISS::Zinc::Tessellation":
        return _tessellation.Tessellationmodule_createTessellation(self)

    def createTessellationiterator(self) -> "OpenCMISS::Zinc::Tessellationiterator":
        return _tessellation.Tessellationmodule_createTessellationiterator(self)

    def findTessellationByName(self, name: "char const *") -> "OpenCMISS::Zinc::Tessellation":
    ...
    def getDefaultTessellation(self) -> "OpenCMISS::Zinc::Tessellation":
        return _tessellation.Tessellationmodule_getDefaultTessellation(self)

    def setDefaultTessellation(self, tessellation: "Tessellation") -> "int":
        return _tessellation.Tessellationmodule_setDefaultTessellation(self, tessellation)

    def getDefaultPointsTessellation(self) -> "OpenCMISS::Zinc::Tessellation":
        return _tessellation.Tessellationmodule_getDefaultPointsTessellation(self)

    def setDefaultPointsTessellation(self, tessellation: "Tessellation") -> "int":
    ...
    def createTessellationmodulenotifier(self) -> "OpenCMISS::Zinc::Tessellationmodulenotifier":
...
class Tessellationmoduleevent(object):
    ...
    def getId(self) -> "cmzn_tessellationmoduleevent_id":
        return _tessellation.Tessellationmoduleevent_getId(self)

    def getTessellationChangeFlags(self, tessellation: "Tessellation") -> "OpenCMISS::Zinc::Tessellation::ChangeFlags":
        return _tessellation.Tessellationmoduleevent_getTessellationChangeFlags(self, tessellation)

    def getSummaryTessellationChangeFlags(self) -> "OpenCMISS::Zinc::Tessellation::ChangeFlags":
...
class Tessellationmodulenotifier(object):
    ...
    def getId(self) -> "cmzn_tessellationmodulenotifier_id":
