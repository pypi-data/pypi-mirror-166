...
class Streaminformation(object):
    ...
    def getResourceDataCompressionType(self, resource: "Streamresource") -> "OpenCMISS::Zinc::Streaminformation::DataCompressionType":
    ...
    def getDataCompressionType(self) -> "OpenCMISS::Zinc::Streaminformation::DataCompressionType":
