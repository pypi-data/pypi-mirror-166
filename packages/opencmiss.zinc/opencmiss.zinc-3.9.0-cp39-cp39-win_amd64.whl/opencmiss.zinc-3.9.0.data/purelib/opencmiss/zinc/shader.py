...
class Shaderprogram(object):
    ...
    def getId(self) -> "cmzn_shaderprogram_id":
...
class Shaderuniforms(object):
    ...
    def getId(self) -> "cmzn_shaderuniforms_id":
...
class Shadermodule(object):
    ...
    def getId(self) -> "cmzn_shadermodule_id":
        return _shader.Shadermodule_getId(self)

    def createShaderprogram(self) -> "OpenCMISS::Zinc::Shaderprogram":
        return _shader.Shadermodule_createShaderprogram(self)

    def findShaderprogramByName(self, name: "char const *") -> "OpenCMISS::Zinc::Shaderprogram":
        return _shader.Shadermodule_findShaderprogramByName(self, name)

    def createShaderuniforms(self) -> "OpenCMISS::Zinc::Shaderuniforms":
        return _shader.Shadermodule_createShaderuniforms(self)

    def findShaderuniformsByName(self, name: "char const *") -> "OpenCMISS::Zinc::Shaderuniforms":
