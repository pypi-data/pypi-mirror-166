...
class StreaminformationImage(opencmiss.zinc.stream.Streaminformation):
    ...
    def setAttributeInteger(self, attribute: "OpenCMISS::Zinc::StreaminformationImage::Attribute", value: "int") -> "int":
        return _streamimage.StreaminformationImage_setAttributeInteger(self, attribute, value)

    def setAttributeReal(self, attribute: "OpenCMISS::Zinc::StreaminformationImage::Attribute", value: "double") -> "int":
        return _streamimage.StreaminformationImage_setAttributeReal(self, attribute, value)

    def setFileFormat(self, imageFileFormat: "OpenCMISS::Zinc::StreaminformationImage::FileFormat") -> "int":
        return _streamimage.StreaminformationImage_setFileFormat(self, imageFileFormat)

    def setPixelFormat(self, imagePixelFormat: "OpenCMISS::Zinc::StreaminformationImage::PixelFormat") -> "int":
