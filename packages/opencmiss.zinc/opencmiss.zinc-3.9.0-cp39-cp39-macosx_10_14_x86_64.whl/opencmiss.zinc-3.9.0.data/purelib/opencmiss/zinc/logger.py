...
def __eq__(a: "Logger", b: "Logger") -> "bool":
...
class Loggerevent(object):
    ...
    def getId(self) -> "cmzn_loggerevent_id":
        return _logger.Loggerevent_getId(self)

    def getChangeFlags(self) -> "OpenCMISS::Zinc::Logger::ChangeFlags":
        return _logger.Loggerevent_getChangeFlags(self)

    def getMessageType(self) -> "OpenCMISS::Zinc::Logger::MessageType":
        return _logger.Loggerevent_getMessageType(self)

    def getMessageText(self) -> "char *":
...
class Loggernotifier(object):
    ...
    def getId(self) -> "cmzn_loggernotifier_id":
