...
/* harmony import */ var _jupyterlab_rendermime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @jupyterlab/rendermime */ "webpack/sharing/consume/default/@jupyterlab/rendermime");
/* harmony import */ var _jupyterlab_rendermime__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_rendermime__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _scatterViewWidget__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scatterViewWidget */ "./lib/scatterViewWidget.js");
...
class ButtonExtension {
    createNew(widget, context) {
        function callback() {
            ...
            const keySolutionWidgetMap = new Map();
            widget.content.widgets.forEach((cell, index) => {
                var solutionViewModel = new _scatterViewWidget__WEBPACK_IMPORTED_MODULE_5__.ScatterViewModel(events);
                var solutionViewWidget = new _scatterViewWidget__WEBPACK_IMPORTED_MODULE_5__.ScatterViewWidget(solutionViewModel);
                keySolutionWidgetMap.set(cell.model.metadata.get('cellID'), solutionViewWidget);
                cell.layout.addWidget(solutionViewWidget);
            });
            const keyCellMap = new Map();
...
/* harmony import */ var _scatterViz__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scatterViz */ "./lib/scatterViz.js");
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_emotion_react_emotion_react-webpack_sharing_cons-092fe4.b0cdab75a5e147bda7b9.js.map