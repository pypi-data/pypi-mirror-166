...
def init():
    ...
    if tf_ver < version.parse('2.5'):
        raise ImportError("The minimum TF version that mttf supports is 2.5. Your TF is {}. "
                          "Please upgrade.".format(tf_ver))

    # add mobilenet_v3_split module
    from .keras_applications import mobilenet_v3_split, mobilevit
    setattr(tensorflow.keras.applications,
            'mobilenet_v3_split', mobilenet_v3_split)
    ...
    setattr(tensorflow.keras.applications, 'MobileNetV3Split',
    ...
    if tf_ver < version.parse('2.8'):
        ...
        setattr(tensorflow.keras.applications, 'EfficientNetV2B0',
                efficientnet_v2.EfficientNetV2B0)
        setattr(tensorflow.keras.applications, 'EfficientNetV2B1',
                efficientnet_v2.EfficientNetV2B1)
        setattr(tensorflow.keras.applications, 'EfficientNetV2B2',
                efficientnet_v2.EfficientNetV2B2)
        setattr(tensorflow.keras.applications, 'EfficientNetV2B3',
                efficientnet_v2.EfficientNetV2B3)
        setattr(tensorflow.keras.applications, 'EfficientNetV2S',
                efficientnet_v2.EfficientNetV2S)
        setattr(tensorflow.keras.applications, 'EfficientNetV2M',
                efficientnet_v2.EfficientNetV2M)
        setattr(tensorflow.keras.applications, 'EfficientNetV2L',
