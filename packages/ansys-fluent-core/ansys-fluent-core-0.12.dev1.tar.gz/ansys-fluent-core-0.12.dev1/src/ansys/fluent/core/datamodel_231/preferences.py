...
class Root(PyMenu):
    ...
    class General(PyMenu):
        ...
        def __init__(self, service, rules, path):
            ...
            self.CfdProTransient = self.__class__.CfdProTransient(service, rules, path + [("CfdProTransient", "")])
            ...
            self.EnablePythonConsole = self.__class__.EnablePythonConsole(service, rules, path + [("EnablePythonConsole", "")])
        ...
        class CfdProTransient(PyParameter):
            """
            Parameter CfdProTransient of value type bool.
            """
            pass
        ...
        class EnablePythonConsole(PyParameter):
            """
            Parameter EnablePythonConsole of value type bool.
            """
            pass
