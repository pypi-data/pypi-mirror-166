...
from .number_of_post_iterations_per_timestep import number_of_post_iterations_per_timestep
class dual_time_iterate(Command):
    ...
    ----------
        ...
        number_of_post_iterations_per_timestep : int
    ...
    argument_names = \
        ['number_of_total_periods', 'number_of_time_steps',
         ...
         'number_of_post_iterations_per_timestep']
    ...
    """
    number_of_post_iterations_per_timestep: number_of_post_iterations_per_timestep = number_of_post_iterations_per_timestep
    """
    number_of_post_iterations_per_timestep argument of dual_time_iterate.
    """
