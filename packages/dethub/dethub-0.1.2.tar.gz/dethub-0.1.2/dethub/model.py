...
class TorchVision(DetectionModel):
    ...
    def object_prediction_list(self, image):
        ...
        from dethub.data_utils import numpy_to_torch, read_yaml
...
class TensorflowHub(DetectionModel):
    ...
    def object_prediction_list(self, image):
        ...
        from dethub.data_utils import read_yaml, to_float_tensor
...
class YoloXHub(DetectionModel):
    ...
    def object_prediction_list(self, image):
        ...
        from dethub.yolox import COCO_CLASSES, postprocess, preproc
        from dethub.data_utils import numpy_to_torch, read_yaml
