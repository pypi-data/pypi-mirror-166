...
BioSAK get_MAG_reads_long -r LongReads.fq -s assembly.fasta.sam -m MAG_1.fa -o MAG_1_reads_dir -l 3000
BioSAK get_MAG_reads_long -r LongReads.fq -s assembly.fasta.sam -m MAG_dir -x fa -o extracted_reads_dir -l 0
BioSAK get_MAG_reads_long -r LongReads.fq -s assembly.fasta.sam -m MAG_dir -x fa -o extracted_reads_dir -l 10000
...
minimap2 -t 12 --secondary=no -a assembly.fasta.mmi long_reads.fastq > assembly.fasta.no.secondary.sam 
