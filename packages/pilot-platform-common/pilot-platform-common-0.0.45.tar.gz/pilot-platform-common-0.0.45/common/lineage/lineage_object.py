...
class LineageAttirbute:
    ...
    def __init__(
        ...
        self.name = name
        self.inputs = [{'typeName': input_type, 'uniqueAttributes': {'global_entity_id': input_id}}]
        self.outputs = [{'typeName': output_type, 'uniqueAttributes': {'global_entity_id': output_id}}]
