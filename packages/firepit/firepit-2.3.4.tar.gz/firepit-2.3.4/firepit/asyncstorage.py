...
from firepit.exceptions import InvalidAttr, InvalidObject, InvalidStixPath
...
from firepit.props import auto_agg_tuple, parse_prop
...
from firepit.sqlstorage import DB_VERSION, _transform, get_path_joins, _get_col_dict, _format_query, _make_aggs
...
class AsyncDBCache:
    ...
    async def _get_metadata(self):
        ...
        await self.columns('observed-data')  # Hacky
        await self.columns('identity')  # Hacky
