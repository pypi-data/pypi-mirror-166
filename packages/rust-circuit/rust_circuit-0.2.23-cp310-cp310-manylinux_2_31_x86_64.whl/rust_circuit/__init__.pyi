...
class TorchDeviceDtype(object):
    def __init__(self, device: Optional[torch.device], dtype: Optional[torch.dtype]) -> None: ...
    @property
...
def scheduled_evaluate(circuit: Circuit, verbose: int = 0, max_mem_elements: int = 9_000_000_000) -> torch.Tensor: ...
def optimize_and_evaluate(
    circuit: Circuit, verbose: int = 0, max_mem_elements: int = 9_000_000_000
) -> torch.Tensor: ...
def optimize_and_evaluate_many(
    circuits: List[Circuit], verbose: int = 0, max_mem_elements: int = 9_000_000_000
) -> List[torch.Tensor]: ...
