...
class BucketOperations(storage.Client):
    ...
    _download_type = ["dataframe", "json", "pickle"]
    ...
    def upload_from_memory(self,bucket_name, blob_name, contents):
    ...
    def download_to_memory(self,bucket_name, blob_name, download_type):
        ...
        if download_type not in BucketOperations._download_type:
        ...
        try:
            ...
            if download_type == 'dataframe':
                ...
                pickle_data = pickle.dumps(load_pickle, indent=4, sort_keys=True)
                return pickle_data
