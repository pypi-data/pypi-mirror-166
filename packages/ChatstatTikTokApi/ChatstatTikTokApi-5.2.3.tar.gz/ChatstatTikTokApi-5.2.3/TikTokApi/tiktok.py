        ...
        if kwargs.get("force_verify_fp_on_cookie_header", False):
            return {
                ...
                "ttwid": kwargs.get("ttwid"),
                 "msToken":"pFO16qpcE-RCM52pbNJnsWed1LV-Wo_hRjhnH2JcjgnaMy9hY0nceuIkCX-QcaW6QdtNXoV-XKhmkEQSC3_WMOabOCm9gC6iR-mL2rvmbMWVEoMJ-I4J8Y3SFbUfR0ppup2OBYpi9BPFw8w=",
            }
        else:
            return {
                "tt_webid": device_id,
