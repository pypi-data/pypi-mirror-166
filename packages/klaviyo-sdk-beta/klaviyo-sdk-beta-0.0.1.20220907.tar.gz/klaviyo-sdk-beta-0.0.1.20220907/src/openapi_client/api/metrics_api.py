...
class MetricsApi(object):
    ...
    def get_metric(
        ...
        **kwargs
        ...
        Get a specific Metric by id<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady: `150/m`  # noqa: E501
    ...
    def get_metrics(
        ...
        **kwargs
        ...
        Returns a list of all Metric objects in an account, that can optionally be filtered by integration name and/or category.<br><br>*Rate limits*:<br>Burst: `10/s`<br>Steady: `150/m`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
