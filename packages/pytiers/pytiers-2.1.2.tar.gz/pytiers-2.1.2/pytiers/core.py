...
class Tier(object):
    ...
    def to_plot(self, start_time=None, end_time=None):
        """Plot the points of the Tier between two time points. If the time points are not specified, start time and end time are used. To change related parameters, use parameters."""
    ...
    #     """Return the mean of the values of the points of the Tier from between two time points. If the time points are not specified, start time and end time are used."""
    #     if start_time==None:
    #         start_time=self.start_time
    ...
    #     values = [value for value in self.__points]
