...
def read_video(video_path: str, resize: Optional[Union[Tuple, int]] = None, out_path: str = None):
    ...
    if out_path is not None:
        ...
        if resize is not None:
            width, height = resize
        out = cv2.VideoWriter(out_path, cv2.VideoWriter_fourcc(*'mp4v'), fps, (width, height), True)
