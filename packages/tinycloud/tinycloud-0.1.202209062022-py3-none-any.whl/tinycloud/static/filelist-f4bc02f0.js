...
class tc_newshare extends s {
  ...
  render() {
    return y`<div id="newshare">${msg("Create share")}<br><input id="write" type="checkbox">${msg("Write access")}<button @click="${this.createShare}">${msg("Create")}</button><button @click="${this.remove}">${msg("Cancel")}</button></div>`;
  }
