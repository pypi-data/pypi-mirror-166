...
def _get_liveAnimal_lookup_values(product: dict, country_id: str, year: int = None):
...
def _run_by_liveAnimal(product: dict, country_id: str, year: int = None):
    term_id = product.get('term', {}).get('@id')
    animal_product, price, carcass_weight = _get_liveAnimal_lookup_values(product, country_id, year)
