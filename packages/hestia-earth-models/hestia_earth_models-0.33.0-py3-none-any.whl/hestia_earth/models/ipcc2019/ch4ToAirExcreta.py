...
from hestia_earth.models.utils.input import excreta_vs_value
from . import MODEL
...
def _should_run(cycle: dict):
    ...
    excreta_b0_product = list_sum([excreta_vs_value(i) * _get_excreta_b0(country, i) for i in excreta])

    ch4_conv_factor = _get_ch4_conv_factor(cycle)

    logRequirements(cycle, model=MODEL, term=TERM_ID,
                    excreta_b0_product=excreta_b0_product,
