...
def get_nh3_factor(termType: str, practices: list, lookup_col: str):
    ...
    value = get_table_value(download_lookup(lookup_name), 'termid', practice_id, column_name(lookup_col))
...
def _should_run(cycle: dict):
    ...
    NH3_N_EF = get_nh3_factor(termType, cycle.get('practices', []), primary_product_id) if primary_product_id else None
