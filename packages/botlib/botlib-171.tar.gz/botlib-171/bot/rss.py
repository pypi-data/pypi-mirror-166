...
from .utl import elapsed, fntime, spl
...
class Fetcher(Object):
    ...
    def run(self):
        "run a fetch on all registered feeds."
        thrs = []
...
def unescape(text):
    "unescape escape characters in text."
    txt = re.sub(r"\s+", " ", text)
