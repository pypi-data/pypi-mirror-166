...
from bot.jsn import dumps, load, loads, save
from bot.hdl import Handler
from bot.obj import Object, get, items, keys, otype, printable
from bot.obj import register, edit, update, values
from bot.utl import cdir
from bot.wdr import Wd, getpath
...
class TestObject(unittest.TestCase):
    ...
    def test_otype(self):
        obj = Object()
        self.assertEqual(otype(obj), "bot.obj.Object")
