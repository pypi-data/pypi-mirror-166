...
class MextractorVideoMetadata(_BaseMextractorMetadata):
    ...
    @classmethod
    def extract(cls, *args, **kwargs) -> "MextractorVideoMetadata":
        return extract_video(*args, **kwargs)
...
def extract_video(
    ...
    cv2_video_capture_api_preference: int = -1,
    ...
    cap = cv2.VideoCapture(str(path_to_video), cv2_video_capture_api_preference)
