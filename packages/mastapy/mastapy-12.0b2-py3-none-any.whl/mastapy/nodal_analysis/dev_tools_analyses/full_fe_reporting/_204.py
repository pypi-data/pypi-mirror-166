...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1222
...
class ElementPropertiesBeam(_211.ElementPropertiesWithMaterial):
    ...
    @property
    def section_type(self) -> '_1222.BeamSectionType':
        ...
        return constructor.new_from_mastapy_type(_1222.BeamSectionType)(value) if value is not None else None
