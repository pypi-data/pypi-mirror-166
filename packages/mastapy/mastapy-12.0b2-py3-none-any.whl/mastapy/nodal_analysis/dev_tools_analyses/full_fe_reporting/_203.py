...
from mastapy.fe_tools.enums import _1229
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_1229.ElementPropertyClass':
        ...
        return constructor.new_from_mastapy_type(_1229.ElementPropertyClass)(value) if value is not None else None
