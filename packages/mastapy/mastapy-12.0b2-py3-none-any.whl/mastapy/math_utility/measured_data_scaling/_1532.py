...
from mastapy.math_utility.measured_data_scaling import _1533
...
TMeasurement = TypeVar('TMeasurement', bound='_1567.MeasurementBase')


class DataScalingReferenceValues(_1533.DataScalingReferenceValuesBase, Generic[TMeasurement]):
    """DataScalingReferenceValues
