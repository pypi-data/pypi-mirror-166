...
from mastapy.math_utility import _1466, _1451
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.math_utility.measured_data_scaling import _1532
from mastapy.utility.units_and_measurements.measurements import (
    _1574, _1579, _1583, _1598,
    _1604, _1656, _1655, _1661,
    _1577, _1694, _1687, _1632
)
...
class DataScalingOptions(_0.APIBase):
    ...
    @property
    def weighting(self) -> '_1451.AcousticWeighting':
        ...
        return constructor.new_from_mastapy_type(_1451.AcousticWeighting)(value) if value is not None else None

    @weighting.setter
    def weighting(self, value: '_1451.AcousticWeighting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Weighting = value

    @property
    def acceleration_reference_values(self) -> '_1532.DataScalingReferenceValues[_1574.Acceleration]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1574.Acceleration](temp) if temp is not None else None

    @property
    def angular_acceleration_reference_values(self) -> '_1532.DataScalingReferenceValues[_1579.AngularAcceleration]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1579.AngularAcceleration](temp) if temp is not None else None

    @property
    def angular_velocity_reference_values(self) -> '_1532.DataScalingReferenceValues[_1583.AngularVelocity]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1583.AngularVelocity](temp) if temp is not None else None

    @property
    def energy_reference_values(self) -> '_1532.DataScalingReferenceValues[_1598.Energy]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1598.Energy](temp) if temp is not None else None

    @property
    def force_reference_values(self) -> '_1532.DataScalingReferenceValues[_1604.Force]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1604.Force](temp) if temp is not None else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_1532.DataScalingReferenceValues[_1656.PowerSmallPerArea]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1656.PowerSmallPerArea](temp) if temp is not None else None

    @property
    def power_small_reference_values(self) -> '_1532.DataScalingReferenceValues[_1655.PowerSmall]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1655.PowerSmall](temp) if temp is not None else None

    @property
    def pressure_reference_values(self) -> '_1532.DataScalingReferenceValues[_1661.Pressure]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1661.Pressure](temp) if temp is not None else None

    @property
    def small_angle_reference_values(self) -> '_1532.DataScalingReferenceValues[_1577.AngleSmall]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1577.AngleSmall](temp) if temp is not None else None

    @property
    def small_velocity_reference_values(self) -> '_1532.DataScalingReferenceValues[_1694.VelocitySmall]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1694.VelocitySmall](temp) if temp is not None else None

    @property
    def torque_reference_values(self) -> '_1532.DataScalingReferenceValues[_1687.Torque]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1687.Torque](temp) if temp is not None else None

    @property
    def very_short_length_reference_values(self) -> '_1532.DataScalingReferenceValues[_1632.LengthVeryShort]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1632.LengthVeryShort](temp) if temp is not None else None
