...
from mastapy.math_utility.optimisation import _1516, _1514
...
class ParetoOptimistaionVariable(_1514.ParetoOptimisationVariableBase):
    """ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1516.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new_from_mastapy_type(_1516.PropertyTargetForDominantCandidateSearch)(value) if value is not None else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1516.PropertyTargetForDominantCandidateSearch'):
