...
class ThreeDChartDefinition(_1814.NDChartDefinition):
    """ThreeDChartDefinition
    ...
    @property
    def z_axis(self) -> '_1705.AxisSettings':
    ...
    @property
    def x_axis_range(self) -> '_1450.Range':
    ...
    @x_axis_range.setter
    def x_axis_range(self, value: '_1450.Range'):
        value = value.wrapped if value else None
        self.wrapped.XAxisRange = value

    @property
    def y_axis_range(self) -> '_1450.Range':
    ...
    @y_axis_range.setter
    def y_axis_range(self, value: '_1450.Range'):
        value = value.wrapped if value else None
        self.wrapped.YAxisRange = value

    @property
    def z_axis_range(self) -> '_1450.Range':
    ...
    @z_axis_range.setter
    def z_axis_range(self, value: '_1450.Range'):
        value = value.wrapped if value else None
        self.wrapped.ZAxisRange = value

    def data_points_for_surfaces(self) -> 'List[_1816.PointsForSurface]':
