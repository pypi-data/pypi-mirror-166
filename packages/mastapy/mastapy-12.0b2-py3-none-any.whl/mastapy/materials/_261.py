...
class LubricationDetail(_1789.NamedDatabaseItem):
    """LubricationDetail
    ...
    @property
    def density_vs_temperature(self) -> '_1495.Vector2DListAccessor':
    ...
    def density_vs_temperature(self, value: '_1495.Vector2DListAccessor'):
