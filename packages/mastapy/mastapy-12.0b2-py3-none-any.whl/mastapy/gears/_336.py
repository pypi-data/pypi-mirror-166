...
class PocketingPowerLossCoefficients(_1789.NamedDatabaseItem):
    """PocketingPowerLossCoefficients
    ...
    @property
    def raw_pocketing_power_loss_lookup_table(self) -> '_1527.GriddedSurfaceAccessor':
    ...
    def raw_pocketing_power_loss_lookup_table(self, value: '_1527.GriddedSurfaceAccessor'):
