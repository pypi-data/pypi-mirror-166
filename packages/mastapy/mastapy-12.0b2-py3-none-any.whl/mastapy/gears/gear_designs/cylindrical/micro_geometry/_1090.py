...
class CylindricalGearMeshMicroGeometry(_1213.GearMeshImplementationDetail):
    """CylindricalGearMeshMicroGeometry
    ...
    @property
    def left_flank_lead_modification_chart(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def left_flank_profile_modification_chart(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def right_flank_lead_modification_chart(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def right_flank_profile_modification_chart(self) -> '_1820.TwoDChartDefinition':
