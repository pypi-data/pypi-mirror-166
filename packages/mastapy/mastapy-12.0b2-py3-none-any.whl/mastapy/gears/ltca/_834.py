...
class GearMeshLoadDistributionAnalysis(_1211.GearMeshImplementationAnalysis):
    """GearMeshLoadDistributionAnalysis
    ...
    @property
    def moment_about_centre_fourier_series(self) -> '_1473.FourierSeries':
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1473.FourierSeries':
