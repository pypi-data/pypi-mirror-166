...
from mastapy.electric_machines import _1285, _1232
...
class ToothAndSlot(_1232.AbstractToothAndSlot):
    """ToothAndSlot
    ...
    @property
    def tooth_slot_style(self) -> '_1285.ToothSlotStyle':
        ...
        return constructor.new_from_mastapy_type(_1285.ToothSlotStyle)(value) if value is not None else None

    @tooth_slot_style.setter
    def tooth_slot_style(self, value: '_1285.ToothSlotStyle'):
