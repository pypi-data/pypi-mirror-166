...
from mastapy.electric_machines import (
    _1244, _1252, _1276, _1288,
    _1292, _1238, _1270, _1277
)
...
class Windings(_0.APIBase):
    ...
    @property
    def double_layer_winding_slot_positions(self) -> '_1244.DoubleLayerWindingSlotPositions':
        ...
        return constructor.new_from_mastapy_type(_1244.DoubleLayerWindingSlotPositions)(value) if value is not None else None

    @double_layer_winding_slot_positions.setter
    def double_layer_winding_slot_positions(self, value: '_1244.DoubleLayerWindingSlotPositions'):
    ...
    @property
    def end_winding_inductance_method(self) -> '_1326.EndWindingInductanceMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1326.EndWindingInductanceMethod)(value) if value is not None else None

    @end_winding_inductance_method.setter
    def end_winding_inductance_method(self, value: '_1326.EndWindingInductanceMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fill_factor_specification_method(self) -> '_1252.FillFactorSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1252.FillFactorSpecificationMethod)(value) if value is not None else None

    @fill_factor_specification_method.setter
    def fill_factor_specification_method(self, value: '_1252.FillFactorSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def mmf(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def single_double_layer_windings(self) -> '_1276.SingleOrDoubleLayerWindings':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1276.SingleOrDoubleLayerWindings)(value) if value is not None else None

    @single_double_layer_windings.setter
    def single_double_layer_windings(self, value: '_1276.SingleOrDoubleLayerWindings'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def winding_connection(self) -> '_1288.WindingConnection':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1288.WindingConnection)(value) if value is not None else None

    @winding_connection.setter
    def winding_connection(self, value: '_1288.WindingConnection'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def wire_size_specification_method(self) -> '_1292.WireSizeSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1292.WireSizeSpecificationMethod)(value) if value is not None else None

    @wire_size_specification_method.setter
    def wire_size_specification_method(self, value: '_1292.WireSizeSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.WireSizeSpecificationMethod = value

    @property
    def mmf_fourier_series_electrical(self) -> '_1473.FourierSeries':
    ...
    @property
    def mmf_fourier_series_mechanical(self) -> '_1473.FourierSeries':
    ...
    @property
    def coils(self) -> 'List[_1238.Coil]':
    ...
    @property
    def phases(self) -> 'List[_1270.Phase]':
    ...
    @property
    def slot_section_details(self) -> 'List[_1277.SlotSectionDetail]':
