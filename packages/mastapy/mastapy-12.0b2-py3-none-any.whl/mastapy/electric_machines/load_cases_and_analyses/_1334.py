...
class SingleOperatingPointAnalysis(_1318.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    @property
    def electric_machine_results(self) -> '_1298.ElectricMachineResultsForOpenCircuitAndOnLoad':
    ...
    @property
    def load_case(self) -> '_1323.ElectricMachineLoadCase':
    ...
    @property
    def slot_section_details_for_analysis(self) -> 'List[_1335.SlotDetailForAnalysis]':
