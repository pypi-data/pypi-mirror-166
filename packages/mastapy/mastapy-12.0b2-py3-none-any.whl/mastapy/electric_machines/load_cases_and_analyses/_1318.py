...
class ElectricMachineAnalysis(_0.APIBase):
    ...
    @property
    def electric_machine_detail(self) -> '_1247.ElectricMachineDetail':
    ...
    @property
    def electric_machine_detail_of_type_cad_electric_machine_detail(self) -> '_1233.CADElectricMachineDetail':
    ...
    @property
    def electric_machine_detail_of_type_interior_permanent_magnet_machine(self) -> '_1257.InteriorPermanentMagnetMachine':
    ...
    @property
    def electric_machine_detail_of_type_non_cad_electric_machine_detail(self) -> '_1265.NonCADElectricMachineDetail':
    ...
    @property
    def electric_machine_detail_of_type_permanent_magnet_assisted_synchronous_reluctance_machine(self) -> '_1268.PermanentMagnetAssistedSynchronousReluctanceMachine':
    ...
    @property
    def electric_machine_detail_of_type_surface_permanent_magnet_machine(self) -> '_1281.SurfacePermanentMagnetMachine':
    ...
    @property
    def electric_machine_detail_of_type_synchronous_reluctance_machine(self) -> '_1283.SynchronousReluctanceMachine':
    ...
    @property
    def load_case(self) -> '_1324.ElectricMachineLoadCaseBase':
        ...
        if _1324.ElectricMachineLoadCaseBase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_dynamic_force_load_case(self) -> '_1315.DynamicForceLoadCase':
        ...
        if _1315.DynamicForceLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_efficiency_map_load_case(self) -> '_1317.EfficiencyMapLoadCase':
        ...
        if _1317.EfficiencyMapLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_electric_machine_load_case(self) -> '_1323.ElectricMachineLoadCase':
        ...
        if _1323.ElectricMachineLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_non_linear_dq_model_multiple_operating_points_load_case(self) -> '_1331.NonLinearDQModelMultipleOperatingPointsLoadCase':
        ...
        if _1331.NonLinearDQModelMultipleOperatingPointsLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_speed_torque_curve_load_case(self) -> '_1339.SpeedTorqueCurveLoadCase':
        ...
        if _1339.SpeedTorqueCurveLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def load_case_of_type_speed_torque_load_case(self) -> '_1340.SpeedTorqueLoadCase':
        ...
        if _1340.SpeedTorqueLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def setup(self) -> '_1250.ElectricMachineSetup':
    ...
    def perform_analysis_with_progress(self, token: '_7476.TaskProgress'):
