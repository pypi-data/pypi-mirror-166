...
from mastapy.electric_machines.load_cases_and_analyses import _1321, _1316, _1331
...
class EfficiencyMapLoadCase(_1331.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """EfficiencyMapLoadCase
    ...
    @property
    def efficiency_map_settings(self) -> '_1321.ElectricMachineEfficiencyMapSettings':
    ...
    def analysis_for(self, setup: '_1250.ElectricMachineSetup') -> '_1316.EfficiencyMapAnalysis':
