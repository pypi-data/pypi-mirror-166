...
from mastapy.electric_machines.load_cases_and_analyses import _1317, _1318
...
class EfficiencyMapAnalysis(_1318.ElectricMachineAnalysis):
    """EfficiencyMapAnalysis
    ...
    @property
    def efficiency_map_results(self) -> '_1294.EfficiencyResults':
    ...
    @property
    def load_case(self) -> '_1317.EfficiencyMapLoadCase':
