...
from mastapy.electric_machines.load_cases_and_analyses import _1339, _1318
from mastapy.electric_machines.results import _1309
...
class SpeedTorqueCurveAnalysis(_1318.ElectricMachineAnalysis):
    """SpeedTorqueCurveAnalysis
    ...
    @property
    def load_case(self) -> '_1339.SpeedTorqueCurveLoadCase':
    ...
    @property
    def results_points(self) -> 'List[_1309.MaximumTorqueResultsPoints]':
