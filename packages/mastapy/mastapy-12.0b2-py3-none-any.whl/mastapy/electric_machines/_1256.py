...
class InteriorPermanentMagnetAndSynchronousReluctanceRotor(_1269.PermanentMagnetRotor):
    """InteriorPermanentMagnetAndSynchronousReluctanceRotor
    ...
    @property
    def flux_barrier_style(self) -> '_1254.FluxBarrierStyle':
        ...
        return constructor.new_from_mastapy_type(_1254.FluxBarrierStyle)(value) if value is not None else None

    @flux_barrier_style.setter
    def flux_barrier_style(self, value: '_1254.FluxBarrierStyle'):
    ...
    @property
    def rotor_type(self) -> '_1275.RotorType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1275.RotorType)(value) if value is not None else None

    @rotor_type.setter
    def rotor_type(self, value: '_1275.RotorType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RotorType = value

    @property
    def cooling_duct_layers(self) -> 'List[_1240.CoolingDuctLayerSpecification]':
    ...
    @property
    def notch_specifications(self) -> 'List[_1267.NotchSpecification]':
    ...
    @property
    def u_shape_layers(self) -> 'List[_1286.UShapedLayerSpecification]':
    ...
    @property
    def v_shape_magnet_layers(self) -> 'List[_1287.VShapedMagnetLayerSpecification]':
