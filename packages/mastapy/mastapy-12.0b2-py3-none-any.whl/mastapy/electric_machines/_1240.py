...
class CoolingDuctLayerSpecification(_0.APIBase):
    ...
    @property
    def shape(self) -> '_1241.CoolingDuctShape':
        ...
        return constructor.new_from_mastapy_type(_1241.CoolingDuctShape)(value) if value is not None else None

    @shape.setter
    def shape(self, value: '_1241.CoolingDuctShape'):
