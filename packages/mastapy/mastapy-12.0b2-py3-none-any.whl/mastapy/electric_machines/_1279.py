...
from mastapy.electric_machines import _1258, _1243
...
class StatorRotorMaterial(_263.Material):
    ...
    @property
    def coefficient_specification_method(self) -> '_1258.IronLossCoefficientSpecificationMethod':
        ...
        return constructor.new_from_mastapy_type(_1258.IronLossCoefficientSpecificationMethod)(value) if value is not None else None

    @coefficient_specification_method.setter
    def coefficient_specification_method(self, value: '_1258.IronLossCoefficientSpecificationMethod'):
    ...
    @property
    def core_loss_coefficients(self) -> '_1243.CoreLossCoefficients':
    ...
    def try_update_coefficients_from_loss_curve_data(self) -> '_1553.MethodOutcome':
