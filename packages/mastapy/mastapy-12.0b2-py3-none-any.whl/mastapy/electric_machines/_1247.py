...
from mastapy.electric_machines import (
    _1242, _1251, _1250, _1272,
    _1235, _1256, _1269, _1282,
    _1231, _1236, _1278
)
...
class ElectricMachineDetail(_0.APIBase):
    ...
    @property
    def core_loss_build_factor_specification_method(self) -> '_1242.CoreLossBuildFactorSpecificationMethod':
        ...
        return constructor.new_from_mastapy_type(_1242.CoreLossBuildFactorSpecificationMethod)(value) if value is not None else None

    @core_loss_build_factor_specification_method.setter
    def core_loss_build_factor_specification_method(self, value: '_1242.CoreLossBuildFactorSpecificationMethod'):
    ...
    @property
    def electric_machine_type(self) -> '_1251.ElectricMachineType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1251.ElectricMachineType)(value) if value is not None else None
    ...
    @property
    def non_linear_dq_model(self) -> '_1310.NonLinearDQModel':
    ...
    @property
    def non_linear_dq_model_generator_settings(self) -> '_1311.NonLinearDQModelSettings':
    ...
    def rotor(self) -> '_1272.Rotor':
        ...
        if _1272.Rotor.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def rotor_of_type_cad_rotor(self) -> '_1235.CADRotor':
        ...
        if _1235.CADRotor.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def rotor_of_type_interior_permanent_magnet_and_synchronous_reluctance_rotor(self) -> '_1256.InteriorPermanentMagnetAndSynchronousReluctanceRotor':
        ...
        if _1256.InteriorPermanentMagnetAndSynchronousReluctanceRotor.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def rotor_of_type_permanent_magnet_rotor(self) -> '_1269.PermanentMagnetRotor':
        ...
        if _1269.PermanentMagnetRotor.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def rotor_of_type_surface_permanent_magnet_rotor(self) -> '_1282.SurfacePermanentMagnetRotor':
        ...
        if _1282.SurfacePermanentMagnetRotor.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def selected_setup(self) -> '_1250.ElectricMachineSetup':
    ...
    @property
    def stator(self) -> '_1231.AbstractStator':
        ...
        if _1231.AbstractStator.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def stator_of_type_cad_stator(self) -> '_1236.CADStator':
        ...
        if _1236.CADStator.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def stator_of_type_stator(self) -> '_1278.Stator':
        ...
        if _1278.Stator.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def results_locations(self) -> 'List[_1482.Named2DLocation]':
    ...
    @property
    def setups(self) -> 'List[_1250.ElectricMachineSetup]':
    ...
    def add_setup(self) -> '_1250.ElectricMachineSetup':
    ...
    def duplicate_setup(self, setup: '_1250.ElectricMachineSetup') -> '_1250.ElectricMachineSetup':
    ...
    def generate_design_without_non_linear_dq_model(self) -> '_1554.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    def remove_setup(self, setup: '_1250.ElectricMachineSetup'):
    ...
    def setup_named(self, name: 'str') -> '_1250.ElectricMachineSetup':
    ...
    def try_generate_non_linear_dq_model(self) -> '_1554.MethodOutcomeWithResult[ElectricMachineDetail]':
    ...
    def try_generate_non_linear_dq_model_with_task_progress(self, progress: '_7476.TaskProgress') -> '_1554.MethodOutcomeWithResult[ElectricMachineDetail]':
