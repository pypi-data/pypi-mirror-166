...
from mastapy.electric_machines import _1259, _1261, _1273
...
class UShapedLayerSpecification(_1273.RotorInternalLayerSpecification):
    """UShapedLayerSpecification
    ...
    @property
    def magnet_configuration(self) -> '_1259.MagnetConfiguration':
        ...
        return constructor.new_from_mastapy_type(_1259.MagnetConfiguration)(value) if value is not None else None

    @magnet_configuration.setter
    def magnet_configuration(self, value: '_1259.MagnetConfiguration'):
    ...
    @property
    def outer_magnets(self) -> '_1261.MagnetForLayer':
