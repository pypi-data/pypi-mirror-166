...
from mastapy.detailed_rigid_connectors.splines.ratings import _1394
...
class SplineJointRating(_1399.ShaftHubConnectionRating):
    """SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1394.SplineHalfRating]':
