...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1385
...
class SAESplineHalfDesign(_1382.StandardSplineHalfDesign):
    """SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1385.SAESplineTolerances':
