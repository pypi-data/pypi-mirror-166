...
from mastapy.detailed_rigid_connectors.splines import _1374, _1365, _1382
...
class DIN5480SplineHalfDesign(_1382.StandardSplineHalfDesign):
    """DIN5480SplineHalfDesign
    ...
    @property
    def finishing_method(self) -> '_1374.FinishingMethods':
        ...
        return constructor.new_from_mastapy_type(_1374.FinishingMethods)(value) if value is not None else None

    @finishing_method.setter
    def finishing_method(self, value: '_1374.FinishingMethods'):
    ...
    @property
    def manufacturing_type(self) -> '_1365.ManufacturingTypes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1365.ManufacturingTypes)(value) if value is not None else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1365.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
