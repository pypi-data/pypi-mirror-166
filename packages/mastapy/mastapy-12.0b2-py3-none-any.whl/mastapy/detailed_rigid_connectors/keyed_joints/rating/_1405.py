...
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1404
...
class KeywayRating(_1412.InterferenceFitRating):
    """KeywayRating
    ...
    @property
    def keyed_joint_design(self) -> '_1400.KeyedJointDesign':
    ...
    @property
    def keyway_half_ratings(self) -> 'List[_1404.KeywayHalfRating]':
