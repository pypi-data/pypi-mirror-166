...
from mastapy.detailed_rigid_connectors.interference_fits import _1410
from mastapy.bearings.tolerances import _1876, _1861, _1867
...
class InterferenceFitHalfDesign(_1351.DetailedRigidConnectorHalfDesign):
    """InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1410.StressRegions':
        ...
        return constructor.new_from_mastapy_type(_1410.StressRegions)(value) if value is not None else None
    ...
    @property
    def tolerance(self) -> '_1876.SupportTolerance':
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1861.InnerSupportTolerance':
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1867.OuterSupportTolerance':
