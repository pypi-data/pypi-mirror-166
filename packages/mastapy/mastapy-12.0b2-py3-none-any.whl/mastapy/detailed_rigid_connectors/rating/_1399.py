...
from mastapy.detailed_rigid_connectors.splines import (
    _1353, _1356, _1360, _1363,
    _1364, _1371, _1378, _1383
)
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    @property
    def joint_design(self) -> '_1350.DetailedRigidConnectorDesign':
        ...
        if _1350.DetailedRigidConnectorDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_custom_spline_joint_design(self) -> '_1353.CustomSplineJointDesign':
    ...
    @property
    def joint_design_of_type_din5480_spline_joint_design(self) -> '_1356.DIN5480SplineJointDesign':
    ...
    @property
    def joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1360.GBT3478SplineJointDesign':
    ...
    @property
    def joint_design_of_type_iso4156_spline_joint_design(self) -> '_1363.ISO4156SplineJointDesign':
    ...
    @property
    def joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1364.JISB1603SplineJointDesign':
    ...
    @property
    def joint_design_of_type_sae_spline_joint_design(self) -> '_1371.SAESplineJointDesign':
    ...
    @property
    def joint_design_of_type_spline_joint_design(self) -> '_1378.SplineJointDesign':
    ...
    @property
    def joint_design_of_type_standard_spline_joint_design(self) -> '_1383.StandardSplineJointDesign':
    ...
    @property
    def joint_design_of_type_keyed_joint_design(self) -> '_1400.KeyedJointDesign':
        ...
        if _1400.KeyedJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_interference_fit_design(self) -> '_1408.InterferenceFitDesign':
