...
from mastapy.bearings.bearing_results.rolling import _1961, _1952
...
class LoadedDeepGrooveBallBearingRow(_1952.LoadedBallBearingRow):
    """LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1961.LoadedDeepGrooveBallBearingResults':
