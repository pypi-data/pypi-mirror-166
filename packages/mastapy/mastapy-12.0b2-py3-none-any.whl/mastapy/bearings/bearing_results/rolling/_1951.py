...
from mastapy.bearings.bearing_results.rolling import _1925, _2024, _1982
...
class LoadedBallBearingResults(_1982.LoadedRollingBearingResults):
    """LoadedBallBearingResults
    ...
    @property
    def friction_model_for_gyroscopic_moment(self) -> '_1925.FrictionModelForGyroscopicMoment':
        ...
        return constructor.new_from_mastapy_type(_1925.FrictionModelForGyroscopicMoment)(value) if value is not None else None
    ...
    @property
    def track_truncation(self) -> '_2024.TrackTruncationSafetyFactorResults':
