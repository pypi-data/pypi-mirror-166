...
from mastapy.bearings.bearing_results.rolling import _1997, _1974
...
class LoadedTaperRollerBearingRow(_1974.LoadedNonBarrelRollerBearingRow):
    """LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1997.LoadedTaperRollerBearingResults':
