...
from mastapy.bearings.bearing_results.rolling.skf_module import _2026, _2045
...
class AdjustedSpeed(_2045.SKFCalculationResult):
    """AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_2026.AdjustmentFactors':
