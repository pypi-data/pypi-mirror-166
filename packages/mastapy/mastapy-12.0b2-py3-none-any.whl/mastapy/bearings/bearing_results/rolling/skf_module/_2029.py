...
from mastapy.bearings.bearing_results.rolling.skf_module import _2042, _2045
...
class DynamicAxialLoadCarryingCapacity(_2045.SKFCalculationResult):
    """DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_2042.PermissibleAxialLoad':
