...
class GreaseLifeAndRelubricationInterval(_2045.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    def grease_quantity(self) -> '_2037.GreaseQuantity':
    ...
    @property
    def initial_fill(self) -> '_2038.InitialFill':
