...
from mastapy.bearings.bearing_results.rolling import _2016, _1963
...
class LoadedRollerBearingElement(_1963.LoadedElement):
    """LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_2016.ResultsAtRollerOffset]':
