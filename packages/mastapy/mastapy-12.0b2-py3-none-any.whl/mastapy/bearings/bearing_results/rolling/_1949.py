...
from mastapy.bearings.bearing_results.rolling import _1921, _1963
...
class LoadedBallBearingElement(_1963.LoadedElement):
    """LoadedBallBearingElement
    ...
    @property
    def inner_race_contact_geometries(self) -> 'List[_1921.BallBearingRaceContactGeometry]':
    ...
    @property
    def outer_race_contact_geometries(self) -> 'List[_1921.BallBearingRaceContactGeometry]':
