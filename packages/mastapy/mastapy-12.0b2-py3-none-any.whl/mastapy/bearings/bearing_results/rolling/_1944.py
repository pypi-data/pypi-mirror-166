...
from mastapy.bearings.bearing_results.rolling import _1943, _1946, _1974
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1974.LoadedNonBarrelRollerBearingRow):
    """LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1943.LoadedAxialThrustCylindricalRollerBearingResults':
