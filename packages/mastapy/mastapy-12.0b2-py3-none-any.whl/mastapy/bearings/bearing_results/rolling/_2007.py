...
from mastapy.bearings.bearing_results.rolling import _2006, _1979
...
class LoadedToroidalRollerBearingRow(_1979.LoadedRollerBearingRow):
    """LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2006.LoadedToroidalRollerBearingResults':
