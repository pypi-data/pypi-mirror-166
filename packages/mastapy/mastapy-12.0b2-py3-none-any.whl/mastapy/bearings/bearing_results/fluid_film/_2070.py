...
from mastapy.bearings.bearing_results.fluid_film import _2071, _2067
...
class LoadedPlainJournalBearingResults(_2067.LoadedFluidFilmBearingResults):
    """LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_2071.LoadedPlainJournalBearingRow]':
