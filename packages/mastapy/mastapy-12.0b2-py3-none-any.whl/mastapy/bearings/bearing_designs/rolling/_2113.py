...
from mastapy.bearings import (
    _1846, _1824, _1825, _1826,
    _1823, _1849
)
from mastapy.bearings.bearing_designs.rolling import (
    _2095, _2099, _2100, _2106,
    _2116, _2094, _2123, _2103,
    _2091, _2115
)
from mastapy._internal.python_net import python_net_import
from mastapy.materials import _239
from mastapy.utility import _1545
from mastapy.bearings.bearing_designs import _2079
...
class RollingBearing(_2079.DetailedBearing):
    """RollingBearing
    ...
    @property
    def cage_bridge_shape(self) -> '_2095.CageBridgeShape':
        ...
        return constructor.new_from_mastapy_type(_2095.CageBridgeShape)(value) if value is not None else None

    @cage_bridge_shape.setter
    def cage_bridge_shape(self, value: '_2095.CageBridgeShape'):
    ...
    @property
    def cage_material(self) -> '_1826.BearingCageMaterial':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1826.BearingCageMaterial)(value) if value is not None else None

    @cage_material.setter
    def cage_material(self, value: '_1826.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def catalogue(self) -> '_1823.BearingCatalog':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1823.BearingCatalog)(value) if value is not None else None
    ...
    @property
    def sleeve_type(self) -> '_2116.SleeveType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2116.SleeveType)(value) if value is not None else None
    ...
    @property
    def type_information(self) -> '_2094.BearingTypeExtraInformation':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2094.BearingTypeExtraInformation)(value) if value is not None else None
    ...
    @property
    def geometric_constants(self) -> '_2103.GeometricConstants':
    ...
    @property
    def history(self) -> '_1545.FileHistory':
    ...
    @property
    def protection(self) -> '_2091.BearingProtection':
    ...
    @property
    def skf_seal_frictional_moment_constants(self) -> '_2115.SKFSealFrictionalMomentConstants':
