...
from mastapy.bearings.bearing_designs.rolling import _2104, _2105
...
class GeometricConstants(_0.APIBase):
    ...
    @property
    def geometric_constants_for_rolling_frictional_moments(self) -> '_2104.GeometricConstantsForRollingFrictionalMoments':
    ...
    @property
    def geometric_constants_for_sliding_frictional_moments(self) -> '_2105.GeometricConstantsForSlidingFrictionalMoments':
