...
from mastapy.bearings.bearing_designs.rolling import _2089, _2113
...
class BallBearing(_2113.RollingBearing):
    """BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_2089.BallBearingShoulderDefinition]':
