...
from mastapy.bearings.bearing_designs.rolling.xml_import import _2125, _2124
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_2125.BearingImportFile]':
    ...
    @property
    def variables(self) -> 'List[_2124.AbstractXmlVariableAssignment]':
