...
from mastapy.bearings.bearing_designs.rolling import _2111, _2112, _2110
...
class NonBarrelRollerBearing(_2110.RollerBearing):
    """NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_2111.RollerEndShape':
        ...
        return constructor.new_from_mastapy_type(_2111.RollerEndShape)(value) if value is not None else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_2111.RollerEndShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RollerEndShape = value

    @property
    def ribs(self) -> 'List[_2112.RollerRibDetail]':
