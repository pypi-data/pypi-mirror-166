...
from mastapy.bearings.bearing_designs.concept import _2144, _2146
...
class ConceptAxialClearanceBearing(_2146.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_2144.BearingNodePosition':
        ...
        return constructor.new_from_mastapy_type(_2144.BearingNodePosition)(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_2144.BearingNodePosition'):
