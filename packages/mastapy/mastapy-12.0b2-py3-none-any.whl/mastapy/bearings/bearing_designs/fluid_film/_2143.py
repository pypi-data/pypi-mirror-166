...
class TiltingPadThrustBearing(_2135.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1854.TiltingPadTypes':
        ...
        return constructor.new_from_mastapy_type(_1854.TiltingPadTypes)(value) if value is not None else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1854.TiltingPadTypes'):
