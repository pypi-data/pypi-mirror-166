...
class RollingBearingDatabase(_1791.SQLDatabase['_1848.RollingBearingKey', '_2113.RollingBearing']):
    """RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_2113.RollingBearing'):
    ...
    def create_bearing(self, type_: '_1850.RollingBearingType', designation: Optional['str'] = 'None') -> '_2113.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_2113.RollingBearing':
        """ 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1850.RollingBearingType', designation: Optional['str'] = 'None') -> '_1848.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1848.RollingBearingKey':
        """ 'CreateKey' is the original name of this method.
    ...
    def remove_from_database(self, bearing: '_2113.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1823.BearingCatalog', type_: '_1850.RollingBearingType', bore_range: '_1450.Range', outer_diameter_range: '_1450.Range', width_range: '_1450.Range', dynamic_capacity_range: '_1450.Range', number_of_rows: 'int', material_type: '_1839.HybridSteelAll') -> 'List[_2113.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1823.BearingCatalog', type_: '_1850.RollingBearingType') -> 'List[_2113.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1823.BearingCatalog') -> '_2113.RollingBearing':
        """ 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1823.BearingCatalog') -> 'List[_2113.RollingBearing]':
        """ 'SearchForRollingBearing' is the original name of this method.
