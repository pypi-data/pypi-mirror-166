...
class ProgramSettings(_1556.PerMachineSettings):
    """ProgramSettings
    ...
    @property
    def default_user_name_for_history(self) -> 'str':
        """str: 'DefaultUserNameForHistory' is the original name of this property."""

        temp = self.wrapped.DefaultUserNameForHistory
    ...
    @default_user_name_for_history.setter
    def default_user_name_for_history(self, value: 'str'):
        self.wrapped.DefaultUserNameForHistory = str(value) if value else ''
