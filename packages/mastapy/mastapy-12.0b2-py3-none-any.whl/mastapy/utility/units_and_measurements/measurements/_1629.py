...
class LengthShort(_1567.MeasurementBase):
    """LengthShort
    ...
    @property
    def micrometres(self) -> '_1572.Unit':
    ...
    @property
    def millimetres(self) -> '_1572.Unit':
    ...
    @property
    def thousandths_of_an_inch(self) -> '_1572.Unit':
