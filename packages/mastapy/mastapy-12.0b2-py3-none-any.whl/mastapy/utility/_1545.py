...
class FileHistory(_0.APIBase):
    ...
    @property
    def items(self) -> 'List[_1546.FileHistoryItem]':
    ...
    def add_file_history_item(self, item: '_1546.FileHistoryItem'):
    ...
    def create_history_item(self, user_name: 'str', comment: 'str') -> '_1546.FileHistoryItem':
