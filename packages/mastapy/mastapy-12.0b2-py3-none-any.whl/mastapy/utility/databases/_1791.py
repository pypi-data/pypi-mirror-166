...
from mastapy.utility.databases import _1786, _1789, _1784
...
TKey = TypeVar('TKey', bound='_1786.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1784.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    """SQLDatabase
    ...
    def delete(self, key: '_1786.DatabaseKey'):
    ...
    def save(self, item: '_1789.NamedDatabaseItem'):
