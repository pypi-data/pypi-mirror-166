...
from mastapy.utility.report import _1728, _1729
...
T = TypeVar('T', bound='_1729.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1728.CustomReportItemContainerCollectionBase, Generic[T]):
    """CustomReportItemContainerCollection
