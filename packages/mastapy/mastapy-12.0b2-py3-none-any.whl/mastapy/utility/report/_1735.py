...
from mastapy.utility.report import _1745, _1746
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.utility.reporting_property_framework import _1750
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    @property
    def font_style(self) -> '_1745.FontStyle':
        ...
        return constructor.new_from_mastapy_type(_1745.FontStyle)(value) if value is not None else None

    @font_style.setter
    def font_style(self, value: '_1745.FontStyle'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontStyle = value

    @property
    def font_weight(self) -> '_1746.FontWeight':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1746.FontWeight)(value) if value is not None else None

    @font_weight.setter
    def font_weight(self, value: '_1746.FontWeight'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontWeight = value

    @property
    def horizontal_position(self) -> '_1750.CellValuePosition':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1750.CellValuePosition)(value) if value is not None else None

    @horizontal_position.setter
    def horizontal_position(self, value: '_1750.CellValuePosition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
