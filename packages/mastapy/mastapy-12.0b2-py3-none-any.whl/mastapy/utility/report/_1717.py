...
from mastapy.utility.cad_export import _1793
...
class CustomReportCadDrawing(_1733.CustomReportNameableItem):
    """CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self) -> '_1793.StockDrawings':
        ...
        return constructor.new_from_mastapy_type(_1793.StockDrawings)(value) if value is not None else None

    @stock_drawing.setter
    def stock_drawing(self, value: '_1793.StockDrawings'):
