...
class ApiVersioning:
    ...
    @staticmethod
    def get_available_api_versions(folder: 'str') -> 'Iterable[_7480.ApiVersion]':
    ...
    @staticmethod
    def get_available_api_utility_versions(folder: 'str') -> 'Iterable[_7480.ApiVersion]':
    ...
    @staticmethod
    def get_api_version_for_assembly(api_library_search_folder: 'str', assembly_path: 'str') -> '_7480.ApiVersion':
