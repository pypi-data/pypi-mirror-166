...
from mastapy.bolts import _1446, _1427
...
class BoltMaterial(_1427.BoltedJointMaterial):
    """BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1446.StrengthGrades':
        ...
        return constructor.new_from_mastapy_type(_1446.StrengthGrades)(value) if value is not None else None

    @strength_grade.setter
    def strength_grade(self, value: '_1446.StrengthGrades'):
