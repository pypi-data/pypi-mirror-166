...
class BoltGeometry(_1789.NamedDatabaseItem):
    """BoltGeometry
    ...
    @property
    def bolt_sections(self) -> 'List[_1433.BoltSection]':
    ...
    def bolt_sections(self, value: 'List[_1433.BoltSection]'):
        value = value if value else None
        value = conversion.mp_to_pn_objects_in_list(value)
        self.wrapped.BoltSections = value

    @property
    def bolt_shank_type(self) -> '_1434.BoltShankType':
        ...
        return constructor.new_from_mastapy_type(_1434.BoltShankType)(value) if value is not None else None

    @bolt_shank_type.setter
    def bolt_shank_type(self, value: '_1434.BoltShankType'):
        value = value if value else None
    ...
    @property
    def standard_size(self) -> '_1445.StandardSizes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1445.StandardSizes)(value) if value is not None else None

    @standard_size.setter
    def standard_size(self, value: '_1445.StandardSizes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_bolted_joint(self) -> '_1435.BoltTypes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1435.BoltTypes)(value) if value is not None else None

    @type_of_bolted_joint.setter
    def type_of_bolted_joint(self, value: '_1435.BoltTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfBoltedJoint = value

    @property
    def type_of_head_cap(self) -> '_1440.HeadCapTypes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1440.HeadCapTypes)(value) if value is not None else None

    @type_of_head_cap.setter
    def type_of_head_cap(self, value: '_1440.HeadCapTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self) -> '_1447.ThreadTypes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1447.ThreadTypes)(value) if value is not None else None

    @type_of_thread.setter
    def type_of_thread(self, value: '_1447.ThreadTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
