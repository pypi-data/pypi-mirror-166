...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def node_detail(self) -> '_1521.ForceAndDisplacementResults':
    ...
    @property
    def section_to_the_left_side(self) -> '_2742.ShaftSectionSystemDeflection':
    ...
    @property
    def section_to_the_right_side(self) -> '_2742.ShaftSectionSystemDeflection':
