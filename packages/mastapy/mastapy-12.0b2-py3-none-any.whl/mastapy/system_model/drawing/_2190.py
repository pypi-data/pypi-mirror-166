...
from mastapy.system_model.drawing import _2200, _2196
...
class ContourDrawStyle(_302.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1781.ThreeDViewContourOption':
        ...
        return constructor.new_from_mastapy_type(_1781.ThreeDViewContourOption)(value) if value is not None else None

    @contour.setter
    def contour(self, value: '_1781.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_2200.ScalingDrawStyle':
    ...
    @property
    def model_view_options(self) -> '_2196.ModelViewOptionsDrawStyle':
