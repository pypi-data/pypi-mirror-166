...
class FESubstructureNodeModeShapes(_0.APIBase):
    ...
    @property
    def condensation_node(self) -> '_2329.FESubstructureNode':
    ...
    @property
    def connected_component_local_coordinate_system(self) -> '_1460.CoordinateSystem3D':
    ...
    @property
    def mode_shapes_at_condensation_node(self) -> 'List[_2330.FESubstructureNodeModeShape]':
