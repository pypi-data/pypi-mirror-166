...
class ElectricMachineDynamicLoadData(_0.APIBase):
    ...
    @property
    def electric_machine_data_sets(self) -> 'List[_2318.ElectricMachineDataSet]':
    ...
    def add_electric_machine_data_set(self, name: 'str') -> '_2318.ElectricMachineDataSet':
    ...
    def add_electric_machine_data_set_from_masta_dynamic_force_analysis(self, analysis: '_1307.IHaveDynamicForceResults', slice_index: 'int') -> '_2318.ElectricMachineDataSet':
