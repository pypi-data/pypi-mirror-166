...
from mastapy.math_utility.measured_vectors import _1525, _1523
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self) -> '_1525.VectorWithLinearAndAngularComponents':
    ...
    @property
    def new_result(self) -> '_1523.NodeResults':
    ...
    @property
    def original_result(self) -> '_1523.NodeResults':
