...
from mastapy.math_utility import _1461
from mastapy.system_model.fe import (
    _2321, _2312, _2313, _2343,
    _2334
)
...
class FESubstructureWithSelectionComponents(_2334.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    @property
    def manual_alignment(self) -> '_1461.CoordinateSystemEditor':
    ...
    @property
    def beam_element_properties(self) -> 'List[_2321.ElementPropertiesWithSelection[_204.ElementPropertiesBeam]]':
    ...
    @property
    def component_links(self) -> 'List[_2364.FELinkWithSelection]':
    ...
    @property
    def contact_pairs(self) -> 'List[_2312.ContactPairWithSelection]':
    ...
    @property
    def coordinate_systems(self) -> 'List[_2313.CoordinateSystemWithSelection]':
    ...
    @property
    def interface_element_properties(self) -> 'List[_2321.ElementPropertiesWithSelection[_205.ElementPropertiesInterface]]':
    ...
    @property
    def links_for_electric_machine(self) -> 'List[_2364.FELinkWithSelection]':
    ...
    @property
    def links_for_selected_component(self) -> 'List[_2364.FELinkWithSelection]':
    ...
    @property
    def mass_element_properties(self) -> 'List[_2321.ElementPropertiesWithSelection[_206.ElementPropertiesMass]]':
    ...
    @property
    def materials(self) -> 'List[_2343.MaterialPropertiesWithSelection]':
    ...
    @property
    def other_element_properties(self) -> 'List[_2321.ElementPropertiesWithSelection[_203.ElementPropertiesBase]]':
    ...
    @property
    def rigid_element_properties(self) -> 'List[_2321.ElementPropertiesWithSelection[_207.ElementPropertiesRigid]]':
    ...
    @property
    def shell_element_properties(self) -> 'List[_2321.ElementPropertiesWithSelection[_208.ElementPropertiesShell]]':
    ...
    @property
    def solid_element_properties(self) -> 'List[_2321.ElementPropertiesWithSelection[_209.ElementPropertiesSolid]]':
    ...
    @property
    def spring_dashpot_element_properties(self) -> 'List[_2321.ElementPropertiesWithSelection[_210.ElementPropertiesSpringDashpot]]':
