...
from mastapy.system_model.fe import (
    _2301, _2307, _2355, _2332,
    _2303, _2328, _2339, _2325,
    _2340, _2329, _2353, _2335,
    _2336, _2337, _2338
)
from mastapy._internal.implicit import list_with_selected_item, overridable, enum_with_selected_value
from mastapy.system_model.part_model import _2389, _2393, _2398
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self) -> '_2301.AlignmentMethod':
        ...
        return constructor.new_from_mastapy_type(_2301.AlignmentMethod)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2301.AlignmentMethod'):
    ...
    @property
    def bearing_node_alignment(self) -> '_2307.BearingNodeAlignmentOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2307.BearingNodeAlignmentOption)(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2307.BearingNodeAlignmentOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_using_axial_node_positions(self) -> '_2303.AlignmentUsingAxialNodePositions':
    ...
    @property
    def alignment_to_component(self) -> '_2168.RelativeComponentAlignment[_2389.Component]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2389.Component](temp) if temp is not None else None
    ...
    @property
    def coordinate_system(self) -> '_1460.CoordinateSystem3D':
    ...
    @property
    def export(self) -> '_2328.FESubstructureExportOptions':
    ...
    @property
    def gear_meshing_options(self) -> 'List[_2339.GearMeshingOptions]':
    ...
    @property
    def geometries(self) -> 'List[_2325.FEStiffnessGeometry]':
    ...
    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2340.IndependentMastaCreatedCondensationNode]':
    ...
    @property
    def links(self) -> 'List[_2362.FELink]':
    ...
    @property
    def replaced_shafts(self) -> 'List[_2427.Shaft]':
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2353.ReplacedShaftSelectionHelper]':
    ...
    @property
    def thermal_expansion_displacements(self) -> 'List[_1525.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def thermal_expansion_forces(self) -> 'List[_1525.VectorWithLinearAndAngularComponents]':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2335.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2336.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2337.FESubstructureWithSelectionForModalAnalysis':
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2338.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_165.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7476.TaskProgress'] = None):
    ...
    def import_node_positions(self, file_name: 'str', distance_unit: '_1572.Unit'):
    ...
    def import_reduced_stiffness(self, file_name: 'str', distance_unit: '_1572.Unit', force_unit: '_1572.Unit'):
    ...
    def links_for(self, node: '_2329.FESubstructureNode') -> 'List[_2362.FELink]':
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7476.TaskProgress'):
        """ 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def load_stl_geometry(self, length_unit: '_1572.Unit', file_name: 'str'):
