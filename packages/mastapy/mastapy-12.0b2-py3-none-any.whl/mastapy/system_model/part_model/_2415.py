...
class PlanetCarrierSettings(_1556.PerMachineSettings):
    """PlanetCarrierSettings
    ...
    @property
    def planet_pin_manufacturing_errors_coordinate_system(self) -> '_2163.PlanetPinManufacturingErrorsCoordinateSystem':
        ...
        return constructor.new_from_mastapy_type(_2163.PlanetPinManufacturingErrorsCoordinateSystem)(value) if value is not None else None

    @planet_pin_manufacturing_errors_coordinate_system.setter
    def planet_pin_manufacturing_errors_coordinate_system(self, value: '_2163.PlanetPinManufacturingErrorsCoordinateSystem'):
