...
from mastapy.system_model.part_model.import_from_cad import _2447, _2448
...
class ConnectorFromCAD(_2448.MountableComponentFromCAD):
    """ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2447.HousedOrMounted':
        ...
        return constructor.new_from_mastapy_type(_2447.HousedOrMounted)(value) if value is not None else None

    @mounting.setter
    def mounting(self, value: '_2447.HousedOrMounted'):
