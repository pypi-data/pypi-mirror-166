...
from mastapy.bearings.tolerances import (
    _1857, _1858, _1867, _1861,
    _1874, _1860, _1871, _1866,
    _1876, _1878
)
from mastapy.bearings import (
    _1827, _1840, _1831, _1823
)
from mastapy.materials.efficiency import _286
from mastapy.utility.report import _1748
from mastapy._internal.python_net import python_net_import
from mastapy.bearings.bearing_results import _1913, _1896, _1914
from mastapy.system_model.part_model import (
    _2384, _2418, _2386, _2390,
    _2392
)
...
from mastapy.bearings.bearing_designs.rolling import (
    ...
    _2087, _2088, _2090, _2096,
    _2097, _2098, _2102, _2107,
    _2108, _2109, _2110, _2113,
    _2114, _2117, _2118, _2119,
    _2120, _2121, _2122
)
from mastapy.bearings.bearing_designs.fluid_film import (
    _2135, _2137, _2139, _2141,
    _2142, _2143
)
from mastapy.bearings.bearing_designs.concept import _2145, _2146, _2147
...
class Bearing(_2392.Connector):
    ...
    @property
    def bearing_tolerance_definition(self) -> '_1858.BearingToleranceDefinitionOptions':
        ...
        return constructor.new_from_mastapy_type(_1858.BearingToleranceDefinitionOptions)(value) if value is not None else None

    @bearing_tolerance_definition.setter
    def bearing_tolerance_definition(self, value: '_1858.BearingToleranceDefinitionOptions'):
    ...
    @property
    def damping_options(self) -> '_1827.BearingDampingMatrixOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1827.BearingDampingMatrixOption)(value) if value is not None else None

    @damping_options.setter
    def damping_options(self, value: '_1827.BearingDampingMatrixOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def inner_fitting_chart(self) -> '_1748.SimpleChartDefinition':
    ...
    @property
    def journal_bearing_type(self) -> '_1840.JournalBearingType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1840.JournalBearingType)(value) if value is not None else None

    @journal_bearing_type.setter
    def journal_bearing_type(self, value: '_1840.JournalBearingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def orientation(self) -> '_1913.Orientations':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1913.Orientations)(value) if value is not None else None

    @orientation.setter
    def orientation(self, value: '_1913.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def outer_fitting_chart(self) -> '_1748.SimpleChartDefinition':
    ...
    @property
    def axial_internal_clearance_tolerance(self) -> '_2384.AxialInternalClearanceTolerance':
    ...
    @property
    def detail(self) -> '_2078.BearingDesign':
        ...
        if _2078.BearingDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_detailed_bearing(self) -> '_2079.DetailedBearing':
        ...
        if _2079.DetailedBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_dummy_rolling_bearing(self) -> '_2080.DummyRollingBearing':
        ...
        if _2080.DummyRollingBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_linear_bearing(self) -> '_2081.LinearBearing':
        ...
        if _2081.LinearBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_non_linear_bearing(self) -> '_2082.NonLinearBearing':
        ...
        if _2082.NonLinearBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_angular_contact_ball_bearing(self) -> '_2083.AngularContactBallBearing':
        ...
        if _2083.AngularContactBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_angular_contact_thrust_ball_bearing(self) -> '_2084.AngularContactThrustBallBearing':
        ...
        if _2084.AngularContactThrustBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_asymmetric_spherical_roller_bearing(self) -> '_2085.AsymmetricSphericalRollerBearing':
        ...
        if _2085.AsymmetricSphericalRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_2086.AxialThrustCylindricalRollerBearing':
        ...
        if _2086.AxialThrustCylindricalRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_needle_roller_bearing(self) -> '_2087.AxialThrustNeedleRollerBearing':
        ...
        if _2087.AxialThrustNeedleRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_ball_bearing(self) -> '_2088.BallBearing':
        ...
        if _2088.BallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_barrel_roller_bearing(self) -> '_2090.BarrelRollerBearing':
        ...
        if _2090.BarrelRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_crossed_roller_bearing(self) -> '_2096.CrossedRollerBearing':
        ...
        if _2096.CrossedRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_cylindrical_roller_bearing(self) -> '_2097.CylindricalRollerBearing':
        ...
        if _2097.CylindricalRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_deep_groove_ball_bearing(self) -> '_2098.DeepGrooveBallBearing':
        ...
        if _2098.DeepGrooveBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_four_point_contact_ball_bearing(self) -> '_2102.FourPointContactBallBearing':
        ...
        if _2102.FourPointContactBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_multi_point_contact_ball_bearing(self) -> '_2107.MultiPointContactBallBearing':
        ...
        if _2107.MultiPointContactBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_needle_roller_bearing(self) -> '_2108.NeedleRollerBearing':
        ...
        if _2108.NeedleRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_non_barrel_roller_bearing(self) -> '_2109.NonBarrelRollerBearing':
        ...
        if _2109.NonBarrelRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_roller_bearing(self) -> '_2110.RollerBearing':
        ...
        if _2110.RollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_rolling_bearing(self) -> '_2113.RollingBearing':
        ...
        if _2113.RollingBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_self_aligning_ball_bearing(self) -> '_2114.SelfAligningBallBearing':
        ...
        if _2114.SelfAligningBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_bearing(self) -> '_2117.SphericalRollerBearing':
        ...
        if _2117.SphericalRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_thrust_bearing(self) -> '_2118.SphericalRollerThrustBearing':
        ...
        if _2118.SphericalRollerThrustBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_taper_roller_bearing(self) -> '_2119.TaperRollerBearing':
        ...
        if _2119.TaperRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_three_point_contact_ball_bearing(self) -> '_2120.ThreePointContactBallBearing':
        ...
        if _2120.ThreePointContactBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_thrust_ball_bearing(self) -> '_2121.ThrustBallBearing':
        ...
        if _2121.ThrustBallBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_toroidal_roller_bearing(self) -> '_2122.ToroidalRollerBearing':
        ...
        if _2122.ToroidalRollerBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_pad_fluid_film_bearing(self) -> '_2135.PadFluidFilmBearing':
        ...
        if _2135.PadFluidFilmBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_grease_filled_journal_bearing(self) -> '_2137.PlainGreaseFilledJournalBearing':
        ...
        if _2137.PlainGreaseFilledJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_journal_bearing(self) -> '_2139.PlainJournalBearing':
        ...
        if _2139.PlainJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_oil_fed_journal_bearing(self) -> '_2141.PlainOilFedJournalBearing':
        ...
        if _2141.PlainOilFedJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_journal_bearing(self) -> '_2142.TiltingPadJournalBearing':
        ...
        if _2142.TiltingPadJournalBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_thrust_bearing(self) -> '_2143.TiltingPadThrustBearing':
        ...
        if _2143.TiltingPadThrustBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_axial_clearance_bearing(self) -> '_2145.ConceptAxialClearanceBearing':
        ...
        if _2145.ConceptAxialClearanceBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_clearance_bearing(self) -> '_2146.ConceptClearanceBearing':
        ...
        if _2146.ConceptClearanceBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_radial_clearance_bearing(self) -> '_2147.ConceptRadialClearanceBearing':
        ...
        if _2147.ConceptRadialClearanceBearing.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def force_at_zero_displacement(self) -> '_1525.VectorWithLinearAndAngularComponents':
    ...
    @property
    def friction_coefficients(self) -> '_2019.RollingBearingFrictionCoefficients':
    ...
    @property
    def inner_mounting_sleeve_bore_tolerance(self) -> '_1867.OuterSupportTolerance':
    ...
    @property
    def inner_mounting_sleeve_outer_diameter_tolerance(self) -> '_1861.InnerSupportTolerance':
    ...
    @property
    def inner_support_detail(self) -> '_1874.SupportDetail':
    ...
    @property
    def left_support_detail(self) -> '_1874.SupportDetail':
    ...
    @property
    def outer_mounting_sleeve_bore_tolerance(self) -> '_1867.OuterSupportTolerance':
    ...
    @property
    def outer_mounting_sleeve_outer_diameter_tolerance(self) -> '_1861.InnerSupportTolerance':
    ...
    @property
    def outer_support_detail(self) -> '_1874.SupportDetail':
    ...
    @property
    def radial_internal_clearance_tolerance(self) -> '_2418.RadialInternalClearanceTolerance':
    ...
    @property
    def right_support_detail(self) -> '_1874.SupportDetail':
    ...
    @property
    def ring_tolerance_inner(self) -> '_1860.InnerRingTolerance':
    ...
    @property
    def ring_tolerance_left(self) -> '_1871.RingTolerance':
        ...
        if _1871.RingTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_inner_ring_tolerance(self) -> '_1860.InnerRingTolerance':
        ...
        if _1860.InnerRingTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_outer_ring_tolerance(self) -> '_1866.OuterRingTolerance':
        ...
        if _1866.OuterRingTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def ring_tolerance_outer(self) -> '_1866.OuterRingTolerance':
    ...
    @property
    def ring_tolerance_right(self) -> '_1871.RingTolerance':
    ...
    @property
    def ring_tolerance_right_of_type_inner_ring_tolerance(self) -> '_1860.InnerRingTolerance':
    ...
    @property
    def ring_tolerance_right_of_type_outer_ring_tolerance(self) -> '_1866.OuterRingTolerance':
    ...
    @property
    def simple_bearing_detail_property(self) -> '_2078.BearingDesign':
    ...
    @property
    def simple_bearing_detail_property_of_type_detailed_bearing(self) -> '_2079.DetailedBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_dummy_rolling_bearing(self) -> '_2080.DummyRollingBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_linear_bearing(self) -> '_2081.LinearBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_non_linear_bearing(self) -> '_2082.NonLinearBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_ball_bearing(self) -> '_2083.AngularContactBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_thrust_ball_bearing(self) -> '_2084.AngularContactThrustBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_asymmetric_spherical_roller_bearing(self) -> '_2085.AsymmetricSphericalRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_2086.AxialThrustCylindricalRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_needle_roller_bearing(self) -> '_2087.AxialThrustNeedleRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_ball_bearing(self) -> '_2088.BallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_barrel_roller_bearing(self) -> '_2090.BarrelRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_crossed_roller_bearing(self) -> '_2096.CrossedRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_cylindrical_roller_bearing(self) -> '_2097.CylindricalRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_deep_groove_ball_bearing(self) -> '_2098.DeepGrooveBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_four_point_contact_ball_bearing(self) -> '_2102.FourPointContactBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_multi_point_contact_ball_bearing(self) -> '_2107.MultiPointContactBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_needle_roller_bearing(self) -> '_2108.NeedleRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_non_barrel_roller_bearing(self) -> '_2109.NonBarrelRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_roller_bearing(self) -> '_2110.RollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_rolling_bearing(self) -> '_2113.RollingBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_self_aligning_ball_bearing(self) -> '_2114.SelfAligningBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_bearing(self) -> '_2117.SphericalRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_thrust_bearing(self) -> '_2118.SphericalRollerThrustBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_taper_roller_bearing(self) -> '_2119.TaperRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_three_point_contact_ball_bearing(self) -> '_2120.ThreePointContactBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_thrust_ball_bearing(self) -> '_2121.ThrustBallBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_toroidal_roller_bearing(self) -> '_2122.ToroidalRollerBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_pad_fluid_film_bearing(self) -> '_2135.PadFluidFilmBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_grease_filled_journal_bearing(self) -> '_2137.PlainGreaseFilledJournalBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_journal_bearing(self) -> '_2139.PlainJournalBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_oil_fed_journal_bearing(self) -> '_2141.PlainOilFedJournalBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_journal_bearing(self) -> '_2142.TiltingPadJournalBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_thrust_bearing(self) -> '_2143.TiltingPadThrustBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_axial_clearance_bearing(self) -> '_2145.ConceptAxialClearanceBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_clearance_bearing(self) -> '_2146.ConceptClearanceBearing':
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_radial_clearance_bearing(self) -> '_2147.ConceptRadialClearanceBearing':
    ...
    @property
    def support_tolerance_inner(self) -> '_1861.InnerSupportTolerance':
    ...
    @property
    def support_tolerance_left(self) -> '_1876.SupportTolerance':
        ...
        if _1876.SupportTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_inner_support_tolerance(self) -> '_1861.InnerSupportTolerance':
        ...
        if _1861.InnerSupportTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_outer_support_tolerance(self) -> '_1867.OuterSupportTolerance':
        ...
        if _1867.OuterSupportTolerance.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def support_tolerance_outer(self) -> '_1867.OuterSupportTolerance':
    ...
    @property
    def support_tolerance_right(self) -> '_1876.SupportTolerance':
    ...
    @property
    def support_tolerance_right_of_type_inner_support_tolerance(self) -> '_1861.InnerSupportTolerance':
    ...
    @property
    def support_tolerance_right_of_type_outer_support_tolerance(self) -> '_1867.OuterSupportTolerance':
    ...
    @property
    def mounting(self) -> 'List[_2386.BearingRaceMountingOptions]':
    ...
    @property
    def tolerance_combinations(self) -> 'List[_1878.ToleranceCombination]':
    ...
    def set_detail_from_catalogue(self, catalogue: '_1823.BearingCatalog', designation: 'str'):
    ...
    def try_attach_left_side_to(self, shaft: '_2427.Shaft', offset: Optional['float'] = float('nan')) -> '_2390.ComponentsConnectedResult':
    ...
    def try_attach_right_side_to(self, shaft: '_2427.Shaft', offset: Optional['float'] = float('nan')) -> '_2390.ComponentsConnectedResult':
