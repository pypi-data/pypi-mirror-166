...
from mastapy.system_model.part_model import _2406, _2409
...
class PlanetCarrier(_2409.MountableComponent):
    """PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_2233.PlanetarySocket]':
    ...
    def attach_carrier_shaft(self, shaft: '_2427.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2427.Shaft', offset: Optional['float'] = float('nan')):
