...
from mastapy.cycloidal import _1423, _1424
...
class RingPins(_2409.MountableComponent):
    """RingPins
    ...
    @property
    def ring_pins_design(self) -> '_1423.RingPinsDesign':
    ...
    @property
    def ring_pins_material(self) -> '_1424.RingPinsMaterial':
