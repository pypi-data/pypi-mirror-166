...
from mastapy.system_model.part_model.part_groups import _2433, _2431
...
class ConcentricPartGroup(_2431.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2433.ConcentricPartGroupParallelToThis]':
