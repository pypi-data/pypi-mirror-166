...
from mastapy.system_model.part_model import _2379
from mastapy.system_model.import_export import _2186
...
class Part(_2152.DesignEntity):
    ...
    @property
    def mass_properties_from_design(self) -> '_1478.MassProperties':
    ...
    @property
    def mass_properties_from_design_including_planetary_duplicates(self) -> '_1478.MassProperties':
    ...
    @property
    def local_connections(self) -> 'List[_2217.Connection]':
    ...
    def connections_to(self, part: 'Part') -> 'List[_2217.Connection]':
    ...
    def copy_to(self, container: '_2379.Assembly') -> 'Part':
    ...
    def create_geometry_export_options(self) -> '_2186.GeometryExportOptions':
