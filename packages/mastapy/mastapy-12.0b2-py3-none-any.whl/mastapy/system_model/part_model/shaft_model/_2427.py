...
class Shaft(_2381.AbstractShaft):
    """Shaft
    ...
    @property
    def guide_image(self) -> '_2401.GuideImage':
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2327.FESubstructure':
    ...
    def mount_component(self, component: '_2409.MountableComponent', offset: 'float'):
