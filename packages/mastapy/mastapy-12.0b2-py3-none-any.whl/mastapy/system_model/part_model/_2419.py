...
from mastapy.system_model.part_model.part_groups import _2435
from mastapy.system_model.part_model.projections import _2430
...
class RootAssembly(_2379.Assembly):
    """RootAssembly
    ...
    @property
    def parallel_part_groups(self) -> 'List[_2435.ParallelPartGroup]':
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2430.SpecifiedParallelPartGroupDrawingOrder]':
