...
from mastapy.system_model.part_model import _2389, _2413
...
class AbstractAssembly(_2413.Part):
    """AbstractAssembly
    ...
    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2389.Component]':
    ...
    @property
    def components_with_zero_mass_properties(self) -> 'List[_2389.Component]':
