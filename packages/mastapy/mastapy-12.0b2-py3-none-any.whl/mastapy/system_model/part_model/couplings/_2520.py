...
from mastapy.system_model.part_model.couplings import _2521, _2534
...
class BeltDrive(_2421.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2521.BeltDriveType':
        ...
        return constructor.new_from_mastapy_type(_2521.BeltDriveType)(value) if value is not None else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2521.BeltDriveType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfBelt = value

    @property
    def belt_connections(self) -> 'List[_2213.BeltConnection]':
    ...
    @property
    def pulleys(self) -> 'List[_2534.Pulley]':
