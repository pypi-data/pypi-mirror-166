...
from mastapy.system_model.part_model.couplings import _2524, _2527
...
class Clutch(_2527.Coupling):
    ...
    @property
    def angular_speed_temperature_grid(self) -> '_1527.GriddedSurfaceAccessor':
    ...
    def angular_speed_temperature_grid(self, value: '_1527.GriddedSurfaceAccessor'):
    ...
    @property
    def clutch_type(self) -> '_2524.ClutchType':
        ...
        return constructor.new_from_mastapy_type(_2524.ClutchType)(value) if value is not None else None

    @clutch_type.setter
    def clutch_type(self, value: '_2524.ClutchType'):
    ...
    @property
    def flow_rate_vs_speed(self) -> '_1495.Vector2DListAccessor':
    ...
    def flow_rate_vs_speed(self, value: '_1495.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def linear_speed_temperature_grid(self) -> '_1527.GriddedSurfaceAccessor':
    ...
    def linear_speed_temperature_grid(self, value: '_1527.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def spring_type(self) -> '_5332.ClutchSpringType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5332.ClutchSpringType)(value) if value is not None else None

    @spring_type.setter
    def spring_type(self, value: '_5332.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_2287.ClutchConnection':
