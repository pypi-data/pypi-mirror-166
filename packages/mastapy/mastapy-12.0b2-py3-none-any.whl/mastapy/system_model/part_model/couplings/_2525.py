...
class ConceptCoupling(_2527.Coupling):
    """ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self) -> '_1495.Vector2DListAccessor':
    ...
    def efficiency_vs_speed_ratio(self, value: '_1495.Vector2DListAccessor'):
