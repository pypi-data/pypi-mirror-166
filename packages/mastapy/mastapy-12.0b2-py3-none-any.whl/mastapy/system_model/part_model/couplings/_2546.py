...
from mastapy.system_model.part_model.couplings import _2550, _2548
...
class Synchroniser(_2421.SpecialisedAssembly):
    """Synchroniser
    ...
    @property
    def clutch_connection_left(self) -> '_2287.ClutchConnection':
    ...
    @property
    def clutch_connection_right(self) -> '_2287.ClutchConnection':
    ...
    @property
    def hub_and_sleeve(self) -> '_2550.SynchroniserSleeve':
    ...
    @property
    def left_cone(self) -> '_2548.SynchroniserHalf':
    ...
    @property
    def right_cone(self) -> '_2548.SynchroniserHalf':
