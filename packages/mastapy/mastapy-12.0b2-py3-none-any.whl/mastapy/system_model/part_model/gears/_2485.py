...
from mastapy.system_model.part_model.gears import _2484, _2481
...
class KlingelnbergCycloPalloidSpiralBevelGearSet(_2481.KlingelnbergCycloPalloidConicalGearSet):
    """KlingelnbergCycloPalloidSpiralBevelGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(self) -> 'List[_2484.KlingelnbergCycloPalloidSpiralBevelGear]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_2265.KlingelnbergCycloPalloidSpiralBevelGearMesh]':
