...
class KlingelnbergCycloPalloidHypoidGearSet(_2481.KlingelnbergCycloPalloidConicalGearSet):
    """KlingelnbergCycloPalloidHypoidGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears(self) -> 'List[_2482.KlingelnbergCycloPalloidHypoidGear]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_2264.KlingelnbergCycloPalloidHypoidGearMesh]':
