...
from mastapy.system_model.part_model.gears import _2465, _2476
...
class ConceptGearSet(_2476.GearSet):
    """ConceptGearSet
    ...
    @property
    def concept_gears(self) -> 'List[_2465.ConceptGear]':
    ...
    @property
    def concept_meshes(self) -> 'List[_2250.ConceptGearMesh]':
