...
from mastapy.system_model.part_model.gears import _2491, _2464
...
class StraightBevelGearSet(_2464.BevelGearSet):
    """StraightBevelGearSet
    ...
    @property
    def straight_bevel_gears(self) -> 'List[_2491.StraightBevelGear]':
    ...
    @property
    def straight_bevel_meshes(self) -> 'List[_2272.StraightBevelGearMesh]':
