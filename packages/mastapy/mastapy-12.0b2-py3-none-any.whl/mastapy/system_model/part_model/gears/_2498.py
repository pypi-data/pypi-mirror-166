...
from mastapy.system_model.part_model.gears import _2497, _2464
...
class ZerolBevelGearSet(_2464.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    def zerol_bevel_gears(self) -> 'List[_2497.ZerolBevelGear]':
    ...
    @property
    def zerol_bevel_meshes(self) -> 'List[_2276.ZerolBevelGearMesh]':
