...
class PerModeResultsReport(_1718.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1780.TableAndChartOptions':
    ...
    def display_option(self, value: '_1780.TableAndChartOptions'):
