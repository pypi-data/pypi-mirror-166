...
from mastapy.system_model.analyses_and_results.modal_analyses import _4519, _4518, _4525
...
class BevelDifferentialGearSetModalAnalysis(_4525.BevelGearSetModalAnalysis):
    """BevelDifferentialGearSetModalAnalysis
    ...
    @property
    def bevel_differential_gears_modal_analysis(self) -> 'List[_4519.BevelDifferentialGearModalAnalysis]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis(self) -> 'List[_4518.BevelDifferentialGearMeshModalAnalysis]':
