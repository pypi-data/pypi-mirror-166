...
from mastapy.system_model.analyses_and_results.modal_analyses import _2579, _4514
...
class RootAssemblyModalAnalysis(_4514.AssemblyModalAnalysis):
    """RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2579.ModalAnalysis':
