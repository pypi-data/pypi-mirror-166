...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def chart_type(self) -> '_4560.DynamicsResponse3DChartType':
        ...
        return constructor.new_from_mastapy_type(_4560.DynamicsResponse3DChartType)(value) if value is not None else None

    @chart_type.setter
    def chart_type(self, value: '_4560.DynamicsResponse3DChartType'):
    ...
    @property
    def connected_component_type(self) -> '_5766.ConnectedComponentType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_5766.ConnectedComponentType)(value) if value is not None else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5766.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def coordinate_system(self) -> '_4544.CoordinateSystemForWhine':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4544.CoordinateSystemForWhine)(value) if value is not None else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4544.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def translation_or_rotation(self) -> '_1494.TranslationRotation':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1494.TranslationRotation)(value) if value is not None else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1494.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def vector_magnitude_method(self) -> '_1480.ComplexMagnitudeMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1480.ComplexMagnitudeMethod)(value) if value is not None else None

    @vector_magnitude_method.setter
    def vector_magnitude_method(self, value: '_1480.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.VectorMagnitudeMethod = value

    @property
    def whine_waterfall_export_option(self) -> '_4640.WhineWaterfallExportOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4640.WhineWaterfallExportOption)(value) if value is not None else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4640.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.WhineWaterfallExportOption = value

    @property
    def data_scaling(self) -> '_1531.DataScalingOptions':
    ...
    @property
    def frequency_options(self) -> '_5679.FrequencyOptionsForHarmonicAnalysisResults':
    ...
    @property
    def modal_contribution_view_options(self) -> '_2208.ModalContributionViewOptions':
    ...
    @property
    def mode_view_options(self) -> '_2206.AdvancedTimeSteppingAnalysisForModulationModeViewOptions':
    ...
    @property
    def order_cuts_chart_settings(self) -> '_4593.OrderCutsChartSettings':
    ...
    @property
    def reference_speed_options(self) -> '_5734.SpeedOptionsForHarmonicAnalysisResults':
    ...
    @property
    def result_location_selection_groups(self) -> '_5774.ResultLocationSelectionGroups':
    ...
    @property
    def selected_excitations(self) -> '_5769.ExcitationSourceSelectionGroup':
    ...
    @property
    def waterfall_chart_settings(self) -> '_4639.WaterfallChartSettings':
    ...
    @property
    def active_result_locations(self) -> 'List[_5775.ResultNodeSelection]':
    ...
    @property
    def degrees_of_freedom(self) -> 'List[_1802.EnumWithBool[_1487.ResultOptionsFor3DVector]]':
