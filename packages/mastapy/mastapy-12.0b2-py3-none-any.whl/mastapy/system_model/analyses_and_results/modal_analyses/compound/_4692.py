...
class ConicalGearCompoundModalAnalysis(_4718.GearCompoundModalAnalysis):
    """ConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4540.ConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4540.ConicalGearModalAnalysis]':
