...
class StraightBevelGearMeshCompoundModalAnalysis(_4677.BevelGearMeshCompoundModalAnalysis):
    """StraightBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4624.StraightBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4624.StraightBevelGearMeshModalAnalysis]':
