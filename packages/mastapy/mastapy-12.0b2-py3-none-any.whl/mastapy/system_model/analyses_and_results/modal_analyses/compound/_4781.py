...
class UnbalancedMassCompoundModalAnalysis(_4782.VirtualComponentCompoundModalAnalysis):
    """UnbalancedMassCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4637.UnbalancedMassModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4637.UnbalancedMassModalAnalysis]':
