...
class RingPinsToDiscConnectionCompoundModalAnalysis(_4725.InterMountableComponentConnectionCompoundModalAnalysis):
    """RingPinsToDiscConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4605.RingPinsToDiscConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4605.RingPinsToDiscConnectionModalAnalysis]':
