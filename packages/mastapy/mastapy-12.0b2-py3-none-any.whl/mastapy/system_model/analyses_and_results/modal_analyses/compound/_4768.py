...
class StraightBevelGearCompoundModalAnalysis(_4676.BevelGearCompoundModalAnalysis):
    """StraightBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4625.StraightBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4625.StraightBevelGearModalAnalysis]':
