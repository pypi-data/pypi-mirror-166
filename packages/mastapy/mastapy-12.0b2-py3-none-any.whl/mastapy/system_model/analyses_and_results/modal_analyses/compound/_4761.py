...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4759, _4760, _4678
...
class SpiralBevelGearSetCompoundModalAnalysis(_4678.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4617.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis(self) -> 'List[_4759.SpiralBevelGearCompoundModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis(self) -> 'List[_4760.SpiralBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4617.SpiralBevelGearSetModalAnalysis]':
