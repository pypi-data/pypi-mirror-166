...
class ConicalGearMeshCompoundModalAnalysis(_4719.GearMeshCompoundModalAnalysis):
    """ConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4539.ConicalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4539.ConicalGearMeshModalAnalysis]':
