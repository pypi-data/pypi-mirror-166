...
class SpiralBevelGearCompoundModalAnalysis(_4676.BevelGearCompoundModalAnalysis):
    """SpiralBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4616.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4616.SpiralBevelGearModalAnalysis]':
