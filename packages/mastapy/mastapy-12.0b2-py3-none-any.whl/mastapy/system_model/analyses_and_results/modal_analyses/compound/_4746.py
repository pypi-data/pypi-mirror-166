...
class PointLoadCompoundModalAnalysis(_4782.VirtualComponentCompoundModalAnalysis):
    """PointLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4601.PointLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4601.PointLoadModalAnalysis]':
