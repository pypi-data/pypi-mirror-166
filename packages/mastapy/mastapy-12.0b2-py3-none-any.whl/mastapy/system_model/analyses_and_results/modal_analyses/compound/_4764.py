...
class SpringDamperHalfCompoundModalAnalysis(_4699.CouplingHalfCompoundModalAnalysis):
    """SpringDamperHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4619.SpringDamperHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4619.SpringDamperHalfModalAnalysis]':
