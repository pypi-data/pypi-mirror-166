...
class HypoidGearCompoundModalAnalysis(_4664.AGMAGleasonConicalGearCompoundModalAnalysis):
    """HypoidGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4574.HypoidGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4574.HypoidGearModalAnalysis]':
