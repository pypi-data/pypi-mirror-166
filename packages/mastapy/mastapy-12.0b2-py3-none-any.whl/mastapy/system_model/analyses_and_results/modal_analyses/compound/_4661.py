...
class AbstractShaftCompoundModalAnalysis(_4662.AbstractShaftOrHousingCompoundModalAnalysis):
    """AbstractShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4508.AbstractShaftModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4508.AbstractShaftModalAnalysis]':
