...
class RollingRingAssemblyCompoundModalAnalysis(_4758.SpecialisedAssemblyCompoundModalAnalysis):
    """RollingRingAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4606.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4606.RollingRingAssemblyModalAnalysis]':
