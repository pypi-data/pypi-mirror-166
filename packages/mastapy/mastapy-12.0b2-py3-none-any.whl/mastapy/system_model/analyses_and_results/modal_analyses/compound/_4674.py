...
class BevelDifferentialPlanetGearCompoundModalAnalysis(_4671.BevelDifferentialGearCompoundModalAnalysis):
    """BevelDifferentialPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4521.BevelDifferentialPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4521.BevelDifferentialPlanetGearModalAnalysis]':
