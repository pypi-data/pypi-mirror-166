...
class BoltedJointCompoundModalAnalysis(_4758.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4526.BoltedJointModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4526.BoltedJointModalAnalysis]':
