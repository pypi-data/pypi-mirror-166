...
class RollingRingCompoundModalAnalysis(_4699.CouplingHalfCompoundModalAnalysis):
    """RollingRingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4608.RollingRingModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4608.RollingRingModalAnalysis]':
