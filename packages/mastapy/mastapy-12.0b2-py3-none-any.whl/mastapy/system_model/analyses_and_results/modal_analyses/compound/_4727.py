...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis(_4693.ConicalGearMeshCompoundModalAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4577.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4577.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
