...
class PulleyCompoundModalAnalysis(_4699.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4603.PulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4603.PulleyModalAnalysis]':
