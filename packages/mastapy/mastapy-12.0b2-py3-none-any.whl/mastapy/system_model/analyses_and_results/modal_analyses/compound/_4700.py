...
class CVTBeltConnectionCompoundModalAnalysis(_4669.BeltConnectionCompoundModalAnalysis):
    """CVTBeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4548.CVTBeltConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4548.CVTBeltConnectionModalAnalysis]':
