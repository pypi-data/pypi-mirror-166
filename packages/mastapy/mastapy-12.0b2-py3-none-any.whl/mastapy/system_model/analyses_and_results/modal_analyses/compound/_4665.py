...
class AGMAGleasonConicalGearMeshCompoundModalAnalysis(_4693.ConicalGearMeshCompoundModalAnalysis):
    """AGMAGleasonConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4511.AGMAGleasonConicalGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4511.AGMAGleasonConicalGearMeshModalAnalysis]':
