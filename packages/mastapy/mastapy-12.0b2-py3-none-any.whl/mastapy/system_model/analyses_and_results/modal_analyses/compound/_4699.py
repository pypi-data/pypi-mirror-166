...
class CouplingHalfCompoundModalAnalysis(_4737.MountableComponentCompoundModalAnalysis):
    """CouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4546.CouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4546.CouplingHalfModalAnalysis]':
