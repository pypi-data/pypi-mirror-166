...
class ConceptGearCompoundModalAnalysis(_4718.GearCompoundModalAnalysis):
    """ConceptGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4537.ConceptGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4537.ConceptGearModalAnalysis]':
