...
class CycloidalDiscCompoundModalAnalysis(_4661.AbstractShaftCompoundModalAnalysis):
    """CycloidalDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4553.CycloidalDiscModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4553.CycloidalDiscModalAnalysis]':
