...
class MountableComponentCompoundModalAnalysis(_4685.ComponentCompoundModalAnalysis):
    """MountableComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4591.MountableComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4591.MountableComponentModalAnalysis]':
