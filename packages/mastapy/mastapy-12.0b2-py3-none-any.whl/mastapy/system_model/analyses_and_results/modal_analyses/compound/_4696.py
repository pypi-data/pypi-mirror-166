...
class ConnectorCompoundModalAnalysis(_4737.MountableComponentCompoundModalAnalysis):
    """ConnectorCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4543.ConnectorModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4543.ConnectorModalAnalysis]':
