...
class SpiralBevelGearMeshCompoundModalAnalysis(_4677.BevelGearMeshCompoundModalAnalysis):
    """SpiralBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4615.SpiralBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4615.SpiralBevelGearMeshModalAnalysis]':
