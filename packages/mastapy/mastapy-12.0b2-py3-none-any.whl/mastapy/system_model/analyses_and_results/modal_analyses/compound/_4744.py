...
class PlanetaryGearSetCompoundModalAnalysis(_4709.CylindricalGearSetCompoundModalAnalysis):
    """PlanetaryGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4599.PlanetaryGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4599.PlanetaryGearSetModalAnalysis]':
