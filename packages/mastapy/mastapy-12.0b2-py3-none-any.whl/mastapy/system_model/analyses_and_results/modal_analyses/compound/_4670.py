...
class BeltDriveCompoundModalAnalysis(_4758.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4517.BeltDriveModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4517.BeltDriveModalAnalysis]':
