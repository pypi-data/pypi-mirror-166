...
class StraightBevelPlanetGearCompoundModalAnalysis(_4765.StraightBevelDiffGearCompoundModalAnalysis):
    """StraightBevelPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4627.StraightBevelPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4627.StraightBevelPlanetGearModalAnalysis]':
