...
class PowerLoadCompoundModalAnalysis(_4782.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4602.PowerLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4602.PowerLoadModalAnalysis]':
