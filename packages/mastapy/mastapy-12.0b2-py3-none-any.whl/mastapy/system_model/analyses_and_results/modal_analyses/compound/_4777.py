...
class TorqueConverterCompoundModalAnalysis(_4697.CouplingCompoundModalAnalysis):
    """TorqueConverterCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4634.TorqueConverterModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4634.TorqueConverterModalAnalysis]':
