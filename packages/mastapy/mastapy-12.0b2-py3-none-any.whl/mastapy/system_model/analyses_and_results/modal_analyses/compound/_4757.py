...
class ShaftToMountableComponentConnectionCompoundModalAnalysis(_4663.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    """ShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4613.ShaftToMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4613.ShaftToMountableComponentConnectionModalAnalysis]':
