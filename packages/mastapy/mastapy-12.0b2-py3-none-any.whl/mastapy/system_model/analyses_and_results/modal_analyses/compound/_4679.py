...
class BoltCompoundModalAnalysis(_4685.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4527.BoltModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4527.BoltModalAnalysis]':
