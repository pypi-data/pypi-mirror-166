...
class CVTCompoundModalAnalysis(_4670.BeltDriveCompoundModalAnalysis):
    """CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4549.CVTModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4549.CVTModalAnalysis]':
