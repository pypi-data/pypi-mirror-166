...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4689, _4690, _4720
...
class ConceptGearSetCompoundModalAnalysis(_4720.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4538.ConceptGearSetModalAnalysis]':
    ...
    @property
    def concept_gears_compound_modal_analysis(self) -> 'List[_4689.ConceptGearCompoundModalAnalysis]':
    ...
    @property
    def concept_meshes_compound_modal_analysis(self) -> 'List[_4690.ConceptGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4538.ConceptGearSetModalAnalysis]':
