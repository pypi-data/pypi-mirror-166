...
class SpringDamperCompoundModalAnalysis(_4697.CouplingCompoundModalAnalysis):
    """SpringDamperCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4620.SpringDamperModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4620.SpringDamperModalAnalysis]':
