...
class OilSealCompoundModalAnalysis(_4696.ConnectorCompoundModalAnalysis):
    """OilSealCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4592.OilSealModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4592.OilSealModalAnalysis]':
