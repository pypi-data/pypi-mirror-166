...
class BearingCompoundModalAnalysis(_4696.ConnectorCompoundModalAnalysis):
    """BearingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4515.BearingModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4515.BearingModalAnalysis]':
