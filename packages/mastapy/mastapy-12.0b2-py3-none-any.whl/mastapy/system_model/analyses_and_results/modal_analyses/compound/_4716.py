...
class FEPartCompoundModalAnalysis(_4662.AbstractShaftOrHousingCompoundModalAnalysis):
    """FEPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4566.FEPartModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4566.FEPartModalAnalysis]':
