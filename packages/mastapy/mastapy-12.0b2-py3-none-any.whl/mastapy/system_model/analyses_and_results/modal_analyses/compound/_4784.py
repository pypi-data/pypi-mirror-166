...
class WormGearMeshCompoundModalAnalysis(_4719.GearMeshCompoundModalAnalysis):
    """WormGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4642.WormGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4642.WormGearMeshModalAnalysis]':
