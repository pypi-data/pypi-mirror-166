...
class CVTPulleyCompoundModalAnalysis(_4748.PulleyCompoundModalAnalysis):
    """CVTPulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4550.CVTPulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4550.CVTPulleyModalAnalysis]':
