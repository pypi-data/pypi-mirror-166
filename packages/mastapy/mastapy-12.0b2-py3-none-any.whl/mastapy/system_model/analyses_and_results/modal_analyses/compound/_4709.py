...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4707, _4708, _4720
...
class CylindricalGearSetCompoundModalAnalysis(_4720.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4557.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis(self) -> 'List[_4707.CylindricalGearCompoundModalAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis(self) -> 'List[_4708.CylindricalGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4557.CylindricalGearSetModalAnalysis]':
