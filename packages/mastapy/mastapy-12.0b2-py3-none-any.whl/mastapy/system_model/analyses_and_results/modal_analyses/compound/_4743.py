...
class PlanetaryConnectionCompoundModalAnalysis(_4757.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    """PlanetaryConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4598.PlanetaryConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4598.PlanetaryConnectionModalAnalysis]':
