...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4722, _4723, _4666
...
class HypoidGearSetCompoundModalAnalysis(_4666.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    """HypoidGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4575.HypoidGearSetModalAnalysis]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis(self) -> 'List[_4722.HypoidGearCompoundModalAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis(self) -> 'List[_4723.HypoidGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4575.HypoidGearSetModalAnalysis]':
