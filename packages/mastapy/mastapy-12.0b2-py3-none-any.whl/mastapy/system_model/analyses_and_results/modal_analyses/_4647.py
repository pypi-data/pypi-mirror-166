...
from mastapy.system_model.analyses_and_results.modal_analyses import _4646, _4645, _4525
...
class ZerolBevelGearSetModalAnalysis(_4525.BevelGearSetModalAnalysis):
    """ZerolBevelGearSetModalAnalysis
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4646.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4645.ZerolBevelGearMeshModalAnalysis]':
