...
class ConnectorModalAnalysis(_4591.MountableComponentModalAnalysis):
    """ConnectorModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2667.ConnectorSystemDeflection':
