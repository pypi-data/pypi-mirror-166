...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6304, _6305, _6216
...
class StraightBevelDiffGearSetDynamicAnalysis(_6216.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_diff_gears_dynamic_analysis(self) -> 'List[_6304.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_dynamic_analysis(self) -> 'List[_6305.StraightBevelDiffGearMeshDynamicAnalysis]':
