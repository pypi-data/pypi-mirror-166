...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6227, _6228, _6259
...
class ConceptGearSetDynamicAnalysis(_6259.GearSetDynamicAnalysis):
    """ConceptGearSetDynamicAnalysis
    ...
    @property
    def concept_gears_dynamic_analysis(self) -> 'List[_6227.ConceptGearDynamicAnalysis]':
    ...
    @property
    def concept_meshes_dynamic_analysis(self) -> 'List[_6228.ConceptGearMeshDynamicAnalysis]':
