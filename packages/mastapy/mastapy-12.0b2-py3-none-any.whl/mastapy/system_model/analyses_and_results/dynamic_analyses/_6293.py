...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2570, _6205
...
class RootAssemblyDynamicAnalysis(_6205.AssemblyDynamicAnalysis):
    """RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self) -> '_2570.DynamicAnalysis':
