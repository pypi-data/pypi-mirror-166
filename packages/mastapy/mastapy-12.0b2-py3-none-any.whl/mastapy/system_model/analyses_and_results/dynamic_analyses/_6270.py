...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6268, _6269, _6267
...
class KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis(_6267.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_dynamic_analysis(self) -> 'List[_6268.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_dynamic_analysis(self) -> 'List[_6269.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
