...
class PlanetaryConnectionCompoundDynamicAnalysis(_6425.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """PlanetaryConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6282.PlanetaryConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6282.PlanetaryConnectionDynamicAnalysis]':
