...
class RollingRingCompoundDynamicAnalysis(_6367.CouplingHalfCompoundDynamicAnalysis):
    """RollingRingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6292.RollingRingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6292.RollingRingDynamicAnalysis]':
