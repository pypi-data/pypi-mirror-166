...
class SpiralBevelGearMeshCompoundDynamicAnalysis(_6345.BevelGearMeshCompoundDynamicAnalysis):
    """SpiralBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6299.SpiralBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6299.SpiralBevelGearMeshDynamicAnalysis]':
