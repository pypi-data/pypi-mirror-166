...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6454, _6455, _6346
...
class ZerolBevelGearSetCompoundDynamicAnalysis(_6346.BevelGearSetCompoundDynamicAnalysis):
    """ZerolBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6327.ZerolBevelGearSetDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6454.ZerolBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6455.ZerolBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6327.ZerolBevelGearSetDynamicAnalysis]':
