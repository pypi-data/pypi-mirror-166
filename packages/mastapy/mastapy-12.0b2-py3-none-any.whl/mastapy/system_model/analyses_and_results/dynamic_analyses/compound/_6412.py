...
class PlanetaryGearSetCompoundDynamicAnalysis(_6377.CylindricalGearSetCompoundDynamicAnalysis):
    """PlanetaryGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6283.PlanetaryGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6283.PlanetaryGearSetDynamicAnalysis]':
