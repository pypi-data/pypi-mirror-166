...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6433, _6434, _6346
...
class StraightBevelDiffGearSetCompoundDynamicAnalysis(_6346.BevelGearSetCompoundDynamicAnalysis):
    """StraightBevelDiffGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6306.StraightBevelDiffGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_dynamic_analysis(self) -> 'List[_6433.StraightBevelDiffGearCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_dynamic_analysis(self) -> 'List[_6434.StraightBevelDiffGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6306.StraightBevelDiffGearSetDynamicAnalysis]':
