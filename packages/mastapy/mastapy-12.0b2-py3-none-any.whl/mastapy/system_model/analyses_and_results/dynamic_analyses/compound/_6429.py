...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6427, _6428, _6346
...
class SpiralBevelGearSetCompoundDynamicAnalysis(_6346.BevelGearSetCompoundDynamicAnalysis):
    """SpiralBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6300.SpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6427.SpiralBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6428.SpiralBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6300.SpiralBevelGearSetDynamicAnalysis]':
