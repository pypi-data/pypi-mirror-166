...
class GuideDxfModelCompoundDynamicAnalysis(_6353.ComponentCompoundDynamicAnalysis):
    """GuideDxfModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6260.GuideDxfModelDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6260.GuideDxfModelDynamicAnalysis]':
