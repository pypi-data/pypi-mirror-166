...
class AGMAGleasonConicalGearCompoundDynamicAnalysis(_6360.ConicalGearCompoundDynamicAnalysis):
    """AGMAGleasonConicalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6202.AGMAGleasonConicalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6202.AGMAGleasonConicalGearDynamicAnalysis]':
