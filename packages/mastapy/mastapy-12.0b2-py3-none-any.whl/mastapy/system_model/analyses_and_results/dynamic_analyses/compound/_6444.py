...
class SynchroniserSleeveCompoundDynamicAnalysis(_6443.SynchroniserPartCompoundDynamicAnalysis):
    """SynchroniserSleeveCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6315.SynchroniserSleeveDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6315.SynchroniserSleeveDynamicAnalysis]':
