...
class TorqueConverterPumpCompoundDynamicAnalysis(_6367.CouplingHalfCompoundDynamicAnalysis):
    """TorqueConverterPumpCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6318.TorqueConverterPumpDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6318.TorqueConverterPumpDynamicAnalysis]':
