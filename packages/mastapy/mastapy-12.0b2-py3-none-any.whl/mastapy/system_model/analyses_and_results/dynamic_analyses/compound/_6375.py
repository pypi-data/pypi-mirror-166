...
class CylindricalGearCompoundDynamicAnalysis(_6386.GearCompoundDynamicAnalysis):
    """CylindricalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6245.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6245.CylindricalGearDynamicAnalysis]':
