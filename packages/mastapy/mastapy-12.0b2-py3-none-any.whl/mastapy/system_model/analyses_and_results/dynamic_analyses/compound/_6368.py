...
class CVTBeltConnectionCompoundDynamicAnalysis(_6337.BeltConnectionCompoundDynamicAnalysis):
    """CVTBeltConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6238.CVTBeltConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6238.CVTBeltConnectionDynamicAnalysis]':
