...
class BearingCompoundDynamicAnalysis(_6364.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6206.BearingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6206.BearingDynamicAnalysis]':
