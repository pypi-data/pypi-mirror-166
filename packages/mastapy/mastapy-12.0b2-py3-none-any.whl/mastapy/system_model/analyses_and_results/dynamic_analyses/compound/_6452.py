...
class WormGearMeshCompoundDynamicAnalysis(_6387.GearMeshCompoundDynamicAnalysis):
    """WormGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6323.WormGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6323.WormGearMeshDynamicAnalysis]':
