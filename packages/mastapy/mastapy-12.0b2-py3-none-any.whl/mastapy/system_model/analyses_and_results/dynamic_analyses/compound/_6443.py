...
class SynchroniserPartCompoundDynamicAnalysis(_6367.CouplingHalfCompoundDynamicAnalysis):
    """SynchroniserPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6314.SynchroniserPartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6314.SynchroniserPartDynamicAnalysis]':
