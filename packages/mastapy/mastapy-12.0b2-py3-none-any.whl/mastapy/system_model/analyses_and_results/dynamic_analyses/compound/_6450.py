...
class VirtualComponentCompoundDynamicAnalysis(_6405.MountableComponentCompoundDynamicAnalysis):
    """VirtualComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6321.VirtualComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6321.VirtualComponentDynamicAnalysis]':
