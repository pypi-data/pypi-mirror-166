...
class ShaftCompoundDynamicAnalysis(_6329.AbstractShaftCompoundDynamicAnalysis):
    """ShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6294.ShaftDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6294.ShaftDynamicAnalysis]':
