...
class ConnectorCompoundDynamicAnalysis(_6405.MountableComponentCompoundDynamicAnalysis):
    """ConnectorCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6234.ConnectorDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6234.ConnectorDynamicAnalysis]':
