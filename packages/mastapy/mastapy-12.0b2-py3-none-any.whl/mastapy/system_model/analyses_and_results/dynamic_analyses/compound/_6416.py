...
class PulleyCompoundDynamicAnalysis(_6367.CouplingHalfCompoundDynamicAnalysis):
    """PulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6287.PulleyDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6287.PulleyDynamicAnalysis]':
