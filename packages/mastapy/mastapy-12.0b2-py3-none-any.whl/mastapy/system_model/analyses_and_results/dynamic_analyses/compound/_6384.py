...
class FEPartCompoundDynamicAnalysis(_6330.AbstractShaftOrHousingCompoundDynamicAnalysis):
    """FEPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6255.FEPartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6255.FEPartDynamicAnalysis]':
