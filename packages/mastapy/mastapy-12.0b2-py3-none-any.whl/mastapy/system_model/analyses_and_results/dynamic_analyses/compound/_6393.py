...
class InterMountableComponentConnectionCompoundDynamicAnalysis(_6363.ConnectionCompoundDynamicAnalysis):
    """InterMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6264.InterMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6264.InterMountableComponentConnectionDynamicAnalysis]':
