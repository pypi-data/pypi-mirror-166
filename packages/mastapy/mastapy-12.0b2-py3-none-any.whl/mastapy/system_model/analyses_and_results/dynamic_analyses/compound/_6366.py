...
class CouplingConnectionCompoundDynamicAnalysis(_6393.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """CouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6235.CouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6235.CouplingConnectionDynamicAnalysis]':
