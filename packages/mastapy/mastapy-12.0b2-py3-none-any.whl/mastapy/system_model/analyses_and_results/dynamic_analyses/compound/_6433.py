...
class StraightBevelDiffGearCompoundDynamicAnalysis(_6344.BevelGearCompoundDynamicAnalysis):
    """StraightBevelDiffGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6304.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6304.StraightBevelDiffGearDynamicAnalysis]':
