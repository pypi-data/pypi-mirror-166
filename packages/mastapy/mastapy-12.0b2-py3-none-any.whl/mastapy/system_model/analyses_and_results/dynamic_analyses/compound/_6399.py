...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6397, _6398, _6396
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis(_6396.KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6270.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_dynamic_analysis(self) -> 'List[_6397.KlingelnbergCycloPalloidHypoidGearCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_dynamic_analysis(self) -> 'List[_6398.KlingelnbergCycloPalloidHypoidGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6270.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
