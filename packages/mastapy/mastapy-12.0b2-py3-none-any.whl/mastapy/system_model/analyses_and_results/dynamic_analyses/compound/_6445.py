...
class TorqueConverterCompoundDynamicAnalysis(_6365.CouplingCompoundDynamicAnalysis):
    """TorqueConverterCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6317.TorqueConverterDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6317.TorqueConverterDynamicAnalysis]':
