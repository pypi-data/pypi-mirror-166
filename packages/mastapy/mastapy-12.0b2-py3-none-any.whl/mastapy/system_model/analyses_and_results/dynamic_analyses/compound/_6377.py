...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6375, _6376, _6388
...
class CylindricalGearSetCompoundDynamicAnalysis(_6388.GearSetCompoundDynamicAnalysis):
    """CylindricalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6247.CylindricalGearSetDynamicAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_dynamic_analysis(self) -> 'List[_6375.CylindricalGearCompoundDynamicAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_dynamic_analysis(self) -> 'List[_6376.CylindricalGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6247.CylindricalGearSetDynamicAnalysis]':
