...
class ConceptCouplingCompoundDynamicAnalysis(_6365.CouplingCompoundDynamicAnalysis):
    """ConceptCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6225.ConceptCouplingDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6225.ConceptCouplingDynamicAnalysis]':
