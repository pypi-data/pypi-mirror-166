...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6451, _6452, _6388
...
class WormGearSetCompoundDynamicAnalysis(_6388.GearSetCompoundDynamicAnalysis):
    """WormGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6324.WormGearSetDynamicAnalysis]':
    ...
    @property
    def worm_gears_compound_dynamic_analysis(self) -> 'List[_6451.WormGearCompoundDynamicAnalysis]':
    ...
    @property
    def worm_meshes_compound_dynamic_analysis(self) -> 'List[_6452.WormGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6324.WormGearSetDynamicAnalysis]':
