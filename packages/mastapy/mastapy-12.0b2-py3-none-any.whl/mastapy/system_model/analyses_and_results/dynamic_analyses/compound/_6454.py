...
class ZerolBevelGearCompoundDynamicAnalysis(_6344.BevelGearCompoundDynamicAnalysis):
    """ZerolBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6325.ZerolBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6325.ZerolBevelGearDynamicAnalysis]':
