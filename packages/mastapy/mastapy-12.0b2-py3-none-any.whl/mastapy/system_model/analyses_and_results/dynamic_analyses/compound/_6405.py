...
class MountableComponentCompoundDynamicAnalysis(_6353.ComponentCompoundDynamicAnalysis):
    """MountableComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6276.MountableComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6276.MountableComponentDynamicAnalysis]':
