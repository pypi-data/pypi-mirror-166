...
class ShaftHubConnectionCompoundDynamicAnalysis(_6364.ConnectorCompoundDynamicAnalysis):
    """ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6295.ShaftHubConnectionDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6295.ShaftHubConnectionDynamicAnalysis]':
