...
class ConceptGearCompoundDynamicAnalysis(_6386.GearCompoundDynamicAnalysis):
    """ConceptGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6227.ConceptGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6227.ConceptGearDynamicAnalysis]':
