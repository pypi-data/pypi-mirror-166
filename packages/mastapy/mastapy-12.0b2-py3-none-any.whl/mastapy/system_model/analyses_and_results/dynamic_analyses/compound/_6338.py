...
class BeltDriveCompoundDynamicAnalysis(_6426.SpecialisedAssemblyCompoundDynamicAnalysis):
    """BeltDriveCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6208.BeltDriveDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6208.BeltDriveDynamicAnalysis]':
