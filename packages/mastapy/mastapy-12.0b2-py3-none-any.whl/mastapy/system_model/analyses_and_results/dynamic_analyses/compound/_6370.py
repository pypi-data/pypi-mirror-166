...
class CVTPulleyCompoundDynamicAnalysis(_6416.PulleyCompoundDynamicAnalysis):
    """CVTPulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6240.CVTPulleyDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6240.CVTPulleyDynamicAnalysis]':
