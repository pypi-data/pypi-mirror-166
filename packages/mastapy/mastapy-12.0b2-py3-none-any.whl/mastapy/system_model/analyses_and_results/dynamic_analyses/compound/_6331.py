...
class AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6363.ConnectionCompoundDynamicAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6201.AbstractShaftToMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6201.AbstractShaftToMountableComponentConnectionDynamicAnalysis]':
