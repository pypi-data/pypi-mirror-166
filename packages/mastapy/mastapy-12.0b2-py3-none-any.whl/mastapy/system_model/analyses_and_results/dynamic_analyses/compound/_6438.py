...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6436, _6437, _6346
...
class StraightBevelGearSetCompoundDynamicAnalysis(_6346.BevelGearSetCompoundDynamicAnalysis):
    """StraightBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6309.StraightBevelGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6436.StraightBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6437.StraightBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6309.StraightBevelGearSetDynamicAnalysis]':
