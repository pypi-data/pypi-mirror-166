...
class WormGearCompoundDynamicAnalysis(_6386.GearCompoundDynamicAnalysis):
    """WormGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6322.WormGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6322.WormGearDynamicAnalysis]':
