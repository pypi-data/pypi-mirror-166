...
class KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis(_6360.ConicalGearCompoundDynamicAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6265.KlingelnbergCycloPalloidConicalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6265.KlingelnbergCycloPalloidConicalGearDynamicAnalysis]':
