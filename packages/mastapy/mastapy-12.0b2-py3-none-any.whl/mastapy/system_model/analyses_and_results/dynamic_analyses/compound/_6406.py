...
class OilSealCompoundDynamicAnalysis(_6364.ConnectorCompoundDynamicAnalysis):
    """OilSealCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6277.OilSealDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6277.OilSealDynamicAnalysis]':
