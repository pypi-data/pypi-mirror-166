...
class TorqueConverterTurbineCompoundDynamicAnalysis(_6367.CouplingHalfCompoundDynamicAnalysis):
    """TorqueConverterTurbineCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6319.TorqueConverterTurbineDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6319.TorqueConverterTurbineDynamicAnalysis]':
