...
class BevelDifferentialGearMeshCompoundDynamicAnalysis(_6345.BevelGearMeshCompoundDynamicAnalysis):
    """BevelDifferentialGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6210.BevelDifferentialGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6210.BevelDifferentialGearMeshDynamicAnalysis]':
