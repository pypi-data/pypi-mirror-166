...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6357, _6358, _6388
...
class ConceptGearSetCompoundDynamicAnalysis(_6388.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6229.ConceptGearSetDynamicAnalysis]':
    ...
    @property
    def concept_gears_compound_dynamic_analysis(self) -> 'List[_6357.ConceptGearCompoundDynamicAnalysis]':
    ...
    @property
    def concept_meshes_compound_dynamic_analysis(self) -> 'List[_6358.ConceptGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6229.ConceptGearSetDynamicAnalysis]':
