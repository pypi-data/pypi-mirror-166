...
class ConceptCouplingHalfCompoundDynamicAnalysis(_6367.CouplingHalfCompoundDynamicAnalysis):
    """ConceptCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6226.ConceptCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6226.ConceptCouplingHalfDynamicAnalysis]':
