...
class TorqueConverterConnectionCompoundDynamicAnalysis(_6366.CouplingConnectionCompoundDynamicAnalysis):
    """TorqueConverterConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6316.TorqueConverterConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6316.TorqueConverterConnectionDynamicAnalysis]':
