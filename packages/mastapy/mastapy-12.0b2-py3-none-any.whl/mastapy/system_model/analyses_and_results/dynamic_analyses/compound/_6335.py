...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import (
    _6336, _6338, _6341, _6348,
    _6347, _6369, _6349, _6354,
    _6359, _6371, _6373, _6377,
    _6384, _6383, _6385, _6392,
    _6399, _6402, _6403, _6404,
    _6406, _6408, _6413, _6414,
    _6415, _6417, _6419, _6424,
    _6423, _6429, _6430, _6435,
    _6438, _6441, _6445, _6449,
    _6453, _6456, _6328
)
...
class AssemblyCompoundDynamicAnalysis(_6328.AbstractAssemblyCompoundDynamicAnalysis):
    """AssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6205.AssemblyDynamicAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_6336.BearingCompoundDynamicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6338.BeltDriveCompoundDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6341.BevelDifferentialGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6348.BoltedJointCompoundDynamicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6347.BoltCompoundDynamicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6369.CVTCompoundDynamicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6349.ClutchCompoundDynamicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6354.ConceptCouplingCompoundDynamicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6359.ConceptGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6371.CycloidalAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6373.CycloidalDiscCompoundDynamicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6377.CylindricalGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6384.FEPartCompoundDynamicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6383.FaceGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6385.FlexiblePinAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6392.HypoidGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6399.KlingelnbergCycloPalloidHypoidGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6402.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6403.MassDiscCompoundDynamicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6404.MeasurementComponentCompoundDynamicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6406.OilSealCompoundDynamicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6408.PartToPartShearCouplingCompoundDynamicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6413.PlanetCarrierCompoundDynamicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6414.PointLoadCompoundDynamicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6415.PowerLoadCompoundDynamicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6417.RingPinsCompoundDynamicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6419.RollingRingAssemblyCompoundDynamicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6424.ShaftHubConnectionCompoundDynamicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6423.ShaftCompoundDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6429.SpiralBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6430.SpringDamperCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6435.StraightBevelDiffGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6438.StraightBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6441.SynchroniserCompoundDynamicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6445.TorqueConverterCompoundDynamicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6449.UnbalancedMassCompoundDynamicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6453.WormGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6456.ZerolBevelGearSetCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6205.AssemblyDynamicAnalysis]':
