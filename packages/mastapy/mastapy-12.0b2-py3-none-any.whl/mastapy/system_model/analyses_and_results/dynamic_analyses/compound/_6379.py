...
class DatumCompoundDynamicAnalysis(_6353.ComponentCompoundDynamicAnalysis):
    """DatumCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6249.DatumDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6249.DatumDynamicAnalysis]':
