...
class BoltCompoundDynamicAnalysis(_6353.ComponentCompoundDynamicAnalysis):
    """BoltCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6217.BoltDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6217.BoltDynamicAnalysis]':
