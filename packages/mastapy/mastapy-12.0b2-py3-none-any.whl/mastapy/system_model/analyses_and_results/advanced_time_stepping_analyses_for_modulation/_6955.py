...
class ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation(_6966.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2656.ConceptCouplingConnectionSystemDeflection':
