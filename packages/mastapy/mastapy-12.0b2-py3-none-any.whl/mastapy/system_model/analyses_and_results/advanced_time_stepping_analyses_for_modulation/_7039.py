...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7037, _7038, _6946
...
class StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6946.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2756.StraightBevelGearSetSystemDeflection':
    ...
    @property
    def straight_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7037.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7038.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
