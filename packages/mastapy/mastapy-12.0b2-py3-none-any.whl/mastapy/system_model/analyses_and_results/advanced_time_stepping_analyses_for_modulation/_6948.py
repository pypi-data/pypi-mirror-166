...
class BoltedJointAdvancedTimeSteppingAnalysisForModulation(_7027.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """BoltedJointAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2648.BoltedJointSystemDeflection':
