...
class TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation(_6967.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2768.TorqueConverterPumpSystemDeflection':
