...
class BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6939.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2643.BevelDifferentialPlanetGearSystemDeflection':
