...
class ConicalGearAdvancedTimeSteppingAnalysisForModulation(_6986.GearAdvancedTimeSteppingAnalysisForModulation):
    """ConicalGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2665.ConicalGearSystemDeflection':
