...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6991, _6992, _6933
...
class HypoidGearSetAdvancedTimeSteppingAnalysisForModulation(_6933.AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2703.HypoidGearSetSystemDeflection':
    ...
    @property
    def hypoid_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6991.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6992.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
