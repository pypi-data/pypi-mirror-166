...
class ClutchAdvancedTimeSteppingAnalysisForModulation(_6965.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """ClutchAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2652.ClutchSystemDeflection':
