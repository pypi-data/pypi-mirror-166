...
from mastapy.system_model.analyses_and_results.system_deflections import _2631, _2677, _2743
...
class AbstractShaftAdvancedTimeSteppingAnalysisForModulation(_6926.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2381.AbstractShaft':
    ...
    @property
    def system_deflection_results(self) -> '_2631.AbstractShaftSystemDeflection':
