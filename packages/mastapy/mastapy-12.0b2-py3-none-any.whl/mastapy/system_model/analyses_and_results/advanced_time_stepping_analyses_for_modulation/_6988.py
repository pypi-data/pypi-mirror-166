...
class GearSetAdvancedTimeSteppingAnalysisForModulation(_7027.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """GearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def eignenmodes_indexed_by_mode_id(self) -> 'List[_1468.Eigenmodes]':
