...
class RollingRingAdvancedTimeSteppingAnalysisForModulation(_6967.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2738.RollingRingSystemDeflection':
