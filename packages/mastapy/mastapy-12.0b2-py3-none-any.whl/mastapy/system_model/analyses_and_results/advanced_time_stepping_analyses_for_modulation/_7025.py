...
class ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation(_6964.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2740.ShaftHubConnectionSystemDeflection':
