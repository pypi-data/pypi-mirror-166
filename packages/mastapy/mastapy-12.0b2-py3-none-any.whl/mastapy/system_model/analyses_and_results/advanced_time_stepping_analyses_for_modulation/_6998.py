...
class KlingelnbergCycloPalloidHypoidGearAdvancedTimeSteppingAnalysisForModulation(_6995.KlingelnbergCycloPalloidConicalGearAdvancedTimeSteppingAnalysisForModulation):
    """KlingelnbergCycloPalloidHypoidGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6834.KlingelnbergCycloPalloidHypoidGearLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2712.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
