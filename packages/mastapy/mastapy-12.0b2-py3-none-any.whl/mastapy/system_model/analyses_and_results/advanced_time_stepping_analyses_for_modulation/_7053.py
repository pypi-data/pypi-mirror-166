...
class WormGearMeshAdvancedTimeSteppingAnalysisForModulation(_6987.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """WormGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6902.WormGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2775.WormGearMeshSystemDeflection':
