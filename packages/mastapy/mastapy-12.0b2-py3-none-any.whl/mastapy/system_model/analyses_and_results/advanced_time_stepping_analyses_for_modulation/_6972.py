...
class CycloidalDiscAdvancedTimeSteppingAnalysisForModulation(_6925.AbstractShaftAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6778.CycloidalDiscLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2677.CycloidalDiscSystemDeflection':
