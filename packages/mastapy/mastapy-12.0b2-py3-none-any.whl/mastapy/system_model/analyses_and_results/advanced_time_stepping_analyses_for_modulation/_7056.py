...
class ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6945.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6905.ZerolBevelGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2778.ZerolBevelGearMeshSystemDeflection':
