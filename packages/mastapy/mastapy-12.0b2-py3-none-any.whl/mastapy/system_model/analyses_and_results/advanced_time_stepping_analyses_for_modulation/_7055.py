...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(_6944.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2780.ZerolBevelGearSystemDeflection':
