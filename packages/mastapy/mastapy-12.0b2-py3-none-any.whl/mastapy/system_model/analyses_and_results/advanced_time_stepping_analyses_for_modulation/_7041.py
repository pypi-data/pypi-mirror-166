...
class StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation(_7034.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2759.StraightBevelSunGearSystemDeflection':
