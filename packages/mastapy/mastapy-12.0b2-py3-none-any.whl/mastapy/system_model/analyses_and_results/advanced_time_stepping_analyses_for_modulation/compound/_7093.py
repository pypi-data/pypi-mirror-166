...
class ConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6963.ConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6963.ConnectionAdvancedTimeSteppingAnalysisForModulation]':
