...
class VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7135.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7051.VirtualComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7051.VirtualComponentAdvancedTimeSteppingAnalysisForModulation]':
