...
class RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation(_7097.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7020.RollingRingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7020.RollingRingAdvancedTimeSteppingAnalysisForModulation]':
