...
class SpiralBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7075.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2268.SpiralBevelGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7029.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7029.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
