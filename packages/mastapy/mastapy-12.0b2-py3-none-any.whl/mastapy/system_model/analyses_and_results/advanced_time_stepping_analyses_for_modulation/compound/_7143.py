...
class PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation(_7135.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetCarrierCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7014.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7014.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
