...
class ComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7137.PartCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6953.ComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6953.ComponentAdvancedTimeSteppingAnalysisForModulation]':
