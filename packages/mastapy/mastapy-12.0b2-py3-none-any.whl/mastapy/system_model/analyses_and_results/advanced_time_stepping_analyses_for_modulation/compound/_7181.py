...
class WormGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7116.GearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """WormGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7052.WormGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7052.WormGearAdvancedTimeSteppingAnalysisForModulation]':
