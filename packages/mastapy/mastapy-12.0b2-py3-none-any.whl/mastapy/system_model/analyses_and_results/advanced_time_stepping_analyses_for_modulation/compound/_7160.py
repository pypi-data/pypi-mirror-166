...
class SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation(_7095.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2544.SpringDamper':
    ...
    @property
    def assembly_design(self) -> '_2544.SpringDamper':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7031.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7031.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
