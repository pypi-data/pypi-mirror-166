...
class CVTPulleyCompoundAdvancedTimeSteppingAnalysisForModulation(_7146.PulleyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CVTPulleyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6970.CVTPulleyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6970.CVTPulleyAdvancedTimeSteppingAnalysisForModulation]':
