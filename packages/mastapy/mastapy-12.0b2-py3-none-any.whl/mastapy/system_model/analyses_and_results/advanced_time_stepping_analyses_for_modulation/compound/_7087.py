...
class ConceptGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7116.GearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6957.ConceptGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6957.ConceptGearAdvancedTimeSteppingAnalysisForModulation]':
