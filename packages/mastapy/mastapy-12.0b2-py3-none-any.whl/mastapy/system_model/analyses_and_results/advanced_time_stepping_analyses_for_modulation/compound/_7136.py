...
class OilSealCompoundAdvancedTimeSteppingAnalysisForModulation(_7094.ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation):
    """OilSealCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2411.OilSeal':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7007.OilSealAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7007.OilSealAdvancedTimeSteppingAnalysisForModulation]':
