...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7087, _7088, _7118
...
class ConceptGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7118.GearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2466.ConceptGearSet':
    ...
    @property
    def assembly_design(self) -> '_2466.ConceptGearSet':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6959.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7087.ConceptGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7088.ConceptGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6959.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]':
