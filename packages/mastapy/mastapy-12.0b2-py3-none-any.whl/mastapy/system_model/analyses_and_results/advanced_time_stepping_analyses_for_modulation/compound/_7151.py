...
class RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7123.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2237.RollingRingConnection':
    ...
    @property
    def connection_design(self) -> '_2237.RollingRingConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7022.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7022.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
