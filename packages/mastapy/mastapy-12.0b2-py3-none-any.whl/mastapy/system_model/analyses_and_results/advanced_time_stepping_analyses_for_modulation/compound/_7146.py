...
class PulleyCompoundAdvancedTimeSteppingAnalysisForModulation(_7097.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PulleyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7017.PulleyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7017.PulleyAdvancedTimeSteppingAnalysisForModulation]':
