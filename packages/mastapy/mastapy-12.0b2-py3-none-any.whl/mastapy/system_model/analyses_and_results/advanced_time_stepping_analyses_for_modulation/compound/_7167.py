...
class StraightBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7075.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2272.StraightBevelGearMesh':
    ...
    @property
    def connection_design(self) -> '_2272.StraightBevelGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7038.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7038.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
