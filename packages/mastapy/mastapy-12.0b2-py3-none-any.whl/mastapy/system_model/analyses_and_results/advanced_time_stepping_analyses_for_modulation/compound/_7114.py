...
class FEPartCompoundAdvancedTimeSteppingAnalysisForModulation(_7060.AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """FEPartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6984.FEPartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6984.FEPartAdvancedTimeSteppingAnalysisForModulation]':
