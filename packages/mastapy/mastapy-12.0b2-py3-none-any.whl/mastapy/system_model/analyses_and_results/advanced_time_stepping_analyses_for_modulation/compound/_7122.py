...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7120, _7121, _7064
...
class HypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7064.AGMAGleasonConicalGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6993.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7120.HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7121.HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6993.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
