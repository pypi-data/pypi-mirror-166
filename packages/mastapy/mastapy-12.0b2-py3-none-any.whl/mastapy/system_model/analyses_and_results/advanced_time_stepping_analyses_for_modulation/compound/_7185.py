...
class ZerolBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7075.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2276.ZerolBevelGearMesh':
    ...
    @property
    def connection_design(self) -> '_2276.ZerolBevelGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7056.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7056.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
