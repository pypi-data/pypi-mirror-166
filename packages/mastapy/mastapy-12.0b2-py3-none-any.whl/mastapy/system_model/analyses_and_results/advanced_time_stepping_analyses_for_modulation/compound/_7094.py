...
class ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation(_7135.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6964.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6964.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
