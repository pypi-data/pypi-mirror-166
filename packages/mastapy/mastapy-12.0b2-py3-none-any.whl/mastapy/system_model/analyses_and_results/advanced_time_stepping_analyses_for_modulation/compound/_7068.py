...
class BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation(_7156.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2520.BeltDrive':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6938.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6938.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
