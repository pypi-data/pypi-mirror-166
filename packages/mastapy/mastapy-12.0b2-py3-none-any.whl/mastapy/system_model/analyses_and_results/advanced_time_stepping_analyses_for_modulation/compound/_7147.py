...
class RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation(_7135.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7018.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7018.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
