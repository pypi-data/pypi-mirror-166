...
class SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation(_7097.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7044.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7044.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation]':
