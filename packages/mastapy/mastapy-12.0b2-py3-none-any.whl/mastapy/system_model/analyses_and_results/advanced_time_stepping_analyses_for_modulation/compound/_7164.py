...
class StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_7075.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2270.StraightBevelDiffGearMesh':
    ...
    @property
    def connection_design(self) -> '_2270.StraightBevelDiffGearMesh':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7035.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7035.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
