...
class UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation(_7180.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """UnbalancedMassCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7050.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7050.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
