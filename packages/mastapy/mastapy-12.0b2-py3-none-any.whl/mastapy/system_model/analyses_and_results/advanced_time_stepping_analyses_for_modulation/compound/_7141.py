...
class PlanetaryConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7155.ShaftToMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2232.PlanetaryConnection':
    ...
    @property
    def connection_design(self) -> '_2232.PlanetaryConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7012.PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7012.PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation]':
