...
class PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation(_7180.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PointLoadCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7015.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7015.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
