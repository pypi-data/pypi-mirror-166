...
class SynchroniserCompoundAdvancedTimeSteppingAnalysisForModulation(_7156.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2546.Synchroniser':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7042.SynchroniserAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7042.SynchroniserAdvancedTimeSteppingAnalysisForModulation]':
