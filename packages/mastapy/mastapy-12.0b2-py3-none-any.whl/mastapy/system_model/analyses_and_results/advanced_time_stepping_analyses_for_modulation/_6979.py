...
class DatumAdvancedTimeSteppingAnalysisForModulation(_6953.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """DatumAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2690.DatumSystemDeflection':
