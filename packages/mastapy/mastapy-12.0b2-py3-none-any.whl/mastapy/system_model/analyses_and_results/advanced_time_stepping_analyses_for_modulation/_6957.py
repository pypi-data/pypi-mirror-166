...
class ConceptGearAdvancedTimeSteppingAnalysisForModulation(_6986.GearAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2661.ConceptGearSystemDeflection':
