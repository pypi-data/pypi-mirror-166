...
class StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation(_7034.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2758.StraightBevelPlanetGearSystemDeflection':
