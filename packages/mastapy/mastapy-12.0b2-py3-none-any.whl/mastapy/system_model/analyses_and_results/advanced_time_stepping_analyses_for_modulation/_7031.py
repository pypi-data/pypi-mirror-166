...
class SpringDamperAdvancedTimeSteppingAnalysisForModulation(_6965.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6877.SpringDamperLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2751.SpringDamperSystemDeflection':
