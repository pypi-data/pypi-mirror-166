...
class CVTPulleyAdvancedTimeSteppingAnalysisForModulation(_7017.PulleyAdvancedTimeSteppingAnalysisForModulation):
    """CVTPulleyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2672.CVTPulleySystemDeflection':
