...
class MassDiscAdvancedTimeSteppingAnalysisForModulation(_7051.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """MassDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6840.MassDiscLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2718.MassDiscSystemDeflection':
