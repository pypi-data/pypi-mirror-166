...
class PowerLoadAdvancedTimeSteppingAnalysisForModulation(_7051.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    """PowerLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2731.PowerLoadSystemDeflection':
