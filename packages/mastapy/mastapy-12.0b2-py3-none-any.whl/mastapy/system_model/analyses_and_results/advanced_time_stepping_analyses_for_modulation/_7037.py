...
class StraightBevelGearAdvancedTimeSteppingAnalysisForModulation(_6944.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6881.StraightBevelGearLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2757.StraightBevelGearSystemDeflection':
