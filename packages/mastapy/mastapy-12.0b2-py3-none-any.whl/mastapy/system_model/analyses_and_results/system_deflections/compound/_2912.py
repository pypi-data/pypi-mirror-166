...
class TorqueConverterTurbineCompoundSystemDeflection(_2829.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterTurbineCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2770.TorqueConverterTurbineSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2770.TorqueConverterTurbineSystemDeflection]':
