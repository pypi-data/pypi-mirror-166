...
class PartToPartShearCouplingConnectionCompoundSystemDeflection(_2828.CouplingConnectionCompoundSystemDeflection):
    """PartToPartShearCouplingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2725.PartToPartShearCouplingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2725.PartToPartShearCouplingConnectionSystemDeflection]':
