...
class VirtualComponentCompoundSystemDeflection(_2868.MountableComponentCompoundSystemDeflection):
    """VirtualComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2774.VirtualComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2774.VirtualComponentSystemDeflection]':
