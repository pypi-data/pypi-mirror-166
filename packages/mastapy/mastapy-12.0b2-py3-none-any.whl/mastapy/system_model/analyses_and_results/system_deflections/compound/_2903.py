...
class StraightBevelPlanetGearCompoundSystemDeflection(_2897.StraightBevelDiffGearCompoundSystemDeflection):
    """StraightBevelPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2758.StraightBevelPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2758.StraightBevelPlanetGearSystemDeflection]':
