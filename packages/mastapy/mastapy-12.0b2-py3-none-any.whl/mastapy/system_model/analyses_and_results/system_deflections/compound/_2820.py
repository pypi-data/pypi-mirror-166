...
class ConceptGearMeshCompoundSystemDeflection(_2850.GearMeshCompoundSystemDeflection):
    """ConceptGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2659.ConceptGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2659.ConceptGearMeshSystemDeflection]':
