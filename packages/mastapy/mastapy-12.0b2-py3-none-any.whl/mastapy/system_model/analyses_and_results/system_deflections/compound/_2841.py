...
class DatumCompoundSystemDeflection(_2815.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2690.DatumSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2690.DatumSystemDeflection]':
