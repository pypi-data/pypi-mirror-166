...
class SpringDamperCompoundSystemDeflection(_2827.CouplingCompoundSystemDeflection):
    """SpringDamperCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2751.SpringDamperSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2751.SpringDamperSystemDeflection]':
