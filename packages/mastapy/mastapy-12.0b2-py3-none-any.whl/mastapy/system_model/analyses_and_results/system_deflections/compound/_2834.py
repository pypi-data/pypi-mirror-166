...
class CycloidalDiscCentralBearingConnectionCompoundSystemDeflection(_2814.CoaxialConnectionCompoundSystemDeflection):
    """CycloidalDiscCentralBearingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2675.CycloidalDiscCentralBearingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2675.CycloidalDiscCentralBearingConnectionSystemDeflection]':
