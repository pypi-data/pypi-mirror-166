...
class OilSealCompoundSystemDeflection(_2826.ConnectorCompoundSystemDeflection):
    """OilSealCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2723.OilSealSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2723.OilSealSystemDeflection]':
