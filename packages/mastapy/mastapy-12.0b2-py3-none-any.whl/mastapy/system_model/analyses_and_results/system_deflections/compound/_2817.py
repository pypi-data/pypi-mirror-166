...
class ConceptCouplingConnectionCompoundSystemDeflection(_2828.CouplingConnectionCompoundSystemDeflection):
    """ConceptCouplingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2656.ConceptCouplingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2656.ConceptCouplingConnectionSystemDeflection]':
