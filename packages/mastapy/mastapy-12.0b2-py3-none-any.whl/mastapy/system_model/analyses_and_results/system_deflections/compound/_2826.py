...
class ConnectorCompoundSystemDeflection(_2868.MountableComponentCompoundSystemDeflection):
    """ConnectorCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2667.ConnectorSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2667.ConnectorSystemDeflection]':
