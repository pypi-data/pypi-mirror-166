...
class MassDiscCompoundSystemDeflection(_2914.VirtualComponentCompoundSystemDeflection):
    """MassDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2718.MassDiscSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2718.MassDiscSystemDeflection]':
