...
class PartCompoundSystemDeflection(_7463.PartCompoundAnalysis):
    """PartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2724.PartSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2724.PartSystemDeflection]':
