...
class ExternalCADModelCompoundSystemDeflection(_2815.ComponentCompoundSystemDeflection):
    """ExternalCADModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2691.ExternalCADModelSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2691.ExternalCADModelSystemDeflection]':
