...
class WormGearMeshCompoundSystemDeflection(_2850.GearMeshCompoundSystemDeflection):
    """WormGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2775.WormGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2775.WormGearMeshSystemDeflection]':
