...
class AGMAGleasonConicalGearCompoundSystemDeflection(_2822.ConicalGearCompoundSystemDeflection):
    """AGMAGleasonConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2635.AGMAGleasonConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2635.AGMAGleasonConicalGearSystemDeflection]':
