...
class FEPartCompoundSystemDeflection(_2792.AbstractShaftOrHousingCompoundSystemDeflection):
    """FEPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2696.FEPartSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2696.FEPartSystemDeflection]':
