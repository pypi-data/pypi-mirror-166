...
class PulleyCompoundSystemDeflection(_2829.CouplingHalfCompoundSystemDeflection):
    """PulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2732.PulleySystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2732.PulleySystemDeflection]':
