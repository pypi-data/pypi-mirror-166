...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2897, _2898, _2808
...
class StraightBevelDiffGearSetCompoundSystemDeflection(_2808.BevelGearSetCompoundSystemDeflection):
    """StraightBevelDiffGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2753.StraightBevelDiffGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gears_compound_system_deflection(self) -> 'List[_2897.StraightBevelDiffGearCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_system_deflection(self) -> 'List[_2898.StraightBevelDiffGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2753.StraightBevelDiffGearSetSystemDeflection]':
