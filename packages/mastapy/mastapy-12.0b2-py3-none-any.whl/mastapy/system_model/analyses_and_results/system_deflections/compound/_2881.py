...
class RingPinsToDiscConnectionCompoundSystemDeflection(_2856.InterMountableComponentConnectionCompoundSystemDeflection):
    """RingPinsToDiscConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2734.RingPinsToDiscConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2734.RingPinsToDiscConnectionSystemDeflection]':
