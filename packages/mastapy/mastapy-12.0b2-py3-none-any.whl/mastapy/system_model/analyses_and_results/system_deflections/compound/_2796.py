...
class AGMAGleasonConicalGearSetCompoundSystemDeflection(_2824.ConicalGearSetCompoundSystemDeflection):
    """AGMAGleasonConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2634.AGMAGleasonConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2634.AGMAGleasonConicalGearSetSystemDeflection]':
