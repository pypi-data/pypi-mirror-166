...
class ClutchCompoundSystemDeflection(_2827.CouplingCompoundSystemDeflection):
    """ClutchCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2652.ClutchSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2652.ClutchSystemDeflection]':
