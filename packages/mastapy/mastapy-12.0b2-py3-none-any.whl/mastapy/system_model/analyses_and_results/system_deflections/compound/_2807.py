...
class BevelGearMeshCompoundSystemDeflection(_2795.AGMAGleasonConicalGearMeshCompoundSystemDeflection):
    """BevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2645.BevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2645.BevelGearMeshSystemDeflection]':
