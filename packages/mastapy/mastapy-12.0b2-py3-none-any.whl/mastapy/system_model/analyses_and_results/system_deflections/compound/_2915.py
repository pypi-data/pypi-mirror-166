...
class WormGearCompoundSystemDeflection(_2849.GearCompoundSystemDeflection):
    """WormGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2777.WormGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2777.WormGearSystemDeflection]':
