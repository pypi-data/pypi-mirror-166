...
class FaceGearMeshCompoundSystemDeflection(_2850.GearMeshCompoundSystemDeflection):
    """FaceGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2693.FaceGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2693.FaceGearMeshSystemDeflection]':
