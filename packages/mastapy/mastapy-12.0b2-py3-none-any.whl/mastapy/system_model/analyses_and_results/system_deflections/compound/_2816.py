...
class ConceptCouplingCompoundSystemDeflection(_2827.CouplingCompoundSystemDeflection):
    """ConceptCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2658.ConceptCouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2658.ConceptCouplingSystemDeflection]':
