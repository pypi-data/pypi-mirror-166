...
class CouplingCompoundSystemDeflection(_2890.SpecialisedAssemblyCompoundSystemDeflection):
    """CouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2670.CouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2670.CouplingSystemDeflection]':
