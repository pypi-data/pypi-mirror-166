...
class CVTCompoundSystemDeflection(_2800.BeltDriveCompoundSystemDeflection):
    """CVTCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2673.CVTSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2673.CVTSystemDeflection]':
