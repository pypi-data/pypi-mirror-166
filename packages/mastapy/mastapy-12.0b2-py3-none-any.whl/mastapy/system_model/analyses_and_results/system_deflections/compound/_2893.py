...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2891, _2892, _2808
...
class SpiralBevelGearSetCompoundSystemDeflection(_2808.BevelGearSetCompoundSystemDeflection):
    """SpiralBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2747.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_compound_system_deflection(self) -> 'List[_2891.SpiralBevelGearCompoundSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_compound_system_deflection(self) -> 'List[_2892.SpiralBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2747.SpiralBevelGearSetSystemDeflection]':
