...
class CylindricalGearCompoundSystemDeflection(_2849.GearCompoundSystemDeflection):
    """CylindricalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2686.CylindricalGearSystemDeflectionWithLTCAResults]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2686.CylindricalGearSystemDeflectionWithLTCAResults]':
