...
class FaceGearCompoundSystemDeflection(_2849.GearCompoundSystemDeflection):
    """FaceGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2695.FaceGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2695.FaceGearSystemDeflection]':
