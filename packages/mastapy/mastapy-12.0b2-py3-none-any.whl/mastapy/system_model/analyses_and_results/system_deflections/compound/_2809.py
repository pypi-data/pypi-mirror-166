...
class BoltCompoundSystemDeflection(_2815.ComponentCompoundSystemDeflection):
    """BoltCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2649.BoltSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2649.BoltSystemDeflection]':
