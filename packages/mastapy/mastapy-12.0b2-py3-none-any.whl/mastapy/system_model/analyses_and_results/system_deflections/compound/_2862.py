...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2860, _2861, _2859
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection(_2859.KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2711.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_system_deflection(self) -> 'List[_2860.KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_system_deflection(self) -> 'List[_2861.KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2711.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
