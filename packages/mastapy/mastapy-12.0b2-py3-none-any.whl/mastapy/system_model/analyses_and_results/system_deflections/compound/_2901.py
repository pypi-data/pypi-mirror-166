...
class StraightBevelGearMeshCompoundSystemDeflection(_2807.BevelGearMeshCompoundSystemDeflection):
    """StraightBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2755.StraightBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2755.StraightBevelGearMeshSystemDeflection]':
