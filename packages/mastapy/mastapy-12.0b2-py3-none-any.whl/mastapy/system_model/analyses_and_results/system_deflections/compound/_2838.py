...
class CylindricalGearMeshCompoundSystemDeflection(_2850.GearMeshCompoundSystemDeflection):
    """CylindricalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2680.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2680.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
