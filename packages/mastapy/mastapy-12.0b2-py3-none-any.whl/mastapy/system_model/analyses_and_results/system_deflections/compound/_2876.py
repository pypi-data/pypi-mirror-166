...
class PlanetCarrierCompoundSystemDeflection(_2868.MountableComponentCompoundSystemDeflection):
    """PlanetCarrierCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2729.PlanetCarrierSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2729.PlanetCarrierSystemDeflection]':
