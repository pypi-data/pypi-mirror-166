...
class KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection(_2824.ConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2708.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2708.KlingelnbergCycloPalloidConicalGearSetSystemDeflection]':
