...
class KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection(_2823.ConicalGearMeshCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2707.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2707.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection]':
