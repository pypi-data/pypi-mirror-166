...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2887, _2791
...
class ShaftCompoundSystemDeflection(_2791.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2887.ShaftDutyCycleSystemDeflection':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2743.ShaftSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2743.ShaftSystemDeflection]':
