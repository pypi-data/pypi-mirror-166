...
class PowerLoadCompoundSystemDeflection(_2914.VirtualComponentCompoundSystemDeflection):
    """PowerLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2731.PowerLoadSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2731.PowerLoadSystemDeflection]':
