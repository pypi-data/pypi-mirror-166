...
class ConnectionCompoundSystemDeflection(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2666.ConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2666.ConnectionSystemDeflection]':
