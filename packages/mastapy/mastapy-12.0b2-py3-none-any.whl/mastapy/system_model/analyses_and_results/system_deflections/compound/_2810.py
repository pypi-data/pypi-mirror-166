...
class BoltedJointCompoundSystemDeflection(_2890.SpecialisedAssemblyCompoundSystemDeflection):
    """BoltedJointCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2648.BoltedJointSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2648.BoltedJointSystemDeflection]':
