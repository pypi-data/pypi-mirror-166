...
class BevelDifferentialPlanetGearSystemDeflection(_2642.BevelDifferentialGearSystemDeflection):
    """BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3983.BevelDifferentialPlanetGearPowerFlow':
