...
from mastapy.system_model.analyses_and_results.system_deflections import _2695, _2693, _2699
...
class FaceGearSetSystemDeflection(_2699.GearSetSystemDeflection):
    """FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4025.FaceGearSetPowerFlow':
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2695.FaceGearSystemDeflection]':
    ...
    @property
    def face_meshes_system_deflection(self) -> 'List[_2693.FaceGearMeshSystemDeflection]':
