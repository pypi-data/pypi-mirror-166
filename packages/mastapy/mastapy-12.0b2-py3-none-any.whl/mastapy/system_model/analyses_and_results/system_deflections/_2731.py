...
from mastapy.system_model.analyses_and_results.system_deflections import _2772, _2774
...
class PowerLoadSystemDeflection(_2774.VirtualComponentSystemDeflection):
    """PowerLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4059.PowerLoadPowerFlow':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_2772.TransmissionErrorResult]':
