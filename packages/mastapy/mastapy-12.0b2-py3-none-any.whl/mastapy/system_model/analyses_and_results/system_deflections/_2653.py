...
from mastapy.system_model.analyses_and_results.power_flows import _3993, _4013
...
class CoaxialConnectionSystemDeflection(_2744.ShaftToMountableComponentConnectionSystemDeflection):
    """CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3993.CoaxialConnectionPowerFlow':
