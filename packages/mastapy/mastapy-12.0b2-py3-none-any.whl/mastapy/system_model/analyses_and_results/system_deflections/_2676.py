...
class CycloidalDiscPlanetaryBearingConnectionSystemDeflection(_2632.AbstractShaftToMountableComponentConnectionSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4014.CycloidalDiscPlanetaryBearingConnectionPowerFlow':
