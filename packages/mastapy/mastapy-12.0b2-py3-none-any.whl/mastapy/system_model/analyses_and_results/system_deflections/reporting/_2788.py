...
from mastapy.utility.enums import _1780
...
class ShaftSystemDeflectionSectionsReport(_1718.CustomReportChart):
    """ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1780.TableAndChartOptions':
        ...
        return constructor.new_from_mastapy_type(_1780.TableAndChartOptions)(value) if value is not None else None

    @display.setter
    def display(self, value: '_1780.TableAndChartOptions'):
