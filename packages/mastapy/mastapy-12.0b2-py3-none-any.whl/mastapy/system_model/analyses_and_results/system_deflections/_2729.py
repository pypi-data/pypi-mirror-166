...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2785
...
class PlanetCarrierSystemDeflection(_2721.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4055.PlanetCarrierPowerFlow':
    ...
    @property
    def windup(self) -> 'List[_2785.PlanetCarrierWindup]':
