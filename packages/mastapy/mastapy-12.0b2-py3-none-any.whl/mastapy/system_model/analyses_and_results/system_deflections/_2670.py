...
class CouplingSystemDeflection(_2745.SpecialisedAssemblySystemDeflection):
    """CouplingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4008.CouplingPowerFlow':
        ...
        if _4008.CouplingPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_clutch_power_flow(self) -> '_3992.ClutchPowerFlow':
        ...
        if _3992.ClutchPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_concept_coupling_power_flow(self) -> '_3997.ConceptCouplingPowerFlow':
        ...
        if _3997.ConceptCouplingPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_part_to_part_shear_coupling_power_flow(self) -> '_4052.PartToPartShearCouplingPowerFlow':
        ...
        if _4052.PartToPartShearCouplingPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_spring_damper_power_flow(self) -> '_4076.SpringDamperPowerFlow':
        ...
        if _4076.SpringDamperPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_torque_converter_power_flow(self) -> '_4091.TorqueConverterPowerFlow':
        ...
        if _4091.TorqueConverterPowerFlow.TYPE not in temp.__class__.__mro__:
