...
class AbstractShaftOrHousingSystemDeflection(_2654.ComponentSystemDeflection):
    """AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3970.AbstractShaftOrHousingPowerFlow':
