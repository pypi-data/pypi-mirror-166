...
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2743, _2681, _2682, _2683,
    _2637, _2740, _2717, _2722,
    _2684, _2745
)
...
class FlexiblePinAssemblySystemDeflection(_2745.SpecialisedAssemblySystemDeflection):
    """FlexiblePinAssemblySystemDeflection
    ...
    @property
    def flexible_pin_shaft_details(self) -> '_2743.ShaftSystemDeflection':
    ...
    @property
    def pin_analysis(self) -> '_2743.ShaftSystemDeflection':
    ...
    @property
    def power_flow_results(self) -> '_4027.FlexiblePinAssemblyPowerFlow':
    ...
    @property
    def separate_gear_set_details(self) -> '_2681.CylindricalGearSetSystemDeflection':
    ...
    @property
    def separate_gear_set_details_of_type_cylindrical_gear_set_system_deflection_timestep(self) -> '_2682.CylindricalGearSetSystemDeflectionTimestep':
    ...
    @property
    def separate_gear_set_details_of_type_cylindrical_gear_set_system_deflection_with_ltca_results(self) -> '_2683.CylindricalGearSetSystemDeflectionWithLTCAResults':
    ...
    @property
    def spindle_analyses(self) -> '_2743.ShaftSystemDeflection':
    ...
    @property
    def bearing_static_analyses(self) -> 'List[_2637.BearingSystemDeflection]':
    ...
    @property
    def flexible_pin_fit_details(self) -> 'List[_2740.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def load_sharing_factor_reporters(self) -> 'List[_2717.LoadSharingFactorReporter]':
    ...
    @property
    def observed_pin_stiffness_reporters(self) -> 'List[_2722.ObservedPinStiffnessReporter]':
    ...
    @property
    def pin_spindle_fit_analyses(self) -> 'List[_2740.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def planet_gear_system_deflections(self) -> 'List[_2684.CylindricalGearSystemDeflection]':
