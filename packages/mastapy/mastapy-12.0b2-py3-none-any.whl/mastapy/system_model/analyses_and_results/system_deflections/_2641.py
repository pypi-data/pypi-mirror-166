...
from mastapy.system_model.analyses_and_results.system_deflections import _2642, _2640, _2646
...
class BevelDifferentialGearSetSystemDeflection(_2646.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3982.BevelDifferentialGearSetPowerFlow':
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2642.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2640.BevelDifferentialGearMeshSystemDeflection]':
