...
from mastapy.system_model.analyses_and_results.system_deflections import _2780, _2778, _2646
...
class ZerolBevelGearSetSystemDeflection(_2646.BevelGearSetSystemDeflection):
    """ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4101.ZerolBevelGearSetPowerFlow':
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2780.ZerolBevelGearSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2778.ZerolBevelGearMeshSystemDeflection]':
