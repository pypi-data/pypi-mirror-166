...
class SpringDamperConnectionSystemDeflection(_2668.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4074.SpringDamperConnectionPowerFlow':
