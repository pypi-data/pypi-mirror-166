...
class AGMAGleasonConicalGearMeshSystemDeflection(_2663.ConicalGearMeshSystemDeflection):
    """AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3973.AGMAGleasonConicalGearMeshPowerFlow':
