...
from mastapy.system_model.analyses_and_results.system_deflections import _2735, _2706
...
class RingPinsToDiscConnectionSystemDeflection(_2706.InterMountableComponentConnectionSystemDeflection):
    """RingPinsToDiscConnectionSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6863.RingPinsToDiscConnectionLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4062.RingPinsToDiscConnectionPowerFlow':
    ...
    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2735.RingPinToDiscContactReporting]':
