...
from mastapy.system_model.analyses_and_results.system_deflections import _2760, _2745
...
class SynchroniserSystemDeflection(_2745.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4087.SynchroniserPowerFlow':
    ...
    @property
    def cones(self) -> 'List[_2760.SynchroniserHalfSystemDeflection]':
