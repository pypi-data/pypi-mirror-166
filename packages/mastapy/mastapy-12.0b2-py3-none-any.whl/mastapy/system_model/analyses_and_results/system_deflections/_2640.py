...
class BevelDifferentialGearMeshSystemDeflection(_2645.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3980.BevelDifferentialGearMeshPowerFlow':
