...
class BevelDifferentialSunGearSystemDeflection(_2642.BevelDifferentialGearSystemDeflection):
    """BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3984.BevelDifferentialSunGearPowerFlow':
