...
class BoltCompoundHarmonicAnalysis(_5826.ComponentCompoundHarmonicAnalysis):
    """BoltCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5628.BoltHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5628.BoltHarmonicAnalysis]':
