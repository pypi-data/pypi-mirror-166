...
class BeltDriveCompoundHarmonicAnalysis(_5899.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """BeltDriveCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5618.BeltDriveHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5618.BeltDriveHarmonicAnalysis]':
