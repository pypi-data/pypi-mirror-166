...
class ClutchConnectionCompoundHarmonicAnalysis(_5839.CouplingConnectionCompoundHarmonicAnalysis):
    """ClutchConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5629.ClutchConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5629.ClutchConnectionHarmonicAnalysis]':
