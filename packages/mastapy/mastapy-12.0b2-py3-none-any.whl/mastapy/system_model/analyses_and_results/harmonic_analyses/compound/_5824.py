...
class ClutchHalfCompoundHarmonicAnalysis(_5840.CouplingHalfCompoundHarmonicAnalysis):
    """ClutchHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5630.ClutchHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5630.ClutchHalfHarmonicAnalysis]':
