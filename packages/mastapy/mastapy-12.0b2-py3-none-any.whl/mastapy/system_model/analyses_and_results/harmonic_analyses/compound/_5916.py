...
class SynchroniserPartCompoundHarmonicAnalysis(_5840.CouplingHalfCompoundHarmonicAnalysis):
    """SynchroniserPartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5751.SynchroniserPartHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5751.SynchroniserPartHarmonicAnalysis]':
