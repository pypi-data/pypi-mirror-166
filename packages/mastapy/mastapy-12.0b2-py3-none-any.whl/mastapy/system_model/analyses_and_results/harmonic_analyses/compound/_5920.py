...
class TorqueConverterPumpCompoundHarmonicAnalysis(_5840.CouplingHalfCompoundHarmonicAnalysis):
    """TorqueConverterPumpCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5755.TorqueConverterPumpHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5755.TorqueConverterPumpHarmonicAnalysis]':
