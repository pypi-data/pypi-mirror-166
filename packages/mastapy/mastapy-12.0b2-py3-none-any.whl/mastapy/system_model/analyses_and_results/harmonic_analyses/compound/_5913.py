...
class StraightBevelSunGearCompoundHarmonicAnalysis(_5906.StraightBevelDiffGearCompoundHarmonicAnalysis):
    """StraightBevelSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5748.StraightBevelSunGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5748.StraightBevelSunGearHarmonicAnalysis]':
