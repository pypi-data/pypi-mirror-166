...
class SpringDamperCompoundHarmonicAnalysis(_5838.CouplingCompoundHarmonicAnalysis):
    """SpringDamperCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5740.SpringDamperHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5740.SpringDamperHarmonicAnalysis]':
