...
class TorqueConverterCompoundHarmonicAnalysis(_5838.CouplingCompoundHarmonicAnalysis):
    """TorqueConverterCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5754.TorqueConverterHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5754.TorqueConverterHarmonicAnalysis]':
