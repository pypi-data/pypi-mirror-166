...
class BevelDifferentialSunGearCompoundHarmonicAnalysis(_5812.BevelDifferentialGearCompoundHarmonicAnalysis):
    """BevelDifferentialSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5623.BevelDifferentialSunGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5623.BevelDifferentialSunGearHarmonicAnalysis]':
