...
class KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis(_5833.ConicalGearCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5698.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5698.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
