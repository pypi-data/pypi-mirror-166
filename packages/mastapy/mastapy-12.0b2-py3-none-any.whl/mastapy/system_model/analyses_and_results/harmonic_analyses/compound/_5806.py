...
class AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis(_5834.ConicalGearMeshCompoundHarmonicAnalysis):
    """AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5613.AGMAGleasonConicalGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5613.AGMAGleasonConicalGearMeshHarmonicAnalysis]':
