...
class SpringDamperHalfCompoundHarmonicAnalysis(_5840.CouplingHalfCompoundHarmonicAnalysis):
    """SpringDamperHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5739.SpringDamperHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5739.SpringDamperHalfHarmonicAnalysis]':
