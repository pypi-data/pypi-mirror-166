...
class AbstractAssemblyCompoundHarmonicAnalysis(_5880.PartCompoundHarmonicAnalysis):
    """AbstractAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5607.AbstractAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5607.AbstractAssemblyHarmonicAnalysis]':
