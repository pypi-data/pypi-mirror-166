...
class RingPinsCompoundHarmonicAnalysis(_5878.MountableComponentCompoundHarmonicAnalysis):
    """RingPinsCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5723.RingPinsHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5723.RingPinsHarmonicAnalysis]':
