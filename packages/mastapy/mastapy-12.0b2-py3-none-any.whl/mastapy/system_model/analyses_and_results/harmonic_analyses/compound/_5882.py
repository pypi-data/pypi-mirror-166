...
class PartToPartShearCouplingConnectionCompoundHarmonicAnalysis(_5839.CouplingConnectionCompoundHarmonicAnalysis):
    """PartToPartShearCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5712.PartToPartShearCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5712.PartToPartShearCouplingConnectionHarmonicAnalysis]':
