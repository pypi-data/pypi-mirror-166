...
class KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis(_5835.ConicalGearSetCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5700.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5700.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
