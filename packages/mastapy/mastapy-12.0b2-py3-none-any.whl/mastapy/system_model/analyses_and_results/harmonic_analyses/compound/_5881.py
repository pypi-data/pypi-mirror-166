...
class PartToPartShearCouplingCompoundHarmonicAnalysis(_5838.CouplingCompoundHarmonicAnalysis):
    """PartToPartShearCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5714.PartToPartShearCouplingHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5714.PartToPartShearCouplingHarmonicAnalysis]':
