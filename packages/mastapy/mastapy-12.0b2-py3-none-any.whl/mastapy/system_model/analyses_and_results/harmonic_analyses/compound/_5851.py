...
class CylindricalPlanetGearCompoundHarmonicAnalysis(_5848.CylindricalGearCompoundHarmonicAnalysis):
    """CylindricalPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5659.CylindricalPlanetGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5659.CylindricalPlanetGearHarmonicAnalysis]':
