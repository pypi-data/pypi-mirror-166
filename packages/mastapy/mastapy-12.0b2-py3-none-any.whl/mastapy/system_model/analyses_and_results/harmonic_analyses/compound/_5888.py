...
class PowerLoadCompoundHarmonicAnalysis(_5923.VirtualComponentCompoundHarmonicAnalysis):
    """PowerLoadCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5720.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5720.PowerLoadHarmonicAnalysis]':
