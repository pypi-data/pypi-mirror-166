...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import (
    _5809, _5811, _5814, _5821,
    _5820, _5842, _5822, _5827,
    _5832, _5844, _5846, _5850,
    _5857, _5856, _5858, _5865,
    _5872, _5875, _5876, _5877,
    _5879, _5881, _5886, _5887,
    _5888, _5890, _5892, _5897,
    _5896, _5902, _5903, _5908,
    _5911, _5914, _5918, _5922,
    _5926, _5929, _5801
)
...
class AssemblyCompoundHarmonicAnalysis(_5801.AbstractAssemblyCompoundHarmonicAnalysis):
    """AssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5615.AssemblyHarmonicAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_5809.BearingCompoundHarmonicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5811.BeltDriveCompoundHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5814.BevelDifferentialGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5821.BoltedJointCompoundHarmonicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5820.BoltCompoundHarmonicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5842.CVTCompoundHarmonicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5822.ClutchCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5827.ConceptCouplingCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5832.ConceptGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5844.CycloidalAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5846.CycloidalDiscCompoundHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5850.CylindricalGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5857.FEPartCompoundHarmonicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5856.FaceGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5858.FlexiblePinAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5865.HypoidGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5872.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5875.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5876.MassDiscCompoundHarmonicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5877.MeasurementComponentCompoundHarmonicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5879.OilSealCompoundHarmonicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5881.PartToPartShearCouplingCompoundHarmonicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5886.PlanetCarrierCompoundHarmonicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5887.PointLoadCompoundHarmonicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5888.PowerLoadCompoundHarmonicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5890.RingPinsCompoundHarmonicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5892.RollingRingAssemblyCompoundHarmonicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5897.ShaftHubConnectionCompoundHarmonicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5896.ShaftCompoundHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5902.SpiralBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5903.SpringDamperCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5908.StraightBevelDiffGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5911.StraightBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5914.SynchroniserCompoundHarmonicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5918.TorqueConverterCompoundHarmonicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5922.UnbalancedMassCompoundHarmonicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5926.WormGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5929.ZerolBevelGearSetCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5615.AssemblyHarmonicAnalysis]':
