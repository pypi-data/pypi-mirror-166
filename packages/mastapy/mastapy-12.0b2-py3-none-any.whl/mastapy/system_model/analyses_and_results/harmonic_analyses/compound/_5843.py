...
class CVTPulleyCompoundHarmonicAnalysis(_5889.PulleyCompoundHarmonicAnalysis):
    """CVTPulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5651.CVTPulleyHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5651.CVTPulleyHarmonicAnalysis]':
