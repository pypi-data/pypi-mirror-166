...
class ConnectorCompoundHarmonicAnalysis(_5878.MountableComponentCompoundHarmonicAnalysis):
    """ConnectorCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5645.ConnectorHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5645.ConnectorHarmonicAnalysis]':
