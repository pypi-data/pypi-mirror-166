...
class KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis(_5834.ConicalGearMeshCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5699.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5699.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis]':
