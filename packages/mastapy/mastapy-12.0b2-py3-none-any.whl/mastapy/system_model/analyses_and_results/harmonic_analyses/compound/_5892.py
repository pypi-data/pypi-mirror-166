...
class RollingRingAssemblyCompoundHarmonicAnalysis(_5899.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """RollingRingAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5725.RollingRingAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5725.RollingRingAssemblyHarmonicAnalysis]':
