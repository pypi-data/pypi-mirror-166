...
class WormGearCompoundHarmonicAnalysis(_5859.GearCompoundHarmonicAnalysis):
    """WormGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5760.WormGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5760.WormGearHarmonicAnalysis]':
