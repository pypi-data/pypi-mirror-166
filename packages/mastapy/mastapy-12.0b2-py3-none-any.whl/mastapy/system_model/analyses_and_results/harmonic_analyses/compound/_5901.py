...
class SpiralBevelGearMeshCompoundHarmonicAnalysis(_5818.BevelGearMeshCompoundHarmonicAnalysis):
    """SpiralBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5736.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5736.SpiralBevelGearMeshHarmonicAnalysis]':
