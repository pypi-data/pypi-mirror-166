...
class SynchroniserSleeveCompoundHarmonicAnalysis(_5916.SynchroniserPartCompoundHarmonicAnalysis):
    """SynchroniserSleeveCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5752.SynchroniserSleeveHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5752.SynchroniserSleeveHarmonicAnalysis]':
