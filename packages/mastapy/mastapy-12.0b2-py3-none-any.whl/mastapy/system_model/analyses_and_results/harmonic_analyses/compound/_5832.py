...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5830, _5831, _5861
...
class ConceptGearSetCompoundHarmonicAnalysis(_5861.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5640.ConceptGearSetHarmonicAnalysis]':
    ...
    @property
    def concept_gears_compound_harmonic_analysis(self) -> 'List[_5830.ConceptGearCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_meshes_compound_harmonic_analysis(self) -> 'List[_5831.ConceptGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5640.ConceptGearSetHarmonicAnalysis]':
