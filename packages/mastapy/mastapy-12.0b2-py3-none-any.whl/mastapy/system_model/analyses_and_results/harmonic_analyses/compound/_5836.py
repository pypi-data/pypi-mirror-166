...
class ConnectionCompoundHarmonicAnalysis(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5644.ConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5644.ConnectionHarmonicAnalysis]':
