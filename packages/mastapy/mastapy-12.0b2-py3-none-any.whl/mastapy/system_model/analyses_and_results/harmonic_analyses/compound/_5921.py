...
class TorqueConverterTurbineCompoundHarmonicAnalysis(_5840.CouplingHalfCompoundHarmonicAnalysis):
    """TorqueConverterTurbineCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5756.TorqueConverterTurbineHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5756.TorqueConverterTurbineHarmonicAnalysis]':
