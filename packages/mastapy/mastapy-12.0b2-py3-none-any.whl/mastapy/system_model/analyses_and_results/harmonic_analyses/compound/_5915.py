...
class SynchroniserHalfCompoundHarmonicAnalysis(_5916.SynchroniserPartCompoundHarmonicAnalysis):
    """SynchroniserHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5749.SynchroniserHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5749.SynchroniserHalfHarmonicAnalysis]':
