...
class FEPartCompoundHarmonicAnalysis(_5803.AbstractShaftOrHousingCompoundHarmonicAnalysis):
    """FEPartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5677.FEPartHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5677.FEPartHarmonicAnalysis]':
