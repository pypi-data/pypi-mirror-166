...
class MeasurementComponentCompoundHarmonicAnalysis(_5923.VirtualComponentCompoundHarmonicAnalysis):
    """MeasurementComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5708.MeasurementComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5708.MeasurementComponentHarmonicAnalysis]':
