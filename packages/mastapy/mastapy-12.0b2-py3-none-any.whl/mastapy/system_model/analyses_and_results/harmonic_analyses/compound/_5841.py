...
class CVTBeltConnectionCompoundHarmonicAnalysis(_5810.BeltConnectionCompoundHarmonicAnalysis):
    """CVTBeltConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5649.CVTBeltConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5649.CVTBeltConnectionHarmonicAnalysis]':
