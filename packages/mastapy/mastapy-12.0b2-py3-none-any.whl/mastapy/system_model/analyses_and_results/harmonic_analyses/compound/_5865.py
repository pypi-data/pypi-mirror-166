...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5863, _5864, _5807
...
class HypoidGearSetCompoundHarmonicAnalysis(_5807.AGMAGleasonConicalGearSetCompoundHarmonicAnalysis):
    """HypoidGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5696.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def hypoid_gears_compound_harmonic_analysis(self) -> 'List[_5863.HypoidGearCompoundHarmonicAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_harmonic_analysis(self) -> 'List[_5864.HypoidGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5696.HypoidGearSetHarmonicAnalysis]':
