...
class CycloidalAssemblyCompoundHarmonicAnalysis(_5899.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """CycloidalAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5652.CycloidalAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5652.CycloidalAssemblyHarmonicAnalysis]':
