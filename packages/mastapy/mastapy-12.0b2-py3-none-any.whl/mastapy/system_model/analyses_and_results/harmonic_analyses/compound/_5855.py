...
class FaceGearMeshCompoundHarmonicAnalysis(_5860.GearMeshCompoundHarmonicAnalysis):
    """FaceGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5675.FaceGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5675.FaceGearMeshHarmonicAnalysis]':
