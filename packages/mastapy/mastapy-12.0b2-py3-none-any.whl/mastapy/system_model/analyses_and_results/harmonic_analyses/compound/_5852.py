...
class DatumCompoundHarmonicAnalysis(_5826.ComponentCompoundHarmonicAnalysis):
    """DatumCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5660.DatumHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5660.DatumHarmonicAnalysis]':
