...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5704, _5705, _5700
...
class KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis(_5700.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis
    ...
    @property
    def assembly_load_case(self) -> '_6839.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2714.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5704.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_harmonic_analysis(self) -> 'List[_5704.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5705.KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_harmonic_analysis(self) -> 'List[_5705.KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis]':
