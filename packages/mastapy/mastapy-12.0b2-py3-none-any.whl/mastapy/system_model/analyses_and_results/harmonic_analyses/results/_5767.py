...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5770, _5768
...
class ExcitationSourceSelection(_5768.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5770.HarmonicSelection]':
