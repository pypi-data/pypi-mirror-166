...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5735, _5736, _5626
...
class SpiralBevelGearSetHarmonicAnalysis(_5626.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5735.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_harmonic_analysis(self) -> 'List[_5735.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5736.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_harmonic_analysis(self) -> 'List[_5736.SpiralBevelGearMeshHarmonicAnalysis]':
