...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5701, _5702, _5700
...
class KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis(_5700.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2711.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5701.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_harmonic_analysis(self) -> 'List[_5701.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5702.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_harmonic_analysis(self) -> 'List[_5702.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
