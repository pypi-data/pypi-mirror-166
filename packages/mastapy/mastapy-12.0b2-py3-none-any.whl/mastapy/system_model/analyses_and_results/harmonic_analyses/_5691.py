...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5722, _5679, _5734
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5769
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def response_cache_level(self) -> '_5722.ResponseCacheLevel':
        ...
        return constructor.new_from_mastapy_type(_5722.ResponseCacheLevel)(value) if value is not None else None

    @response_cache_level.setter
    def response_cache_level(self, value: '_5722.ResponseCacheLevel'):
    ...
    @property
    def excitation_selection(self) -> '_5769.ExcitationSourceSelectionGroup':
    ...
    @property
    def modal_analysis_options(self) -> '_4590.ModalAnalysisOptions':
