...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5638, _5639, _5685
...
class ConceptGearSetHarmonicAnalysis(_5685.GearSetHarmonicAnalysis):
    """ConceptGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5638.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def concept_gears_harmonic_analysis(self) -> 'List[_5638.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5639.ConceptGearMeshHarmonicAnalysis]':
    ...
    @property
    def concept_meshes_harmonic_analysis(self) -> 'List[_5639.ConceptGearMeshHarmonicAnalysis]':
