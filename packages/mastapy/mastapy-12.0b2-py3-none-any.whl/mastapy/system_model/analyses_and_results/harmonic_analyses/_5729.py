...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5693, _5609
...
class ShaftHarmonicAnalysis(_5609.AbstractShaftHarmonicAnalysis):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4611.ShaftModalAnalysis':
    ...
    @property
    def export(self) -> '_5693.HarmonicAnalysisShaftExportOptions':
