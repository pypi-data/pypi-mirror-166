...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5690, _5610
...
class FEPartHarmonicAnalysis(_5610.AbstractShaftOrHousingHarmonicAnalysis):
    """FEPartHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4566.FEPartModalAnalysis':
    ...
    @property
    def export(self) -> '_5690.HarmonicAnalysisFEExportOptions':
    ...
    @property
    def results(self) -> '_5779.FEPartHarmonicAnalysisResultsPropertyAccessor':
    ...
    @property
    def system_deflection_results(self) -> '_2696.FEPartSystemDeflection':
