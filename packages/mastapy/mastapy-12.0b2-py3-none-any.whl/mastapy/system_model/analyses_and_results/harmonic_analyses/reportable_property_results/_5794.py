...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5786, _5793
...
class ResultsForOrderIncludingSurfaces(_5793.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5786.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
