...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5783, _5788
...
class ResultsForMultipleOrdersForGroups(_5788.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForGroups
    ...
    @property
    def groups(self) -> 'List[_5783.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
