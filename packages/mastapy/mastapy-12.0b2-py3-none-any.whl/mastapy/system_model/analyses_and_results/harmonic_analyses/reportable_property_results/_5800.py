...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5793, _5776
...
class SingleWhineAnalysisResultsPropertyAccessor(_5776.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    """SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5793.ResultsForOrderIncludingNodes]':
