...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5794, _5800
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5800.SingleWhineAnalysisResultsPropertyAccessor):
    """FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5794.ResultsForOrderIncludingSurfaces]':
