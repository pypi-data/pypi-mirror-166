...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5792, _5776
...
class RootAssemblySingleWhineAnalysisResultsPropertyAccessor(_5776.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    """RootAssemblySingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5792.ResultsForOrderIncludingGroups]':
