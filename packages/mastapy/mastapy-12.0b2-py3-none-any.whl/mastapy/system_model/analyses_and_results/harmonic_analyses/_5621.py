...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5619, _5620, _5626
...
class BevelDifferentialGearSetHarmonicAnalysis(_5626.BevelGearSetHarmonicAnalysis):
    """BevelDifferentialGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5619.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gears_harmonic_analysis(self) -> 'List[_5619.BevelDifferentialGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5620.BevelDifferentialGearMeshHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_harmonic_analysis(self) -> 'List[_5620.BevelDifferentialGearMeshHarmonicAnalysis]':
