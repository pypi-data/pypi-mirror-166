...
from mastapy.system_model.analyses_and_results.system_deflections import _2678, _2679, _2680
...
class CylindricalGearMeshHarmonicAnalysis(_5682.GearMeshHarmonicAnalysis):
    """CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_7239.CylindricalGearMeshAdvancedSystemDeflection':
    ...
    @property
    def system_deflection_results(self) -> '_2678.CylindricalGearMeshSystemDeflection':
