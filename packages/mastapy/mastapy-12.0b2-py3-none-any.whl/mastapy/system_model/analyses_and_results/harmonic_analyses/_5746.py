...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5744, _5745, _5626
...
class StraightBevelGearSetHarmonicAnalysis(_5626.BevelGearSetHarmonicAnalysis):
    """StraightBevelGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5744.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gears_harmonic_analysis(self) -> 'List[_5744.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5745.StraightBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_harmonic_analysis(self) -> 'List[_5745.StraightBevelGearMeshHarmonicAnalysis]':
