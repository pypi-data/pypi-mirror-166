...
class BearingHarmonicAnalysis(_5645.ConnectorHarmonicAnalysis):
    """BearingHarmonicAnalysis
    ...
    @property
    def rolling_bearing_speed_results(self) -> '_2020.RollingBearingSpeedResults':
    ...
    @property
    def system_deflection_results(self) -> '_2637.BearingSystemDeflection':
