...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6459, _6462, _6461
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self) -> '_6459.ExcelFileDetails':
    ...
    @property
    def masta_file_details(self) -> '_6462.MASTAFileDetails':
    ...
    @property
    def working_folder(self) -> '_1561.SelectableFolder':
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6461.ExcelSheetDesignStateSelector]':
