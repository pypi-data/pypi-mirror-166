...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6039, _6040, _5948
...
class StraightBevelGearSetHarmonicAnalysisOfSingleExcitation(_5948.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """StraightBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def straight_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6039.StraightBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6040.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
