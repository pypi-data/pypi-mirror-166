...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5993, _5994, _5936
...
class HypoidGearSetHarmonicAnalysisOfSingleExcitation(_5936.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation):
    """HypoidGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def hypoid_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5993.HypoidGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def hypoid_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5994.HypoidGearMeshHarmonicAnalysisOfSingleExcitation]':
