...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6030, _6031, _5948
...
class SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation(_5948.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def spiral_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6030.SpiralBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spiral_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6031.SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
