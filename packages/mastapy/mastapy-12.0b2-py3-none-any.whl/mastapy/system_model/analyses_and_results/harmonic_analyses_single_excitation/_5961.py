...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5959, _5960, _5990
...
class ConceptGearSetHarmonicAnalysisOfSingleExcitation(_5990.GearSetHarmonicAnalysisOfSingleExcitation):
    """ConceptGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def concept_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5959.ConceptGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5960.ConceptGearMeshHarmonicAnalysisOfSingleExcitation]':
