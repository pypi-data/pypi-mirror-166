...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5941, _5942, _5948
...
class BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation(_5948.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def bevel_differential_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5941.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5942.BevelDifferentialGearMeshHarmonicAnalysisOfSingleExcitation]':
