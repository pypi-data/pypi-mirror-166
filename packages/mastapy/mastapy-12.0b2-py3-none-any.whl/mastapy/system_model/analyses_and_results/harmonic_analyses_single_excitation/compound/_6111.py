...
class DatumCompoundHarmonicAnalysisOfSingleExcitation(_6085.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """DatumCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5981.DatumHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5981.DatumHarmonicAnalysisOfSingleExcitation]':
