...
class BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation(_6071.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5945.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5945.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
