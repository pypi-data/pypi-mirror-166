...
class BeltDriveCompoundHarmonicAnalysisOfSingleExcitation(_6158.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """BeltDriveCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5940.BeltDriveHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5940.BeltDriveHarmonicAnalysisOfSingleExcitation]':
