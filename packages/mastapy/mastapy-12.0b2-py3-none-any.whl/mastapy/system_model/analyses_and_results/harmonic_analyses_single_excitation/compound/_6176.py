...
class SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation(_6175.SynchroniserPartCompoundHarmonicAnalysisOfSingleExcitation):
    """SynchroniserSleeveCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6047.SynchroniserSleeveHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6047.SynchroniserSleeveHarmonicAnalysisOfSingleExcitation]':
