...
class BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6066.AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5948.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5948.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
