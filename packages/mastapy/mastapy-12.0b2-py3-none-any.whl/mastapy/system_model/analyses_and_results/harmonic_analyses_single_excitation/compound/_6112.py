...
class ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation(_6085.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5982.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5982.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
