...
class BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6125.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5939.BeltConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5939.BeltConnectionHarmonicAnalysisOfSingleExcitation]':
