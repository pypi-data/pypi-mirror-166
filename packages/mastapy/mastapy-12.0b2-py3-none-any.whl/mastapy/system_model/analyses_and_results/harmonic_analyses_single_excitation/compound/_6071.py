...
class BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation(_6076.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5941.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5941.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
