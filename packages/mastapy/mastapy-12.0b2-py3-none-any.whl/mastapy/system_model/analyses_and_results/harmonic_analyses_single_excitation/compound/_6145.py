...
class PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation(_6137.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6016.PlanetCarrierHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6016.PlanetCarrierHarmonicAnalysisOfSingleExcitation]':
