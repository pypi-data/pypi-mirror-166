...
class BevelDifferentialPlanetGearCompoundHarmonicAnalysisOfSingleExcitation(_6071.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialPlanetGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5944.BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5944.BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation]':
