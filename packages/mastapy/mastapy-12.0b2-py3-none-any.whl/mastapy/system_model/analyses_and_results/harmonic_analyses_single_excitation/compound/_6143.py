...
class PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6157.ShaftToMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """PlanetaryConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6014.PlanetaryConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6014.PlanetaryConnectionHarmonicAnalysisOfSingleExcitation]':
