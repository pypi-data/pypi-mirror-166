...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5453
...
class DynamicForceVector3DResult(_0.APIBase):
    ...
    @property
    def magnitude(self) -> '_5453.DynamicForceResultAtTime':
    ...
    @property
    def magnitude_xy(self) -> '_5453.DynamicForceResultAtTime':
    ...
    @property
    def x(self) -> '_5453.DynamicForceResultAtTime':
    ...
    @property
    def y(self) -> '_5453.DynamicForceResultAtTime':
    ...
    @property
    def z(self) -> '_5453.DynamicForceResultAtTime':
