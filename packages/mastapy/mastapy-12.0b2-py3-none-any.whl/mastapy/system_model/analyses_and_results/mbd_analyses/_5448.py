...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5447, _5446, _5370
...
class WormGearSetMultibodyDynamicsAnalysis(_5370.GearSetMultibodyDynamicsAnalysis):
    """WormGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5447.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gears_multibody_dynamics_analysis(self) -> 'List[_5447.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_meshes_multibody_dynamics_analysis(self) -> 'List[_5446.WormGearMeshMultibodyDynamicsAnalysis]':
