...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5363, _5362, _5370
...
class FaceGearSetMultibodyDynamicsAnalysis(_5370.GearSetMultibodyDynamicsAnalysis):
    """FaceGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5363.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_multibody_dynamics_analysis(self) -> 'List[_5363.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_multibody_dynamics_analysis(self) -> 'List[_5362.FaceGearMeshMultibodyDynamicsAnalysis]':
