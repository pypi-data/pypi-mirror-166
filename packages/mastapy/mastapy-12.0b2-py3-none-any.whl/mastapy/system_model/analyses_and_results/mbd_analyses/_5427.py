...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5426, _5425, _5326
...
class StraightBevelDiffGearSetMultibodyDynamicsAnalysis(_5326.BevelGearSetMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5426.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_multibody_dynamics_analysis(self) -> 'List[_5426.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_multibody_dynamics_analysis(self) -> 'List[_5425.StraightBevelDiffGearMeshMultibodyDynamicsAnalysis]':
