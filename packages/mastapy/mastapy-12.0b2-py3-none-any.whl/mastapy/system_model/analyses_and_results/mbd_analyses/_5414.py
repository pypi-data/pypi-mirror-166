...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5454, _5456
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5345.ConnectorMultibodyDynamicsAnalysis):
    """ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5454.DynamicForceVector3DResult':
    ...
    @property
    def peak_dynamic_force_angular(self) -> '_5456.DynamicTorqueVector3DResult':
