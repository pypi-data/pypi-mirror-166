...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5369, _5367, _5418
...
class GearSetMultibodyDynamicsAnalysis(_5418.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5369.GearMultibodyDynamicsAnalysis]':
    ...
    @property
    def meshes(self) -> 'List[_5367.GearMeshMultibodyDynamicsAnalysis]':
