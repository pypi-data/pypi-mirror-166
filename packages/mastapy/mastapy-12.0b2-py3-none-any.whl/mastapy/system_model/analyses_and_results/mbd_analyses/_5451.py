...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5450, _5449, _5326
...
class ZerolBevelGearSetMultibodyDynamicsAnalysis(_5326.BevelGearSetMultibodyDynamicsAnalysis):
    """ZerolBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5450.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5450.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5449.ZerolBevelGearMeshMultibodyDynamicsAnalysis]':
