...
from mastapy.system_model.analyses_and_results.mbd_analyses import (
    _5315, _5318, _5321, _5327,
    _5328, _5350, _5331, _5337,
    _5340, _5379, _5352, _5354,
    _5358, _5365, _5364, _5366,
    _5370, _5374, _5385, _5388,
    _5389, _5393, _5395, _5399,
    _5402, _5403, _5404, _5406,
    _5408, _5414, _5415, _5308,
    _5421, _5424, _5427, _5430,
    _5434, _5439, _5443, _5448,
    _5451, _5306
)
...
class AssemblyMultibodyDynamicsAnalysis(_5306.AbstractAssemblyMultibodyDynamicsAnalysis):
    """AssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def bearings(self) -> 'List[_5315.BearingMultibodyDynamicsAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5318.BeltDriveMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5321.BevelDifferentialGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5327.BoltedJointMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5328.BoltMultibodyDynamicsAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5350.CVTMultibodyDynamicsAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5331.ClutchMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5337.ConceptCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5340.ConceptGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def connections(self) -> 'List[_5379.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5352.CycloidalAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5354.CycloidalDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5358.CylindricalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5365.FEPartMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5364.FaceGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5366.FlexiblePinAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def gear_sets(self) -> 'List[_5370.GearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5374.HypoidGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5385.KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5388.KlingelnbergCycloPalloidSpiralBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5389.MassDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5393.MeasurementComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5395.OilSealMultibodyDynamicsAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5399.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5402.PlanetCarrierMultibodyDynamicsAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5403.PointLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5404.PowerLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5406.RingPinsMultibodyDynamicsAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5408.RollingRingAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5414.ShaftHubConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5415.ShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_5308.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5421.SpiralBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5424.SpringDamperMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5427.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5430.StraightBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5434.SynchroniserMultibodyDynamicsAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5439.TorqueConverterMultibodyDynamicsAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5443.UnbalancedMassMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5448.WormGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5451.ZerolBevelGearSetMultibodyDynamicsAnalysis]':
