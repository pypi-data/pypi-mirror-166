...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5384, _5383, _5382
...
class KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis(_5382.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5384.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_multibody_dynamics_analysis(self) -> 'List[_5384.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_multibody_dynamics_analysis(self) -> 'List[_5383.KlingelnbergCycloPalloidHypoidGearMeshMultibodyDynamicsAnalysis]':
