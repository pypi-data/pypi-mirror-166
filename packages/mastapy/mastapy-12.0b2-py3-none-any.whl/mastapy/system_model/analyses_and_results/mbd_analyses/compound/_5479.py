...
class ClutchCompoundMultibodyDynamicsAnalysis(_5495.CouplingCompoundMultibodyDynamicsAnalysis):
    """ClutchCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5331.ClutchMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5331.ClutchMultibodyDynamicsAnalysis]':
