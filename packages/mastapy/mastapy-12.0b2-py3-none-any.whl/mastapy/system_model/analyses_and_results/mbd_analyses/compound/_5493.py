...
class ConnectionCompoundMultibodyDynamicsAnalysis(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5344.ConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5344.ConnectionMultibodyDynamicsAnalysis]':
