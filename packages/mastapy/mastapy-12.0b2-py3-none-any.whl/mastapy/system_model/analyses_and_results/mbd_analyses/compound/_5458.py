...
class AbstractAssemblyCompoundMultibodyDynamicsAnalysis(_5537.PartCompoundMultibodyDynamicsAnalysis):
    """AbstractAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5306.AbstractAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5306.AbstractAssemblyMultibodyDynamicsAnalysis]':
