...
class PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis(_5495.CouplingCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5399.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5399.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
