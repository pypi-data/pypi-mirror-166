...
class ShaftHubConnectionCompoundMultibodyDynamicsAnalysis(_5494.ConnectorCompoundMultibodyDynamicsAnalysis):
    """ShaftHubConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5414.ShaftHubConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5414.ShaftHubConnectionMultibodyDynamicsAnalysis]':
