...
class StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis(_5563.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5431.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5431.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
