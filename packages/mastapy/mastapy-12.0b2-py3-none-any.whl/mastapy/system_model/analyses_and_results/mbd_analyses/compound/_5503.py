...
class CycloidalDiscCompoundMultibodyDynamicsAnalysis(_5459.AbstractShaftCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5354.CycloidalDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5354.CycloidalDiscMultibodyDynamicsAnalysis]':
