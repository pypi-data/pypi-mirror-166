...
class WormGearCompoundMultibodyDynamicsAnalysis(_5516.GearCompoundMultibodyDynamicsAnalysis):
    """WormGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5447.WormGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5447.WormGearMultibodyDynamicsAnalysis]':
