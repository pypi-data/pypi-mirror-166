...
class InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5493.ConnectionCompoundMultibodyDynamicsAnalysis):
    """InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5379.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5379.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
