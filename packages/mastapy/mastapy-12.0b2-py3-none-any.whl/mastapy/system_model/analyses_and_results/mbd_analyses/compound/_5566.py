...
class StraightBevelGearCompoundMultibodyDynamicsAnalysis(_5474.BevelGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5429.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5429.StraightBevelGearMultibodyDynamicsAnalysis]':
