...
class ShaftCompoundMultibodyDynamicsAnalysis(_5459.AbstractShaftCompoundMultibodyDynamicsAnalysis):
    """ShaftCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5415.ShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5415.ShaftMultibodyDynamicsAnalysis]':
