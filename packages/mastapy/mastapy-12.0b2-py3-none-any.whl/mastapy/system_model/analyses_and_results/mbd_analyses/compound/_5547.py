...
class RingPinsCompoundMultibodyDynamicsAnalysis(_5535.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """RingPinsCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5406.RingPinsMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5406.RingPinsMultibodyDynamicsAnalysis]':
