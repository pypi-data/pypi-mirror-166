...
class StraightBevelSunGearCompoundMultibodyDynamicsAnalysis(_5563.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelSunGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5432.StraightBevelSunGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5432.StraightBevelSunGearMultibodyDynamicsAnalysis]':
