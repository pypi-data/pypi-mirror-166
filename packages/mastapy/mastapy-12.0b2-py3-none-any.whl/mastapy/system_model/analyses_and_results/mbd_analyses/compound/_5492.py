...
class ConicalGearSetCompoundMultibodyDynamicsAnalysis(_5518.GearSetCompoundMultibodyDynamicsAnalysis):
    """ConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5343.ConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5343.ConicalGearSetMultibodyDynamicsAnalysis]':
