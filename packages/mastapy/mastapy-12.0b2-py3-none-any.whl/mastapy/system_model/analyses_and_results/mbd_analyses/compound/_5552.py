...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5465
...
class RootAssemblyCompoundMultibodyDynamicsAnalysis(_5465.AssemblyCompoundMultibodyDynamicsAnalysis):
    """RootAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5411.RootAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5411.RootAssemblyMultibodyDynamicsAnalysis]':
