...
class BeltConnectionCompoundMultibodyDynamicsAnalysis(_5523.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """BeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5317.BeltConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5317.BeltConnectionMultibodyDynamicsAnalysis]':
