...
class CycloidalAssemblyCompoundMultibodyDynamicsAnalysis(_5556.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """CycloidalAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5352.CycloidalAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5352.CycloidalAssemblyMultibodyDynamicsAnalysis]':
