...
class TorqueConverterConnectionCompoundMultibodyDynamicsAnalysis(_5496.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5437.TorqueConverterConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5437.TorqueConverterConnectionMultibodyDynamicsAnalysis]':
