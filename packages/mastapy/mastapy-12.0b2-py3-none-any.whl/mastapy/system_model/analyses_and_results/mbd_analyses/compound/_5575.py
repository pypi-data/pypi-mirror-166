...
class TorqueConverterCompoundMultibodyDynamicsAnalysis(_5495.CouplingCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5439.TorqueConverterMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5439.TorqueConverterMultibodyDynamicsAnalysis]':
