...
class UnbalancedMassCompoundMultibodyDynamicsAnalysis(_5580.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """UnbalancedMassCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5443.UnbalancedMassMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5443.UnbalancedMassMultibodyDynamicsAnalysis]':
