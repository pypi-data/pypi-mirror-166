...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5584, _5585, _5476
...
class ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis(_5476.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5451.ZerolBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5584.ZerolBevelGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5585.ZerolBevelGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5451.ZerolBevelGearSetMultibodyDynamicsAnalysis]':
