...
class RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis(_5523.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """RingPinsToDiscConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5407.RingPinsToDiscConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5407.RingPinsToDiscConnectionMultibodyDynamicsAnalysis]':
