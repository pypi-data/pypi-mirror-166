...
class CoaxialConnectionCompoundMultibodyDynamicsAnalysis(_5555.ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """CoaxialConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5333.CoaxialConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5333.CoaxialConnectionMultibodyDynamicsAnalysis]':
