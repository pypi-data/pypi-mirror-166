...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5557, _5558, _5476
...
class SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis(_5476.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5421.SpiralBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5557.SpiralBevelGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5558.SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5421.SpiralBevelGearSetMultibodyDynamicsAnalysis]':
