...
class ExternalCADModelCompoundMultibodyDynamicsAnalysis(_5483.ComponentCompoundMultibodyDynamicsAnalysis):
    """ExternalCADModelCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5361.ExternalCADModelMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5361.ExternalCADModelMultibodyDynamicsAnalysis]':
