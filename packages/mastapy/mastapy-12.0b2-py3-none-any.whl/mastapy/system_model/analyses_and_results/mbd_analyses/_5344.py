...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2583
from mastapy.math_utility.convergence import _1537, _1536
from mastapy.utility_gui import _1809
...
class ConnectionMultibodyDynamicsAnalysis(_7459.ConnectionTimeSeriesLoadAnalysisCase):
    """ConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis(self) -> '_2583.MultibodyDynamicsAnalysis':
    ...
    @property
    def data_logger(self) -> '_1537.DataLogger':
        ...
        if _1537.DataLogger.TYPE not in temp.__class__.__mro__:
