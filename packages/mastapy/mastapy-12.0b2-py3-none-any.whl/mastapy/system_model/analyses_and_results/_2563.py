...
class CompoundAnalysis(_7470.MarshalByRefObjectPermanent):
    """CompoundAnalysis
    ...
    def perform_analysis_with_progress(self, progress: '_7476.TaskProgress'):
        """ 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2152.DesignEntity') -> 'Iterable[_7460.DesignEntityCompoundAnalysis]':
