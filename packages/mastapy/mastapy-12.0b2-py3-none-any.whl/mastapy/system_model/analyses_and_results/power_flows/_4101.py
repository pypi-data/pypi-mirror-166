...
from mastapy.system_model.analyses_and_results.power_flows import _4100, _4099, _3987
...
class ZerolBevelGearSetPowerFlow(_3987.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4100.ZerolBevelGearPowerFlow]':
    ...
    @property
    def zerol_bevel_gears_power_flow(self) -> 'List[_4100.ZerolBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4099.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def zerol_bevel_meshes_power_flow(self) -> 'List[_4099.ZerolBevelGearMeshPowerFlow]':
