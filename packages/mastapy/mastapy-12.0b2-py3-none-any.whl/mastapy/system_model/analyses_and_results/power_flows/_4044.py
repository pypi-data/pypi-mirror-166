...
from mastapy.system_model.analyses_and_results.power_flows import _4043, _4042, _4038
...
class KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow(_4038.KlingelnbergCycloPalloidConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4043.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_power_flow(self) -> 'List[_4043.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4042.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_power_flow(self) -> 'List[_4042.KlingelnbergCycloPalloidSpiralBevelGearMeshPowerFlow]':
