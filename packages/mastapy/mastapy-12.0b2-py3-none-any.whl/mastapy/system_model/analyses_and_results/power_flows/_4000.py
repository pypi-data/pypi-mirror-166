...
from mastapy.system_model.analyses_and_results.power_flows import _3999, _3998, _4030
...
class ConceptGearSetPowerFlow(_4030.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3999.ConceptGearPowerFlow]':
    ...
    @property
    def concept_gears_power_flow(self) -> 'List[_3999.ConceptGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3998.ConceptGearMeshPowerFlow]':
    ...
    @property
    def concept_meshes_power_flow(self) -> 'List[_3998.ConceptGearMeshPowerFlow]':
