...
class PowerLoadCompoundPowerFlow(_4224.VirtualComponentCompoundPowerFlow):
    """PowerLoadCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4059.PowerLoadPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4059.PowerLoadPowerFlow]':
