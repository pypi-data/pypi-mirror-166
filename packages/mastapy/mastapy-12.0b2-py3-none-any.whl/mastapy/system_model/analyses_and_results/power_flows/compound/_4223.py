...
class UnbalancedMassCompoundPowerFlow(_4224.VirtualComponentCompoundPowerFlow):
    """UnbalancedMassCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4094.UnbalancedMassPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4094.UnbalancedMassPowerFlow]':
