...
class AGMAGleasonConicalGearSetCompoundPowerFlow(_4136.ConicalGearSetCompoundPowerFlow):
    """AGMAGleasonConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3975.AGMAGleasonConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3975.AGMAGleasonConicalGearSetPowerFlow]':
