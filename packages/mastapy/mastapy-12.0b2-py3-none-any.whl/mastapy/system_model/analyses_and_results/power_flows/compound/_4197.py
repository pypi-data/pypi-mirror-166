...
class ShaftCompoundPowerFlow(_4103.AbstractShaftCompoundPowerFlow):
    """ShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4068.ShaftPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4068.ShaftPowerFlow]':
