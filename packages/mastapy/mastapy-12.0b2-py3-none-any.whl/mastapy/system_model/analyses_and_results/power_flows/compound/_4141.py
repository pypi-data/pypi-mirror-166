...
class CouplingHalfCompoundPowerFlow(_4179.MountableComponentCompoundPowerFlow):
    """CouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4007.CouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4007.CouplingHalfPowerFlow]':
