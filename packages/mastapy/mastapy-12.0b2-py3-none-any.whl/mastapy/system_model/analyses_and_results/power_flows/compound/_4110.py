...
class BearingCompoundPowerFlow(_4138.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3977.BearingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3977.BearingPowerFlow]':
