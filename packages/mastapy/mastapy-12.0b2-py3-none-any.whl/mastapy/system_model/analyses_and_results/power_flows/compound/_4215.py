...
class SynchroniserCompoundPowerFlow(_4200.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4087.SynchroniserPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4087.SynchroniserPowerFlow]':
