...
class KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow(_4168.KlingelnbergCycloPalloidConicalGearCompoundPowerFlow):
    """KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4040.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4040.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
