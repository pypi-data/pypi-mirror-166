...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4113, _4114, _4120
...
class BevelDifferentialGearSetCompoundPowerFlow(_4120.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3982.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bevel_differential_gears_compound_power_flow(self) -> 'List[_4113.BevelDifferentialGearCompoundPowerFlow]':
    ...
    @property
    def bevel_differential_meshes_compound_power_flow(self) -> 'List[_4114.BevelDifferentialGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3982.BevelDifferentialGearSetPowerFlow]':
