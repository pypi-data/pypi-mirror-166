...
class PlanetaryGearSetCompoundPowerFlow(_4151.CylindricalGearSetCompoundPowerFlow):
    """PlanetaryGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4054.PlanetaryGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4054.PlanetaryGearSetPowerFlow]':
