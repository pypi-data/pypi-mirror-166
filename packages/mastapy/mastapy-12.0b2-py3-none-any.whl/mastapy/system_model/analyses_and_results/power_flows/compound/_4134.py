...
class ConicalGearCompoundPowerFlow(_4160.GearCompoundPowerFlow):
    """ConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4002.ConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4002.ConicalGearPowerFlow]':
