...
class BoltCompoundPowerFlow(_4127.ComponentCompoundPowerFlow):
    """BoltCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3989.BoltPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3989.BoltPowerFlow]':
