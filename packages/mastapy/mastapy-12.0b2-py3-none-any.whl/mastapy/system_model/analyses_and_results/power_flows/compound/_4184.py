...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4141
...
class PartToPartShearCouplingHalfCompoundPowerFlow(_4141.CouplingHalfCompoundPowerFlow):
    """PartToPartShearCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4051.PartToPartShearCouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4051.PartToPartShearCouplingHalfPowerFlow]':
