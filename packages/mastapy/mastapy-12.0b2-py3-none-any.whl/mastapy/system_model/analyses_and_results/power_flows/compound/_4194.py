...
class RollingRingCompoundPowerFlow(_4141.CouplingHalfCompoundPowerFlow):
    """RollingRingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4065.RollingRingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4065.RollingRingPowerFlow]':
