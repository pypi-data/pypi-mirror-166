...
class ExternalCADModelCompoundPowerFlow(_4127.ComponentCompoundPowerFlow):
    """ExternalCADModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4022.ExternalCADModelPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4022.ExternalCADModelPowerFlow]':
