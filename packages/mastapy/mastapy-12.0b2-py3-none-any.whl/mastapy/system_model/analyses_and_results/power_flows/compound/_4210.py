...
class StraightBevelGearCompoundPowerFlow(_4118.BevelGearCompoundPowerFlow):
    """StraightBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4081.StraightBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4081.StraightBevelGearPowerFlow]':
