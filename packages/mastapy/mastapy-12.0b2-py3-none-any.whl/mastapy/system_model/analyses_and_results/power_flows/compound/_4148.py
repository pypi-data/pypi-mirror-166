...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4105
...
class CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow(_4105.AbstractShaftToMountableComponentConnectionCompoundPowerFlow):
    """CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4014.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4014.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
