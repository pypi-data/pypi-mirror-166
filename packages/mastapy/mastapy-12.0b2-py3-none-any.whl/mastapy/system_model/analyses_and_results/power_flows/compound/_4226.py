...
class WormGearMeshCompoundPowerFlow(_4161.GearMeshCompoundPowerFlow):
    """WormGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4096.WormGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4096.WormGearMeshPowerFlow]':
