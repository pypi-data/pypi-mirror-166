...
class BeltDriveCompoundPowerFlow(_4200.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3979.BeltDrivePowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3979.BeltDrivePowerFlow]':
