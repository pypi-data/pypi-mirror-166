...
class ConceptGearCompoundPowerFlow(_4160.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3999.ConceptGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3999.ConceptGearPowerFlow]':
