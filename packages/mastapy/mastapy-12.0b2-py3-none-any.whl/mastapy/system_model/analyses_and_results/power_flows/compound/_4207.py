...
class StraightBevelDiffGearCompoundPowerFlow(_4118.BevelGearCompoundPowerFlow):
    """StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4078.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4078.StraightBevelDiffGearPowerFlow]':
