...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4174, _4175, _4170
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow(_4170.KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4044.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_power_flow(self) -> 'List[_4174.KlingelnbergCycloPalloidSpiralBevelGearCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_power_flow(self) -> 'List[_4175.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4044.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
