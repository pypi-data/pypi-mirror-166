...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4149, _4150, _4162
...
class CylindricalGearSetCompoundPowerFlow(_4162.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4019.CylindricalGearSetPowerFlow]':
    ...
    @property
    def cylindrical_gears_compound_power_flow(self) -> 'List[_4149.CylindricalGearCompoundPowerFlow]':
    ...
    @property
    def cylindrical_meshes_compound_power_flow(self) -> 'List[_4150.CylindricalGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4019.CylindricalGearSetPowerFlow]':
