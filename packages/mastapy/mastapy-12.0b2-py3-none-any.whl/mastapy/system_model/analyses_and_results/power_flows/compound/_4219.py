...
class TorqueConverterCompoundPowerFlow(_4139.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4091.TorqueConverterPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4091.TorqueConverterPowerFlow]':
