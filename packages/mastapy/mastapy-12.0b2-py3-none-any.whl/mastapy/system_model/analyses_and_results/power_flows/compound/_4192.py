...
class RingPinsToDiscConnectionCompoundPowerFlow(_4167.InterMountableComponentConnectionCompoundPowerFlow):
    """RingPinsToDiscConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4062.RingPinsToDiscConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4062.RingPinsToDiscConnectionPowerFlow]':
