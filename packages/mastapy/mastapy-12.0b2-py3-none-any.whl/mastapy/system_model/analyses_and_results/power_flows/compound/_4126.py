...
class CoaxialConnectionCompoundPowerFlow(_4199.ShaftToMountableComponentConnectionCompoundPowerFlow):
    """CoaxialConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3993.CoaxialConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3993.CoaxialConnectionPowerFlow]':
