...
class MeasurementComponentCompoundPowerFlow(_4224.VirtualComponentCompoundPowerFlow):
    """MeasurementComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4046.MeasurementComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4046.MeasurementComponentPowerFlow]':
