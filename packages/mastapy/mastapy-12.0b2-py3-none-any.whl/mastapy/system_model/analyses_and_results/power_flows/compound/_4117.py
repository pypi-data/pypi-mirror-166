...
class BevelDifferentialSunGearCompoundPowerFlow(_4113.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3984.BevelDifferentialSunGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3984.BevelDifferentialSunGearPowerFlow]':
