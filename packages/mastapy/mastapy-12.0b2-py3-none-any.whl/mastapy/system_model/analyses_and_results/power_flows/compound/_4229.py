...
class ZerolBevelGearMeshCompoundPowerFlow(_4119.BevelGearMeshCompoundPowerFlow):
    """ZerolBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4099.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4099.ZerolBevelGearMeshPowerFlow]':
