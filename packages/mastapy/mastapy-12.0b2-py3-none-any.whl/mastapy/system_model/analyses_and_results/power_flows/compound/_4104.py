...
class AbstractShaftOrHousingCompoundPowerFlow(_4127.ComponentCompoundPowerFlow):
    """AbstractShaftOrHousingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3970.AbstractShaftOrHousingPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3970.AbstractShaftOrHousingPowerFlow]':
