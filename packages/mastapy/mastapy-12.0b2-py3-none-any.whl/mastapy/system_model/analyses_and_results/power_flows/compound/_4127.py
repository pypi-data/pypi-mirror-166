...
class ComponentCompoundPowerFlow(_4181.PartCompoundPowerFlow):
    """ComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3994.ComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3994.ComponentPowerFlow]':
