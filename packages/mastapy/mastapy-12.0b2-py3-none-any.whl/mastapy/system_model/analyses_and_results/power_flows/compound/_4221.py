...
class TorqueConverterPumpCompoundPowerFlow(_4141.CouplingHalfCompoundPowerFlow):
    """TorqueConverterPumpCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4092.TorqueConverterPumpPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4092.TorqueConverterPumpPowerFlow]':
