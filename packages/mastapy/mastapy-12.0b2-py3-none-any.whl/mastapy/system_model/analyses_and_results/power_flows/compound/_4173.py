...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4171, _4172, _4170
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow(_4170.KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4041.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_power_flow(self) -> 'List[_4171.KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_power_flow(self) -> 'List[_4172.KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4041.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
