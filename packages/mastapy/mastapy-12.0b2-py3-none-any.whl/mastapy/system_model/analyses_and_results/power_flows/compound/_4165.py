...
class HypoidGearMeshCompoundPowerFlow(_4107.AGMAGleasonConicalGearMeshCompoundPowerFlow):
    """HypoidGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4032.HypoidGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4032.HypoidGearMeshPowerFlow]':
