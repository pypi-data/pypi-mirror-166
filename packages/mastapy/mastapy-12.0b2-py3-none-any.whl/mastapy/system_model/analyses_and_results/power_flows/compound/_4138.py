...
class ConnectorCompoundPowerFlow(_4179.MountableComponentCompoundPowerFlow):
    """ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4005.ConnectorPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4005.ConnectorPowerFlow]':
