...
class RollingRingConnectionCompoundPowerFlow(_4167.InterMountableComponentConnectionCompoundPowerFlow):
    """RollingRingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4064.RollingRingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4064.RollingRingConnectionPowerFlow]':
