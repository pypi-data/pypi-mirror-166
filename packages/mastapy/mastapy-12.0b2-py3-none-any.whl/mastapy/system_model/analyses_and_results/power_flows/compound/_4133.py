...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4131, _4132, _4162
...
class ConceptGearSetCompoundPowerFlow(_4162.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4000.ConceptGearSetPowerFlow]':
    ...
    @property
    def concept_gears_compound_power_flow(self) -> 'List[_4131.ConceptGearCompoundPowerFlow]':
    ...
    @property
    def concept_meshes_compound_power_flow(self) -> 'List[_4132.ConceptGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4000.ConceptGearSetPowerFlow]':
