...
class KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow(_4135.ConicalGearMeshCompoundPowerFlow):
    """KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4036.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4036.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
