...
class GearSetCompoundPowerFlow(_4200.SpecialisedAssemblyCompoundPowerFlow):
    """GearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4030.GearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4030.GearSetPowerFlow]':
