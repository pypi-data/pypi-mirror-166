...
class CycloidalAssemblyCompoundPowerFlow(_4200.SpecialisedAssemblyCompoundPowerFlow):
    """CycloidalAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4012.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4012.CycloidalAssemblyPowerFlow]':
