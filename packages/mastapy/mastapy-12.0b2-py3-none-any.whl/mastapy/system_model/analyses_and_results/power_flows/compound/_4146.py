...
class CycloidalDiscCentralBearingConnectionCompoundPowerFlow(_4126.CoaxialConnectionCompoundPowerFlow):
    """CycloidalDiscCentralBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4013.CycloidalDiscCentralBearingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4013.CycloidalDiscCentralBearingConnectionPowerFlow]':
