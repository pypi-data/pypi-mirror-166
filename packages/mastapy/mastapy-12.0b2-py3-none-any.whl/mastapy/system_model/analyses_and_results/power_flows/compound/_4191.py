...
class RingPinsCompoundPowerFlow(_4179.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4061.RingPinsPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4061.RingPinsPowerFlow]':
