...
class DatumCompoundPowerFlow(_4127.ComponentCompoundPowerFlow):
    """DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4021.DatumPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4021.DatumPowerFlow]':
