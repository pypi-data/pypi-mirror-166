...
class SpringDamperHalfCompoundPowerFlow(_4141.CouplingHalfCompoundPowerFlow):
    """SpringDamperHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4075.SpringDamperHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4075.SpringDamperHalfPowerFlow]':
