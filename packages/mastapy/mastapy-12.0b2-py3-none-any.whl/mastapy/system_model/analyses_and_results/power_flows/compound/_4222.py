...
class TorqueConverterTurbineCompoundPowerFlow(_4141.CouplingHalfCompoundPowerFlow):
    """TorqueConverterTurbineCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4093.TorqueConverterTurbinePowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4093.TorqueConverterTurbinePowerFlow]':
