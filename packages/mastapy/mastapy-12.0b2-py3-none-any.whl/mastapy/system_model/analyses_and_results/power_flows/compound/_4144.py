...
class CVTPulleyCompoundPowerFlow(_4190.PulleyCompoundPowerFlow):
    """CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4011.CVTPulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4011.CVTPulleyPowerFlow]':
