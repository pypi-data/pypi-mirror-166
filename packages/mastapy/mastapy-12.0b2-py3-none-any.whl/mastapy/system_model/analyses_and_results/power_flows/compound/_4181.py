...
class PartCompoundPowerFlow(_7463.PartCompoundAnalysis):
    """PartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4049.PartPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4049.PartPowerFlow]':
