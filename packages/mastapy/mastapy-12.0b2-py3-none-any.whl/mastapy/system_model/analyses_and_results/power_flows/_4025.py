...
from mastapy.system_model.analyses_and_results.power_flows import _4024, _4023, _4030
...
class FaceGearSetPowerFlow(_4030.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4024.FaceGearPowerFlow]':
    ...
    @property
    def face_gears_power_flow(self) -> 'List[_4024.FaceGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4023.FaceGearMeshPowerFlow]':
    ...
    @property
    def face_meshes_power_flow(self) -> 'List[_4023.FaceGearMeshPowerFlow]':
