...
class FEPartCompoundModalAnalysisAtAStiffness(_4921.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    """FEPartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4846.FEPartModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4846.FEPartModalAnalysisAtAStiffness]':
