...
class AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness(_4944.ComponentCompoundModalAnalysisAtAStiffness):
    """AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4791.AbstractShaftOrHousingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4791.AbstractShaftOrHousingModalAnalysisAtAStiffness]':
