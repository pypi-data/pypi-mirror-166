...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4930, _4931, _4937
...
class BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness(_4937.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4802.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4930.BevelDifferentialGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4931.BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4802.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
