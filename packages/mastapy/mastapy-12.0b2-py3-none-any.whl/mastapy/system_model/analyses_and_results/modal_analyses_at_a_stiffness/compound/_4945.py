...
class ConceptCouplingCompoundModalAnalysisAtAStiffness(_4956.CouplingCompoundModalAnalysisAtAStiffness):
    """ConceptCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4817.ConceptCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4817.ConceptCouplingModalAnalysisAtAStiffness]':
