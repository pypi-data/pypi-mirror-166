...
class StraightBevelDiffGearMeshCompoundModalAnalysisAtAStiffness(_4936.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """StraightBevelDiffGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4895.StraightBevelDiffGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4895.StraightBevelDiffGearMeshModalAnalysisAtAStiffness]':
