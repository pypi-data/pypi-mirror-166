...
class BoltCompoundModalAnalysisAtAStiffness(_4944.ComponentCompoundModalAnalysisAtAStiffness):
    """BoltCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4809.BoltModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4809.BoltModalAnalysisAtAStiffness]':
