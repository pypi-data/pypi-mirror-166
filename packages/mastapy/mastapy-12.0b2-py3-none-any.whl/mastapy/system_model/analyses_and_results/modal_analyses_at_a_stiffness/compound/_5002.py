...
class PlanetaryConnectionCompoundModalAnalysisAtAStiffness(_5016.ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """PlanetaryConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4873.PlanetaryConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4873.PlanetaryConnectionModalAnalysisAtAStiffness]':
