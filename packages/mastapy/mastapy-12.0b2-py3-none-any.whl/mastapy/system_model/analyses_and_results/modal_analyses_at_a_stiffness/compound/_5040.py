...
class UnbalancedMassCompoundModalAnalysisAtAStiffness(_5041.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """UnbalancedMassCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4911.UnbalancedMassModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4911.UnbalancedMassModalAnalysisAtAStiffness]':
