...
class AbstractAssemblyCompoundModalAnalysisAtAStiffness(_4998.PartCompoundModalAnalysisAtAStiffness):
    """AbstractAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4789.AbstractAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4789.AbstractAssemblyModalAnalysisAtAStiffness]':
