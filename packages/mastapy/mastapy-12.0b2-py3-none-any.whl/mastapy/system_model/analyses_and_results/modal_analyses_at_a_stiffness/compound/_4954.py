...
class ConnectionCompoundModalAnalysisAtAStiffness(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4824.ConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4824.ConnectionModalAnalysisAtAStiffness]':
