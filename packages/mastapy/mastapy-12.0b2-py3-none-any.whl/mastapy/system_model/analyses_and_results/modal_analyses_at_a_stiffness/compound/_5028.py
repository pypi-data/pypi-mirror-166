...
class StraightBevelGearMeshCompoundModalAnalysisAtAStiffness(_4936.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """StraightBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4898.StraightBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4898.StraightBevelGearMeshModalAnalysisAtAStiffness]':
