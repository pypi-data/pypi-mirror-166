...
class ComponentCompoundModalAnalysisAtAStiffness(_4998.PartCompoundModalAnalysisAtAStiffness):
    """ComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4814.ComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4814.ComponentModalAnalysisAtAStiffness]':
