...
class GearCompoundModalAnalysisAtAStiffness(_4996.MountableComponentCompoundModalAnalysisAtAStiffness):
    """GearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4849.GearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4849.GearModalAnalysisAtAStiffness]':
