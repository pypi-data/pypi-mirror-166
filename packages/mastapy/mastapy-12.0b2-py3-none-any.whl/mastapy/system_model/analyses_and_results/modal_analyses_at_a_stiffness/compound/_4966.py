...
class CylindricalGearCompoundModalAnalysisAtAStiffness(_4977.GearCompoundModalAnalysisAtAStiffness):
    """CylindricalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4837.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4837.CylindricalGearModalAnalysisAtAStiffness]':
