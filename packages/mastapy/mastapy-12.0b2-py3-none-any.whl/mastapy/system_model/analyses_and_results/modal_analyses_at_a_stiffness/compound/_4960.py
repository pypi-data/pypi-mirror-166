...
class CVTCompoundModalAnalysisAtAStiffness(_4929.BeltDriveCompoundModalAnalysisAtAStiffness):
    """CVTCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4830.CVTModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4830.CVTModalAnalysisAtAStiffness]':
