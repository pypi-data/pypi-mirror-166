...
class OilSealCompoundModalAnalysisAtAStiffness(_4955.ConnectorCompoundModalAnalysisAtAStiffness):
    """OilSealCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4868.OilSealModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4868.OilSealModalAnalysisAtAStiffness]':
