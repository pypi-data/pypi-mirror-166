...
class ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness(_4936.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4916.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4916.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
