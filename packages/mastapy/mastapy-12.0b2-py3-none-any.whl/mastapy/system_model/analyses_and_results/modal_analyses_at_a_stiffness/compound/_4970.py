...
class DatumCompoundModalAnalysisAtAStiffness(_4944.ComponentCompoundModalAnalysisAtAStiffness):
    """DatumCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4840.DatumModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4840.DatumModalAnalysisAtAStiffness]':
