...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4948, _4949, _4979
...
class ConceptGearSetCompoundModalAnalysisAtAStiffness(_4979.GearSetCompoundModalAnalysisAtAStiffness):
    """ConceptGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4820.ConceptGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4948.ConceptGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4949.ConceptGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4820.ConceptGearSetModalAnalysisAtAStiffness]':
