...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import (
    _4927, _4929, _4932, _4939,
    _4938, _4960, _4940, _4945,
    _4950, _4962, _4964, _4968,
    _4975, _4974, _4976, _4983,
    _4990, _4993, _4994, _4995,
    _4997, _4999, _5004, _5005,
    _5006, _5008, _5010, _5015,
    _5014, _5020, _5021, _5026,
    _5029, _5032, _5036, _5040,
    _5044, _5047, _4919
)
...
class AssemblyCompoundModalAnalysisAtAStiffness(_4919.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    """AssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4796.AssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def bearings(self) -> 'List[_4927.BearingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def belt_drives(self) -> 'List[_4929.BeltDriveCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4932.BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4939.BoltedJointCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bolts(self) -> 'List[_4938.BoltCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cv_ts(self) -> 'List[_4960.CVTCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def clutches(self) -> 'List[_4940.ClutchCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4945.ConceptCouplingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4950.ConceptGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4962.CycloidalAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4964.CycloidalDiscCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4968.CylindricalGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def fe_parts(self) -> 'List[_4975.FEPartCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4974.FaceGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4976.FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4983.HypoidGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4990.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4993.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def mass_discs(self) -> 'List[_4994.MassDiscCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def measurement_components(self) -> 'List[_4995.MeasurementComponentCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def oil_seals(self) -> 'List[_4997.OilSealCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4999.PartToPartShearCouplingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5004.PlanetCarrierCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def point_loads(self) -> 'List[_5005.PointLoadCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def power_loads(self) -> 'List[_5006.PowerLoadCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def ring_pins(self) -> 'List[_5008.RingPinsCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5010.RollingRingAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5015.ShaftHubConnectionCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def shafts(self) -> 'List[_5014.ShaftCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5020.SpiralBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5021.SpringDamperCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5026.StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5029.StraightBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def synchronisers(self) -> 'List[_5032.SynchroniserCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def torque_converters(self) -> 'List[_5036.TorqueConverterCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5040.UnbalancedMassCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5044.WormGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5047.ZerolBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4796.AssemblyModalAnalysisAtAStiffness]':
