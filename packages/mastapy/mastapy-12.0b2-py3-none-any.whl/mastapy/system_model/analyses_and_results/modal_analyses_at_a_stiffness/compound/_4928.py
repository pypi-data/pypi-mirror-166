...
class BeltConnectionCompoundModalAnalysisAtAStiffness(_4984.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """BeltConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4798.BeltConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4798.BeltConnectionModalAnalysisAtAStiffness]':
