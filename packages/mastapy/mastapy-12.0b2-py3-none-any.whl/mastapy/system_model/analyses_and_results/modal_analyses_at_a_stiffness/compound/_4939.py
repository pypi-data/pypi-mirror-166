...
class BoltedJointCompoundModalAnalysisAtAStiffness(_5017.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """BoltedJointCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4808.BoltedJointModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4808.BoltedJointModalAnalysisAtAStiffness]':
