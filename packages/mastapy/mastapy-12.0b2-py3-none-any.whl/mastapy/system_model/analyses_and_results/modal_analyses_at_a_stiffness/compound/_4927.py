...
class BearingCompoundModalAnalysisAtAStiffness(_4955.ConnectorCompoundModalAnalysisAtAStiffness):
    """BearingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4797.BearingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4797.BearingModalAnalysisAtAStiffness]':
