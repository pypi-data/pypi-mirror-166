...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4801, _4800, _4807
...
class BevelDifferentialGearSetModalAnalysisAtAStiffness(_4807.BevelGearSetModalAnalysisAtAStiffness):
    """BevelDifferentialGearSetModalAnalysisAtAStiffness
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4801.BevelDifferentialGearModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4800.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
