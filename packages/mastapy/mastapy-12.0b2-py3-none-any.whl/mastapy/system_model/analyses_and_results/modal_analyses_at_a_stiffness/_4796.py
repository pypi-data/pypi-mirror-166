...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import (
    _4797, _4799, _4802, _4808,
    _4809, _4830, _4812, _4817,
    _4820, _4832, _4834, _4838,
    _4846, _4845, _4847, _4854,
    _4861, _4864, _4865, _4866,
    _4868, _4872, _4875, _4876,
    _4877, _4879, _4881, _4885,
    _4886, _4891, _4894, _4897,
    _4900, _4904, _4908, _4911,
    _4915, _4918, _4789
)
...
class AssemblyModalAnalysisAtAStiffness(_4789.AbstractAssemblyModalAnalysisAtAStiffness):
    """AssemblyModalAnalysisAtAStiffness
    ...
    @property
    def bearings(self) -> 'List[_4797.BearingModalAnalysisAtAStiffness]':
    ...
    @property
    def belt_drives(self) -> 'List[_4799.BeltDriveModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4802.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4808.BoltedJointModalAnalysisAtAStiffness]':
    ...
    @property
    def bolts(self) -> 'List[_4809.BoltModalAnalysisAtAStiffness]':
    ...
    @property
    def cv_ts(self) -> 'List[_4830.CVTModalAnalysisAtAStiffness]':
    ...
    @property
    def clutches(self) -> 'List[_4812.ClutchModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4817.ConceptCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4820.ConceptGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4832.CycloidalAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4834.CycloidalDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4838.CylindricalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def fe_parts(self) -> 'List[_4846.FEPartModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4845.FaceGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4847.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4854.HypoidGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4861.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4864.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def mass_discs(self) -> 'List[_4865.MassDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def measurement_components(self) -> 'List[_4866.MeasurementComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def oil_seals(self) -> 'List[_4868.OilSealModalAnalysisAtAStiffness]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4872.PartToPartShearCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4875.PlanetCarrierModalAnalysisAtAStiffness]':
    ...
    @property
    def point_loads(self) -> 'List[_4876.PointLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def power_loads(self) -> 'List[_4877.PowerLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def ring_pins(self) -> 'List[_4879.RingPinsModalAnalysisAtAStiffness]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4881.RollingRingAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4885.ShaftHubConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def shafts(self) -> 'List[_4886.ShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4891.SpiralBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4894.SpringDamperModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4897.StraightBevelDiffGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4900.StraightBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def synchronisers(self) -> 'List[_4904.SynchroniserModalAnalysisAtAStiffness]':
    ...
    @property
    def torque_converters(self) -> 'List[_4908.TorqueConverterModalAnalysisAtAStiffness]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4911.UnbalancedMassModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4915.WormGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4918.ZerolBevelGearSetModalAnalysisAtAStiffness]':
