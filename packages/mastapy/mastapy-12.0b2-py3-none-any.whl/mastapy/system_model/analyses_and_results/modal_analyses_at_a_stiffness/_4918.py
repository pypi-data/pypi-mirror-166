...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4917, _4916, _4807
...
class ZerolBevelGearSetModalAnalysisAtAStiffness(_4807.BevelGearSetModalAnalysisAtAStiffness):
    """ZerolBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4917.ZerolBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4916.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
