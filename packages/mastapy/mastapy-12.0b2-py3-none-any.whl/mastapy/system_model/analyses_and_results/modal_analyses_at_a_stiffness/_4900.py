...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4899, _4898, _4807
...
class StraightBevelGearSetModalAnalysisAtAStiffness(_4807.BevelGearSetModalAnalysisAtAStiffness):
    """StraightBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4899.StraightBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4898.StraightBevelGearMeshModalAnalysisAtAStiffness]':
