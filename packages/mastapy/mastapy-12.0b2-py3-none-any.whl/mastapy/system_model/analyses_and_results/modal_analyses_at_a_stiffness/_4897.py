...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4896, _4895, _4807
...
class StraightBevelDiffGearSetModalAnalysisAtAStiffness(_4807.BevelGearSetModalAnalysisAtAStiffness):
    """StraightBevelDiffGearSetModalAnalysisAtAStiffness
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4896.StraightBevelDiffGearModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4895.StraightBevelDiffGearMeshModalAnalysisAtAStiffness]':
