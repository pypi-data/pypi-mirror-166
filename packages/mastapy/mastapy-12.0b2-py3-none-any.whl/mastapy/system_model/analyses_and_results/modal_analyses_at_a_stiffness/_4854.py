...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4853, _4852, _4795
...
class HypoidGearSetModalAnalysisAtAStiffness(_4795.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness):
    """HypoidGearSetModalAnalysisAtAStiffness
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4853.HypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4852.HypoidGearMeshModalAnalysisAtAStiffness]':
