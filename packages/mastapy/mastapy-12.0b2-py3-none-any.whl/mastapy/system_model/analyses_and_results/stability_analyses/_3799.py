...
from mastapy.system_model.analyses_and_results.stability_analyses import _3742, _3704
...
class ShaftStabilityAnalysis(_3704.AbstractShaftStabilityAnalysis):
    """ShaftStabilityAnalysis
    ...
    @property
    def critical_speeds(self) -> 'List[_3742.CriticalSpeed]':
