...
from mastapy.system_model.analyses_and_results.stability_analyses import _3733, _3731, _3762
...
class ConceptGearSetStabilityAnalysis(_3762.GearSetStabilityAnalysis):
    """ConceptGearSetStabilityAnalysis
    ...
    @property
    def concept_gears_stability_analysis(self) -> 'List[_3733.ConceptGearStabilityAnalysis]':
    ...
    @property
    def concept_meshes_stability_analysis(self) -> 'List[_3731.ConceptGearMeshStabilityAnalysis]':
