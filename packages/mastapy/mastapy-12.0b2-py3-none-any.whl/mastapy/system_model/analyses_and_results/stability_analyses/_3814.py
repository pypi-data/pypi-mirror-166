...
from mastapy.system_model.analyses_and_results.stability_analyses import _3815, _3813, _3719
...
class StraightBevelGearSetStabilityAnalysis(_3719.BevelGearSetStabilityAnalysis):
    """StraightBevelGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_gears_stability_analysis(self) -> 'List[_3815.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_stability_analysis(self) -> 'List[_3813.StraightBevelGearMeshStabilityAnalysis]':
