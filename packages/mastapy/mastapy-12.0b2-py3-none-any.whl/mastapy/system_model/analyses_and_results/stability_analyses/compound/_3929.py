...
class ShaftCompoundStabilityAnalysis(_3835.AbstractShaftCompoundStabilityAnalysis):
    """ShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3799.ShaftStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3799.ShaftStabilityAnalysis]':
