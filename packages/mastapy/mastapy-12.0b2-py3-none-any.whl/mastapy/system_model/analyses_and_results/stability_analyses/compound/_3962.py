...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3960, _3961, _3852
...
class ZerolBevelGearSetCompoundStabilityAnalysis(_3852.BevelGearSetCompoundStabilityAnalysis):
    """ZerolBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3832.ZerolBevelGearSetStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_stability_analysis(self) -> 'List[_3960.ZerolBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_stability_analysis(self) -> 'List[_3961.ZerolBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3832.ZerolBevelGearSetStabilityAnalysis]':
