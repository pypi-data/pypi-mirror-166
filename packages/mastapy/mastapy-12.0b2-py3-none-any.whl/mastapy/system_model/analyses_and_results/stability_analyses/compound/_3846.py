...
class BevelDifferentialGearMeshCompoundStabilityAnalysis(_3851.BevelGearMeshCompoundStabilityAnalysis):
    """BevelDifferentialGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3713.BevelDifferentialGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3713.BevelDifferentialGearMeshStabilityAnalysis]':
