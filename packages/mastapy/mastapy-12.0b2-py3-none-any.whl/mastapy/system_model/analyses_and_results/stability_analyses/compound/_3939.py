...
class StraightBevelDiffGearCompoundStabilityAnalysis(_3850.BevelGearCompoundStabilityAnalysis):
    """StraightBevelDiffGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3812.StraightBevelDiffGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3812.StraightBevelDiffGearStabilityAnalysis]':
