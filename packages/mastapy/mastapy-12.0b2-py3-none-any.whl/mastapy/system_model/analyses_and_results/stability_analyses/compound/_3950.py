...
class SynchroniserSleeveCompoundStabilityAnalysis(_3949.SynchroniserPartCompoundStabilityAnalysis):
    """SynchroniserSleeveCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3820.SynchroniserSleeveStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3820.SynchroniserSleeveStabilityAnalysis]':
