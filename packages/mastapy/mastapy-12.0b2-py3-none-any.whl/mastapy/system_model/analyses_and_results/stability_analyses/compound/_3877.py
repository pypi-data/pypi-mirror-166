...
class CycloidalAssemblyCompoundStabilityAnalysis(_3932.SpecialisedAssemblyCompoundStabilityAnalysis):
    """CycloidalAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3746.CycloidalAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3746.CycloidalAssemblyStabilityAnalysis]':
