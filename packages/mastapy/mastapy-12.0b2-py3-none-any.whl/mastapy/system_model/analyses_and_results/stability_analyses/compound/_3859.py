...
class ComponentCompoundStabilityAnalysis(_3913.PartCompoundStabilityAnalysis):
    """ComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3727.ComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3727.ComponentStabilityAnalysis]':
