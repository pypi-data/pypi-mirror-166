...
class StraightBevelGearCompoundStabilityAnalysis(_3850.BevelGearCompoundStabilityAnalysis):
    """StraightBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3815.StraightBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3815.StraightBevelGearStabilityAnalysis]':
