...
class AGMAGleasonConicalGearCompoundStabilityAnalysis(_3866.ConicalGearCompoundStabilityAnalysis):
    """AGMAGleasonConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3708.AGMAGleasonConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3708.AGMAGleasonConicalGearStabilityAnalysis]':
