...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3906, _3907, _3902
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis(_3902.KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3776.KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_stability_analysis(self) -> 'List[_3906.KlingelnbergCycloPalloidSpiralBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_stability_analysis(self) -> 'List[_3907.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3776.KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis]':
