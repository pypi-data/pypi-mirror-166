...
class FlexiblePinAssemblyCompoundStabilityAnalysis(_3932.SpecialisedAssemblyCompoundStabilityAnalysis):
    """FlexiblePinAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3760.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3760.FlexiblePinAssemblyStabilityAnalysis]':
