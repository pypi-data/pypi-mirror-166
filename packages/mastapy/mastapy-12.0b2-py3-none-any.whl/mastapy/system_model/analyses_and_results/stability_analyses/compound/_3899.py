...
class InterMountableComponentConnectionCompoundStabilityAnalysis(_3869.ConnectionCompoundStabilityAnalysis):
    """InterMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3768.InterMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3768.InterMountableComponentConnectionStabilityAnalysis]':
