...
class AGMAGleasonConicalGearSetCompoundStabilityAnalysis(_3868.ConicalGearSetCompoundStabilityAnalysis):
    """AGMAGleasonConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3707.AGMAGleasonConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3707.AGMAGleasonConicalGearSetStabilityAnalysis]':
