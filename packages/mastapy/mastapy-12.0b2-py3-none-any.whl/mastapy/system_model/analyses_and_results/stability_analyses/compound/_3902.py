...
class KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis(_3868.ConicalGearSetCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3770.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3770.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis]':
