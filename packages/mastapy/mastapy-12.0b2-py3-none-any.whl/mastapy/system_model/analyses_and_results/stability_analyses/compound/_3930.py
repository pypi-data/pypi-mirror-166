...
class ShaftHubConnectionCompoundStabilityAnalysis(_3870.ConnectorCompoundStabilityAnalysis):
    """ShaftHubConnectionCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3798.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3798.ShaftHubConnectionStabilityAnalysis]':
