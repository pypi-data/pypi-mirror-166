...
class ConceptGearCompoundStabilityAnalysis(_3892.GearCompoundStabilityAnalysis):
    """ConceptGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3733.ConceptGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3733.ConceptGearStabilityAnalysis]':
