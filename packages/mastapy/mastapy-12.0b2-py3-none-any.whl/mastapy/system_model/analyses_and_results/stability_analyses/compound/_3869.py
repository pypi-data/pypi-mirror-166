...
class ConnectionCompoundStabilityAnalysis(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3737.ConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3737.ConnectionStabilityAnalysis]':
