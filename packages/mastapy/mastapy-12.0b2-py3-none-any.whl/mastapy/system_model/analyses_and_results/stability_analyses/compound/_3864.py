...
class ConceptGearMeshCompoundStabilityAnalysis(_3893.GearMeshCompoundStabilityAnalysis):
    """ConceptGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3731.ConceptGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3731.ConceptGearMeshStabilityAnalysis]':
