...
class SpringDamperHalfCompoundStabilityAnalysis(_3873.CouplingHalfCompoundStabilityAnalysis):
    """SpringDamperHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3806.SpringDamperHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3806.SpringDamperHalfStabilityAnalysis]':
