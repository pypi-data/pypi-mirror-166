...
class ZerolBevelGearMeshCompoundStabilityAnalysis(_3851.BevelGearMeshCompoundStabilityAnalysis):
    """ZerolBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3831.ZerolBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3831.ZerolBevelGearMeshStabilityAnalysis]':
