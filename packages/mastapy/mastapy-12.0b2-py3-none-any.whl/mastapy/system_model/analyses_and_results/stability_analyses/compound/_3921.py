...
class PowerLoadCompoundStabilityAnalysis(_3956.VirtualComponentCompoundStabilityAnalysis):
    """PowerLoadCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3790.PowerLoadStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3790.PowerLoadStabilityAnalysis]':
