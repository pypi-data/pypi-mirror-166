...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3896, _3897, _3840
...
class HypoidGearSetCompoundStabilityAnalysis(_3840.AGMAGleasonConicalGearSetCompoundStabilityAnalysis):
    """HypoidGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3766.HypoidGearSetStabilityAnalysis]':
    ...
    @property
    def hypoid_gears_compound_stability_analysis(self) -> 'List[_3896.HypoidGearCompoundStabilityAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_stability_analysis(self) -> 'List[_3897.HypoidGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3766.HypoidGearSetStabilityAnalysis]':
