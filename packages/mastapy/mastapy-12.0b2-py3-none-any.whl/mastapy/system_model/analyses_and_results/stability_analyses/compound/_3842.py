...
class BearingCompoundStabilityAnalysis(_3870.ConnectorCompoundStabilityAnalysis):
    """BearingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3710.BearingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3710.BearingStabilityAnalysis]':
