...
class KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis(_3900.KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3774.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3774.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
