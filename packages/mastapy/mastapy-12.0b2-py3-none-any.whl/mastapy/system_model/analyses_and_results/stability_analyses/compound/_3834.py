...
class AbstractAssemblyCompoundStabilityAnalysis(_3913.PartCompoundStabilityAnalysis):
    """AbstractAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3702.AbstractAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3702.AbstractAssemblyStabilityAnalysis]':
