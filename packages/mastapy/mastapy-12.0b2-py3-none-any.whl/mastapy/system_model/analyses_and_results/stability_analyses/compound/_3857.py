...
class ClutchHalfCompoundStabilityAnalysis(_3873.CouplingHalfCompoundStabilityAnalysis):
    """ClutchHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3724.ClutchHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3724.ClutchHalfStabilityAnalysis]':
