...
class CylindricalGearCompoundStabilityAnalysis(_3892.GearCompoundStabilityAnalysis):
    """CylindricalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3752.CylindricalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3752.CylindricalGearStabilityAnalysis]':
