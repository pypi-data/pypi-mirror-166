...
class SynchroniserPartCompoundStabilityAnalysis(_3873.CouplingHalfCompoundStabilityAnalysis):
    """SynchroniserPartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3819.SynchroniserPartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3819.SynchroniserPartStabilityAnalysis]':
