...
class FEPartCompoundStabilityAnalysis(_3836.AbstractShaftOrHousingCompoundStabilityAnalysis):
    """FEPartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3759.FEPartStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3759.FEPartStabilityAnalysis]':
