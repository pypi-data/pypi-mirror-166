...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundStabilityAnalysis(_3900.KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3777.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3777.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
