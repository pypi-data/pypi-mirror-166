...
class AbstractShaftOrHousingCompoundStabilityAnalysis(_3859.ComponentCompoundStabilityAnalysis):
    """AbstractShaftOrHousingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3703.AbstractShaftOrHousingStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3703.AbstractShaftOrHousingStabilityAnalysis]':
