...
class CylindricalGearMeshCompoundStabilityAnalysis(_3893.GearMeshCompoundStabilityAnalysis):
    """CylindricalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3750.CylindricalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3750.CylindricalGearMeshStabilityAnalysis]':
