...
class SynchroniserCompoundStabilityAnalysis(_3932.SpecialisedAssemblyCompoundStabilityAnalysis):
    """SynchroniserCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3821.SynchroniserStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3821.SynchroniserStabilityAnalysis]':
