...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3863, _3864, _3894
...
class ConceptGearSetCompoundStabilityAnalysis(_3894.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3732.ConceptGearSetStabilityAnalysis]':
    ...
    @property
    def concept_gears_compound_stability_analysis(self) -> 'List[_3863.ConceptGearCompoundStabilityAnalysis]':
    ...
    @property
    def concept_meshes_compound_stability_analysis(self) -> 'List[_3864.ConceptGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3732.ConceptGearSetStabilityAnalysis]':
