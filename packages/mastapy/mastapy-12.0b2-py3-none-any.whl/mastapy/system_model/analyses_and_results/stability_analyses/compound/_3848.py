...
class BevelDifferentialPlanetGearCompoundStabilityAnalysis(_3845.BevelDifferentialGearCompoundStabilityAnalysis):
    """BevelDifferentialPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3716.BevelDifferentialPlanetGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3716.BevelDifferentialPlanetGearStabilityAnalysis]':
