...
class BoltedJointCompoundStabilityAnalysis(_3932.SpecialisedAssemblyCompoundStabilityAnalysis):
    """BoltedJointCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3721.BoltedJointStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3721.BoltedJointStabilityAnalysis]':
