...
class TorqueConverterCompoundStabilityAnalysis(_3871.CouplingCompoundStabilityAnalysis):
    """TorqueConverterCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3824.TorqueConverterStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3824.TorqueConverterStabilityAnalysis]':
