...
class ConceptCouplingHalfCompoundStabilityAnalysis(_3873.CouplingHalfCompoundStabilityAnalysis):
    """ConceptCouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3729.ConceptCouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3729.ConceptCouplingHalfStabilityAnalysis]':
