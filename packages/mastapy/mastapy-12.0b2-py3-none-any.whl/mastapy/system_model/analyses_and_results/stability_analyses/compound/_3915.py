...
class PartToPartShearCouplingConnectionCompoundStabilityAnalysis(_3872.CouplingConnectionCompoundStabilityAnalysis):
    """PartToPartShearCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3783.PartToPartShearCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3783.PartToPartShearCouplingConnectionStabilityAnalysis]':
