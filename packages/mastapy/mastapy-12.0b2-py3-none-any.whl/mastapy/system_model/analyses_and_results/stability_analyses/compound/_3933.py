...
class SpiralBevelGearCompoundStabilityAnalysis(_3850.BevelGearCompoundStabilityAnalysis):
    """SpiralBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3804.SpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3804.SpiralBevelGearStabilityAnalysis]':
