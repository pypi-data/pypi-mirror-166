...
class DatumCompoundStabilityAnalysis(_3859.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3754.DatumStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3754.DatumStabilityAnalysis]':
