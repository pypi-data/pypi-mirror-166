...
class UnbalancedMassCompoundStabilityAnalysis(_3956.VirtualComponentCompoundStabilityAnalysis):
    """UnbalancedMassCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3826.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3826.UnbalancedMassStabilityAnalysis]':
