...
from mastapy.system_model.analyses_and_results.stability_analyses import _3833, _3831, _3719
...
class ZerolBevelGearSetStabilityAnalysis(_3719.BevelGearSetStabilityAnalysis):
    """ZerolBevelGearSetStabilityAnalysis
    ...
    @property
    def zerol_bevel_gears_stability_analysis(self) -> 'List[_3833.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_stability_analysis(self) -> 'List[_3831.ZerolBevelGearMeshStabilityAnalysis]':
