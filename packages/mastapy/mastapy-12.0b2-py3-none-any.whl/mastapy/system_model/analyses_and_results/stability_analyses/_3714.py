...
from mastapy.system_model.analyses_and_results.stability_analyses import _3715, _3713, _3719
...
class BevelDifferentialGearSetStabilityAnalysis(_3719.BevelGearSetStabilityAnalysis):
    """BevelDifferentialGearSetStabilityAnalysis
    ...
    @property
    def bevel_differential_gears_stability_analysis(self) -> 'List[_3715.BevelDifferentialGearStabilityAnalysis]':
    ...
    @property
    def bevel_differential_meshes_stability_analysis(self) -> 'List[_3713.BevelDifferentialGearMeshStabilityAnalysis]':
