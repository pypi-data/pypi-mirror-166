...
from mastapy.system_model.analyses_and_results.static_loads import _6837, _6838, _6833
...
class KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase(_6833.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6837.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_load_case(self) -> 'List[_6837.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_load_case(self) -> 'List[_6838.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase]':
