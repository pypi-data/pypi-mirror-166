...
from mastapy.math_utility import _1465, _1473
...
class PointLoadHarmonicLoadData(_1348.SpeedDependentHarmonicLoadData):
    """PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1465.DegreesOfFreedom':
        ...
        return constructor.new_from_mastapy_type(_1465.DegreesOfFreedom)(value) if value is not None else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1465.DegreesOfFreedom'):
