...
class RootAssemblyLoadCase(_6738.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self) -> '_1538.PIDControlSettings':
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6784.CylindricalGearSetLoadCase]':
