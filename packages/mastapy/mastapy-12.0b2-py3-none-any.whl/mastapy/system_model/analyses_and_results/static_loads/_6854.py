...
from mastapy.system_model.analyses_and_results.static_loads import _6853, _6843
...
class PlanetCarrierLoadCase(_6843.MountableComponentLoadCase):
    """PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6853.PlanetarySocketManufactureError]':
