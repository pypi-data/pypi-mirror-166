...
from mastapy.system_model.analyses_and_results.static_loads import (
    ...
    _6751, _6774, _6752, _6754,
    _6759, _6762, _6776, _6778,
    _6784, _6806, _6805, _6807,
    _6811, _6826, _6836, _6839,
    _6840, _6841, _6845, _6850,
    _6854, _6857, _6858, _6862,
    _6863, _6864, _6868, _6869,
    _6728, _6874, _6877, _6880,
    _6883, _6887, _6892, _6899,
    _6903, _6906, _6726
)
...
class AssemblyLoadCase(_6726.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self) -> 'List[_6739.BearingLoadCase]':
    ...
    @property
    def belt_drives(self) -> 'List[_6741.BeltDriveLoadCase]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6744.BevelDifferentialGearSetLoadCase]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6750.BoltedJointLoadCase]':
    ...
    @property
    def bolts(self) -> 'List[_6751.BoltLoadCase]':
    ...
    @property
    def cv_ts(self) -> 'List[_6774.CVTLoadCase]':
    ...
    @property
    def clutch_connections(self) -> 'List[_6752.ClutchConnectionLoadCase]':
    ...
    @property
    def clutches(self) -> 'List[_6754.ClutchLoadCase]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6759.ConceptCouplingLoadCase]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6762.ConceptGearSetLoadCase]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6776.CycloidalAssemblyLoadCase]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6778.CycloidalDiscLoadCase]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6784.CylindricalGearSetLoadCase]':
    ...
    @property
    def fe_parts(self) -> 'List[_6806.FEPartLoadCase]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6805.FaceGearSetLoadCase]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6807.FlexiblePinAssemblyLoadCase]':
    ...
    @property
    def gear_meshes(self) -> 'List[_6811.GearMeshLoadCase]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6826.HypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6836.KlingelnbergCycloPalloidHypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6839.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]':
    ...
    @property
    def mass_discs(self) -> 'List[_6840.MassDiscLoadCase]':
    ...
    @property
    def measurement_components(self) -> 'List[_6841.MeasurementComponentLoadCase]':
    ...
    @property
    def oil_seals(self) -> 'List[_6845.OilSealLoadCase]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6850.PartToPartShearCouplingLoadCase]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6854.PlanetCarrierLoadCase]':
    ...
    @property
    def point_loads(self) -> 'List[_6857.PointLoadLoadCase]':
    ...
    @property
    def ring_pins(self) -> 'List[_6862.RingPinsLoadCase]':
    ...
    @property
    def ring_pins_to_cycloidal_disc_connections(self) -> 'List[_6863.RingPinsToDiscConnectionLoadCase]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6864.RollingRingAssemblyLoadCase]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6868.ShaftHubConnectionLoadCase]':
    ...
    @property
    def shafts(self) -> 'List[_6869.ShaftLoadCase]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_6728.AbstractShaftOrHousingLoadCase]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6874.SpiralBevelGearSetLoadCase]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6877.SpringDamperLoadCase]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6880.StraightBevelDiffGearSetLoadCase]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6883.StraightBevelGearSetLoadCase]':
    ...
    @property
    def synchronisers(self) -> 'List[_6887.SynchroniserLoadCase]':
    ...
    @property
    def torque_converters(self) -> 'List[_6892.TorqueConverterLoadCase]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6899.UnbalancedMassLoadCase]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6903.WormGearSetLoadCase]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6906.ZerolBevelGearSetLoadCase]':
