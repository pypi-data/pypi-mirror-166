...
from mastapy.system_model.fe import _2304, _2327
...
class FEPartLoadCase(_6728.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2304.AngleSource':
        ...
        return constructor.new_from_mastapy_type(_2304.AngleSource)(value) if value is not None else None
