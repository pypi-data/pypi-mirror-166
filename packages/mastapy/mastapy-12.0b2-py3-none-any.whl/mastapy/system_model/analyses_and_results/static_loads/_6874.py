...
from mastapy.system_model.analyses_and_results.static_loads import _6872, _6873, _6749
...
class SpiralBevelGearSetLoadCase(_6749.BevelGearSetLoadCase):
    """SpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6872.SpiralBevelGearLoadCase]':
    ...
    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_6872.SpiralBevelGearLoadCase]':
    ...
    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_6873.SpiralBevelGearMeshLoadCase]':
