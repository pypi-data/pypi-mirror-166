...
from mastapy.system_model.analyses_and_results.static_loads import _6742, _6743, _6749
...
class BevelDifferentialGearSetLoadCase(_6749.BevelGearSetLoadCase):
    """BevelDifferentialGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6742.BevelDifferentialGearLoadCase]':
    ...
    @property
    def bevel_differential_gears_load_case(self) -> 'List[_6742.BevelDifferentialGearLoadCase]':
    ...
    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_6743.BevelDifferentialGearMeshLoadCase]':
