...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6910, _6909, _6912, _6913,
    _6921, _6908, _6915, _6911,
    _6914, _6919, _6922
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def boost_pressure_chart(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def force_chart(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def import_type(self) -> '_6827.ImportType':
        ...
        return constructor.new_from_mastapy_type(_6827.ImportType)(value) if value is not None else None

    @import_type.setter
    def import_type(self, value: '_6827.ImportType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ImportType = value

    @property
    def moment_chart(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def speed_chart(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def torque_chart(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def design_state_options(self) -> '_6909.DesignStateOptions':
    ...
    @property
    def gear_ratio_options(self) -> '_6912.GearRatioInputOptions':
    ...
    @property
    def load_case_name_inputs(self) -> '_6913.LoadCaseNameOptions':
    ...
    @property
    def time_step_input(self) -> '_6921.TimeStepInputOptions':
    ...
    @property
    def boost_pressure_inputs(self) -> 'List[_6908.BoostPressureLoadCaseInputOptions]':
    ...
    @property
    def file_inputs(self) -> 'List[_6915.MultiTimeSeriesDataInputFileOptions]':
    ...
    @property
    def force_inputs(self) -> 'List[_6911.ForceInputOptions]':
    ...
    @property
    def moment_inputs(self) -> 'List[_6914.MomentInputOptions]':
    ...
    @property
    def speed_inputs(self) -> 'List[_6919.SpeedInputOptions]':
    ...
    @property
    def torque_inputs(self) -> 'List[_6922.TorqueInputOptions]':
    ...
    @property
    def columns(self) -> 'List[_1777.ColumnTitle]':
