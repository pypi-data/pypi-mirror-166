...
from mastapy.bearings.tolerances import _1868, _1874
...
class BearingLoadCase(_6769.ConnectorLoadCase):
    """BearingLoadCase
    ...
    @property
    def bearing_stiffness_model(self) -> '_5316.BearingStiffnessModel':
        ...
        return constructor.new_from_mastapy_type(_5316.BearingStiffnessModel)(value) if value is not None else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5316.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5316.BearingStiffnessModel':
    ...
    @property
    def include_fitting_effects(self) -> '_1552.LoadCaseOverrideOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1552.LoadCaseOverrideOption)(value) if value is not None else None

    @include_fitting_effects.setter
    def include_fitting_effects(self, value: '_1552.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def include_ring_ovality(self) -> '_1552.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1552.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeRingOvality = value

    @property
    def include_thermal_expansion_effects(self) -> '_1552.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1552.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def inner_ring_detail(self) -> '_1868.RaceDetail':
    ...
    @property
    def left_ring_detail(self) -> '_1868.RaceDetail':
    ...
    @property
    def outer_ring_detail(self) -> '_1868.RaceDetail':
    ...
    @property
    def right_ring_detail(self) -> '_1868.RaceDetail':
