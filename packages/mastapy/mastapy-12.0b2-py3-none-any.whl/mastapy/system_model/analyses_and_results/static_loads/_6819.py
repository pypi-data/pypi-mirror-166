...
from mastapy.system_model.analyses_and_results.static_loads import _6829, _6817, _6798
...
class HarmonicLoadDataFluxImport(_6817.HarmonicLoadDataCSVImport['_6798.ElectricMachineHarmonicLoadFluxImportOptions']):
    """HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6829.InnerDiameterReference':
        ...
        return constructor.new_from_mastapy_type(_6829.InnerDiameterReference)(value) if value is not None else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6829.InnerDiameterReference'):
