...
class TorqueConverterLoadCase(_6772.CouplingLoadCase):
    """TorqueConverterLoadCase
    ...
    @property
    def lock_up_clutch_pressure_time_profile(self) -> '_1495.Vector2DListAccessor':
    ...
    def lock_up_clutch_pressure_time_profile(self, value: '_1495.Vector2DListAccessor'):
