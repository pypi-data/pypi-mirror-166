...
from mastapy.system_model.analyses_and_results.static_loads import _6878, _6879, _6749
...
class StraightBevelDiffGearSetLoadCase(_6749.BevelGearSetLoadCase):
    """StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6878.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6878.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6879.StraightBevelDiffGearMeshLoadCase]':
