...
class PartSteadyStateSynchronousResponseOnAShaft(_7465.PartStaticLoadAnalysisCase):
    """PartSteadyStateSynchronousResponseOnAShaft
    ...
    def create_viewable(self) -> '_2203.SteadyStateSynchronousResponseViewable':
