...
class CVTBeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3323.BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """CVTBeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3224.CVTBeltConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3224.CVTBeltConnectionSteadyStateSynchronousResponseOnAShaft]':
