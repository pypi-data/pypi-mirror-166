...
class ZerolBevelGearCompoundSteadyStateSynchronousResponseOnAShaft(_3330.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3313.ZerolBevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3313.ZerolBevelGearSteadyStateSynchronousResponseOnAShaft]':
