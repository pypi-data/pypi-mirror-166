...
class MassDiscCompoundSteadyStateSynchronousResponseOnAShaft(_3436.VirtualComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """MassDiscCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3259.MassDiscSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3259.MassDiscSteadyStateSynchronousResponseOnAShaft]':
