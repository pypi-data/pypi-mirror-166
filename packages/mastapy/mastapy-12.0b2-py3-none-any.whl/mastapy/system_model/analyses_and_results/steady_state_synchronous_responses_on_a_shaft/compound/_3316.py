...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft(_3339.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3185.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3185.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft]':
