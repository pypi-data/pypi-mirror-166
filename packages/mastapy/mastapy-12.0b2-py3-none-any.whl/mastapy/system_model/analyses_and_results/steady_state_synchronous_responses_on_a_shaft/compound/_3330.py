...
class BevelGearCompoundSteadyStateSynchronousResponseOnAShaft(_3318.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    """BevelGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3202.BevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3202.BevelGearSteadyStateSynchronousResponseOnAShaft]':
