...
class ConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3219.ConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3219.ConnectionSteadyStateSynchronousResponseOnAShaft]':
