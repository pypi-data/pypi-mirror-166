...
class ComponentCompoundSteadyStateSynchronousResponseOnAShaft(_3393.PartCompoundSteadyStateSynchronousResponseOnAShaft):
    """ComponentCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3209.ComponentSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3209.ComponentSteadyStateSynchronousResponseOnAShaft]':
