...
class ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft(_3372.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3215.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3215.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
