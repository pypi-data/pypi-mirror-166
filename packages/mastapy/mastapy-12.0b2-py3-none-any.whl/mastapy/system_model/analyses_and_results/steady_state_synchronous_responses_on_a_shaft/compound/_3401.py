...
class PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft(_3436.VirtualComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3271.PowerLoadSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3271.PowerLoadSteadyStateSynchronousResponseOnAShaft]':
