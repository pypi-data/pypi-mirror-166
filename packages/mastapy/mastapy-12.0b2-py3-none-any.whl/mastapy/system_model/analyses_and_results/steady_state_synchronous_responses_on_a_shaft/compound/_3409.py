...
class ShaftCompoundSteadyStateSynchronousResponseOnAShaft(_3315.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    """ShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3280.ShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3280.ShaftSteadyStateSynchronousResponseOnAShaft]':
