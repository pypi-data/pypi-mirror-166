...
class ShaftHubConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3350.ConnectorCompoundSteadyStateSynchronousResponseOnAShaft):
    """ShaftHubConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3279.ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3279.ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft]':
