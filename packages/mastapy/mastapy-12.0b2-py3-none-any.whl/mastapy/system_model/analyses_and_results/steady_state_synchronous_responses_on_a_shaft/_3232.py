...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3233, _3231, _3243
...
class CylindricalGearSetSteadyStateSynchronousResponseOnAShaft(_3243.GearSetSteadyStateSynchronousResponseOnAShaft):
    """CylindricalGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3233.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3231.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft]':
