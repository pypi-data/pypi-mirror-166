...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3215, _3213, _3243
...
class ConceptGearSetSteadyStateSynchronousResponseOnAShaft(_3243.GearSetSteadyStateSynchronousResponseOnAShaft):
    """ConceptGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def concept_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3215.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3213.ConceptGearMeshSteadyStateSynchronousResponseOnAShaft]':
