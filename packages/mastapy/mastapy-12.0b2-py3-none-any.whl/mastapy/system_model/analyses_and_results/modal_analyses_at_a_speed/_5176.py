...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5175, _5174, _5066
...
class ZerolBevelGearSetModalAnalysisAtASpeed(_5066.BevelGearSetModalAnalysisAtASpeed):
    """ZerolBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_5175.ZerolBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_5174.ZerolBevelGearMeshModalAnalysisAtASpeed]':
