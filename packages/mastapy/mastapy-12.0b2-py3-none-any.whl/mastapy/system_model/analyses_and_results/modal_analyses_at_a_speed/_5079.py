...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5078, _5077, _5108
...
class ConceptGearSetModalAnalysisAtASpeed(_5108.GearSetModalAnalysisAtASpeed):
    """ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_5078.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_5077.ConceptGearMeshModalAnalysisAtASpeed]':
