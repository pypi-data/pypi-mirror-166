...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5111, _5110, _5054
...
class HypoidGearSetModalAnalysisAtASpeed(_5054.AGMAGleasonConicalGearSetModalAnalysisAtASpeed):
    """HypoidGearSetModalAnalysisAtASpeed
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_speed(self) -> 'List[_5111.HypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_speed(self) -> 'List[_5110.HypoidGearMeshModalAnalysisAtASpeed]':
