...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5060, _5059, _5066
...
class BevelDifferentialGearSetModalAnalysisAtASpeed(_5066.BevelGearSetModalAnalysisAtASpeed):
    """BevelDifferentialGearSetModalAnalysisAtASpeed
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_speed(self) -> 'List[_5060.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_speed(self) -> 'List[_5059.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
