...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import (
    _5056, _5058, _5061, _5067,
    _5068, _5089, _5071, _5076,
    _5079, _5091, _5093, _5097,
    _5104, _5103, _5105, _5112,
    _5119, _5122, _5123, _5124,
    _5126, _5130, _5133, _5134,
    _5135, _5137, _5139, _5143,
    _5144, _5149, _5152, _5155,
    _5158, _5162, _5166, _5169,
    _5173, _5176, _5048
)
...
class AssemblyModalAnalysisAtASpeed(_5048.AbstractAssemblyModalAnalysisAtASpeed):
    """AssemblyModalAnalysisAtASpeed
    ...
    @property
    def bearings(self) -> 'List[_5056.BearingModalAnalysisAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_5058.BeltDriveModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5061.BevelDifferentialGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5067.BoltedJointModalAnalysisAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_5068.BoltModalAnalysisAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_5089.CVTModalAnalysisAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_5071.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5076.ConceptCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5079.ConceptGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5091.CycloidalAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5093.CycloidalDiscModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5097.CylindricalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_5104.FEPartModalAnalysisAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5103.FaceGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5105.FlexiblePinAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5112.HypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5119.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5122.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_5123.MassDiscModalAnalysisAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_5124.MeasurementComponentModalAnalysisAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_5126.OilSealModalAnalysisAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5130.PartToPartShearCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5133.PlanetCarrierModalAnalysisAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_5134.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_5135.PowerLoadModalAnalysisAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_5137.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5139.RollingRingAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5143.ShaftHubConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_5144.ShaftModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5149.SpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5152.SpringDamperModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5155.StraightBevelDiffGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5158.StraightBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_5162.SynchroniserModalAnalysisAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_5166.TorqueConverterModalAnalysisAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5169.UnbalancedMassModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5173.WormGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5176.ZerolBevelGearSetModalAnalysisAtASpeed]':
