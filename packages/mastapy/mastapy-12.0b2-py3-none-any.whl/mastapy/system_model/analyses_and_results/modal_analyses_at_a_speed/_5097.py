...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5096, _5095, _5108
...
class CylindricalGearSetModalAnalysisAtASpeed(_5108.GearSetModalAnalysisAtASpeed):
    """CylindricalGearSetModalAnalysisAtASpeed
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_speed(self) -> 'List[_5096.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_meshes_modal_analysis_at_a_speed(self) -> 'List[_5095.CylindricalGearMeshModalAnalysisAtASpeed]':
