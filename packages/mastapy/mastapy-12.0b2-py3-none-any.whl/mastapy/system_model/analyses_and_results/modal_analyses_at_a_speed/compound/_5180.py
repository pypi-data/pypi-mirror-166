...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5212.ConnectionCompoundModalAnalysisAtASpeed):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5051.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5051.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
