...
class BevelDifferentialPlanetGearCompoundModalAnalysisAtASpeed(_5188.BevelDifferentialGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5062.BevelDifferentialPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5062.BevelDifferentialPlanetGearModalAnalysisAtASpeed]':
