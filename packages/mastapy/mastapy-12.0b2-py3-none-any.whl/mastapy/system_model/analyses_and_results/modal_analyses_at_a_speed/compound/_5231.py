...
class FaceGearMeshCompoundModalAnalysisAtASpeed(_5236.GearMeshCompoundModalAnalysisAtASpeed):
    """FaceGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5101.FaceGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5101.FaceGearMeshModalAnalysisAtASpeed]':
