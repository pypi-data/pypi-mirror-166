...
class StraightBevelDiffGearCompoundModalAnalysisAtASpeed(_5193.BevelGearCompoundModalAnalysisAtASpeed):
    """StraightBevelDiffGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5154.StraightBevelDiffGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5154.StraightBevelDiffGearModalAnalysisAtASpeed]':
