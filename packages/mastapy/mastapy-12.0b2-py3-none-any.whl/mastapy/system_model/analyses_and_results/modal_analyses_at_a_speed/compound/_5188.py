...
class BevelDifferentialGearCompoundModalAnalysisAtASpeed(_5193.BevelGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5060.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5060.BevelDifferentialGearModalAnalysisAtASpeed]':
