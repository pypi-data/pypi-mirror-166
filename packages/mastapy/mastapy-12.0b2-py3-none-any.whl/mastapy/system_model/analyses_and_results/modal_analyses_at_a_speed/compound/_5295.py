...
class TorqueConverterConnectionCompoundModalAnalysisAtASpeed(_5215.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """TorqueConverterConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5165.TorqueConverterConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5165.TorqueConverterConnectionModalAnalysisAtASpeed]':
