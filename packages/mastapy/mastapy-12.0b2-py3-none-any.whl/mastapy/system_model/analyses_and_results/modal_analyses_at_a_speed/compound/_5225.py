...
class CylindricalGearMeshCompoundModalAnalysisAtASpeed(_5236.GearMeshCompoundModalAnalysisAtASpeed):
    """CylindricalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5095.CylindricalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5095.CylindricalGearMeshModalAnalysisAtASpeed]':
