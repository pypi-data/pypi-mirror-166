...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5300, _5301, _5237
...
class WormGearSetCompoundModalAnalysisAtASpeed(_5237.GearSetCompoundModalAnalysisAtASpeed):
    """WormGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5173.WormGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5300.WormGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def worm_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5301.WormGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5173.WormGearSetModalAnalysisAtASpeed]':
