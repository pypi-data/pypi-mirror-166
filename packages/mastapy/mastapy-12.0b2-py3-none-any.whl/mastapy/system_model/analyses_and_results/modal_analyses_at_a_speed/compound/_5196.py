...
class BoltCompoundModalAnalysisAtASpeed(_5202.ComponentCompoundModalAnalysisAtASpeed):
    """BoltCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5068.BoltModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5068.BoltModalAnalysisAtASpeed]':
