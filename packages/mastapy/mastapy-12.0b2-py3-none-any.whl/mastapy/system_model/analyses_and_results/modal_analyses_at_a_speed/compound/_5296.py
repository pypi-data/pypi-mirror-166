...
class TorqueConverterPumpCompoundModalAnalysisAtASpeed(_5216.CouplingHalfCompoundModalAnalysisAtASpeed):
    """TorqueConverterPumpCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5167.TorqueConverterPumpModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5167.TorqueConverterPumpModalAnalysisAtASpeed]':
