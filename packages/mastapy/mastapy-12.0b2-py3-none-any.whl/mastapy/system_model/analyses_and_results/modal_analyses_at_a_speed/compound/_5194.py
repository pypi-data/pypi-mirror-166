...
class BevelGearMeshCompoundModalAnalysisAtASpeed(_5182.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed):
    """BevelGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5064.BevelGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5064.BevelGearMeshModalAnalysisAtASpeed]':
