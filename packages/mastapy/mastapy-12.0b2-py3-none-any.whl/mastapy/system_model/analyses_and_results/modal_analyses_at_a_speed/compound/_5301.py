...
class WormGearMeshCompoundModalAnalysisAtASpeed(_5236.GearMeshCompoundModalAnalysisAtASpeed):
    """WormGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5171.WormGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5171.WormGearMeshModalAnalysisAtASpeed]':
