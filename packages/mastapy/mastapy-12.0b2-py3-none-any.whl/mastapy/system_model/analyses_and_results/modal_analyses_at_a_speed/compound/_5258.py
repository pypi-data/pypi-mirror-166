...
class PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed(_5215.CouplingConnectionCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5128.PartToPartShearCouplingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5128.PartToPartShearCouplingConnectionModalAnalysisAtASpeed]':
