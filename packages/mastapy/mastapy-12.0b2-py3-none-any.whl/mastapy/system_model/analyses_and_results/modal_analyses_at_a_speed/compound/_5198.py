...
class ClutchCompoundModalAnalysisAtASpeed(_5214.CouplingCompoundModalAnalysisAtASpeed):
    """ClutchCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5071.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5071.ClutchModalAnalysisAtASpeed]':
