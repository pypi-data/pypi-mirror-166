...
class PartCompoundModalAnalysisAtASpeed(_7463.PartCompoundAnalysis):
    """PartCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5127.PartModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5127.PartModalAnalysisAtASpeed]':
