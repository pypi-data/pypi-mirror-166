...
class PartToPartShearCouplingCompoundModalAnalysisAtASpeed(_5214.CouplingCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5130.PartToPartShearCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5130.PartToPartShearCouplingModalAnalysisAtASpeed]':
