...
class StraightBevelPlanetGearCompoundModalAnalysisAtASpeed(_5282.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    """StraightBevelPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5159.StraightBevelPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5159.StraightBevelPlanetGearModalAnalysisAtASpeed]':
