...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5206, _5207, _5237
...
class ConceptGearSetCompoundModalAnalysisAtASpeed(_5237.GearSetCompoundModalAnalysisAtASpeed):
    """ConceptGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5079.ConceptGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5206.ConceptGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5207.ConceptGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5079.ConceptGearSetModalAnalysisAtASpeed]':
