...
class PlanetaryConnectionCompoundModalAnalysisAtASpeed(_5274.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """PlanetaryConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5131.PlanetaryConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5131.PlanetaryConnectionModalAnalysisAtASpeed]':
