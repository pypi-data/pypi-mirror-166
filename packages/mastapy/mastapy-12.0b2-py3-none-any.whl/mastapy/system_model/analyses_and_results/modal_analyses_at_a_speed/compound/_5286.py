...
class StraightBevelGearMeshCompoundModalAnalysisAtASpeed(_5194.BevelGearMeshCompoundModalAnalysisAtASpeed):
    """StraightBevelGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5156.StraightBevelGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5156.StraightBevelGearMeshModalAnalysisAtASpeed]':
