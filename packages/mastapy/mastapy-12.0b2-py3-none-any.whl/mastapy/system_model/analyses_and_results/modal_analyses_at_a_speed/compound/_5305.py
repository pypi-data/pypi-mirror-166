...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5303, _5304, _5195
...
class ZerolBevelGearSetCompoundModalAnalysisAtASpeed(_5195.BevelGearSetCompoundModalAnalysisAtASpeed):
    """ZerolBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5176.ZerolBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5303.ZerolBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5304.ZerolBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5176.ZerolBevelGearSetModalAnalysisAtASpeed]':
