...
class ClutchHalfCompoundModalAnalysisAtASpeed(_5216.CouplingHalfCompoundModalAnalysisAtASpeed):
    """ClutchHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5070.ClutchHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5070.ClutchHalfModalAnalysisAtASpeed]':
