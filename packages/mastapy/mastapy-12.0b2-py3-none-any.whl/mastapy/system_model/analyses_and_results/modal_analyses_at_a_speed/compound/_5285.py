...
class StraightBevelGearCompoundModalAnalysisAtASpeed(_5193.BevelGearCompoundModalAnalysisAtASpeed):
    """StraightBevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5157.StraightBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5157.StraightBevelGearModalAnalysisAtASpeed]':
