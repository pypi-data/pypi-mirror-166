...
class WormGearCompoundModalAnalysisAtASpeed(_5235.GearCompoundModalAnalysisAtASpeed):
    """WormGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5172.WormGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5172.WormGearModalAnalysisAtASpeed]':
