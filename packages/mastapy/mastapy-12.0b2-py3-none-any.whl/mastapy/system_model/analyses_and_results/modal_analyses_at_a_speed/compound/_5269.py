...
class RollingRingCompoundModalAnalysisAtASpeed(_5216.CouplingHalfCompoundModalAnalysisAtASpeed):
    """RollingRingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5141.RollingRingModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5141.RollingRingModalAnalysisAtASpeed]':
