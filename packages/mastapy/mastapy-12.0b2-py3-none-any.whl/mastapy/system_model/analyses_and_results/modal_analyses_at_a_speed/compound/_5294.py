...
class TorqueConverterCompoundModalAnalysisAtASpeed(_5214.CouplingCompoundModalAnalysisAtASpeed):
    """TorqueConverterCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5166.TorqueConverterModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5166.TorqueConverterModalAnalysisAtASpeed]':
