...
class CoaxialConnectionCompoundModalAnalysisAtASpeed(_5274.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """CoaxialConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5072.CoaxialConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5072.CoaxialConnectionModalAnalysisAtASpeed]':
