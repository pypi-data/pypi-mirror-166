...
class PlanetaryGearSetCompoundModalAnalysisAtASpeed(_5226.CylindricalGearSetCompoundModalAnalysisAtASpeed):
    """PlanetaryGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5132.PlanetaryGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5132.PlanetaryGearSetModalAnalysisAtASpeed]':
