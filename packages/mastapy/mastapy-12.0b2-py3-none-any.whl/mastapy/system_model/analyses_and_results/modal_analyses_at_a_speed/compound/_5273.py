...
class ShaftHubConnectionCompoundModalAnalysisAtASpeed(_5213.ConnectorCompoundModalAnalysisAtASpeed):
    """ShaftHubConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5143.ShaftHubConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5143.ShaftHubConnectionModalAnalysisAtASpeed]':
