...
class CVTBeltConnectionCompoundModalAnalysisAtASpeed(_5186.BeltConnectionCompoundModalAnalysisAtASpeed):
    """CVTBeltConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5088.CVTBeltConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5088.CVTBeltConnectionModalAnalysisAtASpeed]':
