...
class VirtualComponentCompoundModalAnalysisAtASpeed(_5254.MountableComponentCompoundModalAnalysisAtASpeed):
    """VirtualComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5170.VirtualComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5170.VirtualComponentModalAnalysisAtASpeed]':
