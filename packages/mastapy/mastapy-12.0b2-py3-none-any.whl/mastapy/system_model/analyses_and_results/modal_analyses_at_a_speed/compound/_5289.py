...
class StraightBevelSunGearCompoundModalAnalysisAtASpeed(_5282.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    """StraightBevelSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5160.StraightBevelSunGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5160.StraightBevelSunGearModalAnalysisAtASpeed]':
