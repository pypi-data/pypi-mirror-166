...
class SynchroniserCompoundModalAnalysisAtASpeed(_5275.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """SynchroniserCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5162.SynchroniserModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5162.SynchroniserModalAnalysisAtASpeed]':
