...
class CylindricalGearCompoundModalAnalysisAtASpeed(_5235.GearCompoundModalAnalysisAtASpeed):
    """CylindricalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5096.CylindricalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5096.CylindricalGearModalAnalysisAtASpeed]':
