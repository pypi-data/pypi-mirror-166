...
class ConicalGearCompoundModalAnalysisAtASpeed(_5235.GearCompoundModalAnalysisAtASpeed):
    """ConicalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5081.ConicalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5081.ConicalGearModalAnalysisAtASpeed]':
