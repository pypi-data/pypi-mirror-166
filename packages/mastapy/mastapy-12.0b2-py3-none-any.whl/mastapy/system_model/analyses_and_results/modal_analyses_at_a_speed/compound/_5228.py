...
class DatumCompoundModalAnalysisAtASpeed(_5202.ComponentCompoundModalAnalysisAtASpeed):
    """DatumCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5099.DatumModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5099.DatumModalAnalysisAtASpeed]':
