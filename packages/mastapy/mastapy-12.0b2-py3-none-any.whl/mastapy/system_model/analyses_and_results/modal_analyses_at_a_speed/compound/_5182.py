...
class AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed(_5210.ConicalGearMeshCompoundModalAnalysisAtASpeed):
    """AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5052.AGMAGleasonConicalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5052.AGMAGleasonConicalGearMeshModalAnalysisAtASpeed]':
