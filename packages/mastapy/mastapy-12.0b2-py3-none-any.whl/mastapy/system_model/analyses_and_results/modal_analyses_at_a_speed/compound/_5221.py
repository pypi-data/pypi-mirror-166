...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed(_5201.CoaxialConnectionCompoundModalAnalysisAtASpeed):
    """CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5092.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5092.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]':
