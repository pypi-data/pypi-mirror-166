...
from mastapy.system_model.analyses_and_results.static_loads import _6867, _6723
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    def load_case_root_assemblies(self) -> 'List[_6867.RootAssemblyLoadCase]':
    ...
    def create_load_cases(self, number_of_load_cases: 'int', token: '_7476.TaskProgress') -> 'List[_6723.LoadCase]':
    ...
    def perform_pst_with_progress(self, progress: '_7476.TaskProgress'):
