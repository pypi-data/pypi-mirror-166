...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4279, _4278, _4298
...
class CylindricalGearSetParametricStudyTool(_4298.GearSetParametricStudyTool):
    """CylindricalGearSetParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2681.CylindricalGearSetSystemDeflection]':
    ...
    @property
    def cylindrical_gears_parametric_study_tool(self) -> 'List[_4279.CylindricalGearParametricStudyTool]':
    ...
    @property
    def cylindrical_meshes_parametric_study_tool(self) -> 'List[_4278.CylindricalGearMeshParametricStudyTool]':
