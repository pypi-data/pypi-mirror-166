...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4376, _4375, _4249
...
class ZerolBevelGearSetParametricStudyTool(_4249.BevelGearSetParametricStudyTool):
    """ZerolBevelGearSetParametricStudyTool
    ...
    @property
    def zerol_bevel_gears_parametric_study_tool(self) -> 'List[_4376.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_parametric_study_tool(self) -> 'List[_4375.ZerolBevelGearMeshParametricStudyTool]':
