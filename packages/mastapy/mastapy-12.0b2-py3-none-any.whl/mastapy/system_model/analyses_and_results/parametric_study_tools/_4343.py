...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4323, _4325, _4238
...
class RootAssemblyParametricStudyTool(_4238.AssemblyParametricStudyTool):
    """RootAssemblyParametricStudyTool
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_4323.ParametricStudyTool':
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> 'List[_2842.DutyCycleEfficiencyResults]':
