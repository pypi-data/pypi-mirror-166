...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4318, _4315, _4283
...
class ParametricStudyVariable(_2592.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4318.ParametricStudyDimension':
        ...
        return constructor.new_from_mastapy_type(_4318.ParametricStudyDimension)(value) if value is not None else None

    @dimension.setter
    def dimension(self, value: '_4318.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4315.MonteCarloDistribution':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_4315.MonteCarloDistribution)(value) if value is not None else None

    @distribution.setter
    def distribution(self, value: '_4315.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def doe_variable_setter(self) -> '_4283.DesignOfExperimentsVariableSetter':
