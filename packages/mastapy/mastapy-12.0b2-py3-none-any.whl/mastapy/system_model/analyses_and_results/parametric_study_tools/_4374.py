...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4373, _4372, _4298
...
class WormGearSetParametricStudyTool(_4298.GearSetParametricStudyTool):
    """WormGearSetParametricStudyTool
    ...
    @property
    def worm_gears_parametric_study_tool(self) -> 'List[_4373.WormGearParametricStudyTool]':
    ...
    @property
    def worm_meshes_parametric_study_tool(self) -> 'List[_4372.WormGearMeshParametricStudyTool]':
