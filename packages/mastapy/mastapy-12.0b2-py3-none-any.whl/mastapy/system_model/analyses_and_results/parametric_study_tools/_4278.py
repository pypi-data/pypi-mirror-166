...
class CylindricalGearMeshParametricStudyTool(_4296.GearMeshParametricStudyTool):
    """CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2678.CylindricalGearMeshSystemDeflection]':
