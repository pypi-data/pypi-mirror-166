...
class ConnectionParametricStudyTool(_7455.ConnectionAnalysisCase):
    """ConnectionParametricStudyTool
    ...
    @property
    def data_logger(self) -> '_1809.DataLoggerWithCharts':
    ...
    @property
    def parametric_study_tool(self) -> '_4323.ParametricStudyTool':
