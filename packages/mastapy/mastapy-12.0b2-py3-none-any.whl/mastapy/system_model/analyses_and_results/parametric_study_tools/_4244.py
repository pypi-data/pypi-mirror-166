...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4243, _4242, _4249
...
class BevelDifferentialGearSetParametricStudyTool(_4249.BevelGearSetParametricStudyTool):
    """BevelDifferentialGearSetParametricStudyTool
    ...
    @property
    def bevel_differential_gears_parametric_study_tool(self) -> 'List[_4243.BevelDifferentialGearParametricStudyTool]':
    ...
    @property
    def bevel_differential_meshes_parametric_study_tool(self) -> 'List[_4242.BevelDifferentialGearMeshParametricStudyTool]':
