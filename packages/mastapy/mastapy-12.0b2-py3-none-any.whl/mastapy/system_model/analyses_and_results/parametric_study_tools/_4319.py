...
class ParametricStudyDOEResultVariable(_1514.ParetoOptimisationVariableBase):
    """ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1516.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1516.PropertyTargetForDominantCandidateSearch'):
