...
from mastapy.bearings.bearing_results import _1901
...
class BearingParametricStudyTool(_4267.ConnectorParametricStudyTool):
    """BearingParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> 'List[_1901.LoadedBearingDutyCycle]':
