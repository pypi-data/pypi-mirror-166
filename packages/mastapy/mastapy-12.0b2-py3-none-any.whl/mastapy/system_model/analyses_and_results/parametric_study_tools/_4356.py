...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4355, _4354, _4249
...
class StraightBevelDiffGearSetParametricStudyTool(_4249.BevelGearSetParametricStudyTool):
    """StraightBevelDiffGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_diff_gears_parametric_study_tool(self) -> 'List[_4355.StraightBevelDiffGearParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_meshes_parametric_study_tool(self) -> 'List[_4354.StraightBevelDiffGearMeshParametricStudyTool]':
