...
class StraightBevelDiffGearMeshCompoundParametricStudyTool(_4395.BevelGearMeshCompoundParametricStudyTool):
    """StraightBevelDiffGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4354.StraightBevelDiffGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4354.StraightBevelDiffGearMeshParametricStudyTool]':
