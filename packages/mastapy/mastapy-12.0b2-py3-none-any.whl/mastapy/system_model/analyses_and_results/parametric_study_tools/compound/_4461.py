...
class PlanetaryConnectionCompoundParametricStudyTool(_4475.ShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """PlanetaryConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4332.PlanetaryConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4332.PlanetaryConnectionParametricStudyTool]':
