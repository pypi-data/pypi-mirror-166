...
class PlanetaryGearSetCompoundParametricStudyTool(_4427.CylindricalGearSetCompoundParametricStudyTool):
    """PlanetaryGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4333.PlanetaryGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4333.PlanetaryGearSetParametricStudyTool]':
