...
class PlanetCarrierCompoundParametricStudyTool(_4455.MountableComponentCompoundParametricStudyTool):
    """PlanetCarrierCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4334.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4334.PlanetCarrierParametricStudyTool]':
