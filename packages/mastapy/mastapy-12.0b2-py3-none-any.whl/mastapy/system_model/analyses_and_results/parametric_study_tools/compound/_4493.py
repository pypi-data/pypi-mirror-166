...
class SynchroniserPartCompoundParametricStudyTool(_4417.CouplingHalfCompoundParametricStudyTool):
    """SynchroniserPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4364.SynchroniserPartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4364.SynchroniserPartParametricStudyTool]':
