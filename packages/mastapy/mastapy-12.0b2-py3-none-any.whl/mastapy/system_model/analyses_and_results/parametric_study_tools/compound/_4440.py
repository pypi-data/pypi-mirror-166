...
class HypoidGearCompoundParametricStudyTool(_4382.AGMAGleasonConicalGearCompoundParametricStudyTool):
    """HypoidGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4301.HypoidGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4301.HypoidGearParametricStudyTool]':
