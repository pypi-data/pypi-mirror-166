...
class CylindricalGearCompoundParametricStudyTool(_4436.GearCompoundParametricStudyTool):
    """CylindricalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4279.CylindricalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4279.CylindricalGearParametricStudyTool]':
