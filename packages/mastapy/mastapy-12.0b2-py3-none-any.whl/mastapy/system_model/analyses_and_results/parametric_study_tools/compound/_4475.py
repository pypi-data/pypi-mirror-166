...
class ShaftToMountableComponentConnectionCompoundParametricStudyTool(_4381.AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """ShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4346.ShaftToMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4346.ShaftToMountableComponentConnectionParametricStudyTool]':
