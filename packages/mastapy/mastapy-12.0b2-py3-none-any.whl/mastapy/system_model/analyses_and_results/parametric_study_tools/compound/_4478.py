...
class SpiralBevelGearMeshCompoundParametricStudyTool(_4395.BevelGearMeshCompoundParametricStudyTool):
    """SpiralBevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4348.SpiralBevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4348.SpiralBevelGearMeshParametricStudyTool]':
