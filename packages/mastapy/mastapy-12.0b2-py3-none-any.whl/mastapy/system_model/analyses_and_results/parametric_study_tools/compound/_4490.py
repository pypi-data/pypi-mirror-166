...
class StraightBevelSunGearCompoundParametricStudyTool(_4483.StraightBevelDiffGearCompoundParametricStudyTool):
    """StraightBevelSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4361.StraightBevelSunGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4361.StraightBevelSunGearParametricStudyTool]':
