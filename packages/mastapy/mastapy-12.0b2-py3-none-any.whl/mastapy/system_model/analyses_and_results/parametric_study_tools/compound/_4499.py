...
class UnbalancedMassCompoundParametricStudyTool(_4500.VirtualComponentCompoundParametricStudyTool):
    """UnbalancedMassCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4370.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4370.UnbalancedMassParametricStudyTool]':
