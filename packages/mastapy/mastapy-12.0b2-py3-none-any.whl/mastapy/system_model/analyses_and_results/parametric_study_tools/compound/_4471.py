...
class RollingRingConnectionCompoundParametricStudyTool(_4443.InterMountableComponentConnectionCompoundParametricStudyTool):
    """RollingRingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4341.RollingRingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4341.RollingRingConnectionParametricStudyTool]':
