...
class GuideDxfModelCompoundParametricStudyTool(_4403.ComponentCompoundParametricStudyTool):
    """GuideDxfModelCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4299.GuideDxfModelParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4299.GuideDxfModelParametricStudyTool]':
