...
class GearCompoundParametricStudyTool(_4455.MountableComponentCompoundParametricStudyTool):
    """GearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4297.GearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4297.GearParametricStudyTool]':
