...
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _5588, _5587, _5589, _5592,
    _5593, _5596, _5600
)
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4324, _4325, _4343
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2842
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4385
...
class RootAssemblyCompoundParametricStudyTool(_4385.AssemblyCompoundParametricStudyTool):
    """RootAssemblyCompoundParametricStudyTool
    ...
    @property
    def compound_load_case(self) -> '_5588.AbstractLoadCaseGroup':
        ...
        if _5588.AbstractLoadCaseGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_abstract_design_state_load_case_group(self) -> '_5587.AbstractDesignStateLoadCaseGroup':
        ...
        if _5587.AbstractDesignStateLoadCaseGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_abstract_static_load_case_group(self) -> '_5589.AbstractStaticLoadCaseGroup':
        ...
        if _5589.AbstractStaticLoadCaseGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_design_state(self) -> '_5592.DesignState':
        ...
        if _5592.DesignState.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_duty_cycle(self) -> '_5593.DutyCycle':
        ...
        if _5593.DutyCycle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_sub_group_in_single_design_state(self) -> '_5596.SubGroupInSingleDesignState':
        ...
        if _5596.SubGroupInSingleDesignState.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_time_series_load_case_group(self) -> '_5600.TimeSeriesLoadCaseGroup':
        ...
        if _5600.TimeSeriesLoadCaseGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def results_for_reporting(self) -> '_4325.ParametricStudyToolResultsForReporting':
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> '_2842.DutyCycleEfficiencyResults':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4343.RootAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4343.RootAssemblyParametricStudyTool]':
