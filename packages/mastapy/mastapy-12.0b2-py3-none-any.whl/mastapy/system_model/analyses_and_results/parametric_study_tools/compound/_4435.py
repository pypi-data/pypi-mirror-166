...
class FlexiblePinAssemblyCompoundParametricStudyTool(_4476.SpecialisedAssemblyCompoundParametricStudyTool):
    """FlexiblePinAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4295.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4295.FlexiblePinAssemblyParametricStudyTool]':
