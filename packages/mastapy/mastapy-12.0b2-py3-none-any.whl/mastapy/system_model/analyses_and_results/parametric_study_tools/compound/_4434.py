...
class FEPartCompoundParametricStudyTool(_4380.AbstractShaftOrHousingCompoundParametricStudyTool):
    """FEPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4294.FEPartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4294.FEPartParametricStudyTool]':
