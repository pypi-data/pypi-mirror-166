...
class ShaftHubConnectionCompoundParametricStudyTool(_4414.ConnectorCompoundParametricStudyTool):
    """ShaftHubConnectionCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4344.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4344.ShaftHubConnectionParametricStudyTool]':
