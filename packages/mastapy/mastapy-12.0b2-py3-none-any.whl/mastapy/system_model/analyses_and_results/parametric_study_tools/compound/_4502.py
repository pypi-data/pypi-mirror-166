...
class WormGearMeshCompoundParametricStudyTool(_4437.GearMeshCompoundParametricStudyTool):
    """WormGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4372.WormGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4372.WormGearMeshParametricStudyTool]':
