...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4504, _4505, _4396
...
class ZerolBevelGearSetCompoundParametricStudyTool(_4396.BevelGearSetCompoundParametricStudyTool):
    """ZerolBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4377.ZerolBevelGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4504.ZerolBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4505.ZerolBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4377.ZerolBevelGearSetParametricStudyTool]':
