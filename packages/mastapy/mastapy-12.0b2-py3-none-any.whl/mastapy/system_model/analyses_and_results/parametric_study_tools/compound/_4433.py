...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4431, _4432, _4438
...
class FaceGearSetCompoundParametricStudyTool(_4438.GearSetCompoundParametricStudyTool):
    """FaceGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4293.FaceGearSetParametricStudyTool]':
    ...
    @property
    def face_gears_compound_parametric_study_tool(self) -> 'List[_4431.FaceGearCompoundParametricStudyTool]':
    ...
    @property
    def face_meshes_compound_parametric_study_tool(self) -> 'List[_4432.FaceGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4293.FaceGearSetParametricStudyTool]':
