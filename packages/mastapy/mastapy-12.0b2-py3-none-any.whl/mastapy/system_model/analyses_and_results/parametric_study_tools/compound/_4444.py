...
class KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool(_4410.ConicalGearCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4305.KlingelnbergCycloPalloidConicalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4305.KlingelnbergCycloPalloidConicalGearParametricStudyTool]':
