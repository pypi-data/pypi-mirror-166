...
class BoltCompoundParametricStudyTool(_4403.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4251.BoltParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4251.BoltParametricStudyTool]':
