...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4483, _4484, _4396
...
class StraightBevelDiffGearSetCompoundParametricStudyTool(_4396.BevelGearSetCompoundParametricStudyTool):
    """StraightBevelDiffGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4356.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gears_compound_parametric_study_tool(self) -> 'List[_4483.StraightBevelDiffGearCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_parametric_study_tool(self) -> 'List[_4484.StraightBevelDiffGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4356.StraightBevelDiffGearSetParametricStudyTool]':
