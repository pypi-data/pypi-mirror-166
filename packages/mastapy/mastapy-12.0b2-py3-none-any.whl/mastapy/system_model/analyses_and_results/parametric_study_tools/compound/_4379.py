...
class AbstractShaftCompoundParametricStudyTool(_4380.AbstractShaftOrHousingCompoundParametricStudyTool):
    """AbstractShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4233.AbstractShaftParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4233.AbstractShaftParametricStudyTool]':
