...
class StraightBevelGearCompoundParametricStudyTool(_4394.BevelGearCompoundParametricStudyTool):
    """StraightBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4358.StraightBevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4358.StraightBevelGearParametricStudyTool]':
