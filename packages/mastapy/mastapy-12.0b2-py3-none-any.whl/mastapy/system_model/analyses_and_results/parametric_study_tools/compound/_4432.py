...
class FaceGearMeshCompoundParametricStudyTool(_4437.GearMeshCompoundParametricStudyTool):
    """FaceGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4291.FaceGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4291.FaceGearMeshParametricStudyTool]':
