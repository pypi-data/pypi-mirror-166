...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4389, _4390, _4396
...
class BevelDifferentialGearSetCompoundParametricStudyTool(_4396.BevelGearSetCompoundParametricStudyTool):
    """BevelDifferentialGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4244.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bevel_differential_gears_compound_parametric_study_tool(self) -> 'List[_4389.BevelDifferentialGearCompoundParametricStudyTool]':
    ...
    @property
    def bevel_differential_meshes_compound_parametric_study_tool(self) -> 'List[_4390.BevelDifferentialGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4244.BevelDifferentialGearSetParametricStudyTool]':
