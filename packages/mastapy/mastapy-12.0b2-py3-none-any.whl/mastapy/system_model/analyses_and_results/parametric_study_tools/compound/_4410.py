...
class ConicalGearCompoundParametricStudyTool(_4436.GearCompoundParametricStudyTool):
    """ConicalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4264.ConicalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4264.ConicalGearParametricStudyTool]':
