...
class BevelDifferentialSunGearCompoundParametricStudyTool(_4389.BevelDifferentialGearCompoundParametricStudyTool):
    """BevelDifferentialSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4246.BevelDifferentialSunGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4246.BevelDifferentialSunGearParametricStudyTool]':
