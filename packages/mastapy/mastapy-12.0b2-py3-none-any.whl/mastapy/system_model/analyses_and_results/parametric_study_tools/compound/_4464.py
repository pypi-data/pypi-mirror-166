...
class PointLoadCompoundParametricStudyTool(_4500.VirtualComponentCompoundParametricStudyTool):
    """PointLoadCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4335.PointLoadParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4335.PointLoadParametricStudyTool]':
