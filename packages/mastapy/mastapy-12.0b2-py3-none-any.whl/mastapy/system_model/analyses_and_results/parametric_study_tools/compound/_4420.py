...
class CVTPulleyCompoundParametricStudyTool(_4466.PulleyCompoundParametricStudyTool):
    """CVTPulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4273.CVTPulleyParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4273.CVTPulleyParametricStudyTool]':
