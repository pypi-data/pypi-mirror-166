...
class PowerLoadCompoundParametricStudyTool(_4500.VirtualComponentCompoundParametricStudyTool):
    """PowerLoadCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4336.PowerLoadParametricStudyTool]':
    ...
    @property
    def load_cases(self) -> 'List[_6858.PowerLoadLoadCase]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4336.PowerLoadParametricStudyTool]':
