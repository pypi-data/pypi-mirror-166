...
class DatumCompoundParametricStudyTool(_4403.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4282.DatumParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4282.DatumParametricStudyTool]':
