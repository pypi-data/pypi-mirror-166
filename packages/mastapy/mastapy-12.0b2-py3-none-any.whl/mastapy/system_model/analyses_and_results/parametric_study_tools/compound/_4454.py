...
class MeasurementComponentCompoundParametricStudyTool(_4500.VirtualComponentCompoundParametricStudyTool):
    """MeasurementComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4314.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4314.MeasurementComponentParametricStudyTool]':
