...
class TorqueConverterPumpCompoundParametricStudyTool(_4417.CouplingHalfCompoundParametricStudyTool):
    """TorqueConverterPumpCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4368.TorqueConverterPumpParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4368.TorqueConverterPumpParametricStudyTool]':
