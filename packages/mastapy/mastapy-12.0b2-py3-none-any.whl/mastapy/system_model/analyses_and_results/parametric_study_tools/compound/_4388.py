...
class BeltDriveCompoundParametricStudyTool(_4476.SpecialisedAssemblyCompoundParametricStudyTool):
    """BeltDriveCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4241.BeltDriveParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4241.BeltDriveParametricStudyTool]':
