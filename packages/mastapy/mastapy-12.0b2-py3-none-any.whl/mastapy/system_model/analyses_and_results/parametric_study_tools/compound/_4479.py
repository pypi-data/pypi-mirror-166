...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4477, _4478, _4396
...
class SpiralBevelGearSetCompoundParametricStudyTool(_4396.BevelGearSetCompoundParametricStudyTool):
    """SpiralBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4350.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4477.SpiralBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def spiral_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4478.SpiralBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4350.SpiralBevelGearSetParametricStudyTool]':
