...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4407, _4408, _4438
...
class ConceptGearSetCompoundParametricStudyTool(_4438.GearSetCompoundParametricStudyTool):
    """ConceptGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4262.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def concept_gears_compound_parametric_study_tool(self) -> 'List[_4407.ConceptGearCompoundParametricStudyTool]':
    ...
    @property
    def concept_meshes_compound_parametric_study_tool(self) -> 'List[_4408.ConceptGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4262.ConceptGearSetParametricStudyTool]':
