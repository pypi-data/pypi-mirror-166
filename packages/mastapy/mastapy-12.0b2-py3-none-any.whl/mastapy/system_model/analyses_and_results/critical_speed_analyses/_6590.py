...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6588, _6589, _6525
...
class WormGearSetCriticalSpeedAnalysis(_6525.GearSetCriticalSpeedAnalysis):
    """WormGearSetCriticalSpeedAnalysis
    ...
    @property
    def worm_gears_critical_speed_analysis(self) -> 'List[_6588.WormGearCriticalSpeedAnalysis]':
    ...
    @property
    def worm_meshes_critical_speed_analysis(self) -> 'List[_6589.WormGearMeshCriticalSpeedAnalysis]':
