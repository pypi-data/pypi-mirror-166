...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6647, _6648, _6654
...
class FaceGearSetCompoundCriticalSpeedAnalysis(_6654.GearSetCompoundCriticalSpeedAnalysis):
    """FaceGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6520.FaceGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def face_gears_compound_critical_speed_analysis(self) -> 'List[_6647.FaceGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def face_meshes_compound_critical_speed_analysis(self) -> 'List[_6648.FaceGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6520.FaceGearSetCriticalSpeedAnalysis]':
