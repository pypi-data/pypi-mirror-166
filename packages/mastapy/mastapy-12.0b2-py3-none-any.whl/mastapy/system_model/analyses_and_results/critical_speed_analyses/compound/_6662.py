...
class KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis(_6628.ConicalGearSetCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6533.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6533.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis]':
