...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import (
    _6602, _6604, _6607, _6614,
    _6613, _6635, _6615, _6620,
    _6625, _6637, _6639, _6643,
    _6650, _6649, _6651, _6658,
    _6665, _6668, _6669, _6670,
    _6672, _6674, _6679, _6680,
    _6681, _6683, _6685, _6690,
    _6689, _6695, _6696, _6701,
    _6704, _6707, _6711, _6715,
    _6719, _6722, _6594
)
...
class AssemblyCompoundCriticalSpeedAnalysis(_6594.AbstractAssemblyCompoundCriticalSpeedAnalysis):
    """AssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6470.AssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_6602.BearingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6604.BeltDriveCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6607.BevelDifferentialGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6614.BoltedJointCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6613.BoltCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6635.CVTCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6615.ClutchCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6620.ConceptCouplingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6625.ConceptGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6637.CycloidalAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6639.CycloidalDiscCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6643.CylindricalGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6650.FEPartCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6649.FaceGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6651.FlexiblePinAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6658.HypoidGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6665.KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6668.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6669.MassDiscCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6670.MeasurementComponentCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6672.OilSealCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6674.PartToPartShearCouplingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6679.PlanetCarrierCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6680.PointLoadCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6681.PowerLoadCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6683.RingPinsCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6685.RollingRingAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6690.ShaftHubConnectionCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6689.ShaftCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6695.SpiralBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6696.SpringDamperCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6701.StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6704.StraightBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6707.SynchroniserCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6711.TorqueConverterCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6715.UnbalancedMassCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6719.WormGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6722.ZerolBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6470.AssemblyCriticalSpeedAnalysis]':
