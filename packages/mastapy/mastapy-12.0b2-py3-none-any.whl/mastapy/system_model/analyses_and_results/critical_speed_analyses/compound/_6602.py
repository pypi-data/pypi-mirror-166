...
class BearingCompoundCriticalSpeedAnalysis(_6630.ConnectorCompoundCriticalSpeedAnalysis):
    """BearingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6471.BearingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6471.BearingCriticalSpeedAnalysis]':
