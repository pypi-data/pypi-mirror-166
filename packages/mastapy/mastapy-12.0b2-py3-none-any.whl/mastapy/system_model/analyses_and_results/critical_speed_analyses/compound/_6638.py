...
class CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis(_6618.CoaxialConnectionCompoundCriticalSpeedAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6509.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6509.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
