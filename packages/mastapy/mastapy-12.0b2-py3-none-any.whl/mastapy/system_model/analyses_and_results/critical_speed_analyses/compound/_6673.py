...
class PartCompoundCriticalSpeedAnalysis(_7463.PartCompoundAnalysis):
    """PartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6544.PartCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6544.PartCriticalSpeedAnalysis]':
