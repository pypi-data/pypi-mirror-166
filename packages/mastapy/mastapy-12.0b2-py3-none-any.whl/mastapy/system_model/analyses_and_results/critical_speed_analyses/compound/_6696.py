...
class SpringDamperCompoundCriticalSpeedAnalysis(_6631.CouplingCompoundCriticalSpeedAnalysis):
    """SpringDamperCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6568.SpringDamperCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6568.SpringDamperCriticalSpeedAnalysis]':
