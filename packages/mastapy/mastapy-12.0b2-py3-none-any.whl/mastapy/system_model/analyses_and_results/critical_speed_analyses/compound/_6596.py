...
class AbstractShaftOrHousingCompoundCriticalSpeedAnalysis(_6619.ComponentCompoundCriticalSpeedAnalysis):
    """AbstractShaftOrHousingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6465.AbstractShaftOrHousingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6465.AbstractShaftOrHousingCriticalSpeedAnalysis]':
