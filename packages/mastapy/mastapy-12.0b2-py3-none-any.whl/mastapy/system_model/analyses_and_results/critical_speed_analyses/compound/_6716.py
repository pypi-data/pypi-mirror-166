...
class VirtualComponentCompoundCriticalSpeedAnalysis(_6671.MountableComponentCompoundCriticalSpeedAnalysis):
    """VirtualComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6587.VirtualComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6587.VirtualComponentCriticalSpeedAnalysis]':
