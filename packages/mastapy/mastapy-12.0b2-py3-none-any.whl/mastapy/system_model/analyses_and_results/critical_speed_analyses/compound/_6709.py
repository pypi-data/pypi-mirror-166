...
class SynchroniserPartCompoundCriticalSpeedAnalysis(_6633.CouplingHalfCompoundCriticalSpeedAnalysis):
    """SynchroniserPartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6580.SynchroniserPartCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6580.SynchroniserPartCriticalSpeedAnalysis]':
