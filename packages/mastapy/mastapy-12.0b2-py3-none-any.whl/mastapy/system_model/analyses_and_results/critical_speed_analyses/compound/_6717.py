...
class WormGearCompoundCriticalSpeedAnalysis(_6652.GearCompoundCriticalSpeedAnalysis):
    """WormGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6588.WormGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6588.WormGearCriticalSpeedAnalysis]':
