...
class SynchroniserHalfCompoundCriticalSpeedAnalysis(_6709.SynchroniserPartCompoundCriticalSpeedAnalysis):
    """SynchroniserHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6579.SynchroniserHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6579.SynchroniserHalfCriticalSpeedAnalysis]':
