...
class MeasurementComponentCompoundCriticalSpeedAnalysis(_6716.VirtualComponentCompoundCriticalSpeedAnalysis):
    """MeasurementComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6541.MeasurementComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6541.MeasurementComponentCriticalSpeedAnalysis]':
