...
class ConceptCouplingHalfCompoundCriticalSpeedAnalysis(_6633.CouplingHalfCompoundCriticalSpeedAnalysis):
    """ConceptCouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6491.ConceptCouplingHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6491.ConceptCouplingHalfCriticalSpeedAnalysis]':
