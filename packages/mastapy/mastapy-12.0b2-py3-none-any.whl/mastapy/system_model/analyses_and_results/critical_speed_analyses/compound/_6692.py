...
class SpecialisedAssemblyCompoundCriticalSpeedAnalysis(_6594.AbstractAssemblyCompoundCriticalSpeedAnalysis):
    """SpecialisedAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6563.SpecialisedAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6563.SpecialisedAssemblyCriticalSpeedAnalysis]':
