...
class KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis(_6626.ConicalGearCompoundCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6531.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6531.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]':
