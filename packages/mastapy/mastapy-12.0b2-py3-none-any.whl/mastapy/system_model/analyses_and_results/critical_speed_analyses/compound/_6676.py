...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6633
...
class PartToPartShearCouplingHalfCompoundCriticalSpeedAnalysis(_6633.CouplingHalfCompoundCriticalSpeedAnalysis):
    """PartToPartShearCouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6547.PartToPartShearCouplingHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6547.PartToPartShearCouplingHalfCriticalSpeedAnalysis]':
