...
class AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis(_6627.ConicalGearMeshCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6468.AGMAGleasonConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6468.AGMAGleasonConicalGearMeshCriticalSpeedAnalysis]':
