...
class ConnectionCompoundCriticalSpeedAnalysis(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6498.ConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6498.ConnectionCriticalSpeedAnalysis]':
