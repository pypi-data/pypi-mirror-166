...
class ConicalGearMeshCompoundCriticalSpeedAnalysis(_6653.GearMeshCompoundCriticalSpeedAnalysis):
    """ConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6496.ConicalGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6496.ConicalGearMeshCriticalSpeedAnalysis]':
