...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6623, _6624, _6654
...
class ConceptGearSetCompoundCriticalSpeedAnalysis(_6654.GearSetCompoundCriticalSpeedAnalysis):
    """ConceptGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6494.ConceptGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gears_compound_critical_speed_analysis(self) -> 'List[_6623.ConceptGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_meshes_compound_critical_speed_analysis(self) -> 'List[_6624.ConceptGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6494.ConceptGearSetCriticalSpeedAnalysis]':
