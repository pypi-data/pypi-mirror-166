...
class AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis(_6628.ConicalGearSetCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6469.AGMAGleasonConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6469.AGMAGleasonConicalGearSetCriticalSpeedAnalysis]':
