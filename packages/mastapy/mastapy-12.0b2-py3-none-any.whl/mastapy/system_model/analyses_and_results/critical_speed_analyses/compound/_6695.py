...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6693, _6694, _6612
...
class SpiralBevelGearSetCompoundCriticalSpeedAnalysis(_6612.BevelGearSetCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6566.SpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_critical_speed_analysis(self) -> 'List[_6693.SpiralBevelGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_critical_speed_analysis(self) -> 'List[_6694.SpiralBevelGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6566.SpiralBevelGearSetCriticalSpeedAnalysis]':
