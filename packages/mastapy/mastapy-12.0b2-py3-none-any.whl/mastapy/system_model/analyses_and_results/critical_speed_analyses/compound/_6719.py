...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6717, _6718, _6654
...
class WormGearSetCompoundCriticalSpeedAnalysis(_6654.GearSetCompoundCriticalSpeedAnalysis):
    """WormGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6590.WormGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gears_compound_critical_speed_analysis(self) -> 'List[_6717.WormGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def worm_meshes_compound_critical_speed_analysis(self) -> 'List[_6718.WormGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6590.WormGearSetCriticalSpeedAnalysis]':
