...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6641, _6642, _6654
...
class CylindricalGearSetCompoundCriticalSpeedAnalysis(_6654.GearSetCompoundCriticalSpeedAnalysis):
    """CylindricalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6514.CylindricalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_critical_speed_analysis(self) -> 'List[_6641.CylindricalGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_critical_speed_analysis(self) -> 'List[_6642.CylindricalGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6514.CylindricalGearSetCriticalSpeedAnalysis]':
