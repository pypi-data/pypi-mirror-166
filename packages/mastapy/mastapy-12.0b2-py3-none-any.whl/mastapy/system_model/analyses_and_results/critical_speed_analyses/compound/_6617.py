...
class ClutchHalfCompoundCriticalSpeedAnalysis(_6633.CouplingHalfCompoundCriticalSpeedAnalysis):
    """ClutchHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6486.ClutchHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6486.ClutchHalfCriticalSpeedAnalysis]':
