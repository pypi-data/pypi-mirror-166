...
class ConceptCouplingConnectionCompoundCriticalSpeedAnalysis(_6632.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """ConceptCouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6489.ConceptCouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6489.ConceptCouplingConnectionCriticalSpeedAnalysis]':
