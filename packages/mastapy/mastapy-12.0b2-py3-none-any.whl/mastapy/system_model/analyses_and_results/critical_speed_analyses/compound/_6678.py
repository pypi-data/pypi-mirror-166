...
class PlanetaryGearSetCompoundCriticalSpeedAnalysis(_6643.CylindricalGearSetCompoundCriticalSpeedAnalysis):
    """PlanetaryGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6549.PlanetaryGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6549.PlanetaryGearSetCriticalSpeedAnalysis]':
