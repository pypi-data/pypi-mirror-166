...
class TorqueConverterConnectionCompoundCriticalSpeedAnalysis(_6632.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """TorqueConverterConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6582.TorqueConverterConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6582.TorqueConverterConnectionCriticalSpeedAnalysis]':
