...
class PartToPartShearCouplingConnectionCompoundCriticalSpeedAnalysis(_6632.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """PartToPartShearCouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6545.PartToPartShearCouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6545.PartToPartShearCouplingConnectionCriticalSpeedAnalysis]':
