...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6605, _6606, _6612
...
class BevelDifferentialGearSetCompoundCriticalSpeedAnalysis(_6612.BevelGearSetCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6476.BevelDifferentialGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_critical_speed_analysis(self) -> 'List[_6605.BevelDifferentialGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_critical_speed_analysis(self) -> 'List[_6606.BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6476.BevelDifferentialGearSetCriticalSpeedAnalysis]':
