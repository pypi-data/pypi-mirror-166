...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6720, _6721, _6612
...
class ZerolBevelGearSetCompoundCriticalSpeedAnalysis(_6612.BevelGearSetCompoundCriticalSpeedAnalysis):
    """ZerolBevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6593.ZerolBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_critical_speed_analysis(self) -> 'List[_6720.ZerolBevelGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_critical_speed_analysis(self) -> 'List[_6721.ZerolBevelGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6593.ZerolBevelGearSetCriticalSpeedAnalysis]':
