...
class AbstractAssemblyCompoundCriticalSpeedAnalysis(_6673.PartCompoundCriticalSpeedAnalysis):
    """AbstractAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6463.AbstractAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6463.AbstractAssemblyCriticalSpeedAnalysis]':
