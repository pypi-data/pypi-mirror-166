...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6474, _6475, _6481
...
class BevelDifferentialGearSetCriticalSpeedAnalysis(_6481.BevelGearSetCriticalSpeedAnalysis):
    """BevelDifferentialGearSetCriticalSpeedAnalysis
    ...
    @property
    def bevel_differential_gears_critical_speed_analysis(self) -> 'List[_6474.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_meshes_critical_speed_analysis(self) -> 'List[_6475.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
