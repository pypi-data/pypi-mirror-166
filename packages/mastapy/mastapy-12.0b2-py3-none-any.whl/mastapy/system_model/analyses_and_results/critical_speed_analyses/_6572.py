...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6570, _6571, _6481
...
class StraightBevelDiffGearSetCriticalSpeedAnalysis(_6481.BevelGearSetCriticalSpeedAnalysis):
    """StraightBevelDiffGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_diff_gears_critical_speed_analysis(self) -> 'List[_6570.StraightBevelDiffGearCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_critical_speed_analysis(self) -> 'List[_6571.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
