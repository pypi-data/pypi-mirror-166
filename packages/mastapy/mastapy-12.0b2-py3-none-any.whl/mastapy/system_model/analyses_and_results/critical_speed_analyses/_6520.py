...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6518, _6519, _6525
...
class FaceGearSetCriticalSpeedAnalysis(_6525.GearSetCriticalSpeedAnalysis):
    """FaceGearSetCriticalSpeedAnalysis
    ...
    @property
    def face_gears_critical_speed_analysis(self) -> 'List[_6518.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def face_meshes_critical_speed_analysis(self) -> 'List[_6519.FaceGearMeshCriticalSpeedAnalysis]':
