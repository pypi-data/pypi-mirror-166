...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3572, _3570, _3460
...
class ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed(_3460.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3572.ZerolBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3570.ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
