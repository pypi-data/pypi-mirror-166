...
class BoltCompoundSteadyStateSynchronousResponseAtASpeed(_3598.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3463.BoltSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3463.BoltSteadyStateSynchronousResponseAtASpeed]':
