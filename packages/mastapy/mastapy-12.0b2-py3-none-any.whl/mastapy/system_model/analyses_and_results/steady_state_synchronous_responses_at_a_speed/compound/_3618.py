...
class CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3574.AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed):
    """CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3489.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3489.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]':
