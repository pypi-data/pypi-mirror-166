...
class BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed(_3671.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3462.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3462.BoltedJointSteadyStateSynchronousResponseAtASpeed]':
