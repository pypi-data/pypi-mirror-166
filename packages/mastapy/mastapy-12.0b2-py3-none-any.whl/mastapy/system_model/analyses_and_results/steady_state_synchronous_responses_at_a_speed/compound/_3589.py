...
class BevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3577.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3461.BevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3461.BevelGearSteadyStateSynchronousResponseAtASpeed]':
