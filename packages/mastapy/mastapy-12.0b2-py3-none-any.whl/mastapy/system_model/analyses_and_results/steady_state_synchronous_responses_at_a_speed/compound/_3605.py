...
class ConicalGearCompoundSteadyStateSynchronousResponseAtASpeed(_3631.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """ConicalGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3477.ConicalGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3477.ConicalGearSteadyStateSynchronousResponseAtASpeed]':
