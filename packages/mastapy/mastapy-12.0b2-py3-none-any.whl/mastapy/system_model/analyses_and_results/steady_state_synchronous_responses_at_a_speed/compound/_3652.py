...
class PartCompoundSteadyStateSynchronousResponseAtASpeed(_7463.PartCompoundAnalysis):
    """PartCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3522.PartSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3522.PartSteadyStateSynchronousResponseAtASpeed]':
