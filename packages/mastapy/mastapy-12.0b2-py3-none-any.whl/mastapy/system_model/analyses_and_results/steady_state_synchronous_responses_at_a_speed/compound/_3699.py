...
class ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3589.BevelGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3572.ZerolBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3572.ZerolBevelGearSteadyStateSynchronousResponseAtASpeed]':
