...
class AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3652.PartCompoundSteadyStateSynchronousResponseAtASpeed):
    """AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3443.AbstractAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3443.AbstractAssemblySteadyStateSynchronousResponseAtASpeed]':
