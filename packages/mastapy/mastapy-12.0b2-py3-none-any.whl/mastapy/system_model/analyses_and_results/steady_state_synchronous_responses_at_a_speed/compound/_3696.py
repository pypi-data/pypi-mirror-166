...
class WormGearCompoundSteadyStateSynchronousResponseAtASpeed(_3631.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """WormGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3569.WormGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3569.WormGearSteadyStateSynchronousResponseAtASpeed]':
