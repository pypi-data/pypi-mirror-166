...
class ShaftCompoundSteadyStateSynchronousResponseAtASpeed(_3574.AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed):
    """ShaftCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3539.ShaftSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3539.ShaftSteadyStateSynchronousResponseAtASpeed]':
