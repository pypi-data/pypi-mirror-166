...
class StraightBevelPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed(_3678.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """StraightBevelPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3555.StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3555.StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed]':
