...
class BearingCompoundSteadyStateSynchronousResponseAtASpeed(_3609.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """BearingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3451.BearingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3451.BearingSteadyStateSynchronousResponseAtASpeed]':
