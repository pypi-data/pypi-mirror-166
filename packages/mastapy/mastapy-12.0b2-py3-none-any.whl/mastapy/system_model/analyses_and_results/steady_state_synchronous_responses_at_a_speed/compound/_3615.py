...
class CVTPulleyCompoundSteadyStateSynchronousResponseAtASpeed(_3661.PulleyCompoundSteadyStateSynchronousResponseAtASpeed):
    """CVTPulleyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3484.CVTPulleySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3484.CVTPulleySteadyStateSynchronousResponseAtASpeed]':
