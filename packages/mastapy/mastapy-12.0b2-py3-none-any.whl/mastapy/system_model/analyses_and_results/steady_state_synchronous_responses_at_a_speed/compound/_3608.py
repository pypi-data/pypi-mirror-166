...
class ConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3478.ConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3478.ConnectionSteadyStateSynchronousResponseAtASpeed]':
