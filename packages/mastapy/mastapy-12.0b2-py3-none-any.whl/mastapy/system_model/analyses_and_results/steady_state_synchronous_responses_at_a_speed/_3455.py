...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3456, _3454, _3460
...
class BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed(_3460.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3456.BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3454.BevelDifferentialGearMeshSteadyStateSynchronousResponseAtASpeed]':
