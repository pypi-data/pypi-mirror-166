...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3498, _3496, _3502
...
class FaceGearSetSteadyStateSynchronousResponseAtASpeed(_3502.GearSetSteadyStateSynchronousResponseAtASpeed):
    """FaceGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def face_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3498.FaceGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3496.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]':
