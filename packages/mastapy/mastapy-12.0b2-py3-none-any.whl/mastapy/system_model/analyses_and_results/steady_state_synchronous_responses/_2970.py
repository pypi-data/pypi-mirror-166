...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2971, _2969, _2982
...
class CylindricalGearSetSteadyStateSynchronousResponse(_2982.GearSetSteadyStateSynchronousResponse):
    """CylindricalGearSetSteadyStateSynchronousResponse
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response(self) -> 'List[_2971.CylindricalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response(self) -> 'List[_2969.CylindricalGearMeshSteadyStateSynchronousResponse]':
