...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2953, _2951, _2982
...
class ConceptGearSetSteadyStateSynchronousResponse(_2982.GearSetSteadyStateSynchronousResponse):
    """ConceptGearSetSteadyStateSynchronousResponse
    ...
    @property
    def concept_gears_steady_state_synchronous_response(self) -> 'List[_2953.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response(self) -> 'List[_2951.ConceptGearMeshSteadyStateSynchronousResponse]':
