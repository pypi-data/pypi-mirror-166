...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3024, _3022, _2939
...
class SpiralBevelGearSetSteadyStateSynchronousResponse(_2939.BevelGearSetSteadyStateSynchronousResponse):
    """SpiralBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3024.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3022.SpiralBevelGearMeshSteadyStateSynchronousResponse]':
