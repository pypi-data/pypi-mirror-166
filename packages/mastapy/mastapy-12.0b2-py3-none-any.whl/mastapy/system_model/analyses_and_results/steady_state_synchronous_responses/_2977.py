...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2978, _2976, _2982
...
class FaceGearSetSteadyStateSynchronousResponse(_2982.GearSetSteadyStateSynchronousResponse):
    """FaceGearSetSteadyStateSynchronousResponse
    ...
    @property
    def face_gears_steady_state_synchronous_response(self) -> 'List[_2978.FaceGearSteadyStateSynchronousResponse]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response(self) -> 'List[_2976.FaceGearMeshSteadyStateSynchronousResponse]':
