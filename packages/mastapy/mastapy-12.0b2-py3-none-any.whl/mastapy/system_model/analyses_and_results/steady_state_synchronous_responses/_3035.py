...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3036, _3034, _2939
...
class StraightBevelGearSetSteadyStateSynchronousResponse(_2939.BevelGearSetSteadyStateSynchronousResponse):
    """StraightBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3036.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3034.StraightBevelGearMeshSteadyStateSynchronousResponse]':
