...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2994, _2992, _2990
...
class KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse(_2990.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_steady_state_synchronous_response(self) -> 'List[_2994.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_2992.KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse]':
