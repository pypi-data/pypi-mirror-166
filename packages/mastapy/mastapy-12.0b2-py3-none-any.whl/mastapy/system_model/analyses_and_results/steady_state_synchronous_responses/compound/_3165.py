...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3163, _3164, _3073
...
class StraightBevelGearSetCompoundSteadyStateSynchronousResponse(_3073.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """StraightBevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3035.StraightBevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_gears_compound_steady_state_synchronous_response(self) -> 'List[_3163.StraightBevelGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3164.StraightBevelGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3035.StraightBevelGearSetSteadyStateSynchronousResponse]':
