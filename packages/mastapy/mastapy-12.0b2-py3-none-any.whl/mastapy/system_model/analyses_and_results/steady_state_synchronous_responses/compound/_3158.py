...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponse(_3093.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """SpringDamperConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3025.SpringDamperConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3025.SpringDamperConnectionSteadyStateSynchronousResponse]':
