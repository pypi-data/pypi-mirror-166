...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import (
    _3063, _3065, _3068, _3075,
    _3074, _3096, _3076, _3081,
    _3086, _3098, _3100, _3104,
    _3111, _3110, _3112, _3119,
    _3126, _3129, _3130, _3131,
    _3133, _3135, _3140, _3141,
    _3142, _3144, _3146, _3151,
    _3150, _3156, _3157, _3162,
    _3165, _3168, _3172, _3176,
    _3180, _3183, _3055
)
...
class AssemblyCompoundSteadyStateSynchronousResponse(_3055.AbstractAssemblyCompoundSteadyStateSynchronousResponse):
    """AssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2929.AssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def bearings(self) -> 'List[_3063.BearingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def belt_drives(self) -> 'List[_3065.BeltDriveCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3068.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3075.BoltedJointCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bolts(self) -> 'List[_3074.BoltCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cv_ts(self) -> 'List[_3096.CVTCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def clutches(self) -> 'List[_3076.ClutchCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3081.ConceptCouplingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3086.ConceptGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3098.CycloidalAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3100.CycloidalDiscCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3104.CylindricalGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def fe_parts(self) -> 'List[_3111.FEPartCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3110.FaceGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3112.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3119.HypoidGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3126.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3129.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def mass_discs(self) -> 'List[_3130.MassDiscCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def measurement_components(self) -> 'List[_3131.MeasurementComponentCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def oil_seals(self) -> 'List[_3133.OilSealCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3135.PartToPartShearCouplingCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3140.PlanetCarrierCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def point_loads(self) -> 'List[_3141.PointLoadCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def power_loads(self) -> 'List[_3142.PowerLoadCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def ring_pins(self) -> 'List[_3144.RingPinsCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3146.RollingRingAssemblyCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3151.ShaftHubConnectionCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def shafts(self) -> 'List[_3150.ShaftCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3156.SpiralBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3157.SpringDamperCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3162.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3165.StraightBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def synchronisers(self) -> 'List[_3168.SynchroniserCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def torque_converters(self) -> 'List[_3172.TorqueConverterCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3176.UnbalancedMassCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3180.WormGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3183.ZerolBevelGearSetCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2929.AssemblySteadyStateSynchronousResponse]':
