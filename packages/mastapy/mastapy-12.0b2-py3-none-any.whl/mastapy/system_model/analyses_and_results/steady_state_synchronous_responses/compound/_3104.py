...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3102, _3103, _3115
...
class CylindricalGearSetCompoundSteadyStateSynchronousResponse(_3115.GearSetCompoundSteadyStateSynchronousResponse):
    """CylindricalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2970.CylindricalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gears_compound_steady_state_synchronous_response(self) -> 'List[_3102.CylindricalGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3103.CylindricalGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2970.CylindricalGearSetSteadyStateSynchronousResponse]':
