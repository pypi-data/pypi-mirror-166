...
class CylindricalGearCompoundSteadyStateSynchronousResponse(_3113.GearCompoundSteadyStateSynchronousResponse):
    """CylindricalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2971.CylindricalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2971.CylindricalGearSteadyStateSynchronousResponse]':
