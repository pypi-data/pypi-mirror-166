...
class SynchroniserCompoundSteadyStateSynchronousResponse(_3153.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """SynchroniserCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3042.SynchroniserSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3042.SynchroniserSteadyStateSynchronousResponse]':
