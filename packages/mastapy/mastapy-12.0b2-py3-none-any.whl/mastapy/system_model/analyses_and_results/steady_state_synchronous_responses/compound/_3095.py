...
class CVTBeltConnectionCompoundSteadyStateSynchronousResponse(_3064.BeltConnectionCompoundSteadyStateSynchronousResponse):
    """CVTBeltConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2962.CVTBeltConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2962.CVTBeltConnectionSteadyStateSynchronousResponse]':
