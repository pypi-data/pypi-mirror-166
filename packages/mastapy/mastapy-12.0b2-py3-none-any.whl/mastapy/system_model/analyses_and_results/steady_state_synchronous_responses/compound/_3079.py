...
class CoaxialConnectionCompoundSteadyStateSynchronousResponse(_3152.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """CoaxialConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2946.CoaxialConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2946.CoaxialConnectionSteadyStateSynchronousResponse]':
