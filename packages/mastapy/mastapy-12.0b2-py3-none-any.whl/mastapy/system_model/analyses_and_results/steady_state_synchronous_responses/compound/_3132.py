...
class MountableComponentCompoundSteadyStateSynchronousResponse(_3080.ComponentCompoundSteadyStateSynchronousResponse):
    """MountableComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3000.MountableComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3000.MountableComponentSteadyStateSynchronousResponse]':
