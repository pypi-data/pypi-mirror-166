...
class KlingelnbergCycloPalloidHypoidGearCompoundSteadyStateSynchronousResponse(_3121.KlingelnbergCycloPalloidConicalGearCompoundSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2994.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2994.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
