...
class ExternalCADModelCompoundSteadyStateSynchronousResponse(_3080.ComponentCompoundSteadyStateSynchronousResponse):
    """ExternalCADModelCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2975.ExternalCADModelSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2975.ExternalCADModelSteadyStateSynchronousResponse]':
