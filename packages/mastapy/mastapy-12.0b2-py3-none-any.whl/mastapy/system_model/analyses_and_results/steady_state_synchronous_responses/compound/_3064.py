...
class BeltConnectionCompoundSteadyStateSynchronousResponse(_3120.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """BeltConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2931.BeltConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2931.BeltConnectionSteadyStateSynchronousResponse]':
