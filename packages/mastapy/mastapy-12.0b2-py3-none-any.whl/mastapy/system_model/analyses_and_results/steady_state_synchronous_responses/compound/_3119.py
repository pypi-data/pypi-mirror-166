...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3117, _3118, _3061
...
class HypoidGearSetCompoundSteadyStateSynchronousResponse(_3061.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse):
    """HypoidGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2986.HypoidGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gears_compound_steady_state_synchronous_response(self) -> 'List[_3117.HypoidGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3118.HypoidGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2986.HypoidGearSetSteadyStateSynchronousResponse]':
