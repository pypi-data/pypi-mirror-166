...
class BoltedJointCompoundSteadyStateSynchronousResponse(_3153.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """BoltedJointCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2941.BoltedJointSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2941.BoltedJointSteadyStateSynchronousResponse]':
