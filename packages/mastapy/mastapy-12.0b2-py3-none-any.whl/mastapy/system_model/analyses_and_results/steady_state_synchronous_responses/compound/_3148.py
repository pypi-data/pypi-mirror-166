...
class RollingRingConnectionCompoundSteadyStateSynchronousResponse(_3120.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """RollingRingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3015.RollingRingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3015.RollingRingConnectionSteadyStateSynchronousResponse]':
