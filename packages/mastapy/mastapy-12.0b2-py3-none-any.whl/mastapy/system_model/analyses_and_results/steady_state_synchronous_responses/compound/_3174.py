...
class TorqueConverterPumpCompoundSteadyStateSynchronousResponse(_3094.CouplingHalfCompoundSteadyStateSynchronousResponse):
    """TorqueConverterPumpCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3044.TorqueConverterPumpSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3044.TorqueConverterPumpSteadyStateSynchronousResponse]':
