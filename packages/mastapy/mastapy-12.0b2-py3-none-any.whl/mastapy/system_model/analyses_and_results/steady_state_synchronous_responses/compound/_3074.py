...
class BoltCompoundSteadyStateSynchronousResponse(_3080.ComponentCompoundSteadyStateSynchronousResponse):
    """BoltCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2942.BoltSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2942.BoltSteadyStateSynchronousResponse]':
