...
class PartCompoundSteadyStateSynchronousResponse(_7463.PartCompoundAnalysis):
    """PartCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3002.PartSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3002.PartSteadyStateSynchronousResponse]':
