...
class AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse(_3089.ConicalGearSetCompoundSteadyStateSynchronousResponse):
    """AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2927.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2927.AGMAGleasonConicalGearSetSteadyStateSynchronousResponse]':
