...
class PlanetCarrierCompoundSteadyStateSynchronousResponse(_3132.MountableComponentCompoundSteadyStateSynchronousResponse):
    """PlanetCarrierCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3008.PlanetCarrierSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3008.PlanetCarrierSteadyStateSynchronousResponse]':
