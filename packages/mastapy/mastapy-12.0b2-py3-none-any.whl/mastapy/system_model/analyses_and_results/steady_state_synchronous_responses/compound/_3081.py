...
class ConceptCouplingCompoundSteadyStateSynchronousResponse(_3092.CouplingCompoundSteadyStateSynchronousResponse):
    """ConceptCouplingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2950.ConceptCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2950.ConceptCouplingSteadyStateSynchronousResponse]':
