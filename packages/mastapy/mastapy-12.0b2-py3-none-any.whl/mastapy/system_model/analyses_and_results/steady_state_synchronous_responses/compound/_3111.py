...
class FEPartCompoundSteadyStateSynchronousResponse(_3057.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse):
    """FEPartCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2979.FEPartSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2979.FEPartSteadyStateSynchronousResponse]':
