...
from mastapy import _7476, _7470
...
class SingleAnalysis(_7470.MarshalByRefObjectPermanent):
    """SingleAnalysis
    ...
    def perform_analysis_with_progress(self, task_progress: '_7476.TaskProgress'):
        """ 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2152.DesignEntity') -> '_2595.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2595.DesignEntityAnalysis') -> '_2595.DesignEntityAnalysis':
        """ 'ResultsFor' is the original name of this method.
