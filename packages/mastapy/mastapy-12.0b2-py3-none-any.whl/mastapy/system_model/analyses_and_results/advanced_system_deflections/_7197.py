...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import (
    _7198, _7200, _7203, _7210,
    _7209, _7231, _7211, _7216,
    _7221, _7234, _7235, _7240,
    _7248, _7247, _7249, _7256,
    _7263, _7266, _7268, _7269,
    _7271, _7273, _7278, _7279,
    _7280, _7282, _7285, _7289,
    _7288, _7294, _7295, _7300,
    _7303, _7306, _7310, _7315,
    _7319, _7322, _7187
)
...
class AssemblyAdvancedSystemDeflection(_7187.AbstractAssemblyAdvancedSystemDeflection):
    """AssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2636.AssemblySystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_7198.BearingAdvancedSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_7200.BeltDriveAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7203.BevelDifferentialGearSetAdvancedSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7210.BoltedJointAdvancedSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_7209.BoltAdvancedSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_7231.CVTAdvancedSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_7211.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7216.ConceptCouplingAdvancedSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7221.ConceptGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7234.CycloidalAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7235.CycloidalDiscAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7240.CylindricalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_7248.FEPartAdvancedSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7247.FaceGearSetAdvancedSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7249.FlexiblePinAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7256.HypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7263.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7266.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_7268.MassDiscAdvancedSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_7269.MeasurementComponentAdvancedSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_7271.OilSealAdvancedSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7273.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7278.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_7279.PointLoadAdvancedSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_7280.PowerLoadAdvancedSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_7282.RingPinsAdvancedSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7285.RollingRingAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7289.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_7288.ShaftAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7294.SpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7295.SpringDamperAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7300.StraightBevelDiffGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7303.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_7306.SynchroniserAdvancedSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_7310.TorqueConverterAdvancedSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7315.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7319.WormGearSetAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7322.ZerolBevelGearSetAdvancedSystemDeflection]':
