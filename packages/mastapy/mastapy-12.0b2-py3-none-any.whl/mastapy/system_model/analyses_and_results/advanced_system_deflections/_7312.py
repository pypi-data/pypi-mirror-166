...
class TorqueConverterPumpAdvancedSystemDeflection(_7230.CouplingHalfAdvancedSystemDeflection):
    """TorqueConverterPumpAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2768.TorqueConverterPumpSystemDeflection]':
