...
from mastapy.system_model.analyses_and_results.system_deflections import _2697, _2717, _2740
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7288, _7238, _7291
...
class FlexiblePinAssemblyAdvancedSystemDeflection(_7291.SpecialisedAssemblyAdvancedSystemDeflection):
    """FlexiblePinAssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2697.FlexiblePinAssemblySystemDeflection]':
    ...
    @property
    def pin_advanced_analyses(self) -> 'List[_7288.ShaftAdvancedSystemDeflection]':
    ...
    @property
    def pin_spindle_fit_advanced_analyses(self) -> 'List[_2740.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def planet_gear_analyses(self) -> 'List[_7238.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def spindle_advanced_analyses(self) -> 'List[_7288.ShaftAdvancedSystemDeflection]':
