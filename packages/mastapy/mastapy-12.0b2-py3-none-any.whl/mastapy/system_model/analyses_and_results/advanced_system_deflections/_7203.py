...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7201, _7202, _7208
...
class BevelDifferentialGearSetAdvancedSystemDeflection(_7208.BevelGearSetAdvancedSystemDeflection):
    """BevelDifferentialGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2641.BevelDifferentialGearSetSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_advanced_system_deflection(self) -> 'List[_7201.BevelDifferentialGearAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_advanced_system_deflection(self) -> 'List[_7202.BevelDifferentialGearMeshAdvancedSystemDeflection]':
