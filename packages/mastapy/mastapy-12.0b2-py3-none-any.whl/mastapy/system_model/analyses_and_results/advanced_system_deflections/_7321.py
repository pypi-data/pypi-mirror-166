...
class ZerolBevelGearMeshAdvancedSystemDeflection(_7207.BevelGearMeshAdvancedSystemDeflection):
    """ZerolBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2778.ZerolBevelGearMeshSystemDeflection]':
