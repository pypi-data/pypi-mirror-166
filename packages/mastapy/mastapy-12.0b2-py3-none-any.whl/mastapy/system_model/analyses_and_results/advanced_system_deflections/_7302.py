...
class StraightBevelGearMeshAdvancedSystemDeflection(_7207.BevelGearMeshAdvancedSystemDeflection):
    """StraightBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2755.StraightBevelGearMeshSystemDeflection]':
