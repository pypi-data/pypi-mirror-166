...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(_7207.BevelGearMeshAdvancedSystemDeflection):
    """StraightBevelDiffGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2752.StraightBevelDiffGearMeshSystemDeflection]':
