...
class BeltDriveAdvancedSystemDeflection(_7291.SpecialisedAssemblyAdvancedSystemDeflection):
    """BeltDriveAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2639.BeltDriveSystemDeflection]':
