...
class WormGearAdvancedSystemDeflection(_7250.GearAdvancedSystemDeflection):
    """WormGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2777.WormGearSystemDeflection]':
