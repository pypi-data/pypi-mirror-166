...
class ConceptGearAdvancedSystemDeflection(_7250.GearAdvancedSystemDeflection):
    """ConceptGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2661.ConceptGearSystemDeflection]':
