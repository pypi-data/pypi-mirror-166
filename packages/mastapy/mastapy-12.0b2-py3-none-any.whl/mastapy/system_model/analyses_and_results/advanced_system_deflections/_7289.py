...
class ShaftHubConnectionAdvancedSystemDeflection(_7226.ConnectorAdvancedSystemDeflection):
    """ShaftHubConnectionAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2740.ShaftHubConnectionSystemDeflection]':
