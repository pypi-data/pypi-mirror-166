...
class StraightBevelGearAdvancedSystemDeflection(_7206.BevelGearAdvancedSystemDeflection):
    """StraightBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2757.StraightBevelGearSystemDeflection]':
