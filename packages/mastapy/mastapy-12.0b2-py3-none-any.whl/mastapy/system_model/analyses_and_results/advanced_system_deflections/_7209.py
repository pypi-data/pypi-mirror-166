...
class BoltAdvancedSystemDeflection(_7215.ComponentAdvancedSystemDeflection):
    """BoltAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2649.BoltSystemDeflection]':
