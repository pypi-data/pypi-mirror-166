...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7298, _7299, _7208
...
class StraightBevelDiffGearSetAdvancedSystemDeflection(_7208.BevelGearSetAdvancedSystemDeflection):
    """StraightBevelDiffGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2753.StraightBevelDiffGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gears_advanced_system_deflection(self) -> 'List[_7298.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_advanced_system_deflection(self) -> 'List[_7299.StraightBevelDiffGearMeshAdvancedSystemDeflection]':
