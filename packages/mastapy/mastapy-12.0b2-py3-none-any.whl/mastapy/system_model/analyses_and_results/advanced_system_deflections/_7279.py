...
class PointLoadAdvancedSystemDeflection(_7316.VirtualComponentAdvancedSystemDeflection):
    """PointLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2730.PointLoadSystemDeflection]':
