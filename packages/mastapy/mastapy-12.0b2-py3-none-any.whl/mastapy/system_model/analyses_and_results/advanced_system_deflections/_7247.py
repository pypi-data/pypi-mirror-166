...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7245, _7246, _7252
...
class FaceGearSetAdvancedSystemDeflection(_7252.GearSetAdvancedSystemDeflection):
    """FaceGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2694.FaceGearSetSystemDeflection]':
    ...
    @property
    def face_gears_advanced_system_deflection(self) -> 'List[_7245.FaceGearAdvancedSystemDeflection]':
    ...
    @property
    def face_meshes_advanced_system_deflection(self) -> 'List[_7246.FaceGearMeshAdvancedSystemDeflection]':
