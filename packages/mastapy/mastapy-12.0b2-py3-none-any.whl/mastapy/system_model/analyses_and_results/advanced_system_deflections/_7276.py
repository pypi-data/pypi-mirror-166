...
class PlanetaryConnectionAdvancedSystemDeflection(_7290.ShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """PlanetaryConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2728.PlanetaryConnectionSystemDeflection]':
