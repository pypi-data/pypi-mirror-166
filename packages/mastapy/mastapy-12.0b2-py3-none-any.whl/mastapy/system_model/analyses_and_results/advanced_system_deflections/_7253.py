...
class GuideDxfModelAdvancedSystemDeflection(_7215.ComponentAdvancedSystemDeflection):
    """GuideDxfModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2701.GuideDxfModelSystemDeflection]':
