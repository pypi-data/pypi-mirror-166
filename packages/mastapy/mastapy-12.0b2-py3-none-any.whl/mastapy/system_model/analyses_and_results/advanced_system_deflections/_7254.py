...
class HypoidGearAdvancedSystemDeflection(_7194.AGMAGleasonConicalGearAdvancedSystemDeflection):
    """HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2704.HypoidGearSystemDeflection]':
