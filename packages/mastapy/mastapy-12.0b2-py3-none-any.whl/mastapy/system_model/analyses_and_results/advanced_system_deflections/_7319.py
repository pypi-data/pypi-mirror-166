...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7317, _7318, _7252
...
class WormGearSetAdvancedSystemDeflection(_7252.GearSetAdvancedSystemDeflection):
    """WormGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2776.WormGearSetSystemDeflection]':
    ...
    @property
    def worm_gears_advanced_system_deflection(self) -> 'List[_7317.WormGearAdvancedSystemDeflection]':
    ...
    @property
    def worm_meshes_advanced_system_deflection(self) -> 'List[_7318.WormGearMeshAdvancedSystemDeflection]':
