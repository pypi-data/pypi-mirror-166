...
class PartToPartShearCouplingConnectionAdvancedSystemDeflection(_7229.CouplingConnectionAdvancedSystemDeflection):
    """PartToPartShearCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2725.PartToPartShearCouplingConnectionSystemDeflection]':
