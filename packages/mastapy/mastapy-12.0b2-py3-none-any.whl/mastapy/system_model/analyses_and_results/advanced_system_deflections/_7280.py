...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7314, _7316
...
class PowerLoadAdvancedSystemDeflection(_7316.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6858.PowerLoadLoadCase':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2731.PowerLoadSystemDeflection]':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7314.TransmissionErrorToOtherPowerLoad]':
