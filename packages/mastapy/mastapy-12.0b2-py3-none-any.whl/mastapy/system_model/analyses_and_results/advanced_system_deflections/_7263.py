...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7261, _7262, _7260
...
class KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection(_7260.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2711.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_advanced_system_deflection(self) -> 'List[_7261.KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_advanced_system_deflection(self) -> 'List[_7262.KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection]':
