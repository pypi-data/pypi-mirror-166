...
class StraightBevelDiffGearAdvancedSystemDeflection(_7206.BevelGearAdvancedSystemDeflection):
    """StraightBevelDiffGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2754.StraightBevelDiffGearSystemDeflection]':
