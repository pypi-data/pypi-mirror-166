...
class KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection(_7259.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2710.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
