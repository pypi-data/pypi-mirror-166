...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7238, _7227, _7251
...
class CylindricalGearMeshAdvancedSystemDeflection(_7251.GearMeshAdvancedSystemDeflection):
    """CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6782.CylindricalGearMeshLoadCase':
    ...
    @property
    def points_with_worst_results(self) -> '_1202.PointsWithWorstResults':
    ...
    @property
    def transmission_error_fourier_series_for_first_tooth_passing_period(self) -> '_1473.FourierSeries':
    ...
    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_7238.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2679.CylindricalGearMeshSystemDeflectionTimestep]':
    ...
    @property
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(self) -> 'List[_7227.ContactChartPerToothPass]':
