...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7239, _7241, _7250
...
class CylindricalGearAdvancedSystemDeflection(_7250.GearAdvancedSystemDeflection):
    """CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_7239.CylindricalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_7241.CylindricalMeshedGearAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_7241.CylindricalMeshedGearAdvancedSystemDeflection]':
