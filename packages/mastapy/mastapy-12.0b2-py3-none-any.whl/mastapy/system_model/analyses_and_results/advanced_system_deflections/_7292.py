...
class SpiralBevelGearAdvancedSystemDeflection(_7206.BevelGearAdvancedSystemDeflection):
    """SpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2748.SpiralBevelGearSystemDeflection]':
