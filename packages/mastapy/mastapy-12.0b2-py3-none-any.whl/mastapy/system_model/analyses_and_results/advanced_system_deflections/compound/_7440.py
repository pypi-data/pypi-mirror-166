...
class TorqueConverterCompoundAdvancedSystemDeflection(_7360.CouplingCompoundAdvancedSystemDeflection):
    """TorqueConverterCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7310.TorqueConverterAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7310.TorqueConverterAdvancedSystemDeflection]':
