...
class WormGearCompoundAdvancedSystemDeflection(_7381.GearCompoundAdvancedSystemDeflection):
    """WormGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7317.WormGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7317.WormGearAdvancedSystemDeflection]':
