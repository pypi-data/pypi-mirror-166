...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7431, _7432, _7341
...
class StraightBevelGearSetCompoundAdvancedSystemDeflection(_7341.BevelGearSetCompoundAdvancedSystemDeflection):
    """StraightBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7303.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7431.StraightBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7432.StraightBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7303.StraightBevelGearSetAdvancedSystemDeflection]':
