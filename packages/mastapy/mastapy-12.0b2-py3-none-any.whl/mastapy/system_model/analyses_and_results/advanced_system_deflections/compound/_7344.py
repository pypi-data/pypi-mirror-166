...
class ClutchCompoundAdvancedSystemDeflection(_7360.CouplingCompoundAdvancedSystemDeflection):
    """ClutchCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7211.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7211.ClutchAdvancedSystemDeflection]':
