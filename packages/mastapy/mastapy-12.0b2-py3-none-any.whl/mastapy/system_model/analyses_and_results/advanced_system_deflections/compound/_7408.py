...
class PlanetCarrierCompoundAdvancedSystemDeflection(_7400.MountableComponentCompoundAdvancedSystemDeflection):
    """PlanetCarrierCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7278.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7278.PlanetCarrierAdvancedSystemDeflection]':
