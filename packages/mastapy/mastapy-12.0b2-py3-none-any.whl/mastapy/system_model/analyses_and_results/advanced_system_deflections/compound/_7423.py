...
class SpiralBevelGearMeshCompoundAdvancedSystemDeflection(_7340.BevelGearMeshCompoundAdvancedSystemDeflection):
    """SpiralBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7293.SpiralBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7293.SpiralBevelGearMeshAdvancedSystemDeflection]':
