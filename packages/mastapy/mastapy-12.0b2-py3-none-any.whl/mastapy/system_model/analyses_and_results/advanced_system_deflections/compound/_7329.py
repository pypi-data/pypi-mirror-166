...
class AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection(_7357.ConicalGearSetCompoundAdvancedSystemDeflection):
    """AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7196.AGMAGleasonConicalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7196.AGMAGleasonConicalGearSetAdvancedSystemDeflection]':
