...
class ZerolBevelGearCompoundAdvancedSystemDeflection(_7339.BevelGearCompoundAdvancedSystemDeflection):
    """ZerolBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7320.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7320.ZerolBevelGearAdvancedSystemDeflection]':
