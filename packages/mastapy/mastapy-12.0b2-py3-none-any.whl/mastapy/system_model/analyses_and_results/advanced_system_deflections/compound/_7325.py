...
class AbstractShaftOrHousingCompoundAdvancedSystemDeflection(_7348.ComponentCompoundAdvancedSystemDeflection):
    """AbstractShaftOrHousingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7189.AbstractShaftOrHousingAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7189.AbstractShaftOrHousingAdvancedSystemDeflection]':
