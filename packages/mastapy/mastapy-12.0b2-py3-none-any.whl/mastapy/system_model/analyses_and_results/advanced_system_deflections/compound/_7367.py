...
class CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection(_7347.CoaxialConnectionCompoundAdvancedSystemDeflection):
    """CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7236.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7236.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
