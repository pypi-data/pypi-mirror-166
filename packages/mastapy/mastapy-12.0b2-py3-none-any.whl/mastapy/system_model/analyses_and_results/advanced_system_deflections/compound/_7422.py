...
class SpiralBevelGearCompoundAdvancedSystemDeflection(_7339.BevelGearCompoundAdvancedSystemDeflection):
    """SpiralBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7292.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7292.SpiralBevelGearAdvancedSystemDeflection]':
