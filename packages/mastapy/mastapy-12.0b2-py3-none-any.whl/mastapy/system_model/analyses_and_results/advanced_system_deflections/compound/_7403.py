...
class PartToPartShearCouplingCompoundAdvancedSystemDeflection(_7360.CouplingCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7273.PartToPartShearCouplingAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7273.PartToPartShearCouplingAdvancedSystemDeflection]':
