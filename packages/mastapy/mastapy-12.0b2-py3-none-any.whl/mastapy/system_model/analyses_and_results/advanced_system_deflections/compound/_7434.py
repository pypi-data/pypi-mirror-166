...
class StraightBevelPlanetGearCompoundAdvancedSystemDeflection(_7428.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    """StraightBevelPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7304.StraightBevelPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7304.StraightBevelPlanetGearAdvancedSystemDeflection]':
