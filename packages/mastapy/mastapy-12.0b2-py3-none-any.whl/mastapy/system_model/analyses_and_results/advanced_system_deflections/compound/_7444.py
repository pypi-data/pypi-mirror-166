...
class UnbalancedMassCompoundAdvancedSystemDeflection(_7445.VirtualComponentCompoundAdvancedSystemDeflection):
    """UnbalancedMassCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7315.UnbalancedMassAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7315.UnbalancedMassAdvancedSystemDeflection]':
