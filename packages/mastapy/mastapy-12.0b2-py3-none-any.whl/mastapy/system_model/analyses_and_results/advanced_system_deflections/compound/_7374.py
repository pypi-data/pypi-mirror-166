...
class DatumCompoundAdvancedSystemDeflection(_7348.ComponentCompoundAdvancedSystemDeflection):
    """DatumCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7243.DatumAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7243.DatumAdvancedSystemDeflection]':
