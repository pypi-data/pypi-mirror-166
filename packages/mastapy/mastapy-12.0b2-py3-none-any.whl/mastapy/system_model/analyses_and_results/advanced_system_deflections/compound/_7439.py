...
class SynchroniserSleeveCompoundAdvancedSystemDeflection(_7438.SynchroniserPartCompoundAdvancedSystemDeflection):
    """SynchroniserSleeveCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7309.SynchroniserSleeveAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7309.SynchroniserSleeveAdvancedSystemDeflection]':
