...
class RingPinsToDiscConnectionCompoundAdvancedSystemDeflection(_7388.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """RingPinsToDiscConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7283.RingPinsToDiscConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7283.RingPinsToDiscConnectionAdvancedSystemDeflection]':
