...
class SpecialisedAssemblyCompoundAdvancedSystemDeflection(_7323.AbstractAssemblyCompoundAdvancedSystemDeflection):
    """SpecialisedAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7291.SpecialisedAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7291.SpecialisedAssemblyAdvancedSystemDeflection]':
