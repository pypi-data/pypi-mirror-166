...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7376, _7377, _7383
...
class FaceGearSetCompoundAdvancedSystemDeflection(_7383.GearSetCompoundAdvancedSystemDeflection):
    """FaceGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7247.FaceGearSetAdvancedSystemDeflection]':
    ...
    @property
    def face_gears_compound_advanced_system_deflection(self) -> 'List[_7376.FaceGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def face_meshes_compound_advanced_system_deflection(self) -> 'List[_7377.FaceGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7247.FaceGearSetAdvancedSystemDeflection]':
