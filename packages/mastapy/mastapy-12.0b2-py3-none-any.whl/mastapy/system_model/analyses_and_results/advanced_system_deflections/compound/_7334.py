...
class BevelDifferentialGearCompoundAdvancedSystemDeflection(_7339.BevelGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7201.BevelDifferentialGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7201.BevelDifferentialGearAdvancedSystemDeflection]':
