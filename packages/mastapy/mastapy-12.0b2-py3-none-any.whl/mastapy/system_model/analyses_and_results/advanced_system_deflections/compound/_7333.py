...
class BeltDriveCompoundAdvancedSystemDeflection(_7421.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """BeltDriveCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7200.BeltDriveAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7200.BeltDriveAdvancedSystemDeflection]':
