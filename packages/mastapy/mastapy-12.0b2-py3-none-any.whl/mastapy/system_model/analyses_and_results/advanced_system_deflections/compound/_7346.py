...
class ClutchHalfCompoundAdvancedSystemDeflection(_7362.CouplingHalfCompoundAdvancedSystemDeflection):
    """ClutchHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7213.ClutchHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7213.ClutchHalfAdvancedSystemDeflection]':
