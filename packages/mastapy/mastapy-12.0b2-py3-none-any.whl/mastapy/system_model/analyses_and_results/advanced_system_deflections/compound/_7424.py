...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7422, _7423, _7341
...
class SpiralBevelGearSetCompoundAdvancedSystemDeflection(_7341.BevelGearSetCompoundAdvancedSystemDeflection):
    """SpiralBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7294.SpiralBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7422.SpiralBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7423.SpiralBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7294.SpiralBevelGearSetAdvancedSystemDeflection]':
