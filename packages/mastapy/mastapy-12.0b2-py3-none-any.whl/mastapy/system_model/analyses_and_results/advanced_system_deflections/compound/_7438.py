...
class SynchroniserPartCompoundAdvancedSystemDeflection(_7362.CouplingHalfCompoundAdvancedSystemDeflection):
    """SynchroniserPartCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7308.SynchroniserPartAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7308.SynchroniserPartAdvancedSystemDeflection]':
