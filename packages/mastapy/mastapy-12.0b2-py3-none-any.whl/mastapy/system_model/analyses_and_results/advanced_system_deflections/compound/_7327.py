...
class AGMAGleasonConicalGearCompoundAdvancedSystemDeflection(_7355.ConicalGearCompoundAdvancedSystemDeflection):
    """AGMAGleasonConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7194.AGMAGleasonConicalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7194.AGMAGleasonConicalGearAdvancedSystemDeflection]':
