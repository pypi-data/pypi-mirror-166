...
class TorqueConverterTurbineCompoundAdvancedSystemDeflection(_7362.CouplingHalfCompoundAdvancedSystemDeflection):
    """TorqueConverterTurbineCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7313.TorqueConverterTurbineAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7313.TorqueConverterTurbineAdvancedSystemDeflection]':
