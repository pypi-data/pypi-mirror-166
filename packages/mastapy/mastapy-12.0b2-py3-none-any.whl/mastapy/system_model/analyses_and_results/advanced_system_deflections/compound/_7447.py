...
class WormGearMeshCompoundAdvancedSystemDeflection(_7382.GearMeshCompoundAdvancedSystemDeflection):
    """WormGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7318.WormGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7318.WormGearMeshAdvancedSystemDeflection]':
