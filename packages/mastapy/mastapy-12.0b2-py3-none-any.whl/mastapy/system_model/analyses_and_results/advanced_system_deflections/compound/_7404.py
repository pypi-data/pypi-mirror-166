...
class PartToPartShearCouplingConnectionCompoundAdvancedSystemDeflection(_7361.CouplingConnectionCompoundAdvancedSystemDeflection):
    """PartToPartShearCouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7274.PartToPartShearCouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7274.PartToPartShearCouplingConnectionAdvancedSystemDeflection]':
