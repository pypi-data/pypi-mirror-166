...
class ConceptCouplingConnectionCompoundAdvancedSystemDeflection(_7361.CouplingConnectionCompoundAdvancedSystemDeflection):
    """ConceptCouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7217.ConceptCouplingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7217.ConceptCouplingConnectionAdvancedSystemDeflection]':
