...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2839, _2875, _2798
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6190
...
class FlexiblePinAnalysisGearAndBearingRating(_6190.FlexiblePinAnalysis):
    """FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2839.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2839.CylindricalGearSetCompoundSystemDeflection.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2798.BearingCompoundSystemDeflection]':
