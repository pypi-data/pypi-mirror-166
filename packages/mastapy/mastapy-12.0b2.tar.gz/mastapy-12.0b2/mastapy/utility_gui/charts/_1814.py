...
from mastapy.utility.report import _1705, _1710
...
class NDChartDefinition(_1710.ChartDefinition):
    """NDChartDefinition
    ...
    @property
    def x_axis(self) -> '_1705.AxisSettings':
    ...
    @property
    def y_axis(self) -> '_1705.AxisSettings':
