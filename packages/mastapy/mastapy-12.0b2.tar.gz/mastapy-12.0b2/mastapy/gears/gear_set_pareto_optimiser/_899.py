...
from mastapy.math_utility.optimisation import _1510, _1507, _1501
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1510.ParetoOptimisationStrategy':
    ...
    @property
    def filters(self) -> 'List[_1507.ParetoOptimisationFilter]':
    ...
    @property
    def input_setters(self) -> 'List[_1501.InputSetter[TAnalysis]]':
