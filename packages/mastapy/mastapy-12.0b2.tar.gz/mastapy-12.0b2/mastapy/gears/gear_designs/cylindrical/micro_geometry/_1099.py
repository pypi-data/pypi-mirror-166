...
class CylindricalGearSetMicroGeometry(_1219.GearSetImplementationDetail):
    """CylindricalGearSetMicroGeometry
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet(self) -> '_1219.GearSetImplementationDetail':
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet_and_add_to(self, gear_set_design: '_1033.CylindricalPlanetaryGearSetDesign') -> '_1219.GearSetImplementationDetail':
