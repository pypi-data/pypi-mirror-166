...
class ToothFlankFractureAnalysisSettings(_1549.IndependentReportablePropertiesBase['ToothFlankFractureAnalysisSettings']):
    """ToothFlankFractureAnalysisSettings
    ...
    @property
    def measured_residual_stress_profile_property(self) -> '_1495.Vector2DListAccessor':
    ...
    def measured_residual_stress_profile_property(self, value: '_1495.Vector2DListAccessor'):
