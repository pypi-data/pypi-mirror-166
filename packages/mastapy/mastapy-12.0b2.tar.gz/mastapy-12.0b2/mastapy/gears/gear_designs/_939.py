...
from mastapy.utility.property import _1796
...
class DesignConstraintsCollection(_1789.NamedDatabaseItem):
    """DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1796.DeletableCollectionMember[_937.DesignConstraint]]':
