...
class ConicalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1201.GearLTCAContactCharts':
        ...
        if _1201.GearLTCAContactCharts.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def contact_charts_as_text_file(self) -> '_1200.GearLTCAContactChartDataAsTextFile':
        ...
        if _1200.GearLTCAContactChartDataAsTextFile.TYPE not in temp.__class__.__mro__:
