...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self) -> 'List[_1506.OptimizationVariable]':
    ...
    @property
    def target_history(self) -> 'List[_1506.OptimizationVariable]':
    ...
    def add_input_history(self, value: '_1506.OptimizationVariable'):
    ...
    def add_target_history(self, value: '_1506.OptimizationVariable'):
