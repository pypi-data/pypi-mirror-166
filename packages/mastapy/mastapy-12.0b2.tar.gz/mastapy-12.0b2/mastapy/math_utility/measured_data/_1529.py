...
from mastapy.math_utility.measured_data import _1528
...
class OnedimensionalFunctionLookupTable(_1528.LookupTableBase['OnedimensionalFunctionLookupTable']):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self) -> '_1495.Vector2DListAccessor':
    ...
    @lookup_table.setter
    def lookup_table(self, value: '_1495.Vector2DListAccessor'):
