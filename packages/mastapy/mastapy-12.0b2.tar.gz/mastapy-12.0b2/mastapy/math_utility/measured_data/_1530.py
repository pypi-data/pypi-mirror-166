...
class TwodimensionalFunctionLookupTable(_1528.LookupTableBase['TwodimensionalFunctionLookupTable']):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self) -> '_1527.GriddedSurfaceAccessor':
    ...
    @lookup_table.setter
    def lookup_table(self, value: '_1527.GriddedSurfaceAccessor'):
