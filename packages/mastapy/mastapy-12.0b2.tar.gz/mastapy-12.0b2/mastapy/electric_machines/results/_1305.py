...
from mastapy.utility_gui.charts.colour import _1821
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.electric_machines.results import _1306, _1296
from mastapy._internal.implicit import list_with_selected_item
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.electric_machines import _1274, _1271
...
class ElectricMachineResultsViewable(_168.ElmerResultsViewable):
    ...
    @property
    def field_lines_colour_map(self) -> '_1821.ColourMapOption':
        ...
        return constructor.new_from_mastapy_type(_1821.ColourMapOption)(value) if value is not None else None

    @field_lines_colour_map.setter
    def field_lines_colour_map(self, value: '_1821.ColourMapOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FieldLinesColourMap = value

    @property
    def force_view_options(self) -> '_1306.ElectricMachineForceViewOptions':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1306.ElectricMachineForceViewOptions)(value) if value is not None else None

    @force_view_options.setter
    def force_view_options(self, value: '_1306.ElectricMachineForceViewOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parts_to_view(self) -> 'List[_1802.EnumWithBool[_1271.RegionID]]':
