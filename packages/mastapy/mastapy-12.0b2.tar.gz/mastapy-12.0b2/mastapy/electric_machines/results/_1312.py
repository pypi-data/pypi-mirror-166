...
from mastapy.electric_machines.load_cases_and_analyses import _1327
...
class OnLoadElectricMachineResults(_1296.ElectricMachineResults):
    """OnLoadElectricMachineResults
    ...
    @property
    def power_factor_direction(self) -> '_1327.LeadingOrLagging':
        ...
        return constructor.new_from_mastapy_type(_1327.LeadingOrLagging)(value) if value is not None else None
