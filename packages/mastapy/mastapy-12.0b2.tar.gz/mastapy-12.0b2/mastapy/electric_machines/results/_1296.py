...
from mastapy.electric_machines.results import _1303, _1297, _1299
...
class ElectricMachineResults(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart_at_time_0(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def force_density_in_air_gap_mst_chart_at_time_0(self) -> '_1820.TwoDChartDefinition':
    ...
    @property
    def results_timesteps(self) -> 'List[_1303.ElectricMachineResultsTimeStep]':
    ...
    @property
    def results_for_line_to_line(self) -> 'List[_1297.ElectricMachineResultsForLineToLine]':
    ...
    @property
    def results_for_phases(self) -> 'List[_1299.ElectricMachineResultsForPhase]':
