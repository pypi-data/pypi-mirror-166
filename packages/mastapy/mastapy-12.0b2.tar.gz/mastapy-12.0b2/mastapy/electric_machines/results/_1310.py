...
from mastapy.utility_gui.charts import (
    _1818, _1820, _1810, _1815,
    _1817
)
from mastapy._internal import constructor
from mastapy._internal.cast_exception import CastException
from mastapy.electric_machines.results import _1311, _1295
...
class NonLinearDQModel(_1295.ElectricMachineDQModel):
    """NonLinearDQModel
    ...
    @property
    def alignment_torque_map_at_reference_temperatures(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def d_axis_armature_flux_linkage_map(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def q_axis_armature_flux_linkage_map(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def reluctance_torque_map_at_reference_temperatures(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def rotor_eddy_current_loss_per_frequency_exponent_map(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def rotor_excess_loss_per_frequency_exponent_map(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def rotor_hysteresis_loss_per_frequency_exponent_map(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def stator_eddy_current_loss_per_frequency_exponent_map(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def stator_excess_loss_per_frequency_exponent_map(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def stator_hysteresis_loss_per_frequency_exponent_map(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def torque_map_at_reference_temperatures(self) -> '_1818.ThreeDChartDefinition':
    ...
    @property
    def torque_at_max_current_and_reference_temperatures(self) -> '_1820.TwoDChartDefinition':
