...
class NotchSpecification(_0.APIBase):
    ...
    @property
    def notch_shape(self) -> '_1266.NotchShape':
        ...
        return constructor.new_from_mastapy_type(_1266.NotchShape)(value) if value is not None else None

    @notch_shape.setter
    def notch_shape(self, value: '_1266.NotchShape'):
