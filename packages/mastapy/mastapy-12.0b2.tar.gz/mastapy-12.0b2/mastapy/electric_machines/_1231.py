...
class AbstractStator(_0.APIBase):
    ...
    @property
    def tooth_and_slot(self) -> '_1232.AbstractToothAndSlot':
        ...
        if _1232.AbstractToothAndSlot.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def tooth_and_slot_of_type_cad_tooth_and_slot(self) -> '_1237.CADToothAndSlot':
        ...
        if _1237.CADToothAndSlot.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def tooth_and_slot_of_type_tooth_and_slot(self) -> '_1284.ToothAndSlot':
        ...
        if _1284.ToothAndSlot.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def windings(self) -> '_1291.Windings':
