...
class DynamicForceLoadCase(_1331.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """DynamicForceLoadCase
    ...
    @property
    def number_of_steps_per_operating_point_specification_method(self) -> '_1332.NumberOfStepsPerOperatingPointSpecificationMethod':
        ...
        return constructor.new_from_mastapy_type(_1332.NumberOfStepsPerOperatingPointSpecificationMethod)(value) if value is not None else None

    @number_of_steps_per_operating_point_specification_method.setter
    def number_of_steps_per_operating_point_specification_method(self, value: '_1332.NumberOfStepsPerOperatingPointSpecificationMethod'):
    ...
    @property
    def operating_points_specification_method(self) -> '_1333.OperatingPointsSpecificationMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1333.OperatingPointsSpecificationMethod)(value) if value is not None else None

    @operating_points_specification_method.setter
    def operating_points_specification_method(self, value: '_1333.OperatingPointsSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OperatingPointsSpecificationMethod = value

    @property
    def speed_points_distribution(self) -> '_1337.SpeedPointsDistribution':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1337.SpeedPointsDistribution)(value) if value is not None else None

    @speed_points_distribution.setter
    def speed_points_distribution(self, value: '_1337.SpeedPointsDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpeedPointsDistribution = value

    @property
    def operating_points(self) -> 'List[_1341.SpeedTorqueOperatingPoint]':
    ...
    def add_operating_point_with_torque_and_speed(self, torque: 'float', speed: 'float') -> '_1341.SpeedTorqueOperatingPoint':
        """ 'AddOperatingPoint' is the original name of this method.
    ...
    def analysis_for(self, setup: '_1250.ElectricMachineSetup') -> '_1314.DynamicForceAnalysis':
    ...
    def remove_operating_point(self, operating_point: '_1341.SpeedTorqueOperatingPoint'):
