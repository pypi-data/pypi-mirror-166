...
from mastapy.electric_machines.load_cases_and_analyses import _1342, _1318, _1325
...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    @property
    def temperatures(self) -> '_1342.Temperatures':
    ...
    @property
    def analyses(self) -> 'List[_1318.ElectricMachineAnalysis]':
    ...
    def analysis_for(self, setup: '_1250.ElectricMachineSetup') -> '_1318.ElectricMachineAnalysis':
    ...
    def copy_to(self, another_group: '_1325.ElectricMachineLoadCaseGroup') -> 'ElectricMachineLoadCaseBase':
    ...
    def remove_analysis(self, electric_machine_analysis: '_1318.ElectricMachineAnalysis'):
    ...
    def remove_analysis_for(self, setup: '_1250.ElectricMachineSetup'):
