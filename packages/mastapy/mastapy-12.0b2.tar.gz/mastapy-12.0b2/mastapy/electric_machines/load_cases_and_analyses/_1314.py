...
from mastapy.electric_machines.load_cases_and_analyses import _1315, _1322, _1318
...
class DynamicForceAnalysis(_1318.ElectricMachineAnalysis):
    """DynamicForceAnalysis
    ...
    @property
    def load_case(self) -> '_1315.DynamicForceLoadCase':
    ...
    @property
    def results(self) -> '_1293.DynamicForceResults':
    ...
    @property
    def single_operating_point_analyses(self) -> 'List[_1322.ElectricMachineFEAnalysis]':
