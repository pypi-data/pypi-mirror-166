...
class SpeedTorqueLoadCase(_1323.ElectricMachineLoadCase):
    """SpeedTorqueLoadCase
    ...
    @property
    def control_strategy(self) -> '_1320.ElectricMachineControlStrategy':
        ...
        return constructor.new_from_mastapy_type(_1320.ElectricMachineControlStrategy)(value) if value is not None else None

    @control_strategy.setter
    def control_strategy(self, value: '_1320.ElectricMachineControlStrategy'):
    ...
    @property
    def load_specification(self) -> '_1336.SpecifyTorqueOrCurrent':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1336.SpecifyTorqueOrCurrent)(value) if value is not None else None

    @load_specification.setter
    def load_specification(self, value: '_1336.SpecifyTorqueOrCurrent'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def basic_mechanical_loss_settings(self) -> '_1319.ElectricMachineBasicMechanicalLossSettings':
