...
class ElectricMachineLoadCase(_1324.ElectricMachineLoadCaseBase):
    """ElectricMachineLoadCase
    ...
    @property
    def motoring_or_generating(self) -> '_1330.MotoringOrGenerating':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1330.MotoringOrGenerating)(value) if value is not None else None

    @motoring_or_generating.setter
    def motoring_or_generating(self, value: '_1330.MotoringOrGenerating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def analysis_for(self, setup: '_1250.ElectricMachineSetup') -> '_1322.ElectricMachineFEAnalysis':
