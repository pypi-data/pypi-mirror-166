...
from mastapy.electric_machines.load_cases_and_analyses import _1338, _1331
...
class SpeedTorqueCurveLoadCase(_1331.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """SpeedTorqueCurveLoadCase
    ...
    def analysis_for(self, setup: '_1250.ElectricMachineSetup') -> '_1338.SpeedTorqueCurveAnalysis':
