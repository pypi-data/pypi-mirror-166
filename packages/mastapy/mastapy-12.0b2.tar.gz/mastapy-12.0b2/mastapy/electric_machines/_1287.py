...
from mastapy.electric_machines import _1253, _1273
...
class VShapedMagnetLayerSpecification(_1273.RotorInternalLayerSpecification):
    """VShapedMagnetLayerSpecification
    ...
    @property
    def upper_flux_barrier_web_specification(self) -> '_1253.FluxBarrierOrWeb':
        ...
        return constructor.new_from_mastapy_type(_1253.FluxBarrierOrWeb)(value) if value is not None else None

    @upper_flux_barrier_web_specification.setter
    def upper_flux_barrier_web_specification(self, value: '_1253.FluxBarrierOrWeb'):
