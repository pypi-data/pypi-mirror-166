...
class OilPumpDetail(_1549.IndependentReportablePropertiesBase['OilPumpDetail']):
    """OilPumpDetail
    ...
    @property
    def electric_power_consumed_vs_speed(self) -> '_1495.Vector2DListAccessor':
    ...
    def electric_power_consumed_vs_speed(self, value: '_1495.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ElectricPowerConsumedVsSpeed = value

    @property
    def oil_flow_rate_vs_speed(self) -> '_1495.Vector2DListAccessor':
    ...
    def oil_flow_rate_vs_speed(self, value: '_1495.Vector2DListAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def operating_oil_pressure_vs_speed(self) -> '_1495.Vector2DListAccessor':
    ...
    def operating_oil_pressure_vs_speed(self, value: '_1495.Vector2DListAccessor'):
        value = value.wrapped if value else None
