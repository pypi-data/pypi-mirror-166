...
from mastapy.bearings.bearing_results.rolling.skf_module import _2044
...
class SKFSettings(_1556.PerMachineSettings):
    """SKFSettings
    ...
    @property
    def skf_authentication(self) -> '_2044.SKFAuthentication':
