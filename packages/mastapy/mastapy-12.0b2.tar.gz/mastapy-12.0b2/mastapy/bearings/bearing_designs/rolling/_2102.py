...
from mastapy.bearings.bearing_designs.rolling import _2101, _2107
...
class FourPointContactBallBearing(_2107.MultiPointContactBallBearing):
    """FourPointContactBallBearing
    ...
    @property
    def contact_angle_and_internal_clearance_definition(self) -> '_2101.FourPointContactAngleDefinition':
        ...
        return constructor.new_from_mastapy_type(_2101.FourPointContactAngleDefinition)(value) if value is not None else None

    @contact_angle_and_internal_clearance_definition.setter
    def contact_angle_and_internal_clearance_definition(self, value: '_2101.FourPointContactAngleDefinition'):
