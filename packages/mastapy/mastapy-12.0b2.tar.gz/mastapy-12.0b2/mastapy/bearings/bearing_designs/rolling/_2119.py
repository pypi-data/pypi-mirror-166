...
from mastapy.bearings.bearing_designs.rolling import _2112, _2109
...
class TaperRollerBearing(_2109.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1830.BearingMeasurementType':
        ...
        return constructor.new_from_mastapy_type(_1830.BearingMeasurementType)(value) if value is not None else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1830.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_2112.RollerRibDetail':
