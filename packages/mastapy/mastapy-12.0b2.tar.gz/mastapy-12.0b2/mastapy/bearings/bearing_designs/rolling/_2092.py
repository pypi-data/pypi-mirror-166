...
from mastapy.bearings.bearing_designs.rolling import _2093
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_2093.BearingProtectionLevel':
        ...
        return constructor.new_from_mastapy_type(_2093.BearingProtectionLevel)(value) if value is not None else None
    ...
    @property
    def new_protection_level(self) -> '_2093.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_2093.BearingProtectionLevel'):
