...
from mastapy.bearings.bearing_results.rolling import _1935, _1933
...
class LoadedAngularContactThrustBallBearingRow(_1933.LoadedAngularContactBallBearingRow):
    """LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1935.LoadedAngularContactThrustBallBearingResults':
