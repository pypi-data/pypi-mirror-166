...
from mastapy.bearings.bearing_results.rolling import _1966, _1965, _1952
...
class LoadedFourPointContactBallBearingRow(_1952.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1966.LoadedFourPointContactBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1965.LoadedFourPointContactBallBearingRaceResults]':
