...
from mastapy.bearings.bearing_results.rolling import _1985, _1952
...
class LoadedSelfAligningBallBearingRow(_1952.LoadedBallBearingRow):
    """LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1985.LoadedSelfAligningBallBearingResults':
