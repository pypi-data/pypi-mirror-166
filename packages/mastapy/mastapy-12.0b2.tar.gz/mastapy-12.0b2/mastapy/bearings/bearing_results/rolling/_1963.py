...
from mastapy.bearings.bearing_results.rolling import _1926, _2023, _2022
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1926.InternalClearance':
    ...
    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_2022.StressAtPosition]':
    ...
    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_2022.StressAtPosition]':
