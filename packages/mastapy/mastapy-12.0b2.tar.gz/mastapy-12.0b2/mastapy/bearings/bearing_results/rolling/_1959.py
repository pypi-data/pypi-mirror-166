...
from mastapy.bearings.bearing_results.rolling import _1958, _1970, _1974
...
class LoadedCylindricalRollerBearingRow(_1974.LoadedNonBarrelRollerBearingRow):
    """LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1958.LoadedCylindricalRollerBearingResults':
