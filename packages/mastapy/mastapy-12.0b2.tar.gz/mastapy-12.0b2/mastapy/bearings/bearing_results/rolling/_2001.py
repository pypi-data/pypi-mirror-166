...
from mastapy.bearings.bearing_results.rolling import _2000, _1952
...
class LoadedThreePointContactBallBearingRow(_1952.LoadedBallBearingRow):
    """LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_2000.LoadedThreePointContactBallBearingResults':
