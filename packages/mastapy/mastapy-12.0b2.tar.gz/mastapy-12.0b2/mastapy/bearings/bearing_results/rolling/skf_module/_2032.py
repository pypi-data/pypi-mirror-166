...
from mastapy.bearings.bearing_results.rolling.skf_module import _2034, _2033, _2045
...
class Friction(_2045.SKFCalculationResult):
    """Friction
    ...
    @property
    def friction_sources(self) -> '_2034.FrictionSources':
    ...
    @property
    def frictional_moment(self) -> '_2033.FrictionalMoment':
