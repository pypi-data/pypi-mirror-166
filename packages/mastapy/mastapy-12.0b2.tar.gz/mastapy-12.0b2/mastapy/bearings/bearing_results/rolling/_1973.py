...
from mastapy.bearings.bearing_results.rolling import _2021, _1978
...
class LoadedNonBarrelRollerBearingResults(_1978.LoadedRollerBearingResults):
    """LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_2021.SMTRibStressResults':
