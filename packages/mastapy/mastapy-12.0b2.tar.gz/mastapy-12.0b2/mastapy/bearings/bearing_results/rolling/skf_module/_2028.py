...
from mastapy.bearings.bearing_results.rolling.skf_module import _2039, _2045
...
class BearingRatingLife(_2045.SKFCalculationResult):
    """BearingRatingLife
    ...
    @property
    def life_model(self) -> '_2039.LifeModel':
