...
from mastapy.bearings.bearing_results.rolling import _1989, _1979
...
class LoadedSphericalRollerRadialBearingRow(_1979.LoadedRollerBearingRow):
    """LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1989.LoadedSphericalRollerRadialBearingResults':
