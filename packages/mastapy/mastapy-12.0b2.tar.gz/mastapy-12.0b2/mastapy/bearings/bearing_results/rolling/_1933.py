...
from mastapy.bearings.bearing_results.rolling import _1932, _1935, _1952
...
class LoadedAngularContactBallBearingRow(_1952.LoadedBallBearingRow):
    """LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1932.LoadedAngularContactBallBearingResults':
