...
from mastapy.bearings.bearing_results.rolling import _1946, _1944
...
class LoadedAxialThrustNeedleRollerBearingRow(_1944.LoadedAxialThrustCylindricalRollerBearingRow):
    """LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1946.LoadedAxialThrustNeedleRollerBearingResults':
