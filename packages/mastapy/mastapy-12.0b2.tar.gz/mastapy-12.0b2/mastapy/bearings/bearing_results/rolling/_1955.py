...
from mastapy.bearings.bearing_results.rolling import _1954, _1979
...
class LoadedCrossedRollerBearingRow(_1979.LoadedRollerBearingRow):
    """LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1954.LoadedCrossedRollerBearingResults':
