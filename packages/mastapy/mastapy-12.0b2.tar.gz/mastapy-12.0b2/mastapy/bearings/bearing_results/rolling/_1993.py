...
from mastapy.bearings.bearing_results.rolling import _1992, _1979
...
class LoadedSphericalRollerThrustBearingRow(_1979.LoadedRollerBearingRow):
    """LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1992.LoadedSphericalRollerThrustBearingResults':
