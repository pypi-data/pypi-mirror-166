...
from mastapy.bearings.bearing_results.rolling.skf_module import _2041, _2045
...
class Viscosities(_2045.SKFCalculationResult):
    """Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_2041.OperatingViscosity':
