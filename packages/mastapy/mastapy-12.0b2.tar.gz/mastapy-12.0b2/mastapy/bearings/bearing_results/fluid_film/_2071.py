...
from mastapy.bearings import _1832
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1832.BearingRow':
        ...
        return constructor.new_from_mastapy_type(_1832.BearingRow)(value) if value is not None else None
