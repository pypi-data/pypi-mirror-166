...
from mastapy.bearings.roller_bearing_profiles import (
    _1890, _1884, _1885, _1886,
    _1887, _1888, _1889, _1891
)
...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self) -> '_1845.RollerBearingProfileTypes':
        ...
        return constructor.new_from_mastapy_type(_1845.RollerBearingProfileTypes)(value) if value is not None else None

    @active_profile_type.setter
    def active_profile_type(self, value: '_1845.RollerBearingProfileTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ActiveProfileType = value

    @property
    def active_profile(self) -> '_1890.RollerBearingProfile':
        ...
        if _1890.RollerBearingProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_conical_profile(self) -> '_1884.RollerBearingConicalProfile':
        ...
        if _1884.RollerBearingConicalProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_crowned_profile(self) -> '_1885.RollerBearingCrownedProfile':
        ...
        if _1885.RollerBearingCrownedProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_din_lundberg_profile(self) -> '_1886.RollerBearingDinLundbergProfile':
        ...
        if _1886.RollerBearingDinLundbergProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_flat_profile(self) -> '_1887.RollerBearingFlatProfile':
        ...
        if _1887.RollerBearingFlatProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_johns_gohar_profile(self) -> '_1888.RollerBearingJohnsGoharProfile':
        ...
        if _1888.RollerBearingJohnsGoharProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_lundberg_profile(self) -> '_1889.RollerBearingLundbergProfile':
        ...
        if _1889.RollerBearingLundbergProfile.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def active_profile_of_type_roller_bearing_user_specified_profile(self) -> '_1891.RollerBearingUserSpecifiedProfile':
        ...
        if _1891.RollerBearingUserSpecifiedProfile.TYPE not in temp.__class__.__mro__:
