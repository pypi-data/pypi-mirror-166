...
from mastapy.math_utility import _1460, _1461
from mastapy.system_model.connections_and_sockets import (
    _2215, _2217, _2241, _2236
)
from mastapy.system_model.part_model import _2390, _2413
...
class Component(_2413.Part):
    ...
    @property
    def local_coordinate_system(self) -> '_1460.CoordinateSystem3D':
    ...
    @property
    def component_connections(self) -> 'List[_2215.ComponentConnection]':
    ...
    def can_delete_connection(self, connection: '_2217.Connection') -> 'bool':
    ...
    def connect_to_socket(self, socket: '_2241.Socket') -> '_2390.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2390.ComponentsConnectedResult':
        """ 'ConnectTo' is the original name of this method.
    ...
    def create_coordinate_system_editor(self) -> '_1461.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_2217.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_2217.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2241.Socket') -> 'List[_2241.Socket]':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2241.Socket]':
        """ 'PossibleSocketsToConnectWith' is the original name of this method.
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2236.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1460.CoordinateSystem3D') -> '_2236.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2236.RealignmentResult':
    ...
    def socket_named(self, socket_name: 'str') -> '_2241.Socket':
    ...
    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2390.ComponentsConnectedResult':
