...
from mastapy.system_model.part_model.part_groups import _2431, _2432, _2435
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2431.ConcentricOrParallelPartGroup':
        ...
        if _2431.ConcentricOrParallelPartGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2432.ConcentricPartGroup':
        ...
        if _2432.ConcentricPartGroup.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2435.ParallelPartGroup':
        ...
        if _2435.ParallelPartGroup.TYPE not in temp.__class__.__mro__:
