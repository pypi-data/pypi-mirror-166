...
from mastapy.system_model.part_model.part_groups import _2432, _2434, _2431
...
class ParallelPartGroup(_2431.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2432.ConcentricPartGroup]':
    ...
    @property
    def design_measurements(self) -> 'List[_2434.DesignMeasurements]':
