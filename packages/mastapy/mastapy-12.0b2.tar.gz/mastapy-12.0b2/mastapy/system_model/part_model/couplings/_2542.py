...
from mastapy.detailed_rigid_connectors.splines import (
    _1373, _1358, _1378, _1353,
    _1356, _1360, _1363, _1364,
    _1371, _1383
)
from mastapy.system_model.part_model.couplings import (
    _2535, _2536, _2538, _2539,
    _2543, _2537
)
from mastapy.detailed_rigid_connectors.interference_fits import _1408
from mastapy.detailed_rigid_connectors.keyed_joints import _1400
...
class ShaftHubConnection(_2392.Connector):
    """ShaftHubConnection
    ...
    @property
    def spline_type(self) -> '_1373.SplineDesignTypes':
        ...
        return constructor.new_from_mastapy_type(_1373.SplineDesignTypes)(value) if value is not None else None

    @spline_type.setter
    def spline_type(self, value: '_1373.SplineDesignTypes'):
    ...
    @property
    def tilt_stiffness_type(self) -> '_2536.RigidConnectorTiltStiffnessTypes':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_2536.RigidConnectorTiltStiffnessTypes)(value) if value is not None else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2536.RigidConnectorTiltStiffnessTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def interference_fit_design(self) -> '_1408.InterferenceFitDesign':
        ...
        if _1408.InterferenceFitDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def left_flank_lead_relief(self) -> '_2543.SplineLeadRelief':
    ...
    @property
    def right_flank_lead_relief(self) -> '_2543.SplineLeadRelief':
    ...
    @property
    def spline_joint_design(self) -> '_1378.SplineJointDesign':
        ...
        if _1378.SplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_1353.CustomSplineJointDesign':
        ...
        if _1353.CustomSplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_1356.DIN5480SplineJointDesign':
        ...
        if _1356.DIN5480SplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1360.GBT3478SplineJointDesign':
        ...
        if _1360.GBT3478SplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_1363.ISO4156SplineJointDesign':
        ...
        if _1363.ISO4156SplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1364.JISB1603SplineJointDesign':
        ...
        if _1364.JISB1603SplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_1371.SAESplineJointDesign':
        ...
        if _1371.SAESplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1383.StandardSplineJointDesign':
        ...
        if _1383.StandardSplineJointDesign.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def lead_reliefs(self) -> 'List[_2543.SplineLeadRelief]':
    ...
    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2537.RigidConnectorToothLocation]':
