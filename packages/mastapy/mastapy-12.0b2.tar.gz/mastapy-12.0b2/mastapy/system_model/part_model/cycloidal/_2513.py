...
from mastapy.cycloidal import _1417, _1418, _1424
...
from mastapy.system_model.part_model import _2406, _2381
from mastapy.system_model.connections_and_sockets.cycloidal import _2284
...
class CycloidalDisc(_2381.AbstractShaft):
    """CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self) -> '_1417.CycloidalDiscDesign':
    ...
    @property
    def load_sharing_settings(self) -> '_2406.LoadSharingSettings':
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2284.CycloidalDiscPlanetaryBearingSocket]':
