...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2507
from mastapy.system_model.part_model.gears import _2469, _2476
...
class CylindricalGearSet(_2476.GearSet):
    """CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2507.SuperchargerRotorSet':
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2469.CylindricalGear]':
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_2254.CylindricalGearMesh]':
