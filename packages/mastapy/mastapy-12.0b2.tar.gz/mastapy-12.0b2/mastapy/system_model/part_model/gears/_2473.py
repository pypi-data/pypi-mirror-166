...
from mastapy.system_model.part_model.gears import _2472, _2476
...
class FaceGearSet(_2476.GearSet):
    """FaceGearSet
    ...
    @property
    def face_gears(self) -> 'List[_2472.FaceGear]':
    ...
    @property
    def face_meshes(self) -> 'List[_2256.FaceGearMesh]':
