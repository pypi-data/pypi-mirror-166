...
from mastapy.system_model.part_model.gears import _2475, _2474
...
class ConceptGear(_2474.Gear):
    ...
    @property
    def orientation(self) -> '_2475.GearOrientations':
        ...
        return constructor.new_from_mastapy_type(_2475.GearOrientations)(value) if value is not None else None

    @orientation.setter
    def orientation(self, value: '_2475.GearOrientations'):
