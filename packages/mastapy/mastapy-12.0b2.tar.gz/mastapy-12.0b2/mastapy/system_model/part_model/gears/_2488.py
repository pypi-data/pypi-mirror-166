...
from mastapy.system_model.part_model.gears import _2487, _2464
...
class SpiralBevelGearSet(_2464.BevelGearSet):
    """SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_2487.SpiralBevelGear]':
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_2268.SpiralBevelGearMesh]':
