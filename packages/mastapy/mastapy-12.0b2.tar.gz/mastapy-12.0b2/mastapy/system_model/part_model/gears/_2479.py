...
from mastapy.system_model.part_model.gears import _2478, _2458
...
class HypoidGearSet(_2458.AGMAGleasonConicalGearSet):
    """HypoidGearSet
    ...
    @property
    def hypoid_gears(self) -> 'List[_2478.HypoidGear]':
    ...
    @property
    def hypoid_meshes(self) -> 'List[_2260.HypoidGearMesh]':
