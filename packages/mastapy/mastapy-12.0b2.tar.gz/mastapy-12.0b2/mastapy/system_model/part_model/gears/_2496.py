...
from mastapy.system_model.part_model.gears import _2495, _2476
...
class WormGearSet(_2476.GearSet):
    """WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2495.WormGear]':
    ...
    @property
    def worm_meshes(self) -> 'List[_2274.WormGearMesh]':
