...
from mastapy.system_model.part_model.gears import _2463, _2464
...
class BevelDifferentialGearSet(_2464.BevelGearSet):
    """BevelDifferentialGearSet
    ...
    @property
    def bevel_gears(self) -> 'List[_2463.BevelGear]':
    ...
    @property
    def bevel_meshes(self) -> 'List[_2248.BevelGearMesh]':
