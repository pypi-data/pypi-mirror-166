...
from mastapy.system_model.part_model.gears import _2489, _2464
...
class StraightBevelDiffGearSet(_2464.BevelGearSet):
    """StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self) -> 'List[_2489.StraightBevelDiffGear]':
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_2270.StraightBevelDiffGearMesh]':
