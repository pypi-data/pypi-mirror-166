...
from mastapy.system_model.part_model.gears import _2470, _2486, _2469
...
class CylindricalGearMesh(_2258.GearMesh):
    """CylindricalGearMesh
    ...
    @property
    def centre_distance_range(self) -> '_1526.ShortLengthRange':
    ...
    @property
    def cylindrical_gear_set(self) -> '_2470.CylindricalGearSet':
