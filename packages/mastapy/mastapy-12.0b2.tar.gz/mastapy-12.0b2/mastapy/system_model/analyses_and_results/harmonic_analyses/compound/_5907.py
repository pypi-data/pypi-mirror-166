...
class StraightBevelDiffGearMeshCompoundHarmonicAnalysis(_5818.BevelGearMeshCompoundHarmonicAnalysis):
    """StraightBevelDiffGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5742.StraightBevelDiffGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5742.StraightBevelDiffGearMeshHarmonicAnalysis]':
