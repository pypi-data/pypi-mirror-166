...
class TorqueConverterConnectionCompoundHarmonicAnalysis(_5839.CouplingConnectionCompoundHarmonicAnalysis):
    """TorqueConverterConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5753.TorqueConverterConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5753.TorqueConverterConnectionHarmonicAnalysis]':
