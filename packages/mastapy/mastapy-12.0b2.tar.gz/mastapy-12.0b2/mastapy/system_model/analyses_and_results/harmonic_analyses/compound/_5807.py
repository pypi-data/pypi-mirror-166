...
class AGMAGleasonConicalGearSetCompoundHarmonicAnalysis(_5835.ConicalGearSetCompoundHarmonicAnalysis):
    """AGMAGleasonConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5614.AGMAGleasonConicalGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5614.AGMAGleasonConicalGearSetHarmonicAnalysis]':
