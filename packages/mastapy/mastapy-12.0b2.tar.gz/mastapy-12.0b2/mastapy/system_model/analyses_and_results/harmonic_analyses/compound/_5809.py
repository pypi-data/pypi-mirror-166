...
class BearingCompoundHarmonicAnalysis(_5837.ConnectorCompoundHarmonicAnalysis):
    """BearingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5616.BearingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5616.BearingHarmonicAnalysis]':
