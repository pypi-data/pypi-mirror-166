...
class RootAssemblyHarmonicAnalysis(_5615.AssemblyHarmonicAnalysis):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self) -> '_5692.HarmonicAnalysisRootAssemblyExportOptions':
    ...
    @property
    def harmonic_analysis_inputs(self) -> '_2576.HarmonicAnalysis':
