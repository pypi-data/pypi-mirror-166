...
class CouplingHalfCompoundHarmonicAnalysis(_5878.MountableComponentCompoundHarmonicAnalysis):
    """CouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5647.CouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5647.CouplingHalfHarmonicAnalysis]':
