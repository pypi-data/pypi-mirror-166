...
class CycloidalDiscCompoundHarmonicAnalysis(_5802.AbstractShaftCompoundHarmonicAnalysis):
    """CycloidalDiscCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5654.CycloidalDiscHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5654.CycloidalDiscHarmonicAnalysis]':
