...
class StraightBevelDiffGearCompoundHarmonicAnalysis(_5817.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelDiffGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5741.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5741.StraightBevelDiffGearHarmonicAnalysis]':
