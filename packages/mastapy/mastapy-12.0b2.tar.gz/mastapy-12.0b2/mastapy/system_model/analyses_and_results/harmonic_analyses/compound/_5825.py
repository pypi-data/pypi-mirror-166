...
class CoaxialConnectionCompoundHarmonicAnalysis(_5898.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """CoaxialConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5632.CoaxialConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5632.CoaxialConnectionHarmonicAnalysis]':
