...
class ConceptGearCompoundHarmonicAnalysis(_5859.GearCompoundHarmonicAnalysis):
    """ConceptGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5638.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5638.ConceptGearHarmonicAnalysis]':
