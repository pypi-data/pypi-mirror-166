...
class OilSealCompoundHarmonicAnalysis(_5837.ConnectorCompoundHarmonicAnalysis):
    """OilSealCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5710.OilSealHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5710.OilSealHarmonicAnalysis]':
