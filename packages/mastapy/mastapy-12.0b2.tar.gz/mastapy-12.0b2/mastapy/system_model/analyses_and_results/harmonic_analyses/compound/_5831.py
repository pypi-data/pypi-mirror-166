...
class ConceptGearMeshCompoundHarmonicAnalysis(_5860.GearMeshCompoundHarmonicAnalysis):
    """ConceptGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5639.ConceptGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5639.ConceptGearMeshHarmonicAnalysis]':
