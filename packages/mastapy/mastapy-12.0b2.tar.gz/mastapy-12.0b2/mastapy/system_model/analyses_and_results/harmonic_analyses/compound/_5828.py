...
class ConceptCouplingConnectionCompoundHarmonicAnalysis(_5839.CouplingConnectionCompoundHarmonicAnalysis):
    """ConceptCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5635.ConceptCouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5635.ConceptCouplingConnectionHarmonicAnalysis]':
