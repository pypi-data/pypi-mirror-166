...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5900, _5901, _5819
...
class SpiralBevelGearSetCompoundHarmonicAnalysis(_5819.BevelGearSetCompoundHarmonicAnalysis):
    """SpiralBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5737.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5900.SpiralBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5901.SpiralBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5737.SpiralBevelGearSetHarmonicAnalysis]':
