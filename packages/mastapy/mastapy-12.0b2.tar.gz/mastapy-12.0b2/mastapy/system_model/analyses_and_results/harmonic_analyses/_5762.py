...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5760, _5761, _5685
...
class WormGearSetHarmonicAnalysis(_5685.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5760.WormGearHarmonicAnalysis]':
    ...
    @property
    def worm_gears_harmonic_analysis(self) -> 'List[_5760.WormGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5761.WormGearMeshHarmonicAnalysis]':
    ...
    @property
    def worm_meshes_harmonic_analysis(self) -> 'List[_5761.WormGearMeshHarmonicAnalysis]':
