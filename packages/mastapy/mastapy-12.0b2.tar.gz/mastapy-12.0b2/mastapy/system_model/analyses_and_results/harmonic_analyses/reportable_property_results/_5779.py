...
class FEPartHarmonicAnalysisResultsPropertyAccessor(_5787.HarmonicAnalysisResultsPropertyAccessor):
    """FEPartHarmonicAnalysisResultsPropertyAccessor
    ...
    @property
    def combined_orders(self) -> '_5789.ResultsForMultipleOrdersForFESurface':
    ...
    @property
    def excitations(self) -> 'List[_5780.FEPartSingleWhineAnalysisResultsPropertyAccessor]':
    ...
    @property
    def orders_for_combined_excitations(self) -> 'List[_5794.ResultsForOrderIncludingSurfaces]':
    ...
    @property
    def orders_for_combined_excitations_from_same_parts(self) -> 'List[_5794.ResultsForOrderIncludingSurfaces]':
