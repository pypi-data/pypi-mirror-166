...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5909, _5910, _5819
...
class StraightBevelGearSetCompoundHarmonicAnalysis(_5819.BevelGearSetCompoundHarmonicAnalysis):
    """StraightBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5746.StraightBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5909.StraightBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5910.StraightBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5746.StraightBevelGearSetHarmonicAnalysis]':
