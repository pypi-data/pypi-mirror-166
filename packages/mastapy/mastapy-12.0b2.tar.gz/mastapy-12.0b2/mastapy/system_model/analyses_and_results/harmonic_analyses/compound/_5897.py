...
class ShaftHubConnectionCompoundHarmonicAnalysis(_5837.ConnectorCompoundHarmonicAnalysis):
    """ShaftHubConnectionCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5730.ShaftHubConnectionHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5730.ShaftHubConnectionHarmonicAnalysis]':
