...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5741, _5742, _5626
...
class StraightBevelDiffGearSetHarmonicAnalysis(_5626.BevelGearSetHarmonicAnalysis):
    """StraightBevelDiffGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2753.StraightBevelDiffGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5741.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_harmonic_analysis(self) -> 'List[_5741.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5742.StraightBevelDiffGearMeshHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_harmonic_analysis(self) -> 'List[_5742.StraightBevelDiffGearMeshHarmonicAnalysis]':
