...
class RollingRingCompoundHarmonicAnalysis(_5840.CouplingHalfCompoundHarmonicAnalysis):
    """RollingRingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5727.RollingRingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5727.RollingRingHarmonicAnalysis]':
