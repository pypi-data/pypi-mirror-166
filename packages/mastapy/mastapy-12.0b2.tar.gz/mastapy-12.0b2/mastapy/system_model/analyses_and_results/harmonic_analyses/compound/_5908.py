...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5906, _5907, _5819
...
class StraightBevelDiffGearSetCompoundHarmonicAnalysis(_5819.BevelGearSetCompoundHarmonicAnalysis):
    """StraightBevelDiffGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5743.StraightBevelDiffGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_harmonic_analysis(self) -> 'List[_5906.StraightBevelDiffGearCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_harmonic_analysis(self) -> 'List[_5907.StraightBevelDiffGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5743.StraightBevelDiffGearSetHarmonicAnalysis]':
