...
class StraightBevelGearMeshCompoundHarmonicAnalysis(_5818.BevelGearMeshCompoundHarmonicAnalysis):
    """StraightBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5745.StraightBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5745.StraightBevelGearMeshHarmonicAnalysis]':
