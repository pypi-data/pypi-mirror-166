...
class ZerolBevelGearMeshCompoundHarmonicAnalysis(_5818.BevelGearMeshCompoundHarmonicAnalysis):
    """ZerolBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5764.ZerolBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5764.ZerolBevelGearMeshHarmonicAnalysis]':
