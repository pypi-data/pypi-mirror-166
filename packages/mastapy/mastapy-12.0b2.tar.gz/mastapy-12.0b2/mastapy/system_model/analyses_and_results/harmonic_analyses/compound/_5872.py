...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5870, _5871, _5869
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis(_5869.KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5703.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_harmonic_analysis(self) -> 'List[_5870.KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_harmonic_analysis(self) -> 'List[_5871.KlingelnbergCycloPalloidHypoidGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5703.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
