...
class CouplingConnectionCompoundHarmonicAnalysis(_5866.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """CouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5646.CouplingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5646.CouplingConnectionHarmonicAnalysis]':
