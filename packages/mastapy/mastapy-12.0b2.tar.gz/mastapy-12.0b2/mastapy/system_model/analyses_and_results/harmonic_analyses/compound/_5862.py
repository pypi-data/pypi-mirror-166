...
class GuideDxfModelCompoundHarmonicAnalysis(_5826.ComponentCompoundHarmonicAnalysis):
    """GuideDxfModelCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5687.GuideDxfModelHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5687.GuideDxfModelHarmonicAnalysis]':
