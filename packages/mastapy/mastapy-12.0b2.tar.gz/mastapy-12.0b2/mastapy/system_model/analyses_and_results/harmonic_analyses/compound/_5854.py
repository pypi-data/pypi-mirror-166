...
class FaceGearCompoundHarmonicAnalysis(_5859.GearCompoundHarmonicAnalysis):
    """FaceGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5674.FaceGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5674.FaceGearHarmonicAnalysis]':
