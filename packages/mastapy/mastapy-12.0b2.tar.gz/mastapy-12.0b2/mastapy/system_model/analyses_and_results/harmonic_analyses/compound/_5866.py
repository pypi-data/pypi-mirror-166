...
class InterMountableComponentConnectionCompoundHarmonicAnalysis(_5836.ConnectionCompoundHarmonicAnalysis):
    """InterMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5697.InterMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5697.InterMountableComponentConnectionHarmonicAnalysis]':
