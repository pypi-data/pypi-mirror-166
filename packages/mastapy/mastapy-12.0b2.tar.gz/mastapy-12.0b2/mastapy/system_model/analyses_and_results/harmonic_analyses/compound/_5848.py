...
class CylindricalGearCompoundHarmonicAnalysis(_5859.GearCompoundHarmonicAnalysis):
    """CylindricalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5656.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5656.CylindricalGearHarmonicAnalysis]':
