...
class CVTCompoundHarmonicAnalysis(_5811.BeltDriveCompoundHarmonicAnalysis):
    """CVTCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5650.CVTHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5650.CVTHarmonicAnalysis]':
