...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5924, _5925, _5861
...
class WormGearSetCompoundHarmonicAnalysis(_5861.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5762.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def worm_gears_compound_harmonic_analysis(self) -> 'List[_5924.WormGearCompoundHarmonicAnalysis]':
    ...
    @property
    def worm_meshes_compound_harmonic_analysis(self) -> 'List[_5925.WormGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5762.WormGearSetHarmonicAnalysis]':
