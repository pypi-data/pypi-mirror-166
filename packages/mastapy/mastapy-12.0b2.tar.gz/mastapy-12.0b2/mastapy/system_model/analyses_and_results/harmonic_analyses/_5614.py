...
class AGMAGleasonConicalGearSetHarmonicAnalysis(_5643.ConicalGearSetHarmonicAnalysis):
    """AGMAGleasonConicalGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2634.AGMAGleasonConicalGearSetSystemDeflection':
