...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5694, _5695, _5614
...
class HypoidGearSetHarmonicAnalysis(_5614.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5694.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def hypoid_gears_harmonic_analysis(self) -> 'List[_5694.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5695.HypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def hypoid_meshes_harmonic_analysis(self) -> 'List[_5695.HypoidGearMeshHarmonicAnalysis]':
