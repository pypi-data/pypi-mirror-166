...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5848, _5849, _5861
...
class CylindricalGearSetCompoundHarmonicAnalysis(_5861.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5658.CylindricalGearSetHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_harmonic_analysis(self) -> 'List[_5848.CylindricalGearCompoundHarmonicAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_harmonic_analysis(self) -> 'List[_5849.CylindricalGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5658.CylindricalGearSetHarmonicAnalysis]':
