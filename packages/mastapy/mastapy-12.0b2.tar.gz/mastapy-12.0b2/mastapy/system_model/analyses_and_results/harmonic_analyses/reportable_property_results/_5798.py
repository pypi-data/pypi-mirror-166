...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5790, _5799, _5792
...
class RootAssemblyHarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def combined_orders(self) -> '_5790.ResultsForMultipleOrdersForGroups':
    ...
    @property
    def excitations(self) -> 'List[_5799.RootAssemblySingleWhineAnalysisResultsPropertyAccessor]':
    ...
    @property
    def orders_for_combined_excitations(self) -> 'List[_5792.ResultsForOrderIncludingGroups]':
    ...
    @property
    def orders_for_combined_excitations_from_same_parts(self) -> 'List[_5792.ResultsForOrderIncludingGroups]':
