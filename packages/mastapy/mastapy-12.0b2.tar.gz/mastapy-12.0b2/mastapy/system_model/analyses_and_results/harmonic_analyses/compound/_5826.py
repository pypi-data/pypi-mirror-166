...
class ComponentCompoundHarmonicAnalysis(_5880.PartCompoundHarmonicAnalysis):
    """ComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5634.ComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5634.ComponentHarmonicAnalysis]':
