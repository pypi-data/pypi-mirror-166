...
class UnbalancedMassCompoundHarmonicAnalysis(_5923.VirtualComponentCompoundHarmonicAnalysis):
    """UnbalancedMassCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5758.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5758.UnbalancedMassHarmonicAnalysis]':
