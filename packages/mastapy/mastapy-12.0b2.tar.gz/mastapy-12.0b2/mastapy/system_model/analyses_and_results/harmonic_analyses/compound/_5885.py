...
class PlanetaryGearSetCompoundHarmonicAnalysis(_5850.CylindricalGearSetCompoundHarmonicAnalysis):
    """PlanetaryGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5717.PlanetaryGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5717.PlanetaryGearSetHarmonicAnalysis]':
