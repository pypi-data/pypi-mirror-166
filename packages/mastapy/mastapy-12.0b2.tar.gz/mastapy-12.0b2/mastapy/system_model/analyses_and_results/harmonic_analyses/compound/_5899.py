...
class SpecialisedAssemblyCompoundHarmonicAnalysis(_5801.AbstractAssemblyCompoundHarmonicAnalysis):
    """SpecialisedAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5733.SpecialisedAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5733.SpecialisedAssemblyHarmonicAnalysis]':
