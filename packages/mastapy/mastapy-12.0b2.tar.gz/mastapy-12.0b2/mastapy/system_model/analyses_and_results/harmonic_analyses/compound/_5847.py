...
class CycloidalDiscPlanetaryBearingConnectionCompoundHarmonicAnalysis(_5804.AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5655.CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5655.CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis]':
