...
class GearMeshHarmonicAnalysis(_5697.InterMountableComponentConnectionHarmonicAnalysis):
    """GearMeshHarmonicAnalysis
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_4089.ToothPassingHarmonic]':
    ...
    @property
    def system_deflection_results(self) -> '_2698.GearMeshSystemDeflection':
