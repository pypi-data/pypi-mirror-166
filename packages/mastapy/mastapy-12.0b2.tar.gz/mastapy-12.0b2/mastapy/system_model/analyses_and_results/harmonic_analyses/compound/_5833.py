...
class ConicalGearCompoundHarmonicAnalysis(_5859.GearCompoundHarmonicAnalysis):
    """ConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5641.ConicalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5641.ConicalGearHarmonicAnalysis]':
