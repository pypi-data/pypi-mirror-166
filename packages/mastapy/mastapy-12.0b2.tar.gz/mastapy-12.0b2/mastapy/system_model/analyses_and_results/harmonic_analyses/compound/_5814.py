...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5812, _5813, _5819
...
class BevelDifferentialGearSetCompoundHarmonicAnalysis(_5819.BevelGearSetCompoundHarmonicAnalysis):
    """BevelDifferentialGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5621.BevelDifferentialGearSetHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_harmonic_analysis(self) -> 'List[_5812.BevelDifferentialGearCompoundHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_harmonic_analysis(self) -> 'List[_5813.BevelDifferentialGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5621.BevelDifferentialGearSetHarmonicAnalysis]':
