...
class ShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5804.AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    """ShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5731.ShaftToMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5731.ShaftToMountableComponentConnectionHarmonicAnalysis]':
