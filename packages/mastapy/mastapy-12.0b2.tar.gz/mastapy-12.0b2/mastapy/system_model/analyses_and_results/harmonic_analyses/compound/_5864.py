...
class HypoidGearMeshCompoundHarmonicAnalysis(_5806.AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis):
    """HypoidGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5695.HypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5695.HypoidGearMeshHarmonicAnalysis]':
