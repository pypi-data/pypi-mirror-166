...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6702, _6703, _6612
...
class StraightBevelGearSetCompoundCriticalSpeedAnalysis(_6612.BevelGearSetCompoundCriticalSpeedAnalysis):
    """StraightBevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6575.StraightBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_critical_speed_analysis(self) -> 'List[_6702.StraightBevelGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_critical_speed_analysis(self) -> 'List[_6703.StraightBevelGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6575.StraightBevelGearSetCriticalSpeedAnalysis]':
