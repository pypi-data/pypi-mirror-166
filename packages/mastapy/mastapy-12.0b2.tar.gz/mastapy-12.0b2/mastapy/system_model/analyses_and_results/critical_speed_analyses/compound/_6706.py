...
class StraightBevelSunGearCompoundCriticalSpeedAnalysis(_6699.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    """StraightBevelSunGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6577.StraightBevelSunGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6577.StraightBevelSunGearCriticalSpeedAnalysis]':
