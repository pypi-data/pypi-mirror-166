...
class ClutchCompoundCriticalSpeedAnalysis(_6631.CouplingCompoundCriticalSpeedAnalysis):
    """ClutchCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6485.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6485.ClutchCriticalSpeedAnalysis]':
