...
class StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis(_6611.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6571.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6571.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
