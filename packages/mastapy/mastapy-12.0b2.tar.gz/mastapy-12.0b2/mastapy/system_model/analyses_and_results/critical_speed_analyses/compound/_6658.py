...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6656, _6657, _6600
...
class HypoidGearSetCompoundCriticalSpeedAnalysis(_6600.AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis):
    """HypoidGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6529.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gears_compound_critical_speed_analysis(self) -> 'List[_6656.HypoidGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_critical_speed_analysis(self) -> 'List[_6657.HypoidGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6529.HypoidGearSetCriticalSpeedAnalysis]':
