...
class StraightBevelPlanetGearCompoundCriticalSpeedAnalysis(_6699.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    """StraightBevelPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6576.StraightBevelPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6576.StraightBevelPlanetGearCriticalSpeedAnalysis]':
