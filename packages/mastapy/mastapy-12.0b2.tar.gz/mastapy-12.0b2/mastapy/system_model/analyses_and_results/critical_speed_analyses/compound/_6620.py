...
class ConceptCouplingCompoundCriticalSpeedAnalysis(_6631.CouplingCompoundCriticalSpeedAnalysis):
    """ConceptCouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6490.ConceptCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6490.ConceptCouplingCriticalSpeedAnalysis]':
