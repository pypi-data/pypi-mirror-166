...
class BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis(_6611.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6475.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6475.BevelDifferentialGearMeshCriticalSpeedAnalysis]':
