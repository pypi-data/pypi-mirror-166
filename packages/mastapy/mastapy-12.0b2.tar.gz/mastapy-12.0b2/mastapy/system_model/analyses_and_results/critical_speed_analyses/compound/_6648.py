...
class FaceGearMeshCompoundCriticalSpeedAnalysis(_6653.GearMeshCompoundCriticalSpeedAnalysis):
    """FaceGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6519.FaceGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6519.FaceGearMeshCriticalSpeedAnalysis]':
