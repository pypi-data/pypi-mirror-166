...
class SpiralBevelGearMeshCompoundCriticalSpeedAnalysis(_6611.BevelGearMeshCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6565.SpiralBevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6565.SpiralBevelGearMeshCriticalSpeedAnalysis]':
