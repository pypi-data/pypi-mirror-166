...
class CycloidalDiscCompoundCriticalSpeedAnalysis(_6595.AbstractShaftCompoundCriticalSpeedAnalysis):
    """CycloidalDiscCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6510.CycloidalDiscCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6510.CycloidalDiscCriticalSpeedAnalysis]':
