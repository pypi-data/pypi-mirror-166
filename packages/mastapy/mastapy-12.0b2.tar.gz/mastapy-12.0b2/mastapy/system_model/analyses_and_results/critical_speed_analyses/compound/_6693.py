...
class SpiralBevelGearCompoundCriticalSpeedAnalysis(_6610.BevelGearCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6564.SpiralBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6564.SpiralBevelGearCriticalSpeedAnalysis]':
