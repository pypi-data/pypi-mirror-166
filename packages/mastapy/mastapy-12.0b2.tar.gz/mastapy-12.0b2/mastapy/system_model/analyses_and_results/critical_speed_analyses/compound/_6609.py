...
class BevelDifferentialSunGearCompoundCriticalSpeedAnalysis(_6605.BevelDifferentialGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialSunGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6478.BevelDifferentialSunGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6478.BevelDifferentialSunGearCriticalSpeedAnalysis]':
