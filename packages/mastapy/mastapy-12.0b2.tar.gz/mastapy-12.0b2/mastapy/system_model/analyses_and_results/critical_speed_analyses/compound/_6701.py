...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6699, _6700, _6612
...
class StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis(_6612.BevelGearSetCompoundCriticalSpeedAnalysis):
    """StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6572.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_critical_speed_analysis(self) -> 'List[_6699.StraightBevelDiffGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_critical_speed_analysis(self) -> 'List[_6700.StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6572.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
