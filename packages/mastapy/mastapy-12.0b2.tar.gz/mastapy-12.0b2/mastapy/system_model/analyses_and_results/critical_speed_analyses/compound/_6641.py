...
class CylindricalGearCompoundCriticalSpeedAnalysis(_6652.GearCompoundCriticalSpeedAnalysis):
    """CylindricalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6512.CylindricalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6512.CylindricalGearCriticalSpeedAnalysis]':
