...
class RollingRingAssemblyCompoundCriticalSpeedAnalysis(_6692.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """RollingRingAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6556.RollingRingAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6556.RollingRingAssemblyCriticalSpeedAnalysis]':
