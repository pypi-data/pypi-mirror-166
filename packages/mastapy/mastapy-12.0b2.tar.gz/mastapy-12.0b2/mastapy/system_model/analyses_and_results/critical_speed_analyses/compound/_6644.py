...
class CylindricalPlanetGearCompoundCriticalSpeedAnalysis(_6641.CylindricalGearCompoundCriticalSpeedAnalysis):
    """CylindricalPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6515.CylindricalPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6515.CylindricalPlanetGearCriticalSpeedAnalysis]':
