...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6591, _6592, _6481
...
class ZerolBevelGearSetCriticalSpeedAnalysis(_6481.BevelGearSetCriticalSpeedAnalysis):
    """ZerolBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def zerol_bevel_gears_critical_speed_analysis(self) -> 'List[_6591.ZerolBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_critical_speed_analysis(self) -> 'List[_6592.ZerolBevelGearMeshCriticalSpeedAnalysis]':
