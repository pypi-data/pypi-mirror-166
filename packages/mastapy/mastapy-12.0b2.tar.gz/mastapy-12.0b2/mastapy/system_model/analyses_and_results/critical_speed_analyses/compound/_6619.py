...
class ComponentCompoundCriticalSpeedAnalysis(_6673.PartCompoundCriticalSpeedAnalysis):
    """ComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6488.ComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6488.ComponentCriticalSpeedAnalysis]':
