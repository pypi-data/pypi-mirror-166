...
class CVTBeltConnectionCompoundCriticalSpeedAnalysis(_6603.BeltConnectionCompoundCriticalSpeedAnalysis):
    """CVTBeltConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6505.CVTBeltConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6505.CVTBeltConnectionCriticalSpeedAnalysis]':
