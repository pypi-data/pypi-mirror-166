...
class GuideDxfModelCompoundCriticalSpeedAnalysis(_6619.ComponentCompoundCriticalSpeedAnalysis):
    """GuideDxfModelCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6526.GuideDxfModelCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6526.GuideDxfModelCriticalSpeedAnalysis]':
