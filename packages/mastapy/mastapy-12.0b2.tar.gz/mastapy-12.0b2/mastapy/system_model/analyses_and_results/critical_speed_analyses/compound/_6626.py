...
class ConicalGearCompoundCriticalSpeedAnalysis(_6652.GearCompoundCriticalSpeedAnalysis):
    """ConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6495.ConicalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6495.ConicalGearCriticalSpeedAnalysis]':
