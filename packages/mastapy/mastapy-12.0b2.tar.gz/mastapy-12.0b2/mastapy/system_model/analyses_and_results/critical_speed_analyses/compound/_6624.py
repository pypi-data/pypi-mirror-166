...
class ConceptGearMeshCompoundCriticalSpeedAnalysis(_6653.GearMeshCompoundCriticalSpeedAnalysis):
    """ConceptGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6493.ConceptGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6493.ConceptGearMeshCriticalSpeedAnalysis]':
