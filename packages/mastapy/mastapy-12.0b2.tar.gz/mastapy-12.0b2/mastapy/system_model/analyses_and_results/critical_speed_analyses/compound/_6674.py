...
class PartToPartShearCouplingCompoundCriticalSpeedAnalysis(_6631.CouplingCompoundCriticalSpeedAnalysis):
    """PartToPartShearCouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6546.PartToPartShearCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6546.PartToPartShearCouplingCriticalSpeedAnalysis]':
