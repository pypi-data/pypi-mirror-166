...
class AbstractShaftCompoundCriticalSpeedAnalysis(_6596.AbstractShaftOrHousingCompoundCriticalSpeedAnalysis):
    """AbstractShaftCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6464.AbstractShaftCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6464.AbstractShaftCriticalSpeedAnalysis]':
