...
class MountableComponentCompoundCriticalSpeedAnalysis(_6619.ComponentCompoundCriticalSpeedAnalysis):
    """MountableComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6542.MountableComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6542.MountableComponentCriticalSpeedAnalysis]':
