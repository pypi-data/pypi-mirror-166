...
class BevelDifferentialGearCompoundCriticalSpeedAnalysis(_6610.BevelGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6474.BevelDifferentialGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6474.BevelDifferentialGearCriticalSpeedAnalysis]':
