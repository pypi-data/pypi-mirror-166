...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6534, _6535, _6533
...
class KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis(_6533.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_critical_speed_analysis(self) -> 'List[_6534.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_critical_speed_analysis(self) -> 'List[_6535.KlingelnbergCycloPalloidHypoidGearMeshCriticalSpeedAnalysis]':
