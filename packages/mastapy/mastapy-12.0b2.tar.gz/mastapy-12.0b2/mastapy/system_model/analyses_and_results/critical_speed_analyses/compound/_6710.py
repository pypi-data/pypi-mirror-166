...
class SynchroniserSleeveCompoundCriticalSpeedAnalysis(_6709.SynchroniserPartCompoundCriticalSpeedAnalysis):
    """SynchroniserSleeveCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6581.SynchroniserSleeveCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6581.SynchroniserSleeveCriticalSpeedAnalysis]':
