...
class BevelGearMeshCompoundCriticalSpeedAnalysis(_6599.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    """BevelGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6480.BevelGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6480.BevelGearMeshCriticalSpeedAnalysis]':
