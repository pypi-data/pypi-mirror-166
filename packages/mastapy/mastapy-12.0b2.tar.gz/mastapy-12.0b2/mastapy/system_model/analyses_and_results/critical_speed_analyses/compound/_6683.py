...
class RingPinsCompoundCriticalSpeedAnalysis(_6671.MountableComponentCompoundCriticalSpeedAnalysis):
    """RingPinsCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6554.RingPinsCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6554.RingPinsCriticalSpeedAnalysis]':
