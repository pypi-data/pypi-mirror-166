...
class BeltDriveCompoundCriticalSpeedAnalysis(_6692.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """BeltDriveCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6473.BeltDriveCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6473.BeltDriveCriticalSpeedAnalysis]':
