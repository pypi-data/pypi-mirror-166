...
class AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis(_6626.ConicalGearCompoundCriticalSpeedAnalysis):
    """AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6467.AGMAGleasonConicalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6467.AGMAGleasonConicalGearCriticalSpeedAnalysis]':
