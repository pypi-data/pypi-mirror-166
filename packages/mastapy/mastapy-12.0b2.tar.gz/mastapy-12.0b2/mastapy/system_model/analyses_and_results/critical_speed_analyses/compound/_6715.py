...
class UnbalancedMassCompoundCriticalSpeedAnalysis(_6716.VirtualComponentCompoundCriticalSpeedAnalysis):
    """UnbalancedMassCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6586.UnbalancedMassCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6586.UnbalancedMassCriticalSpeedAnalysis]':
