...
class InterMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6629.ConnectionCompoundCriticalSpeedAnalysis):
    """InterMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6530.InterMountableComponentConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6530.InterMountableComponentConnectionCriticalSpeedAnalysis]':
