...
class BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis(_6605.BevelDifferentialGearCompoundCriticalSpeedAnalysis):
    """BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6477.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6477.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
