...
class CVTPulleyCompoundCriticalSpeedAnalysis(_6682.PulleyCompoundCriticalSpeedAnalysis):
    """CVTPulleyCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6507.CVTPulleyCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6507.CVTPulleyCriticalSpeedAnalysis]':
