...
class PlanetaryConnectionCompoundCriticalSpeedAnalysis(_6691.ShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """PlanetaryConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6548.PlanetaryConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6548.PlanetaryConnectionCriticalSpeedAnalysis]':
