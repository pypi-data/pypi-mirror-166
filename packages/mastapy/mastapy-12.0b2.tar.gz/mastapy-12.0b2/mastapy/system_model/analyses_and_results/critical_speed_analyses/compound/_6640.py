...
class CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis(_6597.AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6511.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6511.CycloidalDiscPlanetaryBearingConnectionCriticalSpeedAnalysis]':
