...
class ConicalGearSetCompoundCriticalSpeedAnalysis(_6654.GearSetCompoundCriticalSpeedAnalysis):
    """ConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6497.ConicalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6497.ConicalGearSetCriticalSpeedAnalysis]':
