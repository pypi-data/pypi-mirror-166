...
from mastapy.system_model.analyses_and_results.load_case_groups import _5596, _5589
...
class DutyCycle(_5589.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_5596.SubGroupInSingleDesignState]':
    ...
    @property
    def time_series_importer(self) -> '_6920.TimeSeriesImporter':
    ...
    def add_static_load(self, static_load: '_6724.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_5596.SubGroupInSingleDesignState'):
    ...
    def remove_static_load(self, static_load: '_6724.StaticLoadCase'):
