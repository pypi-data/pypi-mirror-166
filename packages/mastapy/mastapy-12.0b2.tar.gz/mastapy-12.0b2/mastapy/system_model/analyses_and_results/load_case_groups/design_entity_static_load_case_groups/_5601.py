...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5606
...
TAssembly = TypeVar('TAssembly', bound='_2380.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6726.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5606.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    """AbstractAssemblyStaticLoadCaseGroup
