...
TReal = TypeVar('TReal', bound='_2389.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6756.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5606.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    """ComponentStaticLoadCaseGroup
