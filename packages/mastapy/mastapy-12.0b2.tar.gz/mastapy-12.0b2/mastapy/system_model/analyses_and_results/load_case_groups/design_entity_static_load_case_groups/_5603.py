...
TConnection = TypeVar('TConnection', bound='_2217.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6768.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5604.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    """ConnectionStaticLoadCaseGroup
