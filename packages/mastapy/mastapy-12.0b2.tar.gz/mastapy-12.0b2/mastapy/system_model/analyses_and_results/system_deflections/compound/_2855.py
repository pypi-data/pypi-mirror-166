...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2853, _2854, _2796
...
class HypoidGearSetCompoundSystemDeflection(_2796.AGMAGleasonConicalGearSetCompoundSystemDeflection):
    """HypoidGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2703.HypoidGearSetSystemDeflection]':
    ...
    @property
    def hypoid_gears_compound_system_deflection(self) -> 'List[_2853.HypoidGearCompoundSystemDeflection]':
    ...
    @property
    def hypoid_meshes_compound_system_deflection(self) -> 'List[_2854.HypoidGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2703.HypoidGearSetSystemDeflection]':
