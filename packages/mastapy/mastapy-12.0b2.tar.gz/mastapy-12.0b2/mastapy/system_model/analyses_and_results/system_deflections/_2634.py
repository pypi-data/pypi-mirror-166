...
class AGMAGleasonConicalGearSetSystemDeflection(_2664.ConicalGearSetSystemDeflection):
    """AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3975.AGMAGleasonConicalGearSetPowerFlow':
