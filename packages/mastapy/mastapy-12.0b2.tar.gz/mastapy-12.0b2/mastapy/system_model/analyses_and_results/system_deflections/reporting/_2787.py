...
class RigidlyConnectedComponentGroupSystemDeflection(_2596.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1478.MassProperties':
    ...
    @property
    def components(self) -> 'List[_2654.ComponentSystemDeflection]':
