...
class GearCompoundSystemDeflection(_2868.MountableComponentCompoundSystemDeflection):
    """GearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2700.GearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2700.GearSystemDeflection]':
