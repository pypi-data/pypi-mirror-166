...
class TorqueConverterCompoundSystemDeflection(_2827.CouplingCompoundSystemDeflection):
    """TorqueConverterCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2769.TorqueConverterSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2769.TorqueConverterSystemDeflection]':
