...
from mastapy.system_model.analyses_and_results.system_deflections import _2766, _2716
...
class SystemDeflection(_7461.FEAnalysis):
    """SystemDeflection
    ...
    @property
    def analysis_options(self) -> '_2766.SystemDeflectionOptions':
    ...
    @property
    def overall_efficiency_results(self) -> '_2716.LoadCaseOverallEfficiencyResult':
