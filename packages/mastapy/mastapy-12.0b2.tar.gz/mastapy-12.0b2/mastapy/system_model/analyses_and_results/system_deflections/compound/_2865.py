...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2863, _2864, _2859
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection(_2859.KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2714.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_system_deflection(self) -> 'List[_2863.KlingelnbergCycloPalloidSpiralBevelGearCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_system_deflection(self) -> 'List[_2864.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2714.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]':
