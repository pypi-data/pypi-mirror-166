...
class AbstractShaftOrHousingCompoundSystemDeflection(_2815.ComponentCompoundSystemDeflection):
    """AbstractShaftOrHousingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2630.AbstractShaftOrHousingSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2630.AbstractShaftOrHousingSystemDeflection]':
