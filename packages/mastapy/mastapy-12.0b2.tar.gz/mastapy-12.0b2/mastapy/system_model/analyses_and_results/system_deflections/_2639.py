...
from mastapy.system_model.part_model.couplings import _2520, _2530
from mastapy._internal import constructor, conversion
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.static_loads import _6741, _6774
from mastapy.system_model.analyses_and_results.power_flows import _3979, _4010
from mastapy.system_model.analyses_and_results.system_deflections import _2638, _2745
...
class BeltDriveSystemDeflection(_2745.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    def assembly_design(self) -> '_2520.BeltDrive':
    ...
    @property
    def assembly_load_case(self) -> '_6741.BeltDriveLoadCase':
        ...
        if _6741.BeltDriveLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_flow_results(self) -> '_3979.BeltDrivePowerFlow':
        ...
        if _3979.BeltDrivePowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def belts(self) -> 'List[_2638.BeltConnectionSystemDeflection]':
