...
class RootAssemblySystemDeflection(_2636.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4066.RootAssemblyPowerFlow':
    ...
    @property
    def system_deflection_inputs(self) -> '_2764.SystemDeflection':
        ...
        if _2764.SystemDeflection.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def shaft_deflection_results(self) -> 'List[_2655.ConcentricPartGroupCombinationSystemDeflectionResults]':
