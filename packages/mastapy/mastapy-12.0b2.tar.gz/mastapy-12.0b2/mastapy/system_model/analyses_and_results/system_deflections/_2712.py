...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2709.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4040.KlingelnbergCycloPalloidHypoidGearPowerFlow':
