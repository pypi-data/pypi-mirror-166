...
from mastapy.system_model.analyses_and_results.power_flows import _3978, _4009
...
class BeltConnectionSystemDeflection(_2706.InterMountableComponentConnectionSystemDeflection):
    """BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3978.BeltConnectionPowerFlow':
        ...
        if _3978.BeltConnectionPowerFlow.TYPE not in temp.__class__.__mro__:
