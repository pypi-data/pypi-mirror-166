...
class KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection(_2822.ConicalGearCompoundSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2709.KlingelnbergCycloPalloidConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2709.KlingelnbergCycloPalloidConicalGearSystemDeflection]':
