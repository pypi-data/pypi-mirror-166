...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2793
...
class CycloidalDiscPlanetaryBearingConnectionCompoundSystemDeflection(_2793.AbstractShaftToMountableComponentConnectionCompoundSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2676.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2676.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
