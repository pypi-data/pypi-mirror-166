...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2819, _2820, _2851
...
class ConceptGearSetCompoundSystemDeflection(_2851.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2660.ConceptGearSetSystemDeflection]':
    ...
    @property
    def concept_gears_compound_system_deflection(self) -> 'List[_2819.ConceptGearCompoundSystemDeflection]':
    ...
    @property
    def concept_meshes_compound_system_deflection(self) -> 'List[_2820.ConceptGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2660.ConceptGearSetSystemDeflection]':
