...
class BeltDriveCompoundSystemDeflection(_2890.SpecialisedAssemblyCompoundSystemDeflection):
    """BeltDriveCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2639.BeltDriveSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2639.BeltDriveSystemDeflection]':
