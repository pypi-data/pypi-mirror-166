...
class BearingCompoundSystemDeflection(_2826.ConnectorCompoundSystemDeflection):
    """BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_1901.LoadedBearingDutyCycle':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2637.BearingSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2637.BearingSystemDeflection]':
