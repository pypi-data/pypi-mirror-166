...
class SynchroniserPartCompoundSystemDeflection(_2829.CouplingHalfCompoundSystemDeflection):
    """SynchroniserPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2761.SynchroniserPartSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2761.SynchroniserPartSystemDeflection]':
