...
class StraightBevelDiffGearCompoundSystemDeflection(_2806.BevelGearCompoundSystemDeflection):
    """StraightBevelDiffGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2754.StraightBevelDiffGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2754.StraightBevelDiffGearSystemDeflection]':
