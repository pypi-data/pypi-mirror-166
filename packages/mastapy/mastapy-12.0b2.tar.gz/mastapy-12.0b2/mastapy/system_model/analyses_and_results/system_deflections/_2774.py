...
class VirtualComponentSystemDeflection(_2721.MountableComponentSystemDeflection):
    """VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4095.VirtualComponentPowerFlow':
