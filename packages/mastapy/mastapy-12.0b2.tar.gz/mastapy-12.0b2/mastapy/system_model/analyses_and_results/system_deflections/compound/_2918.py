...
class ZerolBevelGearCompoundSystemDeflection(_2806.BevelGearCompoundSystemDeflection):
    """ZerolBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2780.ZerolBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2780.ZerolBevelGearSystemDeflection]':
