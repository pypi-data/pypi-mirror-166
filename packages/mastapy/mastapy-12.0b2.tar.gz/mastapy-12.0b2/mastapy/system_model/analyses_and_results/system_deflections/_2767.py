...
class TorqueConverterConnectionSystemDeflection(_2668.CouplingConnectionSystemDeflection):
    """TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4090.TorqueConverterConnectionPowerFlow':
