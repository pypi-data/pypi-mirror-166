...
class StraightBevelDiffGearMeshSystemDeflection(_2645.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4077.StraightBevelDiffGearMeshPowerFlow':
