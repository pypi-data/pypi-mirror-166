...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2837, _2838, _2851
...
class CylindricalGearSetCompoundSystemDeflection(_2851.GearSetCompoundSystemDeflection):
    """CylindricalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2683.CylindricalGearSetSystemDeflectionWithLTCAResults]':
    ...
    @property
    def cylindrical_gears_compound_system_deflection(self) -> 'List[_2837.CylindricalGearCompoundSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_compound_system_deflection(self) -> 'List[_2838.CylindricalGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2683.CylindricalGearSetSystemDeflectionWithLTCAResults]':
