...
class CouplingConnectionSystemDeflection(_2706.InterMountableComponentConnectionSystemDeflection):
    """CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4006.CouplingConnectionPowerFlow':
