...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2829
...
class PartToPartShearCouplingHalfCompoundSystemDeflection(_2829.CouplingHalfCompoundSystemDeflection):
    """PartToPartShearCouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2726.PartToPartShearCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2726.PartToPartShearCouplingHalfSystemDeflection]':
