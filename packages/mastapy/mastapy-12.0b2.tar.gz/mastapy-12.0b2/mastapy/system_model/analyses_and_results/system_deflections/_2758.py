...
class StraightBevelPlanetGearSystemDeflection(_2754.StraightBevelDiffGearSystemDeflection):
    """StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4083.StraightBevelPlanetGearPowerFlow':
