...
class ShaftHubConnectionCompoundSystemDeflection(_2826.ConnectorCompoundSystemDeflection):
    """ShaftHubConnectionCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2740.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2740.ShaftHubConnectionSystemDeflection]':
