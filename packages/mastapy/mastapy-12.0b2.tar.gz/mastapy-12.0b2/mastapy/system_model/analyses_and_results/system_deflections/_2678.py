...
class CylindricalGearMeshSystemDeflection(_2698.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def chart_of_misalignment_in_transverse_line_of_action(self) -> '_1748.SimpleChartDefinition':
    ...
    @property
    def gear_a(self) -> '_2684.CylindricalGearSystemDeflection':
    ...
    @property
    def gear_b(self) -> '_2684.CylindricalGearSystemDeflection':
    ...
    @property
    def power_flow_results(self) -> '_4017.CylindricalGearMeshPowerFlow':
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2684.CylindricalGearSystemDeflection]':
    ...
    @property
    def cylindrical_meshed_gear_system_deflections(self) -> 'List[_2688.CylindricalMeshedGearSystemDeflection]':
    ...
    @property
    def mesh_deflections_left_flank(self) -> 'List[_2784.MeshDeflectionResults]':
    ...
    @property
    def mesh_deflections_right_flank(self) -> 'List[_2784.MeshDeflectionResults]':
