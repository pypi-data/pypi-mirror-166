...
from mastapy.system_model.analyses_and_results.power_flows import _3971, _4015, _4068
...
class AbstractShaftSystemDeflection(_2630.AbstractShaftOrHousingSystemDeflection):
    """AbstractShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3971.AbstractShaftPowerFlow':
