...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2801, _2802, _2808
...
class BevelDifferentialGearSetCompoundSystemDeflection(_2808.BevelGearSetCompoundSystemDeflection):
    """BevelDifferentialGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2641.BevelDifferentialGearSetSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_compound_system_deflection(self) -> 'List[_2801.BevelDifferentialGearCompoundSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_compound_system_deflection(self) -> 'List[_2802.BevelDifferentialGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2641.BevelDifferentialGearSetSystemDeflection]':
