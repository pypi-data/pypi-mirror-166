...
class InterMountableComponentConnectionCompoundSystemDeflection(_2825.ConnectionCompoundSystemDeflection):
    """InterMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2706.InterMountableComponentConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2706.InterMountableComponentConnectionSystemDeflection]':
