...
class CylindricalPlanetGearCompoundSystemDeflection(_2837.CylindricalGearCompoundSystemDeflection):
    """CylindricalPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2689.CylindricalPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2689.CylindricalPlanetGearSystemDeflection]':
