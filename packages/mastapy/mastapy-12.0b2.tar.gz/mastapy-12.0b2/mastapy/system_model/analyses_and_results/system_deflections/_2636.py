...
from mastapy.system_model.analyses_and_results.power_flows import _3976, _4066
from mastapy.gears.analysis import _1215
from mastapy.shafts import _40
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2637, _2639, _2641, _2648,
    _2649, _2673, _2652, _2654,
    _2658, _2660, _2666, _2674,
    _2677, _2681, _2696, _2694,
    _2697, _2703, _2711, _2714,
    _2718, _2719, _2721, _2723,
    _2727, _2729, _2730, _2731,
    _2733, _2736, _2740, _2743,
    _2630, _2747, _2751, _2753,
    _2756, _2763, _2769, _2773,
    _2698, _2776, _2779, _2629
)
...
class AssemblySystemDeflection(_2629.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3976.AssemblyPowerFlow':
        ...
        if _3976.AssemblyPowerFlow.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def rating_for_all_gear_sets(self) -> '_1215.GearSetGroupDutyCycle':
    ...
    @property
    def bearings(self) -> 'List[_2637.BearingSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_2639.BeltDriveSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_2641.BevelDifferentialGearSetSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_2648.BoltedJointSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_2649.BoltSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_2673.CVTSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_2652.ClutchSystemDeflection]':
    ...
    @property
    def component_details(self) -> 'List[_2654.ComponentSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_2658.ConceptCouplingSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_2660.ConceptGearSetSystemDeflection]':
    ...
    @property
    def connection_details(self) -> 'List[_2666.ConnectionSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_2674.CycloidalAssemblySystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_2677.CycloidalDiscSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_2681.CylindricalGearSetSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_2696.FEPartSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_2694.FaceGearSetSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_2697.FlexiblePinAssemblySystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_2703.HypoidGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_2711.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_2714.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_2718.MassDiscSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_2719.MeasurementComponentSystemDeflection]':
    ...
    @property
    def mountable_component_details(self) -> 'List[_2721.MountableComponentSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_2723.OilSealSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_2727.PartToPartShearCouplingSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_2729.PlanetCarrierSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_2730.PointLoadSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_2731.PowerLoadSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_2733.RingPinsSystemDeflection]':
    ...
    @property
    def rolling_bearings(self) -> 'List[_2637.BearingSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_2736.RollingRingAssemblySystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_2740.ShaftHubConnectionSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_2743.ShaftSystemDeflection]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_2630.AbstractShaftOrHousingSystemDeflection]':
    ...
    @property
    def sorted_converged_component_details(self) -> 'List[_2654.ComponentSystemDeflection]':
    ...
    @property
    def sorted_converged_connection_details(self) -> 'List[_2666.ConnectionSystemDeflection]':
    ...
    @property
    def sorted_unconverged_component_details(self) -> 'List[_2654.ComponentSystemDeflection]':
    ...
    @property
    def sorted_unconverged_connection_details(self) -> 'List[_2666.ConnectionSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_2747.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_2751.SpringDamperSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_2753.StraightBevelDiffGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_2756.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_2681.CylindricalGearSetSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_2763.SynchroniserSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_2769.TorqueConverterSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_2773.UnbalancedMassSystemDeflection]':
    ...
    @property
    def unconverged_bearings_sorted_by_load(self) -> 'List[_2637.BearingSystemDeflection]':
    ...
    @property
    def unconverged_gear_meshes_sorted_by_power(self) -> 'List[_2698.GearMeshSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_2776.WormGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_2779.ZerolBevelGearSetSystemDeflection]':
