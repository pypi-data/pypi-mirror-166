...
from mastapy.system_model.analyses_and_results.system_deflections import _2741, _2742, _2631
...
class ShaftSystemDeflection(_2631.AbstractShaftSystemDeflection):
    """ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4068.ShaftPowerFlow':
    ...
    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2741.ShaftSectionEndResultsSystemDeflection':
    ...
    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2741.ShaftSectionEndResultsSystemDeflection':
    ...
    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2741.ShaftSectionEndResultsSystemDeflection':
    ...
    @property
    def mounted_components_applying_torque(self) -> 'List[_1522.ForceResults]':
    ...
    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2741.ShaftSectionEndResultsSystemDeflection]':
    ...
    @property
    def shaft_section_results(self) -> 'List[_2742.ShaftSectionSystemDeflection]':
