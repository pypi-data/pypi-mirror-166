...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2900, _2901, _2808
...
class StraightBevelGearSetCompoundSystemDeflection(_2808.BevelGearSetCompoundSystemDeflection):
    """StraightBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2756.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_compound_system_deflection(self) -> 'List[_2900.StraightBevelGearCompoundSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_compound_system_deflection(self) -> 'List[_2901.StraightBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2756.StraightBevelGearSetSystemDeflection]':
