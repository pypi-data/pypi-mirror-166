...
class TorqueConverterPumpCompoundSystemDeflection(_2829.CouplingHalfCompoundSystemDeflection):
    """TorqueConverterPumpCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2768.TorqueConverterPumpSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2768.TorqueConverterPumpSystemDeflection]':
