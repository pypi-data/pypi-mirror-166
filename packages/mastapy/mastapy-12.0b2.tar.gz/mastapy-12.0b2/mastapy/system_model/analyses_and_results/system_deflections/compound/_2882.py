...
class RollingRingAssemblyCompoundSystemDeflection(_2890.SpecialisedAssemblyCompoundSystemDeflection):
    """RollingRingAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2736.RollingRingAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2736.RollingRingAssemblySystemDeflection]':
