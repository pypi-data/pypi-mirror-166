...
from mastapy.system_model.analyses_and_results.power_flows import _4018, _4020
from mastapy.system_model.analyses_and_results.system_deflections import _2688, _2700
...
class CylindricalGearSystemDeflection(_2700.GearSystemDeflection):
    """CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4018.CylindricalGearPowerFlow':
    ...
    @property
    def cylindrical_gear_system_deflections_in_meshes(self) -> 'List[_2688.CylindricalMeshedGearSystemDeflection]':
