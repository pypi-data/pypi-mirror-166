...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2918, _2919, _2808
...
class ZerolBevelGearSetCompoundSystemDeflection(_2808.BevelGearSetCompoundSystemDeflection):
    """ZerolBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2779.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_compound_system_deflection(self) -> 'List[_2918.ZerolBevelGearCompoundSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_compound_system_deflection(self) -> 'List[_2919.ZerolBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2779.ZerolBevelGearSetSystemDeflection]':
