...
class StraightBevelSunGearCompoundSystemDeflection(_2897.StraightBevelDiffGearCompoundSystemDeflection):
    """StraightBevelSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2759.StraightBevelSunGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2759.StraightBevelSunGearSystemDeflection]':
