...
class BevelDifferentialGearCompoundSystemDeflection(_2806.BevelGearCompoundSystemDeflection):
    """BevelDifferentialGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2642.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2642.BevelDifferentialGearSystemDeflection]':
