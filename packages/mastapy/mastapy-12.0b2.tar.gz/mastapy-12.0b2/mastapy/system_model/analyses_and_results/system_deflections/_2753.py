...
from mastapy.system_model.analyses_and_results.system_deflections import _2754, _2752, _2646
...
class StraightBevelDiffGearSetSystemDeflection(_2646.BevelGearSetSystemDeflection):
    """StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4079.StraightBevelDiffGearSetPowerFlow':
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2754.StraightBevelDiffGearSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2752.StraightBevelDiffGearMeshSystemDeflection]':
