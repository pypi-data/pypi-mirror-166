...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2709.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    """KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4043.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow':
