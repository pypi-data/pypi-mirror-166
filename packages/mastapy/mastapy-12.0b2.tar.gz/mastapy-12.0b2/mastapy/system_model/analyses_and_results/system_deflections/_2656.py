...
class ConceptCouplingConnectionSystemDeflection(_2668.CouplingConnectionSystemDeflection):
    """ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3995.ConceptCouplingConnectionPowerFlow':
