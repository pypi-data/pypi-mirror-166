...
class GuideDxfModelCompoundSystemDeflection(_2815.ComponentCompoundSystemDeflection):
    """GuideDxfModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2701.GuideDxfModelSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2701.GuideDxfModelSystemDeflection]':
