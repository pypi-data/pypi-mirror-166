...
class AbstractShaftCompoundSystemDeflection(_2792.AbstractShaftOrHousingCompoundSystemDeflection):
    """AbstractShaftCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2631.AbstractShaftSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2631.AbstractShaftSystemDeflection]':
