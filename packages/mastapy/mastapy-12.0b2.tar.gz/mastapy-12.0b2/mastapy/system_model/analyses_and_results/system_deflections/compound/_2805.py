...
class BevelDifferentialSunGearCompoundSystemDeflection(_2801.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialSunGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2644.BevelDifferentialSunGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2644.BevelDifferentialSunGearSystemDeflection]':
