...
class RollingRingConnectionCompoundSystemDeflection(_2856.InterMountableComponentConnectionCompoundSystemDeflection):
    """RollingRingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2737.RollingRingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2737.RollingRingConnectionSystemDeflection]':
