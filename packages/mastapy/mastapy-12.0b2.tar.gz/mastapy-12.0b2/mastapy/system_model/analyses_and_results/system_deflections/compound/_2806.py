...
class BevelGearCompoundSystemDeflection(_2794.AGMAGleasonConicalGearCompoundSystemDeflection):
    """BevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2647.BevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2647.BevelGearSystemDeflection]':
