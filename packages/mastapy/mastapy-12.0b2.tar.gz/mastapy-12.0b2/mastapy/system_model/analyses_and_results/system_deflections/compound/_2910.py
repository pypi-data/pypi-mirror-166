...
class TorqueConverterConnectionCompoundSystemDeflection(_2828.CouplingConnectionCompoundSystemDeflection):
    """TorqueConverterConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2767.TorqueConverterConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2767.TorqueConverterConnectionSystemDeflection]':
