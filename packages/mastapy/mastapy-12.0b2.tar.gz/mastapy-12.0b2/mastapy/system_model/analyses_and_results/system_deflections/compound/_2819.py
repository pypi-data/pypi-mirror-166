...
class ConceptGearCompoundSystemDeflection(_2849.GearCompoundSystemDeflection):
    """ConceptGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2661.ConceptGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2661.ConceptGearSystemDeflection]':
