...
class ConicalGearSetCompoundSystemDeflection(_2851.GearSetCompoundSystemDeflection):
    """ConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2664.ConicalGearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2664.ConicalGearSetSystemDeflection]':
