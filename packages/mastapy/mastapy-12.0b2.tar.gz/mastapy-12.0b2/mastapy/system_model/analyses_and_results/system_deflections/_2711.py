...
from mastapy.system_model.analyses_and_results.system_deflections import _2712, _2710, _2708
...
class KlingelnbergCycloPalloidHypoidGearSetSystemDeflection(_2708.KlingelnbergCycloPalloidConicalGearSetSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4041.KlingelnbergCycloPalloidHypoidGearSetPowerFlow':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_system_deflection(self) -> 'List[_2712.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_system_deflection(self) -> 'List[_2710.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
