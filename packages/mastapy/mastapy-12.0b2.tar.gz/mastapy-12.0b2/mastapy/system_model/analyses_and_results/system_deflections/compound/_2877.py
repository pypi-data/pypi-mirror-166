...
class PointLoadCompoundSystemDeflection(_2914.VirtualComponentCompoundSystemDeflection):
    """PointLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2730.PointLoadSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2730.PointLoadSystemDeflection]':
