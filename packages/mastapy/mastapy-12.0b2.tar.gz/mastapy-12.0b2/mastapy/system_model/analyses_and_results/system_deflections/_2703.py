...
from mastapy.system_model.analyses_and_results.system_deflections import _2704, _2702, _2634
...
class HypoidGearSetSystemDeflection(_2634.AGMAGleasonConicalGearSetSystemDeflection):
    """HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4034.HypoidGearSetPowerFlow':
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2704.HypoidGearSystemDeflection]':
    ...
    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2702.HypoidGearMeshSystemDeflection]':
