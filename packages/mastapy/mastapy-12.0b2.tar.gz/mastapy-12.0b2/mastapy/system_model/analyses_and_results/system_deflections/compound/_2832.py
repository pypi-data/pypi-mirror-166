...
class CVTPulleyCompoundSystemDeflection(_2879.PulleyCompoundSystemDeflection):
    """CVTPulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2672.CVTPulleySystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2672.CVTPulleySystemDeflection]':
