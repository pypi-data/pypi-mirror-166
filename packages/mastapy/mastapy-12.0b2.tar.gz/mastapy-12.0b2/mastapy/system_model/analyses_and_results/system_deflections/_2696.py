...
from mastapy.math_utility.measured_vectors import _1525, _1521
...
class FEPartSystemDeflection(_2630.AbstractShaftOrHousingSystemDeflection):
    """FEPartSystemDeflection
    ...
    @property
    def component_design(self) -> '_2398.FEPart':
    ...
    @property
    def component_load_case(self) -> '_6806.FEPartLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_4026.FEPartPowerFlow':
    ...
    @property
    def applied_internal_forces_in_world_coordinate_system(self) -> 'List[_1525.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def node_results_in_shaft_coordinate_system(self) -> 'List[_1521.ForceAndDisplacementResults]':
    ...
    @property
    def export(self) -> '_2354.SystemDeflectionFEExportOptions':
