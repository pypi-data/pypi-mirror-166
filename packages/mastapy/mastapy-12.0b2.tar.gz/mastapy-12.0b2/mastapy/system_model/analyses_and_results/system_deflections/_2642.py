...
from mastapy.system_model.analyses_and_results.power_flows import _3981, _3983, _3984
...
class BevelDifferentialGearSystemDeflection(_2647.BevelGearSystemDeflection):
    """BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3981.BevelDifferentialGearPowerFlow':
