...
class RingPinsCompoundSystemDeflection(_2868.MountableComponentCompoundSystemDeflection):
    """RingPinsCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2733.RingPinsSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2733.RingPinsSystemDeflection]':
