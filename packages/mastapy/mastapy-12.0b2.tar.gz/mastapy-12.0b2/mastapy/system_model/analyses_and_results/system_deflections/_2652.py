...
from mastapy.system_model.analyses_and_results.system_deflections import _2650, _2670
...
class ClutchSystemDeflection(_2670.CouplingSystemDeflection):
    """ClutchSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3992.ClutchPowerFlow':
