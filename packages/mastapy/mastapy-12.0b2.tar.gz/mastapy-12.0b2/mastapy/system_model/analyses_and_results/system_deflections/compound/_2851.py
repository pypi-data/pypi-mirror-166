...
class GearSetCompoundSystemDeflection(_2890.SpecialisedAssemblyCompoundSystemDeflection):
    """GearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2699.GearSetSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2699.GearSetSystemDeflection]':
