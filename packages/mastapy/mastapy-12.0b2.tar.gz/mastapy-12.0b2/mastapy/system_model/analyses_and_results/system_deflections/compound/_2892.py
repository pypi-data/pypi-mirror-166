...
class SpiralBevelGearMeshCompoundSystemDeflection(_2807.BevelGearMeshCompoundSystemDeflection):
    """SpiralBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2746.SpiralBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2746.SpiralBevelGearMeshSystemDeflection]':
