...
class CVTPulleySystemDeflection(_2732.PulleySystemDeflection):
    """CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4011.CVTPulleyPowerFlow':
    ...
    @property
    def fixed_sheave_contact_results(self) -> 'List[_1523.NodeResults]':
    ...
    @property
    def moving_sheave_contact_results(self) -> 'List[_1523.NodeResults]':
