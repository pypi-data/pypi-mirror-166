...
class CouplingHalfCompoundSystemDeflection(_2868.MountableComponentCompoundSystemDeflection):
    """CouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2669.CouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2669.CouplingHalfSystemDeflection]':
