...
class PartToPartShearCouplingHalfSystemDeflection(_2669.CouplingHalfSystemDeflection):
    """PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4051.PartToPartShearCouplingHalfPowerFlow':
