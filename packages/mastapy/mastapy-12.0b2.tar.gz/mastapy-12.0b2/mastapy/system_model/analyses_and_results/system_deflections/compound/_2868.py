...
class MountableComponentCompoundSystemDeflection(_2815.ComponentCompoundSystemDeflection):
    """MountableComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2721.MountableComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2721.MountableComponentSystemDeflection]':
