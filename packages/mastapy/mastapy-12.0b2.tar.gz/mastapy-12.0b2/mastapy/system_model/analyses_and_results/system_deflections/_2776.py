...
from mastapy.system_model.analyses_and_results.system_deflections import _2777, _2775, _2699
...
class WormGearSetSystemDeflection(_2699.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4098.WormGearSetPowerFlow':
    ...
    @property
    def worm_gears_system_deflection(self) -> 'List[_2777.WormGearSystemDeflection]':
    ...
    @property
    def worm_meshes_system_deflection(self) -> 'List[_2775.WormGearMeshSystemDeflection]':
