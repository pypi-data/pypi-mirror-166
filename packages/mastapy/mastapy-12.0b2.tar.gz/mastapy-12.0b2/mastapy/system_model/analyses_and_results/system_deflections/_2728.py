...
class PlanetaryConnectionSystemDeflection(_2744.ShaftToMountableComponentConnectionSystemDeflection):
    """PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4053.PlanetaryConnectionPowerFlow':
