...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2653.CoaxialConnectionSystemDeflection):
    """CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4013.CycloidalDiscCentralBearingConnectionPowerFlow':
