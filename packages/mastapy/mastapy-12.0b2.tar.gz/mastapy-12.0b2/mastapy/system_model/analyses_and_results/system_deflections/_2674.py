...
from mastapy.system_model.analyses_and_results.system_deflections import _2734, _2745
...
class CycloidalAssemblySystemDeflection(_2745.SpecialisedAssemblySystemDeflection):
    """CycloidalAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4012.CycloidalAssemblyPowerFlow':
    ...
    @property
    def ring_pins_to_disc_connections(self) -> 'List[_2734.RingPinsToDiscConnectionSystemDeflection]':
