...
class FaceGearCompoundModalAnalysis(_4718.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4564.FaceGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4564.FaceGearModalAnalysis]':
