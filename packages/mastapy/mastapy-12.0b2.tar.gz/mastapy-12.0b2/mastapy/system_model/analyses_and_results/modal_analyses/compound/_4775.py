...
class SynchroniserPartCompoundModalAnalysis(_4699.CouplingHalfCompoundModalAnalysis):
    """SynchroniserPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4631.SynchroniserPartModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4631.SynchroniserPartModalAnalysis]':
