...
class WormGearCompoundModalAnalysis(_4718.GearCompoundModalAnalysis):
    """WormGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4643.WormGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4643.WormGearModalAnalysis]':
