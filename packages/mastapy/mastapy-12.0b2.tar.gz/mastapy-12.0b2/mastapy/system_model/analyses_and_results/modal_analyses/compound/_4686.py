...
class ConceptCouplingCompoundModalAnalysis(_4697.CouplingCompoundModalAnalysis):
    """ConceptCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4535.ConceptCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4535.ConceptCouplingModalAnalysis]':
