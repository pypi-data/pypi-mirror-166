...
from mastapy.system_model.analyses_and_results.modal_analyses import _4622, _4621, _4525
...
class StraightBevelDiffGearSetModalAnalysis(_4525.BevelGearSetModalAnalysis):
    """StraightBevelDiffGearSetModalAnalysis
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4622.StraightBevelDiffGearModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4621.StraightBevelDiffGearMeshModalAnalysis]':
