...
class ExternalCADModelCompoundModalAnalysis(_4685.ComponentCompoundModalAnalysis):
    """ExternalCADModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4562.ExternalCADModelModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4562.ExternalCADModelModalAnalysis]':
