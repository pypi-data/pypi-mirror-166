...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4732, _4733, _4728
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis(_4728.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4585.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_modal_analysis(self) -> 'List[_4732.KlingelnbergCycloPalloidSpiralBevelGearCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_modal_analysis(self) -> 'List[_4733.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4585.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
