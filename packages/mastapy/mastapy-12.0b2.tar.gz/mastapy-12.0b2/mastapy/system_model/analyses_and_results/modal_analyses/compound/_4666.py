...
class AGMAGleasonConicalGearSetCompoundModalAnalysis(_4694.ConicalGearSetCompoundModalAnalysis):
    """AGMAGleasonConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4513.AGMAGleasonConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4513.AGMAGleasonConicalGearSetModalAnalysis]':
