...
from mastapy.utility.modal_analysis import _1758
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2596.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1758.DesignEntityExcitationDescription]':
