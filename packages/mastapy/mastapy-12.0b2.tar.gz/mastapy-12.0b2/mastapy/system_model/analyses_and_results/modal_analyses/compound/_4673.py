...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4671, _4672, _4678
...
class BevelDifferentialGearSetCompoundModalAnalysis(_4678.BevelGearSetCompoundModalAnalysis):
    """BevelDifferentialGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4520.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis(self) -> 'List[_4671.BevelDifferentialGearCompoundModalAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis(self) -> 'List[_4672.BevelDifferentialGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4520.BevelDifferentialGearSetModalAnalysis]':
