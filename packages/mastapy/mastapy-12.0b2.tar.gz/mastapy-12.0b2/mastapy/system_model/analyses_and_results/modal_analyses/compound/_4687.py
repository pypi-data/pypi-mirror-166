...
class ConceptCouplingConnectionCompoundModalAnalysis(_4698.CouplingConnectionCompoundModalAnalysis):
    """ConceptCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4533.ConceptCouplingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4533.ConceptCouplingConnectionModalAnalysis]':
