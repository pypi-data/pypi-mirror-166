...
class RollingRingConnectionCompoundModalAnalysis(_4725.InterMountableComponentConnectionCompoundModalAnalysis):
    """RollingRingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4607.RollingRingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4607.RollingRingConnectionModalAnalysis]':
