...
class PartToPartShearCouplingCompoundModalAnalysis(_4697.CouplingCompoundModalAnalysis):
    """PartToPartShearCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4597.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4597.PartToPartShearCouplingModalAnalysis]':
