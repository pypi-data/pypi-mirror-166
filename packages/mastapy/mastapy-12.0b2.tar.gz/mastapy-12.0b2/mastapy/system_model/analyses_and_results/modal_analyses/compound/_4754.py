...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4667
...
class RootAssemblyCompoundModalAnalysis(_4667.AssemblyCompoundModalAnalysis):
    """RootAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4609.RootAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4609.RootAssemblyModalAnalysis]':
