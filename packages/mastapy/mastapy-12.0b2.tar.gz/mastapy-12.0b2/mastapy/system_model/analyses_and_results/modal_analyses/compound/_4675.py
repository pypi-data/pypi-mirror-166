...
class BevelDifferentialSunGearCompoundModalAnalysis(_4671.BevelDifferentialGearCompoundModalAnalysis):
    """BevelDifferentialSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4522.BevelDifferentialSunGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4522.BevelDifferentialSunGearModalAnalysis]':
