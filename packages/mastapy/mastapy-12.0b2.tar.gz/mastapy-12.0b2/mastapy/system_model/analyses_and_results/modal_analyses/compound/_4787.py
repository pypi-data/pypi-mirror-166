...
class ZerolBevelGearMeshCompoundModalAnalysis(_4677.BevelGearMeshCompoundModalAnalysis):
    """ZerolBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4645.ZerolBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4645.ZerolBevelGearMeshModalAnalysis]':
