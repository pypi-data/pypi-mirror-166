...
class ClutchCompoundModalAnalysis(_4697.CouplingCompoundModalAnalysis):
    """ClutchCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4530.ClutchModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4530.ClutchModalAnalysis]':
