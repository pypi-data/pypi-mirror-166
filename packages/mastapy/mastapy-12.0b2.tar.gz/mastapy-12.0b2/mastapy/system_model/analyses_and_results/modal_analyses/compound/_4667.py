...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import (
    _4668, _4670, _4673, _4680,
    _4679, _4701, _4681, _4686,
    _4691, _4703, _4705, _4709,
    _4716, _4715, _4717, _4724,
    _4731, _4734, _4735, _4736,
    _4738, _4740, _4745, _4746,
    _4747, _4749, _4751, _4756,
    _4755, _4761, _4762, _4767,
    _4770, _4773, _4777, _4781,
    _4785, _4788, _4660
)
...
class AssemblyCompoundModalAnalysis(_4660.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4514.AssemblyModalAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_4668.BearingCompoundModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4670.BeltDriveCompoundModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4673.BevelDifferentialGearSetCompoundModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4680.BoltedJointCompoundModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4679.BoltCompoundModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4701.CVTCompoundModalAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_4681.ClutchCompoundModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4686.ConceptCouplingCompoundModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4691.ConceptGearSetCompoundModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4703.CycloidalAssemblyCompoundModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4705.CycloidalDiscCompoundModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4709.CylindricalGearSetCompoundModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4716.FEPartCompoundModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4715.FaceGearSetCompoundModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4717.FlexiblePinAssemblyCompoundModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4724.HypoidGearSetCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4731.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4734.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4735.MassDiscCompoundModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4736.MeasurementComponentCompoundModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4738.OilSealCompoundModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4740.PartToPartShearCouplingCompoundModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4745.PlanetCarrierCompoundModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4746.PointLoadCompoundModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4747.PowerLoadCompoundModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4749.RingPinsCompoundModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4751.RollingRingAssemblyCompoundModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4756.ShaftHubConnectionCompoundModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4755.ShaftCompoundModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4761.SpiralBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4762.SpringDamperCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4767.StraightBevelDiffGearSetCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4770.StraightBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4773.SynchroniserCompoundModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4777.TorqueConverterCompoundModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4781.UnbalancedMassCompoundModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4785.WormGearSetCompoundModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4788.ZerolBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4514.AssemblyModalAnalysis]':
