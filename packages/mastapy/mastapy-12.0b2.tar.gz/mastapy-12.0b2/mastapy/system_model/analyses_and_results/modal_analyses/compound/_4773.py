...
class SynchroniserCompoundModalAnalysis(_4758.SpecialisedAssemblyCompoundModalAnalysis):
    """SynchroniserCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4630.SynchroniserModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4630.SynchroniserModalAnalysis]':
