...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4515, _4517, _4520, _4526,
    _4527, _4549, _4530, _4535,
    _4538, _4551, _4553, _4557,
    _4566, _4565, _4567, _4575,
    _4582, _4585, _4586, _4587,
    _4592, _4597, _4600, _4601,
    _4602, _4604, _4606, _4610,
    _4611, _4617, _4620, _4623,
    _4626, _4630, _4634, _4637,
    _4644, _4647, _4507
)
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4648
...
class AssemblyModalAnalysis(_4507.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def bearings(self) -> 'List[_4515.BearingModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4517.BeltDriveModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4520.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4526.BoltedJointModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4527.BoltModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4549.CVTModalAnalysis]':
    ...
    @property
    def calculate_full_fe_results_by_mode(self) -> 'List[_4648.CalculateFullFEResultsForMode]':
    ...
    @property
    def clutches(self) -> 'List[_4530.ClutchModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4535.ConceptCouplingModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4538.ConceptGearSetModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4551.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4553.CycloidalDiscModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4557.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4566.FEPartModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4565.FaceGearSetModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4567.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def full_fe_meshes_for_calculating_modes(self) -> 'List[_4566.FEPartModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4575.HypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4582.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4585.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4586.MassDiscModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4587.MeasurementComponentModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4592.OilSealModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4597.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4600.PlanetCarrierModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4601.PointLoadModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4602.PowerLoadModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4604.RingPinsModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4606.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4610.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4611.ShaftModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4617.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4620.SpringDamperModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4623.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4626.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4630.SynchroniserModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4634.TorqueConverterModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4637.UnbalancedMassModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4644.WormGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4647.ZerolBevelGearSetModalAnalysis]':
