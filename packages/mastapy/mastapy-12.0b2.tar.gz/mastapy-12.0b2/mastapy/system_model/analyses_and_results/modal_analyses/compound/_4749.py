...
class RingPinsCompoundModalAnalysis(_4737.MountableComponentCompoundModalAnalysis):
    """RingPinsCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4604.RingPinsModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4604.RingPinsModalAnalysis]':
