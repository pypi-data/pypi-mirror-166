...
class CylindricalPlanetGearCompoundModalAnalysis(_4707.CylindricalGearCompoundModalAnalysis):
    """CylindricalPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4558.CylindricalPlanetGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4558.CylindricalPlanetGearModalAnalysis]':
