...
class SpecialisedAssemblyCompoundModalAnalysis(_4660.AbstractAssemblyCompoundModalAnalysis):
    """SpecialisedAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4614.SpecialisedAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4614.SpecialisedAssemblyModalAnalysis]':
