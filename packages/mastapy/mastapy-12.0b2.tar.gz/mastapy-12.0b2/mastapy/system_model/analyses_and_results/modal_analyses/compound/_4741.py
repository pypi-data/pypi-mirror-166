...
class PartToPartShearCouplingConnectionCompoundModalAnalysis(_4698.CouplingConnectionCompoundModalAnalysis):
    """PartToPartShearCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4595.PartToPartShearCouplingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4595.PartToPartShearCouplingConnectionModalAnalysis]':
