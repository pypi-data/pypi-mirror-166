...
class StraightBevelDiffGearCompoundModalAnalysis(_4676.BevelGearCompoundModalAnalysis):
    """StraightBevelDiffGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4622.StraightBevelDiffGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4622.StraightBevelDiffGearModalAnalysis]':
