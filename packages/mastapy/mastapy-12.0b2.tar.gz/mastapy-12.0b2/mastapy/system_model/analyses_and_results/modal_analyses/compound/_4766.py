...
class StraightBevelDiffGearMeshCompoundModalAnalysis(_4677.BevelGearMeshCompoundModalAnalysis):
    """StraightBevelDiffGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4621.StraightBevelDiffGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4621.StraightBevelDiffGearMeshModalAnalysis]':
