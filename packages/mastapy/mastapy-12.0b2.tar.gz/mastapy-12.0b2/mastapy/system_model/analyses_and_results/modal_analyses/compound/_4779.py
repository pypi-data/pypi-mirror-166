...
class TorqueConverterPumpCompoundModalAnalysis(_4699.CouplingHalfCompoundModalAnalysis):
    """TorqueConverterPumpCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4635.TorqueConverterPumpModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4635.TorqueConverterPumpModalAnalysis]':
