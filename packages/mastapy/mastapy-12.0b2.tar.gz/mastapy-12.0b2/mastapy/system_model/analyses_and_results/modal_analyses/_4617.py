...
from mastapy.system_model.analyses_and_results.modal_analyses import _4616, _4615, _4525
...
class SpiralBevelGearSetModalAnalysis(_4525.BevelGearSetModalAnalysis):
    """SpiralBevelGearSetModalAnalysis
    ...
    @property
    def spiral_bevel_gears_modal_analysis(self) -> 'List[_4616.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis(self) -> 'List[_4615.SpiralBevelGearMeshModalAnalysis]':
