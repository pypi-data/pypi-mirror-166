...
class ZerolBevelGearCompoundModalAnalysis(_4676.BevelGearCompoundModalAnalysis):
    """ZerolBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4646.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4646.ZerolBevelGearModalAnalysis]':
