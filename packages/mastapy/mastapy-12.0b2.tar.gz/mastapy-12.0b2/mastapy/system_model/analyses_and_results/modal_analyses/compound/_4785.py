...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4783, _4784, _4720
...
class WormGearSetCompoundModalAnalysis(_4720.GearSetCompoundModalAnalysis):
    """WormGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4644.WormGearSetModalAnalysis]':
    ...
    @property
    def worm_gears_compound_modal_analysis(self) -> 'List[_4783.WormGearCompoundModalAnalysis]':
    ...
    @property
    def worm_meshes_compound_modal_analysis(self) -> 'List[_4784.WormGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4644.WormGearSetModalAnalysis]':
