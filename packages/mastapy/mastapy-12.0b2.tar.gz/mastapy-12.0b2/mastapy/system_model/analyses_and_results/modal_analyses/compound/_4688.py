...
class ConceptCouplingHalfCompoundModalAnalysis(_4699.CouplingHalfCompoundModalAnalysis):
    """ConceptCouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4534.ConceptCouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4534.ConceptCouplingHalfModalAnalysis]':
