...
class TorqueConverterTurbineCompoundModalAnalysis(_4699.CouplingHalfCompoundModalAnalysis):
    """TorqueConverterTurbineCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4636.TorqueConverterTurbineModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4636.TorqueConverterTurbineModalAnalysis]':
