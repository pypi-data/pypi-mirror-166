...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4713, _4714, _4720
...
class FaceGearSetCompoundModalAnalysis(_4720.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4565.FaceGearSetModalAnalysis]':
    ...
    @property
    def face_gears_compound_modal_analysis(self) -> 'List[_4713.FaceGearCompoundModalAnalysis]':
    ...
    @property
    def face_meshes_compound_modal_analysis(self) -> 'List[_4714.FaceGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4565.FaceGearSetModalAnalysis]':
