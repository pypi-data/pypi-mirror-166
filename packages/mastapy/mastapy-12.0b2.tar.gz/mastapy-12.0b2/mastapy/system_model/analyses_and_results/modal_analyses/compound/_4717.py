...
class FlexiblePinAssemblyCompoundModalAnalysis(_4758.SpecialisedAssemblyCompoundModalAnalysis):
    """FlexiblePinAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4567.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4567.FlexiblePinAssemblyModalAnalysis]':
