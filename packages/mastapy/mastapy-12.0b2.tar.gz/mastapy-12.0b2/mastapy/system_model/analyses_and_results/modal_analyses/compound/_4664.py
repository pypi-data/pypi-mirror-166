...
class AGMAGleasonConicalGearCompoundModalAnalysis(_4692.ConicalGearCompoundModalAnalysis):
    """AGMAGleasonConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4512.AGMAGleasonConicalGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4512.AGMAGleasonConicalGearModalAnalysis]':
