...
class MeasurementComponentCompoundModalAnalysis(_4782.VirtualComponentCompoundModalAnalysis):
    """MeasurementComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4587.MeasurementComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4587.MeasurementComponentModalAnalysis]':
