...
class CouplingCompoundModalAnalysis(_4758.SpecialisedAssemblyCompoundModalAnalysis):
    """CouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4547.CouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4547.CouplingModalAnalysis]':
