...
from mastapy.system_model.analyses_and_results.modal_analyses import _4581, _4580, _4579
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysis(_4579.KlingelnbergCycloPalloidConicalGearSetModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetModalAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis(self) -> 'List[_4581.KlingelnbergCycloPalloidHypoidGearModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis(self) -> 'List[_4580.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
