...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysis(_4695.ConnectionCompoundModalAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4510.AbstractShaftToMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4510.AbstractShaftToMountableComponentConnectionModalAnalysis]':
