...
class ClutchHalfCompoundModalAnalysis(_4699.CouplingHalfCompoundModalAnalysis):
    """ClutchHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4529.ClutchHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4529.ClutchHalfModalAnalysis]':
