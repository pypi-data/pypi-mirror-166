...
class TorqueConverterConnectionCompoundModalAnalysis(_4698.CouplingConnectionCompoundModalAnalysis):
    """TorqueConverterConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4633.TorqueConverterConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4633.TorqueConverterConnectionModalAnalysis]':
