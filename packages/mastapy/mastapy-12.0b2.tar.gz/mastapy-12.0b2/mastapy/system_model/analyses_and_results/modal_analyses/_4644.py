...
from mastapy.system_model.analyses_and_results.modal_analyses import _4643, _4642, _4571
...
class WormGearSetModalAnalysis(_4571.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_4643.WormGearModalAnalysis]':
    ...
    @property
    def worm_meshes_modal_analysis(self) -> 'List[_4642.WormGearMeshModalAnalysis]':
