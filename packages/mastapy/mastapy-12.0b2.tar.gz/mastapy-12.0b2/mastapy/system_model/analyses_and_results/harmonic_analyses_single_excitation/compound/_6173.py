...
class SynchroniserCompoundHarmonicAnalysisOfSingleExcitation(_6158.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """SynchroniserCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6045.SynchroniserHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6045.SynchroniserHarmonicAnalysisOfSingleExcitation]':
