...
class CVTPulleyCompoundHarmonicAnalysisOfSingleExcitation(_6148.PulleyCompoundHarmonicAnalysisOfSingleExcitation):
    """CVTPulleyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5972.CVTPulleyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5972.CVTPulleyHarmonicAnalysisOfSingleExcitation]':
