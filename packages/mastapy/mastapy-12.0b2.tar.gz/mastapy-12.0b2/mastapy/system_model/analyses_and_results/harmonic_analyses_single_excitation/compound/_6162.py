...
class SpringDamperCompoundHarmonicAnalysisOfSingleExcitation(_6097.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """SpringDamperCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6035.SpringDamperHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6035.SpringDamperHarmonicAnalysisOfSingleExcitation]':
