...
class FaceGearCompoundHarmonicAnalysisOfSingleExcitation(_6118.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """FaceGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5983.FaceGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5983.FaceGearHarmonicAnalysisOfSingleExcitation]':
