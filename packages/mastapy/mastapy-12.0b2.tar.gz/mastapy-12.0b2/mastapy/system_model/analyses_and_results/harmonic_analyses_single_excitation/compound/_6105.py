...
class CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation(_6061.AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation):
    """CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5975.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5975.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
