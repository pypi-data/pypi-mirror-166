...
class PowerLoadCompoundHarmonicAnalysisOfSingleExcitation(_6182.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """PowerLoadCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6018.PowerLoadHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6018.PowerLoadHarmonicAnalysisOfSingleExcitation]':
