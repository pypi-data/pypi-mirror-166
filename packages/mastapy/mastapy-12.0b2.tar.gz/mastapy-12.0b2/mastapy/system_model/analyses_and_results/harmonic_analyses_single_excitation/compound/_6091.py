...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _6089, _6090, _6120
...
class ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6120.GearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5961.ConceptGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_gears_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6089.ConceptGearCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_meshes_compound_harmonic_analysis_of_single_excitation(self) -> 'List[_6090.ConceptGearMeshCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5961.ConceptGearSetHarmonicAnalysisOfSingleExcitation]':
