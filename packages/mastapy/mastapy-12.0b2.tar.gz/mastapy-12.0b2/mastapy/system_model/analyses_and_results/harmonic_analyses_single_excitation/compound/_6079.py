...
class BoltCompoundHarmonicAnalysisOfSingleExcitation(_6085.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """BoltCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5950.BoltHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5950.BoltHarmonicAnalysisOfSingleExcitation]':
