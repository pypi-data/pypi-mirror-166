...
class PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6109.CylindricalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6015.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6015.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]':
