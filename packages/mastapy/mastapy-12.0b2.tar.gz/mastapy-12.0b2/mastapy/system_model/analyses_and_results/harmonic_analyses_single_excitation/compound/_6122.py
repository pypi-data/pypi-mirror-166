...
class HypoidGearCompoundHarmonicAnalysisOfSingleExcitation(_6064.AGMAGleasonConicalGearCompoundHarmonicAnalysisOfSingleExcitation):
    """HypoidGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5993.HypoidGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5993.HypoidGearHarmonicAnalysisOfSingleExcitation]':
