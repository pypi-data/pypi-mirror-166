...
class MountableComponentCompoundHarmonicAnalysisOfSingleExcitation(_6085.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """MountableComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6008.MountableComponentHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6008.MountableComponentHarmonicAnalysisOfSingleExcitation]':
