...
class AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation(_6062.AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation):
    """AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5931.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5931.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
