...
class CVTCompoundHarmonicAnalysisOfSingleExcitation(_6070.BeltDriveCompoundHarmonicAnalysisOfSingleExcitation):
    """CVTCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5971.CVTHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5971.CVTHarmonicAnalysisOfSingleExcitation]':
