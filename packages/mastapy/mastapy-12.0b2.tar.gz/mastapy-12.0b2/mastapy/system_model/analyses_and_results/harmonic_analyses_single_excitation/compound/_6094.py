...
class ConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation(_6120.GearSetCompoundHarmonicAnalysisOfSingleExcitation):
    """ConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5964.ConicalGearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5964.ConicalGearSetHarmonicAnalysisOfSingleExcitation]':
