...
class CVTBeltConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6069.BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """CVTBeltConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5970.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5970.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation]':
