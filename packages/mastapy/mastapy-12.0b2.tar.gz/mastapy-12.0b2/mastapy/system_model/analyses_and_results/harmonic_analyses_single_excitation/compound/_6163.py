...
class SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation(_6098.CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """SpringDamperConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6033.SpringDamperConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6033.SpringDamperConnectionHarmonicAnalysisOfSingleExcitation]':
