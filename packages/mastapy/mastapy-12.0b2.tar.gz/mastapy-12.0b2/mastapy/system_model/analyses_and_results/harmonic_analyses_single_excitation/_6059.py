...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6057, _6058, _5948
...
class ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation(_5948.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6057.ZerolBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6058.ZerolBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
