...
class PartCompoundHarmonicAnalysisOfSingleExcitation(_7463.PartCompoundAnalysis):
    """PartCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6010.PartHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6010.PartHarmonicAnalysisOfSingleExcitation]':
