...
class AbstractAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_6139.PartCompoundHarmonicAnalysisOfSingleExcitation):
    """AbstractAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5930.AbstractAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5930.AbstractAssemblyHarmonicAnalysisOfSingleExcitation]':
