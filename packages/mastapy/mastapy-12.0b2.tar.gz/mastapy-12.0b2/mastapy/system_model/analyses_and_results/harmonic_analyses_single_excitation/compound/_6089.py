...
class ConceptGearCompoundHarmonicAnalysisOfSingleExcitation(_6118.GearCompoundHarmonicAnalysisOfSingleExcitation):
    """ConceptGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5959.ConceptGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5959.ConceptGearHarmonicAnalysisOfSingleExcitation]':
