...
class ComponentCompoundHarmonicAnalysisOfSingleExcitation(_6139.PartCompoundHarmonicAnalysisOfSingleExcitation):
    """ComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5955.ComponentHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5955.ComponentHarmonicAnalysisOfSingleExcitation]':
