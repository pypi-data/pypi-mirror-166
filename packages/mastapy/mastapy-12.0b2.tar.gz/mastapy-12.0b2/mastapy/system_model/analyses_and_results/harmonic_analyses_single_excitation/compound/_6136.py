...
class MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation(_6182.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6007.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6007.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
