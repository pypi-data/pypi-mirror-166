...
class PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation(_6099.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    """PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6012.PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6012.PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation]':
