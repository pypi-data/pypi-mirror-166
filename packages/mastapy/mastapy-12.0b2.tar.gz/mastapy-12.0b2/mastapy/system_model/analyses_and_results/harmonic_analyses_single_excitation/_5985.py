...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5983, _5984, _5990
...
class FaceGearSetHarmonicAnalysisOfSingleExcitation(_5990.GearSetHarmonicAnalysisOfSingleExcitation):
    """FaceGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def face_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5983.FaceGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5984.FaceGearMeshHarmonicAnalysisOfSingleExcitation]':
