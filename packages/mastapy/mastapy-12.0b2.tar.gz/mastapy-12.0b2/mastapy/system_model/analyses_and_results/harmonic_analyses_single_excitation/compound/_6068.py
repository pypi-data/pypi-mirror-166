...
class BearingCompoundHarmonicAnalysisOfSingleExcitation(_6096.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    """BearingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5938.BearingHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5938.BearingHarmonicAnalysisOfSingleExcitation]':
