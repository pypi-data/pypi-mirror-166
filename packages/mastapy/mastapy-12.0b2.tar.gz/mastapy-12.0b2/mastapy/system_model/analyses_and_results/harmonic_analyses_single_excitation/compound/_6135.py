...
class MassDiscCompoundHarmonicAnalysisOfSingleExcitation(_6182.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    """MassDiscCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6006.MassDiscHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6006.MassDiscHarmonicAnalysisOfSingleExcitation]':
