...
from mastapy.system_model.analyses_and_results.load_case_groups import _5593
...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6189
...
class WindTurbineCertificationReport(_6189.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2419.RootAssembly':
    ...
    @property
    def extreme_load_case_static_analysis(self) -> '_2739.RootAssemblySystemDeflection':
    ...
    @property
    def ldd_static_analysis(self) -> '_2885.RootAssemblyCompoundSystemDeflection':
    ...
    @property
    def nominal_load_case_static_analysis(self) -> '_2739.RootAssemblySystemDeflection':
