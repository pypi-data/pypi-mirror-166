...
from mastapy.system_model.analyses_and_results.system_deflections import _2697, _2637
...
class FlexiblePinAnalysisConceptLevel(_6190.FlexiblePinAnalysis):
    """FlexiblePinAnalysisConceptLevel
    ...
    @property
    def flexible_pin_extreme_load_case(self) -> '_2697.FlexiblePinAssemblySystemDeflection':
    ...
    @property
    def flexible_pin_nominal_load_case(self) -> '_2697.FlexiblePinAssemblySystemDeflection':
    ...
    @property
    def planet_bearings_in_nominal_load(self) -> 'List[_2637.BearingSystemDeflection]':
