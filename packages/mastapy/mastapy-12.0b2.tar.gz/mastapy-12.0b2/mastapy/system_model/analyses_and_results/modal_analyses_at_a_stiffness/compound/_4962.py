...
class CycloidalAssemblyCompoundModalAnalysisAtAStiffness(_5017.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """CycloidalAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4832.CycloidalAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4832.CycloidalAssemblyModalAnalysisAtAStiffness]':
