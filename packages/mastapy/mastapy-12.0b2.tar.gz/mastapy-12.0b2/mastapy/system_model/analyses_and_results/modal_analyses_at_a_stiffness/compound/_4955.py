...
class ConnectorCompoundModalAnalysisAtAStiffness(_4996.MountableComponentCompoundModalAnalysisAtAStiffness):
    """ConnectorCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4825.ConnectorModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4825.ConnectorModalAnalysisAtAStiffness]':
