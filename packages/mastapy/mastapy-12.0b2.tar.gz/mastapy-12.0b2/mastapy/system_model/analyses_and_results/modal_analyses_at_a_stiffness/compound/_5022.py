...
class SpringDamperConnectionCompoundModalAnalysisAtAStiffness(_4957.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """SpringDamperConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4892.SpringDamperConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4892.SpringDamperConnectionModalAnalysisAtAStiffness]':
