...
class CylindricalGearMeshCompoundModalAnalysisAtAStiffness(_4978.GearMeshCompoundModalAnalysisAtAStiffness):
    """CylindricalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4836.CylindricalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4836.CylindricalGearMeshModalAnalysisAtAStiffness]':
