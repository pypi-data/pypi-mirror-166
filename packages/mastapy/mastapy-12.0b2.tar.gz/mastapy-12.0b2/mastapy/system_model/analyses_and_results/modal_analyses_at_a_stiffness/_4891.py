...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4890, _4889, _4807
...
class SpiralBevelGearSetModalAnalysisAtAStiffness(_4807.BevelGearSetModalAnalysisAtAStiffness):
    """SpiralBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4890.SpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4889.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
