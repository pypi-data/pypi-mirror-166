...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4972, _4973, _4979
...
class FaceGearSetCompoundModalAnalysisAtAStiffness(_4979.GearSetCompoundModalAnalysisAtAStiffness):
    """FaceGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4845.FaceGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4972.FaceGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4973.FaceGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4845.FaceGearSetModalAnalysisAtAStiffness]':
