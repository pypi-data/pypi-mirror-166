...
class CoaxialConnectionCompoundModalAnalysisAtAStiffness(_5016.ShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """CoaxialConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4813.CoaxialConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4813.CoaxialConnectionModalAnalysisAtAStiffness]':
