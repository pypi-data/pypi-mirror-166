...
class BevelDifferentialPlanetGearCompoundModalAnalysisAtAStiffness(_4930.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4803.BevelDifferentialPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4803.BevelDifferentialPlanetGearModalAnalysisAtAStiffness]':
