...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4914, _4913, _4850
...
class WormGearSetModalAnalysisAtAStiffness(_4850.GearSetModalAnalysisAtAStiffness):
    """WormGearSetModalAnalysisAtAStiffness
    ...
    @property
    def worm_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4914.WormGearModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4913.WormGearMeshModalAnalysisAtAStiffness]':
