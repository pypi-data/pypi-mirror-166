...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5045, _5046, _4937
...
class ZerolBevelGearSetCompoundModalAnalysisAtAStiffness(_4937.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """ZerolBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4918.ZerolBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5045.ZerolBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5046.ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4918.ZerolBevelGearSetModalAnalysisAtAStiffness]':
