...
class CycloidalDiscCompoundModalAnalysisAtAStiffness(_4920.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4834.CycloidalDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4834.CycloidalDiscModalAnalysisAtAStiffness]':
