...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4819, _4818, _4850
...
class ConceptGearSetModalAnalysisAtAStiffness(_4850.GearSetModalAnalysisAtAStiffness):
    """ConceptGearSetModalAnalysisAtAStiffness
    ...
    @property
    def concept_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4819.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4818.ConceptGearMeshModalAnalysisAtAStiffness]':
