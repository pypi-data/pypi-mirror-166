...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _5018, _5019, _4937
...
class SpiralBevelGearSetCompoundModalAnalysisAtAStiffness(_4937.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4891.SpiralBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5018.SpiralBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_5019.SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4891.SpiralBevelGearSetModalAnalysisAtAStiffness]':
