...
class ExternalCADModelCompoundModalAnalysisAtAStiffness(_4944.ComponentCompoundModalAnalysisAtAStiffness):
    """ExternalCADModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4842.ExternalCADModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4842.ExternalCADModelModalAnalysisAtAStiffness]':
