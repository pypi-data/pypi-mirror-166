...
class PartToPartShearCouplingCompoundModalAnalysisAtAStiffness(_4956.CouplingCompoundModalAnalysisAtAStiffness):
    """PartToPartShearCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4872.PartToPartShearCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4872.PartToPartShearCouplingModalAnalysisAtAStiffness]':
