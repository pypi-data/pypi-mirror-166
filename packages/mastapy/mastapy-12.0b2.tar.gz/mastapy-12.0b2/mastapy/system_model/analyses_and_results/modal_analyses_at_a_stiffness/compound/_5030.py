...
class StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness(_5024.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4901.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4901.StraightBevelPlanetGearModalAnalysisAtAStiffness]':
