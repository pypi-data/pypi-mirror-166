...
class AbstractShaftCompoundModalAnalysisAtAStiffness(_4921.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    """AbstractShaftCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4790.AbstractShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4790.AbstractShaftModalAnalysisAtAStiffness]':
