...
class ConicalGearMeshCompoundModalAnalysisAtAStiffness(_4978.GearMeshCompoundModalAnalysisAtAStiffness):
    """ConicalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4821.ConicalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4821.ConicalGearMeshModalAnalysisAtAStiffness]':
