...
class AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness(_4953.ConicalGearSetCompoundModalAnalysisAtAStiffness):
    """AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4795.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4795.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness]':
