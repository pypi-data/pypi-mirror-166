...
class PlanetaryGearSetCompoundModalAnalysisAtAStiffness(_4968.CylindricalGearSetCompoundModalAnalysisAtAStiffness):
    """PlanetaryGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4874.PlanetaryGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4874.PlanetaryGearSetModalAnalysisAtAStiffness]':
