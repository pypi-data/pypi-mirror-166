...
class ConceptGearCompoundModalAnalysisAtAStiffness(_4977.GearCompoundModalAnalysisAtAStiffness):
    """ConceptGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4819.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4819.ConceptGearModalAnalysisAtAStiffness]':
