...
class BeltDriveCompoundModalAnalysisAtAStiffness(_5017.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """BeltDriveCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4799.BeltDriveModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4799.BeltDriveModalAnalysisAtAStiffness]':
