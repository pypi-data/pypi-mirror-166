...
class PlanetCarrierCompoundModalAnalysisAtAStiffness(_4996.MountableComponentCompoundModalAnalysisAtAStiffness):
    """PlanetCarrierCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4875.PlanetCarrierModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4875.PlanetCarrierModalAnalysisAtAStiffness]':
