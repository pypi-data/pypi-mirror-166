...
class CVTBeltConnectionCompoundModalAnalysisAtAStiffness(_4928.BeltConnectionCompoundModalAnalysisAtAStiffness):
    """CVTBeltConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4829.CVTBeltConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4829.CVTBeltConnectionModalAnalysisAtAStiffness]':
