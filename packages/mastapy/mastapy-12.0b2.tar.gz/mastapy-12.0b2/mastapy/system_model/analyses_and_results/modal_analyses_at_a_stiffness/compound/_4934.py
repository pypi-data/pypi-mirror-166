...
class BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness(_4930.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4804.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4804.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
