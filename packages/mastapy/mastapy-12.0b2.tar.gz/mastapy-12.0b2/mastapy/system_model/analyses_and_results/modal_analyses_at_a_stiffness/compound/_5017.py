...
class SpecialisedAssemblyCompoundModalAnalysisAtAStiffness(_4919.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    """SpecialisedAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4888.SpecialisedAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4888.SpecialisedAssemblyModalAnalysisAtAStiffness]':
