...
class RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness(_4984.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4880.RingPinsToDiscConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4880.RingPinsToDiscConnectionModalAnalysisAtAStiffness]':
