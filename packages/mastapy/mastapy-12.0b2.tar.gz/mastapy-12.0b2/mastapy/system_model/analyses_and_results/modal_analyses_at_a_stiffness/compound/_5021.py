...
class SpringDamperCompoundModalAnalysisAtAStiffness(_4956.CouplingCompoundModalAnalysisAtAStiffness):
    """SpringDamperCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4894.SpringDamperModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4894.SpringDamperModalAnalysisAtAStiffness]':
