...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4837, _4836, _4850
...
class CylindricalGearSetModalAnalysisAtAStiffness(_4850.GearSetModalAnalysisAtAStiffness):
    """CylindricalGearSetModalAnalysisAtAStiffness
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4837.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4836.CylindricalGearMeshModalAnalysisAtAStiffness]':
