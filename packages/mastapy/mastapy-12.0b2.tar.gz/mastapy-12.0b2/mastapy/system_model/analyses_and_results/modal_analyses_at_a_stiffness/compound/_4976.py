...
class FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness(_5017.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4847.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4847.FlexiblePinAssemblyModalAnalysisAtAStiffness]':
