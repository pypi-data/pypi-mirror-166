...
class TorqueConverterConnectionCompoundModalAnalysisAtAStiffness(_4957.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """TorqueConverterConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4907.TorqueConverterConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4907.TorqueConverterConnectionModalAnalysisAtAStiffness]':
