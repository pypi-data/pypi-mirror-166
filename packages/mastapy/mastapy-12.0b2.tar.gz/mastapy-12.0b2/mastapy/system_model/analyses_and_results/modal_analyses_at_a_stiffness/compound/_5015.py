...
class ShaftHubConnectionCompoundModalAnalysisAtAStiffness(_4955.ConnectorCompoundModalAnalysisAtAStiffness):
    """ShaftHubConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4885.ShaftHubConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4885.ShaftHubConnectionModalAnalysisAtAStiffness]':
