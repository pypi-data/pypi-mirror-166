...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4958
...
class PartToPartShearCouplingHalfCompoundModalAnalysisAtAStiffness(_4958.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """PartToPartShearCouplingHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4871.PartToPartShearCouplingHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4871.PartToPartShearCouplingHalfModalAnalysisAtAStiffness]':
