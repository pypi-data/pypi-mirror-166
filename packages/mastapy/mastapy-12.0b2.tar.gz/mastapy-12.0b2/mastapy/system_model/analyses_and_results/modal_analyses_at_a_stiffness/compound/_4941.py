...
class ClutchConnectionCompoundModalAnalysisAtAStiffness(_4957.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """ClutchConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4810.ClutchConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4810.ClutchConnectionModalAnalysisAtAStiffness]':
