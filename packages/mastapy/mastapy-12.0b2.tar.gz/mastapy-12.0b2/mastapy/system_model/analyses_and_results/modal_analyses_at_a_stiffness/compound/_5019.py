...
class SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness(_4936.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4889.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4889.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
