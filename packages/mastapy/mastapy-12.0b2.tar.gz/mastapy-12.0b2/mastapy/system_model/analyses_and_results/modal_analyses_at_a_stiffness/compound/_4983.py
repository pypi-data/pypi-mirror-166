...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4981, _4982, _4925
...
class HypoidGearSetCompoundModalAnalysisAtAStiffness(_4925.AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness):
    """HypoidGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4854.HypoidGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4981.HypoidGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4982.HypoidGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4854.HypoidGearSetModalAnalysisAtAStiffness]':
