...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4966, _4967, _4979
...
class CylindricalGearSetCompoundModalAnalysisAtAStiffness(_4979.GearSetCompoundModalAnalysisAtAStiffness):
    """CylindricalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4838.CylindricalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4966.CylindricalGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4967.CylindricalGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4838.CylindricalGearSetModalAnalysisAtAStiffness]':
