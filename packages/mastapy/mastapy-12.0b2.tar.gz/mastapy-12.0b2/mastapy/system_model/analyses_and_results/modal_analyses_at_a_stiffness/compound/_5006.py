...
class PowerLoadCompoundModalAnalysisAtAStiffness(_5041.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PowerLoadCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4877.PowerLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4877.PowerLoadModalAnalysisAtAStiffness]':
