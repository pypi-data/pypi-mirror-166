...
class CylindricalPlanetGearCompoundModalAnalysisAtAStiffness(_4966.CylindricalGearCompoundModalAnalysisAtAStiffness):
    """CylindricalPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4839.CylindricalPlanetGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4839.CylindricalPlanetGearModalAnalysisAtAStiffness]':
