...
class AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness(_4951.ConicalGearCompoundModalAnalysisAtAStiffness):
    """AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4794.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4794.AGMAGleasonConicalGearModalAnalysisAtAStiffness]':
