...
class AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness(_4952.ConicalGearMeshCompoundModalAnalysisAtAStiffness):
    """AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4793.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4793.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness]':
