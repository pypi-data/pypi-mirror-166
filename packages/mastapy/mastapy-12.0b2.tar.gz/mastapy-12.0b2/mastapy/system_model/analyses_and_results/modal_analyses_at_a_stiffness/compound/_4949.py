...
class ConceptGearMeshCompoundModalAnalysisAtAStiffness(_4978.GearMeshCompoundModalAnalysisAtAStiffness):
    """ConceptGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4818.ConceptGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4818.ConceptGearMeshModalAnalysisAtAStiffness]':
