...
class ShaftCompoundModalAnalysisAtAStiffness(_4920.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """ShaftCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4886.ShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4886.ShaftModalAnalysisAtAStiffness]':
