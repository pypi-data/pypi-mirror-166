...
class SpringDamperHalfCompoundModalAnalysisAtAStiffness(_4958.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """SpringDamperHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4893.SpringDamperHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4893.SpringDamperHalfModalAnalysisAtAStiffness]':
