...
class PartCompoundModalAnalysisAtAStiffness(_7463.PartCompoundAnalysis):
    """PartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4869.PartModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4869.PartModalAnalysisAtAStiffness]':
