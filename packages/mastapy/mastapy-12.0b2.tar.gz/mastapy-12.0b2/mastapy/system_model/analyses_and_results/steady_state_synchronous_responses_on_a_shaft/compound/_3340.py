...
class ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft(_3351.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    """ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3212.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3212.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
