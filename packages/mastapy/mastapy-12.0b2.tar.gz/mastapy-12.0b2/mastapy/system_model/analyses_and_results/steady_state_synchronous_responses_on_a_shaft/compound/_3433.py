...
class TorqueConverterPumpCompoundSteadyStateSynchronousResponseOnAShaft(_3353.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    """TorqueConverterPumpCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3303.TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3303.TorqueConverterPumpSteadyStateSynchronousResponseOnAShaft]':
