...
class CVTCompoundSteadyStateSynchronousResponseOnAShaft(_3324.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft):
    """CVTCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3226.CVTSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3226.CVTSteadyStateSynchronousResponseOnAShaft]':
