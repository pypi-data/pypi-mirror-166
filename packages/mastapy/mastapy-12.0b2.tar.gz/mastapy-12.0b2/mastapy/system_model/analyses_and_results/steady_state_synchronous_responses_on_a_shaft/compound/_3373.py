...
class GearMeshCompoundSteadyStateSynchronousResponseOnAShaft(_3379.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """GearMeshCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3242.GearMeshSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3242.GearMeshSteadyStateSynchronousResponseOnAShaft]':
