...
class AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft(_3316.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft):
    """AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3186.AbstractShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3186.AbstractShaftSteadyStateSynchronousResponseOnAShaft]':
