...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3310, _3308, _3243
...
class WormGearSetSteadyStateSynchronousResponseOnAShaft(_3243.GearSetSteadyStateSynchronousResponseOnAShaft):
    """WormGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def worm_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3310.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3308.WormGearMeshSteadyStateSynchronousResponseOnAShaft]':
