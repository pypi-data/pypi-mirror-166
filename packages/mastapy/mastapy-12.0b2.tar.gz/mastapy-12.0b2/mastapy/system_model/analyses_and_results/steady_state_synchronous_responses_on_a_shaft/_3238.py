...
class FaceGearSetSteadyStateSynchronousResponseOnAShaft(_3243.GearSetSteadyStateSynchronousResponseOnAShaft):
    """FaceGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def face_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3239.FaceGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def face_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3237.FaceGearMeshSteadyStateSynchronousResponseOnAShaft]':
