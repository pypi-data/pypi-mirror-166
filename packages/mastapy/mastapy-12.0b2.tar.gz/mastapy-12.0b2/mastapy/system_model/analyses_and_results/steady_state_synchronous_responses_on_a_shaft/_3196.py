...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3197, _3195, _3201
...
class BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft(_3201.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3197.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3195.BevelDifferentialGearMeshSteadyStateSynchronousResponseOnAShaft]':
