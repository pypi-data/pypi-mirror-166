...
class RollingRingCompoundSteadyStateSynchronousResponseOnAShaft(_3353.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    """RollingRingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3277.RollingRingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3277.RollingRingSteadyStateSynchronousResponseOnAShaft]':
