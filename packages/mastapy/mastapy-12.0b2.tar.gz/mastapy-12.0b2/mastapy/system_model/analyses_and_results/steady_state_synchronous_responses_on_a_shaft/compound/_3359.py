...
class CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft(_3315.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    """CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3230.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3230.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]':
