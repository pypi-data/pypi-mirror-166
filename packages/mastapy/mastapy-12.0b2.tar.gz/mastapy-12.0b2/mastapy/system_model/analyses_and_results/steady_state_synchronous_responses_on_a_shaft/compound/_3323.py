...
class BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3379.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3193.BeltConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3193.BeltConnectionSteadyStateSynchronousResponseOnAShaft]':
