...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3352
...
class TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3352.CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2297.TorqueConverterConnection':
    ...
    @property
    def connection_design(self) -> '_2297.TorqueConverterConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3302.TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3302.TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft]':
