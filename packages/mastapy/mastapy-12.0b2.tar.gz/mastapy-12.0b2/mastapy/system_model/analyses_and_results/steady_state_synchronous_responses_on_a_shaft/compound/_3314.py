...
class AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_3393.PartCompoundSteadyStateSynchronousResponseOnAShaft):
    """AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3184.AbstractAssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3184.AbstractAssemblySteadyStateSynchronousResponseOnAShaft]':
