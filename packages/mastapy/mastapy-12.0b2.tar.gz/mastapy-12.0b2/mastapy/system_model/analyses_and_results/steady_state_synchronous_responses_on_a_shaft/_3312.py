...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3313, _3311, _3201
...
class ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft(_3201.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3313.ZerolBevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3311.ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
