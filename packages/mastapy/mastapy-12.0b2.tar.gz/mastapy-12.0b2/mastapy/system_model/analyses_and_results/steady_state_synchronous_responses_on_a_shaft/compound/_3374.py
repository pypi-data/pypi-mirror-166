...
class GearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3412.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """GearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3243.GearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3243.GearSetSteadyStateSynchronousResponseOnAShaft]':
