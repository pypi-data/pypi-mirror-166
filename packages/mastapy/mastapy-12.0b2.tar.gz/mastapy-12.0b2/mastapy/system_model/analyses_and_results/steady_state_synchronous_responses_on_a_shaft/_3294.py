...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3295, _3293, _3201
...
class StraightBevelGearSetSteadyStateSynchronousResponseOnAShaft(_3201.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    """StraightBevelGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def straight_bevel_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3295.StraightBevelGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3293.StraightBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
