...
class BoltCompoundSteadyStateSynchronousResponseOnAShaft(_3339.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """BoltCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3204.BoltSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3204.BoltSteadyStateSynchronousResponseOnAShaft]':
