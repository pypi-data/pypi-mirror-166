...
class PointLoadCompoundSteadyStateSynchronousResponseOnAShaft(_3436.VirtualComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """PointLoadCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3270.PointLoadSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3270.PointLoadSteadyStateSynchronousResponseOnAShaft]':
