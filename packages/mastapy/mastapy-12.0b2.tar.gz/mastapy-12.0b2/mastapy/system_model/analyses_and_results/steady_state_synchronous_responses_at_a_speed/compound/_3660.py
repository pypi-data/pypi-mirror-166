...
class PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed(_3695.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3530.PowerLoadSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3530.PowerLoadSteadyStateSynchronousResponseAtASpeed]':
