...
class RingPinsCompoundSteadyStateSynchronousResponseAtASpeed(_3650.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """RingPinsCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3532.RingPinsSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3532.RingPinsSteadyStateSynchronousResponseAtASpeed]':
