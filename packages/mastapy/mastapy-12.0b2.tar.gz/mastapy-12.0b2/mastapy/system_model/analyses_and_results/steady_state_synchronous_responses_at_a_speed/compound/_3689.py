...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed(_3688.SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed):
    """SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3559.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3559.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
