...
class ComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3652.PartCompoundSteadyStateSynchronousResponseAtASpeed):
    """ComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3468.ComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3468.ComponentSteadyStateSynchronousResponseAtASpeed]':
