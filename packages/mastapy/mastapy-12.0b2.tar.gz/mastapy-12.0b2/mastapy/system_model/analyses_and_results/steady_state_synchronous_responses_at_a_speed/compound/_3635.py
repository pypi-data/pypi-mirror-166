...
class HypoidGearCompoundSteadyStateSynchronousResponseAtASpeed(_3577.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    """HypoidGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3507.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3507.HypoidGearSteadyStateSynchronousResponseAtASpeed]':
