...
class MassDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3695.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """MassDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3518.MassDiscSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3518.MassDiscSteadyStateSynchronousResponseAtASpeed]':
