...
class FaceGearCompoundSteadyStateSynchronousResponseAtASpeed(_3631.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """FaceGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3498.FaceGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3498.FaceGearSteadyStateSynchronousResponseAtASpeed]':
