...
class MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3598.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3520.MountableComponentSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3520.MountableComponentSteadyStateSynchronousResponseAtASpeed]':
