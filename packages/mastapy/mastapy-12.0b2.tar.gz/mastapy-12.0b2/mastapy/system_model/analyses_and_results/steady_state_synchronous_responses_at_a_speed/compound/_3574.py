...
class AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed(_3575.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed):
    """AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3445.AbstractShaftSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3445.AbstractShaftSteadyStateSynchronousResponseAtASpeed]':
