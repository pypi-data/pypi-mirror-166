...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3544, _3542, _3460
...
class SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed(_3460.BevelGearSetSteadyStateSynchronousResponseAtASpeed):
    """SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def spiral_bevel_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3544.SpiralBevelGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spiral_bevel_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3542.SpiralBevelGearMeshSteadyStateSynchronousResponseAtASpeed]':
