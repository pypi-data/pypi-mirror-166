...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import (
    _3581, _3583, _3586, _3593,
    _3592, _3614, _3594, _3599,
    _3604, _3616, _3618, _3622,
    _3629, _3628, _3630, _3637,
    _3644, _3647, _3648, _3649,
    _3651, _3653, _3658, _3659,
    _3660, _3662, _3664, _3669,
    _3668, _3674, _3675, _3680,
    _3683, _3686, _3690, _3694,
    _3698, _3701, _3573
)
...
class AssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3573.AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """AssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3450.AssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bearings(self) -> 'List[_3581.BearingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_3583.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3586.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3593.BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_3592.BoltCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_3614.CVTCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_3594.ClutchCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3599.ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3604.ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3616.CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3618.CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3622.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_3629.FEPartCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3628.FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3630.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3637.HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3644.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3647.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_3648.MassDiscCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_3649.MeasurementComponentCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_3651.OilSealCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3653.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3658.PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_3659.PointLoadCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_3660.PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_3662.RingPinsCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3664.RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3669.ShaftHubConnectionCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_3668.ShaftCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3674.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3675.SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3680.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3683.StraightBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_3686.SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_3690.TorqueConverterCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3694.UnbalancedMassCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3698.WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3701.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3450.AssemblySteadyStateSynchronousResponseAtASpeed]':
