...
class CoaxialConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3670.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """CoaxialConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3467.CoaxialConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3467.CoaxialConnectionSteadyStateSynchronousResponseAtASpeed]':
