...
class BevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3579.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """BevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3460.BevelGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3460.BevelGearSetSteadyStateSynchronousResponseAtASpeed]':
