...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3474, _3472, _3502
...
class ConceptGearSetSteadyStateSynchronousResponseAtASpeed(_3502.GearSetSteadyStateSynchronousResponseAtASpeed):
    """ConceptGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def concept_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3474.ConceptGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3472.ConceptGearMeshSteadyStateSynchronousResponseAtASpeed]':
