...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3626, _3627, _3633
...
class FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3633.GearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    """FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3497.FaceGearSetSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_gears_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3626.FaceGearCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_meshes_compound_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3627.FaceGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3497.FaceGearSetSteadyStateSynchronousResponseAtASpeed]':
