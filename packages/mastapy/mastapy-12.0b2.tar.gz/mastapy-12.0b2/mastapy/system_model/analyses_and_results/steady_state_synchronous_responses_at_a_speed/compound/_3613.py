...
class CVTBeltConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3582.BeltConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """CVTBeltConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3483.CVTBeltConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3483.CVTBeltConnectionSteadyStateSynchronousResponseAtASpeed]':
