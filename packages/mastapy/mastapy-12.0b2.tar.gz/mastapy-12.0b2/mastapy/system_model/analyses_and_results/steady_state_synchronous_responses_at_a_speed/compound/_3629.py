...
class FEPartCompoundSteadyStateSynchronousResponseAtASpeed(_3575.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed):
    """FEPartCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3499.FEPartSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3499.FEPartSteadyStateSynchronousResponseAtASpeed]':
