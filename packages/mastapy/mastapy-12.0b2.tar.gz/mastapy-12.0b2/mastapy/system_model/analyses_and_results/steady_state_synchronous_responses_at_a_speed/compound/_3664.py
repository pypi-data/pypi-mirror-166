...
class RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3671.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3534.RollingRingAssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3534.RollingRingAssemblySteadyStateSynchronousResponseAtASpeed]':
