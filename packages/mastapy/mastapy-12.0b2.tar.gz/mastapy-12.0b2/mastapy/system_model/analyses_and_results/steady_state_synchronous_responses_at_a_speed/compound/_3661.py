...
class PulleyCompoundSteadyStateSynchronousResponseAtASpeed(_3612.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """PulleyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3531.PulleySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3531.PulleySteadyStateSynchronousResponseAtASpeed]':
