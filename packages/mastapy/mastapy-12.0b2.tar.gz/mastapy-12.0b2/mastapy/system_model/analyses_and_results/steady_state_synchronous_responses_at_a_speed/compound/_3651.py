...
class OilSealCompoundSteadyStateSynchronousResponseAtASpeed(_3609.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """OilSealCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3521.OilSealSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3521.OilSealSteadyStateSynchronousResponseAtASpeed]':
