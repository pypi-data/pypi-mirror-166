...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3492, _3490, _3502
...
class CylindricalGearSetSteadyStateSynchronousResponseAtASpeed(_3502.GearSetSteadyStateSynchronousResponseAtASpeed):
    """CylindricalGearSetSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3492.CylindricalGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response_at_a_speed(self) -> 'List[_3490.CylindricalGearMeshSteadyStateSynchronousResponseAtASpeed]':
