...
class TorqueConverterPumpCompoundSteadyStateSynchronousResponseAtASpeed(_3612.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """TorqueConverterPumpCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3562.TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3562.TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed]':
