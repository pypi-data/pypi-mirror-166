...
class AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis(_5490.ConicalGearCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5311.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5311.AGMAGleasonConicalGearMultibodyDynamicsAnalysis]':
