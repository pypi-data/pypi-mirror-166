...
class GearMeshCompoundMultibodyDynamicsAnalysis(_5523.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """GearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5367.GearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5367.GearMeshMultibodyDynamicsAnalysis]':
