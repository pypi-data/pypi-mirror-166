...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5497
...
class PartToPartShearCouplingHalfCompoundMultibodyDynamicsAnalysis(_5497.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5398.PartToPartShearCouplingHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5398.PartToPartShearCouplingHalfMultibodyDynamicsAnalysis]':
