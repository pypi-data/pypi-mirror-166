...
class ConicalGearCompoundMultibodyDynamicsAnalysis(_5516.GearCompoundMultibodyDynamicsAnalysis):
    """ConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5342.ConicalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5342.ConicalGearMultibodyDynamicsAnalysis]':
