...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5429, _5428, _5326
...
class StraightBevelGearSetMultibodyDynamicsAnalysis(_5326.BevelGearSetMultibodyDynamicsAnalysis):
    """StraightBevelGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5429.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gears_multibody_dynamics_analysis(self) -> 'List[_5429.StraightBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_meshes_multibody_dynamics_analysis(self) -> 'List[_5428.StraightBevelGearMeshMultibodyDynamicsAnalysis]':
