...
class VirtualComponentCompoundMultibodyDynamicsAnalysis(_5535.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """VirtualComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5444.VirtualComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5444.VirtualComponentMultibodyDynamicsAnalysis]':
