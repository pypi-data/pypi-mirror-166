...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5461
...
class CycloidalDiscPlanetaryBearingConnectionCompoundMultibodyDynamicsAnalysis(_5461.AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscPlanetaryBearingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5355.CycloidalDiscPlanetaryBearingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5355.CycloidalDiscPlanetaryBearingConnectionMultibodyDynamicsAnalysis]':
