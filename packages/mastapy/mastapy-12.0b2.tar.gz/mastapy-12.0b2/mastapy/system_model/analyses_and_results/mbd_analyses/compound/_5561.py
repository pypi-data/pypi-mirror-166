...
class SpringDamperConnectionCompoundMultibodyDynamicsAnalysis(_5496.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """SpringDamperConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5422.SpringDamperConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5422.SpringDamperConnectionMultibodyDynamicsAnalysis]':
