...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5505, _5506, _5518
...
class CylindricalGearSetCompoundMultibodyDynamicsAnalysis(_5518.GearSetCompoundMultibodyDynamicsAnalysis):
    """CylindricalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5358.CylindricalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5505.CylindricalGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5506.CylindricalGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5358.CylindricalGearSetMultibodyDynamicsAnalysis]':
