...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5566, _5567, _5476
...
class StraightBevelGearSetCompoundMultibodyDynamicsAnalysis(_5476.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """StraightBevelGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5430.StraightBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5566.StraightBevelGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5567.StraightBevelGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5430.StraightBevelGearSetMultibodyDynamicsAnalysis]':
