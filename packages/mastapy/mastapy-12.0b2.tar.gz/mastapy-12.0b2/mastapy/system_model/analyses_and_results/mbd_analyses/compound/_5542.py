...
class PlanetaryGearSetCompoundMultibodyDynamicsAnalysis(_5507.CylindricalGearSetCompoundMultibodyDynamicsAnalysis):
    """PlanetaryGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5401.PlanetaryGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5401.PlanetaryGearSetMultibodyDynamicsAnalysis]':
