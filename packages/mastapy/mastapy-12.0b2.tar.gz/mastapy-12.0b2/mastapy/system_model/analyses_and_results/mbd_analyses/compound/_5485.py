...
class ConceptCouplingConnectionCompoundMultibodyDynamicsAnalysis(_5496.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    """ConceptCouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5335.ConceptCouplingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5335.ConceptCouplingConnectionMultibodyDynamicsAnalysis]':
