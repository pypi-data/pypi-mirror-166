...
class PointLoadCompoundMultibodyDynamicsAnalysis(_5580.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """PointLoadCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5403.PointLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5403.PointLoadMultibodyDynamicsAnalysis]':
