...
class MountableComponentCompoundMultibodyDynamicsAnalysis(_5483.ComponentCompoundMultibodyDynamicsAnalysis):
    """MountableComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5394.MountableComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5394.MountableComponentMultibodyDynamicsAnalysis]':
