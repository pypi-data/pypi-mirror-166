...
class ConicalGearMeshCompoundMultibodyDynamicsAnalysis(_5517.GearMeshCompoundMultibodyDynamicsAnalysis):
    """ConicalGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5341.ConicalGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5341.ConicalGearMeshMultibodyDynamicsAnalysis]':
