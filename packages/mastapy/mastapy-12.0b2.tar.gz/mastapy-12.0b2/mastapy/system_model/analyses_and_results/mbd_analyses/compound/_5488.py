...
class ConceptGearMeshCompoundMultibodyDynamicsAnalysis(_5517.GearMeshCompoundMultibodyDynamicsAnalysis):
    """ConceptGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5338.ConceptGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5338.ConceptGearMeshMultibodyDynamicsAnalysis]':
