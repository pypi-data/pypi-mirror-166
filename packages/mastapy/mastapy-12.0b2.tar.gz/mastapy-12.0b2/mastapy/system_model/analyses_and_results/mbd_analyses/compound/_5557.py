...
class SpiralBevelGearCompoundMultibodyDynamicsAnalysis(_5474.BevelGearCompoundMultibodyDynamicsAnalysis):
    """SpiralBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5420.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5420.SpiralBevelGearMultibodyDynamicsAnalysis]':
