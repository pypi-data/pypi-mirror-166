...
class PartCompoundMultibodyDynamicsAnalysis(_7463.PartCompoundAnalysis):
    """PartCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5396.PartMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5396.PartMultibodyDynamicsAnalysis]':
