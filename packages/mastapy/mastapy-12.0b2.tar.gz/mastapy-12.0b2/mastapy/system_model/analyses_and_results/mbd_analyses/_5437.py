...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5441, _5346
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5346.CouplingConnectionMultibodyDynamicsAnalysis):
    """TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5441.TorqueConverterStatus':
        ...
        return constructor.new_from_mastapy_type(_5441.TorqueConverterStatus)(value) if value is not None else None
    ...
    @property
    def connection_load_case(self) -> '_6891.TorqueConverterConnectionLoadCase':
