...
class FEPartCompoundMultibodyDynamicsAnalysis(_5460.AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis):
    """FEPartCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5365.FEPartMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5365.FEPartMultibodyDynamicsAnalysis]':
