...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5469, _5470, _5476
...
class BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis(_5476.BevelGearSetCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5321.BevelDifferentialGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5469.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5470.BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5321.BevelDifferentialGearSetMultibodyDynamicsAnalysis]':
