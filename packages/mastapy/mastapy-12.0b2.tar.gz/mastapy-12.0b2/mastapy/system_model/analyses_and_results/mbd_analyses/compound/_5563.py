...
class StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis(_5474.BevelGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5426.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5426.StraightBevelDiffGearMultibodyDynamicsAnalysis]':
