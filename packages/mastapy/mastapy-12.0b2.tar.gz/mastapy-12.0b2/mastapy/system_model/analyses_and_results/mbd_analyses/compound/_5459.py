...
class AbstractShaftCompoundMultibodyDynamicsAnalysis(_5460.AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis):
    """AbstractShaftCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5307.AbstractShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5307.AbstractShaftMultibodyDynamicsAnalysis]':
