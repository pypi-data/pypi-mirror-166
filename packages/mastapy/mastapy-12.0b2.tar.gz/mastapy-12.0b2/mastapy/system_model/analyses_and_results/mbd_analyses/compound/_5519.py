...
class GuideDxfModelCompoundMultibodyDynamicsAnalysis(_5483.ComponentCompoundMultibodyDynamicsAnalysis):
    """GuideDxfModelCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5371.GuideDxfModelMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5371.GuideDxfModelMultibodyDynamicsAnalysis]':
