...
class ConceptGearCompoundMultibodyDynamicsAnalysis(_5516.GearCompoundMultibodyDynamicsAnalysis):
    """ConceptGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5339.ConceptGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5339.ConceptGearMultibodyDynamicsAnalysis]':
