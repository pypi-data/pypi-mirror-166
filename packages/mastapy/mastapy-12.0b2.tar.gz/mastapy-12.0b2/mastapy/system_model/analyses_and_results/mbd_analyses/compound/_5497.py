...
class CouplingHalfCompoundMultibodyDynamicsAnalysis(_5535.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """CouplingHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5347.CouplingHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5347.CouplingHalfMultibodyDynamicsAnalysis]':
