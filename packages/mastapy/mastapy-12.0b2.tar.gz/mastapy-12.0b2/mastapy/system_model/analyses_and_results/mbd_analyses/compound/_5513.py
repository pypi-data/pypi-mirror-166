...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5511, _5512, _5518
...
class FaceGearSetCompoundMultibodyDynamicsAnalysis(_5518.GearSetCompoundMultibodyDynamicsAnalysis):
    """FaceGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5364.FaceGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5511.FaceGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5512.FaceGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5364.FaceGearSetMultibodyDynamicsAnalysis]':
