...
class BevelGearCompoundMultibodyDynamicsAnalysis(_5462.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis):
    """BevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5325.BevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5325.BevelGearMultibodyDynamicsAnalysis]':
