...
class CVTPulleyCompoundMultibodyDynamicsAnalysis(_5546.PulleyCompoundMultibodyDynamicsAnalysis):
    """CVTPulleyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5351.CVTPulleyMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5351.CVTPulleyMultibodyDynamicsAnalysis]':
