...
class TorqueConverterPumpCompoundMultibodyDynamicsAnalysis(_5497.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """TorqueConverterPumpCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5440.TorqueConverterPumpMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5440.TorqueConverterPumpMultibodyDynamicsAnalysis]':
