...
class FaceGearMeshCompoundMultibodyDynamicsAnalysis(_5517.GearMeshCompoundMultibodyDynamicsAnalysis):
    """FaceGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5362.FaceGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5362.FaceGearMeshMultibodyDynamicsAnalysis]':
