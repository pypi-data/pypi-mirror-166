...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5339, _5338, _5370
...
class ConceptGearSetMultibodyDynamicsAnalysis(_5370.GearSetMultibodyDynamicsAnalysis):
    """ConceptGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5339.ConceptGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gears_multibody_dynamics_analysis(self) -> 'List[_5339.ConceptGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_meshes_multibody_dynamics_analysis(self) -> 'List[_5338.ConceptGearMeshMultibodyDynamicsAnalysis]':
