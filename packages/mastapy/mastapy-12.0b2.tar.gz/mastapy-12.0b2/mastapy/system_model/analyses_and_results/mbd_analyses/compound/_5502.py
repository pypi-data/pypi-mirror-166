...
class CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis(_5482.CoaxialConnectionCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5353.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5353.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
