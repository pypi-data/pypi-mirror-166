...
class ConnectorCompoundMultibodyDynamicsAnalysis(_5535.MountableComponentCompoundMultibodyDynamicsAnalysis):
    """ConnectorCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5345.ConnectorMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5345.ConnectorMultibodyDynamicsAnalysis]':
