...
class BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis(_5469.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5322.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5322.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
