...
class FaceGearCompoundMultibodyDynamicsAnalysis(_5516.GearCompoundMultibodyDynamicsAnalysis):
    """FaceGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5363.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5363.FaceGearMultibodyDynamicsAnalysis]':
