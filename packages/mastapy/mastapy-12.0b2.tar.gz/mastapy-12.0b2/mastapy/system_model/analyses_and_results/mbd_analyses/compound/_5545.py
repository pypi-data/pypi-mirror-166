...
class PowerLoadCompoundMultibodyDynamicsAnalysis(_5580.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    """PowerLoadCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5404.PowerLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5404.PowerLoadMultibodyDynamicsAnalysis]':
