...
class WormGearMeshCompoundMultibodyDynamicsAnalysis(_5517.GearMeshCompoundMultibodyDynamicsAnalysis):
    """WormGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5446.WormGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5446.WormGearMeshMultibodyDynamicsAnalysis]':
