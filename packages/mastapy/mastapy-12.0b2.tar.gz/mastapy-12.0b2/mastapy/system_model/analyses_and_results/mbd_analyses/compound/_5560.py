...
class SpringDamperCompoundMultibodyDynamicsAnalysis(_5495.CouplingCompoundMultibodyDynamicsAnalysis):
    """SpringDamperCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5424.SpringDamperMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5424.SpringDamperMultibodyDynamicsAnalysis]':
