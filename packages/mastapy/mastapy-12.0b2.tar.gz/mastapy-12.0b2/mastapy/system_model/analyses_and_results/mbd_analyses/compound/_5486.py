...
class ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis(_5497.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5336.ConceptCouplingHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5336.ConceptCouplingHalfMultibodyDynamicsAnalysis]':
