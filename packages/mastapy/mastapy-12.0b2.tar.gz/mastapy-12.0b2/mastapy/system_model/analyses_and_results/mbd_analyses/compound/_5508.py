...
class CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis(_5505.CylindricalGearCompoundMultibodyDynamicsAnalysis):
    """CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5359.CylindricalPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5359.CylindricalPlanetGearMultibodyDynamicsAnalysis]':
