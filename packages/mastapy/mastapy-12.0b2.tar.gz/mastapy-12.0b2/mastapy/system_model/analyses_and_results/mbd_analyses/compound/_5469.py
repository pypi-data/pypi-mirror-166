...
class BevelDifferentialGearCompoundMultibodyDynamicsAnalysis(_5474.BevelGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5320.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5320.BevelDifferentialGearMultibodyDynamicsAnalysis]':
