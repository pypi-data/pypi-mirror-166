...
from mastapy.system_model.analyses_and_results import _2583, _2564
...
class TimeSeriesLoadCase(_6723.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5391.MBDAnalysisOptions':
    ...
    @property
    def time_series_load_case_group(self) -> '_5600.TimeSeriesLoadCaseGroup':
    ...
    def duplicate(self, new_load_case_group: '_5600.TimeSeriesLoadCaseGroup', name: Optional['str'] = 'None') -> 'TimeSeriesLoadCase':
