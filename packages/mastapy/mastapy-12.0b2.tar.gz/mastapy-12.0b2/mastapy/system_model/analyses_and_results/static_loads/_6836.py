...
from mastapy.system_model.analyses_and_results.static_loads import _6834, _6835, _6833
...
class KlingelnbergCycloPalloidHypoidGearSetLoadCase(_6833.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    """KlingelnbergCycloPalloidHypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6834.KlingelnbergCycloPalloidHypoidGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_load_case(self) -> 'List[_6834.KlingelnbergCycloPalloidHypoidGearLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_load_case(self) -> 'List[_6835.KlingelnbergCycloPalloidHypoidGearMeshLoadCase]':
