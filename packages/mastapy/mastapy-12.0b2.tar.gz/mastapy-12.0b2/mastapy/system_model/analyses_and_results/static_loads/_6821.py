...
from mastapy.system_model.analyses_and_results.static_loads import _6820, _6799
...
class HarmonicLoadDataImportFromMotorPackages(_6820.HarmonicLoadDataImportBase['T'], Generic[T]):
    """HarmonicLoadDataImportFromMotorPackages
