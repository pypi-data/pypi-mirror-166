...
from mastapy.system_model.analyses_and_results.static_loads import _6904, _6905, _6749
...
class ZerolBevelGearSetLoadCase(_6749.BevelGearSetLoadCase):
    """ZerolBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6904.ZerolBevelGearLoadCase]':
    ...
    @property
    def zerol_bevel_gears_load_case(self) -> 'List[_6904.ZerolBevelGearLoadCase]':
    ...
    @property
    def zerol_bevel_meshes_load_case(self) -> 'List[_6905.ZerolBevelGearMeshLoadCase]':
