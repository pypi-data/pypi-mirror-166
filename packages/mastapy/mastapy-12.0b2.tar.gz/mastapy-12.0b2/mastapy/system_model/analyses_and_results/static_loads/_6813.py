...
class GearSetHarmonicLoadData(_1345.HarmonicLoadDataBase):
    """GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6812.GearMeshTEOrderType':
        ...
        return constructor.new_from_mastapy_type(_6812.GearMeshTEOrderType)(value) if value is not None else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6812.GearMeshTEOrderType'):
