...
from mastapy.system_model.analyses_and_results.static_loads import _6824, _6825, _6735
...
class HypoidGearSetLoadCase(_6735.AGMAGleasonConicalGearSetLoadCase):
    """HypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6824.HypoidGearLoadCase]':
    ...
    @property
    def hypoid_gears_load_case(self) -> 'List[_6824.HypoidGearLoadCase]':
    ...
    @property
    def hypoid_meshes_load_case(self) -> 'List[_6825.HypoidGearMeshLoadCase]':
