...
class PartLoadCase(_2601.PartAnalysis):
    """PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6724.StaticLoadCase':
    ...
    def get_harmonic_load_data_for_import(self) -> '_1345.HarmonicLoadDataBase':
