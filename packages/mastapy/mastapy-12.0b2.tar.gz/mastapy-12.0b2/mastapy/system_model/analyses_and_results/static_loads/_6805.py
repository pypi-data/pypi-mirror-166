...
from mastapy.system_model.analyses_and_results.static_loads import _6803, _6804, _6814
...
class FaceGearSetLoadCase(_6814.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6803.FaceGearLoadCase]':
    ...
    @property
    def face_gears_load_case(self) -> 'List[_6803.FaceGearLoadCase]':
    ...
    @property
    def face_meshes_load_case(self) -> 'List[_6804.FaceGearMeshLoadCase]':
