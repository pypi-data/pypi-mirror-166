...
from mastapy.system_model.analyses_and_results.static_loads import _6901, _6902, _6814
...
class WormGearSetLoadCase(_6814.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6901.WormGearLoadCase]':
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6901.WormGearLoadCase]':
    ...
    @property
    def worm_meshes_load_case(self) -> 'List[_6902.WormGearMeshLoadCase]':
