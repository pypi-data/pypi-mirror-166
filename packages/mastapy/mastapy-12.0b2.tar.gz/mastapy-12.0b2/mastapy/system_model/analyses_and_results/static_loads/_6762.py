...
from mastapy.system_model.analyses_and_results.static_loads import _6760, _6761, _6814
...
class ConceptGearSetLoadCase(_6814.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6760.ConceptGearLoadCase]':
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_6760.ConceptGearLoadCase]':
    ...
    @property
    def concept_meshes_load_case(self) -> 'List[_6761.ConceptGearMeshLoadCase]':
