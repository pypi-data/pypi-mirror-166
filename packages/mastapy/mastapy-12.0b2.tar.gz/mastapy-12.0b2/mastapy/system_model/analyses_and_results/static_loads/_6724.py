...
from mastapy.system_model.analyses_and_results import (
    _2590, _2585, _2565, _2576,
    _2584, _2568, _2587, _2579,
    _2569, _2586, _2567, _2573,
    _2627, _2564
)
...
from mastapy.system_model.analyses_and_results.load_case_groups import _5590, _5591, _5592
from mastapy.system_model.analyses_and_results.static_loads import _6737, _6723
...
class StaticLoadCase(_6723.LoadCase):
    """StaticLoadCase
    ...
    @property
    def system_deflection(self) -> '_2590.SystemDeflectionAnalysis':
    ...
    @property
    def power_flow(self) -> '_2585.PowerFlowAnalysis':
    ...
    @property
    def advanced_system_deflection(self) -> '_2565.AdvancedSystemDeflectionAnalysis':
    ...
    @property
    def parametric_study_tool(self) -> '_2584.ParametricStudyToolAnalysis':
    ...
    @property
    def compound_parametric_study_tool(self) -> '_2568.CompoundParametricStudyToolAnalysis':
    ...
    @property
    def steady_state_synchronous_response(self) -> '_2587.SteadyStateSynchronousResponseAnalysis':
    ...
    @property
    def dynamic_model_for_modal_analysis(self) -> '_2573.DynamicModelForModalAnalysis':
    ...
    @property
    def advanced_system_deflection_options(self) -> '_7192.AdvancedSystemDeflectionOptions':
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5691.HarmonicAnalysisOptions':
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2627.TESetUpForDynamicAnalysisOptions':
    ...
    @property
    def clutch_engagements(self) -> 'List[_5590.ClutchEngagementStatus]':
    ...
    @property
    def concept_clutch_engagements(self) -> 'List[_5591.ConceptSynchroGearEngagementStatus]':
    ...
    @property
    def design_state_load_case_group(self) -> '_5592.DesignState':
    ...
    def analysis_of(self, analysis_type: '_6737.AnalysisType') -> '_2564.SingleAnalysis':
    ...
    def duplicate(self, new_design_state_group: '_5592.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
