...
from mastapy.system_model.analyses_and_results.static_loads import _6764, _6809
...
class ConicalGearLoadCase(_6809.GearLoadCase):
    """ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6764.ConicalGearManufactureError':
