...
class PlanetaryGearSetLoadCase(_6784.CylindricalGearSetLoadCase):
    """PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1552.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1552.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2486.PlanetaryGearSet':
