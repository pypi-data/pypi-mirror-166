...
from mastapy.system_model.analyses_and_results.static_loads import _6790, _6799
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6790.ElectricMachineHarmonicLoadData, Generic[T]):
    """ElectricMachineHarmonicLoadDataFromMotorPackages
