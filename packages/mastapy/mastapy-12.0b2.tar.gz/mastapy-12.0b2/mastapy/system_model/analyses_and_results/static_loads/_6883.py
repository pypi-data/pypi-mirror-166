...
from mastapy.system_model.analyses_and_results.static_loads import _6881, _6882, _6749
...
class StraightBevelGearSetLoadCase(_6749.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6881.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_gears_load_case(self) -> 'List[_6881.StraightBevelGearLoadCase]':
    ...
    @property
    def straight_bevel_meshes_load_case(self) -> 'List[_6882.StraightBevelGearMeshLoadCase]':
