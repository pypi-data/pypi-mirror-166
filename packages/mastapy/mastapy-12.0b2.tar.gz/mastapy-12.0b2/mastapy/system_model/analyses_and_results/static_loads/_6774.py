...
from mastapy.system_model.analyses_and_results.static_loads import _6775, _6741
...
class CVTLoadCase(_6741.BeltDriveLoadCase):
    """CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6775.CVTPulleyLoadCase]':
