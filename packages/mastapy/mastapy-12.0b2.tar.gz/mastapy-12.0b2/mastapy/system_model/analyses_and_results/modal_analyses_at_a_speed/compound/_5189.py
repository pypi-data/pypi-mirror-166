...
class BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed(_5194.BevelGearMeshCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5059.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5059.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
