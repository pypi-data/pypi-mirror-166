...
class MassDiscCompoundModalAnalysisAtASpeed(_5299.VirtualComponentCompoundModalAnalysisAtASpeed):
    """MassDiscCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5123.MassDiscModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5123.MassDiscModalAnalysisAtASpeed]':
