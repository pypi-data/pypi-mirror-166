...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5224, _5225, _5237
...
class CylindricalGearSetCompoundModalAnalysisAtASpeed(_5237.GearSetCompoundModalAnalysisAtASpeed):
    """CylindricalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5097.CylindricalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5224.CylindricalGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5225.CylindricalGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5097.CylindricalGearSetModalAnalysisAtASpeed]':
