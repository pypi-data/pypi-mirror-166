...
class ConnectionCompoundModalAnalysisAtASpeed(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5083.ConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5083.ConnectionModalAnalysisAtASpeed]':
