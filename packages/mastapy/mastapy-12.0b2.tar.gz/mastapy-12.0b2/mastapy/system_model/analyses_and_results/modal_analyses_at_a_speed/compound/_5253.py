...
class MeasurementComponentCompoundModalAnalysisAtASpeed(_5299.VirtualComponentCompoundModalAnalysisAtASpeed):
    """MeasurementComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5124.MeasurementComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5124.MeasurementComponentModalAnalysisAtASpeed]':
