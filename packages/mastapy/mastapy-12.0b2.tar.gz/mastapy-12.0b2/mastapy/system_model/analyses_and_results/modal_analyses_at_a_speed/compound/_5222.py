...
class CycloidalDiscCompoundModalAnalysisAtASpeed(_5178.AbstractShaftCompoundModalAnalysisAtASpeed):
    """CycloidalDiscCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5093.CycloidalDiscModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5093.CycloidalDiscModalAnalysisAtASpeed]':
