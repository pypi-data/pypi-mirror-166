...
class ComponentCompoundModalAnalysisAtASpeed(_5256.PartCompoundModalAnalysisAtASpeed):
    """ComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5073.ComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5073.ComponentModalAnalysisAtASpeed]':
