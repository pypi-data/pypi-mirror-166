...
class BevelDifferentialSunGearCompoundModalAnalysisAtASpeed(_5188.BevelDifferentialGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5063.BevelDifferentialSunGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5063.BevelDifferentialSunGearModalAnalysisAtASpeed]':
