...
class AbstractShaftOrHousingCompoundModalAnalysisAtASpeed(_5202.ComponentCompoundModalAnalysisAtASpeed):
    """AbstractShaftOrHousingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5050.AbstractShaftOrHousingModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5050.AbstractShaftOrHousingModalAnalysisAtASpeed]':
