...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5154, _5153, _5066
...
class StraightBevelDiffGearSetModalAnalysisAtASpeed(_5066.BevelGearSetModalAnalysisAtASpeed):
    """StraightBevelDiffGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_speed(self) -> 'List[_5154.StraightBevelDiffGearModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_speed(self) -> 'List[_5153.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
