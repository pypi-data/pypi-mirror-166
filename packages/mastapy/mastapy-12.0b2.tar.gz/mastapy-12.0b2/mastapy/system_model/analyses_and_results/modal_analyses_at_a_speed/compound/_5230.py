...
class FaceGearCompoundModalAnalysisAtASpeed(_5235.GearCompoundModalAnalysisAtASpeed):
    """FaceGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5102.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5102.FaceGearModalAnalysisAtASpeed]':
