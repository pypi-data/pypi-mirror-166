...
class ConicalGearMeshCompoundModalAnalysisAtASpeed(_5236.GearMeshCompoundModalAnalysisAtASpeed):
    """ConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5080.ConicalGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5080.ConicalGearMeshModalAnalysisAtASpeed]':
