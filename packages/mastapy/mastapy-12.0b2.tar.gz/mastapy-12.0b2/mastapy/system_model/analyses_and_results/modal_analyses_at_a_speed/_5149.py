...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5148, _5147, _5066
...
class SpiralBevelGearSetModalAnalysisAtASpeed(_5066.BevelGearSetModalAnalysisAtASpeed):
    """SpiralBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_5148.SpiralBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_5147.SpiralBevelGearMeshModalAnalysisAtASpeed]':
