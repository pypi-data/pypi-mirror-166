...
class ConceptGearCompoundModalAnalysisAtASpeed(_5235.GearCompoundModalAnalysisAtASpeed):
    """ConceptGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5078.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5078.ConceptGearModalAnalysisAtASpeed]':
