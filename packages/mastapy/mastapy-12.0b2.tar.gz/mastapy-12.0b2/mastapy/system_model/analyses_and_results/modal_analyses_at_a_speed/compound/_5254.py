...
class MountableComponentCompoundModalAnalysisAtASpeed(_5202.ComponentCompoundModalAnalysisAtASpeed):
    """MountableComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5125.MountableComponentModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5125.MountableComponentModalAnalysisAtASpeed]':
