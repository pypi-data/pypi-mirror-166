...
class OilSealCompoundModalAnalysisAtASpeed(_5213.ConnectorCompoundModalAnalysisAtASpeed):
    """OilSealCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5126.OilSealModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5126.OilSealModalAnalysisAtASpeed]':
