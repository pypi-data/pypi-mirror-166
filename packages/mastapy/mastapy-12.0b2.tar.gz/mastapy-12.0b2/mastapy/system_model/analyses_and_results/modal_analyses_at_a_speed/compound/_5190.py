...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5188, _5189, _5195
...
class BevelDifferentialGearSetCompoundModalAnalysisAtASpeed(_5195.BevelGearSetCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5061.BevelDifferentialGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5188.BevelDifferentialGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5189.BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5061.BevelDifferentialGearSetModalAnalysisAtASpeed]':
