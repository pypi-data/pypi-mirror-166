...
class UnbalancedMassCompoundModalAnalysisAtASpeed(_5299.VirtualComponentCompoundModalAnalysisAtASpeed):
    """UnbalancedMassCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5169.UnbalancedMassModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5169.UnbalancedMassModalAnalysisAtASpeed]':
