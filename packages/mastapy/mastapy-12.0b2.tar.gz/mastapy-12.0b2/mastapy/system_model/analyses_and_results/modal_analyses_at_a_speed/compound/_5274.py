...
class ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5180.AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5145.ShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5145.ShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
