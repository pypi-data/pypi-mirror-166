...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5172, _5171, _5108
...
class WormGearSetModalAnalysisAtASpeed(_5108.GearSetModalAnalysisAtASpeed):
    """WormGearSetModalAnalysisAtASpeed
    ...
    @property
    def worm_gears_modal_analysis_at_a_speed(self) -> 'List[_5172.WormGearModalAnalysisAtASpeed]':
    ...
    @property
    def worm_meshes_modal_analysis_at_a_speed(self) -> 'List[_5171.WormGearMeshModalAnalysisAtASpeed]':
