...
class AbstractShaftCompoundModalAnalysisAtASpeed(_5179.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    """AbstractShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5049.AbstractShaftModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5049.AbstractShaftModalAnalysisAtASpeed]':
