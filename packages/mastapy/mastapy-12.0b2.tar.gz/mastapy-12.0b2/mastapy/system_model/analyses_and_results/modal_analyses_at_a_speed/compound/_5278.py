...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5276, _5277, _5195
...
class SpiralBevelGearSetCompoundModalAnalysisAtASpeed(_5195.BevelGearSetCompoundModalAnalysisAtASpeed):
    """SpiralBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5149.SpiralBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5276.SpiralBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5277.SpiralBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5149.SpiralBevelGearSetModalAnalysisAtASpeed]':
