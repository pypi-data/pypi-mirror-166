...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5230, _5231, _5237
...
class FaceGearSetCompoundModalAnalysisAtASpeed(_5237.GearSetCompoundModalAnalysisAtASpeed):
    """FaceGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5103.FaceGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5230.FaceGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def face_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5231.FaceGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5103.FaceGearSetModalAnalysisAtASpeed]':
