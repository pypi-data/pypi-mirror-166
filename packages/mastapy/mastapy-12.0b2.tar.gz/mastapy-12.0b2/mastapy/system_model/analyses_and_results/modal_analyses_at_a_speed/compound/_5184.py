...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
    _5185, _5187, _5190, _5197,
    _5196, _5218, _5198, _5203,
    _5208, _5220, _5222, _5226,
    _5233, _5232, _5234, _5241,
    _5248, _5251, _5252, _5253,
    _5255, _5257, _5262, _5263,
    _5264, _5266, _5268, _5273,
    _5272, _5278, _5279, _5284,
    _5287, _5290, _5294, _5298,
    _5302, _5305, _5177
)
...
class AssemblyCompoundModalAnalysisAtASpeed(_5177.AbstractAssemblyCompoundModalAnalysisAtASpeed):
    """AssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5055.AssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def bearings(self) -> 'List[_5185.BearingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_5187.BeltDriveCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5190.BevelDifferentialGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5197.BoltedJointCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_5196.BoltCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_5218.CVTCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_5198.ClutchCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5203.ConceptCouplingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5208.ConceptGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5220.CycloidalAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5222.CycloidalDiscCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5226.CylindricalGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_5233.FEPartCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5232.FaceGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5234.FlexiblePinAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5241.HypoidGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5248.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5251.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_5252.MassDiscCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_5253.MeasurementComponentCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_5255.OilSealCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5257.PartToPartShearCouplingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5262.PlanetCarrierCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_5263.PointLoadCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_5264.PowerLoadCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_5266.RingPinsCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5268.RollingRingAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5273.ShaftHubConnectionCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_5272.ShaftCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5278.SpiralBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5279.SpringDamperCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5284.StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5287.StraightBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_5290.SynchroniserCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_5294.TorqueConverterCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5298.UnbalancedMassCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5302.WormGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5305.ZerolBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5055.AssemblyModalAnalysisAtASpeed]':
