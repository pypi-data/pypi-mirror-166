...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5102, _5101, _5108
...
class FaceGearSetModalAnalysisAtASpeed(_5108.GearSetModalAnalysisAtASpeed):
    """FaceGearSetModalAnalysisAtASpeed
    ...
    @property
    def face_gears_modal_analysis_at_a_speed(self) -> 'List[_5102.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_speed(self) -> 'List[_5101.FaceGearMeshModalAnalysisAtASpeed]':
