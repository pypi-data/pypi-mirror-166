...
class SpecialisedAssemblyCompoundModalAnalysisAtASpeed(_5177.AbstractAssemblyCompoundModalAnalysisAtASpeed):
    """SpecialisedAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5146.SpecialisedAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5146.SpecialisedAssemblyModalAnalysisAtASpeed]':
