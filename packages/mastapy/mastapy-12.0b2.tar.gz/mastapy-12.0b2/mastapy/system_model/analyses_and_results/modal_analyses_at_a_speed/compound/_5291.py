...
class SynchroniserHalfCompoundModalAnalysisAtASpeed(_5292.SynchroniserPartCompoundModalAnalysisAtASpeed):
    """SynchroniserHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5161.SynchroniserHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5161.SynchroniserHalfModalAnalysisAtASpeed]':
