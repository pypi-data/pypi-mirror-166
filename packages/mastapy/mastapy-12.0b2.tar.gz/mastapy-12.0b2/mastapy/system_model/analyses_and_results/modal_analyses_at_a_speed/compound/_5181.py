...
class AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed(_5209.ConicalGearCompoundModalAnalysisAtASpeed):
    """AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5053.AGMAGleasonConicalGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5053.AGMAGleasonConicalGearModalAnalysisAtASpeed]':
