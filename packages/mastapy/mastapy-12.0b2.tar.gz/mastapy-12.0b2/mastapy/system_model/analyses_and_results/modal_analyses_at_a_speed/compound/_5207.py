...
class ConceptGearMeshCompoundModalAnalysisAtASpeed(_5236.GearMeshCompoundModalAnalysisAtASpeed):
    """ConceptGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5077.ConceptGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5077.ConceptGearMeshModalAnalysisAtASpeed]':
