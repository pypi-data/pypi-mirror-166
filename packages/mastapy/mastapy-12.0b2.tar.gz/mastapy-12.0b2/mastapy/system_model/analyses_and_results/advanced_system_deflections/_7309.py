...
class SynchroniserSleeveAdvancedSystemDeflection(_7308.SynchroniserPartAdvancedSystemDeflection):
    """SynchroniserSleeveAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2762.SynchroniserSleeveSystemDeflection]':
