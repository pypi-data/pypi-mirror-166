...
class ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection(_7326.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7290.ShaftToMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7290.ShaftToMountableComponentConnectionAdvancedSystemDeflection]':
