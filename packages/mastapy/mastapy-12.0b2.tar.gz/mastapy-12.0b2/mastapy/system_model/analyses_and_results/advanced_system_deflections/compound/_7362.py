...
class CouplingHalfCompoundAdvancedSystemDeflection(_7400.MountableComponentCompoundAdvancedSystemDeflection):
    """CouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7230.CouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7230.CouplingHalfAdvancedSystemDeflection]':
