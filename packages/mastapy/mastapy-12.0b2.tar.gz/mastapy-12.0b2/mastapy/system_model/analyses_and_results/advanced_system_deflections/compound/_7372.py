...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7370, _7371, _7383
...
class CylindricalGearSetCompoundAdvancedSystemDeflection(_7383.GearSetCompoundAdvancedSystemDeflection):
    """CylindricalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7240.CylindricalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gears_compound_advanced_system_deflection(self) -> 'List[_7370.CylindricalGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshes_compound_advanced_system_deflection(self) -> 'List[_7371.CylindricalGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7240.CylindricalGearSetAdvancedSystemDeflection]':
