...
class BevelDifferentialGearAdvancedSystemDeflection(_7206.BevelGearAdvancedSystemDeflection):
    """BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2642.BevelDifferentialGearSystemDeflection]':
