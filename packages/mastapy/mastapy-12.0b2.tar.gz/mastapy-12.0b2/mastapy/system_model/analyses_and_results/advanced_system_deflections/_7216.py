...
class ConceptCouplingAdvancedSystemDeflection(_7228.CouplingAdvancedSystemDeflection):
    """ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2658.ConceptCouplingSystemDeflection]':
