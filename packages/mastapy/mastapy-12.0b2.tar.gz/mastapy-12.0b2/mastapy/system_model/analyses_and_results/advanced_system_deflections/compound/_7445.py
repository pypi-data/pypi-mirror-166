...
class VirtualComponentCompoundAdvancedSystemDeflection(_7400.MountableComponentCompoundAdvancedSystemDeflection):
    """VirtualComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7316.VirtualComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7316.VirtualComponentAdvancedSystemDeflection]':
