...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7428, _7429, _7341
...
class StraightBevelDiffGearSetCompoundAdvancedSystemDeflection(_7341.BevelGearSetCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7300.StraightBevelDiffGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gears_compound_advanced_system_deflection(self) -> 'List[_7428.StraightBevelDiffGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_advanced_system_deflection(self) -> 'List[_7429.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7300.StraightBevelDiffGearSetAdvancedSystemDeflection]':
