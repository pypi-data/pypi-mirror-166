...
class BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection(_7334.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7204.BevelDifferentialPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7204.BevelDifferentialPlanetGearAdvancedSystemDeflection]':
