...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7334, _7335, _7341
...
class BevelDifferentialGearSetCompoundAdvancedSystemDeflection(_7341.BevelGearSetCompoundAdvancedSystemDeflection):
    """BevelDifferentialGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7203.BevelDifferentialGearSetAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_compound_advanced_system_deflection(self) -> 'List[_7334.BevelDifferentialGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_compound_advanced_system_deflection(self) -> 'List[_7335.BevelDifferentialGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7203.BevelDifferentialGearSetAdvancedSystemDeflection]':
