...
class CycloidalDiscCompoundAdvancedSystemDeflection(_7324.AbstractShaftCompoundAdvancedSystemDeflection):
    """CycloidalDiscCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7235.CycloidalDiscAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7235.CycloidalDiscAdvancedSystemDeflection]':
