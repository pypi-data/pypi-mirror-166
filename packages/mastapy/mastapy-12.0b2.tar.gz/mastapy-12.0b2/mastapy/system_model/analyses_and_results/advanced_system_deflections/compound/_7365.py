...
class CVTPulleyCompoundAdvancedSystemDeflection(_7411.PulleyCompoundAdvancedSystemDeflection):
    """CVTPulleyCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7233.CVTPulleyAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7233.CVTPulleyAdvancedSystemDeflection]':
