...
class AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection(_7356.ConicalGearMeshCompoundAdvancedSystemDeflection):
    """AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7195.AGMAGleasonConicalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7195.AGMAGleasonConicalGearMeshAdvancedSystemDeflection]':
