...
class ConicalGearSetCompoundAdvancedSystemDeflection(_7383.GearSetCompoundAdvancedSystemDeflection):
    """ConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7224.ConicalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7224.ConicalGearSetAdvancedSystemDeflection]':
