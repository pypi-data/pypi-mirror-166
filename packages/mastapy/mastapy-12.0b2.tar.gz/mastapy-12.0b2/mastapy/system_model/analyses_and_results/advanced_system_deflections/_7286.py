...
class RollingRingConnectionAdvancedSystemDeflection(_7257.InterMountableComponentConnectionAdvancedSystemDeflection):
    """RollingRingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2737.RollingRingConnectionSystemDeflection]':
