...
class StraightBevelGearCompoundAdvancedSystemDeflection(_7339.BevelGearCompoundAdvancedSystemDeflection):
    """StraightBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7301.StraightBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7301.StraightBevelGearAdvancedSystemDeflection]':
