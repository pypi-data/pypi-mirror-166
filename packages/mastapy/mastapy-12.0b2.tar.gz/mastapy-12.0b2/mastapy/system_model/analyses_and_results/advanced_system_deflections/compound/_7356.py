...
class ConicalGearMeshCompoundAdvancedSystemDeflection(_7382.GearMeshCompoundAdvancedSystemDeflection):
    """ConicalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7223.ConicalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7223.ConicalGearMeshAdvancedSystemDeflection]':
