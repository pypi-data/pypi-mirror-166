...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7352, _7353, _7383
...
class ConceptGearSetCompoundAdvancedSystemDeflection(_7383.GearSetCompoundAdvancedSystemDeflection):
    """ConceptGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7221.ConceptGearSetAdvancedSystemDeflection]':
    ...
    @property
    def concept_gears_compound_advanced_system_deflection(self) -> 'List[_7352.ConceptGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_meshes_compound_advanced_system_deflection(self) -> 'List[_7353.ConceptGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7221.ConceptGearSetAdvancedSystemDeflection]':
