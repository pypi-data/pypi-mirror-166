...
class ClutchConnectionCompoundAdvancedSystemDeflection(_7361.CouplingConnectionCompoundAdvancedSystemDeflection):
    """ClutchConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7212.ClutchConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7212.ClutchConnectionAdvancedSystemDeflection]':
