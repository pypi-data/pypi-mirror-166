...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7320, _7321, _7208
...
class ZerolBevelGearSetAdvancedSystemDeflection(_7208.BevelGearSetAdvancedSystemDeflection):
    """ZerolBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2779.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_7320.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_7321.ZerolBevelGearMeshAdvancedSystemDeflection]':
