...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7219, _7220, _7252
...
class ConceptGearSetAdvancedSystemDeflection(_7252.GearSetAdvancedSystemDeflection):
    """ConceptGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2660.ConceptGearSetSystemDeflection]':
    ...
    @property
    def concept_gears_advanced_system_deflection(self) -> 'List[_7219.ConceptGearAdvancedSystemDeflection]':
    ...
    @property
    def concept_meshes_advanced_system_deflection(self) -> 'List[_7220.ConceptGearMeshAdvancedSystemDeflection]':
