...
class ConceptGearMeshCompoundAdvancedSystemDeflection(_7382.GearMeshCompoundAdvancedSystemDeflection):
    """ConceptGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7220.ConceptGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7220.ConceptGearMeshAdvancedSystemDeflection]':
