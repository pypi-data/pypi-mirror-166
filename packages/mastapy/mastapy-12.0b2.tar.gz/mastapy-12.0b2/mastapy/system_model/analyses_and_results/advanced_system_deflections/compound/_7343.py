...
class BoltedJointCompoundAdvancedSystemDeflection(_7421.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """BoltedJointCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7210.BoltedJointAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7210.BoltedJointAdvancedSystemDeflection]':
