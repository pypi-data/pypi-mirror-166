...
class CylindricalGearCompoundAdvancedSystemDeflection(_7381.GearCompoundAdvancedSystemDeflection):
    """CylindricalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7238.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7238.CylindricalGearAdvancedSystemDeflection]':
