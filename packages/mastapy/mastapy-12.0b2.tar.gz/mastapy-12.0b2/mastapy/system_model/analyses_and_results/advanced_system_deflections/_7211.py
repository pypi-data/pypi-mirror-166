...
class ClutchAdvancedSystemDeflection(_7228.CouplingAdvancedSystemDeflection):
    """ClutchAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2652.ClutchSystemDeflection]':
