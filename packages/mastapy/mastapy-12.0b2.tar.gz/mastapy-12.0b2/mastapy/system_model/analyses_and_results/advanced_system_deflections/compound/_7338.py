...
class BevelDifferentialSunGearCompoundAdvancedSystemDeflection(_7334.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    """BevelDifferentialSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7205.BevelDifferentialSunGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7205.BevelDifferentialSunGearAdvancedSystemDeflection]':
