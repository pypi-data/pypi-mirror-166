...
class StraightBevelGearMeshCompoundAdvancedSystemDeflection(_7340.BevelGearMeshCompoundAdvancedSystemDeflection):
    """StraightBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7302.StraightBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7302.StraightBevelGearMeshAdvancedSystemDeflection]':
