...
class StraightBevelDiffGearCompoundAdvancedSystemDeflection(_7339.BevelGearCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7298.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7298.StraightBevelDiffGearAdvancedSystemDeflection]':
