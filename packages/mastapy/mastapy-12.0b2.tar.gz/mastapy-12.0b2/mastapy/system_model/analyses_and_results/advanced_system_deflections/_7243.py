...
class DatumAdvancedSystemDeflection(_7215.ComponentAdvancedSystemDeflection):
    """DatumAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2690.DatumSystemDeflection]':
