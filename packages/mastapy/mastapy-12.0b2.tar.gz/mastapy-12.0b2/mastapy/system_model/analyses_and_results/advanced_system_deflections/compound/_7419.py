...
class ShaftHubConnectionCompoundAdvancedSystemDeflection(_7359.ConnectorCompoundAdvancedSystemDeflection):
    """ShaftHubConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7289.ShaftHubConnectionAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7289.ShaftHubConnectionAdvancedSystemDeflection]':
