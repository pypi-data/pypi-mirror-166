...
class CycloidalAssemblyCompoundAdvancedSystemDeflection(_7421.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """CycloidalAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7234.CycloidalAssemblyAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7234.CycloidalAssemblyAdvancedSystemDeflection]':
