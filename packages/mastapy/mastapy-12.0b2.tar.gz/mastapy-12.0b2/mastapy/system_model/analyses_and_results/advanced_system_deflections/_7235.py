...
class CycloidalDiscAdvancedSystemDeflection(_7188.AbstractShaftAdvancedSystemDeflection):
    """CycloidalDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2677.CycloidalDiscSystemDeflection]':
