...
class ConceptCouplingHalfCompoundAdvancedSystemDeflection(_7362.CouplingHalfCompoundAdvancedSystemDeflection):
    """ConceptCouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7218.ConceptCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7218.ConceptCouplingHalfAdvancedSystemDeflection]':
