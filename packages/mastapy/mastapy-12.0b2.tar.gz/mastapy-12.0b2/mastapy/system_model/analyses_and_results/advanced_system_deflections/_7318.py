...
class WormGearMeshAdvancedSystemDeflection(_7251.GearMeshAdvancedSystemDeflection):
    """WormGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2775.WormGearMeshSystemDeflection]':
