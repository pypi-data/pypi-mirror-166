...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7292, _7293, _7208
...
class SpiralBevelGearSetAdvancedSystemDeflection(_7208.BevelGearSetAdvancedSystemDeflection):
    """SpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2747.SpiralBevelGearSetSystemDeflection]':
    ...
    @property
    def spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_7292.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_7293.SpiralBevelGearMeshAdvancedSystemDeflection]':
