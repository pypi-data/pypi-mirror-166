...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7238, _7242, _7239
...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    @property
    def cylindrical_gear_advanced_system_deflection(self) -> '_7238.CylindricalGearAdvancedSystemDeflection':
        ...
        if _7238.CylindricalGearAdvancedSystemDeflection.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_advanced_system_deflection(self) -> '_7239.CylindricalGearMeshAdvancedSystemDeflection':
    ...
    @property
    def other_cylindrical_gear_advanced_system_deflection(self) -> '_7238.CylindricalGearAdvancedSystemDeflection':
