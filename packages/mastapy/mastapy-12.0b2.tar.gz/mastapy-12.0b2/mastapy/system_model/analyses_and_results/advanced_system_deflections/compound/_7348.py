...
class ComponentCompoundAdvancedSystemDeflection(_7402.PartCompoundAdvancedSystemDeflection):
    """ComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7215.ComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7215.ComponentAdvancedSystemDeflection]':
