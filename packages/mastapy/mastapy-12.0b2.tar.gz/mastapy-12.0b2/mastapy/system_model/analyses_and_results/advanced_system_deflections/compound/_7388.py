...
class InterMountableComponentConnectionCompoundAdvancedSystemDeflection(_7358.ConnectionCompoundAdvancedSystemDeflection):
    """InterMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7257.InterMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7257.InterMountableComponentConnectionAdvancedSystemDeflection]':
