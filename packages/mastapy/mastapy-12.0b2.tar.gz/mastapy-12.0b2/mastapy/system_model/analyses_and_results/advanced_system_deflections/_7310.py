...
class TorqueConverterAdvancedSystemDeflection(_7228.CouplingAdvancedSystemDeflection):
    """TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2769.TorqueConverterSystemDeflection]':
