...
class ConceptGearMeshAdvancedSystemDeflection(_7251.GearMeshAdvancedSystemDeflection):
    """ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2659.ConceptGearMeshSystemDeflection]':
