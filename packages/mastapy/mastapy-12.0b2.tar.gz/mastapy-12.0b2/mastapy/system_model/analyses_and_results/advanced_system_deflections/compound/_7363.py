...
class CVTBeltConnectionCompoundAdvancedSystemDeflection(_7332.BeltConnectionCompoundAdvancedSystemDeflection):
    """CVTBeltConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7232.CVTBeltConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7232.CVTBeltConnectionAdvancedSystemDeflection]':
