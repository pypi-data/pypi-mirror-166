...
class ConceptCouplingHalfAdvancedSystemDeflection(_7230.CouplingHalfAdvancedSystemDeflection):
    """ConceptCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2657.ConceptCouplingHalfSystemDeflection]':
