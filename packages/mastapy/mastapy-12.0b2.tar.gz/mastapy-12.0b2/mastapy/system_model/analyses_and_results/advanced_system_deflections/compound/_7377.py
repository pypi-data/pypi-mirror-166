...
class FaceGearMeshCompoundAdvancedSystemDeflection(_7382.GearMeshCompoundAdvancedSystemDeflection):
    """FaceGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7246.FaceGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7246.FaceGearMeshAdvancedSystemDeflection]':
