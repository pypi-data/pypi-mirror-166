...
class MountableComponentCompoundAdvancedSystemDeflection(_7348.ComponentCompoundAdvancedSystemDeflection):
    """MountableComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7270.MountableComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7270.MountableComponentAdvancedSystemDeflection]':
