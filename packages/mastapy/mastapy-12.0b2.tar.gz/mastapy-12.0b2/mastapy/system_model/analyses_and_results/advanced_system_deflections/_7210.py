...
class BoltedJointAdvancedSystemDeflection(_7291.SpecialisedAssemblyAdvancedSystemDeflection):
    """BoltedJointAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2648.BoltedJointSystemDeflection]':
