...
class ZerolBevelGearMeshCompoundAdvancedSystemDeflection(_7340.BevelGearMeshCompoundAdvancedSystemDeflection):
    """ZerolBevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7321.ZerolBevelGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7321.ZerolBevelGearMeshAdvancedSystemDeflection]':
