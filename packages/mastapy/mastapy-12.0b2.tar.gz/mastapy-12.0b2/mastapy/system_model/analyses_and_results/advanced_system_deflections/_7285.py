...
class RollingRingAssemblyAdvancedSystemDeflection(_7291.SpecialisedAssemblyAdvancedSystemDeflection):
    """RollingRingAssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2736.RollingRingAssemblySystemDeflection]':
