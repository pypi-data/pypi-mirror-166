...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7254, _7255, _7196
...
class HypoidGearSetAdvancedSystemDeflection(_7196.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    """HypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2703.HypoidGearSetSystemDeflection]':
    ...
    @property
    def hypoid_gears_advanced_system_deflection(self) -> 'List[_7254.HypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_meshes_advanced_system_deflection(self) -> 'List[_7255.HypoidGearMeshAdvancedSystemDeflection]':
