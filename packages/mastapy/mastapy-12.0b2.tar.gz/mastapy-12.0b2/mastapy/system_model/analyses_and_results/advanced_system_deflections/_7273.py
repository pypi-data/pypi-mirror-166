...
class PartToPartShearCouplingAdvancedSystemDeflection(_7228.CouplingAdvancedSystemDeflection):
    """PartToPartShearCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2727.PartToPartShearCouplingSystemDeflection]':
