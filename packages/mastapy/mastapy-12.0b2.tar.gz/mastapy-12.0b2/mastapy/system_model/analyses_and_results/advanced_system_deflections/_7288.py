...
class ShaftAdvancedSystemDeflection(_7188.AbstractShaftAdvancedSystemDeflection):
    """ShaftAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2743.ShaftSystemDeflection]':
