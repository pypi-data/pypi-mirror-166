...
class PlanetCarrierAdvancedSystemDeflection(_7270.MountableComponentAdvancedSystemDeflection):
    """PlanetCarrierAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2729.PlanetCarrierSystemDeflection]':
