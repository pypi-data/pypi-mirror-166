...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7301, _7302, _7208
...
class StraightBevelGearSetAdvancedSystemDeflection(_7208.BevelGearSetAdvancedSystemDeflection):
    """StraightBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2756.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_advanced_system_deflection(self) -> 'List[_7301.StraightBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_advanced_system_deflection(self) -> 'List[_7302.StraightBevelGearMeshAdvancedSystemDeflection]':
