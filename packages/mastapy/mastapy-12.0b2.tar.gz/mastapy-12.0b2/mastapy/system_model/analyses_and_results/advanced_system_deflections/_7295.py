...
class SpringDamperAdvancedSystemDeflection(_7228.CouplingAdvancedSystemDeflection):
    """SpringDamperAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2751.SpringDamperSystemDeflection]':
