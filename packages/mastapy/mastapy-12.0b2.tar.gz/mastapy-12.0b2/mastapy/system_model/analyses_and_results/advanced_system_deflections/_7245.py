...
class FaceGearAdvancedSystemDeflection(_7250.GearAdvancedSystemDeflection):
    """FaceGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2695.FaceGearSystemDeflection]':
