...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7385, _7386, _7329
...
class HypoidGearSetCompoundAdvancedSystemDeflection(_7329.AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection):
    """HypoidGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7256.HypoidGearSetAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gears_compound_advanced_system_deflection(self) -> 'List[_7385.HypoidGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_meshes_compound_advanced_system_deflection(self) -> 'List[_7386.HypoidGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7256.HypoidGearSetAdvancedSystemDeflection]':
