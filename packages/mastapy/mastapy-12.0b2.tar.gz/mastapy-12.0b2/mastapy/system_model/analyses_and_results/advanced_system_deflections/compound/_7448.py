...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7446, _7447, _7383
...
class WormGearSetCompoundAdvancedSystemDeflection(_7383.GearSetCompoundAdvancedSystemDeflection):
    """WormGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7319.WormGearSetAdvancedSystemDeflection]':
    ...
    @property
    def worm_gears_compound_advanced_system_deflection(self) -> 'List[_7446.WormGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def worm_meshes_compound_advanced_system_deflection(self) -> 'List[_7447.WormGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7319.WormGearSetAdvancedSystemDeflection]':
