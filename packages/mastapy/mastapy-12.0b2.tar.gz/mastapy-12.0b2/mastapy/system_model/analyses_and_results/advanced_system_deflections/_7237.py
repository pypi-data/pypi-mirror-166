...
class CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection(_7190.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection):
    """CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2676.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
