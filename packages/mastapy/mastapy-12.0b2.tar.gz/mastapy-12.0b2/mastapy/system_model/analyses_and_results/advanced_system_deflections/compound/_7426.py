...
class SpringDamperConnectionCompoundAdvancedSystemDeflection(_7361.CouplingConnectionCompoundAdvancedSystemDeflection):
    """SpringDamperConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7296.SpringDamperConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7296.SpringDamperConnectionAdvancedSystemDeflection]':
