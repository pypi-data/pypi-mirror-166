...
class ExternalCADModelCompoundAdvancedSystemDeflection(_7348.ComponentCompoundAdvancedSystemDeflection):
    """ExternalCADModelCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7244.ExternalCADModelAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7244.ExternalCADModelAdvancedSystemDeflection]':
