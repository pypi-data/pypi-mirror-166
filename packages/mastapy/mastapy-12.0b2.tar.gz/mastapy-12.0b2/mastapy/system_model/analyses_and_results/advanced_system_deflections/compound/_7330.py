...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import (
    _7331, _7333, _7336, _7343,
    _7342, _7364, _7344, _7349,
    _7354, _7366, _7368, _7372,
    _7379, _7378, _7380, _7387,
    _7394, _7397, _7398, _7399,
    _7401, _7403, _7408, _7409,
    _7410, _7412, _7414, _7419,
    _7418, _7424, _7425, _7430,
    _7433, _7436, _7440, _7444,
    _7448, _7451, _7323
)
...
class AssemblyCompoundAdvancedSystemDeflection(_7323.AbstractAssemblyCompoundAdvancedSystemDeflection):
    """AssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7197.AssemblyAdvancedSystemDeflection]':
    ...
    @property
    def bearings(self) -> 'List[_7331.BearingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def belt_drives(self) -> 'List[_7333.BeltDriveCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_7336.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bolted_joints(self) -> 'List[_7343.BoltedJointCompoundAdvancedSystemDeflection]':
    ...
    @property
    def bolts(self) -> 'List[_7342.BoltCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cv_ts(self) -> 'List[_7364.CVTCompoundAdvancedSystemDeflection]':
    ...
    @property
    def clutches(self) -> 'List[_7344.ClutchCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_couplings(self) -> 'List[_7349.ConceptCouplingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_7354.ConceptGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_7366.CycloidalAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_7368.CycloidalDiscCompoundAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_7372.CylindricalGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def fe_parts(self) -> 'List[_7379.FEPartCompoundAdvancedSystemDeflection]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_7378.FaceGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_7380.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_7387.HypoidGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7394.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7397.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def mass_discs(self) -> 'List[_7398.MassDiscCompoundAdvancedSystemDeflection]':
    ...
    @property
    def measurement_components(self) -> 'List[_7399.MeasurementComponentCompoundAdvancedSystemDeflection]':
    ...
    @property
    def oil_seals(self) -> 'List[_7401.OilSealCompoundAdvancedSystemDeflection]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7403.PartToPartShearCouplingCompoundAdvancedSystemDeflection]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7408.PlanetCarrierCompoundAdvancedSystemDeflection]':
    ...
    @property
    def point_loads(self) -> 'List[_7409.PointLoadCompoundAdvancedSystemDeflection]':
    ...
    @property
    def power_loads(self) -> 'List[_7410.PowerLoadCompoundAdvancedSystemDeflection]':
    ...
    @property
    def ring_pins(self) -> 'List[_7412.RingPinsCompoundAdvancedSystemDeflection]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7414.RollingRingAssemblyCompoundAdvancedSystemDeflection]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7419.ShaftHubConnectionCompoundAdvancedSystemDeflection]':
    ...
    @property
    def shafts(self) -> 'List[_7418.ShaftCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7424.SpiralBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7425.SpringDamperCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7430.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7433.StraightBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def synchronisers(self) -> 'List[_7436.SynchroniserCompoundAdvancedSystemDeflection]':
    ...
    @property
    def torque_converters(self) -> 'List[_7440.TorqueConverterCompoundAdvancedSystemDeflection]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7444.UnbalancedMassCompoundAdvancedSystemDeflection]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7448.WormGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7451.ZerolBevelGearSetCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7197.AssemblyAdvancedSystemDeflection]':
