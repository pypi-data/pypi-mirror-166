...
class OilSealAdvancedSystemDeflection(_7226.ConnectorAdvancedSystemDeflection):
    """OilSealAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2723.OilSealSystemDeflection]':
