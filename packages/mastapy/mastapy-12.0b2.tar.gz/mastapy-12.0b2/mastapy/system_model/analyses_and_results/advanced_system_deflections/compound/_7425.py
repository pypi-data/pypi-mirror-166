...
class SpringDamperCompoundAdvancedSystemDeflection(_7360.CouplingCompoundAdvancedSystemDeflection):
    """SpringDamperCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7295.SpringDamperAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7295.SpringDamperAdvancedSystemDeflection]':
