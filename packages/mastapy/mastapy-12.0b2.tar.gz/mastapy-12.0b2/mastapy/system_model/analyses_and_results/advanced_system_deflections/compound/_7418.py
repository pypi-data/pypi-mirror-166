...
class ShaftCompoundAdvancedSystemDeflection(_7324.AbstractShaftCompoundAdvancedSystemDeflection):
    """ShaftCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7288.ShaftAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7288.ShaftAdvancedSystemDeflection]':
