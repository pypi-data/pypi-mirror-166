...
class PlanetaryConnectionCompoundAdvancedSystemDeflection(_7420.ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """PlanetaryConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7276.PlanetaryConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7276.PlanetaryConnectionAdvancedSystemDeflection]':
