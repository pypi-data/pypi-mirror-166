...
class OilSealCompoundAdvancedSystemDeflection(_7359.ConnectorCompoundAdvancedSystemDeflection):
    """OilSealCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7271.OilSealAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7271.OilSealAdvancedSystemDeflection]':
