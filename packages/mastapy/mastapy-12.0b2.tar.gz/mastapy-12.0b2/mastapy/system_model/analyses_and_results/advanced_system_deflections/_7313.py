...
class TorqueConverterTurbineAdvancedSystemDeflection(_7230.CouplingHalfAdvancedSystemDeflection):
    """TorqueConverterTurbineAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2770.TorqueConverterTurbineSystemDeflection]':
