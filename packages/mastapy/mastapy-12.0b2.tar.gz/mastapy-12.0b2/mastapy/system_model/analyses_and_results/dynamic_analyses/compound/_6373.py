...
class CycloidalDiscCompoundDynamicAnalysis(_6329.AbstractShaftCompoundDynamicAnalysis):
    """CycloidalDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6243.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6243.CycloidalDiscDynamicAnalysis]':
