...
class FaceGearMeshCompoundDynamicAnalysis(_6387.GearMeshCompoundDynamicAnalysis):
    """FaceGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6253.FaceGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6253.FaceGearMeshDynamicAnalysis]':
