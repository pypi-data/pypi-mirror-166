...
class SynchroniserHalfCompoundDynamicAnalysis(_6443.SynchroniserPartCompoundDynamicAnalysis):
    """SynchroniserHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6313.SynchroniserHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6313.SynchroniserHalfDynamicAnalysis]':
