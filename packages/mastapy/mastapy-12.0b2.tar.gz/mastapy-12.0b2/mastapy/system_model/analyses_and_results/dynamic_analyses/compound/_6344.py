...
class BevelGearCompoundDynamicAnalysis(_6332.AGMAGleasonConicalGearCompoundDynamicAnalysis):
    """BevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6214.BevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6214.BevelGearDynamicAnalysis]':
