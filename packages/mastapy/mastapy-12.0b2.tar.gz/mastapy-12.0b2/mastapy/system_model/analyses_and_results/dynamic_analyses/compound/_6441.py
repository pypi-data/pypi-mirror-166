...
class SynchroniserCompoundDynamicAnalysis(_6426.SpecialisedAssemblyCompoundDynamicAnalysis):
    """SynchroniserCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6312.SynchroniserDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6312.SynchroniserDynamicAnalysis]':
