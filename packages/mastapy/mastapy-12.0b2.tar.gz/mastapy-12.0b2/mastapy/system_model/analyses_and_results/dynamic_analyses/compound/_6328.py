...
class AbstractAssemblyCompoundDynamicAnalysis(_6407.PartCompoundDynamicAnalysis):
    """AbstractAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6198.AbstractAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6198.AbstractAssemblyDynamicAnalysis]':
