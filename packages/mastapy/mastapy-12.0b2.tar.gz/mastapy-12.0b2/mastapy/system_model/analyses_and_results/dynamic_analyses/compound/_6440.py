...
class StraightBevelSunGearCompoundDynamicAnalysis(_6433.StraightBevelDiffGearCompoundDynamicAnalysis):
    """StraightBevelSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6311.StraightBevelSunGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6311.StraightBevelSunGearDynamicAnalysis]':
