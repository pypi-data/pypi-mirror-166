...
class AbstractShaftCompoundDynamicAnalysis(_6330.AbstractShaftOrHousingCompoundDynamicAnalysis):
    """AbstractShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6199.AbstractShaftDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6199.AbstractShaftDynamicAnalysis]':
