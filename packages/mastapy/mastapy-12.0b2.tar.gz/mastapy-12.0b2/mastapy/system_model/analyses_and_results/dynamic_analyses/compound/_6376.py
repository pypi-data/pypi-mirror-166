...
class CylindricalGearMeshCompoundDynamicAnalysis(_6387.GearMeshCompoundDynamicAnalysis):
    """CylindricalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6246.CylindricalGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6246.CylindricalGearMeshDynamicAnalysis]':
