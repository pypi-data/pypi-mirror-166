...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6209, _6210, _6216
...
class BevelDifferentialGearSetDynamicAnalysis(_6216.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_6209.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_6210.BevelDifferentialGearMeshDynamicAnalysis]':
