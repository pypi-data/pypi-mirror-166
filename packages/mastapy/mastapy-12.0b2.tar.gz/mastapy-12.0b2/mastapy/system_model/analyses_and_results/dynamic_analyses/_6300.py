...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6298, _6299, _6216
...
class SpiralBevelGearSetDynamicAnalysis(_6216.BevelGearSetDynamicAnalysis):
    """SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6298.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6299.SpiralBevelGearMeshDynamicAnalysis]':
