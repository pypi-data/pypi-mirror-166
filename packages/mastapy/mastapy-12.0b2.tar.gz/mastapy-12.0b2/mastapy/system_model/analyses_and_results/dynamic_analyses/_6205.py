...
from mastapy.system_model.analyses_and_results.dynamic_analyses import (
    _6206, _6208, _6211, _6218,
    _6217, _6239, _6220, _6225,
    _6229, _6241, _6243, _6247,
    _6255, _6254, _6256, _6263,
    _6270, _6273, _6274, _6275,
    _6277, _6280, _6284, _6285,
    _6286, _6288, _6290, _6295,
    _6294, _6300, _6302, _6306,
    _6309, _6312, _6317, _6320,
    _6324, _6327, _6198
)
...
class AssemblyDynamicAnalysis(_6198.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    @property
    def bearings(self) -> 'List[_6206.BearingDynamicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6208.BeltDriveDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6211.BevelDifferentialGearSetDynamicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6218.BoltedJointDynamicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6217.BoltDynamicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6239.CVTDynamicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6220.ClutchDynamicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6225.ConceptCouplingDynamicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6229.ConceptGearSetDynamicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6241.CycloidalAssemblyDynamicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6243.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6247.CylindricalGearSetDynamicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6255.FEPartDynamicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6254.FaceGearSetDynamicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6256.FlexiblePinAssemblyDynamicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6263.HypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6270.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6273.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6274.MassDiscDynamicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6275.MeasurementComponentDynamicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6277.OilSealDynamicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6280.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6284.PlanetCarrierDynamicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6285.PointLoadDynamicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6286.PowerLoadDynamicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6288.RingPinsDynamicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6290.RollingRingAssemblyDynamicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6295.ShaftHubConnectionDynamicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6294.ShaftDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6300.SpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6302.SpringDamperDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6306.StraightBevelDiffGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6309.StraightBevelGearSetDynamicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6312.SynchroniserDynamicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6317.TorqueConverterDynamicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6320.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6324.WormGearSetDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6327.ZerolBevelGearSetDynamicAnalysis]':
