...
class PointLoadCompoundDynamicAnalysis(_6450.VirtualComponentCompoundDynamicAnalysis):
    """PointLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6285.PointLoadDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6285.PointLoadDynamicAnalysis]':
