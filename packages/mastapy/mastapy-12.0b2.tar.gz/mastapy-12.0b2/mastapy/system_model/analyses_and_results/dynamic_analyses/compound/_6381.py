...
class FaceGearCompoundDynamicAnalysis(_6386.GearCompoundDynamicAnalysis):
    """FaceGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6252.FaceGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6252.FaceGearDynamicAnalysis]':
