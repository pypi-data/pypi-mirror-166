...
class RingPinsToDiscConnectionCompoundDynamicAnalysis(_6393.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """RingPinsToDiscConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6289.RingPinsToDiscConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6289.RingPinsToDiscConnectionDynamicAnalysis]':
