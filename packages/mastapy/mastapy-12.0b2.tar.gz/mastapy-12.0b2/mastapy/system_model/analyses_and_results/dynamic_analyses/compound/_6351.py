...
class ClutchHalfCompoundDynamicAnalysis(_6367.CouplingHalfCompoundDynamicAnalysis):
    """ClutchHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6221.ClutchHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6221.ClutchHalfDynamicAnalysis]':
