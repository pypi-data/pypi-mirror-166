...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6390, _6391, _6334
...
class HypoidGearSetCompoundDynamicAnalysis(_6334.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    """HypoidGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6263.HypoidGearSetDynamicAnalysis]':
    ...
    @property
    def hypoid_gears_compound_dynamic_analysis(self) -> 'List[_6390.HypoidGearCompoundDynamicAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_dynamic_analysis(self) -> 'List[_6391.HypoidGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6263.HypoidGearSetDynamicAnalysis]':
