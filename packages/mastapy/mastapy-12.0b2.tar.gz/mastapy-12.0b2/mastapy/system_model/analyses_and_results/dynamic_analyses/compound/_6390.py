...
class HypoidGearCompoundDynamicAnalysis(_6332.AGMAGleasonConicalGearCompoundDynamicAnalysis):
    """HypoidGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6261.HypoidGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6261.HypoidGearDynamicAnalysis]':
