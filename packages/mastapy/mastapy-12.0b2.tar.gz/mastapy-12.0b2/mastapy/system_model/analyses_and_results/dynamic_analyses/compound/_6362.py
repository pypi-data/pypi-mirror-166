...
class ConicalGearSetCompoundDynamicAnalysis(_6388.GearSetCompoundDynamicAnalysis):
    """ConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6232.ConicalGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6232.ConicalGearSetDynamicAnalysis]':
