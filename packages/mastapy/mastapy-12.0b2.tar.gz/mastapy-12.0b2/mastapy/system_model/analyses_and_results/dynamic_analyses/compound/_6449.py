...
class UnbalancedMassCompoundDynamicAnalysis(_6450.VirtualComponentCompoundDynamicAnalysis):
    """UnbalancedMassCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6320.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6320.UnbalancedMassDynamicAnalysis]':
