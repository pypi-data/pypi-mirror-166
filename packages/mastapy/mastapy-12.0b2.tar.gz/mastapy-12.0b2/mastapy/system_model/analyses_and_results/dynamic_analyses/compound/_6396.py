...
class KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis(_6362.ConicalGearSetCompoundDynamicAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6267.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6267.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis]':
