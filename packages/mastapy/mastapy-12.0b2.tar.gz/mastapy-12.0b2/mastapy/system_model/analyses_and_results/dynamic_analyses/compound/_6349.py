...
class ClutchCompoundDynamicAnalysis(_6365.CouplingCompoundDynamicAnalysis):
    """ClutchCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6220.ClutchDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6220.ClutchDynamicAnalysis]':
