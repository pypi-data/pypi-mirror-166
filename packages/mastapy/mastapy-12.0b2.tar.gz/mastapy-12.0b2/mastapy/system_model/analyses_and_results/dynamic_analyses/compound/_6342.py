...
class BevelDifferentialPlanetGearCompoundDynamicAnalysis(_6339.BevelDifferentialGearCompoundDynamicAnalysis):
    """BevelDifferentialPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6212.BevelDifferentialPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6212.BevelDifferentialPlanetGearDynamicAnalysis]':
