...
class MassDiscCompoundDynamicAnalysis(_6450.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6274.MassDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6274.MassDiscDynamicAnalysis]':
