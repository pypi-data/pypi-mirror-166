...
class BevelDifferentialGearCompoundDynamicAnalysis(_6344.BevelGearCompoundDynamicAnalysis):
    """BevelDifferentialGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6209.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6209.BevelDifferentialGearDynamicAnalysis]':
