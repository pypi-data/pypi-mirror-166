...
class PartToPartShearCouplingConnectionCompoundDynamicAnalysis(_6366.CouplingConnectionCompoundDynamicAnalysis):
    """PartToPartShearCouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6279.PartToPartShearCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6279.PartToPartShearCouplingConnectionDynamicAnalysis]':
