...
class StraightBevelGearCompoundDynamicAnalysis(_6344.BevelGearCompoundDynamicAnalysis):
    """StraightBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6307.StraightBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6307.StraightBevelGearDynamicAnalysis]':
