...
class PartToPartShearCouplingCompoundDynamicAnalysis(_6365.CouplingCompoundDynamicAnalysis):
    """PartToPartShearCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6280.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6280.PartToPartShearCouplingDynamicAnalysis]':
