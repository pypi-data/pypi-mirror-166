...
class CouplingHalfCompoundDynamicAnalysis(_6405.MountableComponentCompoundDynamicAnalysis):
    """CouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6237.CouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6237.CouplingHalfDynamicAnalysis]':
