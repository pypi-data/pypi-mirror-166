...
class ConceptCouplingConnectionCompoundDynamicAnalysis(_6366.CouplingConnectionCompoundDynamicAnalysis):
    """ConceptCouplingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6224.ConceptCouplingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6224.ConceptCouplingConnectionDynamicAnalysis]':
