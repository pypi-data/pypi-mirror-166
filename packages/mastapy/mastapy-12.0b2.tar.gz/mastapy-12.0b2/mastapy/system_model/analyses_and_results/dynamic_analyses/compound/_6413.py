...
class PlanetCarrierCompoundDynamicAnalysis(_6405.MountableComponentCompoundDynamicAnalysis):
    """PlanetCarrierCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6284.PlanetCarrierDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6284.PlanetCarrierDynamicAnalysis]':
