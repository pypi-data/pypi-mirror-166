...
class AbstractShaftOrHousingCompoundDynamicAnalysis(_6353.ComponentCompoundDynamicAnalysis):
    """AbstractShaftOrHousingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6200.AbstractShaftOrHousingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6200.AbstractShaftOrHousingDynamicAnalysis]':
