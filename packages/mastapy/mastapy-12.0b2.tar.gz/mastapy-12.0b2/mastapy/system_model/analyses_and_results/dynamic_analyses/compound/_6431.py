...
class SpringDamperConnectionCompoundDynamicAnalysis(_6366.CouplingConnectionCompoundDynamicAnalysis):
    """SpringDamperConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6301.SpringDamperConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6301.SpringDamperConnectionDynamicAnalysis]':
