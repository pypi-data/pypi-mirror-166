...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6252, _6253, _6259
...
class FaceGearSetDynamicAnalysis(_6259.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    @property
    def face_gears_dynamic_analysis(self) -> 'List[_6252.FaceGearDynamicAnalysis]':
    ...
    @property
    def face_meshes_dynamic_analysis(self) -> 'List[_6253.FaceGearMeshDynamicAnalysis]':
