...
class ConnectionCompoundDynamicAnalysis(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6233.ConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6233.ConnectionDynamicAnalysis]':
