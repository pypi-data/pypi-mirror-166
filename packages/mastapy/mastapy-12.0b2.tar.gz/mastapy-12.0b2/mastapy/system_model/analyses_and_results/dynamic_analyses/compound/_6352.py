...
class CoaxialConnectionCompoundDynamicAnalysis(_6425.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """CoaxialConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6222.CoaxialConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6222.CoaxialConnectionDynamicAnalysis]':
