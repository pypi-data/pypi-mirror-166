...
class RollingRingConnectionCompoundDynamicAnalysis(_6393.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """RollingRingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6291.RollingRingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6291.RollingRingConnectionDynamicAnalysis]':
