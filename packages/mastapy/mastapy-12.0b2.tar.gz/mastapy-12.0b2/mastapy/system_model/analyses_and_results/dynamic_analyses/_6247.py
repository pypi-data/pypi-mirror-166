...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6245, _6246, _6259
...
class CylindricalGearSetDynamicAnalysis(_6259.GearSetDynamicAnalysis):
    """CylindricalGearSetDynamicAnalysis
    ...
    @property
    def cylindrical_gears_dynamic_analysis(self) -> 'List[_6245.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def cylindrical_meshes_dynamic_analysis(self) -> 'List[_6246.CylindricalGearMeshDynamicAnalysis]':
