...
class ConceptGearMeshCompoundDynamicAnalysis(_6387.GearMeshCompoundDynamicAnalysis):
    """ConceptGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6228.ConceptGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6228.ConceptGearMeshDynamicAnalysis]':
