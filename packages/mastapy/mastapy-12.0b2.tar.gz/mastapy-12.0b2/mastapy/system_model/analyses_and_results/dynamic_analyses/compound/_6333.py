...
class AGMAGleasonConicalGearMeshCompoundDynamicAnalysis(_6361.ConicalGearMeshCompoundDynamicAnalysis):
    """AGMAGleasonConicalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6203.AGMAGleasonConicalGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6203.AGMAGleasonConicalGearMeshDynamicAnalysis]':
