...
class RingPinsCompoundDynamicAnalysis(_6405.MountableComponentCompoundDynamicAnalysis):
    """RingPinsCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6288.RingPinsDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6288.RingPinsDynamicAnalysis]':
