...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6322, _6323, _6259
...
class WormGearSetDynamicAnalysis(_6259.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    @property
    def worm_gears_dynamic_analysis(self) -> 'List[_6322.WormGearDynamicAnalysis]':
    ...
    @property
    def worm_meshes_dynamic_analysis(self) -> 'List[_6323.WormGearMeshDynamicAnalysis]':
