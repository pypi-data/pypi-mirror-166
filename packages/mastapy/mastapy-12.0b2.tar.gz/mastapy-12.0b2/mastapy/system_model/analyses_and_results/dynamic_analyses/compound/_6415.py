...
class PowerLoadCompoundDynamicAnalysis(_6450.VirtualComponentCompoundDynamicAnalysis):
    """PowerLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6286.PowerLoadDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6286.PowerLoadDynamicAnalysis]':
