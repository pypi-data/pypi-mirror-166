...
class BoltedJointCompoundDynamicAnalysis(_6426.SpecialisedAssemblyCompoundDynamicAnalysis):
    """BoltedJointCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6218.BoltedJointDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6218.BoltedJointDynamicAnalysis]':
