...
class BevelGearMeshCompoundParametricStudyTool(_4383.AGMAGleasonConicalGearMeshCompoundParametricStudyTool):
    """BevelGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4247.BevelGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4247.BevelGearMeshParametricStudyTool]':
