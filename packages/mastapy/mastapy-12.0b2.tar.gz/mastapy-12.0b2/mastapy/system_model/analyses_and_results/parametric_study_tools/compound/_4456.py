...
class OilSealCompoundParametricStudyTool(_4414.ConnectorCompoundParametricStudyTool):
    """OilSealCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4317.OilSealParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4317.OilSealParametricStudyTool]':
