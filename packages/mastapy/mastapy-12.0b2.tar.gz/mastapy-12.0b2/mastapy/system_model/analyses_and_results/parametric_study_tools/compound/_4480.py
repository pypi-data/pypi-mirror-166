...
class SpringDamperCompoundParametricStudyTool(_4415.CouplingCompoundParametricStudyTool):
    """SpringDamperCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4353.SpringDamperParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4353.SpringDamperParametricStudyTool]':
