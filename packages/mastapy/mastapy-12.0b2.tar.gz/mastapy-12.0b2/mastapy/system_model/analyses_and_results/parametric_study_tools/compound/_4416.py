...
class CouplingConnectionCompoundParametricStudyTool(_4443.InterMountableComponentConnectionCompoundParametricStudyTool):
    """CouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4268.CouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4268.CouplingConnectionParametricStudyTool]':
