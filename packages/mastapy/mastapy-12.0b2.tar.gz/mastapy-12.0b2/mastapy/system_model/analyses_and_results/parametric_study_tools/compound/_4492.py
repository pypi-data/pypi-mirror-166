...
class SynchroniserHalfCompoundParametricStudyTool(_4493.SynchroniserPartCompoundParametricStudyTool):
    """SynchroniserHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4362.SynchroniserHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4362.SynchroniserHalfParametricStudyTool]':
