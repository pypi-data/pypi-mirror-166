...
class CycloidalDiscCentralBearingConnectionCompoundParametricStudyTool(_4402.CoaxialConnectionCompoundParametricStudyTool):
    """CycloidalDiscCentralBearingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4275.CycloidalDiscCentralBearingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4275.CycloidalDiscCentralBearingConnectionParametricStudyTool]':
