...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4261, _4260, _4298
...
class ConceptGearSetParametricStudyTool(_4298.GearSetParametricStudyTool):
    """ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_4261.ConceptGearParametricStudyTool]':
    ...
    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_4260.ConceptGearMeshParametricStudyTool]':
