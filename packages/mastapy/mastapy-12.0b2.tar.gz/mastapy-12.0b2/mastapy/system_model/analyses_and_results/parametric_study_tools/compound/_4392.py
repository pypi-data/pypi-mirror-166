...
class BevelDifferentialPlanetGearCompoundParametricStudyTool(_4389.BevelDifferentialGearCompoundParametricStudyTool):
    """BevelDifferentialPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4245.BevelDifferentialPlanetGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4245.BevelDifferentialPlanetGearParametricStudyTool]':
