...
class PartCompoundParametricStudyTool(_7463.PartCompoundAnalysis):
    """PartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4328.PartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4328.PartParametricStudyTool]':
