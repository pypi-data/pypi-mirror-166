...
class SynchroniserSleeveCompoundParametricStudyTool(_4493.SynchroniserPartCompoundParametricStudyTool):
    """SynchroniserSleeveCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4365.SynchroniserSleeveParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4365.SynchroniserSleeveParametricStudyTool]':
