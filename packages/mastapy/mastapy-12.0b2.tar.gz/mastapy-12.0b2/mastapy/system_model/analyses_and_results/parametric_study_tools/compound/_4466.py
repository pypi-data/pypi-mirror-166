...
class PulleyCompoundParametricStudyTool(_4417.CouplingHalfCompoundParametricStudyTool):
    """PulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4337.PulleyParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4337.PulleyParametricStudyTool]':
