...
class SynchroniserCompoundParametricStudyTool(_4476.SpecialisedAssemblyCompoundParametricStudyTool):
    """SynchroniserCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4363.SynchroniserParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4363.SynchroniserParametricStudyTool]':
