...
class RollingRingCompoundParametricStudyTool(_4417.CouplingHalfCompoundParametricStudyTool):
    """RollingRingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4342.RollingRingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4342.RollingRingParametricStudyTool]':
