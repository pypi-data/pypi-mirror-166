...
class BoltedJointCompoundParametricStudyTool(_4476.SpecialisedAssemblyCompoundParametricStudyTool):
    """BoltedJointCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4250.BoltedJointParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4250.BoltedJointParametricStudyTool]':
