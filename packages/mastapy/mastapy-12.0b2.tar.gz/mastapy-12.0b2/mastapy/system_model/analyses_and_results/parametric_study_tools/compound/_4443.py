...
class InterMountableComponentConnectionCompoundParametricStudyTool(_4413.ConnectionCompoundParametricStudyTool):
    """InterMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4303.InterMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4303.InterMountableComponentConnectionParametricStudyTool]':
