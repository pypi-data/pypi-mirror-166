...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4440, _4441, _4384
...
class HypoidGearSetCompoundParametricStudyTool(_4384.AGMAGleasonConicalGearSetCompoundParametricStudyTool):
    """HypoidGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4302.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def hypoid_gears_compound_parametric_study_tool(self) -> 'List[_4440.HypoidGearCompoundParametricStudyTool]':
    ...
    @property
    def hypoid_meshes_compound_parametric_study_tool(self) -> 'List[_4441.HypoidGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4302.HypoidGearSetParametricStudyTool]':
