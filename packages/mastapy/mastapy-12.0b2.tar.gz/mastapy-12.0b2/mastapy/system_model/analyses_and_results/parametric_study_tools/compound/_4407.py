...
class ConceptGearCompoundParametricStudyTool(_4436.GearCompoundParametricStudyTool):
    """ConceptGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4261.ConceptGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4261.ConceptGearParametricStudyTool]':
