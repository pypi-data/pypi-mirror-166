...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4486, _4487, _4396
...
class StraightBevelGearSetCompoundParametricStudyTool(_4396.BevelGearSetCompoundParametricStudyTool):
    """StraightBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4359.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4486.StraightBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4487.StraightBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4359.StraightBevelGearSetParametricStudyTool]':
