...
class ShaftCompoundParametricStudyTool(_4379.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4345.ShaftParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4345.ShaftParametricStudyTool]':
