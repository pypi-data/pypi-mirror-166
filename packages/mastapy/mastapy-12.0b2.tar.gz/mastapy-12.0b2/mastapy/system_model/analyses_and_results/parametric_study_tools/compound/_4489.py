...
class StraightBevelPlanetGearCompoundParametricStudyTool(_4483.StraightBevelDiffGearCompoundParametricStudyTool):
    """StraightBevelPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4360.StraightBevelPlanetGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4360.StraightBevelPlanetGearParametricStudyTool]':
