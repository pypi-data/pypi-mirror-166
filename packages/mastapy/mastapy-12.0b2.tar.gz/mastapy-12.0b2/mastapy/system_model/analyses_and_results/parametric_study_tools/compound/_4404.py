...
class ConceptCouplingCompoundParametricStudyTool(_4415.CouplingCompoundParametricStudyTool):
    """ConceptCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4259.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4259.ConceptCouplingParametricStudyTool]':
