...
from mastapy.system_model.analyses_and_results.parametric_study_tools import (
    _4285, _4239, _4241, _4244,
    _4250, _4251, _4272, _4254,
    _4259, _4262, _4274, _4276,
    _4280, _4294, _4293, _4295,
    _4302, _4309, _4312, _4313,
    _4314, _4317, _4331, _4334,
    _4335, _4336, _4338, _4340,
    _4344, _4345, _4350, _4353,
    _4356, _4359, _4363, _4367,
    _4370, _4374, _4377, _4231
)
...
class AssemblyParametricStudyTool(_4231.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    @property
    def all_duty_cycle_results(self) -> 'List[_4285.DutyCycleResultsForAllComponents]':
    ...
    @property
    def bearings(self) -> 'List[_4239.BearingParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4241.BeltDriveParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4244.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4250.BoltedJointParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4251.BoltParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4272.CVTParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4254.ClutchParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4259.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4262.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4274.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4276.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4280.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4294.FEPartParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4293.FaceGearSetParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4295.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4302.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4309.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4312.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4313.MassDiscParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4314.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4317.OilSealParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4331.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4334.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4335.PointLoadParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4336.PowerLoadParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4338.RingPinsParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4340.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4344.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4345.ShaftParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4350.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4353.SpringDamperParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4356.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4359.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4363.SynchroniserParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4367.TorqueConverterParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4370.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4374.WormGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4377.ZerolBevelGearSetParametricStudyTool]':
