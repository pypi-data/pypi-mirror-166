...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4381
...
class CycloidalDiscPlanetaryBearingConnectionCompoundParametricStudyTool(_4381.AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """CycloidalDiscPlanetaryBearingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4277.CycloidalDiscPlanetaryBearingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4277.CycloidalDiscPlanetaryBearingConnectionParametricStudyTool]':
