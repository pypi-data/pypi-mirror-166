...
class CycloidalAssemblyCompoundParametricStudyTool(_4476.SpecialisedAssemblyCompoundParametricStudyTool):
    """CycloidalAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4274.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4274.CycloidalAssemblyParametricStudyTool]':
