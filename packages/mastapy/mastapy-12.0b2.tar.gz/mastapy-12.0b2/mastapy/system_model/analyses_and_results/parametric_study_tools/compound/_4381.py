...
class AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool(_4413.ConnectionCompoundParametricStudyTool):
    """AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4234.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4234.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
