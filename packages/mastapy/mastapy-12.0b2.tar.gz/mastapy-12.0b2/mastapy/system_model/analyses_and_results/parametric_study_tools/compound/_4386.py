...
class BearingCompoundParametricStudyTool(_4414.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> '_1901.LoadedBearingDutyCycle':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4239.BearingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4239.BearingParametricStudyTool]':
