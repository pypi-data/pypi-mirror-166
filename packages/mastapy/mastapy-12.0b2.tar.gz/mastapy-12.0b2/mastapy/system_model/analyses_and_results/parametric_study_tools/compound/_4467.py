...
class RingPinsCompoundParametricStudyTool(_4455.MountableComponentCompoundParametricStudyTool):
    """RingPinsCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4338.RingPinsParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4338.RingPinsParametricStudyTool]':
