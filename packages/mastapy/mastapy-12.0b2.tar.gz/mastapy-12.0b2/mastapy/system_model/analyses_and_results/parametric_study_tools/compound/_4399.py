...
class ClutchCompoundParametricStudyTool(_4415.CouplingCompoundParametricStudyTool):
    """ClutchCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4254.ClutchParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4254.ClutchParametricStudyTool]':
