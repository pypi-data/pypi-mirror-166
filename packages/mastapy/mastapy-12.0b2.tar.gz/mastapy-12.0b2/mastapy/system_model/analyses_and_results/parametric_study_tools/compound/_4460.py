...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4417
...
class PartToPartShearCouplingHalfCompoundParametricStudyTool(_4417.CouplingHalfCompoundParametricStudyTool):
    """PartToPartShearCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4330.PartToPartShearCouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4330.PartToPartShearCouplingHalfParametricStudyTool]':
