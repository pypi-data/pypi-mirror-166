...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4425, _4426, _4438
...
class CylindricalGearSetCompoundParametricStudyTool(_4438.GearSetCompoundParametricStudyTool):
    """CylindricalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4280.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def cylindrical_gears_compound_parametric_study_tool(self) -> 'List[_4425.CylindricalGearCompoundParametricStudyTool]':
    ...
    @property
    def cylindrical_meshes_compound_parametric_study_tool(self) -> 'List[_4426.CylindricalGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4280.CylindricalGearSetParametricStudyTool]':
