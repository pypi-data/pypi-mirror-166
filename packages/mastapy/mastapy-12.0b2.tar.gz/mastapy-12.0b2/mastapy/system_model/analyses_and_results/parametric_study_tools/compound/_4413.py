...
class ConnectionCompoundParametricStudyTool(_7456.ConnectionCompoundAnalysis):
    """ConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4266.ConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4266.ConnectionParametricStudyTool]':
