...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4292, _4291, _4298
...
class FaceGearSetParametricStudyTool(_4298.GearSetParametricStudyTool):
    """FaceGearSetParametricStudyTool
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_4292.FaceGearParametricStudyTool]':
    ...
    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_4291.FaceGearMeshParametricStudyTool]':
