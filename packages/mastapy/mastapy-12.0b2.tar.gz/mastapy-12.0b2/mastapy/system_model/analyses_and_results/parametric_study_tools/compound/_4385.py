...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4285, _4238
from mastapy._internal import constructor, conversion
from mastapy.system_model.part_model import _2379, _2419
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import (
    _4386, _4388, _4391, _4398,
    _4397, _4419, _4399, _4404,
    _4409, _4421, _4423, _4427,
    _4434, _4433, _4435, _4442,
    _4449, _4452, _4453, _4454,
    _4456, _4458, _4463, _4464,
    _4465, _4467, _4469, _4474,
    _4473, _4479, _4480, _4485,
    _4488, _4491, _4495, _4499,
    _4503, _4506, _4378
)
...
class AssemblyCompoundParametricStudyTool(_4378.AbstractAssemblyCompoundParametricStudyTool):
    """AssemblyCompoundParametricStudyTool
    ...
    @property
    def all_duty_cycle_results(self) -> '_4285.DutyCycleResultsForAllComponents':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4238.AssemblyParametricStudyTool]':
    ...
    @property
    def bearings(self) -> 'List[_4386.BearingCompoundParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4388.BeltDriveCompoundParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4391.BevelDifferentialGearSetCompoundParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4398.BoltedJointCompoundParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4397.BoltCompoundParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4419.CVTCompoundParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4399.ClutchCompoundParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4404.ConceptCouplingCompoundParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4409.ConceptGearSetCompoundParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4421.CycloidalAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4423.CycloidalDiscCompoundParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4427.CylindricalGearSetCompoundParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4434.FEPartCompoundParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4433.FaceGearSetCompoundParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4435.FlexiblePinAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4442.HypoidGearSetCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4449.KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4452.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4453.MassDiscCompoundParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4454.MeasurementComponentCompoundParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4456.OilSealCompoundParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4458.PartToPartShearCouplingCompoundParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4463.PlanetCarrierCompoundParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4464.PointLoadCompoundParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4465.PowerLoadCompoundParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4467.RingPinsCompoundParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4469.RollingRingAssemblyCompoundParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4474.ShaftHubConnectionCompoundParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4473.ShaftCompoundParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4479.SpiralBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4480.SpringDamperCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4485.StraightBevelDiffGearSetCompoundParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4488.StraightBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4491.SynchroniserCompoundParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4495.TorqueConverterCompoundParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4499.UnbalancedMassCompoundParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4503.WormGearSetCompoundParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4506.ZerolBevelGearSetCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4238.AssemblyParametricStudyTool]':
