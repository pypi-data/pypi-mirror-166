...
class CVTCompoundParametricStudyTool(_4388.BeltDriveCompoundParametricStudyTool):
    """CVTCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4272.CVTParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4272.CVTParametricStudyTool]':
