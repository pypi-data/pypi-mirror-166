...
class CylindricalGearMeshCompoundParametricStudyTool(_4437.GearMeshCompoundParametricStudyTool):
    """CylindricalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4278.CylindricalGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4278.CylindricalGearMeshParametricStudyTool]':
