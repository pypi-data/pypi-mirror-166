...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4358, _4357, _4249
...
class StraightBevelGearSetParametricStudyTool(_4249.BevelGearSetParametricStudyTool):
    """StraightBevelGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_gears_parametric_study_tool(self) -> 'List[_4358.StraightBevelGearParametricStudyTool]':
    ...
    @property
    def straight_bevel_meshes_parametric_study_tool(self) -> 'List[_4357.StraightBevelGearMeshParametricStudyTool]':
