...
class TorqueConverterTurbineCompoundParametricStudyTool(_4417.CouplingHalfCompoundParametricStudyTool):
    """TorqueConverterTurbineCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4369.TorqueConverterTurbineParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4369.TorqueConverterTurbineParametricStudyTool]':
