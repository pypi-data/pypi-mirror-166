...
class MassDiscCompoundParametricStudyTool(_4500.VirtualComponentCompoundParametricStudyTool):
    """MassDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4313.MassDiscParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4313.MassDiscParametricStudyTool]':
