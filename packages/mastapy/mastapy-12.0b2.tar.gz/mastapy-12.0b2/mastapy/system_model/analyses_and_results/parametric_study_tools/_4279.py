...
class CylindricalGearParametricStudyTool(_4297.GearParametricStudyTool):
    """CylindricalGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2684.CylindricalGearSystemDeflection]':
