...
class ClutchConnectionCompoundParametricStudyTool(_4416.CouplingConnectionCompoundParametricStudyTool):
    """ClutchConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4252.ClutchConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4252.ClutchConnectionParametricStudyTool]':
