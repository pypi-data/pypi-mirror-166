...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4501, _4502, _4438
...
class WormGearSetCompoundParametricStudyTool(_4438.GearSetCompoundParametricStudyTool):
    """WormGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4374.WormGearSetParametricStudyTool]':
    ...
    @property
    def worm_gears_compound_parametric_study_tool(self) -> 'List[_4501.WormGearCompoundParametricStudyTool]':
    ...
    @property
    def worm_meshes_compound_parametric_study_tool(self) -> 'List[_4502.WormGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4374.WormGearSetParametricStudyTool]':
