...
class SpringDamperConnectionParametricStudyTool(_4268.CouplingConnectionParametricStudyTool):
    """SpringDamperConnectionParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2749.SpringDamperConnectionSystemDeflection]':
