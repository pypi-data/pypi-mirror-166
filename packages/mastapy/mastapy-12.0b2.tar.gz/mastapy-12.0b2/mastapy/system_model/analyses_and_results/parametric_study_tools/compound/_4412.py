...
class ConicalGearSetCompoundParametricStudyTool(_4438.GearSetCompoundParametricStudyTool):
    """ConicalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4265.ConicalGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4265.ConicalGearSetParametricStudyTool]':
