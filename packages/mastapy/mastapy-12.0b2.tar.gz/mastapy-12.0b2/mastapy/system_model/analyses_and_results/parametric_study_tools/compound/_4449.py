...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4447, _4448, _4446
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool(_4446.KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4309.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_parametric_study_tool(self) -> 'List[_4447.KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_parametric_study_tool(self) -> 'List[_4448.KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4309.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
