...
class ConceptCouplingConnectionCompoundParametricStudyTool(_4416.CouplingConnectionCompoundParametricStudyTool):
    """ConceptCouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4257.ConceptCouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4257.ConceptCouplingConnectionParametricStudyTool]':
