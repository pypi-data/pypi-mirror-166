...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4308, _4307, _4306
...
class KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool(_4306.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool):
    """KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_parametric_study_tool(self) -> 'List[_4308.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_parametric_study_tool(self) -> 'List[_4307.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
