...
class StraightBevelDiffGearCompoundParametricStudyTool(_4394.BevelGearCompoundParametricStudyTool):
    """StraightBevelDiffGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4355.StraightBevelDiffGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4355.StraightBevelDiffGearParametricStudyTool]':
