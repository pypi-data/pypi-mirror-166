...
class ShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3837.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """ShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3800.ShaftToMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3800.ShaftToMountableComponentConnectionStabilityAnalysis]':
