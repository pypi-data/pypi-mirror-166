...
class PlanetaryGearSetCompoundStabilityAnalysis(_3883.CylindricalGearSetCompoundStabilityAnalysis):
    """PlanetaryGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3787.PlanetaryGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3787.PlanetaryGearSetStabilityAnalysis]':
