...
class RollingRingConnectionCompoundStabilityAnalysis(_3899.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """RollingRingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3795.RollingRingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3795.RollingRingConnectionStabilityAnalysis]':
