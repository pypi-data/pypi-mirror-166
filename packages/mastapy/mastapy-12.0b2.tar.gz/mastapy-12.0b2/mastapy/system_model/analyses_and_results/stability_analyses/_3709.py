...
from mastapy.system_model.analyses_and_results.stability_analyses import (
    _3710, _3712, _3714, _3721,
    _3722, _3745, _3725, _3730,
    _3732, _3746, _3749, _3751,
    _3759, _3757, _3760, _3766,
    _3773, _3776, _3778, _3779,
    _3781, _3785, _3788, _3789,
    _3790, _3792, _3794, _3798,
    _3799, _3803, _3807, _3811,
    _3814, _3821, _3824, _3826,
    _3829, _3832, _3702
)
...
class AssemblyStabilityAnalysis(_3702.AbstractAssemblyStabilityAnalysis):
    """AssemblyStabilityAnalysis
    ...
    @property
    def bearings(self) -> 'List[_3710.BearingStabilityAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_3712.BeltDriveStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3714.BevelDifferentialGearSetStabilityAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3721.BoltedJointStabilityAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_3722.BoltStabilityAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_3745.CVTStabilityAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_3725.ClutchStabilityAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3730.ConceptCouplingStabilityAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3732.ConceptGearSetStabilityAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3746.CycloidalAssemblyStabilityAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3749.CycloidalDiscStabilityAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3751.CylindricalGearSetStabilityAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_3759.FEPartStabilityAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3757.FaceGearSetStabilityAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3760.FlexiblePinAssemblyStabilityAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3766.HypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3773.KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3776.KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_3778.MassDiscStabilityAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_3779.MeasurementComponentStabilityAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_3781.OilSealStabilityAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3785.PartToPartShearCouplingStabilityAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3788.PlanetCarrierStabilityAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_3789.PointLoadStabilityAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_3790.PowerLoadStabilityAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_3792.RingPinsStabilityAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3794.RollingRingAssemblyStabilityAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3798.ShaftHubConnectionStabilityAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_3799.ShaftStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3803.SpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3807.SpringDamperStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3811.StraightBevelDiffGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3814.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_3821.SynchroniserStabilityAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_3824.TorqueConverterStabilityAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3826.UnbalancedMassStabilityAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3829.WormGearSetStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3832.ZerolBevelGearSetStabilityAnalysis]':
