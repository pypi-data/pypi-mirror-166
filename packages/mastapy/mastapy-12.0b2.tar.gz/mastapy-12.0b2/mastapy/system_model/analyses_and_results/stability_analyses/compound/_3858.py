...
class CoaxialConnectionCompoundStabilityAnalysis(_3931.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    """CoaxialConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3726.CoaxialConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3726.CoaxialConnectionStabilityAnalysis]':
