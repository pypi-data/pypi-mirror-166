...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3845, _3846, _3852
...
class BevelDifferentialGearSetCompoundStabilityAnalysis(_3852.BevelGearSetCompoundStabilityAnalysis):
    """BevelDifferentialGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3714.BevelDifferentialGearSetStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_stability_analysis(self) -> 'List[_3845.BevelDifferentialGearCompoundStabilityAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_stability_analysis(self) -> 'List[_3846.BevelDifferentialGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3714.BevelDifferentialGearSetStabilityAnalysis]':
