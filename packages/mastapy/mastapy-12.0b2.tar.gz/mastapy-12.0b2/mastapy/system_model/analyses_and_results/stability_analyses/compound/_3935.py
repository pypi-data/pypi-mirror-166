...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3933, _3934, _3852
...
class SpiralBevelGearSetCompoundStabilityAnalysis(_3852.BevelGearSetCompoundStabilityAnalysis):
    """SpiralBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3803.SpiralBevelGearSetStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_stability_analysis(self) -> 'List[_3933.SpiralBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_stability_analysis(self) -> 'List[_3934.SpiralBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3803.SpiralBevelGearSetStabilityAnalysis]':
