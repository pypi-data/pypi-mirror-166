...
class ClutchCompoundStabilityAnalysis(_3871.CouplingCompoundStabilityAnalysis):
    """ClutchCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3725.ClutchStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3725.ClutchStabilityAnalysis]':
