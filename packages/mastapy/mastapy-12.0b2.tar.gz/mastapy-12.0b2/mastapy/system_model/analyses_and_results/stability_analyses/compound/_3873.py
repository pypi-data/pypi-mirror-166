...
class CouplingHalfCompoundStabilityAnalysis(_3911.MountableComponentCompoundStabilityAnalysis):
    """CouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3740.CouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3740.CouplingHalfStabilityAnalysis]':
