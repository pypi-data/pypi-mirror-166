...
class MountableComponentCompoundStabilityAnalysis(_3859.ComponentCompoundStabilityAnalysis):
    """MountableComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3780.MountableComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3780.MountableComponentStabilityAnalysis]':
