...
class SynchroniserHalfCompoundStabilityAnalysis(_3949.SynchroniserPartCompoundStabilityAnalysis):
    """SynchroniserHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3818.SynchroniserHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3818.SynchroniserHalfStabilityAnalysis]':
