...
class CouplingConnectionCompoundStabilityAnalysis(_3899.InterMountableComponentConnectionCompoundStabilityAnalysis):
    """CouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3739.CouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3739.CouplingConnectionStabilityAnalysis]':
