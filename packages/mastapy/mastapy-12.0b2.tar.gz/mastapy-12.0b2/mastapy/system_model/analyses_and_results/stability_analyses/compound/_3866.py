...
class ConicalGearCompoundStabilityAnalysis(_3892.GearCompoundStabilityAnalysis):
    """ConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3736.ConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3736.ConicalGearStabilityAnalysis]':
