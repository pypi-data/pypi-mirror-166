...
class SpiralBevelGearMeshCompoundStabilityAnalysis(_3851.BevelGearMeshCompoundStabilityAnalysis):
    """SpiralBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3802.SpiralBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3802.SpiralBevelGearMeshStabilityAnalysis]':
