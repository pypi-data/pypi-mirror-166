...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3957, _3958, _3894
...
class WormGearSetCompoundStabilityAnalysis(_3894.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3829.WormGearSetStabilityAnalysis]':
    ...
    @property
    def worm_gears_compound_stability_analysis(self) -> 'List[_3957.WormGearCompoundStabilityAnalysis]':
    ...
    @property
    def worm_meshes_compound_stability_analysis(self) -> 'List[_3958.WormGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3829.WormGearSetStabilityAnalysis]':
