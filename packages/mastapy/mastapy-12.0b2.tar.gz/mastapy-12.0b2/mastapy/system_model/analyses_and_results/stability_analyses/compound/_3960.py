...
class ZerolBevelGearCompoundStabilityAnalysis(_3850.BevelGearCompoundStabilityAnalysis):
    """ZerolBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3833.ZerolBevelGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3833.ZerolBevelGearStabilityAnalysis]':
