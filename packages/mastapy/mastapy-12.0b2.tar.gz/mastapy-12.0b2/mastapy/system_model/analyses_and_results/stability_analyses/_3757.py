...
from mastapy.system_model.analyses_and_results.stability_analyses import _3758, _3756, _3762
...
class FaceGearSetStabilityAnalysis(_3762.GearSetStabilityAnalysis):
    """FaceGearSetStabilityAnalysis
    ...
    @property
    def face_gears_stability_analysis(self) -> 'List[_3758.FaceGearStabilityAnalysis]':
    ...
    @property
    def face_meshes_stability_analysis(self) -> 'List[_3756.FaceGearMeshStabilityAnalysis]':
