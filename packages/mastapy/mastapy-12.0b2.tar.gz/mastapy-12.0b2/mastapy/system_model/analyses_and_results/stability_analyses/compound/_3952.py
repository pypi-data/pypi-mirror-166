...
class TorqueConverterConnectionCompoundStabilityAnalysis(_3872.CouplingConnectionCompoundStabilityAnalysis):
    """TorqueConverterConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3822.TorqueConverterConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3822.TorqueConverterConnectionStabilityAnalysis]':
