...
class SpecialisedAssemblyCompoundStabilityAnalysis(_3834.AbstractAssemblyCompoundStabilityAnalysis):
    """SpecialisedAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3801.SpecialisedAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3801.SpecialisedAssemblyStabilityAnalysis]':
