...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3873
...
class PartToPartShearCouplingHalfCompoundStabilityAnalysis(_3873.CouplingHalfCompoundStabilityAnalysis):
    """PartToPartShearCouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3784.PartToPartShearCouplingHalfStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3784.PartToPartShearCouplingHalfStabilityAnalysis]':
