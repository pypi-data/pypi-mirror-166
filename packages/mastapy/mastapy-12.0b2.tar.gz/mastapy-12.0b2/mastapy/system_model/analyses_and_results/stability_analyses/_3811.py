...
from mastapy.system_model.analyses_and_results.stability_analyses import _3812, _3810, _3719
...
class StraightBevelDiffGearSetStabilityAnalysis(_3719.BevelGearSetStabilityAnalysis):
    """StraightBevelDiffGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_diff_gears_stability_analysis(self) -> 'List[_3812.StraightBevelDiffGearStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_stability_analysis(self) -> 'List[_3810.StraightBevelDiffGearMeshStabilityAnalysis]':
