...
class AGMAGleasonConicalGearMeshCompoundStabilityAnalysis(_3867.ConicalGearMeshCompoundStabilityAnalysis):
    """AGMAGleasonConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3706.AGMAGleasonConicalGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3706.AGMAGleasonConicalGearMeshStabilityAnalysis]':
