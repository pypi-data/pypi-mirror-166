...
class BevelDifferentialGearCompoundStabilityAnalysis(_3850.BevelGearCompoundStabilityAnalysis):
    """BevelDifferentialGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3715.BevelDifferentialGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3715.BevelDifferentialGearStabilityAnalysis]':
