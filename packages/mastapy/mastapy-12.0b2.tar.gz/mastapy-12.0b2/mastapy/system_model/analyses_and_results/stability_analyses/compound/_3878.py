...
class CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis(_3858.CoaxialConnectionCompoundStabilityAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3747.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3747.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
