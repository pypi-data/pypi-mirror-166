...
class StraightBevelSunGearCompoundStabilityAnalysis(_3939.StraightBevelDiffGearCompoundStabilityAnalysis):
    """StraightBevelSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3817.StraightBevelSunGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3817.StraightBevelSunGearStabilityAnalysis]':
