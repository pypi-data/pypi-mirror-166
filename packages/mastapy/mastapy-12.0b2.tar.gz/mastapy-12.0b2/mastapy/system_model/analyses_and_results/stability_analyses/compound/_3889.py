...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3887, _3888, _3894
...
class FaceGearSetCompoundStabilityAnalysis(_3894.GearSetCompoundStabilityAnalysis):
    """FaceGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3757.FaceGearSetStabilityAnalysis]':
    ...
    @property
    def face_gears_compound_stability_analysis(self) -> 'List[_3887.FaceGearCompoundStabilityAnalysis]':
    ...
    @property
    def face_meshes_compound_stability_analysis(self) -> 'List[_3888.FaceGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3757.FaceGearSetStabilityAnalysis]':
