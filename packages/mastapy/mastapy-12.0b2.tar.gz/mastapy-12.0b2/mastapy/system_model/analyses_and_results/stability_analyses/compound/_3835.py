...
class AbstractShaftCompoundStabilityAnalysis(_3836.AbstractShaftOrHousingCompoundStabilityAnalysis):
    """AbstractShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3704.AbstractShaftStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3704.AbstractShaftStabilityAnalysis]':
