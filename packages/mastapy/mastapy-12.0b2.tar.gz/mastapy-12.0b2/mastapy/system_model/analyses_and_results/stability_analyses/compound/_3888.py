...
class FaceGearMeshCompoundStabilityAnalysis(_3893.GearMeshCompoundStabilityAnalysis):
    """FaceGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3756.FaceGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3756.FaceGearMeshStabilityAnalysis]':
