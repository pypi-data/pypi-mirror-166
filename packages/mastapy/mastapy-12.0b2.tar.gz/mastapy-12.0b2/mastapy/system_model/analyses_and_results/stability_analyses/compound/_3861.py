...
class ConceptCouplingConnectionCompoundStabilityAnalysis(_3872.CouplingConnectionCompoundStabilityAnalysis):
    """ConceptCouplingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3728.ConceptCouplingConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3728.ConceptCouplingConnectionStabilityAnalysis]':
