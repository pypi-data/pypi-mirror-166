...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3939, _3940, _3852
...
class StraightBevelDiffGearSetCompoundStabilityAnalysis(_3852.BevelGearSetCompoundStabilityAnalysis):
    """StraightBevelDiffGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3811.StraightBevelDiffGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_stability_analysis(self) -> 'List[_3939.StraightBevelDiffGearCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_stability_analysis(self) -> 'List[_3940.StraightBevelDiffGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3811.StraightBevelDiffGearSetStabilityAnalysis]':
