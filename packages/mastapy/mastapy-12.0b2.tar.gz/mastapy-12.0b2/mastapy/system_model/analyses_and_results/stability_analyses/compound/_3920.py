...
class PointLoadCompoundStabilityAnalysis(_3956.VirtualComponentCompoundStabilityAnalysis):
    """PointLoadCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3789.PointLoadStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3789.PointLoadStabilityAnalysis]':
