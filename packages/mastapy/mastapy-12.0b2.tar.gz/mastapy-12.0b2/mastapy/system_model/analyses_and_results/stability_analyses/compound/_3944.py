...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3942, _3943, _3852
...
class StraightBevelGearSetCompoundStabilityAnalysis(_3852.BevelGearSetCompoundStabilityAnalysis):
    """StraightBevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3814.StraightBevelGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_stability_analysis(self) -> 'List[_3942.StraightBevelGearCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_stability_analysis(self) -> 'List[_3943.StraightBevelGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3814.StraightBevelGearSetStabilityAnalysis]':
