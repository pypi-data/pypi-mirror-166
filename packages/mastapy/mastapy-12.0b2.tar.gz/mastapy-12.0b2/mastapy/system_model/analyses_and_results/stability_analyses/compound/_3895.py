...
class GuideDxfModelCompoundStabilityAnalysis(_3859.ComponentCompoundStabilityAnalysis):
    """GuideDxfModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3764.GuideDxfModelStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3764.GuideDxfModelStabilityAnalysis]':
