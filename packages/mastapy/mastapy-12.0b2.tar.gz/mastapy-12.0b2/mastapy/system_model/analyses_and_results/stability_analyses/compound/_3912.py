...
class OilSealCompoundStabilityAnalysis(_3870.ConnectorCompoundStabilityAnalysis):
    """OilSealCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3781.OilSealStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3781.OilSealStabilityAnalysis]':
