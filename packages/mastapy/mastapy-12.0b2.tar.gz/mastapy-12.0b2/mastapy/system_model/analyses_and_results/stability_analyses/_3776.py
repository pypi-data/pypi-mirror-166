...
from mastapy.system_model.analyses_and_results.stability_analyses import _3777, _3775, _3770
...
class KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis(_3770.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_stability_analysis(self) -> 'List[_3777.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_stability_analysis(self) -> 'List[_3775.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis]':
