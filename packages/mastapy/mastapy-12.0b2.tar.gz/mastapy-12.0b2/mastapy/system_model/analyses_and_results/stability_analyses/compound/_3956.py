...
class VirtualComponentCompoundStabilityAnalysis(_3911.MountableComponentCompoundStabilityAnalysis):
    """VirtualComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3827.VirtualComponentStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3827.VirtualComponentStabilityAnalysis]':
