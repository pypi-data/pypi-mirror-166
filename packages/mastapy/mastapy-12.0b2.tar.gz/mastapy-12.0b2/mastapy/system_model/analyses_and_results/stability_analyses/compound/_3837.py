...
class AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3869.ConnectionCompoundStabilityAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3705.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3705.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
