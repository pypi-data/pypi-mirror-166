...
class HypoidGearMeshCompoundStabilityAnalysis(_3839.AGMAGleasonConicalGearMeshCompoundStabilityAnalysis):
    """HypoidGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3765.HypoidGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3765.HypoidGearMeshStabilityAnalysis]':
