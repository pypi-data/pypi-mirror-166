...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3903, _3904, _3902
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis(_3902.KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3773.KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_stability_analysis(self) -> 'List[_3903.KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_stability_analysis(self) -> 'List[_3904.KlingelnbergCycloPalloidHypoidGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3773.KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis]':
