...
class StraightBevelDiffGearMeshCompoundStabilityAnalysis(_3851.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelDiffGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3810.StraightBevelDiffGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3810.StraightBevelDiffGearMeshStabilityAnalysis]':
