...
class RootAssemblyCompoundStabilityAnalysis(_3841.AssemblyCompoundStabilityAnalysis):
    """RootAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3797.RootAssemblyStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3797.RootAssemblyStabilityAnalysis]':
