...
class ConicalGearSetCompoundStabilityAnalysis(_3894.GearSetCompoundStabilityAnalysis):
    """ConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3735.ConicalGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3735.ConicalGearSetStabilityAnalysis]':
