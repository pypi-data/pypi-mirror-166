...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3084, _3085, _3115
...
class ConceptGearSetCompoundSteadyStateSynchronousResponse(_3115.GearSetCompoundSteadyStateSynchronousResponse):
    """ConceptGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2952.ConceptGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_gears_compound_steady_state_synchronous_response(self) -> 'List[_3084.ConceptGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3085.ConceptGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2952.ConceptGearSetSteadyStateSynchronousResponse]':
