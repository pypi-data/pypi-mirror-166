...
class RootAssemblyCompoundSteadyStateSynchronousResponse(_3062.AssemblyCompoundSteadyStateSynchronousResponse):
    """RootAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3017.RootAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3017.RootAssemblySteadyStateSynchronousResponse]':
