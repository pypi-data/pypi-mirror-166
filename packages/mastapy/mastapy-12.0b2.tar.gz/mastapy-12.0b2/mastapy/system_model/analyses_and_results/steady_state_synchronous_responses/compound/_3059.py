...
class AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse(_3087.ConicalGearCompoundSteadyStateSynchronousResponse):
    """AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2928.AGMAGleasonConicalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2928.AGMAGleasonConicalGearSteadyStateSynchronousResponse]':
