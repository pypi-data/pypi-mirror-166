...
class TorqueConverterCompoundSteadyStateSynchronousResponse(_3092.CouplingCompoundSteadyStateSynchronousResponse):
    """TorqueConverterCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3045.TorqueConverterSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3045.TorqueConverterSteadyStateSynchronousResponse]':
