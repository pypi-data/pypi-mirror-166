...
class ZerolBevelGearCompoundSteadyStateSynchronousResponse(_3071.BevelGearCompoundSteadyStateSynchronousResponse):
    """ZerolBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3054.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3054.ZerolBevelGearSteadyStateSynchronousResponse]':
