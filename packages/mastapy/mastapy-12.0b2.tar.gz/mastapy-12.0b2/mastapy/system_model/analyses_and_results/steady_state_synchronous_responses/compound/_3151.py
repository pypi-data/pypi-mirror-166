...
class ShaftHubConnectionCompoundSteadyStateSynchronousResponse(_3091.ConnectorCompoundSteadyStateSynchronousResponse):
    """ShaftHubConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3018.ShaftHubConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3018.ShaftHubConnectionSteadyStateSynchronousResponse]':
