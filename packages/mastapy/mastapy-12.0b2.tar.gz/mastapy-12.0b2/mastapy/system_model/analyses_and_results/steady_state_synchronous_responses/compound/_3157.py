...
class SpringDamperCompoundSteadyStateSynchronousResponse(_3092.CouplingCompoundSteadyStateSynchronousResponse):
    """SpringDamperCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3027.SpringDamperSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3027.SpringDamperSteadyStateSynchronousResponse]':
