...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponse(_3170.SynchroniserPartCompoundSteadyStateSynchronousResponse):
    """SynchroniserSleeveCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3041.SynchroniserSleeveSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3041.SynchroniserSleeveSteadyStateSynchronousResponse]':
