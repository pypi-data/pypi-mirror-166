...
class PlanetaryConnectionCompoundSteadyStateSynchronousResponse(_3152.ShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """PlanetaryConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3006.PlanetaryConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3006.PlanetaryConnectionSteadyStateSynchronousResponse]':
