...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2935, _2933, _2939
...
class BevelDifferentialGearSetSteadyStateSynchronousResponse(_2939.BevelGearSetSteadyStateSynchronousResponse):
    """BevelDifferentialGearSetSteadyStateSynchronousResponse
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response(self) -> 'List[_2935.BevelDifferentialGearSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_meshes_steady_state_synchronous_response(self) -> 'List[_2933.BevelDifferentialGearMeshSteadyStateSynchronousResponse]':
