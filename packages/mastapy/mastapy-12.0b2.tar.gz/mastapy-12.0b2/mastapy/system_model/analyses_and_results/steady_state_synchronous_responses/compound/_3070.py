...
class BevelDifferentialSunGearCompoundSteadyStateSynchronousResponse(_3066.BevelDifferentialGearCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialSunGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2937.BevelDifferentialSunGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2937.BevelDifferentialSunGearSteadyStateSynchronousResponse]':
