...
class ConceptCouplingConnectionCompoundSteadyStateSynchronousResponse(_3093.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """ConceptCouplingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2948.ConceptCouplingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2948.ConceptCouplingConnectionSteadyStateSynchronousResponse]':
