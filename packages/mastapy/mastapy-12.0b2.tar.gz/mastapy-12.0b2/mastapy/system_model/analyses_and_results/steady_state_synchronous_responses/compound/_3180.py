...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3178, _3179, _3115
...
class WormGearSetCompoundSteadyStateSynchronousResponse(_3115.GearSetCompoundSteadyStateSynchronousResponse):
    """WormGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3050.WormGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_gears_compound_steady_state_synchronous_response(self) -> 'List[_3178.WormGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def worm_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3179.WormGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3050.WormGearSetSteadyStateSynchronousResponse]':
