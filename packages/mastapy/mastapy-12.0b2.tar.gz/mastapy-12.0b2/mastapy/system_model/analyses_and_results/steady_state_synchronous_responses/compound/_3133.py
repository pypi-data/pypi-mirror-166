...
class OilSealCompoundSteadyStateSynchronousResponse(_3091.ConnectorCompoundSteadyStateSynchronousResponse):
    """OilSealCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3001.OilSealSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3001.OilSealSteadyStateSynchronousResponse]':
