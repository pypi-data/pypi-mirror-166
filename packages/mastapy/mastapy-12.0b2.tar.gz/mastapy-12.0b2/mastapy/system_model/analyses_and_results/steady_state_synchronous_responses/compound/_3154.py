...
class SpiralBevelGearCompoundSteadyStateSynchronousResponse(_3071.BevelGearCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3024.SpiralBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3024.SpiralBevelGearSteadyStateSynchronousResponse]':
