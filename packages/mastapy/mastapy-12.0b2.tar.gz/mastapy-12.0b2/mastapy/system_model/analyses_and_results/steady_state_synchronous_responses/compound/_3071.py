...
class BevelGearCompoundSteadyStateSynchronousResponse(_3059.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    """BevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2940.BevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2940.BevelGearSteadyStateSynchronousResponse]':
