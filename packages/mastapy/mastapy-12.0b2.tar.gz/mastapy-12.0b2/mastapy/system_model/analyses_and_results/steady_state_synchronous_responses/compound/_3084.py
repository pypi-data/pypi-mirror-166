...
class ConceptGearCompoundSteadyStateSynchronousResponse(_3113.GearCompoundSteadyStateSynchronousResponse):
    """ConceptGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2953.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2953.ConceptGearSteadyStateSynchronousResponse]':
