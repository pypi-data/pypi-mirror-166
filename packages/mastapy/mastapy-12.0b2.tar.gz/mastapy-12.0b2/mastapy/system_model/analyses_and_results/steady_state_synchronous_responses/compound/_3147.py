...
class RollingRingCompoundSteadyStateSynchronousResponse(_3094.CouplingHalfCompoundSteadyStateSynchronousResponse):
    """RollingRingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3016.RollingRingSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3016.RollingRingSteadyStateSynchronousResponse]':
