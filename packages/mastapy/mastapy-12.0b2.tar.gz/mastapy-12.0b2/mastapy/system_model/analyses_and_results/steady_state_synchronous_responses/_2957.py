...
class ConnectionSteadyStateSynchronousResponse(_7458.ConnectionStaticLoadAnalysisCase):
    """ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3028.SteadyStateSynchronousResponse':
