...
class ConicalGearCompoundSteadyStateSynchronousResponse(_3113.GearCompoundSteadyStateSynchronousResponse):
    """ConicalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2956.ConicalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2956.ConicalGearSteadyStateSynchronousResponse]':
