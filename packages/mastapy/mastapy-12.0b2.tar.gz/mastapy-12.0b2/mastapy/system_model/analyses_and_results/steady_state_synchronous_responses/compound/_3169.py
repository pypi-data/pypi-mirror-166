...
class SynchroniserHalfCompoundSteadyStateSynchronousResponse(_3170.SynchroniserPartCompoundSteadyStateSynchronousResponse):
    """SynchroniserHalfCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3039.SynchroniserHalfSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3039.SynchroniserHalfSteadyStateSynchronousResponse]':
