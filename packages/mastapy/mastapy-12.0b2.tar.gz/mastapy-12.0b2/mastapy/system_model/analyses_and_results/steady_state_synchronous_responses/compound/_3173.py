...
class TorqueConverterConnectionCompoundSteadyStateSynchronousResponse(_3093.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """TorqueConverterConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3043.TorqueConverterConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3043.TorqueConverterConnectionSteadyStateSynchronousResponse]':
