...
class FaceGearCompoundSteadyStateSynchronousResponse(_3113.GearCompoundSteadyStateSynchronousResponse):
    """FaceGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2978.FaceGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2978.FaceGearSteadyStateSynchronousResponse]':
