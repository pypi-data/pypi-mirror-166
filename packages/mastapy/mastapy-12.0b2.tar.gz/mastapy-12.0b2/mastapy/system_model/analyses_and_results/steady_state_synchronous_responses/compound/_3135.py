...
class PartToPartShearCouplingCompoundSteadyStateSynchronousResponse(_3092.CouplingCompoundSteadyStateSynchronousResponse):
    """PartToPartShearCouplingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3005.PartToPartShearCouplingSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3005.PartToPartShearCouplingSteadyStateSynchronousResponse]':
