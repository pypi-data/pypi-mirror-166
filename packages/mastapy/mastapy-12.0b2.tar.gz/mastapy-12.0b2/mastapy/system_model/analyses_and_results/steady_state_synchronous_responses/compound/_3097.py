...
class CVTPulleyCompoundSteadyStateSynchronousResponse(_3143.PulleyCompoundSteadyStateSynchronousResponse):
    """CVTPulleyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2963.CVTPulleySteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2963.CVTPulleySteadyStateSynchronousResponse]':
