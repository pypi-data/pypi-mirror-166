...
class CycloidalAssemblyCompoundSteadyStateSynchronousResponse(_3153.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """CycloidalAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2965.CycloidalAssemblySteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2965.CycloidalAssemblySteadyStateSynchronousResponse]':
