...
class CVTCompoundSteadyStateSynchronousResponse(_3065.BeltDriveCompoundSteadyStateSynchronousResponse):
    """CVTCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2964.CVTSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2964.CVTSteadyStateSynchronousResponse]':
