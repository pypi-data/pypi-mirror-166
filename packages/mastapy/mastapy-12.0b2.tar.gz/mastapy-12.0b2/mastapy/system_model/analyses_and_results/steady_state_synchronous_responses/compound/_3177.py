...
class VirtualComponentCompoundSteadyStateSynchronousResponse(_3132.MountableComponentCompoundSteadyStateSynchronousResponse):
    """VirtualComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3048.VirtualComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3048.VirtualComponentSteadyStateSynchronousResponse]':
