...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse(_3080.ComponentCompoundSteadyStateSynchronousResponse):
    """AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2923.AbstractShaftOrHousingSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2923.AbstractShaftOrHousingSteadyStateSynchronousResponse]':
