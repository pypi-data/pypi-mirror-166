...
class BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse(_3066.BevelDifferentialGearCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2936.BevelDifferentialPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2936.BevelDifferentialPlanetGearSteadyStateSynchronousResponse]':
