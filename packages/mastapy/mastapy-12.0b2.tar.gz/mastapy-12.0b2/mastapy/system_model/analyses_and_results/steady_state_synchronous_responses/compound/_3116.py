...
class GuideDxfModelCompoundSteadyStateSynchronousResponse(_3080.ComponentCompoundSteadyStateSynchronousResponse):
    """GuideDxfModelCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2984.GuideDxfModelSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2984.GuideDxfModelSteadyStateSynchronousResponse]':
