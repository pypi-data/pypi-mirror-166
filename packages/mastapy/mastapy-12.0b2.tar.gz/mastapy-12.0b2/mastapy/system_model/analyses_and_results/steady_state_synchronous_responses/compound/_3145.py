...
class RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponse(_3120.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    """RingPinsToDiscConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3013.RingPinsToDiscConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3013.RingPinsToDiscConnectionSteadyStateSynchronousResponse]':
