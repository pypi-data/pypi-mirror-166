...
class CycloidalDiscCompoundSteadyStateSynchronousResponse(_3056.AbstractShaftCompoundSteadyStateSynchronousResponse):
    """CycloidalDiscCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2968.CycloidalDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2968.CycloidalDiscSteadyStateSynchronousResponse]':
