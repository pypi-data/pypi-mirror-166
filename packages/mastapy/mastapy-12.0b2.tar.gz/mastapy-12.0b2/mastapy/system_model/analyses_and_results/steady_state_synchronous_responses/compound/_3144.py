...
class RingPinsCompoundSteadyStateSynchronousResponse(_3132.MountableComponentCompoundSteadyStateSynchronousResponse):
    """RingPinsCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3012.RingPinsSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3012.RingPinsSteadyStateSynchronousResponse]':
