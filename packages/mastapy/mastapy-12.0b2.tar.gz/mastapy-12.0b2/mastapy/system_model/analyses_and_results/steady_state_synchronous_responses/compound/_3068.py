...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3066, _3067, _3073
...
class BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse(_3073.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2934.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_gears_compound_steady_state_synchronous_response(self) -> 'List[_3066.BevelDifferentialGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def bevel_differential_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3067.BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2934.BevelDifferentialGearSetSteadyStateSynchronousResponse]':
