...
class ShaftCompoundSteadyStateSynchronousResponse(_3056.AbstractShaftCompoundSteadyStateSynchronousResponse):
    """ShaftCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3019.ShaftSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3019.ShaftSteadyStateSynchronousResponse]':
