...
class MassDiscCompoundSteadyStateSynchronousResponse(_3177.VirtualComponentCompoundSteadyStateSynchronousResponse):
    """MassDiscCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2998.MassDiscSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2998.MassDiscSteadyStateSynchronousResponse]':
