...
class CylindricalPlanetGearCompoundSteadyStateSynchronousResponse(_3102.CylindricalGearCompoundSteadyStateSynchronousResponse):
    """CylindricalPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2972.CylindricalPlanetGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2972.CylindricalPlanetGearSteadyStateSynchronousResponse]':
