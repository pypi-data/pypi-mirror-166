...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3154, _3155, _3073
...
class SpiralBevelGearSetCompoundSteadyStateSynchronousResponse(_3073.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """SpiralBevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3023.SpiralBevelGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_gears_compound_steady_state_synchronous_response(self) -> 'List[_3154.SpiralBevelGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def spiral_bevel_meshes_compound_steady_state_synchronous_response(self) -> 'List[_3155.SpiralBevelGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3023.SpiralBevelGearSetSteadyStateSynchronousResponse]':
