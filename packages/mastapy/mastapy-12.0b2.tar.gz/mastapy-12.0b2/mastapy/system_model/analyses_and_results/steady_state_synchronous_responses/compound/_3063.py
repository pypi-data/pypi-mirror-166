...
class BearingCompoundSteadyStateSynchronousResponse(_3091.ConnectorCompoundSteadyStateSynchronousResponse):
    """BearingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2930.BearingSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2930.BearingSteadyStateSynchronousResponse]':
