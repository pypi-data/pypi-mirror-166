...
class ClutchCompoundSteadyStateSynchronousResponse(_3092.CouplingCompoundSteadyStateSynchronousResponse):
    """ClutchCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2945.ClutchSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2945.ClutchSteadyStateSynchronousResponse]':
