...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3033, _3031, _2939
...
class StraightBevelDiffGearSetSteadyStateSynchronousResponse(_2939.BevelGearSetSteadyStateSynchronousResponse):
    """StraightBevelDiffGearSetSteadyStateSynchronousResponse
    ...
    @property
    def straight_bevel_diff_gears_steady_state_synchronous_response(self) -> 'List[_3033.StraightBevelDiffGearSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_meshes_steady_state_synchronous_response(self) -> 'List[_3031.StraightBevelDiffGearMeshSteadyStateSynchronousResponse]':
