...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def active_report_as_text(self) -> '_1716.CustomReport':
    ...
    @property
    def component_design(self) -> '_2152.DesignEntity':
    ...
    @property
    def component_design_of_type_connection(self) -> '_2217.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2413.Part':
