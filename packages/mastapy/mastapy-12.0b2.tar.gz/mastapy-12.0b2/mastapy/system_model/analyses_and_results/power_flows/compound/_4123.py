...
class ClutchCompoundPowerFlow(_4139.CouplingCompoundPowerFlow):
    """ClutchCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3992.ClutchPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3992.ClutchPowerFlow]':
