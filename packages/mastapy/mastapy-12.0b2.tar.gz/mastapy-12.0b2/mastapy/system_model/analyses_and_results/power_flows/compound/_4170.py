...
class KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow(_4136.ConicalGearSetCompoundPowerFlow):
    """KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4038.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4038.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
