...
class PlanetCarrierCompoundPowerFlow(_4179.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4055.PlanetCarrierPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4055.PlanetCarrierPowerFlow]':
