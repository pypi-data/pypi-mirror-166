...
from mastapy.system_model.analyses_and_results.power_flows import _4081, _4080, _3987
...
class StraightBevelGearSetPowerFlow(_3987.BevelGearSetPowerFlow):
    """StraightBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4081.StraightBevelGearPowerFlow]':
    ...
    @property
    def straight_bevel_gears_power_flow(self) -> 'List[_4081.StraightBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4080.StraightBevelGearMeshPowerFlow]':
    ...
    @property
    def straight_bevel_meshes_power_flow(self) -> 'List[_4080.StraightBevelGearMeshPowerFlow]':
