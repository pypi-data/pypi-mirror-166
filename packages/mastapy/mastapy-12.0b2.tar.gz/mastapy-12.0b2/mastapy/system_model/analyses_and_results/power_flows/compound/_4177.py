...
class MassDiscCompoundPowerFlow(_4224.VirtualComponentCompoundPowerFlow):
    """MassDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4045.MassDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4045.MassDiscPowerFlow]':
