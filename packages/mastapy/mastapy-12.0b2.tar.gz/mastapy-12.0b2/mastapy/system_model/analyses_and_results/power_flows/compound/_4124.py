...
class ClutchConnectionCompoundPowerFlow(_4140.CouplingConnectionCompoundPowerFlow):
    """ClutchConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3990.ClutchConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3990.ClutchConnectionPowerFlow]':
