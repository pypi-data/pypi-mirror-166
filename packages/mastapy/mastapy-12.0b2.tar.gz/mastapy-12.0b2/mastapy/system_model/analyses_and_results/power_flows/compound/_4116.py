...
class BevelDifferentialPlanetGearCompoundPowerFlow(_4113.BevelDifferentialGearCompoundPowerFlow):
    """BevelDifferentialPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3983.BevelDifferentialPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3983.BevelDifferentialPlanetGearPowerFlow]':
