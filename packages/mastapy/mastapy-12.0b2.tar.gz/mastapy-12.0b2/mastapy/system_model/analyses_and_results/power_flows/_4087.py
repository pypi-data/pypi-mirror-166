...
from mastapy.system_model.analyses_and_results.power_flows import _4085, _4070
...
class SynchroniserPowerFlow(_4070.SpecialisedAssemblyPowerFlow):
    """SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_4085.SynchroniserHalfPowerFlow]':
