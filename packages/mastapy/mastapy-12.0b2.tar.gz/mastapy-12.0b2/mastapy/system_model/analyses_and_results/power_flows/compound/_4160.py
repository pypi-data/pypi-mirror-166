...
class GearCompoundPowerFlow(_4179.MountableComponentCompoundPowerFlow):
    """GearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4029.GearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4029.GearPowerFlow]':
