...
class WormGearCompoundPowerFlow(_4160.GearCompoundPowerFlow):
    """WormGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4097.WormGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4097.WormGearPowerFlow]':
