...
class FEPartCompoundPowerFlow(_4104.AbstractShaftOrHousingCompoundPowerFlow):
    """FEPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4026.FEPartPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4026.FEPartPowerFlow]':
