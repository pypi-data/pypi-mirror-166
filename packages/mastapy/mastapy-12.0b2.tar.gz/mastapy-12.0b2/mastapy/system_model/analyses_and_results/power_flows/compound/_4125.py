...
class ClutchHalfCompoundPowerFlow(_4141.CouplingHalfCompoundPowerFlow):
    """ClutchHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3991.ClutchHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3991.ClutchHalfPowerFlow]':
