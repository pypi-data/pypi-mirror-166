...
from mastapy.system_model.analyses_and_results.power_flows import (
    _3977, _3979, _3982, _3988,
    _3989, _4010, _3992, _3997,
    _4000, _4012, _4015, _4019,
    _4026, _4025, _4027, _4034,
    _4041, _4044, _4030, _4045,
    _4046, _4048, _4052, _4055,
    _4056, _4059, _4061, _4063,
    _4067, _4068, _4073, _4076,
    _4079, _4082, _4087, _4091,
    _4094, _4098, _4101, _3969
)
...
class AssemblyPowerFlow(_3969.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self) -> 'List[_3977.BearingPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_3979.BeltDrivePowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3982.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3988.BoltedJointPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_3989.BoltPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_4010.CVTPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_3992.ClutchPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3997.ConceptCouplingPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4000.ConceptGearSetPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4012.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4015.CycloidalDiscPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4019.CylindricalGearSetPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_4026.FEPartPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4025.FaceGearSetPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4027.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4034.HypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4041.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4044.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_4030.GearSetPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_4045.MassDiscPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_4046.MeasurementComponentPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_4048.OilSealPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4052.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4055.PlanetCarrierPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_4056.PointLoadPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_4059.PowerLoadPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_4061.RingPinsPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4063.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4067.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4068.ShaftPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4073.SpiralBevelGearSetPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4076.SpringDamperPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4079.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4082.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4087.SynchroniserPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4091.TorqueConverterPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4094.UnbalancedMassPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4098.WormGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4101.ZerolBevelGearSetPowerFlow]':
