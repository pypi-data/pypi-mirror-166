...
class HypoidGearCompoundPowerFlow(_4106.AGMAGleasonConicalGearCompoundPowerFlow):
    """HypoidGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4033.HypoidGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4033.HypoidGearPowerFlow]':
