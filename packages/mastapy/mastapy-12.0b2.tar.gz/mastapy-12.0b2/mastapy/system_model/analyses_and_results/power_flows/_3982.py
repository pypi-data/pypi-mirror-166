...
from mastapy.system_model.analyses_and_results.power_flows import _3981, _3980, _3987
...
class BevelDifferentialGearSetPowerFlow(_3987.BevelGearSetPowerFlow):
    """BevelDifferentialGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3981.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def bevel_differential_gears_power_flow(self) -> 'List[_3981.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3980.BevelDifferentialGearMeshPowerFlow]':
    ...
    @property
    def bevel_differential_meshes_power_flow(self) -> 'List[_3980.BevelDifferentialGearMeshPowerFlow]':
