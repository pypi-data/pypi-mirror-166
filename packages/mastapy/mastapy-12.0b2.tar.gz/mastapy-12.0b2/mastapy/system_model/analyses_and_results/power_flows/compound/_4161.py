...
class GearMeshCompoundPowerFlow(_4167.InterMountableComponentConnectionCompoundPowerFlow):
    """GearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4028.GearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4028.GearMeshPowerFlow]':
