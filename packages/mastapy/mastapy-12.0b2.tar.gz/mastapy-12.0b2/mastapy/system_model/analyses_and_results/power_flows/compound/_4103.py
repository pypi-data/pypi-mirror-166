...
class AbstractShaftCompoundPowerFlow(_4104.AbstractShaftOrHousingCompoundPowerFlow):
    """AbstractShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3971.AbstractShaftPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3971.AbstractShaftPowerFlow]':
