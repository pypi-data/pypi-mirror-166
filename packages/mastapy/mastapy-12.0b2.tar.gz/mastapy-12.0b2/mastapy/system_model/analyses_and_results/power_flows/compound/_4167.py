...
class InterMountableComponentConnectionCompoundPowerFlow(_4137.ConnectionCompoundPowerFlow):
    """InterMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4035.InterMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4035.InterMountableComponentConnectionPowerFlow]':
