...
class ConceptCouplingConnectionCompoundPowerFlow(_4140.CouplingConnectionCompoundPowerFlow):
    """ConceptCouplingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3995.ConceptCouplingConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3995.ConceptCouplingConnectionPowerFlow]':
