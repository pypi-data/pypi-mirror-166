...
from mastapy.system_model.analyses_and_results.power_flows import _4078, _4077, _3987
...
class StraightBevelDiffGearSetPowerFlow(_3987.BevelGearSetPowerFlow):
    """StraightBevelDiffGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4078.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gears_power_flow(self) -> 'List[_4078.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4077.StraightBevelDiffGearMeshPowerFlow]':
    ...
    @property
    def straight_bevel_diff_meshes_power_flow(self) -> 'List[_4077.StraightBevelDiffGearMeshPowerFlow]':
