...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4210, _4211, _4120
...
class StraightBevelGearSetCompoundPowerFlow(_4120.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4082.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gears_compound_power_flow(self) -> 'List[_4210.StraightBevelGearCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_meshes_compound_power_flow(self) -> 'List[_4211.StraightBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4082.StraightBevelGearSetPowerFlow]':
