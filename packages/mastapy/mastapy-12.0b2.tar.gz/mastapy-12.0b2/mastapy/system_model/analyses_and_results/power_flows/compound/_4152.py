...
class CylindricalPlanetGearCompoundPowerFlow(_4149.CylindricalGearCompoundPowerFlow):
    """CylindricalPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4020.CylindricalPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4020.CylindricalPlanetGearPowerFlow]':
