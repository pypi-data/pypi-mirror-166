...
class CylindricalGearMeshCompoundPowerFlow(_4161.GearMeshCompoundPowerFlow):
    """CylindricalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4017.CylindricalGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4017.CylindricalGearMeshPowerFlow]':
