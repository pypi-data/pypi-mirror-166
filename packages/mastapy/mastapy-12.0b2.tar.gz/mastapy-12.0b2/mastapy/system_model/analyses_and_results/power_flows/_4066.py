...
from mastapy.system_model.analyses_and_results.power_flows import _4057, _3976
...
class RootAssemblyPowerFlow(_3976.AssemblyPowerFlow):
    """RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_4057.PowerFlow':
