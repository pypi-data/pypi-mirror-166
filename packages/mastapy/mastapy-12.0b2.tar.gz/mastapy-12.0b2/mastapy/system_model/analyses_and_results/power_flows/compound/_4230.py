...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4228, _4229, _4120
...
class ZerolBevelGearSetCompoundPowerFlow(_4120.BevelGearSetCompoundPowerFlow):
    """ZerolBevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4101.ZerolBevelGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gears_compound_power_flow(self) -> 'List[_4228.ZerolBevelGearCompoundPowerFlow]':
    ...
    @property
    def zerol_bevel_meshes_compound_power_flow(self) -> 'List[_4229.ZerolBevelGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4101.ZerolBevelGearSetPowerFlow]':
