...
class CVTBeltConnectionCompoundPowerFlow(_4111.BeltConnectionCompoundPowerFlow):
    """CVTBeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4009.CVTBeltConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4009.CVTBeltConnectionPowerFlow]':
