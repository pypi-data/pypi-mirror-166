...
class BoltedJointCompoundPowerFlow(_4200.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3988.BoltedJointPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3988.BoltedJointPowerFlow]':
