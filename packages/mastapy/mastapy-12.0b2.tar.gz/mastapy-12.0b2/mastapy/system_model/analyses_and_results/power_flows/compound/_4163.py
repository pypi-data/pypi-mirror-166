...
class GuideDxfModelCompoundPowerFlow(_4127.ComponentCompoundPowerFlow):
    """GuideDxfModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4031.GuideDxfModelPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4031.GuideDxfModelPowerFlow]':
