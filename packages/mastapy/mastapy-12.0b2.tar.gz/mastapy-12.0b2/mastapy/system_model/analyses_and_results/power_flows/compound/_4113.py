...
class BevelDifferentialGearCompoundPowerFlow(_4118.BevelGearCompoundPowerFlow):
    """BevelDifferentialGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3981.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3981.BevelDifferentialGearPowerFlow]':
