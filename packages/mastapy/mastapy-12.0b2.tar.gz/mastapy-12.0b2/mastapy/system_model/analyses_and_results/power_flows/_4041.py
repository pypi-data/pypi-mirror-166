...
from mastapy.system_model.analyses_and_results.power_flows import _4040, _4039, _4038
...
class KlingelnbergCycloPalloidHypoidGearSetPowerFlow(_4038.KlingelnbergCycloPalloidConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidHypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4040.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_power_flow(self) -> 'List[_4040.KlingelnbergCycloPalloidHypoidGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4039.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_power_flow(self) -> 'List[_4039.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]':
