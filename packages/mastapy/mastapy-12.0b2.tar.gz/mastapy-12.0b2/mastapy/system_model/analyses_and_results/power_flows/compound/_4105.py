...
class AbstractShaftToMountableComponentConnectionCompoundPowerFlow(_4137.ConnectionCompoundPowerFlow):
    """AbstractShaftToMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3972.AbstractShaftToMountableComponentConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3972.AbstractShaftToMountableComponentConnectionPowerFlow]':
