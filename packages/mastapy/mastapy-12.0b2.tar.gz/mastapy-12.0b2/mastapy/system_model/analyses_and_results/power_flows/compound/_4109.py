...
from mastapy.system_model.analyses_and_results.power_flows.compound import (
    _4110, _4112, _4115, _4122,
    _4121, _4143, _4123, _4128,
    _4133, _4145, _4147, _4151,
    _4158, _4157, _4159, _4166,
    _4173, _4176, _4177, _4178,
    _4180, _4182, _4187, _4188,
    _4189, _4191, _4193, _4198,
    _4197, _4203, _4204, _4209,
    _4212, _4215, _4219, _4223,
    _4227, _4230, _4102
)
...
class AssemblyCompoundPowerFlow(_4102.AbstractAssemblyCompoundPowerFlow):
    """AssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3976.AssemblyPowerFlow]':
    ...
    @property
    def bearings(self) -> 'List[_4110.BearingCompoundPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_4112.BeltDriveCompoundPowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4115.BevelDifferentialGearSetCompoundPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4122.BoltedJointCompoundPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_4121.BoltCompoundPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_4143.CVTCompoundPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_4123.ClutchCompoundPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4128.ConceptCouplingCompoundPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4133.ConceptGearSetCompoundPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4145.CycloidalAssemblyCompoundPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4147.CycloidalDiscCompoundPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4151.CylindricalGearSetCompoundPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_4158.FEPartCompoundPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4157.FaceGearSetCompoundPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4159.FlexiblePinAssemblyCompoundPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4166.HypoidGearSetCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4173.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4176.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_4177.MassDiscCompoundPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_4178.MeasurementComponentCompoundPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_4180.OilSealCompoundPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4182.PartToPartShearCouplingCompoundPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4187.PlanetCarrierCompoundPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_4188.PointLoadCompoundPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_4189.PowerLoadCompoundPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_4191.RingPinsCompoundPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4193.RollingRingAssemblyCompoundPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4198.ShaftHubConnectionCompoundPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4197.ShaftCompoundPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4203.SpiralBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4204.SpringDamperCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4209.StraightBevelDiffGearSetCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4212.StraightBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4215.SynchroniserCompoundPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4219.TorqueConverterCompoundPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4223.UnbalancedMassCompoundPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4227.WormGearSetCompoundPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4230.ZerolBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3976.AssemblyPowerFlow]':
