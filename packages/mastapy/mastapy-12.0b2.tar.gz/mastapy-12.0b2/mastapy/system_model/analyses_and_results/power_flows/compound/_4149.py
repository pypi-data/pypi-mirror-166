...
class CylindricalGearCompoundPowerFlow(_4160.GearCompoundPowerFlow):
    """CylindricalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4018.CylindricalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4018.CylindricalGearPowerFlow]':
