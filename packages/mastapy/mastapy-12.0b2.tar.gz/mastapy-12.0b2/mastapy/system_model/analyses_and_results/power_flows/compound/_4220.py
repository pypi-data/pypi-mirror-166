...
class TorqueConverterConnectionCompoundPowerFlow(_4140.CouplingConnectionCompoundPowerFlow):
    """TorqueConverterConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4090.TorqueConverterConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4090.TorqueConverterConnectionPowerFlow]':
