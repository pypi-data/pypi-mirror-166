...
class ConceptCouplingHalfCompoundPowerFlow(_4141.CouplingHalfCompoundPowerFlow):
    """ConceptCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3996.ConceptCouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3996.ConceptCouplingHalfPowerFlow]':
