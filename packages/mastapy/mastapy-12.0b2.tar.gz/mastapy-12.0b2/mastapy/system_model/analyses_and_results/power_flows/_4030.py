...
from mastapy.system_model.analyses_and_results.power_flows import _4029, _4028, _4070
...
class GearSetPowerFlow(_4070.SpecialisedAssemblyPowerFlow):
    """GearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4029.GearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4028.GearMeshPowerFlow]':
