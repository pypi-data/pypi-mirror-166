...
class PlanetaryConnectionCompoundPowerFlow(_4199.ShaftToMountableComponentConnectionCompoundPowerFlow):
    """PlanetaryConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4053.PlanetaryConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4053.PlanetaryConnectionPowerFlow]':
