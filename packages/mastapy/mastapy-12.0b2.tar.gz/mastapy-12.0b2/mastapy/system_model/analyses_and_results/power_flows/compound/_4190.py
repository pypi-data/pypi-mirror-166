...
class PulleyCompoundPowerFlow(_4141.CouplingHalfCompoundPowerFlow):
    """PulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4060.PulleyPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4060.PulleyPowerFlow]':
