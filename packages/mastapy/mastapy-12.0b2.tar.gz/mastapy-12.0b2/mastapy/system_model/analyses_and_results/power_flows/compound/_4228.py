...
class ZerolBevelGearCompoundPowerFlow(_4118.BevelGearCompoundPowerFlow):
    """ZerolBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4100.ZerolBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4100.ZerolBevelGearPowerFlow]':
