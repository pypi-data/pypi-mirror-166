...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4207, _4208, _4120
...
class StraightBevelDiffGearSetCompoundPowerFlow(_4120.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4079.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gears_compound_power_flow(self) -> 'List[_4207.StraightBevelDiffGearCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_power_flow(self) -> 'List[_4208.StraightBevelDiffGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4079.StraightBevelDiffGearSetPowerFlow]':
