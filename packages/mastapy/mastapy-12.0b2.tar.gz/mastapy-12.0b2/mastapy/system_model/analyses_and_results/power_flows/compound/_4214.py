...
class StraightBevelSunGearCompoundPowerFlow(_4207.StraightBevelDiffGearCompoundPowerFlow):
    """StraightBevelSunGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4084.StraightBevelSunGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4084.StraightBevelSunGearPowerFlow]':
