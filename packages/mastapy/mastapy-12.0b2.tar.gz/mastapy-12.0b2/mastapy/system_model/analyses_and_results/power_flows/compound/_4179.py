...
class MountableComponentCompoundPowerFlow(_4127.ComponentCompoundPowerFlow):
    """MountableComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4047.MountableComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4047.MountableComponentPowerFlow]':
