...
from mastapy.system_model.analyses_and_results.power_flows import _4072, _4071, _3987
...
class SpiralBevelGearSetPowerFlow(_3987.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_4072.SpiralBevelGearPowerFlow]':
    ...
    @property
    def spiral_bevel_gears_power_flow(self) -> 'List[_4072.SpiralBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_4071.SpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def spiral_bevel_meshes_power_flow(self) -> 'List[_4071.SpiralBevelGearMeshPowerFlow]':
