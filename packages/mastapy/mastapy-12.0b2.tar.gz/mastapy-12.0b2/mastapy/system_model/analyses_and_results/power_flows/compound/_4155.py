...
class FaceGearCompoundPowerFlow(_4160.GearCompoundPowerFlow):
    """FaceGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4024.FaceGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4024.FaceGearPowerFlow]':
