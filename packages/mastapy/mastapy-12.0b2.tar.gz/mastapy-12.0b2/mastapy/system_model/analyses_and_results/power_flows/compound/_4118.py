...
class BevelGearCompoundPowerFlow(_4106.AGMAGleasonConicalGearCompoundPowerFlow):
    """BevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3986.BevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3986.BevelGearPowerFlow]':
