...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4164, _4165, _4108
...
class HypoidGearSetCompoundPowerFlow(_4108.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """HypoidGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4034.HypoidGearSetPowerFlow]':
    ...
    @property
    def hypoid_gears_compound_power_flow(self) -> 'List[_4164.HypoidGearCompoundPowerFlow]':
    ...
    @property
    def hypoid_meshes_compound_power_flow(self) -> 'List[_4165.HypoidGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4034.HypoidGearSetPowerFlow]':
