...
class CVTCompoundPowerFlow(_4112.BeltDriveCompoundPowerFlow):
    """CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4010.CVTPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4010.CVTPowerFlow]':
