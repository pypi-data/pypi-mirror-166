...
class CycloidalDiscCompoundPowerFlow(_4103.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4015.CycloidalDiscPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4015.CycloidalDiscPowerFlow]':
