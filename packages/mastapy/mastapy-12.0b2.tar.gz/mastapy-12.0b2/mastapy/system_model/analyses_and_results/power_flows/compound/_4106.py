...
class AGMAGleasonConicalGearCompoundPowerFlow(_4134.ConicalGearCompoundPowerFlow):
    """AGMAGleasonConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3974.AGMAGleasonConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3974.AGMAGleasonConicalGearPowerFlow]':
