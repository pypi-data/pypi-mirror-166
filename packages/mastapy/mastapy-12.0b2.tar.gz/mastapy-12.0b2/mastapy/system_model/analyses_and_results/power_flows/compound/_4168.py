...
class KlingelnbergCycloPalloidConicalGearCompoundPowerFlow(_4134.ConicalGearCompoundPowerFlow):
    """KlingelnbergCycloPalloidConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4037.KlingelnbergCycloPalloidConicalGearPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4037.KlingelnbergCycloPalloidConicalGearPowerFlow]':
