...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6732, _6724, _6814, _6735,
    _6744, _6749, _6762, _6767,
    _6784, _6805, _6826, _6833,
    _6836, _6839, _6852, _6874,
    _6880, _6883, _6903, _6906
)
...
class AdvancedTimeSteppingAnalysisForModulationOptions(_0.APIBase):
    ...
    @property
    def advanced_time_stepping_analysis_method(self) -> '_6732.AdvancedTimeSteppingAnalysisForModulationType':
        ...
        return constructor.new_from_mastapy_type(_6732.AdvancedTimeSteppingAnalysisForModulationType)(value) if value is not None else None

    @advanced_time_stepping_analysis_method.setter
    def advanced_time_stepping_analysis_method(self, value: '_6732.AdvancedTimeSteppingAnalysisForModulationType'):
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation(self) -> '_6814.GearSetLoadCase':
        ...
        if _6814.GearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_agma_gleason_conical_gear_set_load_case(self) -> '_6735.AGMAGleasonConicalGearSetLoadCase':
        ...
        if _6735.AGMAGleasonConicalGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_bevel_differential_gear_set_load_case(self) -> '_6744.BevelDifferentialGearSetLoadCase':
        ...
        if _6744.BevelDifferentialGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_bevel_gear_set_load_case(self) -> '_6749.BevelGearSetLoadCase':
        ...
        if _6749.BevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_concept_gear_set_load_case(self) -> '_6762.ConceptGearSetLoadCase':
        ...
        if _6762.ConceptGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_conical_gear_set_load_case(self) -> '_6767.ConicalGearSetLoadCase':
        ...
        if _6767.ConicalGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_cylindrical_gear_set_load_case(self) -> '_6784.CylindricalGearSetLoadCase':
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_face_gear_set_load_case(self) -> '_6805.FaceGearSetLoadCase':
        ...
        if _6805.FaceGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_hypoid_gear_set_load_case(self) -> '_6826.HypoidGearSetLoadCase':
        ...
        if _6826.HypoidGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_klingelnberg_cyclo_palloid_conical_gear_set_load_case(self) -> '_6833.KlingelnbergCycloPalloidConicalGearSetLoadCase':
        ...
        if _6833.KlingelnbergCycloPalloidConicalGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_load_case(self) -> '_6836.KlingelnbergCycloPalloidHypoidGearSetLoadCase':
        ...
        if _6836.KlingelnbergCycloPalloidHypoidGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_load_case(self) -> '_6839.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase':
        ...
        if _6839.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_planetary_gear_set_load_case(self) -> '_6852.PlanetaryGearSetLoadCase':
        ...
        if _6852.PlanetaryGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_spiral_bevel_gear_set_load_case(self) -> '_6874.SpiralBevelGearSetLoadCase':
        ...
        if _6874.SpiralBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_straight_bevel_diff_gear_set_load_case(self) -> '_6880.StraightBevelDiffGearSetLoadCase':
        ...
        if _6880.StraightBevelDiffGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_straight_bevel_gear_set_load_case(self) -> '_6883.StraightBevelGearSetLoadCase':
        ...
        if _6883.StraightBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_worm_gear_set_load_case(self) -> '_6903.WormGearSetLoadCase':
        ...
        if _6903.WormGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_set_load_case_within_load_case_for_advanced_time_stepping_analysis_for_modulation_of_type_zerol_bevel_gear_set_load_case(self) -> '_6906.ZerolBevelGearSetLoadCase':
        ...
        if _6906.ZerolBevelGearSetLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def time_options(self) -> '_2628.TimeOptions':
