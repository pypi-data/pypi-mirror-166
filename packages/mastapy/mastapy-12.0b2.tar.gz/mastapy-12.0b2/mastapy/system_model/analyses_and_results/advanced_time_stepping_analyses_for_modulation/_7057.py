...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7055, _7056, _6946
...
class ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6946.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2779.ZerolBevelGearSetSystemDeflection':
    ...
    @property
    def zerol_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7055.ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7056.ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
