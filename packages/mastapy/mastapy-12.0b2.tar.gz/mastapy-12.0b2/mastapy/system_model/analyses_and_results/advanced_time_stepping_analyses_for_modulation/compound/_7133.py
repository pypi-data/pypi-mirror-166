...
class MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation(_7180.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2407.MassDisc':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7004.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7004.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
