...
class CycloidalDiscCentralBearingConnectionAdvancedTimeSteppingAnalysisForModulation(_6952.CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscCentralBearingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_2280.CycloidalDiscCentralBearingConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2675.CycloidalDiscCentralBearingConnectionSystemDeflection':
