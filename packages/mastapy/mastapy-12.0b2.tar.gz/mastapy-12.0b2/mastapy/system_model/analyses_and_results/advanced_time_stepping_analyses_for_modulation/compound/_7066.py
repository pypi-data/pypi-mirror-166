...
class BearingCompoundAdvancedTimeSteppingAnalysisForModulation(_7094.ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BearingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6936.BearingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6936.BearingAdvancedTimeSteppingAnalysisForModulation]':
