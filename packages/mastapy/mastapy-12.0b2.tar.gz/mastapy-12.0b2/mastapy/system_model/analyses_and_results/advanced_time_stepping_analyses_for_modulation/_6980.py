...
class ExternalCADModelAdvancedTimeSteppingAnalysisForModulation(_6953.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """ExternalCADModelAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2691.ExternalCADModelSystemDeflection':
