...
class SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation(_7044.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2760.SynchroniserHalfSystemDeflection':
