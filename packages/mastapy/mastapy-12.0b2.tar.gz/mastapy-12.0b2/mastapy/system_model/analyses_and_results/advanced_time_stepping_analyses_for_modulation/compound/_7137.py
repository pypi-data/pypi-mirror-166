...
class PartCompoundAdvancedTimeSteppingAnalysisForModulation(_7463.PartCompoundAnalysis):
    """PartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7008.PartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7008.PartAdvancedTimeSteppingAnalysisForModulation]':
