...
class PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation(_7180.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7016.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7016.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
