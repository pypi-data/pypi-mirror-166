...
class CVTCompoundAdvancedTimeSteppingAnalysisForModulation(_7068.BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CVTCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6968.CVTAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6968.CVTAdvancedTimeSteppingAnalysisForModulation]':
