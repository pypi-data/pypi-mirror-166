...
class ConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7116.GearCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6960.ConicalGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6960.ConicalGearAdvancedTimeSteppingAnalysisForModulation]':
