...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7163, _7164, _7076
...
class StraightBevelDiffGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7076.BevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7036.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7163.StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7164.StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7036.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]':
