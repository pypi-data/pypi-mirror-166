...
class CVTAdvancedTimeSteppingAnalysisForModulation(_6938.BeltDriveAdvancedTimeSteppingAnalysisForModulation):
    """CVTAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_design(self) -> '_2530.CVT':
    ...
    @property
    def system_deflection_results(self) -> '_2673.CVTSystemDeflection':
