...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6981, _6982, _6988
...
class FaceGearSetAdvancedTimeSteppingAnalysisForModulation(_6988.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def face_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6981.FaceGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6982.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]':
