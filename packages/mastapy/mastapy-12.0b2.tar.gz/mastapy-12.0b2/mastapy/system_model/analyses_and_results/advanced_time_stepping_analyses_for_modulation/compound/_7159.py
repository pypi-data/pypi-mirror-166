...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _7157, _7158, _7076
...
class SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7076.BevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2488.SpiralBevelGearSet':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7030.SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_gears_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7157.SpiralBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_meshes_compound_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7158.SpiralBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7030.SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
