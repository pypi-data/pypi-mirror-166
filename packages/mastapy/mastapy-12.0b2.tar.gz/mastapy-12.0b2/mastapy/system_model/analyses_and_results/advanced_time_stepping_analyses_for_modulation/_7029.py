...
class SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6945.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2746.SpiralBevelGearMeshSystemDeflection':
