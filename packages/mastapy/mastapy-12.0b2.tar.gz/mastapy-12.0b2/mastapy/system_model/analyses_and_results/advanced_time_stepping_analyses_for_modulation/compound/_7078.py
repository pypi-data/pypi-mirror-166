...
class BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation(_7156.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltedJointCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2388.BoltedJoint':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6948.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6948.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
