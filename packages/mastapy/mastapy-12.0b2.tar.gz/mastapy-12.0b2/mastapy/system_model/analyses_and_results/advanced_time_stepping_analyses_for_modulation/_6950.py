...
class ClutchConnectionAdvancedTimeSteppingAnalysisForModulation(_6966.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """ClutchConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2650.ClutchConnectionSystemDeflection':
