...
class DatumCompoundAdvancedTimeSteppingAnalysisForModulation(_7083.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """DatumCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6979.DatumAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6979.DatumAdvancedTimeSteppingAnalysisForModulation]':
