...
class TorqueConverterPumpCompoundAdvancedTimeSteppingAnalysisForModulation(_7097.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterPumpCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7048.TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7048.TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation]':
