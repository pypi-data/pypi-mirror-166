...
class SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation(_6966.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    """SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6875.SpringDamperConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2749.SpringDamperConnectionSystemDeflection':
