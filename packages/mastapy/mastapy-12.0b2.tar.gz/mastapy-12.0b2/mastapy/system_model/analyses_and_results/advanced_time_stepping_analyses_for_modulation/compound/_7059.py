...
class AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation(_7060.AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6925.AbstractShaftAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6925.AbstractShaftAdvancedTimeSteppingAnalysisForModulation]':
