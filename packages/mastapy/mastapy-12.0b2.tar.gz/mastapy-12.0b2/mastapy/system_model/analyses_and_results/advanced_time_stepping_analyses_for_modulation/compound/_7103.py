...
class CycloidalDiscCompoundAdvancedTimeSteppingAnalysisForModulation(_7059.AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2513.CycloidalDisc':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6972.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6972.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]':
