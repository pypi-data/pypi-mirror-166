...
class MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7083.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7006.MountableComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7006.MountableComponentAdvancedTimeSteppingAnalysisForModulation]':
