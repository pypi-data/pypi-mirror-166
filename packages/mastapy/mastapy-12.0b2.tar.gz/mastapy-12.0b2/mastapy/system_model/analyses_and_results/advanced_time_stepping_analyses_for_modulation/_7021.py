...
class RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation(_7027.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2736.RollingRingAssemblySystemDeflection':
