...
from mastapy.system_model.analyses_and_results.system_deflections import _2636, _2739
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import (
    _6936, _6938, _6941, _6948,
    _6947, _6968, _6949, _6954,
    _6959, _6971, _6972, _6977,
    _6984, _6983, _6985, _6993,
    _7000, _7003, _7004, _7005,
    _7007, _7009, _7014, _7015,
    _7016, _7018, _7021, _7025,
    _7024, _7030, _7031, _7036,
    _7039, _7042, _7046, _7050,
    _7054, _7057, _6924
)
...
class AssemblyAdvancedTimeSteppingAnalysisForModulation(_6924.AbstractAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """AssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2636.AssemblySystemDeflection':
    ...
    @property
    def bearings(self) -> 'List[_6936.BearingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def belt_drives(self) -> 'List[_6938.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6941.BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6948.BoltedJointAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bolts(self) -> 'List[_6947.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cv_ts(self) -> 'List[_6968.CVTAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def clutches(self) -> 'List[_6949.ClutchAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6954.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6959.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6971.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6972.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6977.CylindricalGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def fe_parts(self) -> 'List[_6984.FEPartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6983.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6985.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6993.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_7000.KlingelnbergCycloPalloidHypoidGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_7003.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def mass_discs(self) -> 'List[_7004.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def measurement_components(self) -> 'List[_7005.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def oil_seals(self) -> 'List[_7007.OilSealAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_7009.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def planet_carriers(self) -> 'List[_7014.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def point_loads(self) -> 'List[_7015.PointLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def power_loads(self) -> 'List[_7016.PowerLoadAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def ring_pins(self) -> 'List[_7018.RingPinsAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_7021.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_7025.ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def shafts(self) -> 'List[_7024.ShaftAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_7030.SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spring_dampers(self) -> 'List[_7031.SpringDamperAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_7036.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_7039.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def synchronisers(self) -> 'List[_7042.SynchroniserAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def torque_converters(self) -> 'List[_7046.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_7050.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_7054.WormGearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_7057.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]':
