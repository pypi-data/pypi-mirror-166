...
class GearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7156.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """GearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6988.GearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6988.GearSetAdvancedTimeSteppingAnalysisForModulation]':
