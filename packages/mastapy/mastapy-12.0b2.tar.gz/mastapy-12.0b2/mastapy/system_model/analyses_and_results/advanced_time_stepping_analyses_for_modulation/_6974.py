...
class CycloidalDiscPlanetaryBearingConnectionAdvancedTimeSteppingAnalysisForModulation(_6927.AbstractShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalDiscPlanetaryBearingConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6779.CycloidalDiscPlanetaryBearingConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2676.CycloidalDiscPlanetaryBearingConnectionSystemDeflection':
