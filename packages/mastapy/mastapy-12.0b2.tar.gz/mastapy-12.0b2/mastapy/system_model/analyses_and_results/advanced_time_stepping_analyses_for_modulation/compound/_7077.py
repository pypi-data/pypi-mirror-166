...
class BoltCompoundAdvancedTimeSteppingAnalysisForModulation(_7083.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BoltCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6947.BoltAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6947.BoltAdvancedTimeSteppingAnalysisForModulation]':
