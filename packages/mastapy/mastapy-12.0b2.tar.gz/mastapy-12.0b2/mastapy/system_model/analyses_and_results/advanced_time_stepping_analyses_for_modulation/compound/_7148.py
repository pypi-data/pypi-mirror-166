...
class RingPinsToDiscConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_7123.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """RingPinsToDiscConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2286.RingPinsToDiscConnection':
    ...
    @property
    def connection_design(self) -> '_2286.RingPinsToDiscConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7019.RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7019.RingPinsToDiscConnectionAdvancedTimeSteppingAnalysisForModulation]':
