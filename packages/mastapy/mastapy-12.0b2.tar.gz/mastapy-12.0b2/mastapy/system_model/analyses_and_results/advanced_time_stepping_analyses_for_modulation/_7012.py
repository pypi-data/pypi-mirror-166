...
class PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(_7026.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6851.PlanetaryConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2728.PlanetaryConnectionSystemDeflection':
