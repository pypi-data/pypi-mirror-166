...
class BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation(_6939.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2644.BevelDifferentialSunGearSystemDeflection':
