...
class ConceptCouplingAdvancedTimeSteppingAnalysisForModulation(_6965.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """ConceptCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6759.ConceptCouplingLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2658.ConceptCouplingSystemDeflection':
