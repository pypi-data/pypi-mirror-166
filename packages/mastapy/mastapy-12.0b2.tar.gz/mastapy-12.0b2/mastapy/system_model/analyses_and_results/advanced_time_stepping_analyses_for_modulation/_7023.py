...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _2567, _6934
...
class RootAssemblyAdvancedTimeSteppingAnalysisForModulation(_6934.AssemblyAdvancedTimeSteppingAnalysisForModulation):
    """RootAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_inputs(self) -> '_2567.AdvancedTimeSteppingAnalysisForModulation':
    ...
    @property
    def results(self) -> '_5798.RootAssemblyHarmonicAnalysisResultsPropertyAccessor':
    ...
    @property
    def system_deflection_results(self) -> '_2739.RootAssemblySystemDeflection':
