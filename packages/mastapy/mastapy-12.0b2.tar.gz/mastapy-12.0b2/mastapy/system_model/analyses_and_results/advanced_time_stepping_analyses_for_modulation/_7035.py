...
class StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation(_6945.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6879.StraightBevelDiffGearMeshLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2752.StraightBevelDiffGearMeshSystemDeflection':
