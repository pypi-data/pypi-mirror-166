...
class OilSealAdvancedTimeSteppingAnalysisForModulation(_6964.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    """OilSealAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6845.OilSealLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2723.OilSealSystemDeflection':
