...
class ShaftCompoundAdvancedTimeSteppingAnalysisForModulation(_7059.AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation):
    """ShaftCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7024.ShaftAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7024.ShaftAdvancedTimeSteppingAnalysisForModulation]':
