...
class CycloidalAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation(_7156.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CycloidalAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2512.CycloidalAssembly':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6971.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6971.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]':
