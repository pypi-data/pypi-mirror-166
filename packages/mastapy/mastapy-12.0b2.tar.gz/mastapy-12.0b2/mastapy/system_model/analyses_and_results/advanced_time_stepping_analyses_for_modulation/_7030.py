...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7028, _7029, _6946
...
class SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6946.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2747.SpiralBevelGearSetSystemDeflection':
    ...
    @property
    def spiral_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7028.SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7029.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
