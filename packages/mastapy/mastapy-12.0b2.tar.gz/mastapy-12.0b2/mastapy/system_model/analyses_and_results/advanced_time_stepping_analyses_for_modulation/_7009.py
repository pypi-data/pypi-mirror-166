...
class PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation(_6965.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2727.PartToPartShearCouplingSystemDeflection':
