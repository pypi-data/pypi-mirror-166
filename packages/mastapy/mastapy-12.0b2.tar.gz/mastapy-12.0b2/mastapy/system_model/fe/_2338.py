...
from mastapy.utility.enums import _1781
...
from mastapy.system_model.fe import _2344, _2334
...
class FESubstructureWithSelectionForStaticAnalysis(_2334.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2344.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2344.NodeBoundaryConditionStaticAnalysis]':
    ...
    @property
    def displacement_results(self) -> 'List[_1525.VectorWithLinearAndAngularComponents]':
    ...
    @property
    def force_results(self) -> 'List[_1525.VectorWithLinearAndAngularComponents]':
