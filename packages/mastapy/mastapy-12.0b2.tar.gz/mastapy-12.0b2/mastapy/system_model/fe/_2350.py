...
from mastapy.system_model.fe import _2302, _2309
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2302.AlignmentMethodForRaceBearing':
        ...
        return constructor.new_from_mastapy_type(_2302.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2302.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2309.BearingRaceNodeLink]':
