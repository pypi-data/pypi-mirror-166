...
class FESubstructureWithSelection(_2305.BaseFEWithSelection):
    """FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2327.FESubstructure':
    ...
    @property
    def element_face_groups(self) -> 'List[_2320.ElementFaceGroupWithSelection]':
    ...
    @property
    def node_groups(self) -> 'List[_2345.NodeGroupWithSelection]':
