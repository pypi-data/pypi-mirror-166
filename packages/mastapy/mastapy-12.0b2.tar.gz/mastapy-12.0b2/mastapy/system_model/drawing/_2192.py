...
from mastapy.system_model.drawing import _2190, _2197
...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _3963
...
class DynamicAnalysisViewable(_2197.PartAnalysisCaseWithContourViewable):
    """DynamicAnalysisViewable
    ...
    @property
    def contour_draw_style(self) -> '_2190.ContourDrawStyle':
        ...
        if _2190.ContourDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_system_deflection_draw_style(self) -> '_2765.SystemDeflectionDrawStyle':
        ...
        if _2765.SystemDeflectionDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_steady_state_synchronous_response_draw_style(self) -> '_3029.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3029.SteadyStateSynchronousResponseDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_stability_analysis_draw_style(self) -> '_3808.StabilityAnalysisDrawStyle':
        ...
        if _3808.StabilityAnalysisDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_rotor_dynamics_draw_style(self) -> '_3963.RotorDynamicsDrawStyle':
        ...
        if _3963.RotorDynamicsDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_modal_analysis_draw_style(self) -> '_4589.ModalAnalysisDrawStyle':
        ...
        if _4589.ModalAnalysisDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_mbd_analysis_draw_style(self) -> '_5390.MBDAnalysisDrawStyle':
        ...
        if _5390.MBDAnalysisDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5688.HarmonicAnalysisDrawStyle':
        ...
        if _5688.HarmonicAnalysisDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_dynamic_analysis_draw_style(self) -> '_6250.DynamicAnalysisDrawStyle':
        ...
        if _6250.DynamicAnalysisDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_critical_speed_analysis_draw_style(self) -> '_6503.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6503.CriticalSpeedAnalysisDrawStyle.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style(self) -> '_6250.DynamicAnalysisDrawStyle':
    ...
    @property
    def dynamic_analysis_draw_style_of_type_modal_analysis_draw_style(self) -> '_4589.ModalAnalysisDrawStyle':
    ...
    @property
    def dynamic_analysis_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5688.HarmonicAnalysisDrawStyle':
