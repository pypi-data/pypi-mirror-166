...
from mastapy.utility.enums import _1779
...
class ScalingDrawStyle(_0.APIBase):
    ...
    @property
    def bearing_force_arrows(self) -> '_1779.BearingForceArrowOption':
        ...
        return constructor.new_from_mastapy_type(_1779.BearingForceArrowOption)(value) if value is not None else None

    @bearing_force_arrows.setter
    def bearing_force_arrows(self, value: '_1779.BearingForceArrowOption'):
