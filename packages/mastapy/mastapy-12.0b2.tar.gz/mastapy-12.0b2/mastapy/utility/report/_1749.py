...
from mastapy.utility.report import _1747, _1740
...
class UserTextRow(_1740.CustomRow):
    """UserTextRow
    ...
    @property
    def heading_size(self) -> '_1747.HeadingSize':
        ...
        return constructor.new_from_mastapy_type(_1747.HeadingSize)(value) if value is not None else None

    @heading_size.setter
    def heading_size(self, value: '_1747.HeadingSize'):
