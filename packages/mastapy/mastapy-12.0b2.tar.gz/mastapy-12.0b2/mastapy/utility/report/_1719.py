...
from mastapy.utility.report import _1711, _1735
...
class CustomReportChartItem(_1735.CustomReportPropertyItem):
    """CustomReportChartItem
    ...
    @property
    def point_shape(self) -> '_1711.SMTChartPointShape':
        ...
        return constructor.new_from_mastapy_type(_1711.SMTChartPointShape)(value) if value is not None else None

    @point_shape.setter
    def point_shape(self, value: '_1711.SMTChartPointShape'):
