...
from mastapy.utility.report import _1732, _1735
...
TItem = TypeVar('TItem', bound='_1735.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1732.CustomReportMultiPropertyItemBase, Generic[TItem]):
    """CustomReportMultiPropertyItem
