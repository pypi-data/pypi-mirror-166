...
from mastapy.utility.modal_analysis.gears import _1761, _1764, _1766
...
class GearOrderForTE(_1766.OrderWithRadius):
    """GearOrderForTE
    ...
    @property
    def position(self) -> '_1761.GearPositions':
        ...
        return constructor.new_from_mastapy_type(_1761.GearPositions)(value) if value is not None else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1764.OrderForTE]':
