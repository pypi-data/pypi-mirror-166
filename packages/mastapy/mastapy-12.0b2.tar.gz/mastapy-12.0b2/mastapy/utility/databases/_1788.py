...
from mastapy.utility.databases import _1789, _1791, _1790
...
TValue = TypeVar('TValue', bound='_1789.NamedDatabaseItem')


class NamedDatabase(_1791.SQLDatabase['_1790.NamedKey', 'TValue'], Generic[TValue]):
    """NamedDatabase
    ...
    def duplicate(self, new_name: 'str', item: '_1789.NamedDatabaseItem') -> '_1789.NamedDatabaseItem':
    ...
    def rename(self, item: '_1789.NamedDatabaseItem', new_name: 'str') -> 'bool':
