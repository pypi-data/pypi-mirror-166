...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1225
...
class ElementPropertiesShell(_211.ElementPropertiesWithMaterial):
    ...
    @property
    def wall_type(self) -> '_1225.ElementPropertiesShellWallType':
        ...
        return constructor.new_from_mastapy_type(_1225.ElementPropertiesShellWallType)(value) if value is not None else None
