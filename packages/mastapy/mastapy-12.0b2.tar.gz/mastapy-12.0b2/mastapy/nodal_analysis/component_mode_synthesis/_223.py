...
from mastapy.fe_tools.vfx_tools import _1226
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1464.DataPrecision':
        ...
        return constructor.new_from_mastapy_type(_1464.DataPrecision)(value) if value is not None else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1464.DataPrecision'):
    ...
    @property
    def solver_options(self) -> '_1226.ProSolveOptions':
