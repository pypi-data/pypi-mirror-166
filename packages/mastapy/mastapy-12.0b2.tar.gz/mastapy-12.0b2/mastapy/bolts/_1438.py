...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self) -> 'List[_1436.ClampedSection]':
    ...
    def clamped_parts(self, value: 'List[_1436.ClampedSection]'):
    ...
    @property
    def joint_geometry(self) -> '_1441.JointGeometries':
        ...
        return constructor.new_from_mastapy_type(_1441.JointGeometries)(value) if value is not None else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1441.JointGeometries'):
        value = value if value else None
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1444.RolledBeforeOrAfterHeatTreament':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1444.RolledBeforeOrAfterHeatTreament)(value) if value is not None else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1444.RolledBeforeOrAfterHeatTreament'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bolt_geometry(self) -> '_1429.BoltGeometry':
    ...
    @property
    def material_of_bolt(self) -> '_1431.BoltMaterial':
    ...
    @property
    def material_of_nut(self) -> '_1427.BoltedJointMaterial':
        ...
        if _1427.BoltedJointMaterial.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def material_of_tapped_thread(self) -> '_1427.BoltedJointMaterial':
    ...
    @property
    def clamped_sections(self) -> 'List[_1436.ClampedSection]':
