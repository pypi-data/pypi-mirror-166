...
class BoltedJointMaterial(_263.Material):
    ...
    @property
    def temperature_dependent_coefficient_of_thermal_expansion(self) -> '_1495.Vector2DListAccessor':
    ...
    def temperature_dependent_coefficient_of_thermal_expansion(self, value: '_1495.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.TemperatureDependentCoefficientOfThermalExpansion = value

    @property
    def temperature_dependent_youngs_moduli(self) -> '_1495.Vector2DListAccessor':
    ...
    def temperature_dependent_youngs_moduli(self, value: '_1495.Vector2DListAccessor'):
        value = value.wrapped if value else None
