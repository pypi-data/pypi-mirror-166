...
from mastapy.detailed_rigid_connectors.splines import _1358, _1383
...
class SAESplineJointDesign(_1383.StandardSplineJointDesign):
    """SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_1358.FitTypes':
        ...
        return constructor.new_from_mastapy_type(_1358.FitTypes)(value) if value is not None else None

    @fit_type.setter
    def fit_type(self, value: '_1358.FitTypes'):
