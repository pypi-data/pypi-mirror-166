...
from mastapy.detailed_rigid_connectors.keyed_joints import _1401, _1403
...
class KeyedJointDesign(_1408.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    @property
    def geometry_type(self) -> '_1401.KeyTypes':
        ...
        return constructor.new_from_mastapy_type(_1401.KeyTypes)(value) if value is not None else None

    @geometry_type.setter
    def geometry_type(self, value: '_1401.KeyTypes'):
    ...
    @property
    def number_of_keys(self) -> '_1403.NumberOfKeys':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1403.NumberOfKeys)(value) if value is not None else None

    @number_of_keys.setter
    def number_of_keys(self, value: '_1403.NumberOfKeys'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
