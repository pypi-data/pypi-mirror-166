...
from mastapy.detailed_rigid_connectors.interference_fits import _1406, _1407, _1411
...
class InterferenceFitDesign(_1350.DetailedRigidConnectorDesign):
    """InterferenceFitDesign
    ...
    @property
    def assembly_method(self) -> '_1406.AssemblyMethods':
        ...
        return constructor.new_from_mastapy_type(_1406.AssemblyMethods)(value) if value is not None else None

    @assembly_method.setter
    def assembly_method(self, value: '_1406.AssemblyMethods'):
    ...
    @property
    def calculation_method(self) -> '_1407.CalculationMethods':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1407.CalculationMethods)(value) if value is not None else None

    @calculation_method.setter
    def calculation_method(self, value: '_1407.CalculationMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
