...
from mastapy.cycloidal import _1423, _1422, _1417
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self) -> '_1423.RingPinsDesign':
    ...
    @property
    def disc_phases(self) -> 'List[_1422.NamedDiscPhase]':
    ...
    @property
    def discs(self) -> 'List[_1417.CycloidalDiscDesign]':
