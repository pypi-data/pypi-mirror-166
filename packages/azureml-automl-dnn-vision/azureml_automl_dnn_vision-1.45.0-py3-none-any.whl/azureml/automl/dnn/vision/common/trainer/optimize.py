...
class BaseOptimizerWrapper(ABC):
    ...
    def get_lr_scaling_factor(self) -> int:
        """Returns the scaling factor for the learning rate.

        :return learning rate scaling factor
        :rtype int
        """
        world_size = distributed_utils.get_world_size()
        return world_size if world_size < constants.CommonSettings.MAX_LEARNING_RATE_SCALE_FACTOR \
            else constants.CommonSettings.MAX_LEARNING_RATE_SCALE_FACTOR
...
class SGDWrapper(BaseOptimizerWrapper):
    ...
    def __init__(self, model_parameters: Union[Iterable[Tensor], Iterable[dict]],
        ...
        self._learning_rate = sgd_parameters.learning_rate * self.get_lr_scaling_factor()
...
class ADAMWrapper(BaseOptimizerWrapper):
    ...
    def __init__(self, model_parameters: Union[Iterable[Tensor], Iterable[dict]],
        ...
        self._learning_rate = adam_parameters.learning_rate * self.get_lr_scaling_factor()
