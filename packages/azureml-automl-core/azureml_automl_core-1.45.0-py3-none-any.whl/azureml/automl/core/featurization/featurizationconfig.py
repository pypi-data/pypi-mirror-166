...
class FeaturizationConfig:
    ...
    .. remarks::
        ...
        * Add or remove prediction transform type. With ``add_prediction_transform_type`` and
        ...
        https://github.com/Azure/azureml-examples/blob/main/python-sdk/tutorials/automl-with-azureml/forecasting-orange-juice-sales/auto-ml-forecasting-orange-juice-sales.ipynb
        ...
        Full sample is available from
        https://github.com/Azure/azureml-examples/blob/main/python-sdk/tutorials/automl-with-azureml/regression-explanation-featurization/auto-ml-regression-explanation-featurization.ipynb
