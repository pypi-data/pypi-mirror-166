                ...
                if 'type' in modbus_info.keys():
                    ...
                    if modbus_type == 'tcp':
                        ...
                        if modbus_com.find('/dev/tty') == 0:
                            ...
                            self.modbus_client = modbus_rtu.RtuMaster(serial.Serial(port=modbus_com, baudrate=modbus_info['baudrate'],bytesize=modbus_info['bytesize'], parity=modbus_info['parity'],stopbits=modbus_info['stopbits'], xonxoff=modbus_info['xonxoff']))
