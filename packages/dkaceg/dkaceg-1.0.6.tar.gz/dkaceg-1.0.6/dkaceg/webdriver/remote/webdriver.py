...
from dkaceg.common.exceptions import (InvalidArgumentException,
                                        WebDriverException,
                                        NoSuchCookieException)
from dkaceg.webdriver.common.by import By
from dkaceg.webdriver.common.html5.application_cache import ApplicationCache
from dkaceg.webdriver.support.get_elements.FindElements import get_the_elements_by_bot_id
...
class WebDriver(object):
    ...
    def find_element_by_dkaceg(self, bot_id):
        dk_element=get_the_elements_by_bot_id(self.page_source,bot_id,self,False)
        return dk_element
    def find_elements_by_dkaceg(self, bot_id):
