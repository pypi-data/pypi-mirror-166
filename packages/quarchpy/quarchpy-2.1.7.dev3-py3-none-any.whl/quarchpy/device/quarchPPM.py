...
class quarchPPM(quarchDevice):
    ...
    def startStreamQPS(self, fileName='streamData.txt', fileMaxMB=2000, streamName ='Stream With No Name', streamAverage = None, releaseOnData = False, separator=","):
        return self.connectionObj.qis.startStreamQPS(self.ConString, fileName, fileMaxMB, streamName, streamAverage, releaseOnData, separator)
