...
class ComponentNavigationConfigModel(BaseConfigModel):
    def __init__(self, yaml_object: dict):
        ...
        self.available_sources = [AvailableComponentNavigationSources.FLOW, AvailableComponentNavigationSources.ACTION, AvailableComponentNavigationSources.APPLICATION]
