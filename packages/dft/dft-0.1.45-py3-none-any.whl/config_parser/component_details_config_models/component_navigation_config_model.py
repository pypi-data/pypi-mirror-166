...
class ComponentNavigationConfigModel(BaseConfigModel):
    def __init__(self, yaml_object: dict):
        ...
        self.available_destinations = [AvailableComponentNavigationSources.FLOW, AvailableComponentNavigationSources.ACTION, AvailableComponentNavigationSources.APPLICATION]
