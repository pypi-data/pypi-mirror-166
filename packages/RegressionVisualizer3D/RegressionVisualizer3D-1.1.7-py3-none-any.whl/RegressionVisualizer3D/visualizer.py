...
def model_plot(model_type="linear_regression",
    ...
    if verbose == True:
        ...
        print("""
The lefthand graph shows some population data and the population regression 
surface for that data. (E.g. if a regression model were fit to all of the 
population data).
""")
        print("""
The righthand graph shows data from a sample which was randomly drawn from the
