...
population data).""")
        print("""
The righthand graph shows the data from the sample which was randomly drawn 
from the population data. It also shows the sample regression surface (e.g. 
from a regression model fit to the sample data).""")
