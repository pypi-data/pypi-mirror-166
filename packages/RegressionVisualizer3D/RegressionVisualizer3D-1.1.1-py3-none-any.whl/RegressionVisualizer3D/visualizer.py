...
# LINEAR REGRESSION
    ...
    if model_type == model_types[0]:
        ...
        try:
            ...
            _display(_Markdown('This combination of parameters generated computational errors!'))
            _display(_Markdown('Please try another combination...'))
            _display(_Markdown(f'The error generated was:"{e}"'))
