...
from funny_passphrase import __version__ as funny_passphrase_version
from funny_passphrase import __author__ as funny_passphrase_author
from funny_passphrase import __license__ as funny_passphrase_license
...
setuptools.setup(
    ...
    version=funny_passphrase_version,
    author=funny_passphrase_author,
    author_email="jose.m.fernandez@bsc.es",
    license=funny_passphrase_license,
    description="A library to index text files, and generate passphrases from them",
