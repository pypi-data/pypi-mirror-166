...
class Chrome:
    def __init__(self, **kwargs):
        ...
        if 'selenium_url_options' in kwargs and kwargs['selenium_url_options']:
            self._driver = Remote(command_executor=kwargs['selenium_url_options'], options=options.bind())
        else:
