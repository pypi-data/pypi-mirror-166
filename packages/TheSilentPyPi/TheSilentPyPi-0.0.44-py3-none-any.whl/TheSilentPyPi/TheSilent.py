...
def packet_sniffer():
    ...
    while True:
        ...
        try:
            source = socket.gethostbyaddr(source)

        except socket.herror:
            print(color + "can't get domain name for source")

        try:
            destination = socket.gethostbyaddr(destination)

        except socket.herror:
            print(color + "can't get domain name for destination")

        #display
        print(color + "source: " + str(source))
        print(color + "destination: " + str(destination))
        pause = input()
