...
class MinioSampleSource(LocalDisk_NLSampleSource):
    ...
    def _download_if_not_exsited(self, name: str):
        ...
        if name in all_sets:
            ...
            for remote_f in progressbar.progressbar(client.list_objects(self._bucket_name, prefix=f"{name}/")):
    ...
    def update(self, set_name=None):
        ...
        for set in progressbar.progressbar(local_sets):
