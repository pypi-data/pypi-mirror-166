...
class ListTrainingJobMetricsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiStudio', '2022-01-12', 'ListTrainingJobMetrics')
		self.set_uri_pattern('/api/v1/trainingjobs/[TrainingJobId]/metrics')
		self.set_method('GET')
