...
class GetTrainingJobRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiStudio', '2022-01-12', 'GetTrainingJob')
		self.set_uri_pattern('/api/v1/trainingjobs/[TrainingJobId]')
		self.set_method('GET')
