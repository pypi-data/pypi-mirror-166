...
class ListResourceGroupsRequest(RoaRequest):
	...
	def __init__(self):
		RoaRequest.__init__(self, 'PaiStudio', '2022-01-12', 'ListResourceGroups')
		self.set_uri_pattern('/api/v1/resources')
		self.set_method('GET')
	...
	def get_ShowAll(self): # boolean
		return self.get_query_params().get('ShowAll')

	def set_ShowAll(self, ShowAll):  # boolean
		self.add_query_param('ShowAll', ShowAll)
