...
class GenericGenerator(BaseGenerator):
    ...
    def _json_encode(self, leagueid, marketids, markettypes, outcomes, seeds):
        ...
        for i in range(lines[0].shape[0]):
            ...
            zipped = zip(marketids, markettypes, pred_outcomes)
            ...
            for marketid, markettype, pred_outcome in zipped:
                event = {'MarketId': marketid, 'MarketType': markettype, 'Prediction': pred_outcome}
