...
class Utils:
    ...
    def convert_timestamp_to_building_timezone(self, building_id: str, timestamp: datetime) -> datetime:
        ...
        """
        timestamp = timestamp.replace(tzinfo=pytz.timezone(timestamp.tzname()))  # Workaround for pandas bug
        ...
        return datetime.utcfromtimestamp(tz_conversion(timestamp).timestamp())
