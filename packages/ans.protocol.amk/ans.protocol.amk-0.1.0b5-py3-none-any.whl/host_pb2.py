...
_PROXYID = DESCRIPTOR.message_types_by_name['ProxyId']
_LICENSINGINPUT = DESCRIPTOR.message_types_by_name['LicensingInput']
_PROGRESSINFO = DESCRIPTOR.message_types_by_name['ProgressInfo']
_MESSAGEINFO = DESCRIPTOR.message_types_by_name['MessageInfo']
_MESSAGEINFO_SEVERITY = _MESSAGEINFO.enum_types_by_name['Severity']
_MESSAGEINFO_MAPDLMESSAGETYPE = _MESSAGEINFO.enum_types_by_name['MAPDLMessageType']
ProxyId = _reflection.GeneratedProtocolMessageType('ProxyId', (_message.Message,), {
  'DESCRIPTOR' : _PROXYID,
  '__module__' : 'host_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.solver_proxy.host.ProxyId)
  })
_sym_db.RegisterMessage(ProxyId)

LicensingInput = _reflection.GeneratedProtocolMessageType('LicensingInput', (_message.Message,), {
  'DESCRIPTOR' : _LICENSINGINPUT,
  '__module__' : 'host_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.solver_proxy.host.LicensingInput)
  })
_sym_db.RegisterMessage(LicensingInput)

ProgressInfo = _reflection.GeneratedProtocolMessageType('ProgressInfo', (_message.Message,), {
  'DESCRIPTOR' : _PROGRESSINFO,
  '__module__' : 'host_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.solver_proxy.host.ProgressInfo)
  })
...
MessageInfo = _reflection.GeneratedProtocolMessageType('MessageInfo', (_message.Message,), {
  ...
  '__module__' : 'host_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.solver_proxy.host.MessageInfo)
  })
