...
_MODESCOMBINATIONTYPE_ENUM = _MODESCOMBINATIONTYPE.enum_types_by_name['Enum']
_SPECTRUMTYPE_ENUM = _SPECTRUMTYPE.enum_types_by_name['Enum']
_RIGIDRESPONSEEFFECT_ENUM = _RIGIDRESPONSEEFFECT.enum_types_by_name['Enum']
ModesCombinationType = _reflection.GeneratedProtocolMessageType('ModesCombinationType', (_message.Message,), {
  'DESCRIPTOR' : _MODESCOMBINATIONTYPE,
  '__module__' : 'analysis_settings.ansys.structural.response_spectrum_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.structural.response_spectrum.ModesCombinationType)
  })
_sym_db.RegisterMessage(ModesCombinationType)

SpectrumType = _reflection.GeneratedProtocolMessageType('SpectrumType', (_message.Message,), {
  'DESCRIPTOR' : _SPECTRUMTYPE,
  '__module__' : 'analysis_settings.ansys.structural.response_spectrum_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.structural.response_spectrum.SpectrumType)
  })
_sym_db.RegisterMessage(SpectrumType)

RigidResponseEffect = _reflection.GeneratedProtocolMessageType('RigidResponseEffect', (_message.Message,), {
  'DESCRIPTOR' : _RIGIDRESPONSEEFFECT,
  '__module__' : 'analysis_settings.ansys.structural.response_spectrum_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.structural.response_spectrum.RigidResponseEffect)
  })
_sym_db.RegisterMessage(RigidResponseEffect)

Damping = _reflection.GeneratedProtocolMessageType('Damping', (_message.Message,), {
  'DESCRIPTOR' : _DAMPING,
  '__module__' : 'analysis_settings.ansys.structural.response_spectrum_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.structural.response_spectrum.Damping)
  })
_sym_db.RegisterMessage(Damping)
...
OutputControls = _reflection.GeneratedProtocolMessageType('OutputControls', (_message.Message,), {
  ...
  'Fields' : _reflection.GeneratedProtocolMessageType('Fields', (_message.Message,), {
    ...
    '__module__' : 'analysis_settings.ansys.structural.response_spectrum_pb2'
    # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.structural.response_spectrum.OutputControls.Fields)
    })
  ,
  'DESCRIPTOR' : _OUTPUTCONTROLS,
  '__module__' : 'analysis_settings.ansys.structural.response_spectrum_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.structural.response_spectrum.OutputControls)
  })
...
Settings = _reflection.GeneratedProtocolMessageType('Settings', (_message.Message,), {
  ...
  '__module__' : 'analysis_settings.ansys.structural.response_spectrum_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.structural.response_spectrum.Settings)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SETTINGS._serialized_end=1863
