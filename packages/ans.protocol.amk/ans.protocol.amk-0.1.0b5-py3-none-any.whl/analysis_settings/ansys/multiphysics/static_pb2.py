...
_NONLINEARADAPTIVITYCONTROLS = DESCRIPTOR.message_types_by_name['NonlinearAdaptivityControls']
...
NonlinearAdaptivityControls = _reflection.GeneratedProtocolMessageType('NonlinearAdaptivityControls', (_message.Message,), {
  'DESCRIPTOR' : _NONLINEARADAPTIVITYCONTROLS,
  '__module__' : 'analysis_settings.ansys.multiphysics.static_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.multiphysics.static_.NonlinearAdaptivityControls)
  })
_sym_db.RegisterMessage(NonlinearAdaptivityControls)

SolverControls = _reflection.GeneratedProtocolMessageType('SolverControls', (_message.Message,), {
  'DESCRIPTOR' : _SOLVERCONTROLS,
  '__module__' : 'analysis_settings.ansys.multiphysics.static_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.multiphysics.static_.SolverControls)
  })
...
OutputControls = _reflection.GeneratedProtocolMessageType('OutputControls', (_message.Message,), {
  ...
  'Fields' : _reflection.GeneratedProtocolMessageType('Fields', (_message.Message,), {
    ...
    '__module__' : 'analysis_settings.ansys.multiphysics.static_pb2'
    # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.multiphysics.static_.OutputControls.Fields)
    })
  ,
  'DESCRIPTOR' : _OUTPUTCONTROLS,
  '__module__' : 'analysis_settings.ansys.multiphysics.static_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.multiphysics.static_.OutputControls)
  })
...
StepControl = _reflection.GeneratedProtocolMessageType('StepControl', (_message.Message,), {
  ...
  '__module__' : 'analysis_settings.ansys.multiphysics.static_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.multiphysics.static_.StepControl)
  })
...
AdditiveManufacturingControls = _reflection.GeneratedProtocolMessageType('AdditiveManufacturingControls', (_message.Message,), {
  ...
  '__module__' : 'analysis_settings.ansys.multiphysics.static_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.multiphysics.static_.AdditiveManufacturingControls)
  })
...
Settings = _reflection.GeneratedProtocolMessageType('Settings', (_message.Message,), {
  ...
  '__module__' : 'analysis_settings.ansys.multiphysics.static_pb2'
  # @@protoc_insertion_point(class_scope:ans.protocol.analysis_settings.ansys.multiphysics.static_.Settings)
  })
