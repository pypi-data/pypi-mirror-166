...
def process_class(channel, img_num_channels=1, label=None, normalize=True, min_pixel=638, max_pixel=3000):
    ...
    Args:
        ...
        label (int, optional): Class label, 0 for class1, 1 for class2. Defaults to None.
...
def create_training_set(class1, class2, img_num_channels=1, normalize=True, min_pixel=638, max_pixel=3000):
    """
    ...
    Args:
        class1 (array): 3D array containing more than one image.
        class2 (array): 3D array containing more than one image.
        img_num_channels (int): The number of filters used. Defaults to 1.
    ...
    class1_data, class1_label = process_class(class1, label=0, normalize=normalize, min_pixel=min_pixel, max_pixel=max_pixel, img_num_channels=img_num_channels)
    class2_data, class2_label = process_class(class2, label=1, normalize=normalize, min_pixel=min_pixel, max_pixel=max_pixel, img_num_channels=img_num_channels)
