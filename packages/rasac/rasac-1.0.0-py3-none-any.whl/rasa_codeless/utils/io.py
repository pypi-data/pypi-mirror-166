...
from rasa_codeless.shared.constants import (
    ...
    DEFAULT_LATEST_TAG,
    DEFAULT_INIT_DEST_DIR_NAME, DEFAULT_RASA_ROOT_DIR, DEFAULT_TENSORBOARD_LOGDIR, DEFAULT_MODEL_PATH,
)
...
def get_model_list(model_path=DEFAULT_MODEL_PATH, file_suffixes=RASA_MODEL_EXTENSIONS) -> List:
    file_list = get_dir_file_list(dir_path=DEFAULT_MODEL_PATH, file_suffixes=RASA_MODEL_EXTENSIONS)
