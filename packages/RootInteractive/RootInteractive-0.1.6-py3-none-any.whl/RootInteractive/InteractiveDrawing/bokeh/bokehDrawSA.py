...
class bokehDrawSA(object):
    ...
    def __init__(self, source, query, varX, varY, varColor, widgetsDescription, p, **kwargs):
        ...
        `figureArray  <https://github.com/miranov25/RootInteractive/blob/master/RootInteractive/InteractiveDrawing/bokeh/doc/READMEfigure.md>`_
        `histogramArray  <https://github.com/miranov25/RootInteractive/blob/master/RootInteractive/InteractiveDrawing/bokeh/doc/READMEhistogram.md>`_
