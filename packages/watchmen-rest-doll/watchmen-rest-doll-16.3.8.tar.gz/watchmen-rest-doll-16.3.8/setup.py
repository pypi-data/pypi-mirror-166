...
['bcrypt>=3.2.0,<4.0.0',
 ...
 'watchmen-data-surface==16.3.8',
 'watchmen-indicator-surface==16.3.8',
 'watchmen-inquiry-surface==16.3.8',
 'watchmen-pipeline-surface==16.3.8']

extras_require = \
{'collector': ['watchmen-collector-kernel==16.3.8'],
 'kafka': ['kafka-python>=2.0.2,<3.0.0', 'aiokafka>=0.7.2,<0.8.0'],
 'mongodb': ['watchmen-storage-mongodb==16.3.8'],
 'mssql': ['watchmen-storage-mssql==16.3.8'],
 'mysql': ['watchmen-storage-mysql==16.3.8', 'cryptography>=36.0.2,<37.0.0'],
 'oracle': ['watchmen-storage-oracle==16.3.8'],
 'oss': ['watchmen-storage-oss==16.3.8'],
 'postgresql': ['watchmen-storage-postgresql==16.3.8'],
 'prometheus': ['starlette-prometheus>=0.9.0,<0.10.0'],
 'rabbit': ['aio-pika>=7.1.2,<8.0.0'],
 's3': ['watchmen-storage-s3==16.3.8'],
 'sso': ['python3-saml>=1.14.0,<2.0.0', 'cryptography>=36.0.2,<37.0.0'],
 'standard_ext_writer': ['requests>=2.27.1,<3.0.0'],
 'trino': ['watchmen-inquiry-trino==16.3.8']}
