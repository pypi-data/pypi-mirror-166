...
```""" + SPLIT_EXAMPLE_STR, extra="key:language,val:json")
    join_rules: Dict[str, str] = Field(None,
                                       description="""List of join rules_segmenter that operates over tokens based on the [Spacy Rule-based matcher](https://spacy.io/usage/rule-based-matching) syntax<br/>
