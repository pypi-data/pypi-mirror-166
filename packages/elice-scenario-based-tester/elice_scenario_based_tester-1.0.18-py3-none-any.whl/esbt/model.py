...
from test_based_scenario.workflows.aaa import workflow
        ...
        try:
            async with workflow.session.request(
                ...
                for extract_field in self.extract_fields:
                    ...
                    print(f'[{self.url}] - {target_key} : {workflow.context[target_key]}')
...
class Agent:
    def __init__(self, name: str, scenarios: list[ScenarioBase] | None = []) -> None:
        self.name = name
