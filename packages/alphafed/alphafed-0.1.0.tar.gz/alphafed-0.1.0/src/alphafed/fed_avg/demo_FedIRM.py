...
class FedAvgIRM(FedAvgScheduler):
    ...
    def __init__(self,
                 ...
                 drop_rate: float = 0.2,
                 root_path: str = f"{CURRENT_DIR}/data/gtr21/ISIN-2018/train_image_224/",
                 csv_file_train: str = f"{CURRENT_DIR}/data/train.csv",
                 csv_file_test: str = f"{CURRENT_DIR}/data/test.csv",
                 batch_size: int = 16,
                 base_lr: float = 2e-4):
    ...
    def make_train_dataloader(self) -> DataLoader:
        ...
        train_dataset = CheXpertDataset(root_dir=self.root_path,
    ...
    def make_test_dataloader(self) -> DataLoader:
        normalize = transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
        test_dataset = CheXpertDataset(root_dir=self.root_path,
...
def get_scheduler() -> FedAvgIRM:
    return FedAvgIRM(min_clients=2,
                     max_clients=3,
                     name='demo_task',
                     max_rounds=50,
                     log_rounds=5,
