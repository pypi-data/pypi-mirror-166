...
def build_beamline(nrays=1000):
    ...
    beamLine.xzMax += 2 * r0
    print('{0} capillaries'.format(len(beamLine.capillaries)))
...
#    PlotClass = xrtp.XYCPlotWithNumerOfReflections
    ...
    ppb = 1
    for ibins, bins in enumerate([512]):
        plot = xrtp.XYCPlot(
            'beamFSM1', (1, 3, -1),
    ...
    #    print(capillariesToShow)
        for i in capillariesToShow:
            ...
            plot = PlotClass(
                ...
                xaxis=xrtp.XYCAxis(r'$\phi$', 'rad', bins=bins, ppb=ppb),
                yaxis=xrtp.XYCAxis(r'$s$', 'mm', bins=bins, ppb=ppb),
    ...
    #    plot.fluxFormatStr = '%.2e'
        ...
        plot = PlotClass(
            ...
            xaxis=xrtp.XYCAxis(r'$x$', 'mm', bins=bins, ppb=ppb),
            yaxis=xrtp.XYCAxis(r"$x'$", 'mrad', bins=bins, ppb=ppb),
            caxis=xrtp.XYCAxis('number of reflections', '', bins=nReflDisp+1,
                               ppb=16, data=raycing.get_reflection_number),
            title='FSM2_xxPrimeN')
        plot.xaxis.fwhmFormatStr = fwhmFormatStr3
    ...
    #    plot.fluxFormatStr = '%.2e'
        ...
        plot = PlotClass(
            ...
            xaxis=xrtp.XYCAxis(r'$y$', 'mm', bins=bins, ppb=ppb),
            yaxis=xrtp.XYCAxis(r"$x$", 'mm', bins=bins, ppb=ppb),
            caxis=xrtp.XYCAxis(r"$x'$", 'mrad', bins=bins, ppb=ppb),
    ...
    #    plot.fluxFormatStr = '%.2e'
        ...
        plot = PlotClass(
            ...
            xaxis=xrtp.XYCAxis(r'$y$', 'mm', bins=bins, ppb=ppb),
            yaxis=xrtp.XYCAxis(r"$z$", 'mm', bins=bins, ppb=ppb),
            caxis=xrtp.XYCAxis(r"$z'$", 'mrad', bins=bins, ppb=ppb),
