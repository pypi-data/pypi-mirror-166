...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GeneratePromoCode = channel.unary_unary(
                '/batchx.auth.AuthService/GeneratePromoCode',
                request_serializer=auth__pb2.GeneratePromoCodeRequest.SerializeToString,
                response_deserializer=auth__pb2.GeneratePromoCodeResponse.FromString,
                )
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GeneratePromoCode': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.GeneratePromoCodeRequest.FromString,
                    response_serializer=auth__pb2.GeneratePromoCodeResponse.SerializeToString,
            ),
    }
...
class AuthService(object):
    ...
    def GeneratePromoCode(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/batchx.auth.AuthService/GeneratePromoCode',
            auth__pb2.GeneratePromoCodeRequest.SerializeToString,
            auth__pb2.GeneratePromoCodeResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
