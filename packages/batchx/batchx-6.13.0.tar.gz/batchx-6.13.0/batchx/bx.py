...
class AuthService:
    ...
    def GeneratePromoCode(self, request):
        check()
        return make_call(auth_pb2_grpc.AuthServiceStub(channel).GeneratePromoCode, request)
    ...
    def GeneratePromoCodeRequest(self, **kwargs):
        return auth_pb2.GeneratePromoCodeRequest(**kwargs)

    def GeneratePromoCodeResponse(self, **kwargs):
        return auth_pb2.GeneratePromoCodeResponse(**kwargs)
