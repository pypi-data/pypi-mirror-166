...
class PowerBIDataset:
    ...
    def from_dict(obj: Any) -> 'PowerBIDataset':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        workspace = from_union([PowerBIWorkspace.from_dict, from_none], obj.get("workspace"))
        return PowerBIDataset(created_at, id, aspect_type, power_bi_dataset_created_at, description, entity_id, power_bi_dataset_id, name, sensitivity_label, source_datasets, tables, url, workspace)
