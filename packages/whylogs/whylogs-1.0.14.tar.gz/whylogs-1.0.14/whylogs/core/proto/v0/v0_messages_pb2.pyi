...
class NLPMetricsMessage(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    MER_FIELD_NUMBER: builtins.int
    WER_FIELD_NUMBER: builtins.int
    WIL_FIELD_NUMBER: builtins.int
    @property
    def mer(self) -> global___NumbersMessageV0: ...
    @property
    def wer(self) -> global___NumbersMessageV0: ...
    @property
    def wil(self) -> global___NumbersMessageV0: ...
    def __init__(self,
        *,
        mer: typing.Optional[global___NumbersMessageV0] = ...,
        wer: typing.Optional[global___NumbersMessageV0] = ...,
        wil: typing.Optional[global___NumbersMessageV0] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["mer",b"mer","wer",b"wer","wil",b"wil"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["mer",b"mer","wer",b"wer","wil",b"wil"]) -> None: ...
global___NLPMetricsMessage = NLPMetricsMessage
