...
namespace py::impl::Windows::Foundation::Collections
{
    ...
    struct IIterator : public py::proj::Windows::Foundation::Collections::IIterator
    {
        ...
        PyObject* GetMany(PyObject* args) noexcept override
        {
            ...
            if (arg_count == 1)
            {
                if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Foundation.Collections.IIterator`1", L"GetMany", 1))
                {
    ...
    struct IObservableVector : public py::proj::Windows::Foundation::Collections::IObservableVector
    {
        ...
        PyObject* GetMany(PyObject* args) noexcept override
        {
            ...
            if (arg_count == 2)
            {
                if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Foundation.Collections.IVector`1", L"GetMany", 2))
                {
                    PyErr_SetString(PyExc_AttributeError, "method 2 args is not available in this version of Windows");
                    return nullptr;
                }
    ...
    struct IVectorView : public py::proj::Windows::Foundation::Collections::IVectorView
    {
        ...
        PyObject* GetMany(PyObject* args) noexcept override
        {
            ...
            if (arg_count == 2)
            {
                if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Foundation.Collections.IVectorView`1", L"GetMany", 2))
                {
                    PyErr_SetString(PyExc_AttributeError, "method 2 args is not available in this version of Windows");
                    return nullptr;
                }
