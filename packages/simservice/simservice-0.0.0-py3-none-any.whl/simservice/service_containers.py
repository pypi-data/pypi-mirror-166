...
class ProcessContainer(Process):
    ...
    """
    def __init__(self, _conn, _process_cls, *args, **kwargs):
        """
        :param _conn: X-process connection, process side
        :type _conn: multiprocessing.connection.Connection
        :param _process_cls: process-launching class; *args* and *kwargs* are passed to this to instantiate the process
