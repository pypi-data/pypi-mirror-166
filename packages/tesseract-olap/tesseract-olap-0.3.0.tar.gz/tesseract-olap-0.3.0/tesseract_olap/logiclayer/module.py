...
class TesseractModule(ll.LogicLayerModule):
    ...
    async def query_data(
        ...
        return StreamingResponse(result_to_asyncgen(result.data, {
            "format": filetype,
...
async def result_to_asyncgen(data: Any, extra: dict):
    yield orjson.dumps(extra, default=jsonable_encoder)[:-1]
    yield b',"data":['
    comma = ''
