...
from .exceptions import EadSchemaMissingError, EadSchemaNotAvailableError, EadSchemaValidationError
...
class EadValidator:
    ...
    def _load_settings(ead_settings_path):
        with open(ead_settings_path) as f:
            return json.load(f)
    ...
    def _load_schemas(ead_schema_dir_path, ead_settings, enable_legacy_support):
        ...
        for name in names:
            with open(Path(ead_schema_dir_path, name)) as f:
