import numpy as np
from baseflow.comparision import KGE, strict_baseflow
from baseflow.methods import *
from baseflow.param_estimate import (maxmium_BFI, param_calibrate,
...
def separation(Q, date=None, area=None, ice_period=None, method="all"):
    ...
    KGEs = KGE(
        b[strict].view(np.float64).reshape(-1, len(method)),
