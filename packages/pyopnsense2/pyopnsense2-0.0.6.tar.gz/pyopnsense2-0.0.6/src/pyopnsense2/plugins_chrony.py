...
class chrony_general(client.BaseClient):
    """A client for interacting with the OPNSense's chronygeneral API.
    for more information on used parameters, see : ['https://github.com/opnsense/plugins/blob/master/net/chrony/src/opnsense/mvc/app/models/OPNsense/Chrony/General.xml']
    ...
    def set(self, args={}, params={}):
        """"""
        url = "chrony/general/set/"
        data = {}

        data = self._get( url, args)
        return data

class chrony_service(client.BaseClient):
    """A client for interacting with the OPNSense's chronyservice API.
    for more information on used parameters, see : ['https://github.com/opnsense/plugins/blob/master/net/chrony/src/opnsense/mvc/app/models/OPNsense/Chrony/General.xml']
    ...
    def reconfigure(self, args={}, params={}):
        """"""
        url = "chrony/service/reconfigure/"
        data = {}
