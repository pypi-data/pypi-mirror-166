...
class diagnostics_proofpoint_et(client.BaseClient):
    """A client for interacting with the OPNSense's diagnosticsproofpoint_et API.
    ...
    def status(self, args={}, params={}):
        """"""
        url = "diagnostics/proofpoint_et/status/"
        data = {}
