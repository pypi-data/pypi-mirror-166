...
_AMLIGNORE_PATH = _DATA_PATH / '.amlignore'
...
def _condition_output(
    ...
    condition_output_component_func = Component.from_yaml(
        yaml_file=_COMPONENT_PATH, additional_amlignore_file=_AMLIGNORE_PATH
    )
