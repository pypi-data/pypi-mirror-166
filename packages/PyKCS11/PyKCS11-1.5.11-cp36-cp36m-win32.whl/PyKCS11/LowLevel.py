...
class CK_ECDH1_DERIVE_PARAMS(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, CK_ECDH1_DERIVE_PARAMS, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, CK_ECDH1_DERIVE_PARAMS, name)
    __repr__ = _swig_repr
    __swig_setmethods__["kdf"] = _LowLevel.CK_ECDH1_DERIVE_PARAMS_kdf_set
    __swig_getmethods__["kdf"] = _LowLevel.CK_ECDH1_DERIVE_PARAMS_kdf_get
    if _newclass:kdf = _swig_property(_LowLevel.CK_ECDH1_DERIVE_PARAMS_kdf_get, _LowLevel.CK_ECDH1_DERIVE_PARAMS_kdf_set)
    __swig_setmethods__["ulSharedDataLen"] = _LowLevel.CK_ECDH1_DERIVE_PARAMS_ulSharedDataLen_set
    __swig_getmethods__["ulSharedDataLen"] = _LowLevel.CK_ECDH1_DERIVE_PARAMS_ulSharedDataLen_get
    if _newclass:ulSharedDataLen = _swig_property(_LowLevel.CK_ECDH1_DERIVE_PARAMS_ulSharedDataLen_get, _LowLevel.CK_ECDH1_DERIVE_PARAMS_ulSharedDataLen_set)
    __swig_setmethods__["pSharedData"] = _LowLevel.CK_ECDH1_DERIVE_PARAMS_pSharedData_set
    __swig_getmethods__["pSharedData"] = _LowLevel.CK_ECDH1_DERIVE_PARAMS_pSharedData_get
    if _newclass:pSharedData = _swig_property(_LowLevel.CK_ECDH1_DERIVE_PARAMS_pSharedData_get, _LowLevel.CK_ECDH1_DERIVE_PARAMS_pSharedData_set)
    __swig_setmethods__["ulPublicDataLen"] = _LowLevel.CK_ECDH1_DERIVE_PARAMS_ulPublicDataLen_set
    __swig_getmethods__["ulPublicDataLen"] = _LowLevel.CK_ECDH1_DERIVE_PARAMS_ulPublicDataLen_get
    if _newclass:ulPublicDataLen = _swig_property(_LowLevel.CK_ECDH1_DERIVE_PARAMS_ulPublicDataLen_get, _LowLevel.CK_ECDH1_DERIVE_PARAMS_ulPublicDataLen_set)
    __swig_setmethods__["pPublicData"] = _LowLevel.CK_ECDH1_DERIVE_PARAMS_pPublicData_set
    __swig_getmethods__["pPublicData"] = _LowLevel.CK_ECDH1_DERIVE_PARAMS_pPublicData_get
    if _newclass:pPublicData = _swig_property(_LowLevel.CK_ECDH1_DERIVE_PARAMS_pPublicData_get, _LowLevel.CK_ECDH1_DERIVE_PARAMS_pPublicData_set)
    def __init__(self): 
        this = _LowLevel.new_CK_ECDH1_DERIVE_PARAMS()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _LowLevel.delete_CK_ECDH1_DERIVE_PARAMS
    __del__ = lambda self : None;
CK_ECDH1_DERIVE_PARAMS_swigregister = _LowLevel.CK_ECDH1_DERIVE_PARAMS_swigregister
CK_ECDH1_DERIVE_PARAMS_swigregister(CK_ECDH1_DERIVE_PARAMS)
...
class CPKCS11Lib(_object):
    ...
    def C_DeriveKey(self, *args): return _LowLevel.CPKCS11Lib_C_DeriveKey(self, *args)
