        ...
        <div class="container-temperature">
          <div class=${t.state}>
            ${r||n?i.dy`
                ...
                `:""}
            ${r&&!n&&void 0!==t.attributes.temperature&&null!==t.attributes.temperature?i.dy`
                  <ha-climate-control
                    .hass=${this.hass}
                  ...
                  ></ha-climate-control>
                `:""}
            ${n&&(void 0!==t.attributes.target_temp_low&&null!==t.attributes.target_temp_low||void 0!==t.attributes.target_temp_high&&null!==t.attributes.target_temp_high)?i.dy`
                  <ha-climate-control
                    .hass=${this.hass}
...
//# sourceMappingURL=9aa05868.js.map