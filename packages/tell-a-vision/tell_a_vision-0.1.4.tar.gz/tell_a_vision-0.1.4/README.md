...
<p align="center">
  <img src="misc/street-2.jpg" width="700em"/>
</p>
...
Finally, using `narrator.get_narration()` we can get the summerized description of the scene in the format of the name of the audio files to be played:
