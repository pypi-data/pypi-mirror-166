# This code is heavily borrowed from the Pytorch-UNet repo(https://github.com/milesial/Pytorch-UNet)
# and followed the GPL-3.0 license.
...
class UnetDecoder(nn.Module):
    def __init__(self, num_classes, dims, in_channels=3, bilinear=False):
        super().__init__()
