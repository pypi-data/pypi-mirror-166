...
class BoardCollisionManager:
    ...
    def _handle_token_detecting_token_methods(self):
        methods = self.board.event_manager.registered_events["on_detecting"].union(
            self.board.event_manager.registered_events["on_sensing"])
    ...
    def _handle_token_not_detecting_token_methods(self):
        methods = self.board.event_manager.registered_events["on_not_detecting"].union(
            self.board.event_manager.registered_events["on_not_sensing"])
