...
class Token(token_base.BaseToken):
    ...
    def detect_tokens(self, token_filter: str = None) -> List["Token"]:
    ...
    def detect_token(self, token_filter: Union[str, type] = None) -> Union["Token", None]:
    ...
    sensing_token = detect_token  #: Alias of :meth:`Token.sensing_token`
    ...
    def detect_tokens_at(self, direction: int = 0, distance: int = 0) -> list:
