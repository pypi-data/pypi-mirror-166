...
def validate_postgresql_parameters(value: Dict[str, Any]) -> Dict[str, Any]:
    """Validate PostgreSQL configuration w.r.t. to Patroni usage.

    >>> PostgreSQLPatroniConfig.parse_obj({
    ...     "authentication": {
    ...         "superuser": {"username": "postgres"},
    ...         "replication": {"username": "replication"},
    ...     },
    ...     "connect_address": "server:5432",
    ...     "data_dir": "/tmp",
    ...     "bin_dir": "/usr/lib/postgresql/14/bin/",
    ...     "listen": "server:5432",
    ...     "parameters": {"log_directory": "/var/log/pgsql"},
    ... })
    Traceback (most recent call last):
        ...
    pydantic.error_wrappers.ValidationError: 1 validation error for PostgreSQLPatroniConfig
    parameters
      log_directory setting incompatible with Patroni usage (type=value_error)
    """
    # This mostly a limitation rather than a true incompatibility.
    if "log_directory" in value:
        raise ValueError("log_directory setting incompatible with Patroni usage")
    return value
...
class PostgreSQLPatroniConfig(_BaseModel):
    ...
    __validate_parameters_ = validator("parameters", allow_reuse=True)(
    ...
    def values(
        ...
        unix_socket_directories = parameters.get("unix_socket_directories")
        ...
        return dict(
            ...
            listen=listen,
            use_unix_socket=unix_socket_directories is not None,
            use_unix_socket_repl=unix_socket_directories is not None,
            # custom_conf
...
class Patroni(_BaseModel):
    ...
    def build(
        ...
        **args: Any,
        ...
        parameters = {k: v for k, v in sorted(pgconfig.as_dict().items())}
...
class ClusterMember(BaseModel):
    """An item of 'patronictl list' return list."""
