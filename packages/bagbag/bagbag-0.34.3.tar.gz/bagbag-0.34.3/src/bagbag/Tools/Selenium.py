    ...
    def autoRealodOnErrorChrome(self):
        while True:
            ...
            try:
                ...
                # 有时候没有Reload按钮, 就说没法载入
                page = self.PageSource()
                if 'This page isn’t working' in page and 'ERR_EMPTY_RESPONSE' in page and 'didn’t send any data' in page and URL(self.Url()).Parse().Host in page:
                    self.Refresh()
                    time.sleep(10)
