...
class Api():
    ...
    def __init__(self, auth_legacy = True, appkey: Optional[str] = None, un: Optional[str] = None, pw: Optional[str] = None, **cfg):
        self.auth_apikey: Optional[str] = None
        self.auth_apikey_expiry: Optional[int] = None
        self.auth_apikey_mins_left: Optional[float] = None
        ...
        if self.auth_method_legacy:
            ...
            warn('legacy userpass authentication, please use modern appkey auth https://optilogic.app/#/user-account?tab=appkey', FutureWarning, stacklevel=2)
