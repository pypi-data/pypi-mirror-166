...
from .util import (max as max_1, compare_primitives, IEnumerable, IEqualityComparer_1, ignore, get_enumerator, equals as equals_1, IComparer_1, min as min_1)
...
def insert_range_in_place(index: int, range: IEnumerable[_T], array: Array[_T]) -> None:
    ...
    with get_enumerator(range) as enumerator:
        while enumerator.System_Collections_IEnumerator_MoveNext():
            ...
            def _arrow48(__unit: Literal[None]=None, index: int=index, range: IEnumerable[_T]=range, array: Array[_T]=array) -> Array[_T]:
                index_1: int = i or 0
