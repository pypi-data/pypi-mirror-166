...
from .util import (get_enumerator, IEnumerator, to_iterator, IDisposable, is_disposable, dispose as dispose_2, IEnumerable, is_array_like, IEqualityComparer_1, equals, ignore, lock, clear, IComparer_1)
...
def Enumerator_cast(e: IEnumerator[Any]) -> IEnumerator[Any]:
    def current(__unit: Literal[None]=None, e: IEnumerator[Any]=e) -> _T:
        return e.System_Collections_IEnumerator_get_Current()

    def next_1(__unit: Literal[None]=None, e: IEnumerator[Any]=e) -> bool:
        return e.System_Collections_IEnumerator_MoveNext()

    def dispose(__unit: Literal[None]=None, e: IEnumerator[Any]=e) -> None:
        if is_disposable(e):
            dispose_2(e)
...
def Enumerator_concat(sources: IEnumerable[Any]) -> IEnumerator[Any]:
    ...
    def current(__unit: Literal[None]=None, sources: IEnumerable[_U]=sources) -> _T:
        if not started:
    ...
    def finish(__unit: Literal[None]=None, sources: IEnumerable[_U]=sources) -> None:
    ...
    def loop(__unit: Literal[None]=None, sources: IEnumerable[_U]=sources) -> bool:
            ...
            if outer_opt_1 is not None:
                if inner_opt_1 is not None:
                    ...
                    if outer_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        def _arrow139(__unit: Literal[None]=None) -> IEnumerator[_T]:
    ...
    def next_1(__unit: Literal[None]=None, sources: IEnumerable[_U]=sources) -> bool:
        nonlocal started
        if not started:
            started = True
    ...
    def dispose(__unit: Literal[None]=None, sources: IEnumerable[_U]=sources) -> None:
        if not finished:
            finish()
...
def delay(generator: Callable[[], IEnumerable[_T]]) -> IEnumerable[_T]:
    def _arrow140(__unit: Literal[None]=None, generator: Callable[[], IEnumerable[_T]]=generator) -> IEnumerator[_T]:
...
def concat(sources: IEnumerable[Any]) -> IEnumerable[Any]:
    def _arrow141(__unit: Literal[None]=None, sources: IEnumerable[__A]=sources) -> IEnumerator[_T]:
...
def unfold(generator: Callable[[_STATE], Optional[Tuple[_T, _STATE]]], state: _STATE) -> IEnumerable[_T]:
    def _arrow142(__unit: Literal[None]=None, generator: Callable[[_STATE], Optional[Tuple[_T, _STATE]]]=generator, state: _STATE=state) -> IEnumerator[_T]:
        return Enumerator_unfold(generator, state)

    return mk_seq(_arrow142)


def empty(__unit: Literal[None]=None) -> IEnumerable[Any]:
    def _arrow143(__unit: Literal[None]=None) -> IEnumerable[_T]:
        return [0] * 0
...
def singleton(x: Optional[_T]=None) -> IEnumerable[_T]:
    def _arrow144(__unit: Literal[None]=None, x: _T=x) -> IEnumerable[_T]:
...
def generate(create: Callable[[], __A], compute: Callable[[__A], Optional[__B]], dispose: Callable[[__A], None]) -> IEnumerable[__B]:
    def _arrow145(__unit: Literal[None]=None, create: Callable[[], __A]=create, compute: Callable[[__A], Optional[__B]]=compute, dispose: Callable[[__A], None]=dispose) -> IEnumerator[__B]:
        return Enumerator_generateWhileSome(create, compute, dispose)

    return mk_seq(_arrow145)


def generate_indexed(create: Callable[[], __A], compute: Callable[[int, __A], Optional[__B]], dispose: Callable[[__A], None]) -> IEnumerable[__B]:
    def _arrow147(__unit: Literal[None]=None, create: Callable[[], __A]=create, compute: Callable[[int, __A], Optional[__B]]=compute, dispose: Callable[[__A], None]=dispose) -> IEnumerator[__B]:
        i: int = -1
        def _arrow146(x: Optional[__A]=None) -> Optional[__B]:
            nonlocal i
            i = (i + 1) or 0
            return compute(i, x)

        return Enumerator_generateWhileSome(create, _arrow146, dispose)
...
def cast(xs: IEnumerable[Any]) -> IEnumerable[Any]:
    def _arrow148(__unit: Literal[None]=None, xs: IEnumerable[Any]=xs) -> IEnumerator[__A]:
        check_non_null("source", xs)
        return Enumerator_cast(get_enumerator(xs))

    return mk_seq(_arrow148)


def choose(chooser: Callable[[_T], Optional[_U]], xs: IEnumerable[_T]) -> IEnumerable[_U]:
    def _arrow149(__unit: Literal[None]=None, chooser: Callable[[_T], Optional[_U]]=chooser, xs: IEnumerable[_T]=xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow150(e: IEnumerator[_T], chooser: Callable[[_T], Optional[_U]]=chooser, xs: IEnumerable[_T]=xs) -> Optional[_U]:
        curr: Optional[_U] = None
    ...
    def _arrow151(e_1: IEnumerator[_T], chooser: Callable[[_T], Optional[_U]]=chooser, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(e_1)

    return generate(_arrow149, _arrow150, _arrow151)
...
def contains(value: _T, xs: IEnumerable[_T], comparer: IEqualityComparer_1[Any]) -> bool:
    with of_seq(xs) as e:
        found: bool = False
...
def enumerate_from_functions(create: Callable[[], __A], move_next: Callable[[__A], bool], current: Callable[[__A], __B]) -> IEnumerable[__B]:
    def _arrow152(x: Optional[__A]=None, create: Callable[[], __A]=create, move_next: Callable[[__A], bool]=move_next, current: Callable[[__A], __B]=current) -> Optional[__B]:
        return some(current(x)) if move_next(x) else None

    def _arrow153(x_1: Optional[__A]=None, create: Callable[[], __A]=create, move_next: Callable[[__A], bool]=move_next, current: Callable[[__A], __B]=current) -> None:
        match_value: Any = x_1
        if is_disposable(match_value):
            dispose_2(match_value)


    return generate(create, _arrow152, _arrow153)
...
def enumerate_then_finally(source: IEnumerable[_T], compensation: Callable[[], None]) -> IEnumerable[_T]:
    ...
    def _arrow154(__unit: Literal[None]=None, source: IEnumerable[_T]=source, compensation: Callable[[], None]=compensation) -> IEnumerator[_T]:
        try: 
...
def enumerate_using(resource: _T, source: Callable[[_T], __A]) -> IEnumerable[Any]:
    def compensation(__unit: Literal[None]=None, resource: _T=resource, source: Callable[[_T], __A]=source) -> None:
    ...
    def _arrow155(__unit: Literal[None]=None, resource: _T=resource, source: Callable[[_T], __A]=source) -> IEnumerator[_U]:
        try: 
    ...
    return mk_seq(_arrow155)


def enumerate_while(guard: Callable[[], bool], xs: IEnumerable[_T]) -> IEnumerable[_T]:
    def _arrow156(i: int, guard: Callable[[], bool]=guard, xs: IEnumerable[_T]=xs) -> Optional[Tuple[IEnumerable[_T], int]]:
        return ((xs, i + 1)) if guard() else None

    return concat(unfold(_arrow156, 0))
...
def fold_back(folder: Callable[[_T, __A], __A], xs: IEnumerable[_T], state: __A) -> __A:
...
def for_all(predicate: Callable[[__A], bool], xs: IEnumerable[__A]) -> bool:
    def _arrow157(x: Optional[__A]=None, predicate: Callable[[__A], bool]=predicate, xs: IEnumerable[__A]=xs) -> bool:
        return not predicate(x)

    return not exists(_arrow157, xs)


def for_all2(predicate: Callable[[__A, __B], bool], xs: IEnumerable[__A], ys: IEnumerable[__B]) -> bool:
    def _arrow158(x: __A, y: __B, predicate: Callable[[__A, __B], bool]=predicate, xs: IEnumerable[__A]=xs, ys: IEnumerable[__B]=ys) -> bool:
        return not predicate(x, y)

    return not exists2(_arrow158, xs, ys)
...
def initialize(count: int, f: Callable[[int], __A]) -> IEnumerable[__A]:
    def _arrow159(i: int, count: int=count, f: Callable[[int], __A]=f) -> Optional[Tuple[__A, int]]:
        return ((f(i), i + 1)) if (i < count) else None

    return unfold(_arrow159, 0)
...
def iterate(action: Callable[[__A], None], xs: IEnumerable[__A]) -> None:
    def _arrow160(unit_var: None, x: __A, action: Callable[[__A], None]=action, xs: IEnumerable[__A]=xs) -> None:
        action(x)

    fold(_arrow160, None, xs)


def iterate2(action: Callable[[__A, __B], None], xs: IEnumerable[__A], ys: IEnumerable[__B]) -> None:
    def _arrow161(unit_var: None, x: __A, y: __B, action: Callable[[__A, __B], None]=action, xs: IEnumerable[__A]=xs, ys: IEnumerable[__B]=ys) -> None:
        action(x, y)

    fold2(_arrow161, None, xs, ys)


def iterate_indexed(action: Callable[[int, __A], None], xs: IEnumerable[__A]) -> None:
    def _arrow162(i: int, x: __A, action: Callable[[int, __A], None]=action, xs: IEnumerable[__A]=xs) -> int:
        action(i, x)
        return i + 1

    ignore(fold(_arrow162, 0, xs))


def iterate_indexed2(action: Callable[[int, __A, __B], None], xs: IEnumerable[__A], ys: IEnumerable[__B]) -> None:
    def _arrow163(i: int, x: __A, y: __B, action: Callable[[int, __A, __B], None]=action, xs: IEnumerable[__A]=xs, ys: IEnumerable[__B]=ys) -> int:
        action(i, x, y)
        return i + 1

    ignore(fold2(_arrow163, 0, xs, ys))


def try_last(xs: IEnumerable[_T]) -> Optional[_T]:
    with of_seq(xs) as e:
        def loop(acc_mut: Optional[_T]=None, xs: IEnumerable[_T]=xs) -> Optional[_T]:
            while True:
                (acc,) = (acc_mut,)
                if not e.System_Collections_IEnumerator_MoveNext():
                    return acc
...
def map(mapping: Callable[[_T], _U], xs: IEnumerable[_T]) -> IEnumerable[_U]:
    def _arrow164(__unit: Literal[None]=None, mapping: Callable[[_T], _U]=mapping, xs: IEnumerable[_T]=xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow165(e: IEnumerator[_T], mapping: Callable[[_T], _U]=mapping, xs: IEnumerable[_T]=xs) -> Optional[_U]:
    ...
    def _arrow166(e_1: IEnumerator[_T], mapping: Callable[[_T], _U]=mapping, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(e_1)

    return generate(_arrow164, _arrow165, _arrow166)


def map_indexed(mapping: Callable[[int, _T], _U], xs: IEnumerable[_T]) -> IEnumerable[_U]:
    def _arrow167(__unit: Literal[None]=None, mapping: Callable[[int, _T], _U]=mapping, xs: IEnumerable[_T]=xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow168(i: int, e: IEnumerator[_T], mapping: Callable[[int, _T], _U]=mapping, xs: IEnumerable[_T]=xs) -> Optional[_U]:
    ...
    def _arrow169(e_1: IEnumerator[_T], mapping: Callable[[int, _T], _U]=mapping, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(e_1)

    return generate_indexed(_arrow167, _arrow168, _arrow169)
...
def map2(mapping: Callable[[_T1, _T2], _U], xs: IEnumerable[_T1], ys: IEnumerable[_T2]) -> IEnumerable[_U]:
    def _arrow170(__unit: Literal[None]=None, mapping: Callable[[_T1, _T2], _U]=mapping, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys) -> Tuple[IEnumerator[_T1], IEnumerator[_T2]]:
        return (of_seq(xs), of_seq(ys))

    def _arrow171(tupled_arg: Tuple[IEnumerator[_T1], IEnumerator[_T2]], mapping: Callable[[_T1, _T2], _U]=mapping, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys) -> Optional[_U]:
    ...
    def _arrow172(tupled_arg_1: Tuple[IEnumerator[_T1], IEnumerator[_T2]], mapping: Callable[[_T1, _T2], _U]=mapping, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys) -> None:
        try: 
    ...
    return generate(_arrow170, _arrow171, _arrow172)


def map_indexed2(mapping: Callable[[int, _T1, _T2], _U], xs: IEnumerable[_T1], ys: IEnumerable[_T2]) -> IEnumerable[_U]:
    def _arrow173(__unit: Literal[None]=None, mapping: Callable[[int, _T1, _T2], _U]=mapping, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys) -> Tuple[IEnumerator[_T1], IEnumerator[_T2]]:
        return (of_seq(xs), of_seq(ys))

    def _arrow174(i: int, tupled_arg: Tuple[IEnumerator[_T1], IEnumerator[_T2]], mapping: Callable[[int, _T1, _T2], _U]=mapping, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys) -> Optional[_U]:
        e1: IEnumerator[_T1] = tupled_arg[0]
        e2: IEnumerator[_T2] = tupled_arg[1]
    ...
    def _arrow175(tupled_arg_1: Tuple[IEnumerator[_T1], IEnumerator[_T2]], mapping: Callable[[int, _T1, _T2], _U]=mapping, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys) -> None:
        try: 
            dispose_2(tupled_arg_1[0])
    ...
    return generate_indexed(_arrow173, _arrow174, _arrow175)


def map3(mapping: Callable[[_T1, _T2, _T3], _U], xs: IEnumerable[_T1], ys: IEnumerable[_T2], zs: IEnumerable[_T3]) -> IEnumerable[_U]:
    def _arrow176(__unit: Literal[None]=None, mapping: Callable[[_T1, _T2, _T3], _U]=mapping, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys, zs: IEnumerable[_T3]=zs) -> Tuple[IEnumerator[_T1], IEnumerator[_T2], IEnumerator[_T3]]:
        return (of_seq(xs), of_seq(ys), of_seq(zs))

    def _arrow177(tupled_arg: Tuple[IEnumerator[_T1], IEnumerator[_T2], IEnumerator[_T3]], mapping: Callable[[_T1, _T2, _T3], _U]=mapping, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys, zs: IEnumerable[_T3]=zs) -> Optional[_U]:
        e1: IEnumerator[_T1] = tupled_arg[0]
        e2: IEnumerator[_T2] = tupled_arg[1]
    ...
    def _arrow178(tupled_arg_1: Tuple[IEnumerator[_T1], IEnumerator[_T2], IEnumerator[_T3]], mapping: Callable[[_T1, _T2, _T3], _U]=mapping, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys, zs: IEnumerable[_T3]=zs) -> None:
        try: 
            dispose_2(tupled_arg_1[0])
    ...
    return generate(_arrow176, _arrow177, _arrow178)


def read_only(xs: IEnumerable[_T]) -> IEnumerable[_T]:
    check_non_null("source", xs)
    def _arrow179(x: Optional[_T]=None, xs: IEnumerable[_T]=xs) -> Optional[_T]:
        return x

    return map(_arrow179, xs)
...
CachedSeq_1_reflection = _expr180
...
def cache(source: IEnumerable[_T]) -> IEnumerable[_T]:
    ...
    def cleanup(__unit: Literal[None]=None, source: IEnumerable[_T]=source) -> None:
        def _arrow181(__unit: Literal[None]=None) -> None:
            nonlocal enumerator_r
            clear(prefix)
        ...
        lock(prefix, _arrow181)

    def _arrow183(i_1: int, source: IEnumerable[_T]=source) -> Optional[Tuple[_T, int]]:
        def _arrow182(__unit: Literal[None]=None) -> Optional[Tuple[_T, int]]:
            if i_1 < len(prefix):
        ...
        return lock(prefix, _arrow182)

    return CachedSeq_1__ctor_Z7A8347D4(cleanup, unfold(_arrow183, 0))


def all_pairs(xs: IEnumerable[_T1], ys: IEnumerable[_T2]) -> IEnumerable[Tuple[_T1, _T2]]:
    ys_cache: IEnumerable[_T2] = cache(ys)
    def _arrow184(__unit: Literal[None]=None, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys) -> IEnumerable[Tuple[_T1, _T2]]:
...
def reduce(folder: Callable[[_T, _T], _T], xs: IEnumerable[_T]) -> _T:
    with of_seq(xs) as e:
        def loop(acc_mut: Optional[_T]=None, folder: Callable[[_T, _T], _T]=folder, xs: IEnumerable[_T]=xs) -> Optional[_T]:
            while True:
                (acc,) = (acc_mut,)
                if e.System_Collections_IEnumerator_MoveNext():
...
def replicate(n: int, x: __A) -> IEnumerable[__A]:
    def _arrow185(_arg: int, n: int=n, x: __A=x) -> __A:
        return x

    return initialize(n, _arrow185)


def reverse(xs: IEnumerable[_T]) -> IEnumerable[_T]:
    def _arrow186(__unit: Literal[None]=None, xs: IEnumerable[_T]=xs) -> IEnumerable[_T]:
...
def scan(folder: Callable[[_STATE, _T], _STATE], state: _STATE, xs: IEnumerable[_T]) -> IEnumerable[_STATE]:
    def _arrow187(__unit: Literal[None]=None, folder: Callable[[_STATE, _T], _STATE]=folder, state: _STATE=state, xs: IEnumerable[_T]=xs) -> IEnumerable[_STATE]:
        acc: _STATE = state
...
def scan_back(folder: Callable[[_T, _STATE], _STATE], xs: IEnumerable[_T], state: _STATE) -> IEnumerable[_STATE]:
    def _arrow188(__unit: Literal[None]=None, folder: Callable[[_T, _STATE], _STATE]=folder, xs: IEnumerable[_T]=xs, state: _STATE=state) -> IEnumerable[_STATE]:
...
def skip(count: int, source: IEnumerable[_T]) -> IEnumerable[_T]:
    def _arrow189(__unit: Literal[None]=None, count: int=count, source: IEnumerable[_T]=source) -> IEnumerator[_T]:
    ...
    return mk_seq(_arrow189)


def skip_while(predicate: Callable[[_T], bool], xs: IEnumerable[_T]) -> IEnumerable[_T]:
    def _arrow190(__unit: Literal[None]=None, predicate: Callable[[_T], bool]=predicate, xs: IEnumerable[_T]=xs) -> IEnumerable[_T]:
        skipped: bool = True
...
def take(count: int, xs: IEnumerable[_T]) -> IEnumerable[_T]:
    def _arrow191(__unit: Literal[None]=None, count: int=count, xs: IEnumerable[_T]=xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow192(i: int, e: IEnumerator[_T], count: int=count, xs: IEnumerable[_T]=xs) -> Optional[_T]:
        if i < count:
            if e.System_Collections_IEnumerator_MoveNext():
                return some(e.System_Collections_Generic_IEnumerator_1_get_Current())
    ...
    def _arrow193(e_1: IEnumerator[_T], count: int=count, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(e_1)
...
def take_while(predicate: Callable[[_T], bool], xs: IEnumerable[_T]) -> IEnumerable[_T]:
    def _arrow194(__unit: Literal[None]=None, predicate: Callable[[_T], bool]=predicate, xs: IEnumerable[_T]=xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow195(e: IEnumerator[_T], predicate: Callable[[_T], bool]=predicate, xs: IEnumerable[_T]=xs) -> Optional[_T]:
    ...
    def _arrow196(e_1: IEnumerator[_T], predicate: Callable[[_T], bool]=predicate, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(e_1)

    return generate(_arrow194, _arrow195, _arrow196)


def truncate(count: int, xs: IEnumerable[_T]) -> IEnumerable[_T]:
    def _arrow197(__unit: Literal[None]=None, count: int=count, xs: IEnumerable[_T]=xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow198(i: int, e: IEnumerator[_T], count: int=count, xs: IEnumerable[_T]=xs) -> Optional[_T]:
    ...
    def _arrow199(e_1: IEnumerator[_T], count: int=count, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(e_1)

    return generate_indexed(_arrow197, _arrow198, _arrow199)


def zip(xs: IEnumerable[_T1], ys: IEnumerable[_T2]) -> IEnumerable[Tuple[_T1, _T2]]:
    def _arrow200(x: _T1, y: _T2, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys) -> Tuple[_T1, _T2]:
        return (x, y)

    return map2(_arrow200, xs, ys)


def zip3(xs: IEnumerable[_T1], ys: IEnumerable[_T2], zs: IEnumerable[_T3]) -> IEnumerable[Tuple[_T1, _T2, _T3]]:
    def _arrow201(x: _T1, y: _T2, z: _T3, xs: IEnumerable[_T1]=xs, ys: IEnumerable[_T2]=ys, zs: IEnumerable[_T3]=zs) -> Tuple[_T1, _T2, _T3]:
        return (x, y, z)

    return map3(_arrow201, xs, ys, zs)


def collect(mapping: Callable[[_T], IEnumerable[_U]], xs: IEnumerable[_T]) -> IEnumerable[_U]:
    def _arrow202(__unit: Literal[None]=None, mapping: Callable[[_T], IEnumerable[_U]]=mapping, xs: IEnumerable[_T]=xs) -> IEnumerable[_U]:
...
def pairwise(xs: IEnumerable[_T]) -> IEnumerable[Tuple[_T, _T]]:
    def _arrow203(__unit: Literal[None]=None, xs: IEnumerable[_T]=xs) -> IEnumerable[Tuple[_T, _T]]:
...
def split_into(chunks: int, xs: IEnumerable[_T]) -> IEnumerable[IEnumerable[_T]]:
    def _arrow204(__unit: Literal[None]=None, chunks: int=chunks, xs: IEnumerable[_T]=xs) -> IEnumerable[IEnumerable[_T]]:
...
def windowed(window_size: int, xs: IEnumerable[_T]) -> IEnumerable[IEnumerable[_T]]:
    def _arrow205(__unit: Literal[None]=None, window_size: int=window_size, xs: IEnumerable[_T]=xs) -> IEnumerable[IEnumerable[_T]]:
        def mapping(arr: Array[_T]) -> IEnumerable[_T]:
            return of_array(arr)
...
def transpose(xss: IEnumerable[Any]) -> IEnumerable[IEnumerable[Any]]:
    def _arrow206(__unit: Literal[None]=None, xss: IEnumerable[__A]=xss) -> IEnumerable[IEnumerable[_T]]:
...
def sort_with(comparer: Callable[[_T, _T], int], xs: IEnumerable[_T]) -> IEnumerable[_T]:
    def _arrow207(__unit: Literal[None]=None, comparer: Callable[[_T, _T], int]=comparer, xs: IEnumerable[_T]=xs) -> IEnumerable[_T]:
        arr: Array[_T] = to_array(xs)
        arr.sort()
        return of_array(arr)

    return delay(_arrow207)


def sort(xs: IEnumerable[_T], comparer: IComparer_1[_T]) -> IEnumerable[_T]:
    def _arrow208(x: _T, y: _T, xs: IEnumerable[_T]=xs, comparer: IComparer_1[_T]=comparer) -> int:
        return comparer.Compare(x, y)

    return sort_with(_arrow208, xs)


def sort_by(projection: Callable[[_T], _U], xs: IEnumerable[_T], comparer: IComparer_1[_U]) -> IEnumerable[_T]:
    def _arrow209(x: _T, y: _T, projection: Callable[[_T], _U]=projection, xs: IEnumerable[_T]=xs, comparer: IComparer_1[_U]=comparer) -> int:
        return comparer.Compare(projection(x), projection(y))

    return sort_with(_arrow209, xs)


def sort_descending(xs: IEnumerable[_T], comparer: IComparer_1[_T]) -> IEnumerable[_T]:
    def _arrow210(x: _T, y: _T, xs: IEnumerable[_T]=xs, comparer: IComparer_1[_T]=comparer) -> int:
        return comparer.Compare(x, y) * -1

    return sort_with(_arrow210, xs)


def sort_by_descending(projection: Callable[[_T], _U], xs: IEnumerable[_T], comparer: IComparer_1[_U]) -> IEnumerable[_T]:
    def _arrow211(x: _T, y: _T, projection: Callable[[_T], _U]=projection, xs: IEnumerable[_T]=xs, comparer: IComparer_1[_U]=comparer) -> int:
        return comparer.Compare(projection(x), projection(y)) * -1

    return sort_with(_arrow211, xs)


def sum(xs: IEnumerable[_T], adder: IGenericAdder_1[_T]) -> _T:
    def _arrow212(acc: _T, x: _T, xs: IEnumerable[_T]=xs, adder: IGenericAdder_1[_T]=adder) -> _T:
...
def sum_by(f: Callable[[_T], _U], xs: IEnumerable[_T], adder: IGenericAdder_1[_U]) -> _U:
    def _arrow213(acc: _U, x: _T, f: Callable[[_T], _U]=f, xs: IEnumerable[_T]=xs, adder: IGenericAdder_1[_U]=adder) -> _U:
        return adder.Add(acc, f(x))

    return fold(_arrow213, adder.GetZero(), xs)


def max_by(projection: Callable[[_T], _U], xs: IEnumerable[_T], comparer: IComparer_1[_U]) -> _T:
    def _arrow214(x: _T, y: _T, projection: Callable[[_T], _U]=projection, xs: IEnumerable[_T]=xs, comparer: IComparer_1[_U]=comparer) -> _T:
        return y if (comparer.Compare(projection(y), projection(x)) > 0) else x

    return reduce(_arrow214, xs)


def max(xs: IEnumerable[_T], comparer: IComparer_1[_T]) -> _T:
    def _arrow215(x: _T, y: _T, xs: IEnumerable[_T]=xs, comparer: IComparer_1[_T]=comparer) -> _T:
        return y if (comparer.Compare(y, x) > 0) else x

    return reduce(_arrow215, xs)


def min_by(projection: Callable[[_T], _U], xs: IEnumerable[_T], comparer: IComparer_1[_U]) -> _T:
    def _arrow216(x: _T, y: _T, projection: Callable[[_T], _U]=projection, xs: IEnumerable[_T]=xs, comparer: IComparer_1[_U]=comparer) -> _T:
        return x if (comparer.Compare(projection(y), projection(x)) > 0) else y

    return reduce(_arrow216, xs)


def min(xs: IEnumerable[_T], comparer: IComparer_1[_T]) -> _T:
    def _arrow217(x: _T, y: _T, xs: IEnumerable[_T]=xs, comparer: IComparer_1[_T]=comparer) -> _T:
        return x if (comparer.Compare(y, x) > 0) else y

    return reduce(_arrow217, xs)
...
def average_by(f: Callable[[_T], _U], xs: IEnumerable[_T], averager: IGenericAverager_1[_U]) -> _U:
    count: int = 0
    def _arrow218(acc: _U, x: _T, f: Callable[[_T], _U]=f, xs: IEnumerable[_T]=xs, averager: IGenericAverager_1[_U]=averager) -> _U:
        nonlocal count
        count = (count + 1) or 0
        return averager.Add(acc, f(x))

    total: _U = fold(_arrow218, averager.GetZero(), xs)
    if count == 0:
        raise Exception((SR_inputSequenceEmpty + "\\nParameter name: ") + "source")
...
def permute(f: Callable[[int], int], xs: IEnumerable[_T]) -> IEnumerable[_T]:
    def _arrow219(__unit: Literal[None]=None, f: Callable[[int], int]=f, xs: IEnumerable[_T]=xs) -> IEnumerable[_T]:
...
def chunk_by_size(chunk_size: int, xs: IEnumerable[_T]) -> IEnumerable[IEnumerable[_T]]:
    def _arrow220(__unit: Literal[None]=None, chunk_size: int=chunk_size, xs: IEnumerable[_T]=xs) -> IEnumerable[IEnumerable[_T]]:
        def mapping(arr: Array[_T]) -> IEnumerable[_T]:
            return of_array(arr)

        return of_array(map_1(mapping, chunk_by_size_1(chunk_size, to_array(xs)), None))

    return delay(_arrow220)
...
def insert_at(index: int, y: _T, xs: IEnumerable[_T]) -> IEnumerable[_T]:
    ...
    def _arrow221(__unit: Literal[None]=None, index: int=index, y: _T=y, xs: IEnumerable[_T]=xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow222(i: int, e: IEnumerator[_T], index: int=index, y: _T=y, xs: IEnumerable[_T]=xs) -> Optional[_T]:
        nonlocal is_done
    ...
    def _arrow223(e_1: IEnumerator[_T], index: int=index, y: _T=y, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(e_1)
...
def insert_many_at(index: int, ys: IEnumerable[_T], xs: IEnumerable[_T]) -> IEnumerable[_T]:
    ...
    def _arrow224(__unit: Literal[None]=None, index: int=index, ys: IEnumerable[_T]=ys, xs: IEnumerable[_T]=xs) -> Tuple[IEnumerator[_T], IEnumerator[_T]]:
        return (of_seq(xs), of_seq(ys))

    def _arrow225(i: int, tupled_arg: Tuple[IEnumerator[_T], IEnumerator[_T]], index: int=index, ys: IEnumerable[_T]=ys, xs: IEnumerable[_T]=xs) -> Optional[_T]:
        nonlocal status
    ...
    def _arrow226(tupled_arg_1: Tuple[IEnumerator[_T], IEnumerator[_T]], index: int=index, ys: IEnumerable[_T]=ys, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(tupled_arg_1[0])
        dispose_2(tupled_arg_1[1])
...
def remove_at(index: int, xs: IEnumerable[_T]) -> IEnumerable[_T]:
    ...
    def _arrow227(__unit: Literal[None]=None, index: int=index, xs: IEnumerable[_T]=xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow228(i: int, e: IEnumerator[_T], index: int=index, xs: IEnumerable[_T]=xs) -> Optional[_T]:
        nonlocal is_done
        if e.System_Collections_IEnumerator_MoveNext() if (True if is_done else (i < index)) else False:
            return some(e.System_Collections_Generic_IEnumerator_1_get_Current())
    ...
    def _arrow229(e_1: IEnumerator[_T], index: int=index, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(e_1)
...
def remove_many_at(index: int, count: int, xs: IEnumerable[_T]) -> IEnumerable[_T]:
    ...
    def _arrow230(__unit: Literal[None]=None, index: int=index, count: int=count, xs: IEnumerable[_T]=xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow231(i: int, e: IEnumerator[_T], index: int=index, count: int=count, xs: IEnumerable[_T]=xs) -> Optional[_T]:
        if i < index:
            if e.System_Collections_IEnumerator_MoveNext():
                return some(e.System_Collections_Generic_IEnumerator_1_get_Current())
    ...
    def _arrow232(e_1: IEnumerator[_T], index: int=index, count: int=count, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(e_1)
...
def update_at(index: int, y: _T, xs: IEnumerable[_T]) -> IEnumerable[_T]:
    ...
    def _arrow233(__unit: Literal[None]=None, index: int=index, y: _T=y, xs: IEnumerable[_T]=xs) -> IEnumerator[_T]:
        return of_seq(xs)

    def _arrow234(i: int, e: IEnumerator[_T], index: int=index, y: _T=y, xs: IEnumerable[_T]=xs) -> Optional[_T]:
        nonlocal is_done
        if e.System_Collections_IEnumerator_MoveNext() if (True if is_done else (i < index)) else False:
            return some(e.System_Collections_Generic_IEnumerator_1_get_Current())
    ...
    def _arrow235(e_1: IEnumerator[_T], index: int=index, y: _T=y, xs: IEnumerable[_T]=xs) -> None:
        dispose_2(e_1)

    return generate_indexed(_arrow233, _arrow234, _arrow235)
