...
from .util import (get_enumerator, IEnumerator, to_iterator, ignore, IEnumerable, IEqualityComparer_1, dispose)
...
def HashSet__ctor_Z6150332D(items: IEnumerable[_T], comparer: IEqualityComparer_1[Any]) -> HashSet[_T]:
