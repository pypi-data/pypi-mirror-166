...
from .util import (IEnumerable, IEqualityComparer_1, get_enumerator)

_T = TypeVar("_T")

_KEY = TypeVar("_KEY")

def distinct(xs: IEnumerable[_T], comparer: IEqualityComparer_1[Any]) -> IEnumerable[_T]:
    def _arrow126(__unit: Literal[None]=None, xs: IEnumerable[_T]=xs, comparer: IEqualityComparer_1[Any]=comparer) -> IEnumerable[_T]:
...
def distinct_by(projection: Callable[[_T], _KEY], xs: IEnumerable[_T], comparer: IEqualityComparer_1[Any]) -> IEnumerable[_T]:
    def _arrow127(__unit: Literal[None]=None, projection: Callable[[_T], _KEY]=projection, xs: IEnumerable[_T]=xs, comparer: IEqualityComparer_1[Any]=comparer) -> IEnumerable[_T]:
        hash_set: Any = HashSet([], comparer)
        def predicate(x: Optional[_T]=None) -> bool:
...
def except_(items_to_exclude: IEnumerable[_T], xs: IEnumerable[_T], comparer: IEqualityComparer_1[Any]) -> IEnumerable[_T]:
    def _arrow128(__unit: Literal[None]=None, items_to_exclude: IEnumerable[_T]=items_to_exclude, xs: IEnumerable[_T]=xs, comparer: IEqualityComparer_1[Any]=comparer) -> IEnumerable[_T]:
...
def count_by(projection: Callable[[_T], _KEY], xs: IEnumerable[_T], comparer: IEqualityComparer_1[Any]) -> IEnumerable[Tuple[_KEY, int]]:
    def _arrow132(__unit: Literal[None]=None, projection: Callable[[_T], _KEY]=projection, xs: IEnumerable[_T]=xs, comparer: IEqualityComparer_1[Any]=comparer) -> IEnumerable[Tuple[_KEY, int]]:
...
def group_by(projection: Callable[[_T], _KEY], xs: IEnumerable[_T], comparer: IEqualityComparer_1[Any]) -> IEnumerable[Tuple[_KEY, IEnumerable[_T]]]:
    def _arrow136(__unit: Literal[None]=None, projection: Callable[[_T], _KEY]=projection, xs: IEnumerable[_T]=xs, comparer: IEqualityComparer_1[Any]=comparer) -> IEnumerable[Tuple[_KEY, IEnumerable[_T]]]:
        dict_1: Any = Dictionary([], comparer)
        keys: Array[_KEY] = []
        with get_enumerator(xs) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
        ...
        def _arrow135(key_1: Optional[_KEY]=None) -> Tuple[_KEY, IEnumerable[_T]]:
            return (key_1, get_item_from_dict(dict_1, key_1))
...
def Array_except(items_to_exclude: IEnumerable[_T], xs: Array[_T], comparer: IEqualityComparer_1[Any]) -> Array[_T]:
...
def Array_groupBy(projection: Callable[[_T], _KEY], xs: Array[_T], comparer: IEqualityComparer_1[Any]) -> Array[Tuple[_KEY, Array[_T]]]:
    def mapping(tupled_arg: Tuple[_KEY, IEnumerable[_T]], projection: Callable[[_T], _KEY]=projection, xs: Array[_T]=xs, comparer: IEqualityComparer_1[Any]=comparer) -> Tuple[_KEY, Array[_T]]:
...
def List_except(items_to_exclude: IEnumerable[_T], xs: FSharpList[_T], comparer: IEqualityComparer_1[Any]) -> FSharpList[_T]:
...
def List_groupBy(projection: Callable[[_T], _KEY], xs: FSharpList[_T], comparer: IEqualityComparer_1[Any]) -> FSharpList[Tuple[_KEY, FSharpList[_T]]]:
    def mapping(tupled_arg: Tuple[_KEY, IEnumerable[_T]], projection: Callable[[_T], _KEY]=projection, xs: FSharpList[_T]=xs, comparer: IEqualityComparer_1[Any]=comparer) -> Tuple[_KEY, FSharpList[_T]]:
