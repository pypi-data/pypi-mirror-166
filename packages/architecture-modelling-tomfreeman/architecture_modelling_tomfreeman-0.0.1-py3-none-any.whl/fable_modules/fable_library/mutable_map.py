...
from .util import (get_enumerator, IEnumerator, to_iterator, equals, ignore, IEnumerable, ICollection, IEqualityComparer_1, dispose)
...
class Dictionary(Generic[_KEY, _VALUE]):
    def __init__(self, pairs: IEnumerable[Any], comparer: IEqualityComparer_1[Any]) -> None:
    ...
    def System_Collections_Generic_IDictionary_2_get_Keys(self, __unit: Literal[None]=None) -> ICollection[_KEY]:
        this: Dictionary[_KEY, _VALUE] = self
        def _arrow33(__unit: Literal[None]=None) -> IEnumerable[_KEY]:
    ...
    def System_Collections_Generic_IDictionary_2_get_Values(self, __unit: Literal[None]=None) -> ICollection[_VALUE]:
        this: Dictionary[_KEY, _VALUE] = self
        def _arrow35(__unit: Literal[None]=None) -> IEnumerable[_VALUE]:
...
def Dictionary__ctor_6623D9B3(pairs: IEnumerable[Any], comparer: IEqualityComparer_1[Any]) -> Dictionary[_KEY, _VALUE]:
