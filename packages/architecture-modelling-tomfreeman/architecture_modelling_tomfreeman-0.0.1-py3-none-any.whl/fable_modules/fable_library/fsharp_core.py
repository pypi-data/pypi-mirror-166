...
class ObjectExpr16(IEqualityComparer):
...
LanguagePrimitives_GenericEqualityComparer: IEqualityComparer = ObjectExpr16()

class ObjectExpr17(IEqualityComparer):
    def System_Collections_IEqualityComparer_Equals541DA560(self, x: Any=None, y: Any=None) -> bool:
        return equals(x, y)
...
LanguagePrimitives_GenericEqualityERComparer: IEqualityComparer = ObjectExpr17()
...
def PrintfModule_PrintFormatToStringBuilder(builder: StringBuilder, format: Any) -> __A:
    def _arrow21(__unit: Literal[None]=None, builder: StringBuilder=builder, format: Any=format) -> None:
        ignore()

    return PrintfModule_PrintFormatToStringBuilderThen(_arrow21, builder, format)
