...
from .util import (IComparer_1, IEnumerator, IEnumerable, is_array_like, get_enumerator, ignore, to_iterator, structural_hash)
...
SetTreeLeaf_1_reflection = _expr236
...
SetTreeNode_1_reflection = _expr237
...
def SetTreeModule_rebalance(t1: Optional[SetTreeLeaf_1[_T]], v: _T, t2: Optional[SetTreeLeaf_1[_T]]=None) -> Optional[SetTreeLeaf_1[_T]]:
    ...
    if t2h > (t1h + 2):
        ...
        if isinstance(match_value_2, SetTreeNode_1):
            def _arrow239(__unit: Literal[None]=None, t1: Optional[SetTreeLeaf_1[_T]]=t1, v: _T=v, t2: Optional[SetTreeLeaf_1[_T]]=t2) -> int:
...
def SetTreeModule_subset(comparer: IComparer_1[__A], a: Optional[SetTreeLeaf_1[__A]]=None, b: Optional[SetTreeLeaf_1[__A]]=None) -> bool:
    ...
    return SetTreeModule_forall(_arrow240, a)
...
def SetTreeModule_properSubset(comparer: IComparer_1[__A], a: Optional[SetTreeLeaf_1[__A]]=None, b: Optional[SetTreeLeaf_1[__A]]=None) -> bool:
    def _arrow241(x: Optional[__A]=None, comparer: IComparer_1[__A]=comparer, a: Optional[SetTreeLeaf_1[__A]]=a, b: Optional[SetTreeLeaf_1[__A]]=b) -> bool:
        return SetTreeModule_mem(comparer, x, b)

    if SetTreeModule_forall(_arrow241, a):
        def _arrow242(x_1: Optional[__A]=None, comparer: IComparer_1[__A]=comparer, a: Optional[SetTreeLeaf_1[__A]]=a, b: Optional[SetTreeLeaf_1[__A]]=b) -> bool:
            return not SetTreeModule_mem(comparer, x_1, a)

        return SetTreeModule_exists(_arrow242, b)
...
SetTreeModule_SetIterator_1_reflection = _expr243
...
def SetTreeModule_copyToArray(s: Optional[SetTreeLeaf_1[__A]], arr: Array[__A], i: int) -> None:
    j: int = i or 0
    def _arrow245(x: Optional[__A]=None, s: Optional[SetTreeLeaf_1[__A]]=s, arr: Array[__A]=arr, i: int=i) -> None:
        nonlocal j
        arr[j] = x
        j = (j + 1) or 0

    SetTreeModule_iter(_arrow245, s)
...
def SetTreeModule_ofArray(comparer: IComparer_1[__A], l: Array[__A]) -> Optional[SetTreeLeaf_1[__A]]:
    def _arrow246(acc: Optional[SetTreeLeaf_1[__A]], k: __A, comparer: IComparer_1[__A]=comparer, l: Array[__A]=l) -> Optional[SetTreeLeaf_1[__A]]:
        return SetTreeModule_add(comparer, k, acc)

    return fold_1(_arrow246, SetTreeModule_empty(), l)


def SetTreeModule_ofList(comparer: IComparer_1[__A], l: FSharpList[__A]) -> Optional[SetTreeLeaf_1[__A]]:
    def _arrow247(acc: Optional[SetTreeLeaf_1[__A]], k: __A, comparer: IComparer_1[__A]=comparer, l: FSharpList[__A]=l) -> Optional[SetTreeLeaf_1[__A]]:
        return SetTreeModule_add(comparer, k, acc)

    return fold_2(_arrow247, SetTreeModule_empty(), l)


def SetTreeModule_ofSeq(comparer: IComparer_1[_T], c: IEnumerable[_T]) -> Optional[SetTreeLeaf_1[_T]]:
    if is_array_like(c):
...
def _expr249(gen0: TypeInfo) -> TypeInfo:
...
class FSharpSet(Generic[_T]):
    ...
    def __str__(self, __unit: Literal[None]=None) -> str:
        this: FSharpSet[_T] = self
        def _arrow248(x: Optional[_T]=None) -> str:
            copy_of_struct: _T = x
            return to_string(copy_of_struct)

        return ("set [" + join("; ", map_1(_arrow248, this))) + "]"
    ...
    def keys(self, __unit: Literal[None]=None) -> IEnumerable[_T]:
        s: FSharpSet[_T] = self
    ...
    def values(self, __unit: Literal[None]=None) -> IEnumerable[_T]:
        s: FSharpSet[_T] = self
        def mapping(x: Optional[_T]=None) -> Optional[_T]:
            return x
    ...
    def entries(self, __unit: Literal[None]=None) -> IEnumerable[Tuple[_T, _T]]:
        s: FSharpSet[_T] = self
...
def FSharpSet__Fold(s: FSharpSet[_T], f: Callable[[_T, __A], __A], z: __A) -> __A:
    f_1: Any = f
    def _arrow250(x: __A, z_1: _T, s: FSharpSet[_T]=s, f: Callable[[_T, __A], __A]=f, z: __A=z) -> __A:
        return f_1(z_1, x)

    return SetTreeModule_fold(_arrow250, z, FSharpSet__get_Tree(s))
...
def FSharpSet__Map(s: FSharpSet[_T], f: Callable[[_T], _U], comparer: IComparer_1[_U]) -> FSharpSet[_U]:
    def _arrow251(acc: Optional[SetTreeLeaf_1[_U]], k: _T, s: FSharpSet[_T]=s, f: Callable[[_T], _U]=f, comparer: IComparer_1[_U]=comparer) -> Optional[SetTreeLeaf_1[_U]]:
        return SetTreeModule_add(comparer, f(k), acc)

    return FSharpSet__ctor(comparer, SetTreeModule_fold(_arrow251, SetTreeModule_empty(), FSharpSet__get_Tree(s)))
...
def FSharpSet_IntersectionMany(sets: IEnumerable[FSharpSet[_T]]) -> FSharpSet[_T]:
    def _arrow252(s1: FSharpSet[_T], s2: FSharpSet[_T], sets: IEnumerable[FSharpSet[_T]]=sets) -> FSharpSet[_T]:
        return FSharpSet_Intersection(s1, s2)

    return reduce(_arrow252, sets)
...
def union_many(sets: IEnumerable[FSharpSet[_T]], comparer: IComparer_1[_T]) -> FSharpSet[_T]:
    def _arrow253(s1: FSharpSet[_T], s2: FSharpSet[_T], sets: IEnumerable[FSharpSet[_T]]=sets, comparer: IComparer_1[_T]=comparer) -> FSharpSet[_T]:
        return FSharpSet_op_Addition(s1, s2)

    return fold_3(_arrow253, FSharpSet_Empty(comparer), sets)
...
def of_list(elements: IEnumerable[_T], comparer: IComparer_1[_T]) -> FSharpSet[_T]:
...
def of_seq(elements: IEnumerable[_T], comparer: IComparer_1[_T]) -> FSharpSet[_T]:
    return FSharpSet__ctor(comparer, SetTreeModule_ofSeq(comparer, elements))
