...
from .util import (IComparer_1, IEnumerator, IEnumerable, is_array_like, get_enumerator, equals, to_iterator, compare, ignore, ICollection, structural_hash)
...
MapTreeLeaf_2_reflection = _expr254
...
MapTreeNode_2_reflection = _expr255
...
def MapTreeModule_rebalance(t1: Optional[MapTreeLeaf_2[_KEY, _VALUE]], k: _KEY, v: _VALUE, t2: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Optional[MapTreeLeaf_2[_KEY, _VALUE]]:
    ...
    if t2h > (t1h + 2):
        ...
        if isinstance(match_value_2, MapTreeNode_2):
            def _arrow257(__unit: Literal[None]=None, t1: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=t1, k: _KEY=k, v: _VALUE=v, t2: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=t2) -> int:
...
def MapTreeModule_foldSectionOpt(comparer: IComparer_1[_KEY], lo: _KEY, hi: _KEY, f: Any, m: Optional[MapTreeLeaf_2[_KEY, _VALUE]], x: __A) -> __A:
    def fold_from_to(f_1_mut: Any, m_1_mut: Optional[MapTreeLeaf_2[_KEY, _VALUE]], x_1_mut: __B, comparer: IComparer_1[_KEY]=comparer, lo: _KEY=lo, hi: _KEY=hi, f: Any=f, m: Optional[MapTreeLeaf_2[_KEY, _VALUE]]=m, x: __A=x) -> __B:
        while True:
...
def MapTreeModule_copyToArray(m: Optional[MapTreeLeaf_2[__A, __B]], arr: Array[Any], i: int) -> None:
    j: int = i or 0
    def _arrow258(x: __A, y: __B, m: Optional[MapTreeLeaf_2[__A, __B]]=m, arr: Array[Any]=arr, i: int=i) -> None:
        nonlocal j
        arr[j] = (x, y)
        j = (j + 1) or 0

    MapTreeModule_iter(_arrow258, m)
...
def MapTreeModule_ofList(comparer: IComparer_1[__A], l: FSharpList[Tuple[__A, __B]]) -> Optional[MapTreeLeaf_2[__A, __B]]:
    def _arrow259(acc: Optional[MapTreeLeaf_2[__A, __B]], tupled_arg: Tuple[__A, __B], comparer: IComparer_1[__A]=comparer, l: FSharpList[Tuple[__A, __B]]=l) -> Optional[MapTreeLeaf_2[__A, __B]]:
        return MapTreeModule_add(comparer, tupled_arg[0], tupled_arg[1], acc)

    return fold_1(_arrow259, MapTreeModule_empty(), l)
...
def MapTreeModule_ofSeq(comparer: IComparer_1[_KEY], c: IEnumerable[Tuple[_KEY, _VALUE]]) -> Optional[MapTreeLeaf_2[_KEY, _VALUE]]:
    if is_array_like(c):
...
def _expr260(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
MapTreeModule_MapIterator_2_reflection = _expr260
...
def MapTreeModule_mkIEnumerator(m: Optional[MapTreeLeaf_2[_A, _B]]=None) -> IEnumerator[Any]:
    ...
    class ObjectExpr261(IEnumerator[Any]):
    ...
    return ObjectExpr261()


def MapTreeModule_toSeq(s: Optional[MapTreeLeaf_2[__A, __B]]=None) -> IEnumerable[Any]:
...
def _expr264(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
class FSharpMap(Generic[_KEY, _VALUE]):
    ...
    def __str__(self, __unit: Literal[None]=None) -> str:
        this: FSharpMap[_KEY, _VALUE] = self
        def _arrow262(kv: Any) -> str:
            return format("({0}, {1})", kv[0], kv[1])

        return ("map [" + join("; ", map_1(_arrow262, this))) + "]"
    ...
    def entries(self, __unit: Literal[None]=None) -> IEnumerable[Tuple[_KEY, _VALUE]]:
        m: FSharpMap[_KEY, _VALUE] = self
    ...
    def keys(self, __unit: Literal[None]=None) -> IEnumerable[_KEY]:
        m: FSharpMap[_KEY, _VALUE] = self
    ...
    def values(self, __unit: Literal[None]=None) -> IEnumerable[_VALUE]:
        m: FSharpMap[_KEY, _VALUE] = self
...
def of_seq(elements: IEnumerable[Tuple[_T, __A]], comparer: IComparer_1[_T]) -> FSharpMap[_T, __A]:
    return FSharpMap__ctor(comparer, MapTreeModule_ofSeq(comparer, elements))
