...
def run_workflow(
    ...
    Step 1: Get the ws_root_path and workflow_dir
    ...
    if ws_config.workflow_dir is None:
        logger.error("Workflow directory invalid")
        return
    workflow_dir: str = ws_config.workflow_dir

    # Step 2: Get the workflow_file and workflow_name
    # The workflow_file is the path of the file relative to the workflow_dir.
    ...
    try:
        workflow_file_path = (
            ws_root_path.joinpath(workflow_dir)
