...
#long_description='A python model with additional files. A test for PyPI'

setup(
    

    # Define the library name, this is what is used along with `pip install`.
    name='my-test-package101',

    # Define the author of the repository.
    author='Dmitry Blum',

    # Define the Author's email, so people know who to reach out to.
    author_email='dmitryblum@tutanota.com',
    ...
    description='A python model with additional files',
