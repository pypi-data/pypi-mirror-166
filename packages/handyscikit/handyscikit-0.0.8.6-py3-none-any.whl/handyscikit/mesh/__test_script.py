...
class Mesh2DTest:
    ...
    def structured_quadrilateral_topology_test():
        ...
        assert mesh.face_area[0, 0] == 0.0 and mesh.face_area[0, 1] == -0.5 and mesh.face_area[0, 2] == 0.0
        assert mesh.face_area[1, 0] == 0.0 and mesh.face_area[1, 1] == -0.5 and mesh.face_area[1, 2] == 0.0
        assert mesh.face_area[2, 0] == 0.5 and mesh.face_area[2, 1] == 0.0 and mesh.face_area[2, 2] == 0.0
        assert mesh.face_area[3, 0] == 0.5 and mesh.face_area[3, 1] == 0.0 and mesh.face_area[3, 2] == 0.0
        assert mesh.face_area[4, 0] == 0.0 and mesh.face_area[4, 1] == 0.5 and mesh.face_area[4, 2] == 0.0
        assert mesh.face_area[5, 0] == 0.0 and mesh.face_area[5, 1] == 0.5 and mesh.face_area[5, 2] == 0.0
        assert mesh.face_area[6, 0] == -0.5 and mesh.face_area[6, 1] == 0.0 and mesh.face_area[6, 2] == 0.0
        assert mesh.face_area[7, 0] == -0.5 and mesh.face_area[7, 1] == 0.0 and mesh.face_area[7, 2] == 0.0
        assert mesh.face_area[8, 0] == 0.5 and mesh.face_area[8, 1] == 0.0 and mesh.face_area[8, 2] == 0.0
        assert mesh.face_area[9, 0] == 0.0 and mesh.face_area[9, 1] == 0.5 and mesh.face_area[9, 2] == 0.0
        assert mesh.face_area[10, 0] == 0.5 and mesh.face_area[10, 1] == 0.0 and mesh.face_area[10, 2] == 0.0
        assert mesh.face_area[11, 0] == 0.0 and mesh.face_area[11, 1] == 0.5 and mesh.face_area[11, 2] == 0.0
    ...
    def unstructured_triangle_topology_test():
        ...
        assert mesh.cell_cell[2, 0] == 3 and mesh.cell_cell[2, 1] == 8 and mesh.cell_cell[2, 2] == ghost_cell
        ...
        assert mesh.cell_face[1, 0] == 8 and mesh.cell_face[1, 1] == 2 and mesh.cell_face[1, 2] == 10
        assert mesh.cell_face[2, 0] == 3 and mesh.cell_face[2, 1] == 11 and mesh.cell_face[2, 2] == 12
        assert mesh.cell_face[3, 0] == 11 and mesh.cell_face[3, 1] == 4 and mesh.cell_face[3, 2] == 13
        ...
        assert mesh.cell_face[8, 0] == 10 and mesh.cell_face[8, 1] == 12 and mesh.cell_face[8, 2] == 20
        ...
        assert mesh.cells[1, 0] == 0 and mesh.cells[1, 1] == 5 and mesh.cells[1, 2] == 9
        assert mesh.cells[2, 0] == 9 and mesh.cells[2, 1] == 6 and mesh.cells[2, 2] == 1
        ...
        assert mesh.face_area[0, 0] == 0.0 and abs(mesh.face_area[0, 1] - (-0.5)) < error and mesh.face_area[0, 2] == 0.0
        assert mesh.face_area[1, 0] == 0.0 and abs(mesh.face_area[1, 1] - (-0.5)) < error and mesh.face_area[1, 2] == 0.0
        assert abs(mesh.face_area[2, 0] - 0.5) < error and mesh.face_area[2, 1] == 0.0 and mesh.face_area[2, 2] == 0.0
        assert abs(mesh.face_area[3, 0] - 0.5) < error and mesh.face_area[3, 1] == 0.0 and mesh.face_area[3, 2] == 0.0
        assert mesh.face_area[4, 0] == 0.0 and abs(mesh.face_area[4, 1] - 0.5) < error and mesh.face_area[4, 2] == 0.0
        assert mesh.face_area[5, 0] == 0.0 and abs(mesh.face_area[5, 1] - 0.5) < error and mesh.face_area[5, 2] == 0.0
        assert abs(mesh.face_area[6, 0] - (-0.5)) < error and mesh.face_area[6, 1] == 0.0 and mesh.face_area[6, 2] == 0.0
        assert abs(mesh.face_area[7, 0] - (-0.5)) < error and mesh.face_area[7, 1] == 0.0 and mesh.face_area[7, 2] == 0.0
        assert abs(mesh.face_area[8, 0] - 0.26138848) < error and abs(mesh.face_area[8, 1] - 0.26138848) < error and \
               mesh.face_area[8, 2] == 0.0
        assert abs(mesh.face_area[9, 0] - (-0.26138848)) < error and abs(mesh.face_area[9, 1] - 0.23861152) < error and \
               mesh.face_area[9, 2] == 0.0
        assert abs(mesh.face_area[10, 0] - (-0.23861152)) < error and abs(mesh.face_area[10, 1] - 0.26138848) < error and \
               mesh.face_area[10, 2] == 0.0
        assert abs(mesh.face_area[11, 0] - (-0.37499997)) < error and abs(mesh.face_area[11, 1] - 0.37499997) < error and \
               mesh.face_area[11, 2] == 0.0
        assert abs(mesh.face_area[12, 0] - (-0.125)) < error and abs(mesh.face_area[12, 1] - (-0.375)) < error and \
               mesh.face_area[12, 2] == 0.0
        assert abs(mesh.face_area[13, 0] - (-0.375)) < error and abs(mesh.face_area[13, 1] - (-0.125)) < error and \
               mesh.face_area[13, 2] == 0.0
        assert abs(mesh.face_area[14, 0] - 0.28125) < error and abs(mesh.face_area[14, 1] - 0.28125) < error and \
               mesh.face_area[14, 2] == 0.0
        assert abs(mesh.face_area[15, 0] - 0.21875) < error and abs(mesh.face_area[15, 1] - (-0.28125)) < error and \
               mesh.face_area[15, 2] == 0.0
        assert abs(mesh.face_area[16, 0] - 0.28125) < error and abs(mesh.face_area[16, 1] - (-0.21875)) < error and \
               mesh.face_area[16, 2] == 0.0
        assert abs(mesh.face_area[17, 0] - 0.35085642) < error and abs(mesh.face_area[17, 1] - (-0.3574769)) < error and \
               mesh.face_area[17, 2] == 0.0
        assert abs(mesh.face_area[18, 0] - 0.14914358) < error and abs(mesh.face_area[18, 1] - 0.35747692) < error and \
               mesh.face_area[18, 2] == 0.0
        assert abs(mesh.face_area[19, 0] - 0.3508564) < error and abs(mesh.face_area[19, 1] - 0.14252308) < error and \
               mesh.face_area[19, 2] == 0.0
        assert abs(mesh.face_area[20, 0] - (-0.36361155)) < error and abs(mesh.face_area[20, 1] - (-0.11361153)) < error and \
               mesh.face_area[20, 2] == 0.0
        assert abs(mesh.face_area[21, 0] - (-0.08946794)) < error and abs(mesh.face_area[21, 1] - (-0.3811346)) < error and \
               mesh.face_area[21, 2] == 0.0
        assert abs(mesh.face_area[22, 0] - (-0.27414358)) < error and abs(mesh.face_area[22, 1] - 0.26752308) < error and \
               mesh.face_area[22, 2] == 0.0
        assert abs(mesh.face_area[23, 0] - (-0.09375)) < error and abs(mesh.face_area[23, 1] - (-0.34375)) < error and \
               mesh.face_area[23, 2] == 0.0
        assert abs(mesh.face_area[24, 0] - 0.36789355) < error and abs(mesh.face_area[24, 1] - 0.07622692) < error and \
               mesh.face_area[24, 2] == 0.0
        ...
        assert mesh.face_cell[11, 0] == 2 and mesh.face_cell[11, 1] == 3
        assert mesh.face_cell[12, 0] == 2 and mesh.face_cell[12, 1] == 8
        ...
        assert abs(mesh.face_center[11, 0] - 0.8125) < error and abs(mesh.face_center[11, 1] - 0.8125) < error
        assert abs(mesh.face_center[12, 0] - 0.8125) < error and abs(mesh.face_center[12, 1] - 0.5625) < error
        ...
        assert abs(mesh.face_norm[11, 0] - (-0.70710677)) < error and abs(mesh.face_norm[11, 1] - 0.70710677) < error
        assert abs(mesh.face_norm[12, 0] - (-0.31622776)) < error and abs(mesh.face_norm[12, 1] - (-0.9486833)) < error
        ...
        assert mesh.faces[11, 0] == 1 and mesh.faces[11, 1] == 6
        assert mesh.faces[12, 0] == 9 and mesh.faces[12, 1] == 1
