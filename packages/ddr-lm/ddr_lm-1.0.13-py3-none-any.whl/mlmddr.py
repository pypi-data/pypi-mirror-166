...
#PVH        class_file = path.join(basedir_infr_files, "ddrclass.py")
...
#PVH            debug(f"{device.name}: Uploading infra files")
...
#PVH        info("DDR XE Infra Deploy: Install DDR Python Packages and Dependencies - 2")
...
#                    "rm /bootflash/guest-share/ddr/ddr_python-1.0.1-py3-none-any.whl",
