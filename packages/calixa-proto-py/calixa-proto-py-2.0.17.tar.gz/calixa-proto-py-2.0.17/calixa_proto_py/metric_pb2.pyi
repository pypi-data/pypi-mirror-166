...
class MetricRollup(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    organization_id: typing___Text = ...
    range: condition_pb2___RelativeTimeRangeValue = ...

    def __init__(self,
        *,
        organization_id : typing___Optional[typing___Text] = None,
        range : typing___Optional[condition_pb2___RelativeTimeRangeValue] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"organization_id",b"organization_id",u"range",b"range"]) -> None: ...
