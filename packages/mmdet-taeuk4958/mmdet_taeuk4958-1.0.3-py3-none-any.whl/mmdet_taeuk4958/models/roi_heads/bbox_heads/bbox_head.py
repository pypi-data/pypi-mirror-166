...
from mmdet_taeuk4958.core import build_bbox_coder, multi_apply, multiclass_nms
from mmdet_taeuk4958.models.builder import HEADS, build_loss
from mmdet_taeuk4958.models.losses import accuracy
from mmdet_taeuk4958.models.utils import build_linear_layer
...
class BBoxHead(BaseModule):
    ...
    def refine_bboxes(self, rois, labels, bbox_preds, pos_is_gts, img_metas):
        ...
        Example:
            ...
            >>> import kwarray
            >>> import numpy as np
            >>> from mmdet_taeuk4958.core.bbox.demodata import random_boxes
    ...
    def onnx_export(self,
        ...
        from mmdet_taeuk4958.core.export import add_dummy_nms_for_onnx
