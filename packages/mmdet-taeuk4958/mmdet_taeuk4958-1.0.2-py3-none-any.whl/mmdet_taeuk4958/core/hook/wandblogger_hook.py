...
from mmdet_taeuk4958.core import DistEvalHook, EvalHook
from mmdet_taeuk4958.core.mask.structures import polygon_to_bitmap
...
class MMDetWandbHook(WandbLoggerHook):
    ...
    def _add_ground_truth(self, runner):
        ...
        from mmdet_taeuk4958.datasets.pipelines import LoadImageFromFile
        img_loader = None
