...
- This is one of the advanced methods added in this library aise from the conventional methods in selenium.
- This method finds element without you having to mention selectors or locators
- It ensures that its able to find the element with locators it suits fine
- Also this ensures that whenever element HTML changes, its able to adapt to changes & work fine without you having to do any code change
- Use this [Selenium Pro Auto Code Generator Chrome Extension](https://chrome.google.com/webstore/detail/low-code-writerselenium-b/ocimgcpcnobcnmclomhhmjidgoiekeaf) to get pro-id for any element on the web
