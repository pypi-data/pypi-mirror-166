...
class ThreadClassify(models.Model):
    ...
    show = models.ForeignKey(verbose_name='默认展示ID', to=ThreadShow, db_column='show_id', related_name='+',
                             on_delete=models.DO_NOTHING, default=1, help_text='')
    description = models.CharField(verbose_name='描述', max_length=255, blank=True, null=True, help_text='')
...
class ThreadExtendData(models.Model):
    ...
    field_1 = models.CharField(verbose_name='1', max_length=255, blank=True, null=True, help_text='')
    field_2 = models.CharField(verbose_name='2', max_length=255, blank=True, null=True, help_text='')
    field_3 = models.CharField(verbose_name='3', max_length=255, blank=True, null=True, help_text='')
    field_4 = models.CharField(verbose_name='4', max_length=255, blank=True, null=True, help_text='')
    field_5 = models.CharField(verbose_name='5', max_length=255, blank=True, null=True, help_text='')
    field_6 = models.CharField(verbose_name='6', max_length=255, blank=True, null=True, help_text='')
    field_7 = models.CharField(verbose_name='7', max_length=255, blank=True, null=True, help_text='')
    field_8 = models.CharField(verbose_name='8', max_length=255, blank=True, null=True, help_text='')
    field_9 = models.CharField(verbose_name='9', max_length=255, blank=True, null=True, help_text='')
    field_10 = models.CharField(verbose_name='10', max_length=255, blank=True, null=True, help_text='')
    field_11 = models.CharField(verbose_name='11', max_length=255, blank=True, null=True, help_text='')
    field_12 = models.CharField(verbose_name='12', max_length=255, blank=True, null=True, help_text='')
    field_13 = models.CharField(verbose_name='13', max_length=255, blank=True, null=True, help_text='')
    field_14 = models.CharField(verbose_name='14', max_length=255, blank=True, null=True, help_text='')
    field_15 = models.CharField(verbose_name='15', max_length=255, blank=True, null=True, help_text='')
    field_16 = models.CharField(verbose_name='16', max_length=255, blank=True, null=True, help_text='')
    field_17 = models.CharField(verbose_name='17', max_length=255, blank=True, null=True, help_text='')
    field_18 = models.CharField(verbose_name='18', max_length=255, blank=True, null=True, help_text='')
    field_19 = models.CharField(verbose_name='19', max_length=255, blank=True, null=True, help_text='')
    field_20 = models.CharField(verbose_name='20', max_length=255, blank=True, null=True, help_text='')
