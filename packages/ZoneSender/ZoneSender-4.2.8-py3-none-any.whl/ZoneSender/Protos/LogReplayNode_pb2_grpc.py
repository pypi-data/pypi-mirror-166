...
class LogReplayNodeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetLogStatus = channel.unary_unary(
                ...
                response_deserializer=Common__pb2.generic_string_response.FromString,
                )
        ...
        self.GetReplayFileInfo = channel.unary_unary(
                '/LogReplayNode.LogReplayNode/GetReplayFileInfo',
                request_serializer=Common__pb2.file_path.SerializeToString,
                response_deserializer=LogReplayNode__pb2.blf_file_info.FromString,
                )
...
class LogReplayNodeServicer(object):
    ...
    def GetReplayFileInfo(self, request, context):
        """
        获取 blf 文件的描述信息
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
...
def add_LogReplayNodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetLogStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=Common__pb2.generic_string_response.SerializeToString,
            ),
            ...
            'GetReplayFileInfo': grpc.unary_unary_rpc_method_handler(
                    servicer.GetReplayFileInfo,
                    request_deserializer=Common__pb2.file_path.FromString,
                    response_serializer=LogReplayNode__pb2.blf_file_info.SerializeToString,
            ),
...
class LogReplayNode(object):
    ...
    def GetLogStatus(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/LogReplayNode.LogReplayNode/GetLogStatus',
            ...
            Common__pb2.generic_string_response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetReplayFileInfo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/LogReplayNode.LogReplayNode/GetReplayFileInfo',
            Common__pb2.file_path.SerializeToString,
            LogReplayNode__pb2.blf_file_info.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
